...
public sealed partial class ToriiClient
{
        ...
        string requestedSelector)
    {
        ...
        if (hasEq != hasEp)
        {
            throw new JsonException("Kagemusha V4 recursive verifier records must be reported as an Eq/Ep pair.");
        }
        if ((readiness.ArtifactSet is not null) != hasEq)
        {
            throw new JsonException("artifact_set and the Kagemusha V4 Eq/Ep verifier pair must be reported together.");
        }
        ...
        {
            throw new JsonException("recursive_lineage_supported contradicts the Kagemusha V4 runtime conjunction.");
        }
        ...
        {
            throw new JsonException("ready contradicts the complete Kagemusha V4 runtime conjunction.");
        }
        ...
        ulong evaluatedHeight)
    {
        ...
        {
            throw new JsonException($"{field} does not identify its Kagemusha V4 verifier role.");
        }
    }
        ...
        ToriiKagemushaReadinessV4 readiness)
    {
        ...
        {
            throw new JsonException("artifact_set does not match the authenticated active Kagemusha V4 release.");
        }
    }
