...
public sealed class NetworkIdTests
{
    ...
    public void NetworkIdJsonRejectsPublicTextAndNonCanonicalMarkedLiterals(string json)
    {
        Assert.Throws<JsonException>(() => JsonSerializer.Deserialize<NetworkId>(json));
    }
