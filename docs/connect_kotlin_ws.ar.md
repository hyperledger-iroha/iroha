...
<!-- الترجمة العربية لـ docs/connect_kotlin_ws.md (Kotlin WS Join with Tokens) -->

## الاتصال عبر WebSocket في Kotlin مع Tokens (باستخدام OkHttp)
...
### تشفير/فك تشفير الـ payload (ChaCha20‑Poly1305 + AAD)
...
// تشفير SignResultOk من المحفظة إلى التطبيق عند seq=1 (payload فقط؛ تغليف Norito غير معروض)
