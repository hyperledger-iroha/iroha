...
<!-- Traducción al español de docs/connect_kotlin_ws.md (Kotlin WS Join with Tokens) -->

## Conexión WebSocket en Kotlin con Tokens (OkHttp)
...
### Cifrar/descifrar payloads (ChaCha20‑Poly1305 + AAD)
...
// Sellar SignResultOk wallet → app en seq=1 (sólo payload; el framing Norito no se muestra)
