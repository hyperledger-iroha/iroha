...
<!-- Traduction française de docs/comment_audit.md (Comment Audit Notes) -->

# Notes d’Audit des Commentaires

Les modules IVM suivants ont été vérifiés et leurs commentaires inline/docs
ont été confirmés comme étant conformes au comportement actuel (aucune
...
Les autres crates du workspace devront faire l’objet d’un passage similaire si
de futures mises à jour de commentaires s’avèrent nécessaires.
