...
id: staging-manifest-playbook-hy
...
slug: /sorafs/staging-manifest-playbook-hy
---

:::note Կանոնական աղբյուր
Հայելիներ `docs/source/sorafs/runbooks/staging_manifest_playbook.md`. Պահպանեք երկու օրինակները համահունչ թողարկումներում:
:::
...
3. Անցեք արտադրության ստուգաթերթին (`chunker_registry_rollout_checklist.md`-ի 4-րդ բաժինը), երբ շահագրգիռ կողմերը ստորագրեն:
