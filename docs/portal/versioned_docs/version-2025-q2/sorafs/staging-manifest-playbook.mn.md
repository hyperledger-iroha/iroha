...
id: staging-manifest-playbook-mn
...
slug: /sorafs/staging-manifest-playbook-mn
---

::: Каноник эх сурвалжийг анхаарна уу
`docs/source/sorafs/runbooks/staging_manifest_playbook.md` толь. Хоёр хуулбарыг хувилбаруудын хооронд зэрэгцүүлэн хадгална уу.
:::
