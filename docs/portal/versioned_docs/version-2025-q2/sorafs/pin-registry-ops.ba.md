...
2. **Ҡоро-йүгереү сәхнәләштереү **
   ...
   - `/v2/sorafs/pin/{digest}` һәм `/v2/sorafs/aliases` ос нөктәләре менән синтетик дәлилдәр менән яңы, яңыртыу-тәҙрә ҡаплай, һәм ҡаты сирле осраҡтарҙа. HTTP статус кодтарын, башлыҡтарын (`Sora-Proof-Status`, `Retry-After`, `Warning`) һәм JSON корпусына ҡаршы раҫлау.
3. **Производствола **
