...
2. **მშრალი გაშვება დადგმაში**
   ...
   - განახორციელეთ `/v2/sorafs/pin/{digest}` და `/v2/sorafs/aliases` საბოლოო წერტილები სინთეზური მტკიცებულებებით, რომლებიც ფარავს ახალ, განახლების ფანჯარას, ვადაგასულ და ვადაგასულობას. დაადასტურეთ HTTP სტატუსის კოდები, სათაურები (`Sora-Proof-Status`, `Retry-After`, `Warning`) და JSON სხეულის ველები ამ runbook-თან.
3. ** ჩართვა წარმოებაში **
