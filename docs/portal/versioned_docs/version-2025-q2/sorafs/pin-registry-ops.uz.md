...
2. **Sahnadagi quruq yugurish**
   ...
   - `/v2/sorafs/pin/{digest}` va `/v2/sorafs/aliases` so'nggi nuqtalarini yangi, yangilash oynasi, muddati o'tgan va muddati o'tgan holatlarni qamrab oluvchi sintetik dalillar bilan ishlating. HTTP holat kodlari, sarlavhalar (`Sora-Proof-Status`, `Retry-After`, `Warning`) va JSON asosiy maydonlarini ushbu runbook bilan taqqoslang.
