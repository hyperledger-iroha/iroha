...
1. **အကြောင်းရင်းကို ဖော်ထုတ်ပါ**
   ...
   - တည်ငြိမ်သော လွဲချော်မှုများဖြင့် နောက်ကျကျန်နေပါက ကောင်စီ၏အတည်ပြုချက်ကို စောင့်ဆိုင်းနေသော ထင်ရှားသည့်ရလဒ်များကို အတည်ပြုရန် ဝင်ခွင့် (`/v2/sorafs/pin/*`) ကို စစ်ဆေးပါ။
...
3. **ပုံတူကူးခြင်းကို ပြန်လည်သတ်မှတ်ရန်**
   - backlog slack (`stat="avg"`) သည် 5 ပိုင်းအောက် ကျဆင်းသွားသောအခါတွင် `sorafs_manifest_stub capacity replication-order` မှတစ်ဆင့် အမှာစာအသစ်များ ထုတ်ပေးပါသည်။
