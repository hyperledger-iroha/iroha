...
- `iroha app da get`-ն ավելացնում է DA-ի վրա հիմնված այլանուն բազմաղբյուր նվագախմբի համար, որն արդեն իսկ ուժ ունի
  ...
  ուղին օգտագործվում է, CLI-ն հանում է մանիֆեստը `/v1/da/manifests/<ticket>`-ից, պահպանում է փաթեթը տակ
...
- **PDP/PoTR կեռիկներ** — PDP պարտավորությունները բխում են անմիջապես կտորների պահեստից և պահպանվում են
  ...
  `/v1/da/ingest` գումարած `/v1/da/manifests/{ticket}` այժմ ներառում է `Sora-PDP-Commitment` վերնագիր
...
- Torii-ի `/v1/da/ingest` վերջնակետն այժմ նորմալացնում է ծանրաբեռնվածության սեղմումը, ամրացնում է վերարտադրման քեշը,
