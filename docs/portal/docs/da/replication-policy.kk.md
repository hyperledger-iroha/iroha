...
барлық `/v2/da/ingest` жіберілімдері. Torii манифесттерді мәжбүрлі түрде қайта жазады
...
люкс сәйкес емес сақтау саясатын `/v2/da/ingest` жібереді және тексереді
