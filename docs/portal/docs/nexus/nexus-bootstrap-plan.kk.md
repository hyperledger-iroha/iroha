...
- **Sora Taira (testnet)** – `taira` кезеңдік желі префиксі, интеграциялық тестілеу және шығарылым алдындағы тексеру (UUID `809574f5-fee7-5e69-bfcf-52451e42d50f` тізбегі) үшін негізгі желі конфигурациясын шағылыстыру.
- Әрбір орта үшін бөлек генезистік файлдарды, басқару кілттерін және инфрақұрылым іздерін сақтаңыз. Taira Nexus дейін жылжыту алдында барлық SoraFS/SoraNet шығарылымдары үшін сынақ алаңы ретінде әрекет етеді.
- CI/CD құбырлары алдымен Taira жүйесіне орнатылып, автоматтандырылған түтін сынақтарын орындауы керек және тексерулерден өткеннен кейін Nexus қолмен жылжытуды талап етеді.
- Анықтамалық конфигурация топтамалары `configs/soranexus/nexus/` (негізгі желі) және `configs/soranexus/taira/` (testnet) астында тұрады, олардың әрқайсысында `config.toml`, `genesis.json` және Torii қабылдау каталогтары бар.
