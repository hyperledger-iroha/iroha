...
- **Sora Taira (testnet)** – `taira` кезеңдік желі префиксі, интеграциялық тестілеу және шығарылым алдындағы тексеру (UUID `fc56984b-2be7-431d-840e-21514d1883f0` тізбегі) үшін негізгі желі конфигурациясын шағылыстыру.
