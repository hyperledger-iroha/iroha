...
- **Sora Taira (testnet)** - prefixo de rede de staging `taira`, espelhando a configuracao da mainnet para testes de integracao e validacao pre-release (chain UUID `fc56984b-2be7-431d-840e-21514d1883f0`).
