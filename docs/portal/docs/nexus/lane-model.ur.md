...
- `LaneCatalog`, `LaneMetadata`, اور `DataSpaceCatalog` `iroha_data_model::nexus` میں رہتے ہیں اور manifests و SDKs کے لئے Norito-compatible structures فراہم کرتے ہیں۔
