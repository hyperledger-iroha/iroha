...
- CI/CD торбалары тәүҙә Taira-ҡа таратыу, автоматлаштырылған төтөн һынауҙарын башҡарырға тейеш, һәм ҡул менән I18NT000000011X чек үткәндән һуң ҡул менән пропагандалауҙы талап итә.
