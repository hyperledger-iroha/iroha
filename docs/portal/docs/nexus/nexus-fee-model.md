---
id: nexus-fee-model
title: Nexus fees and sponsor programs
description: Quote-to-sign fees, isolated sponsor programs, reservations, and settlement.
---

:::note Canonical Source
This page mirrors `docs/source/nexus_fee_model.md`. Keep both copies aligned while translations migrate.
:::
