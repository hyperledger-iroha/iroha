...
- Torii URL, որը բացահայտում է `/v2/sorafs/*`, գումարած հեղինակային հաշիվ/մասնավոր բանալի
...
| Անունը | Նպատակը |
|------|---------|
| `DOCS_SORAFS_TORII_URL` | Torii հոսթ, որը բացահայտում է `/v2/sorafs/pin/register`-ը: |
