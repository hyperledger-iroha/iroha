...
- Torii URL, რომელიც ასახავს `/v2/sorafs/*`-ს, პლუს ავტორიტეტული ანგარიშის/პირადი გასაღების
...
| სახელი | დანიშნულება |
|------|---------|
| `DOCS_SORAFS_TORII_URL` | Torii ჰოსტი, რომელიც ავლენს `/v2/sorafs/pin/register`-ს. |
