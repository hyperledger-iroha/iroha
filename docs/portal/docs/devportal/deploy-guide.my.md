...
- Torii URL နှင့် `/v2/sorafs/*` နှင့် အခွင့်အာဏာအကောင့်/ပုဂ္ဂလိကသော့ကို ဖော်ထုတ်ပေးသည်
...
| အမည် | ရည်ရွယ်ချက် |
|--------|---------|
| `DOCS_SORAFS_TORII_URL` | Torii သည် `/v2/sorafs/pin/register` ကို ဖော်ထုတ်သည့် လက်ခံဆောင်ရွက်ပေးသည်။ |
