...
title: יומן הזמנות בטא W3
sidebar_label: יומן W3
description: ציר זמן לגל ההזמנות של preview בתאריך 2026-02-18.
---

האירועים המופיעים להלן משוכפלים ב-`artifacts/docs_portal_preview/feedback_log.json`
ומסוכמים ב-`preview-20260218-summary.json` / `preview-20260218-digest.md`.

| חותמת זמן (UTC) | אירוע | נמען | הערות |
| --- | --- | --- | --- |
| 2026-02-18 14:00 | invite-sent | finance-beta-01 | קוהורט פיילוט פיננסי |
...
| 2026-02-18 14:05 | invite-sent | observability-ops-02 | מוכנות observability |
...
| 2026-02-18 14:10 | invite-sent | partner-sdk-03 | גל שותף SDK |
...
השתמש ב-`npm run --prefix docs/portal preview:wave -- --wave preview-20260218 --invite-start 2026-02-18 --invite-end 2026-02-28 --report-date 2026-03-01`
כדי לייצר מחדש את ה-digest ונתוני הפורטל בעת עדכון הלוג.
