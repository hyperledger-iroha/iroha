...
title: SoraNet 定率プロファイル
sidebar_label: 定率プロファイル
description: core/home 本番 relay 向けの SNNet-17B1 preset カタログと SNNet-17A2 の null dogfood プロファイル、tick->bandwidth の計算、CLI helpers、MTU guardrails をまとめる。
---
