...
title: תרגיל PQ Ratchet של SoraNet
sidebar_label: Runbook ל-PQ Ratchet
description: שלבי תרגול לכוננות לקידום או הורדה של מדיניות האנונימיות PQ המדורגת עם אימות telemetry דטרמיניסטי.
---
