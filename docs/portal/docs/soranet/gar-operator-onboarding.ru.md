...
---
title: Онбординг операторов GAR
sidebar_label: Онбординг GAR
description: Чеклист для активации политик compliance SNNet-9 с digests аттестаций и фиксацией доказательств.
---
