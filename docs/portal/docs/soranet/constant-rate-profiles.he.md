...
title: פרופילי קצב קבוע של SoraNet
sidebar_label: פרופילי קצב קבוע
description: קטלוג presets של SNNet-17B1 עבור relays מסוג core/home בפרודקשן לצד פרופיל dogfood null של SNNet-17A2, עם מתמטיקת tick->bandwidth, עזרי CLI והגנות MTU.
---
