...
---
title: Revision jurisdiccional GAR (SNNet-9)
sidebar_label: Revision jurisdiccional GAR
description: Decisiones jurisdiccionales aprobadas y digests Blake2b para integrar en configs de compliance de SoraNet.
---
