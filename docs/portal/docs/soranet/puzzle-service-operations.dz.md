...
- `POST /v2/puzzle/mint` – མིན་ཊི་ཚུ་ Argon2 གི་ཤོག་འཛིན་; གདམ་ཁ་ཅན་གྱི་ JSON གཟུགས་པོ།
...
- `GET /v2/token/config` – `pow.token.enabled = true` སྐབས་ ཤུགས་ལྡན་འདི་སླར་ལོག་འབདཝ་ཨིན།
...
- `POST /v2/token/mint` – མིན་ཊི་ཚུ་ ཨེམ་ཨེལ་ཌི་ཨེསི་ཨེ་ འཛུལ་ཞུགས་བརྡ་མཚོན་ཅིག་ བཀྲམ་སྤེལ་འབད་ཡོདཔ་ཨིན།
...
ལག་ཆས་ཀྱི་ མདོང་ལམ་། ཆ་མེད་ཡིག་སྣོད་བལྟ་མི་གིས་ `/v2/token/config` གློག་རྒྱུན་བཞགཔ་ཨིན།
...
4. ** Validate.** `POST /v2/puzzle/mint` བརྒྱུད་དེ་ ཤོག་འཛིན་ཅིག་བཏོན་ཞིནམ་ལས་ ངེས་གཏན་བཟོ།
...
- **Puzzle ཕྲང་སྒྲིག་:** I18NI000000058X དང་མཐུན་དགོ།
  `/v2/puzzle/config` གིས་ལོག་འོང་དཀའ་སྡིག། ཁ་སྟོར་འདི་གིས་ རྒྱུན་ལམ་བཀག་པའི་རི་ལེ་བརྡ་སྟོནམ་ཨིན།
  figg ཡང་ན་ འཐུས་ཤོར་འབྱུང་མི་ ལོག་འགོ་བཙུགས་ཡོདཔ།
- **ཊོ་ཀེན་གྲ་སྒྲིག་:** `/v2/token/config` `enabled = false` ལུ་མར་ཕབ་འབད་བ་ཅིན་ ཉེན་བརྡ་འབདཝ་ཨིན།
...
- **ཞབས་ཞུ་འཕྲོད་བསྟེན:** དུས་རྒྱུན་གྱི་ཚེ་སྲོག་ཐོབ་ཐང་དང་ཉེན་བརྡ།
  ...
  ལན་ཚུ་ `/v2/token/mint` ལུ་; བསྐྱར་ལོག་འཐུས་ཤོར་འདི་ ཤོག་ལེབ་ཀྱི་གནས་སྟངས་ཅིག་སྦེ་ཨིན།
