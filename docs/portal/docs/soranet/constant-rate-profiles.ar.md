...
title: ملفات المعدل الثابت في SoraNet
sidebar_label: ملفات المعدل الثابت
description: كتالوج presets لـ SNNet-17B1 لمرحل core/home الانتاجية مع ملف null dogfood لـ SNNet-17A2، ومعادلات tick->bandwidth ومساعدات CLI وحواجز MTU.
---
