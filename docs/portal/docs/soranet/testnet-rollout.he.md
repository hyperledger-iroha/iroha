...
---
id: testnet-rollout
title: השקת testnet של SoraNet (SNNet-10)
sidebar_label: השקת testnet (SNNet-10)
description: תכנית הפעלה מדורגת, kit להצטרפות, ושערי telemetry לקידומי testnet של SoraNet.
---
