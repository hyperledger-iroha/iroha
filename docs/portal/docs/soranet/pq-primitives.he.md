...
---
id: pq-primitives
title: פרימיטיבים פוסט-קוונטיים של SoraNet
sidebar_label: פרימיטיבי PQ
description: סקירה של ה-crate `soranet_pq` וכיצד ה-handshake של SoraNet משתמש בעזרי ML-KEM/ML-DSA.
---
