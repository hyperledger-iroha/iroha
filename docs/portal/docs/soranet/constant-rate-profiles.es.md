...
title: Perfiles de tasa constante de SoraNet
sidebar_label: Perfiles de tasa constante
description: Catalogo de presets SNNet-17B1 para relays de produccion core/home y el perfil null de dogfood SNNet-17A2, con matematica tick->bandwidth, helpers de CLI y guardrails de MTU.
---
