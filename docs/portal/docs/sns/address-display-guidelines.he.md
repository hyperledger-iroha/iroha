...
- **שתי מטרות העתקה.** ספקו שני כפתורי העתקה מפורשים: IH58 (ברירת מחדל)
  והצורה הדחוסה עבור Sora בלבד (`snx1...`). IH58 תמיד בטוחה לשיתוף חיצוני
...
|---------------|---------------|
| ברירת מחדל משתמעת | `0x0200000120641297079357229f295938a4b5a333de35069bf47b9d0704e45805713d13c201` |
