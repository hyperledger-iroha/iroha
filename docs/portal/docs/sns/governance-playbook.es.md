...
| Guia UX de direcciones | [`address-display-guidelines.md`](./address-display-guidelines.md) | Renderizados canonicos IH58/comprimidos reflejados por wallets/explorers. |
