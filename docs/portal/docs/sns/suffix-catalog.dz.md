...
|-------------------------------------------------------------------------- -------------- -----|-|--------------------------------------------------------------- ----- - --------------------|------------------------------------------- ---|-----------------|-------------------------|----------------|
| `.sora` | `0x0001` | `i105...` | I18NI0000039X | ཤུགས་ལྡན་ | I18NI0000040X | ༥༠༠ | 1 – 5 | ༣༠ / ༦༠ | I18NI0000041X | I18NI0000042X | I18NI0000043X | 1 |
| I18NI0000044X | `0x0002` | I18NI0000046X | I18NI0000047X | མཚམས་འཇོག་འབད་ཡོདཔ། | I18NI0000048X | 300 | 1 1 – 3 | ༡༥ / ༣༠ | I18NI0000049X<br>`T1: ^[a-z]{2}$ → 4000 XOR (Dutch floor 500)` | `treasury → i105...`, `guardian → i105...` | I18NI0000003X | 2 |
...
༢ ཐོ་བཀོད་ཀྱི་ལག་ཆས་འདི་གིས་ `suffix_id` དང་ དུས་ཡུན་ཚད་གཞི་ དེ་ལས་ གོང་ཚད་ཚུ་ ཐོན་དགོ།
   ཐོ་གཞུང་ལས་ ཞུ་བ་ཅིག་གིས་ `/v2/sns/*` ལུ་ ཕོག་པའི་སྐབས་ལུ་ཨིན།
