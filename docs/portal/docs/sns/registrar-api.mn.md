...
**Сонгонлогчийн кодчилол:** `{selector}` замын сегмент нь ADDR-5-д IH58 (давуу), шахсан (`sora`, хоёрдугаарт) эсвэл каноник зургаан өнцөгтийг хүлээн зөвшөөрдөг; Torii үүнийг `NameSelectorV1`-ээр хэвийн болгодог.
...
2. Үйлчлүүлэгч `RegisterNameRequestV1`:
   - `selector` нь илүүд үздэг IH58 буюу хоёр дахь хамгийн сайн шахсан (`sora`) шошгоноос гаралтай.
