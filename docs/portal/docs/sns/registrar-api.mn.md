...
|-------------|--------|
| Протоколууд | `/v2/sns/*` болон gRPC үйлчилгээний `sns.v1.Registrar` дор АМРАХ. Аль аль нь Norito-JSON (`application/json`) болон Norito-RPC хоёртын (`application/x-norito`) хүлээн авдаг. |
...
|----------|--------|---------|-------------|
| `/v2/sns/registrations` | POST | `RegisterNameRequestV1` | Нэрээ бүртгүүлэх эсвэл дахин нээх. Үнийн түвшнийг шийдэж, төлбөр/засаглалын нотолгоог баталгаажуулж, бүртгэлийн үйл явдлуудыг гаргадаг. |
| `/v2/sns/registrations/{selector}/renew` | POST | `RenewNameRequestV1` | Хугацаа сунгах. Бодлогын хөнгөлөлт/зөлөөллийн цонхыг хэрэгжүүлдэг. |
| `/v2/sns/registrations/{selector}/transfer` | POST | `TransferNameRequestV1` | Засаглалын зөвшөөрлийг хавсаргасны дараа өмчлөлийг шилжүүлнэ. |
| `/v2/sns/registrations/{selector}/controllers` | PUT | `UpdateControllersRequestV1` | Хянагчийн багцыг солих; гарын үсэг зурсан дансны хаягуудыг баталгаажуулдаг. |
| `/v2/sns/registrations/{selector}/freeze` | POST | `FreezeNameRequestV1` | Асран хамгаалагч/зөвлөл хөлддөг. Асран хамгаалагчийн тасалбар, засаглалын баримт бичгийн лавлагаа шаардлагатай. |
| `/v2/sns/registrations/{selector}/freeze` | УСТГАХ | `GovernanceHookV1` | Засвар хийсний дараа хөлдөөх; зөвлөлийн дарангуйллыг бүртгэхийг баталгаажуулдаг. |
| `/v2/sns/reserved/{selector}` | POST | `ReservedAssignmentRequestV1` | Нөөцлөгдсөн нэрсийн нярав/зөвлөлийн томилгоо. |
| `/v2/sns/policies/{suffix_id}` | АВАХ | — | `SuffixPolicyV1` гүйдлийг татах (кэш хийх боломжтой). |
| `/v2/sns/registrations/{selector}` | АВАХ | — | Одоогийн `NameRecordV1` + үр дүнтэй төлөвийг буцаана (Идэвхтэй, Грейс гэх мэт). |
...
`--governance-json` нь хүчинтэй `GovernanceHookV1` бичлэг (саналын ID, саналын хэш, нярав/асран хамгаалагчийн гарын үсэг) агуулсан байх ёстой. Тушаал бүр нь харгалзах `/v2/sns/registrations/{selector}/…` төгсгөлийн цэгийг тусгадаг тул бета операторууд SDK-ийн дуудах Torii гадаргууг яг таг давтах боломжтой.
...
1. Саналын ID нь засаглалын дэвтэрт (`/v2/governance/proposals/{id}`) байгаа бөгөөд статус нь `Approved` байна.
...
1. Үйлчлүүлэгч `/v2/sns/policies/{suffix_id}`-ээс үнэ, хөнгөлөлт, боломжит түвшний мэдээллийг авахын тулд асуудаг.
...
3. Засвар хийсний дараа зөвлөлийн асуудлыг шийдвэрлэх; оператор DELETE `/v2/sns/registrations/{selector}/freeze`-г `GovernanceHookV1`-ээр илгээдэг.
...
- Төлбөрийн баталгаа нь Norito дэвтэрийн баримтыг дахин ашиглах; төрийн сангийн үйлчилгээ нь туслах API (`/v2/finance/sns/payments`) өгдөг.
