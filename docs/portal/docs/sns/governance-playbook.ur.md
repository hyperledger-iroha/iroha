...
| Address UX guide | [`address-display-guidelines.md`](./address-display-guidelines.md) | کینونیکل I105 (ترجیحی) / I105 (`sora`) renderings جو wallets/explorers میں جھلکتے ہیں۔ |
