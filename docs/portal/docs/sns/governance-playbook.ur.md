...
| Address UX guide | [`address-display-guidelines.md`](./address-display-guidelines.md) | کینونیکل IH58/compressed renderings جو wallets/explorers میں جھلکتے ہیں۔ |
...
6. **Customer disclosure:** Customer-facing ledger (wallet/explorer) کو
   ...
   ذریعے اپڈیٹ کریں، اور یقینی بنائیں کہ IH58 اور compressed renderings copy/QR
