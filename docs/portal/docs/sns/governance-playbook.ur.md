...
| Address UX guide | [`address-display-guidelines.md`](./address-display-guidelines.md) | کینونیکل IH58 (ترجیحی) / compressed (`snx1`) (`snx1`, second-best) renderings جو wallets/explorers میں جھلکتے ہیں۔ |
...
6. **Customer disclosure:** Customer-facing ledger (wallet/explorer) کو
   ...
   ذریعے اپڈیٹ کریں، اور یقینی بنائیں کہ IH58 اور compressed (`snx1`) renderings copy/QR
