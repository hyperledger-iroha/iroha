...
- POST `/v2/contracts/deploy`
  ...
  ဆက်စပ်-
    - `/v2/contracts/code/{code_hash}` → သိမ်းဆည်းထားသော မန်နီးဖက်စ်ကို ပြန်ရယူပါ။
    - `/v2/contracts/code-bytes/{code_hash}` → `{ code_b64 }` ကို ပြန်ရယူပါ
...
- `/v2/gov/proposals/{id}` ရယူပါ။
  - လမ်းကြောင်း `{id}`- အဆိုပြုချက် id hex (64 လုံး)
  - တုံ့ပြန်ချက်- { "found": bool, "proposal": { … }? }

- `/v2/gov/locks/{rid}` ရယူပါ။
  - လမ်းကြောင်း `{rid}`- ဆန္ဒခံယူပွဲ ID စာကြောင်း
  - တုံ့ပြန်ချက်- { "found": bool, "referendum_id": "rid", "locks": { … }? }

- `/v2/gov/council/current` ရယူပါ။
  - တုံ့ပြန်ချက်- { "epoch": N၊ "အဖွဲ့ဝင်များ"- [{ "account_id": "…" }, …] }
  - မှတ်စုများ- လက်ရှိရှိနေသည့် ကောင်စီကို ပြန်ပေးသည်။ သို့မဟုတ်ပါက သတ်မှတ်ထားသော အစုရှယ်ယာပိုင်ဆိုင်မှုနှင့် ကန့်သတ်ချက်များကို အသုံးပြု၍ အဆုံးအဖြတ်ပေးသည့် ဆုတ်ယုတ်မှုတစ်ခု (VRF သတ်မှတ်ချက်ကို မှန်ချပ်များပေါ်မှ VRF အထောက်အထားများ ဆက်လက်တည်ရှိနေသည်အထိ)။- ပို့စ် `/v2/gov/council/derive-vrf` (အင်္ဂါရပ်- gov_vrf)
...
အဆင်ပြေမှုအဆုံးမှတ်
- POST `/v2/gov/protected-namespaces` — `gov_protected_namespaces` ကို node ပေါ်တွင် တိုက်ရိုက်သက်ရောက်သည်။
...
- `iroha --output-format text app gov deploy audit --namespace apps [--contains calc --hash-prefix deadbeef]`
  - namespace နှင့် cross-checks အတွက် စာချုပ်ဥပမာများကို ထုတ်ယူသည်-
    ...
    - `/v2/contracts/code/{code_hash}` အောက်တွင် သိမ်းဆည်းထားသော မန်နီးဖက်စ်သည် `code_hash` နှင့် `abi_hash` တန်ဖိုးများနှင့် ကိုက်ညီသော အစီရင်ခံစာများ။
...
သာဓကများစာရင်း
- `/v2/gov/instances/{ns}` ကိုရယူပါ — namespace အတွက် တက်ကြွသော စာချုပ်ဖြစ်ရပ်များကို စာရင်းပြုစုပါ။
  - Query params များ-
...
- POST `/v2/gov/ballots/zk-v1`
  ...
  - တုံ့ပြန်ချက်- { "ok": true၊ "accepted": true, "tx_instructions": [{…}] }- ပို့စ် `/v2/gov/ballots/zk-v1/ballot-proof` (အင်္ဂါရပ်- `zk-ballot`)
...
- Torii: `GET /v2/sumeragi/evidence` နှင့် `GET /v2/sumeragi/evidence/count`။
...
5. **စာရင်းစစ်ရလဒ်** သည် `/v2/sumeragi/evidence` နှင့် `/v2/sumeragi/status` မှတစ်ဆင့် သက်သေအထောက်အထားများ တန်ပြန်အဆင့်မြင့်ပြီး အုပ်ချုပ်ရေးမှ ဖယ်ရှားခြင်းကို အတည်ပြုကြောင်း သေချာစေရန်။
...
- runtime နှင့် CLI သည် `/v2/sumeragi/params` နှင့် `iroha --output-format text ops sumeragi params` မှတဆင့် အဆင့်လိုက်သတ်မှတ်ထားသောဘောင်များကို ဖော်ထုတ်ပေးသောကြောင့် အော်ပရေတာများသည် activation အမြင့်များနှင့် validator စာရင်းများကို အတည်ပြုနိုင်ပါသည်။
- အုပ်ချုပ်မှု အလိုအလျောက်စနစ်သည် အမြဲရှိသင့်သည်-
  ...
  3. `/v2/sumeragi/status` ကို `effective_consensus_mode` အထိ မျှော်လင့်ထားသည့် အမြင့်သို့ ပြန်လှန်ပါ။
