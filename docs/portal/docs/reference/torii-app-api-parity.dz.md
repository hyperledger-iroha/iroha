...
fatche-gated ལམ་བཟོ་མི། ང་བཅས་ཀྱིས་ བདེན་དཔྱད་འབད་མི་ ལམ་སྟོན་ནང་ `/v2/*` གི་ཁ་ཐོག་རེ་ལུ་ཨིན།
...
### རྩིས་ཁྲའི་གནང་བ་ (`/v2/accounts/{id}/permissions`) — ཁྱབ་བསྒྲགས།
...
### ཨ་ལི་ཡས་ཨོ་པི་ཨར་ཨེཕ་དབྱེ་ཞིབ་ (`POST /v2/aliases/voprf/evaluate`) — ཁྱབ་ཁོངས།
...
### བདེན་དཔང་བྱུང་རིམ་ SSE (`GET /v2/events/sse`) — ཁྱབ་བསྒྲགས།
...
### ལྡེ་མིག་མི་ཚེ་འཁོར་རིམ་ བདེན་དཔྱད་འབད་ནི། (`/v2/zk/vk/*`) — ཁ་བསྡམས།
...
### I18NT0000005X མཐུད་ལམ་ (`/v2/connect/*`) — ཁྱབ་ཁོངས་ (`connect`)
