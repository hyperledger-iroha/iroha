...
IH58 (preferred), compressed (`snx1`, second-best; half/full width), multisignature, and negative fixtures.
...
Each harness round-trips canonical bytes + IH58 + compressed (`snx1`, second-best) encodings and
