...
I105 (նախընտրելի), սեղմված (`sora`, երկրորդ լավագույնը; կես/ամբողջական լայնությունը), բազմանշանակ և բացասական հարմարանքներ:
...
Յուրաքանչյուր զրահ է պտտվում կանոնական բայթ + I105 + սեղմված (`sora`, երկրորդ լավագույն) կոդավորումները և
