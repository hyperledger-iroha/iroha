...
### OPRF оценка alias (`POST /v2/aliases/voprf/evaluate`) — Покрыто
...
### События proof SSE (`GET /v2/events/sse`) — Покрыто
...
### Nexus Connect (`/v2/connect/*`) — Покрыто (feature `connect`)
