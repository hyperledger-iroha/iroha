...
`ExplorerAccountQrSnapshot` espelha o JSON `/v2/explorer/accounts/{id}/qr`: inclui o account id canônico, o literal canônico I105, metadados de prefixo/correção de erro, dimensões do QR e o payload SVG inline.
