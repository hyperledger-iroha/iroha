...
title: תוכנית Observability ו-SLO של SoraFS
sidebar_label: Observability ו-SLOs
description: סכמת טלמטריה, דשבורדים ומדיניות תקציב שגיאות עבור gateways של SoraFS, נודים והאורקסטרטור מרובה מקורות.
---
