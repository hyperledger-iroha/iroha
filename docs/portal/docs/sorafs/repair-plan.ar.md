...
| `max_penalty` | 1,000,000,000 | الحد الأقصى لعقوبة القطع المسموح به لتصعيد الإصلاح (nano-XOR). |

- المقترحات التي تم إنشاؤها بواسطة المجدول هي `max_penalty`؛ يتم رفض طلبات المدقق التي تتجاوز الحد الأقصى.
