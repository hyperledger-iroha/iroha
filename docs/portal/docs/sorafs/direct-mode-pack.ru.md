...
Эта страница отражает `docs/source/sorafs/direct_mode_pack.md`. Держите обе копии синхронизированными, пока legacy набор Sphinx не будет выведен из эксплуатации.
:::
