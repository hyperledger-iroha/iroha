...
---
title: Дайджест резервного реестра и дашборды
description: Как превратить вывод `sorafs reserve ledger` в телеметрию, дашборды и алерты для политики Reserve+Rent.
---
