...
title: תוכנית מימוש Pin Registry של SoraFS
sidebar_label: תוכנית Pin Registry
description: תוכנית מימוש SF-4 המכסה מכונת מצבים של registry, חזית Torii, tooling ותצפיתיות.
---
