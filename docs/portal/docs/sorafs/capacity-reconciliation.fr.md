...
title: Réconciliation de capacité SoraFS
description: Workflow nocturne pour faire correspondre les registres de frais de capacité aux exports de transferts XOR.
---
