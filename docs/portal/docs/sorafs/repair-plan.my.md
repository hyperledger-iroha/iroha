...
| `max_penalty` | 1,000,000,000 | ပြုပြင်ခြင်း (nano-XOR) အတွက် အမြင့်ဆုံး မျဉ်းစောင်း ဒဏ်ကြေးကို ခွင့်ပြုသည်။ |

- အစီအစဉ်ဆွဲသူ-ထုတ်ပေးသော အဆိုပြုချက်များကို `max_penalty` တွင် ကန့်သတ်ထားသည်။ ဦးထုပ်အထက် စာရင်းစစ်တင်ပြချက်များကို ပယ်ချပါသည်။
