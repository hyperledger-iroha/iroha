...
title: רולאאוט וכיול לאורקסטרטור
sidebar_label: כיוונון אורקסטרטור
description: ברירות מחדל מעשיות, הנחיות כיוונון ונקודות ביקורת כדי להביא את האורקסטרטור רב-המקורות ל‑GA.
---
