...
- ဝန်ဆောင်မှုပေးသူ ကြော်ငြာပေးချေမှုတွင် `range_capability`၊ `stream_budget` နှင့်
  `transport_hints` မက်တာဒေတာ။ `/v1/sorafs/providers` တုံ့ပြန်မှုများနှင့် သက်သေပြပါ။
...
- Torii `/v1/sorafs/providers` သည် ခွဲခြမ်းစိတ်ဖြာနိုင်စွမ်းရှိသော မက်တာဒေတာကို တစ်ပါတည်း ပြန်ပေးသည်
