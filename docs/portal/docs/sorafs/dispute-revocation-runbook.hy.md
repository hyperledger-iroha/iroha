...
- **Հաստատեք հեռաչափությունը.** նկարահանեք `/v2/sorafs/capacity/state` և `/v2/sorafs/capacity/telemetry` նկարներ մատակարարի համար:
...
4. Ներկայացրե՛ք JSON հարցումը Torii `/v2/sorafs/capacity/dispute`-ին կառավարման գործարքների հերթի միջոցով: Գրեք `dispute_id_hex` պատասխանի արժեքը; այն խարսխում է չեղյալ համարելու հետագա գործողությունները և աուդիտի հաշվետվությունները:
