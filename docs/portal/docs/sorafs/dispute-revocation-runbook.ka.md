...
- **დაადასტურეთ ტელემეტრია:** გადაიღეთ `/v2/sorafs/capacity/state` და `/v2/sorafs/capacity/telemetry` კადრები პროვაიდერისთვის.
...
4. გაგზავნეთ მოთხოვნა JSON-ზე Torii `/v2/sorafs/capacity/dispute` მმართველობითი ტრანზაქციის რიგის მეშვეობით. დააფიქსირეთ `dispute_id_hex` პასუხის მნიშვნელობა; ის ამაგრებს შემდგომი გაუქმების ქმედებებს და აუდიტის ანგარიშებს.
