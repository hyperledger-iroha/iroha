...
title: Plan de publication du portail docs → SoraFS
sidebar_label: Plan de publication du portail
description: Checklist pas a pas pour publier le portail docs, OpenAPI et les bundles SBOM via SoraFS.
---
