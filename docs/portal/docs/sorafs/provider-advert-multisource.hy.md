...
- Մատակարարի գովազդային բեռները պետք է ներառեն `range_capability`, `stream_budget` և
  `transport_hints` մետատվյալներ. Վավերացնել `/v2/sorafs/providers` պատասխանների միջոցով և
...
- Torii `/v2/sorafs/providers`-ը վերադարձնում է վերլուծված միջակայքի հնարավորությունների մետատվյալները միասին
