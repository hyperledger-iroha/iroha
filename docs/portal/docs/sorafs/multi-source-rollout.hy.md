...
1. **Հաստատեք կառավարման տվյալները։**
   - Բոլոր թեկնածու մատակարարները պետք է հրապարակեն `ProviderAdvertV1` ծրարներ՝ տիրույթի հնարավորության օգտակար բեռներով և հոսքային բյուջեներով: Վավերացրեք `/v2/sorafs/providers`-ի միջոցով և համեմատեք ակնկալվող կարողությունների դաշտերի հետ:
