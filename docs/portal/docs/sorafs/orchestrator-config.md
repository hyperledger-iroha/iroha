...
Protocol controls cap handshake and stream-open frames at 64 KiB and individual
fields at 1024 bytes. The runtime disables 0-RTT, services at most 128
connections and 256 streams per connection, applies a ten-second connect/frame
timeout, and terminates transfers after five minutes.
