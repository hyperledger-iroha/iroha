...
---
title: אימות שוק קיבולת SoraFS
tags: [SF-2c, acceptance, checklist]
summary: צ'קליסט קבלה שמכסה onboarding של providers, זרימות dispute ו-reconciliation של treasury שנדרשות ל-GA של שוק קיבולת SoraFS.
---
