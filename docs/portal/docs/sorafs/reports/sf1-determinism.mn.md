...
| 3 | `cargo run -p sorafs_car --bin sorafs_manifest_chunk_store -- --list-profiles` | `sorafs.sf1@1.0.0`-ийн оруулга нь бүртгэлийн тодорхойлогчтой таарч байна (`profile_id=1`). | Бүртгэлийн мета өгөгдлийг синхрончлолд байлгахыг баталгаажуулдаг. |
