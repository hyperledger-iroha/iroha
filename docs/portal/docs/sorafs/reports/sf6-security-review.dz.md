...
**གནས་ཁོངས་:**
- སི་ཨེལ་ཨའི་འབྱུང་ཁུངས་དང་བརྟག་དཔྱད་ (`crates/sorafs_orchestrator/src/bin/sorafs_cli.rs`)
...
4. ཆ་སྙོམས་འཕྲུལ་ཆས་ (`cargo test -p sorafs_orchestrator --test sorafs_cli proof_stream_consumes_ndjson_and_reports_metrics -- --nocapture`) ལས་ བསྡུ་བསྒྱོམ་འབད་ཡོད་པའི་དྲན་ཐོ་ཚུ།
