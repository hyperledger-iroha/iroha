...
| 3 | `cargo run -p sorafs_car --bin sorafs_manifest_chunk_store -- --list-profiles` | الإدخال الخاص بـ `sorafs.sf1@1.0.0` يطابق واصف registry (`profile_id=1`). | يضمن بقاء metadata الخاصة بالregistry متزامنة. |
