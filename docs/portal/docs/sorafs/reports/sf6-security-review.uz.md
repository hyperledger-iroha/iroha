...
**Artifaktlar:**
- CLI manbasi va testlari (`crates/sorafs_orchestrator/src/bin/sorafs_cli.rs`)
...
- Deterministik paritet jabduqlar (`crates/sorafs_orchestrator/tests/sorafs_cli.rs`, [SoraFS Orchestrator GA Paritet hisoboti](./orchestrator-ga-parity.md))
...
4. Paritet jabduqdan olingan jurnallar (`cargo test -p sorafs_orchestrator --test sorafs_cli proof_stream_consumes_ndjson_and_reports_metrics -- --nocapture`).
