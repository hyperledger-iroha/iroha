...
title: ראנבוק סכסוכים וביטולים של SoraFS
sidebar_label: ראנבוק סכסוכים וביטולים
description: תהליך ממשל להגשת סכסוכי קיבולת של SoraFS, תיאום ביטולים ופינוי נתונים באופן דטרמיניסטי.
---
