...
| Release rollback and yank | Release Engineering / Governance Council | [`sorafs/release-rollback-yank`](./release-rollback-yank.md) | `docs/source/sorafs_release_pipeline_plan.md` |
