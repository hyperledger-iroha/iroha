...
- Үйлчилгээ үзүүлэгчийн сурталчилгааны ачаалал нь `range_capability`, `stream_budget`, болон
  `transport_hints` мета өгөгдөл. `/v2/sorafs/providers` хариултаар баталгаажуулна уу
...
- Torii `/v2/sorafs/providers` нь задалсан хүрээний чадамжийн мета өгөгдлийг буцаана
