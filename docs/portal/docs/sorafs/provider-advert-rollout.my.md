...
2. **ပံ့ပိုးသူကိရိယာဖြင့် ပြန်လည်ထုတ်လုပ်ပါ။**
   ...
   - `/v1/sorafs/providers` နှင့် `sorafs_fetch` မှတဆင့် တရားဝင်စစ်ဆေးပါ။ အမည်မသိအကြောင်း သတိပေးချက်များ
...
- ** မတော်တဆ တုံ့ပြန်မှု။** `reject` သတိပေးချက် မီးလောင်ပါက၊ ဖုန်းဆက်ပြီး အင်ဂျင်နီယာများ-
  1. Torii ရှာဖွေတွေ့ရှိမှု (`/v1/sorafs/providers`) မှတစ်ဆင့် စော်ကားသောကြော်ငြာကို ရယူပါ။
  2. ပံ့ပိုးပေးသူပိုက်လိုင်းတွင် ကြော်ငြာအတည်ပြုချက်ကို ပြန်လည်လုပ်ဆောင်ပြီး နှင့် နှိုင်းယှဉ်ပါ။
     အမှားကိုပြန်ထုတ်ရန် `/v1/sorafs/providers`။
