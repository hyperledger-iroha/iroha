...
`run_cli.sh` encapsule `sorafs_manifest_builder capacity` pour émettre des payloads Norito, des blobs base64, des corps de requête Torii et des résumés JSON pour :
