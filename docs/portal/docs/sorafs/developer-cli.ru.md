...
Эта страница отражает `docs/source/sorafs/developer/cli.md`. Держите обе копии синхронизированными, пока legacy набор Sphinx не будет выведен из эксплуатации.
:::
