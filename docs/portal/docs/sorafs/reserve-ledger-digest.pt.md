...
---
title: Resumo do ledger de reserva e dashboards
description: Como transformar a saida de `sorafs reserve ledger` em telemetria, dashboards e alertas para a politica Reserve+Rent.
---
