...
title: Plano de publicacao do portal de docs -> SoraFS
sidebar_label: Plano de publicacao do portal
description: Checklist passo a passo para publicar o portal de docs, OpenAPI e bundles SBOM via SoraFS.
---
