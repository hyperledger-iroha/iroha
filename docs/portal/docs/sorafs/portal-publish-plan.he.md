...
title: תוכנית פרסום פורטל docs → SoraFS
sidebar_label: תוכנית פרסום פורטל
description: רשימת בדיקה צעד-אחר-צעד לפרסום פורטל docs, OpenAPI וחבילות SBOM דרך SoraFS.
---
