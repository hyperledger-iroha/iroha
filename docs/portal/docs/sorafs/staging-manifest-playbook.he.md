...
title: פלייבוק manifest ל-staging
sidebar_label: פלייבוק manifest ל-staging
description: צ'קליסט להפעלת פרופיל chunker שאושר בפרלמנט בפריסות Torii של staging.
---
