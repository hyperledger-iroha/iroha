...
- Тасымалдауды тексеру үшін `iroha ledger nft list all --verbose` немесе SDK эквиваленттерімен NFT кітапшасының күйін тексеріңіз, содан кейін жазу нұсқауы орындалғаннан кейін актив жойылғанын растаңыз.
