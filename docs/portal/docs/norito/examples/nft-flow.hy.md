...
- Ստուգեք NFT մատյանային վիճակը `iroha ledger nft list all --verbose`-ով կամ SDK-ի համարժեքներով՝ փոխանցումը ստուգելու համար, այնուհետև հաստատեք, որ ակտիվը հեռացված է, երբ գործարկվի այրման հրահանգը:
