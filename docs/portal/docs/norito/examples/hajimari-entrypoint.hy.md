...
- Տեղադրեք արտեֆակտը `iroha app contracts deploy`-ի միջոցով և հաստատեք մանիֆեստը՝ օգտագործելով [Norito Getting Started] (/norito/getting-started#4-deploy-via-iroha) քայլերը:
