...
- გადაამოწმეთ ნაშთები `FindAccountAssets` ან `iroha ledger asset list all --verbose` მეშვეობით და შეამოწმეთ მოვლენები, რათა დაადასტუროთ, რომ მეტამონაცემების მცველმა დაარეგისტრირა გადაცემის კონტექსტი.
