...
- Проверьте балансы через `FindAccountAssets` или `iroha_cli assets list --account ih58...` и просмотрите события, чтобы подтвердить, что guard метаданных записал контекст перевода.
