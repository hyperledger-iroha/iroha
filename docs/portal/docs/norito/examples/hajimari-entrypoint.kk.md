...
- `iroha app contracts deploy` арқылы артефактты орналастырыңыз және [Norito Жұмысқа кірісу](/norito/getting-started#4-deploy-via-iroha) бөліміндегі қадамдарды пайдаланып манифестті растаңыз.
