...
- `iroha app contracts deploy` བརྒྱུད་དེ་ བརྡ་མཚོན་འདི་བཀྲམ་སྤེལ་འབད་ཞིནམ་ལས་ [Norito འགོ་བཙུགས་ནི་](/norito/getting-started#4-deploy-via-iroha) ནང་གི་རིམ་པ་ཚུ་ལག་ལེན་འཐབ་སྟེ་ གསལ་བསྒྲགས་འདི་ངེས་གཏན་བཟོ།
