...
- Шилжүүлгийг баталгаажуулахын тулд NFT дэвтэрийн төлөвийг `iroha ledger nft list all --verbose` эсвэл SDK түүнтэй адилтгах хэрэглүүрээр шалгаад дараа нь шатаах заавар ажилласны дараа хөрөнгийг устгасан эсэхийг баталгаажуулна уу.
