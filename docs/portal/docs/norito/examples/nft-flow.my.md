...
- လွှဲပြောင်းမှုကိုစစ်ဆေးရန် `iroha ledger nft list all --verbose` သို့မဟုတ် ညီမျှသော SDK ဖြင့် NFT လယ်ဂျာအခြေအနေအား စစ်ဆေးပါ၊ ထို့နောက် မီးလောင်မှုညွှန်ကြားချက်ကို လုပ်ဆောင်သည်နှင့် ပိုင်ဆိုင်မှုကို ဖယ်ရှားကြောင်း အတည်ပြုပါ။
