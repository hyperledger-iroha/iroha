...
- განათავსეთ არტეფაქტი `iroha app contracts deploy`-ის მეშვეობით და დაადასტურეთ მანიფესტი [Norito დაწყება] (/norito/getting-started#4-deploy-via-iroha) ნაბიჯების გამოყენებით.
