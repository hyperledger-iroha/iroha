...
- `iroha app contracts deploy` မှတစ်ဆင့် ရှေးဟောင်းပစ္စည်းကို ဖြန့်ကျက်ပြီး [Norito စတင်ခြင်း](/norito/getting-started#4-deploy-via-iroha) ရှိ အဆင့်များကို အသုံးပြု၍ မန်နီးဖက်စ်ကို အတည်ပြုပါ။
