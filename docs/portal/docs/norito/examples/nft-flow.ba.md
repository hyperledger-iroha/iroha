...
- Тикшерергә NFT баш китабы дәүләте менән `iroha ledger nft list all --verbose` йәки SDK эквиваленттары раҫлау өсөн тапшырыу, һуңынан раҫлау актив юйылған бер тапҡыр яндырыу инструкцияһы эшләй.
