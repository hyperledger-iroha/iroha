...
- `iroha app contracts deploy`-ээр дамжуулан олдворыг байрлуулж, [Norito Эхлэх](/norito/getting-started#4-deploy-via-iroha) хэсэгт байгаа алхмуудыг ашиглан манифестийг баталгаажуулна уу.
