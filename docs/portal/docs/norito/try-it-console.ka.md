...
მხოლოდ JSON მარშრუტებისთვის, ჩაშენებული Try it sandbox ხშირად უფრო სწრაფია: შეიყვანეთ გზა (მაგალითად, `/v1/accounts/<i105-account-id>/assets`), აირჩიეთ HTTP მეთოდი, ჩასვით JSON ტექსტი საჭიროების შემთხვევაში და დააჭირეთ **Send მოთხოვნა** სათაურების, ხანგრძლივობისა და დატვირთვის ხაზში შესამოწმებლად.
