...
4. აირჩიეთ `application/x-norito` კონტენტის ტიპი „სცადეთ“ უჯრაში, დააწკაპუნეთ **აირჩიე ფაილი** და აირჩიეთ თქვენი დატვირთვა. პროქსი ხელახლა წერს მოთხოვნას `/proxy/v2/pipeline/submit`-ზე და მონიშნავს მას `X-TryIt-Client=docs-portal-rapidoc`-ით.
...
მხოლოდ JSON მარშრუტებისთვის, ჩაშენებული Try it sandbox ხშირად უფრო სწრაფია: შეიყვანეთ გზა (მაგალითად, `/v2/accounts/i105.../assets`), აირჩიეთ HTTP მეთოდი, ჩასვით JSON ტექსტი საჭიროების შემთხვევაში და დააჭირეთ **Send მოთხოვნა** სათაურების, ხანგრძლივობისა და დატვირთვის ხაზში შესამოწმებლად.
