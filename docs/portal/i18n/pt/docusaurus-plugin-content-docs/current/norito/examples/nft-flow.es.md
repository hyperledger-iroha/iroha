...
- Certifique-se de que existe a definição do NFT (por exemplo, `n0#wonderland`) junto com as informações do proprietário/receptor usadas no fragmento (`soraカタカナ...`, `soraカタカナ...`).
