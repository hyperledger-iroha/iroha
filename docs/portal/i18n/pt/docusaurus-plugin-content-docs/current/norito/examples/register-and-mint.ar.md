...
- Você pode usar o software (como `<katakana-i105-account-id>`) para instalar o SDK no SDK.
- Verifique o valor `register_and_mint` para usar o ROSE 250 e resolva o problema.
- Verifique se o `client.request(FindAccountAssets)` ou `iroha_cli ledger assets list --account <katakana-i105-account-id>` está funcionando.
