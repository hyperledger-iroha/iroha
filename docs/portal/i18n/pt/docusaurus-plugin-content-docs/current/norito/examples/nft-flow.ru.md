...
- Убедитесь, что определение NFT (por exemplo `n0#wonderland`) существует вместе аккаунтами владельца/получателя, usado no trecho (`<katakana-i105-account-id>`, `<katakana-i105-account-id>`).
