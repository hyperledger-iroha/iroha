...
- Verifique saldos via `FindAccountAssets` ou `iroha_cli ledger assets list --account <i105-account-id>` e inspecione eventos para confirmar que o guard de metadados registrou o contexto da transferencia.
