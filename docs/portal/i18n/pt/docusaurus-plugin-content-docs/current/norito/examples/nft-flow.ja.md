...
- Garanta que a definicao do NFT (por exemplo `n0#wonderland`) exista junto com as contas de dono/destinatario usadas no trecho (`<katakana-i105-account-id>`, `<katakana-i105-account-id>`).
