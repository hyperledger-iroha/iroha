...
---
título: Norito Nome de usuário
description: لیجر واک تھرو کے ساتھ منتخب Kotodama اسنیپٹس۔
slug: /norito/exemplos
---

یہ مثالیں SDK کے کوئیک اسٹارٹس اور لیجر واک تھروز کی عکاسی کرتی ہیں۔ ہر اسنیپٹ میں لیجر چیک لسٹ شامل ہے اور Rust, Python e JavaScript گائیڈز کے لنکس دیے ہیں تاکہ آپ وہی منظرنامہ ابتدا سے انتہا تک دہرا سکیں۔
...
- **[اکاؤنٹس کے درمیان اثاثہ منتقل کریں](./transfer-asset)** — سادہ اثاثہ ٹرانسفر ورک فلو جو SDK guias de início rápido e tutoriais passo a passo
