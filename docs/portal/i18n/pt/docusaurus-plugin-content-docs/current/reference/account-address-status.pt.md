...
Cada chicote faz round-trip de bytes canonicos + I105 + encodings comprimidos e verifica se os códigos de erro no estilo Norito batem com o fixture para casos negativos.
