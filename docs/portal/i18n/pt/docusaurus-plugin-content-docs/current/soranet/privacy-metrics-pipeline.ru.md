...
1. Execute NDJSON do relé de endpoints de administrador e use o orquestrador `/v1/soranet/privacy/event|share` em `artifacts/sorafs_privacy/<relay>.ndjson`.
