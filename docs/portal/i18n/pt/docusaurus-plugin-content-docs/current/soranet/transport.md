...
:::note Fonte canonica
Esta pagina espelha a especificacao de transporte SNNet-1 em `docs/source/soranet/spec.md`. Mantenha as duas copias alinhadas ate que o conjunto legado de documentacao seja retirado.
:::
