...
Submissões `/v1/da/ingest` پر لاگو ہوتی ہیں۔ Perfil de retenção imposta Torii
...
suíte `/v1/da/ingest` کو política de retenção incompatível بھیجتی ہے اور verificar کرتی ہے
