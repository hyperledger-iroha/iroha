...
| Guia UX de enderecos | [`address-display-guidelines.md`](./address-display-guidelines.md) | Renderizacoes IH58/comprimidas canonicas refletidas por wallets/explorers. |
