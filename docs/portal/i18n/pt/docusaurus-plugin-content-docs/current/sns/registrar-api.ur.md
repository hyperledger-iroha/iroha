...
2. Cliente `RegisterNameRequestV1` بناتا ہے:
   - `selector` ترجیحی IH58 یا segundo melhor rótulo compactado (`sora`) سے derivado ہے۔
