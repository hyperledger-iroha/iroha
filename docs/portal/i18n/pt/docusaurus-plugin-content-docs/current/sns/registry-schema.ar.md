...
| `payment_asset_id` | `AsciiString` | Você pode obter um acordo de liquidação (como `xor#sora`). |
...
2. Crie modelos de resolvedor (IH58 المفضلة + arquivos de texto compactados (`sora`)).
