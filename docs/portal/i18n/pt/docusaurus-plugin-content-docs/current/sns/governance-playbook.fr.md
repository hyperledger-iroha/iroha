...
| `torii_request_duration_seconds{route="/v2/sns/*"}` | Métricas Torii | SLO de latência para API de manipuladores; alimentos dos painéis são emitidos por `torii_norito_rpc_observability.json`. |
