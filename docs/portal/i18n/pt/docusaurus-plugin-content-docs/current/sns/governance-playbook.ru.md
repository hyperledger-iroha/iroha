...
| `torii_request_duration_seconds{route="/v1/sns/*"}` | Métricas Torii | SLO para dados latentes para API обработчиков; instalado em `torii_norito_rpc_observability.json`. |
