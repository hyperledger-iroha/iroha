...
lang: pt
direction: ltr
source: docs/portal/docs/sdks/recipes/java-ledger-flow.ru.md
status: complete
...
---
title: Рецепт потока реестра на Java
description: Запустите демо регистрация → выпуск → перевод с использованием JVM-библиотеки IrohaAndroid.
slug: /sdks/recipes/java-ledger-flow
---

import SampleDownload from '@site/src/components/SampleDownload';

Этот рецепт рассчитан на desktop/JVM вариант модуля `java/iroha_android`. Он повторяет CLI walkthrough: регистрирует определение актива, выпускает на админ-аккаунт, переводит на второй аккаунт и печатает итоговый баланс.

<SampleDownload
  href="/sdk-recipes/java/src/main/java/ledger/LedgerFlow.java"
  filename="src/main/java/ledger/LedgerFlow.java"
  description="Скачайте полный пример на Java, чтобы импортировать его в IDE или шаблон проекта."
/>
...
Соберите с помощью предпочтительного инструмента (`./gradlew :java:iroha_android:assemble && ./gradlew run`).
