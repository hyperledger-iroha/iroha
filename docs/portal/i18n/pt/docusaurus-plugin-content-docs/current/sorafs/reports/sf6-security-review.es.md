...
**Artefatos:**
- Fonte do CLI e testes (`crates/sorafs_orchestrator/src/bin/sorafs_cli.rs`)
...
- Chicote de paridade determinista (`crates/sorafs_orchestrator/tests/sorafs_cli.rs`, [Relatório de Paridade GA do Orquestrador SoraFS](./orchestrator-ga-parity.md))
...
4. Logs capturados do arnês de segurança (`cargo test -p sorafs_orchestrator --test sorafs_cli proof_stream_consumes_ndjson_and_reports_metrics -- --nocapture`).
