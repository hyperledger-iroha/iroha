...
Os operadores devem regenerar as cargas úteis de solicitação de integração/disputa com `sorafs_manifest_builder capacity {declaration,dispute}` e arquivar os bytes JSON/Norito resultantes junto com o ticket de governança.
