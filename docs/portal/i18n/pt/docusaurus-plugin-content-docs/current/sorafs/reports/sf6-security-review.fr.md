...
**Artefatos:**
- Fonte CLI e testes (`crates/sorafs_orchestrator/src/bin/sorafs_cli.rs`)
...
- Harness de parité déterminista (`crates/sorafs_orchestrator/tests/sorafs_cli.rs`, [Rapport de parité GA SoraFS Orchestrator](./orchestrator-ga-parity.md))
...
4. Registros capturados do arnês de paridade (`cargo test -p sorafs_orchestrator --test sorafs_cli proof_stream_consumes_ndjson_and_reports_metrics -- --nocapture`).
