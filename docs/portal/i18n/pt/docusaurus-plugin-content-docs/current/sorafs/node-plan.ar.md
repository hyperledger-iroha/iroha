...
- ✅ أصبح المسار `/v1/sorafs/por/ingestion/{manifest_digest_hex}` يعرض عمق الـ backlog وأقدم época/prazo وأحدث طوابع النجاح/الفشل لكل مزود، `sorafs_node::NodeHandle::por_ingestion_status`, e Torii ou `torii_sorafs_por_ingest_backlog`/`torii_sorafs_por_ingest_failures_total` 【crates/sorafs_node/src/lib.rs:510】【crates/iroha_torii/src/sorafs/api.rs:1883】【crates/iroha_torii/src/routing.rs:7244】【crates/iroha_telemetry/src/metrics.rs:5390】
