...
:::nota مستند ماخذ
یہ صفحہ `docs/source/sorafs/runbooks/sorafs_orchestrator_ops.md` کی عکاسی کرتا ہے۔ جب تک پرانا Esfinge ڈاکیومنٹیشن سیٹ مکمل طور پر منتقل نہ ہو جائے, دونوں نقول کو ہم آہنگ رکھیں۔
:::

یہ رن بک SRE ٹیموں کو ملٹی سورس fetch آرکسٹریٹر کی تیاری, رول آؤٹ اور آپریشنز میں رہنمائی کرتی ہے۔ یہ ڈیولپر گائیڈ کو پروڈکشن رول آؤٹس کے مطابق طریقۂ کار سے مکمل کرتی ہے، جن میں مرحلہ وار فعال سازی اور peers کی بلیک لسٹنگ شامل ہے۔
...
1. **پرووائیڈر ان پٹس جمع کریں**
   - ہدف فلیٹ کے لیے تازہ ترین پرووائیڈر اشتہارات (`ProviderAdvertV1`) اور ٹیلیمیٹری اسننپ شاٹ۔
   - A carga útil da carga útil é (`plan.json`)۔
2. **متعین (determinístico) اسکور بورڈ تیار کریں**
   ...
   - اسکور بورڈ کے ساتھ سمری JSON آرکائیو کریں؛ آڈیٹرز تبدیلی کی درخواست کی توثیق میں pedaço ریٹرائی کاؤنٹرز پر انحصار کرتے ہیں۔
3. **fixtures کے ساتھ dry-run** — `docs/examples/sorafs_ci_sample/` میں موجود عوامی fixtures پر یہی کمانڈ چلائیں تاکہ پروڈکشن cargas úteis کو چھونے سے پہلے آرکسٹریٹر بائنری متوقع ورژن سے میچ ہو جائے۔

## 2. مرحلہ وار رول آؤٹ طریقۂ کار

1. **کینری مرحلہ (≤2 پرووائیڈرز)**
   - اسکور بورڈ دوبارہ بنائیں اور `--max-peers=2` کے ساتھ چلائیں تاکہ آرکسٹریٹر کو چھوٹے Qual é a melhor opção para você
   - مانیٹر کریں:
...
## 3. pares کی بلیک لسٹنگ اور بوسٹنگ

CLI اسکورنگ پالیسی اوور رائیڈز استعمال کریں تاکہ گورننس اپ ڈیٹس کا انتظار کیے بغیر O que você precisa saber sobre o seu negócio
...
4. `--scoreboard-json` é um arquivo de busca que pode ser usado para fetch چلا کر خرابی کو متعین طور پر دوبارہ پیدا کریں۔
...
3. کم از کم ایک دن تک آرکسٹریٹر میٹرکس اکٹھے کرتے رہیں تاکہ یقین ہو جائے کہ کوئی باقی fetch کاروائیاں جاری نہیں ہیں۔
