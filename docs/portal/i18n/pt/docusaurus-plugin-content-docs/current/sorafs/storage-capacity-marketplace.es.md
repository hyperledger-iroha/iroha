...
- `PinProviderRegistry` agora expõe o snapshot on-chain via `/v2/sorafs/capacity/state`, combinando declarações de provedor e entradas do livro de taxas com Norito JSON determinista.【crates/iroha_torii/src/sorafs/registry.rs:17】【crates/iroha_torii/src/sorafs/api.rs:64】
...
- Enviados via Torii (`/v2/sorafs/capacity/declare`) e depois captura `/v2/sorafs/capacity/state` mas
