...
- Arquivar disputas via `sorafs_manifest_builder capacity dispute` (testes:
...
- Regenere artistas de declaração/telemetria com `sorafs_manifest_builder capacity ...` e rode os
