...
1. قم بترحيل نقطة (نقاط) نهاية المشرف والمنسق للدفق `/v2/soranet/privacy/event|share` وتصدير NDJSON إلى `artifacts/sorafs_privacy/<relay>.ndjson`.
