...
- تم السماح للبطاقة الإلكترونية (مثل `soraカタカナ...`) التي تعمل بتقنية الأثاث والألعاب بدورة أو إجراء `CanTransfer`.
- `call_transfer_asset` تنتقل بطاقة الائتمان عبر الإنترنت `soraカタカナ...` إلى 5 يونيو، أو من خلال هذه المهارة. ما الذي يجعل هذه الآلة أكثر ذكاءً؟
- `FindAccountAssets` أو `iroha_cli ledger assets list --account soraカタカナ...` لا يمكن نقل أي شيء آخر إلى أي شيء آخر. كان الكنست حاضرًا.
