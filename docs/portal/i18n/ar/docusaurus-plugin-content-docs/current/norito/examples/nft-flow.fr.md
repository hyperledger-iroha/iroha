...
- تأكد من أن تعريف NFT (على سبيل المثال `n0#wonderland`) موجود مع الحسابات الشخصية/الوجهة المستخدمة في المقتطف (`<katakana-i105-account-id>`، `<katakana-i105-account-id>`).
