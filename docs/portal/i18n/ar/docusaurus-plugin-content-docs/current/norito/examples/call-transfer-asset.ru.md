...
- عقد المساهمات الكاملة (على سبيل المثال `i105...`) الذي يتم تجديده على الميزانية، ويحدد الدور الهام `CanTransfer` أو ما يعادلها.
- اختر هنا `call_transfer_asset` لتحويل 5 سنوات إلى عقد حساب `i105...`، بالإضافة إلى ذلك، يمكن للأتمتة الأولية أن تدعم استخدام المضيف.
- التحقق من التوازن عبر `FindAccountAssets` أو `iroha_cli ledger assets list --account i105...` وإظهار الاشتراكات للتأكد من حماية البيانات المسجلة إعادة صياغة السياق.
