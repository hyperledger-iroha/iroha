...
- تأكد من وجود تعريف NFT (على سبيل المثال `n0#wonderland`) جنبًا إلى جنب مع حسابات المالك/المستقبل المستخدمة في الجزء (`<katakana-i105-account-id>`، `<katakana-i105-account-id>`).
