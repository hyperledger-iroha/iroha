...
- إحدى أدوات NFT (مثل `n0#wonderland`) الموجودة والمتاحة للاستخدام مرة واحدة وملكية الوصول/الوصول (`<katakana-i105-account-id>`, `<katakana-i105-account-id>`) موجود بالفعل.
