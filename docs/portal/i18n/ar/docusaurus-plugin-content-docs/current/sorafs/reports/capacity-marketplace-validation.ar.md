...
|-------|-----------|----------|
| يقبل التسجيل إعلانات السعة النوعية | يقوم باختبار متكامل ويستطيع `/v1/sorafs/capacity/declare` عبر واجهة برمجة تطبيقات التطبيق، مع التحقق من التشفير التواقيع، والتقاط البيانات الوصفية، وتسليمها إلى التسجيل في العقدة. | `crates/iroha_torii/src/routing.rs:7654` |
