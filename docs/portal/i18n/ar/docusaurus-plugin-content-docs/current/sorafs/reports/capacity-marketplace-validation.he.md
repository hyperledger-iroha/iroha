...
يجب على المشغلين إعادة توليد payloads طلبات الانضمام/النزاع عبر `sorafs_manifest_builder capacity {declaration,dispute}` وأرشفة بايتات JSON/Norito الناتجة بجانب تذكرة الحوكمة.
