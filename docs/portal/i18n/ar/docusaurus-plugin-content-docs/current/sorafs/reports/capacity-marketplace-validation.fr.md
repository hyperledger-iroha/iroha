...
|-------|-----------|----------|
| يقبل التسجيل الإقرارات القانونية المتعلقة بالسعة | يتم إجراء اختبار التكامل `/v1/sorafs/capacity/declare` عبر واجهة برمجة تطبيقات التطبيق، والتحقق من إدارة التوقيعات، والتقاط البيانات الوصفية، والتسليم من خلال سجل جديد. | `crates/iroha_torii/src/routing.rs:7654` |
...
يتعين على المشغلين إعادة إنشاء حمولات الطلب على متن الطائرة/الدعوى باستخدام `sorafs_manifest_builder capacity {declaration,dispute}` وأرشفة وحدات البايت JSON/Norito الناتجة عن بطاقات الإدارة.
