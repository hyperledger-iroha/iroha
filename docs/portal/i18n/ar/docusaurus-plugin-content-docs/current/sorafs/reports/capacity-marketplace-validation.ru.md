...
|-------|-----------|----------|
| مبدأ التسجيل الإقرارات القانونية | يتم استخدام اختبار التكامل `/v1/sorafs/capacity/declare` من خلال واجهة برمجة تطبيقات التطبيق، والتحقق من صحة الوصف، وحفظ البيانات التعريفية، وإرسالها إلى وحدات التسجيل. | `crates/iroha_torii/src/routing.rs:7654` |
