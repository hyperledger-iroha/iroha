...
- **التحقق من القياس عن بعد:** قم بمسح اللقطات `/v2/sorafs/capacity/state` و`/v2/sorafs/capacity/telemetry` للتجربة.
...
4. قم بإصلاح مشكلة JSON في Torii `/v2/sorafs/capacity/dispute` من خلال مراقبة معاملات الحوكمة. قم بتأكيد الإجابة على `dispute_id_hex`; هذه هي الطريقة التالية للملاحظة وملاحظات مدققي الحسابات.
