...
| `sorafs_provider_advert_stub` | ⚠️ اعتزال | مساعد التحقق من صحة البيانات دون اتصال بالإنترنت؛ إعلانات الموفر يجب أن يتم إنتاجها من خلال خط أنابيب النشر والمصادقة عبر `/v2/sorafs/providers`. |
...
- **إعلانات الموفر** - تشتمل حمولات الإعلانات على بيانات وصفية للقدرة والأسماء المستعارة؛ صالحة cobertura عبر `/v2/sorafs/providers` (على سبيل المثال، presenca da capacidade `range`).
