...
- **تأكيد اللقطة البعيدة:** التقاط اللقطات `/v2/sorafs/capacity/state` و`/v2/sorafs/capacity/telemetry` من أجل المورد.
...
4. قم بطلب JSON إلى Torii `/v2/sorafs/capacity/dispute` عبر ملف معاملات الإدارة. التقاط قيمة الاستجابة `dispute_id_hex` ; بالإضافة إلى إجراءات الإلغاء اللاحقة وتقارير التدقيق.
