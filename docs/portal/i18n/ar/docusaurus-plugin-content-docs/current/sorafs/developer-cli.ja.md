...
lang: ja
direction: ltr
source: docs/portal/i18n/ar/docusaurus-plugin-content-docs/current/sorafs/developer-cli.md
status: complete
generator: scripts/sync_docs_i18n.py
source_hash: 58e45a25e2b71334f364c9ddf1159fa4fd3e3ef8189732b8900907d1b1b68801
...
سطح `sorafs_cli` الموحّد (provided by the `sorafs_orchestrator` crate) يعرض كل خطوة مطلوبة لإعداد آرتيفاكتات SoraFS. استخدم هذا الكتيب للانتقال مباشرةً إلى مسارات العمل الشائعة؛ واقرنه بخط أنابيب المانيفست ودلائل تشغيل المُنسِّق للحصول على السياق التشغيلي.
