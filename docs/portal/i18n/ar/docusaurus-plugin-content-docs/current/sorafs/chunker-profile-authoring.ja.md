...
lang: ja
direction: ltr
source: docs/portal/i18n/ar/docusaurus-plugin-content-docs/current/sorafs/chunker-profile-authoring.md
status: complete
generator: scripts/sync_docs_i18n.py
source_hash: d536362a9a04c45c8a5cf30f3814478b095ac514457d4969d782cf71f2a8af30
...
- `sorafs_manifest_chunk_store --json-out=-` — بث تقرير chunk-store إلى stdout
  للمقارنات الآلية.
- `sorafs_manifest_builder --chunker-profile=<handle>` — تأكيد أن manifests وخطط CAR
