...
1. **تأكيد مدخلات الحوكمة.**
   - يجب على جميع المزوّدين المرشحين نشر أظرفة `ProviderAdvertV1` مع حمولة قدرات النطاق وميزانيات التدفق. تحقّق عبر `/v2/sorafs/providers` وقارن مع حقول القدرات المتوقعة.
