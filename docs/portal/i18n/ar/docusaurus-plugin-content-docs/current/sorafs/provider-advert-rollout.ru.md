...
2. **التجديد من خلال أدوات الموفر.**
   ...
   - تحقق من خلال `/v2/sorafs/providers` و`sorafs_fetch`؛ المسبقة o
...
- **الاستجابة للحوادث.** إذا قمت بإعداد التنبيهات `reject`، مهندسون عند الطلب:
  1. قم بإزالة الإعلان الإشكالي من خلال الاكتشاف Torii (`/v2/sorafs/providers`).
  2. قم بالتحقق من صحة الإعلان في خط أنابيب الموفر واتصل به
     `/v2/sorafs/providers`، للتحدث.
