...
توحيد التوحيد `sorafs_cli` (provided by the `sorafs_orchestrator` crate) في كل مرة, مطلوب للمنتج الفني SoraFS. استخدم كتاب الطبخ هذا للوصول بسرعة إلى أنواع سير العمل؛ تدرب مع بيان خط الأنابيب ومنسق دفاتر التشغيل لسياق التشغيل.
