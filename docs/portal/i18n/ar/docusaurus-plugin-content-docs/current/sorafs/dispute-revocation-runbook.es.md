...
- **تأكيد القياس عن بعد:** التقط لقطات `/v2/sorafs/capacity/state` و`/v2/sorafs/capacity/telemetry` للمزود.
...
4. قم بإرسال طلب JSON إلى Torii `/v2/sorafs/capacity/dispute` من خلال مجموعة المعاملات الحكومية. التقاط قيمة الرد `dispute_id_hex`; قم بإضافة إجراءات الإلغاء اللاحقة ومعلومات الاستماع.
