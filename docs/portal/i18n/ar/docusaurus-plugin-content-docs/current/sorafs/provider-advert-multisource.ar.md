...
- يجب أن تتضمن إعلانات الحمولات الصافية `range_capability` و`stream_budget` و`transport_hints`.
  تحقّق عبر استجابات `/v1/sorafs/providers` والتركيبات القديمة؛ يجب أن تتضمن
...
## تكامل المُنسق وTorii- إعادة Torii `/v1/sorafs/providers` قدرة بيانات النطاق المبتكرة مع
