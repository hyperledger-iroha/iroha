...
سطح `sorafs_cli` الموحَّد (provided by the `sorafs_orchestrator` crate) يعرض كل خطوة مطلوبة لإعداد آرتيفاكتات SoraFS. استخدم هذا الكتيب للانتقال إلى ألوان العمل الشائعة؛ واقرنه عملياً لأنابيب المانيفست ودلائل المُنسِّق لإنجاز أعمال السياقة.
