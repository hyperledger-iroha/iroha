...
- **إعلانات الموفر** — تتضمن حمولات الإعلانات بيانات وصفية لقدرات واسم مستعار؛ التحقق من صحة التغطية عبر `/v1/sorafs/providers` (ص. على سبيل المثال، وجود السعة `range`).
