...
- **التتبع:** يمكنك التقاط لقطات `/v2/sorafs/capacity/state` و`/v2/sorafs/capacity/telemetry`.
...
4. تم تحديث الإصدار Torii `/v2/sorafs/capacity/dispute` إلى ريكوست JSON. جواب کي تحت `dispute_id_hex` محفوظ کریں؛ هذا بعد منسوخ وتقرير آخر.
