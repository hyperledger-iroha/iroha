...
---
id: pin-registry-ops
title: Operacoes do Pin Registry
sidebar_label: Operacoes do Pin Registry
description: Monitorar e fazer triagem do Pin Registry do SoraFS e das metricas de SLA de replicacao.
---
