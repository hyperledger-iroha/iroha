...
| `torii_request_duration_seconds{route="/v2/sns/*"}` | مقاييس Torii | SLOs زمن الاستجابة لمعالجات API؛ لوحات المعلومات الغذائية مبنية على `torii_norito_rpc_observability.json`. |
