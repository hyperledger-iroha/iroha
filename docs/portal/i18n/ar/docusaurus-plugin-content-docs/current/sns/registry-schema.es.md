...
| `payment_asset_id` | `AsciiString` | معرف نشاط التسوية بسبب العيب (على سبيل المثال `61CtjvNd9T3THAR65GsMVHr82Bjc`). |
...
2. إعادة إنشاء قوالب المحلل (الاتجاهات المفضلة I105 + المضغوطة (`sora`) كخيار ثانٍ، والسجلات النصية).
