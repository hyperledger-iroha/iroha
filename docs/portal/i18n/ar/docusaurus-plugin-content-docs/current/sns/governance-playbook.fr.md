...
| `torii_request_duration_seconds{route="/v2/sns/*"}` | ميتريكس Torii | SLO زمن الاستجابة لواجهة برمجة تطبيقات المعالجات؛ تم إصدار لوحات المعلومات `torii_norito_rpc_observability.json`. |
