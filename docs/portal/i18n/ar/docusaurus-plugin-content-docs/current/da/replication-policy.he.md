...
lang: he
direction: rtl
source: docs/portal/i18n/ar/docusaurus-plugin-content-docs/current/da/replication-policy.md
status: complete
generator: scripts/sync_docs_i18n.py
source_hash: df01354716121e700a4bba93103412cb5566c41a5a1dd38f49e30a9791f2ddc5
...
طلبات `/v2/da/ingest`. يعيد Torii كتابة manifests مع ملف الاحتفاظ المفروض ويصدر
...
الحزمة بارسال سياسة احتفاظ غير متطابقة الى `/v2/da/ingest` وتتحقق من ان
