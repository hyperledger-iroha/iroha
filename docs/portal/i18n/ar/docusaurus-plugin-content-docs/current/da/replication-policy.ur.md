...
`/v1/da/ingest` تم نشر عمليات الإرسال في وقت لاحق. Torii ملف تعريف الاحتفاظ المفروض
...
مجموعة `/v1/da/ingest` تعمل على سياسة استبقاء غير متطابقة وتتحقق من البطاقة
