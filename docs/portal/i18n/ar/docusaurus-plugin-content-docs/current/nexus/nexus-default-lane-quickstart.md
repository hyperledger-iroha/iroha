...
بعد نجاح هذه الفحوصات يمكنك اعتبار `nexus.routing_policy.default_lane` مصدر الحقيقة لتكوين SDK والبدء بتعطيل مسارات الكود legacy ذات lane الواحد على الشبكة.