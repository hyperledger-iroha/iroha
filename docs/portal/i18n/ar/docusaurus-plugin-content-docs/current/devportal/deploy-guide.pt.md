...
- عنوان URL الخاص بـ Torii الذي يعرض `/v2/sorafs/*` لديه حساب/لديه خصوصية التفويض الذي يمكنه إرسال البيانات والأسماء المستعارة.
...
| الاسم | اقتراح |
| --- | --- |
| `DOCS_SORAFS_TORII_URL` | المضيف Torii الذي يعرض `/v2/sorafs/pin/register`. |
