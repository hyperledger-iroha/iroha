...
- **روابط التذاكر.** يمكنك الحصول على معرفات اللوحة Grafana أو صادرات image المحددة في تغيير التذكرة باستخدام تقرير التحقيق، بحيث يمكن للمراجعين التحقق من SLOs بدون الصدفة التسليم.
