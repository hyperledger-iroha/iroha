...
`ExplorerAccountQrSnapshot` refleja el JSON `/v2/explorer/accounts/{id}/qr`: incluye el account id canónico, el literal canónico I105, metadatos de prefijo/corrección de error, dimensiones del QR y el payload SVG en línea que wallets/explorers pueden incrustar.
