...
lang: ar
direction: rtl
source: docs/portal/docs/sdks/recipes/java-ledger-flow.ur.md
status: complete
...
---
title: جاوا لیجر فلو ترکیب
description: IrohaAndroid JVM لائبریری استعمال کرتے ہوئے رجسٹر → منٹ → ٹرانسفر ڈیمو چلائیں۔
slug: /sdks/recipes/java-ledger-flow
---

import SampleDownload from '@site/src/components/SampleDownload';

یہ ترکیب `java/iroha_android` ماڈیول کے ڈیسک ٹاپ/JVM ویرینٹ کو ہدف بناتی ہے۔ یہ CLI walkthrough کی عکاسی کرتی ہے: اثاثہ تعریف رجسٹر کرنا، admin اکاؤنٹ میں منٹنگ، دوسرے اکاؤنٹ میں ٹرانسفر، اور نتیجہ بیلنس پرنٹ کرنا۔

<SampleDownload
  href="/sdk-recipes/java/src/main/java/ledger/LedgerFlow.java"
  filename="src/main/java/ledger/LedgerFlow.java"
  description="مکمل Java مثال ڈاؤن لوڈ کریں تاکہ اسے اپنے IDE یا پروجیکٹ ٹیمپلیٹ میں امپورٹ کر سکیں۔"
/>

## 1. اثاثہ تعریف رجسٹر کریں (CLI)

```bash
iroha --config defaults/client.toml asset definition register --id coffee#wonderland
```

## 2. اسناد ایکسپورٹ کریں
...
اپنے پسندیدہ بلڈ ٹول سے کمپائل کریں (`./gradlew :java:iroha_android:assemble && ./gradlew run`).
