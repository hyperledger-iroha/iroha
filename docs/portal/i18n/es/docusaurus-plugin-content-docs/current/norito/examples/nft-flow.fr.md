...
- Asegúrese de que la definición de NFT (por ejemplo, `n0#wonderland`) existe con las cuentas propietarias/destinatarias utilizadas en el fragmento (`<katakana-i105-account-id>`, `<katakana-i105-account-id>`).
