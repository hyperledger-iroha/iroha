...
- Asegúrese de que exista la cuenta de destino (por ejemplo `soraカタカナ...`), reflejando la fase de configuración en cada inicio rápido del SDK.
...
- Verifica los saldos mediante `client.request(FindAccountAssets)` o `iroha_cli ledger assets list --account soraカタカナ...` para confirmar que la acuñación tuvo éxito.
