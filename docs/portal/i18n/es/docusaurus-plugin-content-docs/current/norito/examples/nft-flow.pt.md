...
- Garantía que a definicao do NFT (por ejemplo `n0#wonderland`) existe junto com as contas de dono/destinatario usadas no trecho (`<katakana-i105-account-id>`, `<katakana-i105-account-id>`).
