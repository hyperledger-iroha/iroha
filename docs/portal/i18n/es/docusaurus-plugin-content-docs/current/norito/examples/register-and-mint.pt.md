...
- Garantía de que existe una cuenta de destino (por ejemplo, `soraカタカナ...`), activando una fase de configuración en cada inicio rápido del SDK.
...
- Verifique os saldos vía `client.request(FindAccountAssets)` o `iroha_cli ledger assets list --account soraカタカナ...` para confirmar que a cunhagem foi bem-sucedida.
