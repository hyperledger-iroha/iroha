...
- Tenga en cuenta que esta cuenta de usuario (principal `<i105-account-id>`) está almacenada en el SDK de inicio rápido.
...
- Asegúrese de que los equilibrios sean `client.request(FindAccountAssets)` o `iroha_cli ledger assets list --account <i105-account-id>`, para poder utilizar datos personales.
