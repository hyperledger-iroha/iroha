...
- Asegúrese de que exista la definición del NFT (por ejemplo `n0#wonderland`) junto con las cuentas de propietario/receptor usadas en el fragmento (`<katakana-i105-account-id>`, `<katakana-i105-account-id>`).
