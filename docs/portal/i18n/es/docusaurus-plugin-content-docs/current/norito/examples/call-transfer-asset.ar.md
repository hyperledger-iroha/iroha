...
- Utilice el cable de alimentación (`soraカタカナ...`) para conectar el cable y el conector de `CanTransfer` y el cable de alimentación.
- Presione el botón `call_transfer_asset` para 5 veces el conector `soraカタカナ...`, y luego presione el botón `soraカタカナ...`. الأتمتة على السلسلة لنداءات المضيف.
- Para cambiar la configuración de `FindAccountAssets` o `iroha_cli ledger assets list --account soraカタカナ...` y de las opciones de configuración سياق النقل.
