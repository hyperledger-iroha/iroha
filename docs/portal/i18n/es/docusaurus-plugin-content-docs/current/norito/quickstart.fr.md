...
- Binarios `koto build`, `ivm_run` y `iroha_cli`. Podrás construir después de realizar la compra del espacio de trabajo como ci-dessous o telecargar los artefactos de lanzamiento correspondientes:
