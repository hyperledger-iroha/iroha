...
- Binarios `koto build`, `ivm_run` e `iroha_cli`. Puedes compilar los archivos a partir del checkout del espacio de trabajo como mostrar abajo o bajar los artefactos de lanzamiento correspondientes:
