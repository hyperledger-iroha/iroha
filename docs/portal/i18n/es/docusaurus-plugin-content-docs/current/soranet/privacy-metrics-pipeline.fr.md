...
1. Exportador de NDJSON desde los puntos finales del administrador del relé más el flujo `/v2/soranet/privacy/event|share` del orquestador versus `artifacts/sorafs_privacy/<relay>.ndjson`.
