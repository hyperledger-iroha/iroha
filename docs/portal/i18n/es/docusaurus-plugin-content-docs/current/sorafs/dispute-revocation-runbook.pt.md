...
1. Llame a la especificación JSON para `sorafs_manifest_builder capacity dispute`:
...
2. **Gere `ProviderAdmissionRevocationV1`:**
   - Utilice `sorafs_manifest_builder provider-admission revoke` con o motivo aprobado.
