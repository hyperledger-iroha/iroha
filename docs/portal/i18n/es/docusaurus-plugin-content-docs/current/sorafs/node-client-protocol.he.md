...
- `iroha app sorafs storage pin` y `torii /v2/sorafs/pin/register` aceptan manifests
...
- Los endpoints REST (`/v2/sorafs/pin`, `/v2/sorafs/aliases`,
  `/v2/sorafs/replication`) incluyen estructuras de attestation para que los
