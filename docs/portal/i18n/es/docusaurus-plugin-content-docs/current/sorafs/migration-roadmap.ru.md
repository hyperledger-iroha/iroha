...
| Banderas de expectativa | M1 | Пайплайны вызывают `sorafs_manifest_builder` с явными expectativas для фиксации salida: | Documentos CI | Обновленные скрипты со ссылкой на expectation flags (см. блок команды ниже). |
