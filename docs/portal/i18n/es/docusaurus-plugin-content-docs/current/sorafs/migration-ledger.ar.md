...
|--------|---------------|--------------|----------------|-------------|--------|
| M0 | الأسابيع 1–6 | نُشرت accesorios للـ chunker؛ تصدر tuberías حزما من CAR + manifiesto إلى جانب artefactos القديمة؛ تم إنشاء إدخالات السجل. | Documentos, DevRel, SDK | Utilice `sorafs_manifest_builder` para seleccionar banderas que estén conectadas al CDN. | ✅ نشط |
