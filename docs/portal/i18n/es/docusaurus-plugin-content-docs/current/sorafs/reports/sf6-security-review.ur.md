...
**Artefactos:**
- Fuente CLI y pruebas (`crates/sorafs_orchestrator/src/bin/sorafs_cli.rs`)
...
- Arnés de paridad determinista (`crates/sorafs_orchestrator/tests/sorafs_cli.rs`, [SoraFS Informe de paridad GA de Orchestrator](./orchestrator-ga-parity.md))
...
4. arnés de paridad کے registros capturados (`cargo test -p sorafs_orchestrator --test sorafs_cli proof_stream_consumes_ndjson_and_reports_metrics -- --nocapture`) ۔
