...
يجب على المشغلين إعادة توليد cargas útiles طلبات الانضمام/النزاع عبر `sorafs_manifest_builder capacity {declaration,dispute}` y بايتات JSON/Norito الناتجة بجانب تذكرة الحوكمة.
