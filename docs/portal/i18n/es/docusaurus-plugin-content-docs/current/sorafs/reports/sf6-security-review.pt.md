...
**Artefactos:**
- Fuente de CLI y pruebas (`crates/sorafs_orchestrator/src/bin/sorafs_cli.rs`)
...
4. Troncos capturados do arnés de paridad (`cargo test -p sorafs_orchestrator --test sorafs_cli proof_stream_consumes_ndjson_and_reports_metrics -- --nocapture`).
