...
**القطع الفنية:**
- CLI y pantalla táctil (`crates/sorafs_orchestrator/src/bin/sorafs_cli.rs`)
...
- Arnés تساوي حتمي (`crates/sorafs_orchestrator/tests/sorafs_cli.rs`, [تقرير تكافؤ GA لمشغل SoraFS](./orchestrator-ga-parity.md))
...
4. Cable de paridad del arnés (`cargo test -p sorafs_orchestrator --test sorafs_cli proof_stream_consumes_ndjson_and_reports_metrics -- --nocapture`).
