...
**Artefactos:**
- Fuente del CLI y pruebas (`crates/sorafs_orchestrator/src/bin/sorafs_cli.rs`)
...
- Arnés de paridad determinista (`crates/sorafs_orchestrator/tests/sorafs_cli.rs`, [Reporte de Paridad GA del Orchestrator SoraFS](./orchestrator-ga-parity.md))
...
4. Troncos capturados del arnés de paridad (`cargo test -p sorafs_orchestrator --test sorafs_cli proof_stream_consumes_ndjson_and_reports_metrics -- --nocapture`).
