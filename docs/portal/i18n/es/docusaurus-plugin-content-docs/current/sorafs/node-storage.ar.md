...
>
> - `GET /v2/sorafs/storage/manifest/{manifest_id_hex}` — Manifestado Norito (base64) en resumen/metadatos.【crates/iroha_torii/src/sorafs/api.rs:1207】
> - `GET /v2/sorafs/storage/plan/{manifest_id_hex}` — يعيد خطة القطع الحتمية JSON (`chunk_fetch_specs`) en sentido descendente.【crates/iroha_torii/src/sorafs/api.rs:1259】
>
