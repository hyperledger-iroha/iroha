...
título: SoraFS آرکسٹریٹر آپریشنز رن بک
sidebar_label: آرکسٹریٹر رن بک
descripción: ملٹی سورس آرکسٹریٹر کے رول آؤٹ، نگرانی اور رول بیک کے لیے مرحلہ وار آپریشنل گائیڈ۔
---
...
یہ رن بک SRE ٹیموں کو ملٹی سورس buscar آرکسٹریٹر کی تیاری، رول آؤٹ اور آپریشنز میں رہنمائی کرتی ہے۔ یہ ڈیولپر گائیڈ کو پروڈکشن رول آؤٹس کے مطابق طریقۂ کار سے مکمل کرتی ہے، جن میں مرحلہ وار فعال سازی اور peers کی بلیک لسٹنگ شامل ہے۔
...
1. **پرووائیڈر ان پٹس جمع کریں**
   ...
   - زیرِ آزمائش مینِفیسٹ سے اخذ کردہ carga útil پلان (`plan.json`)۔
2. **متعین (determinista) اسکور بورڈ تیار کریں**
   ...
   - اسکور بورڈ کے ساتھ سمری JSON آرکائیو کریں؛ آڈیٹرز تبدیلی کی درخواست کی توثیق میں trozo ریٹرائی کاؤنٹرز پر انحصار کرتے ہیں۔
3. **accesorios کے ساتھ funcionamiento en seco** — `docs/examples/sorafs_ci_sample/` میں موجود عوامی accesorios پر یہی کمانڈ چلائیں تاکہ پروڈکشن cargas útiles کو چھونے سے پہلے آرکسٹریٹر بائنری متوقع ورژن سے میچ ہو جائے۔
...
1. **کینری مرحلہ (≤2 پرووائیڈرز)**
   ...
   - اس وقت آگے بڑھیں جب مکمل مینِفیسٹ buscar کے لیے ریٹرائی ریٹس 1% سے کم رہیں اور کوئی پرووائیڈر ناکامیاں جمع نہ کرے۔
...
## 3. pares کی بلیک لسٹنگ اور بوسٹنگInstalación CLI para el usuario صحت مند پرووائیڈرز کی درجہ بندی ہو سکے۔
...
مستقل تبدیلیوں کے لیے سورس ٹیلیمیٹری میں ترمیم کریں (خلاف ورزی کرنے والے کو penalizado کے طور پر نشان زد کریں) یا CLI اوور رائیڈز صاف کرنے سے پہلے اپ ڈیٹڈ اسٹریم بجٹس کے ساتھ اشتہار ریفریش کریں۔
...
2. `session.summary.json` میں قابل فہم ایرر سٹرنگ دیکھیں:
   ...
   - `retry budget exhausted ...` → `--retry-budget` بڑھائیں یا غیر مستحکم pares ہٹا دیں۔
...
## 5. رول بیکآرکسٹریٹر رول آؤٹ واپس لینے کے لیے:

1. ایسی کنفیگریشن تقسیم کریں جو `--max-peers=1` سیٹ کرے (ملٹی سورس شیڈیولنگ کو مؤثر طور پر غیر فعال کرتی ہے) یا کلائنٹس کو پرانے سنگل سورس buscar راستے پر واپس لے جائیں۔
2. کسی بھی `--boost-provider` اوور رائیڈ کو ہٹا دیں تاکہ اسکور بورڈ نیوٹرل ویٹنگ پر واپس آ جائے۔
3. کم از کم ایک دن تک آرکسٹریٹر میٹرکس اکٹھے کرتے رہیں تاکہ یقین ہو جائے کہ کوئی باقی buscar کارروائیاں جاری نہیں ہیں۔
