...
title: План наблюдаемости и SLO для SoraFS
sidebar_label: Наблюдаемость и SLO
description: Схема телеметрии, дашборды и политика бюджета ошибок для gateways SoraFS, узлов и мульти-источникового оркестратора.
---
