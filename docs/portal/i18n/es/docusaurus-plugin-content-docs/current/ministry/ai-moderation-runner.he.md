...
lang: he
direction: rtl
source: docs/portal/i18n/es/docusaurus-plugin-content-docs/current/ministry/ai-moderation-runner.md
status: complete
generator: scripts/sync_docs_i18n.py
source_hash: b129a39611e76191ff12cbed12c6d1edd0c9909a59378ee21ba3cf22198e7f82
...
- El binario del runner se envía como parte del crate `sorafs_ai_runner`. El pipeline de build incrusta el hash del manifiesto en el binario (expuesto vía `/v2/info`).
