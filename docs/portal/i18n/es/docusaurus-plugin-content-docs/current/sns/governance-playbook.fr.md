...
| `torii_request_duration_seconds{route="/v2/sns/*"}` | Métricas Torii | SLO de latencia para la API de controladores; Alimente des Dashboards issus de `torii_norito_rpc_observability.json`. |
