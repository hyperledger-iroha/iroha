...
| `torii_request_duration_seconds{route="/v2/sns/*"}` | Métricas Torii | SLO по латентности для API обработчиков; Está instalado en el tablero de instrumentos según `torii_norito_rpc_observability.json`. |
