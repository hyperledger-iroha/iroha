...
| `payment_asset_id` | `AsciiString` | Identificador de activo de asentamiento por defecto (por ejemplo `xor#sora`). |
...
2. Regenerar plantillas de resolución (direcciones IH58 preferidas + comprimidas (`sora`) como segunda opción, registros de texto).
