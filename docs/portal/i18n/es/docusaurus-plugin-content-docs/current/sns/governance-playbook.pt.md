...
| `torii_request_duration_seconds{route="/v2/sns/*"}` | Métricas Torii | SLO de latencia para manejadores de API; Tableros de alimentación basados ​​en `torii_norito_rpc_observability.json`. |
