...
2. En Swagger o RapiDoc, seleccione el punto final NRPC (por ejemplo, `POST /v1/pipeline/submit`) y seleccione el selector **Tipo de contenido** en `application/x-norito`.
