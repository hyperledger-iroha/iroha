...
- **Pruebas de canalización/SSE.** Los filtros de eventos de transacciones aceptan los predicados `tx_lane_id == <u32>` (ver `docs/source/pipeline.md`). Abra `/v2/pipeline/events/transactions` con este filtro para comprobar que las escrituras enviadas sin carril explícito llegan al ID de carril de reserva.
