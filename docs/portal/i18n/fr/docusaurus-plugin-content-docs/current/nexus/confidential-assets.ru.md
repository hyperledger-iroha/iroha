...
3. **Écrivez les instructions pour les opérateurs :** Indiquez la rampe d'accès/sortie du runbook `transition_id`. Les écouteurs et les écouteurs sont adaptés au `/v2/confidential/assets/{id}/transitions` pour ouvrir la porte.
