...
2. معاون بائنریز کو بنائیں یا ڈاؤن لوڈ کریں:
   - `koto build` - Kotodama bytecode et IVM/Norito bytecode par défaut
...
- `--max-cycles 1000000` لامحدود اجرا کی درخواست کرتا ہے؛ preuves de connaissance nulle pour le remplissage du cycle et pour les preuves de connaissances nulles
