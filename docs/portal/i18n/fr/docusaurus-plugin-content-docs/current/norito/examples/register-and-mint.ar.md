...
- Utilisez le SDK (`soraカタカナ...`) pour télécharger le SDK.
- Le prix du produit `register_and_mint` est de 250 $ pour ROSE.
- تحقق من أرصدة عبر `client.request(FindAccountAssets)` et `iroha_cli ledger assets list --account soraカタカナ...` لتأكيد نجاح السك.
