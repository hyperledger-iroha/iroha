...
- Assurez-vous que le compte de démarrage (par exemple `soraカタカナ...`) soit disponible à l'étape suivante du SDK de démarrage rapide.
...
- Vérifiez les soldes correspondant à `client.request(FindAccountAssets)` ou `iroha_cli ledger assets list --account soraカタカナ...` pour pouvoir modifier votre compte.
