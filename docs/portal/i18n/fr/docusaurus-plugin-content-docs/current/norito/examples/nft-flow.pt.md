...
- Garantit que la définition du NFT (par exemple `n0#wonderland`) existe avec les données de don/destination utilisées pas (`<katakana-i105-account-id>`, `<katakana-i105-account-id>`).
