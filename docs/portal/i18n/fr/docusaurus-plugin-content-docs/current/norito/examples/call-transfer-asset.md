...
- Approvisionnez l'autorité du contrat (par exemple `<katakana-i105-account-id>`) avec l'actif qu'elle transférera et accordez-lui le rôle `CanTransfer` ou une permission équivalente.
