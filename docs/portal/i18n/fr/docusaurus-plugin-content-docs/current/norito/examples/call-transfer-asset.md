...
- Vérifiez les soldes via `FindAccountAssets` ou `iroha_cli ledger assets list --account bob@wonderland` et inspectez les événements pour confirmer que le garde de métadonnées a journalisé le contexte du transfert.
