...
- Assurez-vous que la définition du NFT existe (par exemple `n0#wonderland`) avec les données du propriétaire/récepteur utilisées dans le fragment (`soraカタカナ...`, `soraカタカナ...`).
