...
- URL de Torii qui expose `/v2/sorafs/*` mais un compte/clave privé d'autorité qui peut envoyer des manifestes et des alias.
...
| Nom | Proposé |
| --- | --- |
| `DOCS_SORAFS_TORII_URL` | Hôte Torii qui expose `/v2/sorafs/pin/register`. |
