...
Le flux suppose que vous avez le binaire `sorafs_cli` (built from the `sorafs_orchestrator` Cargo target), accés à
...
- `sorafs_cli` à partir de `cargo run -p sorafs_orchestrator --bin sorafs_cli`.
