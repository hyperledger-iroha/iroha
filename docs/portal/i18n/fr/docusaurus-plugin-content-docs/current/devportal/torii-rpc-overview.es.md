...
2. Ouvrez la page **Essayez-le** sur cette page du panneau `/reference/torii-swagger` et sélectionnez un point de terminaison comme `POST /v1/pipeline/submit`.
