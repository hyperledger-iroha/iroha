...
2. Ouvrez la carte **Try it** sur cette page ou le panneau `/reference/torii-swagger` et sélectionnez un point final comme `POST /v2/pipeline/submit`.
