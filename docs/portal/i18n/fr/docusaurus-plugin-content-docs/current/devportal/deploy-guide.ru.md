...
- L'URL Torii, qui ouvre `/v2/sorafs/*`, et votre clé d'accès/privée, vous permet d'ouvrir les manifestes et les alias.
...
| Nom | Назначение |
| --- | --- |
| `DOCS_SORAFS_TORII_URL` | Hôte Torii et `/v2/sorafs/pin/register`. |
