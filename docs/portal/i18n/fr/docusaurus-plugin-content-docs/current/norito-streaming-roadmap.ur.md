...
lang: fr
direction: ltr
source: docs/portal/docs/norito-streaming-roadmap.ur.md
status: complete
...
---
titre : Norito Streaming روڈ میپ
---

Le backlog et le groupe de travail sur la diffusion audio/vidéo Norito sont en cours de préparation. کرتا ہے۔ اقدار `status.md` کے ساتھ اپ ڈیٹ ہوتی ہیں اور یہاں ان پورٹل صارفین کے لئے شیئر کی جاتی ہیں جو vue conviviale pour les machines
