...
| `sorafs_manifest_builder` | ⚠️ Retraité | Constructeur de forums de soutien manifestes ; utiliser `iroha app sorafs toolkit pack` pour empacotamento CAR/manifest e mantenha `--plan=-` para revalidacao deterministica. |
