...
| `taikai_trm_alias_rotations_total{alias_namespace,alias_name}` | Incrémente à chaque acceptation d’un nouveau TRM par `/v1/da/ingest`; utilisez `rate()` pour valider la cadence de rotation. |
