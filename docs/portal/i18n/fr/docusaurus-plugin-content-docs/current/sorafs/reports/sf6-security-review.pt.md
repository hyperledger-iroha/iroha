...
**Artefacts :**
- Fonte do CLI et tests (`crates/sorafs_orchestrator/src/bin/sorafs_cli.rs`)
...
4. Les journaux capturés font un harnais de parité (`cargo test -p sorafs_orchestrator --test sorafs_cli proof_stream_consumes_ndjson_and_reports_metrics -- --nocapture`).
