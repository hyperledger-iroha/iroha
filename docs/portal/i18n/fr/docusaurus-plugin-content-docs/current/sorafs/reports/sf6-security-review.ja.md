...
**Artefacts :**
- Source CLI et tests (`crates/sorafs_orchestrator/src/bin/sorafs_cli.rs`)
...
- Harness de parité déterministe (`crates/sorafs_orchestrator/tests/sorafs_cli.rs`, [Rapport de parité GA SoraFS Orchestrator](./orchestrator-ga-parity.md))
...
4. Logs capturés du harness de parité (`cargo test -p sorafs_orchestrator --test sorafs_cli proof_stream_consumes_ndjson_and_reports_metrics -- --nocapture`).
