...
| `torii_request_duration_seconds{route="/v2/sns/*"}` | Mesures Torii | SLO по латентности для API обработчиков; utilisé dans le pays depuis `torii_norito_rpc_observability.json`. |
