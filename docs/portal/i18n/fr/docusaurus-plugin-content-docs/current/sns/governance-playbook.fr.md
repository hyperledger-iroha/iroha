...
| `torii_request_duration_seconds{route="/v2/sns/*"}` | Métriques Torii | SLO de latence pour les gestionnaires API ; alimente des tableaux de bord issue de `torii_norito_rpc_observability.json`. |
