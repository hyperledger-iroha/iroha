...
1. Exporter du NDJSON depuis les endpoints admin du relay plus le flux `/v2/soranet/privacy/event|share` de l'orchestrator vers `artifacts/sorafs_privacy/<relay>.ndjson`.
