...
les collectionneurs reenvien observaciones sin incrustar un transporte sur mesure :- `POST /v2/soranet/privacy/event` accepte une charge utile
  ...
  mode du relais.
- `POST /v2/soranet/privacy/share` accepte une charge utile `RecordSoranetPrivacyShareDto`.
...
1. Exporter NDJSON depuis l'administrateur du point de terminaison du relais et le flux
   `/v2/soranet/privacy/event|share` de l'orchestrateur maintenant
