...
- Կիրառեք `data-copy-mode="i105|qr"` կոճակները պատճենելու համար, որպեսզի ճակատային մասերը կարողանան օգտագործել օգտագործման հաշվիչներ
...
3. Փոխակերպեք կանոնական բեռնվածությունը՝ կրկին օգտագործելով `i105.value` կամ `i105`
