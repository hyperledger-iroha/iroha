...
|-------|------------|----------|
| Ռեեստրն ընդունում է կարողությունների կանոնական հայտարարագրեր | Ինտեգրման թեստային վարժություններ `/v2/sorafs/capacity/declare` հավելվածի API-ի միջոցով՝ ստուգելով ստորագրությունների մշակումը, մետատվյալների հավաքագրումը և հանձնումը հանգույցի ռեեստր: | `crates/iroha_torii/src/routing.rs:7654` |
