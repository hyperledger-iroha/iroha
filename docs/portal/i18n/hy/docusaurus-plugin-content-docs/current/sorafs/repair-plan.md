...
| `max_penalty` | 1,000,000,000 | Վերանորոգման սրացումների համար թույլատրելի շեղման առավելագույն տույժ (nano-XOR): |

- Ժամանակացույցի կողմից ստեղծված առաջարկները սահմանվում են `max_penalty`-ով; Աուդիտորական սահմանաչափից բարձր ներկայացումները մերժվում են:
