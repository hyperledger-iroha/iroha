...
|-------|--------|-------|--------------|
| **P0 – Լաբորատոր հավասարություն ** | Q22025 | Rust CLI + Python ծխի հավաքակազմերը աշխատում են `/v2/norito-rpc` CI-ում, JS helper-ը անցնում է միավորի թեստեր, Android-ի կեղծ ամրագոտիները կատարում են կրկնակի փոխադրումներ: | `python/iroha_python/scripts/run_norito_rpc_smoke.sh` և `javascript/iroha_js/test/noritoRpcClient.test.js` կանաչ CI-ում; Android զրահը միացված է `./gradlew test`-ին: |
