...
Միայն JSON երթուղիների համար ներկառուցված «Փորձեք այն» ավազարկղը հաճախ ավելի արագ է. մուտքագրեք ուղին (օրինակ՝ `/v1/accounts/<katakana-i105-account-id>/assets`), ընտրեք HTTP մեթոդը, տեղադրեք JSON մարմինը, երբ անհրաժեշտ է, և սեղմեք **Ուղարկել հարցումը**՝ վերնագրերը, տևողությունը և օգտակար բեռները ստուգելու համար:
