...
lang: ja
direction: ltr
source: docs/portal/i18n/ru/docusaurus-plugin-content-docs/current/sns/registry-schema.md
status: complete
generator: scripts/sync_docs_i18n.py
source_hash: 6b25ccc328ac7c0df40f1afa91f1694cda9167b17b9c2aa0d0114410ad7c1aae
...
| `payment_asset_id` | `AsciiString` | Актив settlement по умолчанию (например `61CtjvNd9T3THAR65GsMVHr82Bjc`). |
...
2. Перегенерация resolver templates (i105 предпочтительно + i105 как второй выбор, text records).
