...
- URL-адрес Torii, который выставляет `/v2/sorafs/*`, чтобы получить конфиденциальную информацию/задать приватность авторизации, чтобы можно было отправить манифесты и псевдонимы.
