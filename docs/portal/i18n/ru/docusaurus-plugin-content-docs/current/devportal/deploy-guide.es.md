...
- URL-адрес Torii, который экспонирует `/v2/sorafs/*`, является приватной учетной записью/клавишой авторизации, которую можно передать манифесту и псевдониму.
...
| --- | --- |
| `DOCS_SORAFS_TORII_URL` | Хост Torii, который экспонирует `/v2/sorafs/pin/register`. |
