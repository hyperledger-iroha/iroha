...
- URL Torii, который предоставляет доступ к `/v2/sorafs/*` плюс доступ к конфиденциальному доступу к авторизации, который может быть полезен.
...
| --- | --- |
| `DOCS_SORAFS_TORII_URL` | Хост Torii, который выставляет `/v2/sorafs/pin/register`. |
