...
lang: he
direction: rtl
source: docs/portal/i18n/ru/docusaurus-plugin-content-docs/current/devportal/deploy-guide.md
status: complete
generator: scripts/sync_docs_i18n.py
source_hash: 89d9c2313836223e0d1e1c05f6e796c8c3e410cc2270d811eb30026030892245
...
- URL Torii, который открывает `/v2/sorafs/*`, плюс учетная запись/приватный ключ, способные отправлять манифесты и алиасы.
...
| Name | Назначение |
| --- | --- |
| `DOCS_SORAFS_TORII_URL` | Torii host с `/v2/sorafs/pin/register`. |
