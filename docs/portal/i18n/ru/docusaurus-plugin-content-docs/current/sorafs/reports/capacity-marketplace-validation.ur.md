...
|-------|------------|----------|
| Декларации о канонической емкости реестра قبول کرتا ہے | API приложения для интеграционного тестирования `/v2/sorafs/capacity/declare` обеспечивает обработку подписей, сбор метаданных, реестр узлов, а также возможность ручной проверки и проверки. | `crates/iroha_torii/src/routing.rs:7654` |
