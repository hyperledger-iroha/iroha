...
|-------|------------|----------|
| Канонические объявления о регистрации | При проверке интеграции `/v2/sorafs/capacity/declare` через API приложения выполните проверку операций удаления, захват метаданных и передачу данных для узла реестра. | `crates/iroha_torii/src/routing.rs:7654` |
