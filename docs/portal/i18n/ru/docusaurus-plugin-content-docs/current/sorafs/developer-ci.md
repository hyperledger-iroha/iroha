...
Эта страница отражает `docs/source/sorafs/developer/ci.md`. Держите обе версии синхронизированными, пока legacy документация не будет выведена из эксплуатации.
:::
