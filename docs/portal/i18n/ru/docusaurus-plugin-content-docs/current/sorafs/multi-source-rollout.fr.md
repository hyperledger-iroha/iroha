...
1. **Подтвердите входы в управление.**
   - Все кандидаты-четверщики публикуют конверты `ProviderAdvertV1` с полезной нагрузкой на пляж и бюджетами потоков. Подтвердите через `/v2/sorafs/providers` и сравните возможности посещаемости.
