...
- **Отключено:** Установите `/v2/sorafs/capacity/state` и `/v2/sorafs/capacity/telemetry`.
...
4. Создайте JSON-файл Torii `/v2/sorafs/capacity/dispute` и сохраните его. Дополнительный файл `dispute_id_hex`; Он был убит в 1990-х годах.
