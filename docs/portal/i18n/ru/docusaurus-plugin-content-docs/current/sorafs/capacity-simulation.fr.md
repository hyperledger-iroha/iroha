...
`run_cli.sh` инкапсуляция `sorafs_manifest_builder capacity` для измерения полезных данных Norito, больших двоичных объектов base64, запрошенных корпусов Torii и резюме JSON для:
