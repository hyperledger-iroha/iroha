...
`run_cli.sh` оборачивает `sorafs_manifest_builder capacity`, чтобы выдать Norito полезные нагрузки, base64-blob, запросы тела Torii и JSON-сводки для:
