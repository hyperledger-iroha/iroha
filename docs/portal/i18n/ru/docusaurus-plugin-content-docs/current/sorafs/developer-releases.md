...
- `MINOR`: Backwards-compatible фичи (новые команды/флаги, новые поля Norito
...
- **Compatibility**: breaking изменения, upgrades политик, минимальные требования к gateway/node.
