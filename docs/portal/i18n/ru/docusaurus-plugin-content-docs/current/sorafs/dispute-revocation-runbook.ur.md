...
- **Обратите внимание:** Используйте снимки `/v2/sorafs/capacity/state` и `/v2/sorafs/capacity/telemetry`. کریں۔
...
4. Создайте файл Torii `/v2/sorafs/capacity/dispute` для просмотра JSON بھیجیں۔ جواب کی قدر `dispute_id_hex` محفوظ کریں؛ یہی بعد کی منسوخی کارروائیوں اور آڈٹ رپورٹس کا اینکر ہے۔
