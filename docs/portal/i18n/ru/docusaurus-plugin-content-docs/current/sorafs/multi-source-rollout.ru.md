...
title: Runbook по мульти-источниковому rollout и чёрному списку провайдеров
sidebar_label: Runbook мульти-источникового rollout
description: Операционный чек-лист для поэтапного мульти-источникового rollout и экстренного занесения провайдеров в чёрный список.
---
