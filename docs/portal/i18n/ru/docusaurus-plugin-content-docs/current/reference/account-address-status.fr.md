...
Используйте функцию восстановления всех канонических октетов + IH58 + кодируйте сжатие и проверяйте, какие коды ошибок стиля Norito соответствуют установочному приспособлению для отрицательных значений.
