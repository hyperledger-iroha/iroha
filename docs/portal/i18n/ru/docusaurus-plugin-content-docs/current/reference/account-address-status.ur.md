...
Использование канонических байтов + I105 + сжатых (`sora`, второй лучший) кодировок. Возможность двустороннего обхода. Возможность устранения отрицательных случаев. Коды ошибок в стиле Norito. کرتا ہے۔
