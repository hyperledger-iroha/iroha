...
- Гарантия, что определенный NFT (например, `n0#wonderland`) существует вместе с данными донора/назначения, используемого без использования (`<i105-account-id>`, `<i105-account-id>`).
