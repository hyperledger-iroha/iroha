...
- Добавлено сообщение (`soraカタカナ...`) Да, это правда.
- Установите флажок `call_transfer_asset` в течение 5 дней с момента запуска `soraカタカナ...`, Он сказал, что хочет, чтобы он сделал это.
- تحقق من الأرصدة عبر `FindAccountAssets` أو `iroha_cli ledger assets list --account soraカタカナ...` وافحص الأحداث لتأكيد حارس Дэнни Сейл Сейлл.
