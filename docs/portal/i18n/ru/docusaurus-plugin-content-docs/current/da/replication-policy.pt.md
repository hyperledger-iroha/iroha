...
todas в качестве материалов `/v2/da/ingest`. Torii повторно заблокировать манифесты с помощью perfil
...
пакет политики сохранения расходящихся средств для `/v2/da/ingest` и проверки
