...
lang: he
direction: rtl
source: docs/portal/i18n/ru/docusaurus-plugin-content-docs/current/da/ingest-plan.md
status: complete
generator: scripts/sync_docs_i18n.py
source_hash: b9fa583640a5537789beb3dd68c508cab721d90ce688389ab9e5b49bf7be78b1
...
- `iroha app da get` добавляет DA-ориентированный alias для multi-source orchestrator,
  ...
  загружает manifest из `/v2/da/manifests/<ticket>`, сохраняет bundle в
