...
source_hash: 20696eb987b900e29649753f05b1491b1fbac1b40e6f951d11c9aa24f6b0c857
...
- `iroha app gov vote --mode zk --referendum-id <id> --proof-b64 <b64> [--owner <katakana-i105-account-id> --nullifier <32-byte-hex> --lock-amount <u128> --lock-duration-blocks <u64> --direction <Aye|Nay|Abstain>]` — lock hints are required when `min_bond_amount > 0`, and any provided hint set must include `owner`, `amount`, and `duration_blocks`.
...
- `iroha app gov vote --mode plain --referendum-id <id> --owner <katakana-i105-account-id> --amount <u128> --duration-blocks <u64> --direction <Aye|Nay|Abstain>`
  - `--owner` accepts canonical Katakana i105 account ids only; account aliases (name@dataspace or name@domain.dataspace) are separate on-chain names and are not accepted here.
