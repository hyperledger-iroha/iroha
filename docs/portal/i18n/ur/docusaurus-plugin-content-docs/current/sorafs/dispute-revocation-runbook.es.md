...
4. درخواست JSON کو گورننس ٹرانزیکشن قطار کے ذریعے Torii `/v2/sorafs/capacity/dispute` پر بھیجیں۔ ردعمل کی قیمت `dispute_id_hex` پر قبضہ کرتا ہے۔ اس کے بعد منسوخ کرنے کے اقدامات اور آڈٹ رپورٹس کو لنگر انداز کرتے ہیں۔
