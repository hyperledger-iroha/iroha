...
درزی ساختہ وائرنگ لیس معاہدہ لائف سائیکل:- `POST /v2/sorafs/deal/usage` `DealUsageReport` ٹیلی میٹری کو قبول کرتا ہے اور واپسی کرتا ہے
...
- `/v2/events/sse` فیڈ Torii سے اب `SorafsGatewayEvent::DealUsage` ریکارڈز منتقل کرتا ہے
