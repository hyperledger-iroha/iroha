...
مستحکم سطح `sorafs_cli` (provided by the `sorafs_orchestrator` crate) میں نمونے SoraFS تیار کرنے کے لئے ضروری ہر قدم کی خاکہ پیش کیا گیا ہے۔ عام ورک فلوز میں سیدھے کودنے کے لئے اس کک بوک کا استعمال کریں۔ آپریشنل سیاق و سباق کے ل it اس کو مینی فیسٹ پائپ لائن اور آرکسٹریٹر رن بوکس کے ساتھ منسلک کریں۔
