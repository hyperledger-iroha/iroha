...
4. گورننس ٹرانزیکشن قطار کے ذریعے Torii `/v2/sorafs/capacity/dispute` پر JSON کی درخواست بھیجیں۔ ردعمل کی قیمت `dispute_id_hex` پر قبضہ ؛ یہ اس کے بعد منسوخی کے طریقہ کار اور آڈٹ رپورٹس کی تصدیق کرتا ہے۔
