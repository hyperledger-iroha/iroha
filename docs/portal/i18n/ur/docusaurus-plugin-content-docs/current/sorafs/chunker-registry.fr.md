...
۔
- ** فراہم کنندہ اشتہارات ** - اشتہاری پے لوڈ میں صلاحیت اور عرف میٹا ڈیٹا شامل ہیں۔ `/v1/sorafs/providers` (جیسے ، صلاحیت کی موجودگی `range`) کے ذریعے کوریج کی توثیق کریں۔
