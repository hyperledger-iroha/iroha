...
- فراہم کنندہ اشتہارات کے پے لوڈ میں `range_capability` ، `stream_budget` شامل ہونا ضروری ہے
  اور `transport_hints`۔ جوابات `/v2/sorafs/providers` اور داخلہ فکسچر کے ذریعے چیک کریں۔
...
## آرکسٹریٹر اور Torii کے ساتھ انضمام- Torii `/v2/sorafs/providers` پارسڈ رینج صلاحیتوں کو میٹا ڈیٹا لوٹاتا ہے
