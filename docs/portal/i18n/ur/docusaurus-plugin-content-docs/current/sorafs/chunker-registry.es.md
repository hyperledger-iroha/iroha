...
۔
- ** فراہم کنندہ اشتہارات ** - اشتہارات پے لوڈ میں صلاحیتیں اور عرفی میٹا ڈیٹا شامل ہیں۔ `/v1/sorafs/providers` (جیسے ، صلاحیت کی موجودگی `range`) کے ذریعے کوریج کی توثیق کرتا ہے۔
