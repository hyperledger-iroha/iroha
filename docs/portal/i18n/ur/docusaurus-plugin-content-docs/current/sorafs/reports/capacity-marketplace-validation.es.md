...
| چیک اپ | توثیق | ثبوت |
| ------- | ------------ | ------------ |
| رجسٹری قابلیت کے اعلانیہ اعلامیے کو قبول کرتی ہے انضمام ٹیسٹ میں API ایپ کے ذریعہ `/v2/sorafs/capacity/declare` کی مشق کی جاتی ہے ، دستخطی انتظام ، میٹا ڈیٹا کیپچر اور نوڈ رجسٹری میں ہینڈ آف کی تصدیق ہوتی ہے۔ | `crates/iroha_torii/src/routing.rs:7654` |
