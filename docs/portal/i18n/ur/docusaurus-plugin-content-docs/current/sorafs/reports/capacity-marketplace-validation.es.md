...
آپریٹرز کو `sorafs_manifest_builder capacity {declaration,dispute}` کے ساتھ جہاز پر سوار/تنازعہ کی درخواست پے لوڈ کو دوبارہ تخلیق کرنا چاہئے اور اس کے نتیجے میں JSON/Norito بائٹس کو گورننس کے ٹکٹ کے ساتھ محفوظ کرنا چاہئے۔
