...
| چیک | توثیق | ثبوت |
| ------- | ------------ | --------- |
| رجسٹری قابلیت کے اعلانیہ اعلامیے کو قبول کرتی ہے انضمام ٹیسٹ میں API ایپ کے ذریعہ `/v1/sorafs/capacity/declare` کی مشق کی جاتی ہے ، نوڈ رجسٹری میں دستخطی انتظام ، میٹا ڈیٹا کیپچر اور ہینڈ آف کی جانچ پڑتال کی جاتی ہے۔ | `crates/iroha_torii/src/routing.rs:7654` |
