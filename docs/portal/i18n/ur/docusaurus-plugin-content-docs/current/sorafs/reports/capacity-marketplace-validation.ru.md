...
| چیک | توثیق | ثبوت |
| ------- | ----------- | ------------ |
| رجسٹری کیننیکل صلاحیت کے اعلانات کو قبول کرتی ہے انضمام ٹیسٹ `/v2/sorafs/capacity/declare` کو ایپ API کے ذریعے چلتا ہے ، دستخطی پروسیسنگ ، میٹا ڈیٹا کیپچر اور نوڈ کی رجسٹری میں ٹرانسمیشن کی جانچ پڑتال کرتا ہے۔ | `crates/iroha_torii/src/routing.rs:7654` |
