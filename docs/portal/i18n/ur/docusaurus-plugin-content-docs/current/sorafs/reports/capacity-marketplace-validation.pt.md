...
| چیک | توثیق | ثبوت |
| ------- | --------------- | ---------- |
| رجسٹری قابلیت کے اعلانیہ اعلامیے کو قبول کرتی ہے انضمام ٹیسٹ میں API ایپ کے ذریعہ `/v1/sorafs/capacity/declare` کی مشق ہوتی ہے ، دستخطی ہینڈلنگ ، میٹا ڈیٹا کیپچر اور نوڈ رجسٹری میں ہینڈ آف کی جانچ پڑتال کرتی ہے۔ | `crates/iroha_torii/src/routing.rs:7654` |
...
آپریٹرز کو `sorafs_manifest_builder capacity {declaration,dispute}` کے ساتھ جہاز پر سوار/تنازعہ کی درخواست پے لوڈ کو دوبارہ تخلیق کرنا ہوگا اور اس کے نتیجے میں JSON/Norito بائٹس کو گورننس ٹکٹ کے ساتھ محفوظ کرنا ہوگا۔
