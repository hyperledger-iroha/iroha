...
`sorafs_cli` کنسولیڈیٹیڈ سطح (provided by the `sorafs_orchestrator` crate) SoraFS نمونے تیار کرنے کے لئے درکار ہر قدم کا احاطہ کرتا ہے۔ سیدھے عام ورک فلوز تک جانے کے لئے اس کک بوک کا استعمال کریں۔ آپریشنل سیاق و سباق کے ل it اس کو مینی فیسٹ پائپ لائن اور آرکسٹریٹر رن بوکس کے ساتھ جوڑیں۔
