...
- ** ٹیلی میٹری کی تصدیق کریں: ** فراہم کنندہ سے `/v2/sorafs/capacity/state` اور `/v2/sorafs/capacity/telemetry` کے اسنیپ شاٹس پر قبضہ کریں۔
...
4. گورننس ٹرانزیکشن قطار کے ذریعے JSON JSON کو Torii `/v2/sorafs/capacity/dispute` پر بھیجیں۔ ردعمل کی قیمت `dispute_id_hex` پر قبضہ کریں ؛ یہ بعد میں منسوخی کے اقدامات اور آڈٹ رپورٹس کو لنگر انداز کرتا ہے۔
