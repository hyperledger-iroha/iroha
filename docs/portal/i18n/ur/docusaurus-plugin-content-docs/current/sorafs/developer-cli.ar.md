...
یونیفائیڈ `sorafs_cli` ڈیک (provided by the `sorafs_orchestrator` crate) SoraFS نمونے ترتیب دینے کے لئے درکار ہر قدم دکھاتا ہے۔ عام کام کے بہاؤ میں کودنے کے لئے اس کتابچے کا استعمال کریں۔ آپریشنل سیاق و سباق حاصل کرنے کے ل it اس کو مینی فیسٹ پائپ لائن اور آرکسٹریٹر پلے بوکس کے ساتھ جوڑیں۔
