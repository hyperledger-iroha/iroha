...
مخصوص وائرنگ کے بغیر معاہدوں کی زندگی کا چکر:- `POST /v2/sorafs/deal/usage` `DealUsageReport` ٹیلی میٹری کو قبول کرتا ہے اور واپسی کرتا ہے
  ڈٹرمینسٹک اکاؤنٹنگ کے نتائج (`UsageOutcome`)۔
- `POST /v2/sorafs/deal/settle` موجودہ ونڈو کو حتمی شکل دیتا ہے ، اور اسٹریم کرتا ہے
  `DealSettlementRecord` کے نتیجے میں BASE64 انکوڈڈ `DealSettlementV1` ہے
  گورننس ڈی اے جی میں اشاعت کے لئے تیار ہے۔
- Torii کا فیڈ `/v2/events/sse` اب ریکارڈنگ کو نشر کرتا ہے
