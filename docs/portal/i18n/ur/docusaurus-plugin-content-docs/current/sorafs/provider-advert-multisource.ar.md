...
- پے لوڈ میں فراہم کنندہ کے اشتہارات `range_capability` ، `stream_budget` ، اور `transport_hints` شامل ہونا ضروری ہے۔
  `/v2/sorafs/providers` جوابات کے ذریعے چیک کریں اور فکسچر کو قبول کریں۔ شامل ہونا ضروری ہے
...
## فارمیٹر اور Torii کا انضمام- Torii `/v2/sorafs/providers` تجزیہ کردہ رینج پاور ڈیٹا کے ساتھ واپس کرتا ہے
