...
`/v2/pipeline/transactions` پر لین دین۔ مددگار عزم کی لمبائی کی توثیق کرتا ہے ،
...
3. ** آپریٹر گائیڈ کو شائع کریں: ** ریکارڈ شدہ `transition_id` ریکارڈ کریں اور آن/آف ریمپ رن بک کو گردش کریں۔ ونڈو کھلنے کی اونچائی کو جاننے کے لئے بٹوے اور آڈیٹر `/v2/confidential/assets/{id}/transitions` کو سبسکرائب کرتے ہیں۔
