...
- ** پائپ لائن/ایس ایس ای ٹیسٹ۔ اس فلٹر کے ساتھ `/v2/pipeline/events/transactions` پر دستخط کریں تاکہ یہ ثابت کیا جاسکے کہ بغیر کسی واضح لین کے بھیجے گئے لکھنے والے فال بیک لین ID کے تحت پہنچے۔
