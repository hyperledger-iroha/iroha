...
- Block execution receipts کو lane/dataspace کے حساب سے aggregate کرتا ہے اور انہیں `/v2/sumeragi/status` میں `lane_settlement_commitments` کے ذریعے شائع کرتا ہے۔ totals میں `total_local_micro`, `total_xor_due_micro`, اور `total_xor_after_haircut_micro` شامل ہوتے ہیں جو block پر جمع کر کے nightly reconciliation exports کے لئے فراہم ہوتے ہیں۔
