...
- ** پائپ لائن/ایس ایس ای ٹیسٹ۔ اس شرط کے ساتھ `/v1/pipeline/events/transactions` کو سبسکرائب کریں تاکہ یہ ثابت کیا جاسکے کہ بغیر کسی واضح لین کے لکھنے والے لکھنے والے فال بیک لین ID کے تحت پہنچے۔
