...
- ** پائپ لائن/ایس ایس ای ٹیسٹ۔ اس فلٹر کے ساتھ `/v2/pipeline/events/transactions` کو سبسکرائب کریں تاکہ یہ ظاہر کیا جاسکے کہ بغیر کسی واضح لین کے فال بیک لین ID کے تحت بھیجے گئے لکھتے ہیں۔
