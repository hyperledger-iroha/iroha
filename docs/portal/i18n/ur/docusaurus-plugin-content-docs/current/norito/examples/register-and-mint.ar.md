...
- اس بات کو یقینی بنائیں کہ ہر SDK ہاٹ اسٹارٹ میں سیٹ اپ مرحلے کی عکاسی کرنے کے لئے منزل مقصود اکاؤنٹ (جیسے `soraカタカナ...`) موجود ہے۔
...
- کامیاب ٹکسال کی تصدیق کے ل I `client.request(FindAccountAssets)` یا `iroha_cli ledger assets list --account soraカタカナ...` کے ذریعے بیلنس چیک کریں۔
