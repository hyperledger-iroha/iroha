...
- اس بات کو یقینی بنائیں کہ ہدف اکاؤنٹ موجود ہے (مثال کے طور پر `<i105-account-id>`) ، ہر SDK کوئیک اسٹارٹ میں ترتیب کے مرحلے کی عکاسی کرتا ہے۔
...
- اس بات کی تصدیق کے لئے `client.request(FindAccountAssets)` یا `iroha_cli ledger assets list --account <i105-account-id>` کا استعمال کرتے ہوئے بیلنس چیک کریں۔
