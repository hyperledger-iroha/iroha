...
- کسی معاہدے کے اتھارٹی (جیسے `i105...`) کو اثاثہ کے ساتھ تقویت بخشیں وہ اتھارٹی کو `CanTransfer` یا مساوی اجازت کی منتقلی اور جاری کرے گی۔
- کال انٹری پوائنٹ `call_transfer_asset` کو معاہدہ اکاؤنٹ سے 5 یونٹوں کو `i105...` میں منتقل کرنے کے لئے ، اس بات کی عکاسی کرتی ہے کہ آن چین آٹومیشن میزبان کالوں کو کیسے لپیٹ سکتا ہے۔
- `FindAccountAssets` یا `iroha_cli ledger assets list --account i105...` کے ذریعے بیلنس چیک کریں اور اس بات کی تصدیق کے ل investims واقعات کا جائزہ لیں کہ میٹا ڈیٹا گارڈ نے منتقلی کا سیاق و سباق ریکارڈ کیا ہے۔
