...
- اس بات کو یقینی بنائیں کہ NFT کی تعریف موجود ہے (مثال کے طور پر `n0#wonderland`) کے ساتھ ساتھ شارڈ (`soraカタカナ...` ، `soraカタカナ...`) میں استعمال ہونے والے مالک/وصول کنندہ اکاؤنٹس کے ساتھ۔
