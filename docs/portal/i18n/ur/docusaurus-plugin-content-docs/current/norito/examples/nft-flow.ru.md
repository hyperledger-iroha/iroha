...
- اس بات کو یقینی بنائیں کہ این ایف ٹی تعریف (مثال کے طور پر `n0#wonderland`) اسنیپٹ (`soraカタカナ...` ، `soraカタカナ...`) میں استعمال ہونے والے مالک/وصول کنندہ اکاؤنٹس کے ساتھ موجود ہے۔
