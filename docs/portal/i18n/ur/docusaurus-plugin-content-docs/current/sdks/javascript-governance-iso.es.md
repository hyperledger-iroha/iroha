...
`@iroha/iroha-js` کے ساتھ آئی ایس او 20022 پل بہتا ہے۔ ٹکڑوں کو دوبارہ استعمال کیا جاتا ہے
...
درخواست کرنے سے پہلے مندرجہ ذیل ماحولیاتی متغیرات کو مقرر کریں
...
آئی ایس او پل جب تک کہ حیثیت طے نہیں ہوتی ہے۔ اس کے ساتھ سیٹ کریں:
...
دونوں اسکرپٹس اسٹیٹس کوڈ `1` کے ساتھ باہر نکلیں اگر Torii کبھی بھی ٹرمینل کو اطلاع نہیں دیتا ہے
...
پیدا ہوا `buildPacs009Message` برائے PVP جاری کرنے کیلئے `buildPacs008Message` کو تبدیل کریں
فنڈنگ ​​پے لوڈ۔
...
- `resolveAlias` / `resolveAliasByIndex` ISO برج عرف بائنڈنگز کو بے نقاب کریں
  مفاہمت کے اوزار ادائیگی جاری کرنے سے پہلے اکاؤنٹ کی ملکیت فراہم کرسکتے ہیں۔