...
`@iroha/iroha-js` Torii کے ساتھ بات چیت کرنے کے لئے کیننیکل نوڈ. جے ایس پیکیج ہے۔
...
2. `ToriiClient.buildRbcSampleRequest(session, overrides)` معمولات `{blockHash,height,view}`
