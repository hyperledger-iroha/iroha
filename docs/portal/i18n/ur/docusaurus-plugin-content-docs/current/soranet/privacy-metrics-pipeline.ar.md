...
1. ریلے کے ایڈمن پوائنٹس سے NDJSON برآمد کرنے کے ساتھ ساتھ آرکسٹیٹر کے `/v2/soranet/privacy/event|share` کو `artifacts/sorafs_privacy/<relay>.ndjson` میں اسٹریم `/v2/soranet/privacy/event|share` برآمد کریں۔
