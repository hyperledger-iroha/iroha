...
جمع کرنے والے بیسپوک ٹرانسپورٹ کو سرایت کیے بغیر مشاہدات کو آگے بڑھاتے ہیں:- `POST /v2/soranet/privacy/event` ایک پے لوڈ کو قبول کرتا ہے
  ...
  ریلے وضع۔
- `POST /v2/soranet/privacy/share` ایک پے لوڈ `RecordSoranetPrivacyShareDto` کو قبول کرتا ہے۔
...
1. ریلے اور اسٹریم کے ایڈمن اختتامی نقطہ سے Ndjson برآمد کریں
   `/v2/soranet/privacy/event|share` آرکسٹریٹر سے
