...
1. ریلے ایڈمن اینڈ پوائنٹس کے علاوہ آرکسٹریٹر اسٹریم `/v1/soranet/privacy/event|share` سے `artifacts/sorafs_privacy/<relay>.ndjson` سے NDJSON برآمد کریں۔
