...
- ابان اور آئی ایس او 4217 پابندیوں کو اسی پرت میں نافذ کیا گیا ہے: Pacs.008/Pacs.009 اب بہاؤ
  `InvalidIdentifier` غلطیاں خارج کریں جب مقروض/قرض دہندہ IBANS نے عرفی کو تشکیل دیا یا کب
...
- سی ایل آئی بستی کے مددگار ایک ہی گارڈ ریلوں کا وارث ہیں: پاس
  ...
  `sese.023` XML اسنیپ شاٹ کو خارج کرنے سے پہلے پیش نظارہ آلات کی شناخت کی توثیق کریں۔
...
- ریٹرن فکسچر اب `ChrgBr` کو معمول پر لائیں (`DEBT`/`CRED`/`SHAR`/`SLEV`) اور پریپریٹری ریٹرن وجوہات کو `TxInf[*]/RtrdRsn/Prtry` کے ذریعہ بے نقاب کیا گیا ہے۔
