...
یہ پالیسی شناخت کنندہ کی ترجیحات ، توثیق کے قواعد ، اور حوالہ کے اعداد و شمار کو پیک کرتی ہے
...
- ** آلہ (`FinInstrmId`) **
  ...
  - فال بیکس:
    - ** CUSIP ** یا `…/OthrId/Id` کے تحت `Tp/Cd` کے ساتھ بیرونی ISO سے سیٹ کریں
      کوڈ کی فہرست (جیسے ، `CUSP`) ؛ لازمی ہونے پر `Issr` میں جاری کرنے والے کو شامل کریں۔ [^iso_mdr]
...
| ** cusip ** | ریجیکس `^[A-Z0-9]{9}$` اور ماڈیولس -10 2 وزن کے ساتھ (حروف کا نقشہ ہندسے) | صرف اس وقت جب آئین دستیاب نہیں ہے۔ انا/CUSIP کراس واک کے ذریعے نقشہ ایک بار کھایا گیا۔ [^cusip] |
...
| ** مائک ** | آئی ایس او 10383 را فائل سے برقرار رکھیں۔ یقینی بنائیں کہ مقامات متحرک ہیں (نہیں `!` ٹرمینیشن پرچم) | اخراج سے پہلے پرچم کو ختم کردیا۔ [^iso_mic] |
...
| ** کرنسی ** | آئی ایس او 4217 3-لیٹر کوڈ ، معمولی اکائیوں کے ذریعہ طے شدہ اسکیل | رقم کو اجازت شدہ اعشاریہ کے لئے گول کرنا ضروری ہے۔ Norito سائیڈ پر نافذ کریں۔ [^iso_4217] |
...
- ریفریش ** بِک ↔ لی ** گلف پبلک ریلیشنز فائلوں سے نقشہ سازی تاکہ پل کرسکیں
...
- ابان اور آئی ایس او 4217 پابندیوں کو اسی پرت میں نافذ کیا گیا ہے: Pacs.008/Pacs.009 اب بہاؤ
  ...
  اقدار کو جلد ہی مسترد کردیا جاتا ہے۔ 【کریٹس/اروہ_ٹوری/ایس آر سی/آئی ایس او 20022_ برج۔
...
- ** اسی دن کے تصفیے کے پائلٹ **: ہندوستان کا ریگولیٹر T0/T+0 تصفیہ میں مرحلہ وار ہے۔ رکھیں
  پائلٹ کے پھیلتے ہی پل کیلنڈرز تازہ کاری کرتے ہیں۔ [^انڈیا_ٹی 0]
...
| `delivery_leg.to` (خریدار / وصول کرنے والی پارٹی) | `RcvgSttlmPties/Pty/Bic` | شرکاء کو حاصل کرنے کا BIC
...
| کاؤنٹرپارٹی ایجنٹ کی شناخت `InstgAgt` ، `InstdAgt` | ایجنٹ بھیجنے اور وصول کرنے کا BIC/LEI۔ |
...
غیر سکیورٹیز کریڈٹ ٹرانسفر جاری کرتے وقت درست آئی ایس او کوڈ ، لیکن غلط
...
| کولیٹرل متبادل TX شناخت کنندہ | `TxId` | متبادل کے ذریعہ تیار کردہ |
...
- لکس سی ایس ڈی/کلیئر اسٹریم آئی ایس او 20022 تصفیے کی مثالوں میں `SttlmTpAndAddtlParams/SctiesMvmntTp` (`DELI`/`RECE`) اور `Pmt` (Norito/`FREE`). (`FREE`)۔
...
#### مطلوبہ اعتراف / حیثیت
- ٹرانسپورٹ کی سطح: گیٹ وے `admi.007` خارج کرسکتے ہیں یا بزنس پروسیسنگ سے پہلے مسترد کرسکتے ہیں۔  
