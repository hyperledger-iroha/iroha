...
ایکسپلورر کو لازمی طور پر پورٹ فولیوز میں ایک ہی پیمائش اور دستیابی کے کام کی عکاسی کرنا ہوگی:- بٹنوں کاپی کرنے کے لئے `data-copy-mode="i105|qr"` کا اطلاق کریں تاکہ انٹرفیس کرسکیں
...
3. `i105.value` فیلڈز کو دوبارہ استعمال کرکے قانونی پے لوڈ کو تبدیل کریں۔
