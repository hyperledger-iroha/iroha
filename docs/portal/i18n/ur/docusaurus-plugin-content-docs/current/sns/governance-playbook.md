...
| Address UX guide | [`address-display-guidelines.md`](./address-display-guidelines.md) | کینونیکل IH58 (ترجیحی) / compressed (`sora`, second-best) renderings جو wallets/explorers میں جھلکتے ہیں۔ |
