...
| `payment_asset_id` | `AsciiString` | پہلے سے طے شدہ تصفیہ اثاثہ شناخت کنندہ (جیسے `xor#sora`)۔ |
...
2. حل کرنے والے ٹیمپلیٹس کو دوبارہ تخلیق کریں (IH58 ایڈریس ترجیحی + کمپریسڈ (`sora`) دوسری پسند ، متن کے ریکارڈ)۔
