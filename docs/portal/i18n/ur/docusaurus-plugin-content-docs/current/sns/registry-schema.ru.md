...
| `payment_asset_id` | `AsciiString` | پہلے سے طے شدہ تصفیہ اثاثہ (مثال کے طور پر `xor#sora`)۔ |
...
2. حل کرنے والے ٹیمپلیٹس کی تخلیق نو (IH58 ترجیحی طور پر + کمپریسڈ (`sora`) دوسرے انتخاب کے طور پر ، متن کے ریکارڈ)۔
