...
درخواستیں `/v1/da/ingest`۔ Torii نافذ شدہ فائل اور ریلیز کے ساتھ ظاہر ہوتا ہے
...
پیکیج `/v1/da/ingest` کو ایک مماثل برقراری کی پالیسی بھیجتا ہے اور اس کی تصدیق کرتا ہے
