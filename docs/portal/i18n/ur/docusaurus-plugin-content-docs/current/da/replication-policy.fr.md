...
تمام گذارشات `/v2/da/ingest` پر۔ Torii کے ساتھ ظاہر ہوتا ہے
...
سویٹ برقرار رکھنے کی پالیسی پیش کرتا ہے جو `/v2/da/ingest` کے ساتھ تعمیل نہیں کرتا ہے اور تصدیق کرتا ہے
