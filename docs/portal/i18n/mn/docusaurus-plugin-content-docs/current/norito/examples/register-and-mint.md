...
- SDK-ийн хурдан эхлүүлэх бүрт тохируулах үе шатыг тусгаж, очих хаяг (жишээ нь, `<katakana-i105-account-id>`) байгаа эсэхийг шалгаарай.
...
- Үлдэгдлийг `client.request(FindAccountAssets)` эсвэл `iroha_cli ledger asset list --account <katakana-i105-account-id>`-ээр шалгана уу.
