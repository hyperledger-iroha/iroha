...
| `max_penalty` | 1,000,000,000 | Засварыг нэмэгдүүлэх (нано-XOR) -д зөвшөөрөгдсөн хамгийн дээд талбарын торгууль. |

- Хуваарьлагчийн үүсгэсэн саналууд нь `max_penalty`-ээр хязгаарлагдсан; дээд хязгаараас дээш аудиторын мэдүүлгийг үгүйсгэдэг.
