...
- **Телеметрийг баталгаажуулах:** үйлчилгээ үзүүлэгчийн хувьд `/v2/sorafs/capacity/state` болон `/v2/sorafs/capacity/telemetry` агшин зуурын зургийг авах.
...
4. JSON хүсэлтийг Torii `/v2/sorafs/capacity/dispute` руу засаглалын гүйлгээний дарааллаар илгээнэ үү. `dispute_id_hex` хариултын утгыг авах; Энэ нь хүчингүй болгох арга хэмжээ болон аудитын тайлангуудыг зангуу болгодог.
