...
- Torii မေးခွန်းများ (`/v2/da/commitments/*`) နှင့် relays များခွင့်ပြုသည့် အထောက်အထားများကို ဖော်ထုတ်ပါ၊
...
|---------|--------|---------|---------|
| `/v2/da/commitments` | `POST` | `DaCommitmentQuery` (လမ်းကြော/အပိုင်း/အစီအစဥ်အလိုက် စစ်ထုတ်ခြင်း) | စုစုပေါင်းရေတွက်မှု၊ ကတိကဝတ်များနှင့် ပိတ်ဆို့ hash ဖြင့် `DaCommitmentPage` ကို ပြန်ပေးသည်။ |
| `/v2/da/commitments/prove` | `POST` | `DaCommitmentProofRequest` (လမ်းကြော + manifest hash သို့မဟုတ် `(epoch, sequence)` tuple)။ | `DaCommitmentProof` (မှတ်တမ်း + Merkle လမ်းကြောင်း + ပိတ်ဆို့ hash) ဖြင့် တုံ့ပြန်သည်။ |
| `/v2/da/commitments/verify` | `POST` | `DaCommitmentProof` | block hash တွက်ချက်မှုကို ပြန်လည်ပြသပြီး ပါဝင်မှုကို အတည်ပြုပေးသည့် နိုင်ငံမဲ့အကူအညီ၊ `iroha_crypto` နှင့် တိုက်ရိုက်ချိတ်ဆက်၍မရသော SDK များမှ အသုံးပြုသည်။ |
