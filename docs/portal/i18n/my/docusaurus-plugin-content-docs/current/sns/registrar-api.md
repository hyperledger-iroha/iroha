...
| လိုအပ်ချက် | Detail |
|-------------|--------|
| ပရိုတိုကောများ | `/v2/sns/*` နှင့် gRPC ဝန်ဆောင်မှု `sns.v1.Registrar` အောက်တွင် အနားယူပါ။ Norito-JSON (`application/json`) နှင့် Norito-RPC binary (`application/x-norito`) ကို လက်ခံပါသည်။ |
...
|----------|--------|---------|-------------|
| `/v2/sns/registrations` | POST | `RegisterNameRequestV1` | အမည်စာရင်းသွင်းပါ သို့မဟုတ် ပြန်လည်ဖွင့်ပါ။ စျေးနှုန်းအဆင့်ကို ဖြေရှင်းပါ၊ ငွေပေးချေမှု/အုပ်ချုပ်မှုဆိုင်ရာ အထောက်အထားများကို အတည်ပြုပေးသည်၊ မှတ်ပုံတင်ခြင်းဆိုင်ရာ ဖြစ်ရပ်များကို ထုတ်လွှတ်ပါသည်။ |
| `/v2/sns/registrations/{selector}/renew` | POST | `RenewNameRequestV1` | သက်တမ်းတိုး။ မူဝါဒမှ ကျေးဇူးတော်/ရွေးနှုတ်မှု ပြတင်းပေါက်များကို တွန်းအားပေးသည်။ |
| `/v2/sns/registrations/{selector}/transfer` | POST | `TransferNameRequestV1` | အုပ်ချုပ်မှုအတည်ပြုချက်များ ပူးတွဲပါရှိပြီး ပိုင်ဆိုင်မှုလွှဲပြောင်းပါ။ |
| `/v2/sns/registrations/{selector}/controllers` | PUT | `UpdateControllersRequestV1` | ထိန်းချုပ်ကိရိယာအစုံကို အစားထိုးပါ။ လက်မှတ်ထိုးထားသော အကောင့်လိပ်စာများကို အတည်ပြုသည်။ |
| `/v2/sns/registrations/{selector}/freeze` | POST | `FreezeNameRequestV1` | အုပ်ထိန်းသူ/ကောင်စီကို ခေတ္တရပ်ဆိုင်းထားသည်။ အုပ်ထိန်းသူလက်မှတ်နှင့် အုပ်ချုပ်မှုဆိုင်ရာစာရွက်စာတမ်းများကို ကိုးကားရန် လိုအပ်သည်။ |
| `/v2/sns/registrations/{selector}/freeze` | ဖျက်ရန် | `GovernanceHookV1` | ပြုပြင်ပြီးနောက် အေးခဲမှုကို ပြန်ဖြုတ်ပါ။ မှတ်တမ်းတင်ထားသော ကောင်စီကို ထပ်လောင်းသေချာစေပါသည်။ |
| `/v2/sns/reserved/{selector}` | POST | `ReservedAssignmentRequestV1` | ဘဏ္ဍာစိုး/ကောင်စီ၏ သီးသန့်အမည်များကို တာဝန်ပေးသည်။ |
| `/v2/sns/policies/{suffix_id}` | GET | — | လက်ရှိ `SuffixPolicyV1` (cacheable) ကို ရယူပါ။ |
| `/v2/sns/registrations/{selector}` | GET | — | လက်ရှိ `NameRecordV1` + ထိရောက်မှုအခြေအနေ (တက်ကြွ၊ ကျေးဇူးတော်၊ စသည်) ကို ပြန်ပေးသည်။ |
...
`--governance-json` တွင် မှန်ကန်သော `GovernanceHookV1` မှတ်တမ်း (အဆိုပြုချက် ID၊ မဲနှိုက်ချက်များ၊ ဘဏ္ဍာစိုး/အုပ်ထိန်းသူလက်မှတ်များ) ပါဝင်ရပါမည်။ ညွှန်ကြားချက်တစ်ခုစီသည် သက်ဆိုင်ရာ `/v2/sns/registrations/{selector}/…` အဆုံးမှတ်ကို ထင်ဟပ်နေစေသောကြောင့် beta အော်ပရေတာများသည် SDKs ခေါ်ဆိုမည့် Torii မျက်နှာပြင်များကို အတိအကျ ပြန်လည်လေ့ကျင့်နိုင်ပါသည်။
...
1. အဆိုပြုချက် id သည် အုပ်ချုပ်မှုစာရင်းဇယား (`/v2/governance/proposals/{id}`) တွင်ရှိပြီး အဆင့်အတန်းမှာ `Approved` ဖြစ်သည်။
...
1. စျေးနှုန်း၊ ကျေးဇူးတော်နှင့် ရနိုင်သောအဆင့်များကို ရယူရန် ဖောက်သည် `/v2/sns/policies/{suffix_id}` ကို မေးမြန်းပါသည်။
...
3. ပြန်လည်ပြင်ဆင်ပြီးနောက်၊ အော်ပရေတာသည် `/v2/sns/registrations/{selector}/freeze` ဖြင့် DELETE `GovernanceHookV1` ပေးပို့သည်။
...
- ငွေပေးချေမှုအထောက်အထားများ Norito လယ်ဂျာဖြတ်ပိုင်းဖြတ်ပိုင်းများကို ပြန်သုံးပါ။ ဘဏ္ဍာတိုက်ဝန်ဆောင်မှုများသည် အထောက်အကူ APIs (`/v2/finance/sns/payments`) ကို ပံ့ပိုးပေးပါသည်။
