...
| `owner` | ဟုတ်တယ် | AccountId string (domainless encoded literal; canonical Katakana i105 only; no `@<domain>` suffix). |
...
- **ထိန်းချုပ်သူများ-** ဆဲလ်အလွတ်များသည် `--default-controllers` ကို ဂုဏ်ပြုပါသည်။ ပြတ်သားစွာဖော်ပြပါ။
  ပိုင်ရှင်မဟုတ်သူများကို လွှဲအပ်သည့်အခါ ထိန်းချုပ်သူစာရင်းများ (ဥပမာ `<katakana-i105-account-id>;<katakana-i105-account-id>`)
  သရုပ်ဆောင်များ။
