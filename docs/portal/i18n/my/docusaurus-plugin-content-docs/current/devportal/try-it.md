...
2. Swagger သို့မဟုတ် RapiDoc တွင် NRPC အဆုံးမှတ်ကို ရှာပါ (ဥပမာ
   `POST /v2/pipeline/submit`) နှင့် **အကြောင်းအရာ-အမျိုးအစား** ရွေးချယ်ကိရိယာသို့ ပြောင်းပါ။
...
(`https://docs.sora.example/proxy/v2/pipeline/submit`) လေ့ကျင့်ခန်းအတူတူပါပဲ။
