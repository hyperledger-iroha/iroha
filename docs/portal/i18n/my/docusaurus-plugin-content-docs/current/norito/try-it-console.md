...
ထည့်သွင်းထားသော JSON သီးသန့်လမ်းကြောင်းများအတွက် Try it sandbox သည် မကြာခဏ ပိုမြန်သည်- လမ်းကြောင်း (ဥပမာ၊ `/v1/accounts/soraカタカナ.../assets`) ကို ရိုက်ထည့်ပါ၊ HTTP နည်းလမ်းကို ရွေးချယ်ပါ၊ လိုအပ်သည့်အခါတွင် JSON စာကိုယ်ကို ကူးထည့်ကာ ခေါင်းစီးများ၊ ကြာချိန်နှင့် ပေးဆောင်မှုများကို စစ်ဆေးရန် **Send Request** ကို နှိပ်ပါ။
