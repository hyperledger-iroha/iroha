...
ခေါင်းစဉ်- Hajimari entrypoint အရိုးစု
ဖော်ပြချက်- အများသူငှာ ဝင်ပေါက်အမှတ်နှင့် ပြည်နယ်လက်ကိုင်တစ်ခုပါရှိသော အနည်းဆုံး Kotodama စာချုပ်။
အရင်းအမြစ်- crates/ivm/docs/examples/01_hajimari.ko
---
...
- node ကိုမထိမီ `info!` မှတ်တမ်းနှင့် ကနဦး syscall ကိုစစ်ဆေးရန် `ivm_run` / `developer_portal_norito_snippets_run` ဖြင့် Smoke-test ။
