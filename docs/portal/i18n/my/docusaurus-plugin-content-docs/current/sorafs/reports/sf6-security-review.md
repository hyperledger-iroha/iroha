...
**ရှေးဟောင်းပစ္စည်း**
- CLI အရင်းအမြစ်နှင့် စမ်းသပ်မှုများ (`crates/sorafs_orchestrator/src/bin/sorafs_cli.rs`)
...
| SF6-SR-03 | လတ် | တင်ပြချက် | `--plan` မရှိတော့သောအခါတွင် ထည့်သွင်းထားသော အတုံးအခဲအစီအစဥ်များကို အတည်မပြုဘဲ CLI က လက်ခံခဲ့သည်။ | ယခု `sorafs_cli manifest submit` သည် `--expect-plan-digest` ကို ပံ့ပိုးမပေးပါက CAR အချေအတင်များကို ပြန်လည်တွက်ချက်ပြီး နှိုင်းယှဉ်ပြီး ကိုက်ညီမှုမရှိပါက ငြင်းဆိုကာ ပြန်လည်ပြင်ဆင်ခြင်းဆိုင်ရာ အရိပ်အမြွက်များကို ဖြည့်စွက်ထားပါသည်။ စမ်းသပ်မှုများသည် အောင်မြင်မှု/ကျရှုံးမှုများ (`crates/sorafs_orchestrator/tests/sorafs_cli.rs`) အကျုံးဝင်သည်။ |
...
4. တူညီသောကြိုးကြိုး (`cargo test -p sorafs_orchestrator --test sorafs_cli proof_stream_consumes_ndjson_and_reports_metrics -- --nocapture`) မှဖမ်းယူထားသောမှတ်တမ်းများ။
