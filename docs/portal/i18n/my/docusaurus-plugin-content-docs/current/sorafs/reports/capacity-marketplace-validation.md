...
|---------|------------------|----------|
| Registry သည် canonical စွမ်းရည်ကြေငြာချက်များကိုလက်ခံသည် | ပေါင်းစပ်စမ်းသပ်မှုလေ့ကျင့်ခန်း `/v2/sorafs/capacity/declare` ကို အက်ပ် API မှတစ်ဆင့်၊ လက်မှတ်ကိုင်တွယ်ခြင်း၊ မက်တာဒေတာဖမ်းယူခြင်းနှင့် node မှတ်ပုံတင်ခြင်းသို့ လက်လွှဲခြင်းတို့ကို စစ်ဆေးခြင်း။ | `crates/iroha_torii/src/routing.rs:7654` |
