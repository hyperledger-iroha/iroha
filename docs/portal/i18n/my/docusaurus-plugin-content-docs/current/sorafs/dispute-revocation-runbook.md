...
- ** တယ်လီမီတာကို အတည်ပြုပါ-** ပံ့ပိုးပေးသူအတွက် `/v2/sorafs/capacity/state` နှင့် `/v2/sorafs/capacity/telemetry` လျှပ်တစ်ပြက်ရိုက်ချက်များ။
...
4. တောင်းဆိုချက် JSON ကို Torii `/v2/sorafs/capacity/dispute` သို့ အုပ်ချုပ်မှုငွေပေးငွေယူတန်းစီမှတစ်ဆင့် တင်သွင်းပါ။ `dispute_id_hex` တုံ့ပြန်မှုတန်ဖိုးကို ဖမ်းယူပါ။ ၎င်းသည် နောက်ဆက်တွဲ ရုပ်သိမ်းခြင်းဆိုင်ရာ လုပ်ဆောင်ချက်များနှင့် စာရင်းစစ်အစီရင်ခံစာများကို ကျောက်ချထားသည်။
