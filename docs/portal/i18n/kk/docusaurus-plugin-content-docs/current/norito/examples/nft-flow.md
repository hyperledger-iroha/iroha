...
- NFT анықтамасының (мысалы, `n0#wonderland`) үзіндіде (`<i105-account-id>`, `<i105-account-id>`) пайдаланылған иесі/алушы тіркелгілерімен қатар бар екеніне көз жеткізіңіз.
