...
ለJSON-ብቻ መንገዶች የተከተተው ማጠሪያ ሞክር ብዙ ጊዜ ፈጣን ነው፡ መንገዱን አስገባ (ለምሳሌ፡ `/v1/accounts/<katakana-i105-account-id>/assets`)፣ የኤችቲቲፒ ዘዴን ምረጥ፣ ሲያስፈልግ የJSON አካል ለጥፍ እና ራስጌን፣ የቆይታ ጊዜን እና የሚጫኑ ጭነቶችን በውስጥ መስመር ለመፈተሽ **ጥያቄ ላክ** የሚለውን ተጫን።
