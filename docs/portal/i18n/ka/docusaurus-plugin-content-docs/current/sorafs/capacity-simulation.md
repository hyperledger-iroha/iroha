...
`run_cli.sh` ახვევს `sorafs_manifest_builder capacity`-ს Norito ტვირთამწეობის, base64 blobs, Torii მოთხოვნის ორგანოებისა და JSON შეჯამებების გამოსაცემად:
