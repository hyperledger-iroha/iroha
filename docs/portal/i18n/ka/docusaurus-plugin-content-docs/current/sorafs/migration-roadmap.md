...
| მოლოდინის დროშები | M1 | მილსადენები იძახებენ `sorafs_manifest_builder` გამომავალი შედეგების დამაგრების აშკარა მოლოდინებით: | Docs CI | განახლებული სკრიპტები, რომლებიც მიუთითებენ მოლოდინის დროშებზე (იხილეთ ბრძანების ბლოკი ქვემოთ). |
