...
2. **რეგენერაცია პროვაიდერის ხელსაწყოებით.**
   ...
   - გადამოწმება `/v2/sorafs/providers` და `sorafs_fetch` საშუალებით; გაფრთხილებები უცნობის შესახებ
...
- **შემთხვევის რეაგირება.** თუ `reject` გააფრთხილებს ხანძარს, მოწვეული ინჟინრები:
  1. მიიღეთ შეურაცხმყოფელი რეკლამა Torii აღმოჩენის მეშვეობით (`/v2/sorafs/providers`).
  2. ხელახლა გაუშვით რეკლამის ვალიდაცია პროვაიდერის მილსადენში და შეადარეთ
     `/v2/sorafs/providers` შეცდომის რეპროდუცირებისთვის.
