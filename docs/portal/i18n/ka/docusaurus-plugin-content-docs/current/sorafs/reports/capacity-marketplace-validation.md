...
|-------|------------|----------|
| რეესტრი იღებს კანონიკურ ქმედუნარიანობის დეკლარაციებს | ინტეგრაციის ტესტის სავარჯიშოები `/v2/sorafs/capacity/declare` აპლიკაციის API-ს მეშვეობით, ხელმოწერის დამუშავების, მეტამონაცემების აღების და კვანძების რეესტრში გადაცემის გადამოწმებას. | `crates/iroha_torii/src/routing.rs:7654` |
