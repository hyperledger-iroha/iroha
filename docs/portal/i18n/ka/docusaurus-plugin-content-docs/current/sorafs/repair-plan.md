...
| `max_penalty` | 1 000 000 000 | სარემონტო ესკალაციებისთვის დაშვებული მაქსიმალური დახრილობის ჯარიმა (ნანო-XOR). |

- გრაფიკის მიერ გენერირებული წინადადებები შეზღუდულია `max_penalty`-ით; აუდიტორის წარდგინებები ზღვრულ ზღვრულზე მაღლა უარყოფილია.
