...
|--------|-----------|--------|--------------|--------|------ ---------|-------------------|------------------------|-------- --------------------------------------------------------------- ---|------------------------------------------|---------------|
| `.sora` | `0x0001` | `ih58...` | `ih58...` | აქტიური | `xor#sora` | 500 | 1 – 5 | 30 / 60 | `T0: ^[a-z0-9]{3,}$ → 120 XOR (Vickrey)` | `treasury → ih58...` | `7000 / 3000 / 1000 / 0` | 1 |
| `.nexus` | `0x0002` | `ih58...` | `ih58...` | შეჩერებულია | `xor#sora` | 300 | 1 – 3 | 15 / 30 | `T0: ^[a-z0-9]{4,}$ → 480 XOR (Vickrey)`<br>`T1: ^[a-z]{2}$ → 4000 XOR (Dutch floor 500)` | `treasury → ih58...`, `guardian → ih58...` | `6500 / 2500 / 800 / 200` | 2 |
| `.dao` | `0x0003` | `ih58...` | `ih58...` | გაუქმებულია | `xor#sora` | 0 | 1 – 2 | 30 / 30 | `T0: ^[a-z0-9]{3,}$ → 60 XOR (Vickrey)` | `dao (held for future release)` | `9000 / 1000 / 0 / 0` | 0 |
