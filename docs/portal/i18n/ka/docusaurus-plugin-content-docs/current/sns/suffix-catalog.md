...
| `payment_asset_id` | სიმებიანი | აქტივი გამოიყენება ანგარიშსწორებისთვის (`xor#sora` საწყისი კოჰორტისთვის). |
...
|--------|-----------|--------|--------------|--------|------ ---------|-------------------|------------------------|-------- --------------------------------------------------------------- ---|------------------------------------------|---------------|
| `.sora` | `0x0001` | `i105...` | `i105...` | აქტიური | `xor#sora` | 500 | 1 – 5 | 30 / 60 | `T0: ^[a-z0-9]{3,}$ → 120 XOR (Vickrey)` | `treasury → i105...` | `7000 / 3000 / 1000 / 0` | 1 |
| `.nexus` | `0x0002` | `i105...` | `i105...` | შეჩერებულია | `xor#sora` | 300 | 1 – 3 | 15 / 30 | `T0: ^[a-z0-9]{4,}$ → 480 XOR (Vickrey)`<br>`T1: ^[a-z]{2}$ → 4000 XOR (Dutch floor 500)` | `treasury → i105...`, `guardian → i105...` | `6500 / 2500 / 800 / 200` | 2 |
| `.dao` | `0x0003` | `i105...` | `i105...` | გაუქმებულია | `xor#sora` | 0 | 1 – 2 | 30 / 30 | `T0: ^[a-z0-9]{3,}$ → 60 XOR (Vickrey)` | `dao (held for future release)` | `9000 / 1000 / 0 / 0` | 0 |
...
2. რეგისტრატორის ხელსაწყოები უნდა ასახავდეს `suffix_id`, ვადის ლიმიტებს და ფასებს
   კატალოგიდან, როდესაც მოთხოვნა მოხვდება `/v2/sns/*`.
