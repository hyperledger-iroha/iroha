...
|-------|--------|-------|--------------|
| **P0 – ლაბორატორიული პარიტეტი ** | Q22025 | Rust CLI + Python smoke კომპლექტი მუშაობს `/v2/norito-rpc` CI-ში, JS helper გადის ერთეულის ტესტებს, Android-ის იმიტირებული აღკაზმულობა ახორციელებს ორმაგ ტრანსპორტს. | `python/iroha_python/scripts/run_norito_rpc_smoke.sh` და `javascript/iroha_js/test/noritoRpcClient.test.js` მწვანე CI-ში; Android-ის აღკაზმულობა ჩართულია `./gradlew test`-ში. |
