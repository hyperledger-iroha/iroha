...
- POST `/v1/gov/finalize`
  - მოთხოვნა: { "referendum_id": "r1", "proposal_id": "…64hex", "authority": "ih58...?", "private_key": "...?" }
  ...
  - მოთხოვნა (v1 სტილის DTO):
    {
      ...
      "root_hint": "0x…64hex?",
      "მფლობელი": "ih58...?", // კანონიკური ანგარიშის ID (IH58 ლიტერ.)
      "თანხა": "100?",
  ...
  - მოთხოვნა:
    {
      ...
      "კენჭისყრა": {
        ...
        "მფლობელი": null, // არჩევითი კანონიკური AccountId (IH58 ლიტერ.)
