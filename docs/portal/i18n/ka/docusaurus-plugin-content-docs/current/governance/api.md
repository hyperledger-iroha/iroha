...
- მიიღეთ `/v2/gov/council/current`
  ...
  - შენიშვნები: აბრუნებს შენარჩუნებულ საბჭოს, როდესაც ეს არის; სხვაგვარად გამოიმუშავებს დეტერმინისტულ სანაცვლოდ კონფიგურირებული ფსონის აქტივისა და ზღვრების გამოყენებით (ასახავს VRF სპეციფიკას, სანამ ცოცხალი VRF მტკიცებულებები არ დარჩება ჯაჭვზე).- POST `/v2/gov/council/derive-vrf` (მახასიათებელი: gov_vrf)
...
5. **აუდიტის შედეგები** `/v2/sumeragi/evidence`-ის და `/v2/sumeragi/status`-ის მეშვეობით, რათა უზრუნველყოს მტკიცებულებების მრიცხველი და მმართველობამ მიიღო წაშლა.
...
- გაშვების დრო და CLI ავლენს ეტაპობრივ პარამეტრებს `/v2/sumeragi/params` და `iroha --output-format text ops sumeragi params` მეშვეობით, ასე რომ ოპერატორებს შეუძლიათ დაადასტურონ აქტივაციის სიმაღლეები და ვალიდატორების სია.
