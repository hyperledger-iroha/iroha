...
- NFT tərifinin (məsələn, `n0#wonderland`) fraqmentdə istifadə edilən sahib/alıcı hesabları ilə (`<i105-account-id>`, `<i105-account-id>`) yanaşı mövcud olduğundan əmin olun.
