...
title: Əhəmiyyətli əmanət
description: Dəqiq hədəf məbləğə qədər əlavələri qəbul edən, sonra vəsaiti buraxan və ya geri qaytaran tək ödəyici eskrou.
source: crates/kotodama_lang/src/samples/threshold_escrow.ko
---

Dəqiq hədəf məbləğə qədər əlavələri qəbul edən, sonra vəsaiti buraxan və ya geri qaytaran tək ödəyici eskrou.

## Ledger prospekti

- Əmanət hesabını və rəqəmli aktiv tərifini əvvəlcədən yaradın, sonra müqavilə çağırışlarını təqdim edəcək ödəyici hesabını maliyyələşdirin. Nümunə `open_escrow` zamanı həmin ödəyicini avtomatik olaraq `authority()` ilə bağlayır.
...
[Kotodama mənbəyini endirin](/norito-snippets/threshold-escrow.ko)
