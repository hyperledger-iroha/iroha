...
**Artifaktlar:**
- CLI mənbəyi və testləri (`crates/sorafs_orchestrator/src/bin/sorafs_cli.rs`)
...
- Deterministik paritet qoşqu (`crates/sorafs_orchestrator/tests/sorafs_cli.rs`, [SoraFS Orchestrator GA Parity Report](./orchestrator-ga-parity.md))
...
4. Paritet qoşqundan tutulan qeydlər (`cargo test -p sorafs_orchestrator --test sorafs_cli proof_stream_consumes_ndjson_and_reports_metrics -- --nocapture`).
