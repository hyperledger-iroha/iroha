...
I18NI000000061X, `/v2/assets/definitions`, NFTs, balues, རྒྱུ་དངོས་འཛིན་མཁན་, དང་།
...
`/v2/offline/allowances` གིས་ བརྡ་སྟོན་འབད་མི་ REST ཚགས་མ་ཚུ་ མེ་ལོང་:
...
འཚོལ་ཞིབ་ཀྱི་བརྡ་འཕྲིན་གྱིས་ `/v2/explorer/metrics` དང་ གི་དོན་ལུ་ ཡིག་དཔར་རྐྱབ་མི་གྲོགས་རམ་པ་བྱིནམ་ཨིན།
...
`/v2/connect/ws` URL (`sid`, I18NI000000113X, དང་ ཊོ་ཀེན་ཚད་བཟུང་ཚུ་རྩིས་ཏེ་) ཡར་འཕེལ་ཚུ།
...
`ToriiClient.streamEvents()` རང་བཞིན་གྱིས་ `/v2/events/sse` རང་བཞིན་དང་གཅིག་ཁར་ཨ་སིན་བསྐྱར་ལོག་འབད་མི་ཅིག་སྦེ་ ཕྱིར་བཏོན་འབདཝ་ཨིན།
...
- I18NI000000135X གིས་ ངོས་འདྲ་བ་གཅིག་པ་ལུ་ མེ་ལོང་བཟོཝ་ཨིན།
  `/v2/sumeragi/status/sse` དེ་འབདཝ་ལས་ མོས་མཐུན་གྱི་བརྡ་འཕྲིན་འདི་ སོ་སོ་སྦེ་ མཇུག་བསྡུཝ་ཨིན།
...
1. `getSumeragiRbcSessions()` `/v2/sumeragi/rbc/sessions`, དང་།
...
2. `ToriiClient.buildRbcSampleRequest(session, overrides)` སྤྱིར་བཏང་ང་ཡི་`{blockHash,height,view}`
   ...
   Torii ལུ་ལྷོད་ཡོདཔ།
3. I18NI000000176X POSTs `/v2/sumeragi/rbc/sample` ལུ་ཞུ་བ་འབདཝ་ཨིན།
