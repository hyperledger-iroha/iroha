...
| I18NI0000033X | ཨིན་ | ཐོ་བཀོད་ཀྱི་ཇོ་བདག་གི་དོན་ལུ་ རྩིས་ཐོ་ཨའི་ཌི་ཡིག་རྒྱུན་ (domainless encoded literal; canonical Katakana i105 only; no `@<domain>` suffix)། |
...
- གྲོགས་རམ་འབད་མི་གིས་ ཞུ་བ་རེ་ལུ་ `POST /v1/sns/names` གཅིག་དང་ མངལ་སྟོངམ་བཏོན་མི་ཚུ་ལུ་ བཀོདཔ་ཨིན།
...
- **ཚད་འཛིན་:** ནང་ཐིག་སྟོངམ་གུའི་གུས་ཞབས་ `--default-controllers`. གསལ་སྟོན་
  ཚད་འཛིན་ཐོ་ཡིག་ཚུ་ (དཔེར་ན་ `<katakana-i105-account-id>;<katakana-i105-account-id>`) ཇོ་བདག་མེན་མི་ལུ་སྤྲོད་པའི་སྐབས་ཨིན།
  འཁྲབ་རྩེདཔ་ཚུ།
