...
- NFT ta'rifi (masalan, `n0#wonderland`) parchada ishlatiladigan egasi/oluvchi hisoblari (`<i105-account-id>`, `<i105-account-id>`) bilan birga mavjudligiga ishonch hosil qiling.
