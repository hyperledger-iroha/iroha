...
2. Torii ishga tushirilganda o'qiladigan qabul konvertining katalogini tayyorlang (misol yo'li): `/var/lib/iroha/admission/sorafs`.
...
- Boshqaruv paneli kutilgan taxallus ostida staging provayderini ko'rsatishi va profil faol bo'lgan vaqtda qo'ng'iroq hisoblagichlarini nolda ushlab turishi kerak.
