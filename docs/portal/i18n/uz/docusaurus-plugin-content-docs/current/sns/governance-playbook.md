...
| `torii_request_duration_seconds{route="/v2/sns/*"}` | Torii ko'rsatkichlari | API ishlov beruvchilari uchun kechikish SLO'lari; `torii_norito_rpc_observability.json` dan qurilgan ozuqa asboblar paneli. |
