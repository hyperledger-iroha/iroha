...
- `scripts/address_local_toolkit.sh` ishlab chiqarish uchun `iroha` CLI-ni o'rab oladi:
  ...
  - `normalized.txt` - har bir Lokal domen selektori uchun afzal qilingan i105 / ikkinchi eng yaxshi siqilgan (`sora`) literallari aylantirildi.
...
- i105 o'rniga `i105` chiqishi uchun `--format i105`.
