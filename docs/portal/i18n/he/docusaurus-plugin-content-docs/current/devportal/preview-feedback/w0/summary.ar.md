...
3. **تكافؤ runbook في SoraFS** - طلب sorafs-ops-01 روابط متقاطعة اوضح بين
   `sorafs/orchestrator-ops` ו-`sorafs/multi-source-rollout`. تم فتح مشكلة
   متابعة؛ טבלת W1.
...
| W0-A3 | مشاركة لقطات القياس + حزمة الاستعلامات مع متتبع الحوكمة. | צפיות-01 | مكتمل - الحزمة مرفقة بـ `DOCS-SORA-Preview-W0`. |
...
- لم تقع حوادث او تنبيهات خلال الموجة؛ ‏
...
- משבצת טלפון מדיה וערוץ טלפון בימוי
