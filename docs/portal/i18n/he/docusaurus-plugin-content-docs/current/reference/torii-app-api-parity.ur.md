...
- בעלים: Torii Platform.
- Notes: جواب کی سطح deterministic hex اور backend identifiers نافذ کرتی ہے؛ SDKs اس DTO کو استعمال کرتے ہیں۔### Proof SSE ایونٹس (`GET /v2/events/sse`) — کورڈ
...
### Nexus Connect (`/v2/connect/*`) — צילום (תכונה `connect`)
