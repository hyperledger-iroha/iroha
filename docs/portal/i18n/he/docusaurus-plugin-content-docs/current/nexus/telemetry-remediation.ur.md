...
תיאור: `docs/source/nexus_telemetry_remediation_plan.md`. ہے۔
---
...
2. **الرٹ dry-run۔** ہر الرٹ رول کے ساتھ `dashboards/alerts/tests/*.test.yml` انٹری دی جاتی ہے تاکہ guardrail بدلنے پر CI `promtool test rules` ‏
...
4. **اسکیلشن۔** اگر کوئی guardrail ریہرسل ونڈو کے باہر فائر ہو تو متعلقہ ٹیم اس پلان کے حوالہ תקרית תקרית Nexus תקרית תקרית תקרית תקרית תקרית תקרית. شروع کرتی ہے۔
