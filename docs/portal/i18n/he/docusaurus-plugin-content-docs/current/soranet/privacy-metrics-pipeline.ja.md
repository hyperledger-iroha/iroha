...
1. ייצאו NDJSON מנקודות admin של relay יחד עם הזרם `/v2/soranet/privacy/event|share` של ה-orchestrator אל `artifacts/sorafs_privacy/<relay>.ndjson`.
