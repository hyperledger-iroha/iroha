...
`ExplorerAccountQrSnapshot` משקף את ה‑JSON `/v2/explorer/accounts/{id}/qr`: כולל מזהה חשבון קנוני, literal קנוני I105, מטא‑נתוני prefix/תיקון שגיאות, ממדי QR ו‑SVG inline שניתן להטמיע ישירות.
