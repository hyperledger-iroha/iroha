...
##### `colr.010` / `.011` / `.012` (ניהול בטחונות)
...
- **Torii בליעה** ← שלח רגליים למימון PvP דרך `POST /v1/iso20022/pacs009`; את הגשר
...
### החלפת בטחונות חוזרת → `colr.012`| שדה ריפו / הקשר | נתיב ISO 20022 | הערות |
|------------------------------------------------|--------------------------------|------|
