...
מערכת ההפעלה מפתחת מטענים מחודשים של בקשה ל- onboarding/disputa com `sorafs_manifest_builder capacity {declaration,dispute}` e arquivar os bytes JSON/Norito resultantes Junto ao ticket de governanca.
