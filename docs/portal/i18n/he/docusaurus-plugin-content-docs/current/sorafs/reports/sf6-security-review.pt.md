...
** חפצים:**
- בדיקות Fonte do CLI e (`crates/sorafs_orchestrator/src/bin/sorafs_cli.rs`)
...
- רתמת זוגיות דטרמיניסטית (`crates/sorafs_orchestrator/tests/sorafs_cli.rs`, [SoraFS דו"ח זוגיות של תזמורת GA](./orchestrator-ga-parity.md))
...
4. Logs capturados עושים רתמה זוגית (`cargo test -p sorafs_orchestrator --test sorafs_cli proof_stream_consumes_ndjson_and_reports_metrics -- --nocapture`).
