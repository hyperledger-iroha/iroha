...
| 5 | `node scripts/check_sf1_vectors.mjs` | يبلغ عدم وجود diff بين fixtures TypeScript و Rust JSON. | עוזרת تأكد من parity عبر runtimes (السكربت يديره Tooling WG). |
