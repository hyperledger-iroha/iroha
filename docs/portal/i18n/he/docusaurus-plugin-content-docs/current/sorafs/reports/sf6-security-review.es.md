...
- רתום de paridad determinista (`crates/sorafs_orchestrator/tests/sorafs_cli.rs`, [Reporte de Paridad GA del Orchestrator SoraFS](./orchestrator-ga-parity.md))
