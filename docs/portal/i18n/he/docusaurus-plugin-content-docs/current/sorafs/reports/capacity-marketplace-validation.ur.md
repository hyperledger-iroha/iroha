...
---
כותרת: SoraFS Capacity Marketplace Validation
...
# SoraFS רשימת אימות של Capacity Marketplace

**חלון סקירה:** 2026-03-18 -> 2026-03-24  
**בעלי תוכנית:** צוות אחסון (`@storage-wg`), מועצת ממשל (`@council`), גילדת האוצר (`@treasury`)  
...
### פיוס משרד האוצר| בדוק | אימות | עדות |
|-------|----------------|--------|
...
| Billing dashboards penalties اور accrual telemetry surface کرتے ہیں | Grafana ייבוא ​​צבירת GiB-שעות, מונים שביתה, חלקת בטחונות מלוכדת. | `dashboards/grafana/sorafs_capacity_penalties.json:1` |
...
|--------|------|--------|
| חבילת אישור כניסת ספק | `docs/examples/sorafs_capacity_marketplace_validation/2026-03-24_onboarding_signoff.md` | `8f41a745d8d94710fe81c07839651520429d4abea5729bc00f8f45bbb11daa4c` |
| חבילת אישור ליישוב סכסוכים | `docs/examples/sorafs_capacity_marketplace_validation/2026-03-24_dispute_signoff.md` | `c3ac3999ef52857170fedb83cddbff7733ef5699f8b38aea2e65ae507a6229f7` |
| חבילת אישור פיוס האוצר | `docs/examples/sorafs_capacity_marketplace_validation/2026-03-24_treasury_signoff.md` | `0511aeed1f5607c329428cd49c94d1af51292c85134c10c3330c172b0140e8c6` |
