...
| 5 | `node scripts/check_sf1_vectors.mjs` | TypeScript fixtures اور Rust JSON کے درمیان کوئی diff report نہ کرے۔ | עוזר אופציונלי; runtimes کے درمیان parity یقینی بنائیں (script Tooling WG maintain کرتا ہے)۔ |
