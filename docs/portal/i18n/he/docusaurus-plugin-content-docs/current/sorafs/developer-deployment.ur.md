...
SoraFS דטרמיניזם זרימת עבודה של אריזה جب آپ ٹولنگ کو حقیقی gateways اور storage providers پر rollout کریں تو یہ checklist استعمال کریں۔
...
- `docs/source/sorafs/runbooks/` נתיבי הסלמה טלפוניים:
...
- PDP/PoTR upgrades کو SF-13/SF-14 کے تحت track کریں؛ جب یہ proofs stabilize ہوں تو CLI اور docs deadlines اور tier selection surface کریں گے۔הערות פריסה והתחלה מהירה או מתכוני סי.אי.פי. מתכוני CI . سکتی ہیں۔