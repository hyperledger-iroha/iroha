...
|------|----------------|-------|
| إضافة معالجات Torii لـ `/v2/sorafs/capacity/declare` و`/v2/sorafs/capacity/telemetry` و`/v2/sorafs/capacity/orders` بحمولات Norito JSON. | צוות Torii | محاكاة منطق التحقق؛ إعادة استخدام Norito JSON helpers. |
