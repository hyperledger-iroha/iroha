...
על-שרשרת מכשירי רשת ותקשורת. يشرح هذا الدليل
...
- **اين ذهب `signer.json`؟**  
  تمت ازالته. اسناد التوقيعات بالكامل على السلسلة؛ `manifest_signatures.json` ב
  المستودع مجرد fixture للمطورين يجب ان يطابق حدث الموافقة الاخير.

- **هل ما زلنا نحتاج تواقيع Ed25519 محلية؟**  
  לא. موافقات البرلمان محفوظة كـ artefacts على السلسلة. fixtures المحلية موجودة
