...
| `/v1/sns/registrations/{selector}` | קבל | -- | Devuelve `NameRecordV1` בפועל + אפקטיבי (Active, Grace וכו'). |**קוד הבורר:** מקטע `{selector}` מאפיין I105, קומפרימי או משושה קנוני מדגם ADDR-5; Torii נורמל דרך `NameSelectorV1`.
