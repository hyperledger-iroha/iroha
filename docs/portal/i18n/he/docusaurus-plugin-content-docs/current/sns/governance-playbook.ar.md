...
| تذكرة guardian | مجلس guardian | `sns governance freeze --selector <IH58> --reason <text> --until <ts>` יין `GuardianFreezeTicketV1`. خزّن JSON التذكرة تحت `artifacts/sns/guardian/<id>.json`. | <=30 דקות ACK, <=2 שעות זמן. |
