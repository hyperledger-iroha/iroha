...
- Asegúrate de que exista la definición del NFT (for ejemplo `n0#wonderland`) junto con las cuentas de propietario/receptor usadas en el fragmento (`i105...`, `i105...`).
