...
- CLI helper (`iroha_cli da prove-commitment`) は proof の要求/検証フローをラップし、
...
| P2 - Operator tooling | CLI helpers、Grafana dashboard、proof 検証 docs を出荷。 | `iroha_cli da prove-commitment` が devnet で動作し、ダッシュボードが live データを表示。 |
