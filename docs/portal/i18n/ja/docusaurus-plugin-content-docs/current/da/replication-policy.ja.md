...
source_hash: 535cccdbb42adc9b5439ae635c7cdf6c26f89fc95cfcea0542d44a975e4a2c84
...
`/v2/da/ingest` の全送信に適用されます。Torii は強制された retention
...
不一致の retention ポリシーを `/v2/da/ingest` に送って、取得した manifest が
