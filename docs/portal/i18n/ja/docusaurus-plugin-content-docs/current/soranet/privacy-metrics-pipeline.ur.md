...
1. リレー管理エンドポイントとオーケストレーター `/v1/soranet/privacy/event|share` ストリーム NDJSON エクスポート `artifacts/sorafs_privacy/<relay>.ndjson` セキュリティ
2. 政策予算の補助者:
