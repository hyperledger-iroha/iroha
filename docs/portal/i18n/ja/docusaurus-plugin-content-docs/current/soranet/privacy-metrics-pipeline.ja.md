...
1. relay 管理エンドポイントと orchestrator の `/v2/soranet/privacy/event|share` ストリームから NDJSON をエクスポートし、`artifacts/sorafs_privacy/<relay>.ndjson` に保存します。
2. ポリシー予算でヘルパーを実行します:
