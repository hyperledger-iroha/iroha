...
1. NDJSON と管理エンドポイント リレーとオーケストレーター `/v1/soranet/privacy/event|share` と `artifacts/sorafs_privacy/<relay>.ndjson` を組み合わせます。
2. 必要な情報:
