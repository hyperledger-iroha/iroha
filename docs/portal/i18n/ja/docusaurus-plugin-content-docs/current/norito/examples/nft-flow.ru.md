...
- Убедитесь、что определение NFT (например `n0#wonderland`) существует вместе с аккаунтами владельца/получателя, (`<katakana-i105-account-id>`、`<katakana-i105-account-id>`) を参照してください。
