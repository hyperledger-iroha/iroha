...
下記のイベントは `artifacts/docs_portal_preview/feedback_log.json` に反映され、
`preview-20260218-summary.json` / `preview-20260218-digest.md` に要約されます。

| タイムスタンプ (UTC) | イベント | 受信者 | メモ |
| --- | --- | --- | --- |
| 2026-02-18 14:00 | invite-sent | finance-beta-01 | 金融パイロットコホート |
...
| 2026-02-18 14:05 | invite-sent | observability-ops-02 | 観測準備 |
...
| 2026-02-18 14:10 | invite-sent | partner-sdk-03 | SDK パートナー波 |
...
| 2026-02-18 14:15 | invite-sent | ecosystem-advocate-04 | エコシステムアドボケイト |
...
このログを更新する際は `npm run --prefix docs/portal preview:wave -- --wave preview-20260218 --invite-start 2026-02-18 --invite-end 2026-02-28 --report-date 2026-03-01`
を使って digest とポータルデータを再生成してください。
