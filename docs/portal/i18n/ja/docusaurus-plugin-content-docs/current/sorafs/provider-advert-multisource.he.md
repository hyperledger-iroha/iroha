...
source_hash: 6f36c9398551627b7061595591c7982905027f1faca1bfa4625ae91c17058636
source_last_modified: "2025-11-14T04:43:22.128797+00:00"
...
- プロバイダー advert の payload は `range_capability`、`stream_budget`、`transport_hints`
  を含める必要がある。`/v1/sorafs/providers` の応答と admission fixtures で検証し、
...
- Torii `/v1/sorafs/providers` は解析済みレンジ能力メタデータと `stream_budget`、`transport_hints`
