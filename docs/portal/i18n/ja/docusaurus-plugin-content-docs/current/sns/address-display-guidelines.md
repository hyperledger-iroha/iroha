...
| セレクタ種別 | 正規hex |
|---------------|---------------|
| 暗黙のデフォルト | `0x0200000120641297079357229f295938a4b5a333de35069bf47b9d0704e45805713d13c201` |
...
Toriiは現在 `torii.strict_addresses=true` を既定にしています。
...
- `AddressLocal8Resurgence` は、コンテキストが新しいLocal-8増分を報告すると
  ...
  を特定し、必要なら一時的に `torii.strict_addresses=false` を設定して
