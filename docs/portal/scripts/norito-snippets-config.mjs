...
export const SNIPPETS = [
  ...
  },
  {
    ...
    ledgerWalkthrough: [
      'Ensure the destination account (e.g., `ih58...` for Alice) exists, mirroring the setup phase in each SDK quickstart.',
  ...
  },
  {
    ...
    ledgerWalkthrough: [
      'Fund the contract authority (for example `ih58...` for the contract account) with the asset it will transfer and grant the authority the `CanTransfer` role or equivalent permission.',
      'Call the `call_transfer_asset` entrypoint to transfer 5 units from the contract account to Bob (`ih58...`), mirroring the way on-chain automation can wrap host calls.',
  ...
  },
  {
    ...
    ledgerWalkthrough: [
      'Ensure the NFT definition (for example `n0#wonderland`) exists alongside the owner/recipient accounts used in the snippet (`ih58...` for Alice, `ih58...` for Bob).',
