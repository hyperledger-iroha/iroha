...
PROOF
  <1>1. ASSUME QuorumConfiguration,
    ...
    <2>10. /\ prepareVote.signer \in Honest
      ...
      BY <1>1, <2>6, <2>9, SMT
    <2>11. PrepareCarriesHigherSafeQc(prepareVote)
      BY <1>1, <2>6, <2>8 DEF PrepareLineageSound,
                                    VoteBacksCertificate
    <2>12. PICK carried \in prepareQCs:
      ...
      BY <2>10, <2>11 DEF PrepareCarriesHigherSafeQc
    <2>13. /\ carried.context = committed.context
           /\ carried.phase = "Prepare"
           /\ committed.view < carried.view
           /\ carried.view < later.view
           /\ carried.subject = later.subject
