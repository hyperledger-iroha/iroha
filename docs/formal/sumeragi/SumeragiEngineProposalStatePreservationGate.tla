...
(***************************************************************************
A bounded abstract model for proposal unrelated-state preservation.

This slice models the state fields that
`ConsensusEngine::on_proposal(...)` must not touch. Companion models cover the
proposal admission guards, output fields, phase transition, lock/highest-QC
and pending-marker preservation, validation-owner recording, and lock helper.
This model proves that accepted and rejected proposals preserve committed
records, the Prepare-QC replay cache, pending-finality certificate-map entries,
available-payload records, and staged reconfiguration exactly.
***************************************************************************)
...
Cases == {
  "safe_unlocked_clean",
  "safe_unlocked_with_all_state",
  "safe_locked_subject_with_all_state",
  "safe_conflict_higher_qc_with_all_state",
  "wrong_phase_with_all_state",
  "wrong_round_clean",
  "wrong_round_with_all_state",
  "incompatible_highest_with_all_state",
  "locked_conflict_no_qc_with_all_state",
  "locked_conflict_equal_qc_with_all_state",
  "locked_conflict_lower_qc_with_all_state"
}
