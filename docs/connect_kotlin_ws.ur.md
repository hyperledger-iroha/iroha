...
<!-- docs/connect_kotlin_ws.md (Kotlin WS Join with Tokens) کا اردو ترجمہ -->

## Kotlin میں WebSocket جوائن کرنا (Tokens کے ساتھ، OkHttp)
...
### Payload کو seal/open کرنا (ChaCha20‑Poly1305 + AAD)
...
// SignResultOk کو wallet → app، seq=1 پر seal کرنا (صرف payload؛ Norito framing یہاں شامل نہیں)
