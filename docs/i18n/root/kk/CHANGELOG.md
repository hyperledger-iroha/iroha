...
- retired codec белгішесін тастаңыз; `norito::codec` енді жергілікті Norito сериялауымен жүзеге асырылады.
- жәшіктер бойынша `retired_codec` пайдалануларын `norito::codec` арқылы ауыстырыңыз.
- Құралдарды жергілікті Norito сериялауға көшіруді бастаңыз.
- Негізгі Norito сериялау пайдасына жұмыс кеңістігінен қалған `retired codec` тәуелділігін жойыңыз.
- Қалдық retired codec белгілерінің туындыларын жергілікті Norito іске асыруларымен ауыстырыңыз және нұсқаланған кодек модулінің атын өзгертіңіз.
...
- жеке кілттер үшін мультихэш пішімін пайдаланыңыз (#4541)
 - `legacy_codec_decoder` атауын `norito_cli` етіп өзгерту
...
- Ағымдағы пайдаланушылармен қайшылықтарды болдырмау үшін жаңа контейнерге жылжытыңыз.
 - hyperledger#2158 `retired_codec` және басқа тәуелділіктерді жаңарту. (Norito кодегі)
- Құрылымды түзетіңіз.
