...
## [Չթողարկված]- Գցեք retired codec շեմը; `norito::codec`-ն այժմ իրականացվում է բնիկ Norito սերիականացմամբ:
- Փոխարինեք `retired_codec` օգտագործումը `norito::codec`-ով արկղերի միջով:
- Սկսեք գործիքավորումը տեղափոխել բնիկ Norito սերիականացմանը:
- Հեռացրեք `retired codec` մնացած կախվածությունը աշխատանքային տարածքից՝ հօգուտ բնիկ Norito սերիալիզացիայի:
- Փոխարինեք retired codec հատկանիշի մնացորդային ածանցյալները բնիկ Norito իրականացումներով և վերանվանեք տարբերակված կոդեկ մոդուլը:
...
- օգտագործել մուլտիհեշ ձևաչափ մասնավոր բանալիների համար (#4541)
 - վերանվանել `legacy_codec_decoder` դեպի `norito_cli`
...
- Տեղափոխեք նոր կոնտեյներ՝ ընթացիկ օգտատերերի հետ կոնֆլիկտները կանխելու համար:
 - hyperledger#2158 Թարմացնել `retired_codec` և այլ կախվածություններ: (Norito կոդեկ)
