...
ეს ფაილი არის workspace-ის root დონეზე მდებარე შესასვლელი დოკუმენტი IVM-ის არქიტექტურისა და ABI შენიშვნებისთვის.
დეტალური დოკუმენტაცია განთავსებულია `docs/source/` და `crates/ivm/docs/` მისამართებზე.
