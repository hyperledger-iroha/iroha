...
Bu fayl IVM arxitekturasi va ABI izohlari uchun workspace ildizidagi kirish hujjatidir.
Batafsil hujjatlar `docs/source/` va `crates/ivm/docs/` ichida joylashgan.
