...
Түрийвч болон сүлжээнээс гадуурх хэрэгслүүд нь өнөөдөр түүхий `name@dataspace` or `name@domain.dataspace` чиглүүлэлтийн нэр дээр тулгуурладаг. Энэ
...
- Хоёртын удирдлагын ачаалал (`ControllerPayload::Multisig`) кодлодог
  ...
  `AccountAddress::canonical_bytes()` нь canonical Katakana i105 / non-canonical Katakana i105 ачаалалд бичдэг.
...
- Torii болон `name@dataspace` or `name@domain.dataspace` нэрсийн SDK задлан шинжлэл нь canonical Katakana i105 / non-canonical Katakana i105 оролтууд нь өөр нэр буцаахаас өмнө бүтэлгүйтсэн (жишээ нь, домайны бүтцийн алдаа алдагдах), үйлчлүүлэгчийн бүтцийн алдаа алдагдах үед одоо ижил `ERR_*` кодуудыг ялгаруулдаг. зохиолын мөрүүдээс таамаглах.
...
|--------------------------------|--------------------------------|-------------------------|
| `default` домэйн (далд сонгогч, үрийн `0x00`) | `soraゴヂアニィルサフユイサヹピビレッデヹボテハキョメベチュヒャネィギチュヲベァヱェベモネェネツデトツオチハセ` | `sorauﾛ1NﾗhBUd2BﾂｦﾄiﾔﾆﾂﾇKSﾃaﾘﾒﾓQﾗrﾒoﾘﾅnｳﾘbQｳQJﾆLJ5HSE` |
...
хариултууд (`canonical Katakana i105 literal rendering`) болон SDK туслахууд тул UX хуулах/буудах
...
- **Гинжин нэрийн загвар:** Гуалин болон хүний хувьд `ih:<chain-alias>:<name@domain.dataspace>`
...
- **`addr-single-default-ed25519` (Sora Nexus, угтвар `0x02F1`).**  
  I105 `soraゴヂアニィルサフユイサヹピビレッデヹボテハキョメベチュヒャネィギチュヲベァヱェベモネェネツデトツオチハセ`, шахсан (`sora`)
...
4. **Баталгаажуулж, нийтлэх.** Runbook шалгах хуудсыг дагаарай (хэш, Sigstore,
   ...
   багц газардсаны дараа шууд canonical Katakana i105 / non-canonical Katakana i105 литералуудыг каноникчилдаг.
...
- **Дэлгэцийн өгөгдмөл:** Түрийвч нь I105 хаягийг харуулдаг (богино, шалгах нийлбэр)
  ...
  тогтвортой хаяг.
- **Оролтын каноникчилал:** Torii болон SDK нь canonical Katakana i105 / non-canonical Katakana i105/0x-г хүлээн зөвшөөрдөг
  хаягууд дээр нэмэх нь `name@dataspace` or `name@domain.dataspace`, `uaid:…`, болон
...
- `GET /v1/accounts` нь нэмэлт `canonical Katakana i105 rendering` асуулгын параметрийг хүлээн авах ба
  ...
  - `i105` — хариултууд нь зөвхөн Sora-н `i105` шахсан харагдацыг гаргадаг.
...
- Хөрөнгийн эзэмшигчийн жагсаалт (`GET /v1/assets/{definition_id}/holders`) болон тэдгээрийн JSON
  дугтуйны хамтрагч (`POST …/holders/query`) мөн `canonical Katakana i105 rendering` хүндэтгэдэг.
  `items[*].account_id` талбар нь шахагдсан литералуудыг ялгаруулдаг
  Параметр/дугтуйны талбарыг `i105` болгож тохируулсан бөгөөд энэ нь дансуудыг тусгах
