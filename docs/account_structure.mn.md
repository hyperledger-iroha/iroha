...
- Шалгах нийлбэртэй, хүн рүү чиглэсэн **Iroha Base58 хаяг (I105)**
...
- Өгөгдлийн загварт хэрэгжсэн I105 Base58 дугтуйг тайлбарлана уу
...
- **I105 (Iroha Base58)** – гинжийг суулгасан Base58 дугтуй
...
- **Кодчилол:** `encode_i105()` нь угтвар байтыг канониктай холбодог.
  ...
  угтвар `I105PRE` (`b"I105PRE" || prefix || payload`). Үр дүн нь `bs58`-ээр дамжуулан Base58 кодлогдсон байна.
...
- **I105 дугтуй:** Угтвар нь `chain_discriminant`-г компакт ашиглан кодлодог.
  ...
  Blake2b-512(`b"I105PRE"` || угтвар || бие). Бүрэн ачаалал нь Base58-
  `bs58`-ээр кодлогдсон.
...
- `GET /v2/accounts` нь нэмэлт `canonical I105 rendering` асуулгын параметрийг хүлээн авах ба
  `POST /v2/accounts/query` JSON дугтуй доторх ижил талбарыг хүлээн авдаг.
  Дэмжигдсэн утгууд нь:
  - `i105` (өгөгдмөл) — хариултууд нь каноник I105 Base58 ачааллыг ялгаруулдаг (жишээ нь,
...
- Хөрөнгийн эзэмшигчийн жагсаалт (`GET /v2/assets/{definition_id}/holders`) болон тэдгээрийн JSON
...
| `ERR_INVALID_I105_PREFIX_ENCODING` | I105 угтвар байт алдаатай байна. | Тохиромжтой кодлогчоор хаягийг дахин кодлох; тэргүүлэх Base58 байтыг гараар бүү өөрчил. |
