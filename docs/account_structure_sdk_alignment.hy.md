...
2. **Ընդունված մուտքեր.** վերլուծիչները ՊԵՏՔ Է ընդունեն IH58 (նախընտրելի), `sora` սեղմված,
   ...
   `@<domain>` վերջածանց՝ երթուղային ակնարկների համար; `<label>@<domain>` փոխանունները պահանջում են a
   լուծող. Raw `public_key@domain` (multihash hex) շարունակում է աջակցվել:
3. **Վերլուծիչներ.** առանց տիրույթի IH58/sora վերլուծությունը պահանջում է տիրույթի ընտրիչ
