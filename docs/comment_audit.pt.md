...
<!-- Tradução em português de docs/comment_audit.md (Comment Audit Notes) -->

# Notas de Auditoria de Comentários

Foram verificados os seguintes módulos de IVM e confirmado que seus comentários
inline e de documentação refletem o comportamento atual (nenhuma alteração de
código é necessária):
...
Os demais crates do workspace ainda precisam de uma passada semelhante caso
novas atualizações de comentários se tornem necessárias.
