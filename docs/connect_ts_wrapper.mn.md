...
## TypeScript холбогч (WS нэгдэх + жетон)
...
```
// Битүүмжлэх SignResultOk (зөвхөн ачаалал; Norito хүрээг харуулаагүй):
// const signResult = new TextEncoder().encode(JSON.stringify({ SignResultOk: { гарын үсэг: { алгоритм: 'ed25519', signature_hex: 'deadbeef' } } }));
// const { aead } = sealEnvelope хүлээж байна(kWallet, sidBytes, 'W2A', 1n, signResult);