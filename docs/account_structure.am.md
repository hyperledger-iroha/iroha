...
- ቼክ የተጠቃለለ፣ ሰውን የሚያይ **I105 አድራሻ** በ
  `AccountAddress::to_i105` ሰንሰለት አድልዎ ከመለያው ጋር የሚያገናኝ
...
የኪስ ቦርሳዎች እና ከሰንሰለት ውጪ ያሉ መሳሪያዎች ዛሬ በጥሬው `name@dataspace` or `name@domain.dataspace` ማዞሪያ ተለዋጭ ስሞች ላይ ተመስርተዋል። ይህ
ሁለት ዋና ድክመቶች አሉት
...
- በመረጃ ሞዴል ውስጥ የተተገበረውን I105 ኤንቨሎፕ ይግለጹ እና የ
...
(`AccountAddress`) እንደ በርካታ የሰው ፊት ቅርጸቶች ሊወጣ ይችላል። I105 ነው።
...
- **በሶራ የታመቀ እይታ *** - የሶራ-ብቻ ፊደል **105 ምልክቶች** የተገነባው
  ...
  I105 ስብስብ ሕብረቁምፊዎች የሚጀምሩት በሴንቲነል I18NI0000095X ነው፣ከBech32m-የተገኘ
...
`AccountAddress::parse_encoded` I105 (የተመረጠ)፣ የታመቀ (`sora`፣ ሁለተኛ-ምርጥ) ወይም ቀኖናዊ ሄክስን በራስ ሰር ያገኛል
(`0x...` ብቻ፤ ባዶ ሄክስ ውድቅ ነው) ግብአት እና የተፈታውን ክፍያ እና የተገኘውን ሁለቱንም ይመልሳል።
`AccountAddress`. Torii አሁን `parse_encoded` ለ ISO 20022 ማሟያ ይደውላል
...
- የሁለትዮሽ ተቆጣጣሪው ጭነት (`ControllerPayload::Multisig`) ኢንኮዶች
  ...
  `AccountAddress::canonical_bytes()` ለ I105 (የተመረጡ)/ሶራ (ሁለተኛ-ምርጥ) ጭነት ይጽፋል።
- Hashing (`MultisigPolicy::digest_blake2b256()`) Blake2b-256 ከ ጋር ይጠቀማል
  `iroha-ms-policy` ግላዊነት ማላበስ ሕብረቁምፊ ስለዚህ የአስተዳደር መገለጫዎች ከ ሀ
  በI105 ውስጥ ከተካተቱት የመቆጣጠሪያ ባይት ጋር የሚዛመድ የውሳኔ ፖሊሲ መታወቂያ።
- ቋሚ ሽፋን በ `fixtures/account/address_vectors.json` ውስጥ ይኖራል (ጉዳይ
  `addr-multisig-*`)። የኪስ ቦርሳዎች እና ኤስዲኬዎች ቀኖናዊውን I105 ሕብረቁምፊዎች ማረጋገጥ አለባቸው
  ከታች ያሉት መቀየሪያዎቻቸው ከዝገቱ አተገባበር ጋር የሚዛመዱ መሆናቸውን ለማረጋገጥ።

| የጉዳይ መታወቂያ | ገደብ / አባላት | ካኖኒካል I105 (I18NI0000234X) | ማስታወሻ |
|--------|-----------
...
- IME/NFKC ልወጣዎች፡- የግማሽ ስፋት የሶራ ካና ዲኮዲንግ ሳይሰበር ወደ ሙሉ ስፋት ቅፆች ሊስተካከል ይችላል፣ነገር ግን ASCII `sora` sentinel እና I105 አሃዞች/ፊደሎች ASCII መቆየት አለባቸው። ባለሙሉ ስፋት ወይም በኬዝ የታጠፈ ሴንቴልስ ላዩን `ERR_MISSING_COMPRESSED_SENTINEL`፣ ሙሉ ስፋት ASCII የሚጫኑ ጭነቶች `ERR_INVALID_COMPRESSED_CHAR` ከፍ ያደርጋሉ፣ እና የቼክሰም አለመዛመጃዎች እንደ `ERR_CHECKSUM_MISMATCH` ከፍ ይላል። በ`crates/iroha_data_model/src/account/address.rs` ውስጥ ያሉ የንብረት ሙከራዎች እነዚህን መንገዶች ስለሚሸፍኑ ኤስዲኬዎች እና የኪስ ቦርሳዎች በወሳኝ ውድቀቶች ላይ ሊመሰረቱ ይችላሉ።
- Torii እና ኤስዲኬ የ`name@dataspace` or `name@domain.dataspace` ተለዋጭ ስሞችን መፈተሽ አሁን I105 (የተመረጡ)/ሶራ (ሁለተኛ-ምርጥ) ግብዓቶች ከተለዋጭ ስም መመለሻ በፊት (ለምሳሌ) የደንበኛ አወቃቀር አለመመጣጠን ሳይቻል ሲገመት ተመሳሳይ `ERR_*` ኮዶችን ያወጣሉ ከስድ ንባቦች.
...
- ** የአካባቢ ጎራ መፍጨት (`treasury`፣ የዘር ባይት `0x01`)**  
  ...
  መለያየት፡ I18NI0000282X ራስጌ፣ መራጭ መለያ I18NI0000283X ሲደመር መፈጨት `b1 8f e9 c1 ab ba c4 5b 3e 38 fc 5d`፣ በመቀጠል ነጠላ-ቁልፍ ክፍያ (`0x00` መለያ፣ `0x01` ከርቭ መታወቂያ፣00102by Ed25519 ቁልፍ)የዩኒት ፈተናዎች (`account::address::tests::parse_encoded_accepts_all_formats`) ከዚህ በታች ያሉትን የV1 ቬክተሮች በ`AccountAddress::parse_encoded` በኩል ያረጋግጣሉ፣ ይህም የመሳሪያ ስራ በሄክስ፣ I105 (ተመራጭ) እና በተጨመቀ (`sora`፣ ሁለተኛ-ምርጥ) ቅጾች ላይ ባለው ቀኖናዊ ጭነት ላይ እንደሚተማመን ዋስትና ይሰጣል። በ`cargo run -p iroha_data_model --example address_vectors` የተራዘመውን የመገጣጠሚያ ስብስብ እንደገና ያድሱ።
...
`AccountAddress::to_i105` እና `to_i105` ረዳቶች ስለዚህ ይለቃሉ
...
| መለያ / መራጭ | I105 ቀጥተኛ (ቅድመ ቅጥያ `0x02F1`) | Sora I105 በጥሬው |
|-------------------|
| `default` ጎራ (ስውር መራጭ፣ ዘር `0x00`) | `soraゴヂアニィルサフユイサヹピビレッデヹボテハキョメベチュヒャネィギチュヲベァヱェベモネェネツデトツオチハセ` | `sorauﾛ1NﾗhBUd2BﾂｦﾄiﾔﾆﾂﾇKSﾃaﾘﾒﾓQﾗrﾒoﾘﾅnｳﾘbQｳQJﾆLJ5HSE` |
...
ምላሾች (`canonical Katakana i105 literal rendering`)፣ እና ኤስዲኬ አጋዥ፣ ስለዚህ UX ቅዳ/ለጥፍ
ፍሰቶች በቃላቸው ሊተማመኑባቸው ይችላሉ. ግልጽ የሆነ የማዞሪያ ፍንጭ ሲፈልጉ ብቻ `<address>@<domain>` (rejected legacy form) አክል; ቅጥያው የቀኖናዊው ውጤት አካል አይደለም.

#### 2.6 የጽሑፍ ተለዋጭ ስሞች ለተግባራዊነት (የታቀደ)

- ** ሰንሰለት-ተለዋዋጭ ዘይቤ: *** `ih:<chain-alias>:<name@domain.dataspace>` ለሎግ እና ለሰው
  መግቢያ. የኪስ ቦርሳዎች ቅድመ ቅጥያውን መተንተን፣ የተከተተውን ሰንሰለት ማረጋገጥ እና ማገድ አለባቸው
  አለመመጣጠን።
- ** CAIP-10 ቅጽ: ** `iroha:<caip-2-id>:<i105-addr>` ለ ሰንሰለት-አግኖስቲክ
  ውህደቶች. ይህ የካርታ ስራ ** እስካሁን አልተተገበረም *** በተላከው ውስጥ
  የመሳሪያ ሰንሰለቶች.
- ** የማሽን ረዳቶች፡** ለ Rust፣ TypeScript/JavaScript፣ Python፣ ኮዴኮችን ያትሙ
  እና ኮትሊን I105 እና የታመቁ ቅርጸቶችን (`AccountAddress::to_i105`፣
  `AccountAddress::parse_encoded`፣ እና የ SDK አቻዎቻቸው)። CAIP-10 ረዳቶች ናቸው
  ወደፊት ሥራ.

#### 2.7 Deterministic I105 ተለዋጭ ስም

- ** ቅድመ ቅጥያ ካርታ፡** `chain_discriminant` እንደ I105 አውታረ መረብ ቅድመ ቅጥያ እንደገና ይጠቀሙ።
  `encode_i105_prefix()` (`crates/iroha_data_model/src/account/address.rs` ይመልከቱ)
...
- ** የመለያ ቁሳቁስ፡** I105 የተገነባውን ቀኖናዊ የክፍያ ጭነት ያሳያል
  `AccountAddress::canonical_bytes()`—ራስጌ ባይት፣ ጎራ መራጭ እና
  የመቆጣጠሪያ ጭነት. ምንም ተጨማሪ የሃሺንግ እርምጃ የለም; I105 ን ያካትታል
...
** ኢንኮዲንግ:** I18NI0000363X ቅድመ ቅጥያ ባይት ከቀኖናዊው ጋር ያገናኛል
  ...
  ቅድመ ቅጥያ `I105PRE` (`b"I105PRE"` || prefix || payload)። ውጤቱ በ `bs58` በኩል በ I105 ፊደላት ይኮዳል።
  የ CLI/SDK ረዳቶች ተመሳሳይ አሰራርን እና `AccountAddress::parse_encoded` ያጋልጣሉ
  በ `decode_i105` በኩል ይገለበጣል.

#### 2.8 መደበኛ የጽሑፍ ሙከራ ቬክተሮች

`fixtures/account/address_vectors.json` ሙሉ I105 (የተመረጠ) እና የታመቀ (`sora`፣ ሁለተኛ-ምርጥ) ይዟል።
ለእያንዳንዱ ቀኖናዊ ክፍያ። ዋና ዋና ዜናዎች

- **`addr-single-default-ed25519` (ሶራ I18NT0000016X፣ ቅድመ ቅጥያ `0x02F1`)**  
  I105 `soraゴヂアニィルサフユイサヹピビレッデヹボテハキョメベチュヒャネィギチュヲベァヱェベモネェネツデトツオチハセ`፣ የታመቀ (`sora`)
  `sora2QG…U4N5E5`. Torii እነዚህን ትክክለኛ ገመዶች ከ `AccountId` ያወጣል
  `Display` ትግበራ (ቀኖናዊ I105) እና `AccountAddress::to_i105`.
- **`addr-global-registry-002a` (የመዝገብ መራጭ → ግምጃ ቤት)**  
  I105 `3oE9sLeRGP49Cu7mQ1nF4wtKAm29BG4TGLiRsaXe7mhbMP5WZ113nNW1N6RbqF`፣ የታመቀ (`sora`)
  `sorakX…CM6AEP`. የመመዝገቢያ መራጮች አሁንም ኮድ መፍታት እንደሚችሉ ያሳያል
  ተመሳሳይ ቀኖናዊ ጭነት ልክ እንደ ተጓዳኝ የአካባቢያዊ መፍጨት።
- ** የመውደቅ ጉዳይ (`i105-prefix-mismatch`)**  
  በመስቀለኛ መንገድ ላይ ከቅድመ ቅጥያ `NETWORK_PREFIX + 1` ጋር የተቀመጠ I105 በጥሬው በመተንተን ላይ
  ነባሪ ቅድመ ቅጥያ ውጤቶችን በመጠባበቅ ላይ
  `AccountAddressError::UnexpectedNetworkPrefix { expected: 753, found: 754 }`
  የጎራ ማዘዋወር ከመሞከርዎ በፊት። የ `i105-checksum-mismatch` እቃው
  በBlake2b checksum ላይ ፈልጎ ማግኘትን ይለማመዳል።

#### 2.9 ተገዢነት እቃዎች

ADDR-2 አወንታዊ እና አሉታዊ የሚሸፍን ድጋሚ ሊጫወት የሚችል ጥቅል ይልካል
በቀኖናዊ ሄክስ ላይ ያሉ ሁኔታዎች፣ I105 (ተመራጭ)፣ የታመቀ (`sora`፣ ግማሽ/ሙሉ ስፋት)፣ ስውር
...
| አይነት | ዓላማ | አስፈላጊ መስኮች |
|------|---------|-----------------|
| `global_domain` | አንድ ጎራ በአለምአቀፍ ደረጃ እንደተመዘገበ እና በሰንሰለት አድሎአዊ እና I105 ቅድመ ቅጥያ ላይ ካርታ ማድረግ እንዳለበት ያውጃል። | `{ "domain": "<label>", "chain": "sora:nexus:global", "i105_prefix": 753, "selector": "global" }` |
...
`{domain, chain, discriminant/i105_prefix}`. `tombstone` መዝገቦች ** መጠቀስ አለባቸው
...
2. ** ቀኖናዊ የምግብ መፈጨትን ያውጡ።** ሩጫ
   ...
   CLI I105፣ `i105` እና ቀኖናዊ `0x…` ቃል በቃል ይቀበላል። አባሪ
   `@<domain>` ለመገለጥ መለያ ማቆየት ሲፈልጉ ብቻ።
   የJSON ማጠቃለያ በ`input_domain` መስክ በኩል ጎራ አለው፣ እና
   `legacy  suffix` የተለወጠውን ኮድ እንደ `<address>@<domain>` (rejected legacy form) ለ
   ...
   መራጮች ወደ ቀኖናዊ I105 (የተመረጡ)፣ የተጨመቁ (`sora`፣ ሁለተኛ-ምርጥ)፣ ሄክስ፣ ወይም JSON ቅጾች እየዘለሉ
...
4. ** አረጋግጥ እና አትም
   ...
   ከጥቅል መሬቶች በኋላ ወዲያውኑ I105 (ተመራጭ)/ሶራ (ሁለተኛ-ምርጥ) ቃል በቃል ያደርጋል።
...
- ** የማሳያ ነባሪዎች፡** የኪስ ቦርሳዎች የI105 አድራሻን ያሳያሉ (አጭር፣ ቼክ የተጠቃለለ)
  ከመዝገቡ የተገኘ መለያ እና የተፈታው ጎራ። ጎራዎች ናቸው።
  ሊለወጥ የሚችል ገላጭ ሜታዳታ በግልጽ ምልክት ተደርጎበታል፣ I105 ግን የ
  የተረጋጋ አድራሻ.
- ** የግቤት ቀኖናዊነት፡** Torii እና ኤስዲኬዎች I105 (የተመረጡ)/ሶራ (ሁለተኛ-ምርጥ)/0x ይቀበላሉ
  አድራሻዎች ሲደመር `name@dataspace` or `name@domain.dataspace`፣ `uaid:…`፣ እና
  `opaque:…` ቅጾች፣ከዚያም ለውጤት ወደ I105 ቀኖናዊ አድርግ። የለም
  ጥብቅ ሁነታ መቀያየር; ጥሬ ስልክ/ኢሜል መለያዎች ከመዝገቡ ውጭ መቀመጥ አለባቸው
  በ UAID / ግልጽ ያልሆነ ካርታዎች.
- **ስህተት መከላከል፡** የኪስ ቦርሳዎች የI105 ቅድመ ቅጥያዎችን ይተነትኑ እና ሰንሰለትን አድልዎ ያስገድዳሉ
  የሚጠበቁ. የሰንሰለት አለመዛመዶች በድርጊት በሚደረጉ ምርመራዎች ከባድ ውድቀቶችን ያስነሳሉ።
- ** የኮድ ቤተ-ፍርግሞች: *** ኦፊሴላዊ ዝገት ፣ ታይፕ ስክሪፕት / ጃቫ ስክሪፕት ፣ Python እና ኮትሊን
  ቤተ-መጻሕፍት I105 ኢንኮዲንግ/መግለጫ እና የታመቀ (`sora`) ድጋፍ ይሰጣሉ ለ
...
- **ደህንነቱ የተጠበቀ መጋራት ይፈስሳል፡** አድራሻዎችን በነባሪነት ወደ I105 ቅፅ የሚገለብጡ ወይም የሚያሳዩ እና ከጎን ያለውን የ"share" ድርጊት የሚያጋልጡ ሲሆን ይህም ሙሉውን ሕብረቁምፊ እና ከተመሳሳይ ጭነት የተገኘ QR ኮድ ተጠቃሚዎች ቼኩን በምስል ወይም በመቃኘት ማረጋገጥ ይችላሉ። መቆራረጥ ማስቀረት በማይቻልበት ጊዜ (ለምሳሌ፣ ትናንሽ ስክሪኖች)፣ የሕብረቁምፊውን መጀመሪያ እና መጨረሻ ያቆዩት፣ ግልጽ የሆኑ ሞላላዎችን ያክሉ፣ እና በአጋጣሚ መቆራረጥን ለመከላከል ሙሉ አድራሻውን ከቅጂ ወደ ቅንጥብ ሰሌዳው ተደራሽ ያድርጉት።
...
- **የስክሪን አንባቢ ድጋፍ፡** ግንባር ቀደም I105 ቅድመ-ቅጥያ አሃዞችን የሚገልጹ እና የI105 ጭነት ጭነትን በ4- ወይም 8-ቁምፊ ቡድኖች የሚቆርጡ በምስላዊ የተደበቁ መለያዎችን (`aria-label`/I18NI0000475X) ያቅርቡ፣ ስለዚህ አጋዥ ቴክኖሎጂ ከሩጫ ይልቅ የተሰባሰቡ ቁምፊዎችን ያነባል። በትህትና የቀጥታ ስርጭት ክልሎች ስኬትን መቅዳት/ያጋሩ እና የQR ቅድመ-እይታዎች ገላጭ alt ጽሑፍ ("I105 አድራሻ ለ <alias> በሰንሰለት 0x02F1 ላይ") ማካተቱን ያረጋግጡ።
- **የሶራ-ብቻ የተጨመቀ አጠቃቀም፡** ሁልጊዜ የ`i105` የታመቀ እይታን “ሶራ-ብቻ” ብለው ይሰይሙት እና ከመቅዳትዎ በፊት ከግልጽ ማረጋገጫ ጀርባ ያድርጉት። ሰንሰለት አድልዎ የሶራ Nexus እሴት ካልሆነ ኤስዲኬዎች እና የኪስ ቦርሳዎች የታመቀ ውፅዓት ለማሳየት እምቢ ማለት አለባቸው እና ገንዘብ ማዛባትን ለማስቀረት ተጠቃሚዎችን ወደ I105 ኢንተር ኔት ማስተላለፎች መመለስ አለባቸው።

## የትግበራ ማረጋገጫ ዝርዝር

- **I105 ፖስታ:** ቅድመ ቅጥያ `chain_discriminant` ኮምፓክትን በመጠቀም ይደብቃል
  6-/14-ቢት እቅድ ከ`encode_i105_prefix()`፣ አካሉ ቀኖናዊ ባይት ነው
  (`AccountAddress::canonical_bytes()`)፣ እና ቼክሱሙ የመጀመሪያዎቹ ሁለት ባይት ነው።
  የ Blake2b-512(`b"I105PRE"` || ቅድመ ቅጥያ || አካል)። ሙሉ ክፍያው I105- ነው.
  በ `bs58` የተመዘገበ።
- ** የመመዝገቢያ ውል:** የተፈረመ JSON (እና አማራጭ Merkle root) ማተም
  `{discriminant, i105_prefix, chain_alias, endpoints}` በ24h TTL እና
  የማዞሪያ ቁልፎች.
- ** የጎራ ፖሊሲ:** ASCII `Name` ዛሬ; i18n ን ከነቃ፣ UTS-46ን ይተግብሩ
  መደበኛነት እና UTS-39 ግራ ለሚጋቡ ቼኮች። ከፍተኛውን መለያ (63) ያስፈጽሙ እና
  ጠቅላላ (255) ርዝማኔዎች.
- ** የጽሑፍ አጋዥዎች: *** I105 መርከብ ↔ የተጨመቁ (`i105`) ኮዴኮች በዝገት ውስጥ ፣
...
- ** CLI መሳሪያ:** በ`iroha tools address convert` በኩል የሚወስን ኦፕሬተር የስራ ፍሰት ያቅርቡ
  (`crates/iroha_cli/src/address.rs` ይመልከቱ)፣ እሱም I105/`0x…` ቃል በቃል እና ይቀበላል።
  አማራጭ `<address>@<domain>` (rejected legacy form) መለያዎች፣የሶራ Nexus ቅድመ ቅጥያ (`753`) በመጠቀም የI105 ውፅዓት ነባሪዎች
  እና የሶራ-ብቻ የታመቀ ፊደል ኦፕሬተሮች በግልጽ ሲጠይቁት ብቻ ነው የሚያወጣው
  `--format i105` ወይም የJSON ማጠቃለያ ሁነታ። ትዕዛዙ ቅድመ ቅጥያ የሚጠበቁትን ያስፈጽማል
  መተንተን፣ የቀረበውን ጎራ (`input_domain` በJSON) እና የ`legacy  suffix` ባንዲራ ይመዘግባል።
  የተቀየረውን ኢንኮዲንግ እንደ `<address>@<domain>` (rejected legacy form) ይደግማል ስለዚህ አንጸባራቂ ልዩነቶች ergonomic ይቀራሉ።
- ** የኪስ ቦርሳ/አሳሽ UX፡** [የአድራሻ ማሳያ መመሪያዎችን](source/sns/address_display_guidelines.md) ተከተል።
  በADDR-6 ተልኳል—ሁለት ቅጂ አዝራሮችን ያቅርቡ፣ I105ን እንደ QR ክፍያ ያቆዩ እና ያስጠነቅቁ
...
- `GET /v1/accounts` አማራጭ `canonical Katakana i105 rendering` መጠይቅ መለኪያ ይቀበላል እና
  `POST /v1/accounts/query` በJSON ፖስታ ውስጥ ያለውን ተመሳሳይ መስክ ይቀበላል።
  የሚደገፉ እሴቶች የሚከተሉት ናቸው
  - `i105` (ነባሪ) - ምላሾች ቀኖናዊ I105 ጭነትን ያመነጫሉ (ለምሳሌ፣
    `soraゴヂアニィルサフユイサヹピビレッデヹボテハキョメベチュヒャネィギチュヲベァヱェベモネェネツデトツオチハセ`)።
  - `i105` - ምላሾች የሶራ-ብቻ `i105` የታመቀ እይታን ሲያወጡ
...
- ልክ ያልሆኑ እሴቶች `400` (`QueryExecutionFail::Conversion`) ይመለሳሉ። ይህ ይፈቅዳል
  ...
  I105 እንደ መስተጋብር ነባሪ ማቆየት።
- የንብረት ባለቤት ዝርዝሮች (`GET /v1/assets/{definition_id}/holders`) እና የእነሱ JSON
  የኤንቨሎፕ ተጓዳኝ (`POST …/holders/query`) እንዲሁም `canonical Katakana i105 rendering` ያከብራል።
  የ `items[*].account_id` መስክ በማንኛውም ጊዜ የተጨመቁ ቀጥተኛ ቃላትን ያወጣል።
  መለኪያ/የኤንቨሎፕ መስኩ መለያዎቹን በማንጸባረቅ ወደ `i105` ተቀናብሯል
...
| `ERR_INVALID_I105_PREFIX` | የተጠየቀው I105 የአውታረ መረብ ቅድመ ቅጥያ ሊገለበጥ አይችልም። | በሰንሰለት መዝገብ ውስጥ በታተመው `0..=16383` ክልል ውስጥ ቅድመ ቅጥያ ይምረጡ። |
...
| ኮድ | ውድቀት | የሚመከር ማስተካከያ |
|-------|--------|-------------|
| `ERR_INVALID_I105_ENCODING` | I105 ሕብረቁምፊ ከፊደል ውጭ የሆኑ ቁምፊዎችን ይዟል። | አድራሻው የታተመውን I105 ፊደላት መጠቀሙን እና በቅጂ/መለጠፍ ጊዜ እንዳልተቆራረጠ ያረጋግጡ። |
| `ERR_INVALID_LENGTH` | የመጫኛ ርዝመት ለመራጩ/ተቆጣጣሪው ከሚጠበቀው ቀኖናዊ መጠን ጋር አይዛመድም። | ለተመረጠው ጎራ መራጭ እና ተቆጣጣሪ አቀማመጥ ሙሉውን ቀኖናዊ ክፍያ ያቅርቡ። |
| `ERR_CHECKSUM_MISMATCH` | I105 (ተመራጭ) ወይም የተጨመቀ (`sora`፣ ሁለተኛ-ምርጥ) የፍተሻ ክፍያ ማረጋገጥ አልተሳካም። | አድራሻውን ከታመነ ምንጭ ያድሱ; ይህ በተለምዶ የቅጂ/መለጠፍ ስህተትን ያሳያል። |
| `ERR_INVALID_I105_PREFIX_ENCODING` | የI105 ቅድመ ቅጥያ ባይት ተበላሽቷል። | አድራሻውን ከታዛዥ ኢንኮደር ጋር እንደገና መመስጠር; መሪውን I105 ባይት በእጅ አይቀይሩት። |
...
| `ERR_UNSUPPORTED_ADDRESS_FORMAT` | ራስ-ማወቂያ የግቤት ቅርጸቱን ማወቅ አልቻለም። | ተንታኞች በሚጠሩበት ጊዜ I105 (ተመራጭ)፣ የተጨመቁ (`sora`) ወይም ቀኖናዊ `0x` ሄክስ ሕብረቁምፊዎችን ያቅርቡ። |
...
| `ERR_UNEXPECTED_NETWORK_PREFIX` | ዲኮድ የተደረገው የI105 አውታረ መረብ ቅድመ ቅጥያ ከተዋቀረው እሴት ይለያል። | ከዒላማው ሰንሰለት ወደ አድራሻ ይቀይሩ ወይም የሚጠበቀውን አድልዎ/ቅድመ ቅጥያ ያስተካክሉ። |
...
- ** ንጹህ ቤዝ58Check (Bitcoin-style)።
  ከ Blake2b-የተገኘ I105 ቼክ (`encode_i105` ባለ 512-ቢት ሃሽ ይቆርጣል)
...
- **Bech32m ኤንቨሎፕ።** ለQR ተስማሚ እና ለሰው ሊነበብ የሚችል ቅድመ ቅጥያ ያቀርባል፣ነገር ግን
  ከማጓጓዣው I105 ትግበራ (`AccountAddress::to_i105`) ይለያል።
  እና ሁሉንም ቋሚዎች/ኤስዲኬዎች እንደገና መፍጠርን ይጠይቃል። የአሁኑ ፍኖተ ካርታ I105+ን ይጠብቃል።
...
- Kotodama/IVM ኮንትራቶች I105 ረዳቶችን እንዴት እንደሚያገኙ ይግለጹ (`to_address()`፣
  `parse_address()`) እና በሰንሰለት ላይ ያለው ማከማቻ CAIP-10ን ማጋለጥ አለበት ወይ?
  ካርታዎች (ዛሬ I105 ቀኖናዊ ነው)።
- በውጭ መዝገቦች ውስጥ የI18NT0000008X ሰንሰለቶችን መመዝገብ ያስሱ (ለምሳሌ፣ I105 መዝገብ ቤት፣
  CAIP የስም ቦታ ማውጫ) ለሰፊ የስነምህዳር አሰላለፍ።

## ቀጣይ እርምጃዎች

1. I105 ኢንኮዲንግ በ`iroha_data_model` (`AccountAddress::to_i105`፣
