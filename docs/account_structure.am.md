...
- ቼክ የተጠቃለለ፣ ሰውን የሚያይ **Iroha Base58 አድራሻ (I105)** በ
...
የኪስ ቦርሳዎች እና ከሰንሰለት ውጪ ያሉ መሳሪያዎች ዛሬ በጥሬው `alias@domain` (rejected legacy form) ማዞሪያ ተለዋጭ ስሞች ላይ ተመስርተዋል። ይህ
ሁለት ዋና ድክመቶች አሉት
...
- በመረጃ ሞዴል ውስጥ የተተገበረውን I105 Base58 ኤንቨሎፕ ይግለጹ እና የ
...
- ** I105 (Iroha Base58)** - ሰንሰለቱን የሚጨምር Base58 ፖስታ
...
| የጉዳይ መታወቂያ | ገደብ / አባላት | I105 ቀጥተኛ (ቅድመ ቅጥያ I18NI0000234X) | Sora i105-default (I18NI0000235X) በጥሬው | ማስታወሻ |
|--------|-----------
...
- Torii እና ኤስዲኬ የ`address@domain` (rejected legacy form) ተለዋጭ ስሞችን መፈተሽ አሁን I105 (የተመረጡ)/ሶራ (ሁለተኛ-ምርጥ) ግብዓቶች ከተለዋጭ ስም መመለሻ በፊት (ለምሳሌ) የደንበኛ አወቃቀር አለመመጣጠን ሳይቻል ሲገመት ተመሳሳይ `ERR_*` ኮዶችን ያወጣሉ ከስድ ንባቦች.
...
ምላሾች (`canonical I105 literal rendering`)፣ እና ኤስዲኬ አጋዥ፣ ስለዚህ UX ቅዳ/ለጥፍ
...
** ኢንኮዲንግ:** I18NI0000363X ቅድመ ቅጥያ ባይት ከቀኖናዊው ጋር ያገናኛል
  ...
  ቅድመ ቅጥያ `I105PRE` (`b"I105PRE" || prefix || payload`)። ውጤቱ በ `bs58` በኩል Base58-encoded ነው።
...
- **`addr-single-default-ed25519` (ሶራ I18NT0000016X፣ ቅድመ ቅጥያ `0x02F1`)**  
  I105 `6cmzPVPX5jDQFNfiz6KgmVfm1fhoAqjPhoPFn4nx9mBWaFMyUCwq4cw`፣ የታመቀ (`sora`)
...
- ** የግቤት ቀኖናዊነት፡** Torii እና ኤስዲኬዎች I105 (የተመረጡ)/ሶራ (ሁለተኛ-ምርጥ)/0x ይቀበላሉ
  አድራሻዎች ሲደመር `alias@domain` (rejected legacy form)፣ `uaid:…`፣ እና
...
- **የስክሪን አንባቢ ድጋፍ፡** ግንባር ቀደም Base58 ቅድመ-ቅጥያ አሃዞችን የሚገልጹ እና የI105 ጭነት ጭነትን በ4- ወይም 8-ቁምፊ ቡድኖች የሚቆርጡ በምስላዊ የተደበቁ መለያዎችን (`aria-label`/I18NI0000475X) ያቅርቡ፣ ስለዚህ አጋዥ ቴክኖሎጂ ከሩጫ ይልቅ የተሰባሰቡ ቁምፊዎችን ያነባል። በትህትና የቀጥታ ስርጭት ክልሎች ስኬትን መቅዳት/ያጋሩ እና የQR ቅድመ-እይታዎች ገላጭ alt ጽሑፍ ("I105 አድራሻ ለ <alias> በሰንሰለት 0x02F1 ላይ") ማካተቱን ያረጋግጡ።
...
- **I105 ፖስታ:** ቅድመ ቅጥያ `chain_discriminant` ኮምፓክትን በመጠቀም ይደብቃል
  ...
  የ Blake2b-512(`b"I105PRE"` || ቅድመ ቅጥያ || አካል)። ሙሉ ክፍያው Base58- ነው.
  በ `bs58` የተመዘገበ።
...
- `GET /v2/accounts` አማራጭ `canonical I105 rendering` መጠይቅ መለኪያ ይቀበላል እና
  `POST /v2/accounts/query` በJSON ፖስታ ውስጥ ያለውን ተመሳሳይ መስክ ይቀበላል።
  የሚደገፉ እሴቶች የሚከተሉት ናቸው
  - `i105` (ነባሪ) - ምላሾች ቀኖናዊ I105 Base58 ጭነትን ያመነጫሉ (ለምሳሌ፣
    `6cmzPVPX5jDQFNfiz6KgmVfm1fhoAqjPhoPFn4nx9mBWaFMyUCwq4cw`)።
  - `i105_default` - ምላሾች የሶራ-ብቻ `i105` የታመቀ እይታን ሲያወጡ
...
- የንብረት ባለቤት ዝርዝሮች (`GET /v2/assets/{definition_id}/holders`) እና የእነሱ JSON
  የኤንቨሎፕ ተጓዳኝ (`POST …/holders/query`) እንዲሁም `canonical I105 rendering` ያከብራል።
  የ `items[*].account_id` መስክ በማንኛውም ጊዜ የተጨመቁ ቀጥተኛ ቃላትን ያወጣል።
  መለኪያ/የኤንቨሎፕ መስኩ መለያዎቹን በማንጸባረቅ ወደ `i105_default` ተቀናብሯል
...
| `ERR_INVALID_I105_PREFIX_ENCODING` | የI105 ቅድመ ቅጥያ ባይት ተበላሽቷል። | አድራሻውን ከታዛዥ ኢንኮደር ጋር እንደገና መመስጠር; መሪውን Base58 ባይት በእጅ አይቀይሩት። |
