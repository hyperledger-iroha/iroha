...
<!-- الترجمة العربية لـ docs/comment_audit.md (Comment Audit Notes) -->

# ملاحظات تدقيق التعليقات

تم فحص وحدات IVM التالية والتأكد من أن تعليقاتها inline وتعليقات التوثيق
تطابق السلوك الحالي (ولا تتطلب أي تعديلات على الكود):
...
لا تزال بقية الـ crates في الـ workspace بحاجة إلى مرور مماثل إذا دعت الحاجة
لاحقًا إلى تحديثات إضافية في التعليقات.
