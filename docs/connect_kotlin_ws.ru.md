...
<!-- Русский перевод docs/connect_kotlin_ws.md (Kotlin WS Join with Tokens) -->

## Подключение по WebSocket на Kotlin с токенами (OkHttp)
...
### Шифрование/расшифровка payload’ов (ChaCha20‑Poly1305 + AAD)
...
// Шифрование SignResultOk wallet → app при seq=1 (только payload; Norito‑фрейминг не показан)
