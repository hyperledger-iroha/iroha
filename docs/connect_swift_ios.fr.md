...
- `ConnectClient` maintient le transport WebSocket (`/v1/connect/ws?...`) au‑dessus de
...
Notes :
- Calculez `sid` côté client puis faites un POST vers `/v1/connect/session` avec ce `sid`
