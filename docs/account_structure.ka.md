...
`AccountAddress::parse_encoded` ავტომატურად ამოიცნობს IH58 (სასურველია), შეკუმშული (`sora`, მეორე საუკეთესო) ან კანონიკურ ექვსკუთხედს
(მხოლოდ `0x...`; შიშველი ექვსკუთხედი უარყოფილია) შეაქვს და აბრუნებს როგორც დეკოდირებულ დატვირთვას, ასევე აღმოჩენილს
`AccountAddressFormat`. Torii ახლა უწოდებს `parse_encoded`-ს ISO 20022-ის დამატებით
...
- **შეყვანის კანონიკიზაცია:** Torii და SDK-ები მიიღებენ IH58 (სასურველია)/sora (მეორე საუკეთესო)/0x
  მისამართები პლუს `alias@domain`, `uaid:…` და
