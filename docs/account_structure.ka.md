...
- `GET /v2/accounts` იღებს არასავალდებულო `canonical I105 rendering` მოთხოვნის პარამეტრს და
  `POST /v2/accounts/query` იღებს იმავე ველს JSON კონვერტში.
...
- აქტივების მფლობელთა ჩამონათვალი (`GET /v2/assets/{definition_id}/holders`) და მათი JSON
