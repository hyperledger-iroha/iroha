...
|----|-------|-----------------|-----------------|----------------|
| C1 | WebSocket ပြတ်တောက်ပြီး ပြန်လည်ချိတ်ဆက် | `/v2/connect/ws` ကို ပရောက်စီတစ်ခု၏ နောက်ကွယ်တွင် ခြုံပါ (ဥပမာ၊ `kubectl -n demo port-forward svc/torii 18080:8080` + `toxiproxy-cli toxic add ... timeout`) သို့မဟုတ် ဝန်ဆောင်မှုကို ယာယီပိတ်ပါ (`kubectl scale deploy/torii --replicas=0` အတွက် ≤60s)။ ပိုက်ဆံအိတ်ကို ဘောင်များ ဆက်ပို့ရန် အတင်းအကြပ် အော့ဖ်လိုင်း တန်းစီခြင်းများကို ဖြည့်ပါ။ | `connect.reconnects_total` တိုးမှုများ၊ `connect.resume_latency_ms` တိုးသွားသော်လည်း - ပြတ်တောက်မှုဝင်းဒိုးအတွက် ဒက်ရှ်ဘုတ်မှတ်ချက်။- ပြန်လည်ချိတ်ဆက်မှု + ယိုထုတ်သည့်စာတိုများပါသည့် နမူနာမှတ်တမ်း ကောက်နုတ်ချက်။ |
