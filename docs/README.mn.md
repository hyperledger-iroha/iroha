...
Norito нь ажлын талбарын цуваа кодлогч юм. Бид `retired codec` ашигладаггүй
(ХЭМЖЭЭ). Баримт бичиг эсвэл жишиг үзүүлэлтийг retired codec-тай харьцуулсан тохиолдолд энэ нь зөвхөн зориулагдсан
...
үр ашиг - энэ нь Norito, retired codec биш.
...
- Утасны формат нь retired codec биш Norito. `norito::codec::{Encode,Decode}` API-г нүцгэн хувилбарт ашигладаг.