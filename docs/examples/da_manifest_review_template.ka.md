...
# მონაცემთა ხელმისაწვდომობის მანიფესტის მმართველობის პაკეტი (თარგი)

გამოიყენეთ ეს შაბლონი, როდესაც პარლამენტის პანელები განიხილავენ DA მანიფესტებს სუბსიდიებისთვის,
წაშლა ან შეკავების ცვლილებები (საგზაო რუკა DA-10). დააკოპირეთ Markdown-ში
მმართველობის ბილეთი, შეავსეთ ჩანაცვლების ადგილები და დაურთეთ დასრულებული ფაილი
ხელმოწერილი Norito ტვირთამწეობისა და CI არტეფაქტების გვერდით, რომლებიც მითითებულია ქვემოთ.
...
დაარქივეთ ყველა დასრულებული პაკეტი Governance DAG ჩანაწერის ქვეშ ხმის მიცემისთვის
შემდგომ მიმოხილვებს შეუძლია მიუთითოს მანიფესტის დაიჯესტი სრული გამეორების გარეშე
ცერემონია.【docs/source/governance_playbook.md:24】