...
<!-- תרגום עברי ל-docs/examples/android_device_lab_request.md -->

# תבנית בקשת הזמנת מעבדת מכשירי Android

העתיקו את התבנית הזו לתור Jira `_android-device-lab` בעת הזמנת חומרה. צרפו קישורים
ל-pipelines של Buildkite, artefacts תאימות וכל כרטיסי שותפים שתלויים בהרצה.
