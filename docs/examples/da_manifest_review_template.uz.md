...
# Maʼlumotlar mavjudligi manifestini boshqarish paketi (shablon)

Parlament panellari subsidiyalar boʻyicha DA manifestlarini koʻrib chiqqanda ushbu shablondan foydalaning,
olib tashlashlar yoki saqlash o'zgarishlari (DA-10 yo'l xaritasi). Markdown-dan nusxa ko'chiring
boshqaruv chiptasi, to'ldiruvchini to'ldiring va to'ldirilgan faylni ilova qiling
imzolangan Norito foydali yuklari va quyida keltirilgan CI artefaktlari bilan birga.
...
Ovoz berish uchun har bir to'ldirilgan paketni Governance DAG yozuvi ostida arxivlang
keyingi sharhlar to'liq takrorlanmasdan manifest dayjestiga murojaat qilishi mumkin
marosim.【docs/source/governance_playbook.md:24】