...
|-----------|------|---------|-------|
| `<i105...>` | `custodian_ack_<custodian>.md` | `<sha256>` | SLA assinado cobrindo janela de custody, conta de roteamento e contato de drill. |
...
for aplicada, capture snapshots de `/v2/configuration` de cada peer para que os auditors
