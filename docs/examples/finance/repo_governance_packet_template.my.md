...
|-----------|------|---------|-------|
| `<ih58...>` | `custodian_ack_<custodian>.md` | `<sha256>` | အချုပ်အနှောင်ဝင်းဒိုး၊ လမ်းပြအကောင့်နှင့် ဖောက်ထွင်းအဆက်အသွယ်တို့ကို ဖုံးအုပ်ထားသည့် SLA တွင် လက်မှတ်ရေးထိုးထားသည်။ |
