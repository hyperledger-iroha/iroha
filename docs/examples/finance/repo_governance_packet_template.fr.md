...
`iroha repo ... --output`. Chaque entree doit inclure le hash du fichier emis
...
|-----------|------|---------|-------|
| `<custodian@domain>` | `custodian_ack_<custodian>.md` | `<sha256>` | SLA signe couvrant fenetre de custody, compte de routage et contact drill. |
