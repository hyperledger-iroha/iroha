...
# Деректердің қолжетімділігі манифестінің басқару пакеті (үлгі)

Бұл үлгіні парламенттік панельдер субсидияларға қатысты DA манифесттерін қараған кезде пайдаланыңыз,
жоюлар немесе сақтау өзгерістері (DA-10 жол картасы). Markdown файлына көшіріңіз
басқару билетін, толтырғыштарды толтырыңыз және толтырылған файлды тіркеңіз
қол қойылған Norito пайдалы жүктемелерімен және төменде сілтеме жасалған CI артефактілерімен қатар.
...
Дауыс беру үшін Governance DAG жазбасының астындағы әрбір аяқталған пакетті мұрағаттаңыз
кейінгі шолулар толық қайталамай-ақ манифест дайджестіне сілтеме жасай алады
рәсім.【docs/source/governance_playbook.md:24】