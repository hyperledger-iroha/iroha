...
<!-- docs/examples/android_device_lab_request.md کا اردو ترجمہ -->

# Android ڈیوائس لیب ریزرویشن درخواست ٹیمپلیٹ

ہارڈویئر بک کرتے وقت یہ ٹیمپلیٹ Jira کی `_android-device-lab` قطار میں کاپی کریں۔
Buildkite pipelines، compliance artefacts اور وہ پارٹنر ٹکٹس منسلک کریں جو اس run پر منحصر ہوں۔
