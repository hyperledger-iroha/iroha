...
# Android құрылғысының зертханалық резервін сұрау үлгісі

Брондау кезінде осы үлгіні `_android-device-lab` Jira кезегіне көшіріңіз.
аппараттық құрал. Сілтемелерді Buildkite құбырларына, сәйкестік артефактілеріне және кез келгеніне тіркеңіз
жүгіруге байланысты серіктес билеттері.
