...
# Android စက်ပစ္စည်း ဓာတ်ခွဲခန်း ကြိုတင်မှာယူမှု တောင်းဆိုမှု ပုံစံ

ကြိုတင်မှာယူသည့်အခါ ဤပုံစံခွက်ကို `_android-device-lab` Jira တန်းစီထဲသို့ ကူးယူပါ။
ဟာ့ဒ်ဝဲ။ Buildkite ပိုက်လိုင်းများ၊ လိုက်နာမှုဆိုင်ရာ ပစ္စည်းများနှင့် မည်သည့်အရာများနှင့်မဆို ချိတ်ဆက်ပါ။
ပြေးမှုအပေါ် မူတည်သော ပါတနာလက်မှတ်များ။
