...
# Android төхөөрөмжийн лабораторийн захиалгын хүсэлтийн загвар

Захиалга хийхдээ энэ загварыг `_android-device-lab` Jira дараалалд хуулна уу.
техник хангамж. Buildkite дамжуулах хоолой, нийцлийн олдворууд болон бусад зүйлсийн холбоосыг хавсаргана уу
гүйлтээс хамаарах түншийн тасалбар.
