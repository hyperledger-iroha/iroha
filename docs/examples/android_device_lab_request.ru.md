...
# Шаблон запроса на бронирование лаборатории устройств Android

Скопируйте этот шаблон в очередь Jira `_android-device-lab` при бронировании оборудования.
Приложите ссылки на пайплайны Buildkite, compliance артефакты и любые партнерские тикеты,
зависящие от запуска.
