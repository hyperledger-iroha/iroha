...
- `AccountId`: kanonik identifikator `AccountAddress` orqali kodlangan, u IH58, Sora siqilgan (`sora…`) va kanonik hex kodeklarni (`AccountAddress::to_ih58`, I100030, I180030, I1800030, Kotodama) ochib beradi. `canonical_hex`, `parse_encoded`). IH58 - afzal qilingan hisob formati; `sora…` shakli Sora-faqat UX uchun ikkinchi o'rinda turadi. Odamlar uchun qulay `alias` (rejected legacy form) marshrutlash taxallusi UX uchun saqlanib qolgan, ammo endi vakolatli identifikator sifatida ko'rib chiqilmaydi. Torii `AccountAddress::parse_encoded` orqali kiruvchi satrlarni normallashtiradi. Hisob identifikatorlari bitta kalitli va multisig kontrollerlarini qo'llab-quvvatlaydi.
