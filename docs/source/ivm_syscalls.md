...
| 0xA8 | CURRENT_TIME_MS            | –                                                                       | `u64=deterministic_execution_time_ms` | `G_sysvar` | Kotodama `current_time_ms()`; signed transaction time for transaction calls, block-header time for triggers |
