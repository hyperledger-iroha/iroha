...
- მშენებლები:
  - `NewAccount` `Account::new_in_domain(id, domain)`-ის მეშვეობით ახდენს დომენთან დაკავშირებულ აშკარა რეგისტრაციას და, შესაბამისად, მოითხოვს `ScopedAccountId`.
  - `NewAccount` `Account::new(id)`-ის მეშვეობით რეგისტრირებს მხოლოდ უნივერსალური ანგარიშის საგანს დაკავშირებული დომენის გარეშე.
- Alias მოდელი:
