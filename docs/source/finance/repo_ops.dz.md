...
1. **པར་ལེན་ཚད་སྙོམས་ཚུ་** ནུས་ཤུགས་དེ་ལུ་ `FindAssets` འདྲི་དཔྱད་ལག་ལེན་འཐབ།
   ...
   python3 scripts/repo_evidence_manifest.py \
     ...
     --output artifacts/finance/repo/<slug>/manifest.json
   ```) ཡང་ན་
   `iroha_python` གྲོགས་རམ་འབད་མི་གིས་ `soraカタカナ...` གི་དོན་ལུ་ XOR ལྷག་ལུས་ཚུ་ ཕྱིར་འདྲེན་འབདཝ་ཨིན།
   `soraカタカナ...`, དང་ བསྐྱར་ཞིབ་ནང་འབྲེལ་གཏོགས་ཡོད་པའི་ ཌིཀསི་རྩིས་ཐོ་རེ་རེ་བཞིན་ཨིན། བསགས་བཞག་ནི
