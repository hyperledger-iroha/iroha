...
- **Torii გადაყლაპვა** → გაგზავნეთ PvP დაფინანსების შედეგები `POST /v2/iso20022/pacs009`-ის მეშვეობით; ხიდი
...
### რეპო გირაოს ჩანაცვლება → `colr.007`| რეპო ველი / კონტექსტი | ISO 20022 გზა | შენიშვნები |
|---------------------------------------------------------------------------------|-------|
