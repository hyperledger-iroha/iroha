...
1. **Суретті баланстар.** Қуат беретін `FindAssets` сұрауын пайдаланыңыз.
   ...
   `<katakana-i105-account-id>` үшін XOR баланстарын экспорттауға арналған `iroha_python` көмекшісі,
   `<katakana-i105-account-id>` және шолуға қатысатын әрбір жұмыс үстелі тіркелгісі. Дүкен
   астында JSON
