...
3. ယခု runtime သည် တောင်းဆိုထားသော cadence/haircut ကို မေးမြန်းခြင်းဖြင့် သက်သေပြပါ
   ...
   Torii ၏ `/v2/configuration` လျှပ်တစ်ပြက်ရိုက်ချက်သည် မလုံလောက်ပါ။
...
- `GET /v2/repo/agreements` သည် ရွေးချယ်နိုင်သော pagination၊ filtering ဖြင့် တက်ကြွသောသဘောတူညီချက်များကို ပြန်ပေးသည်
...
- `POST /v2/repo/agreements/query` သည် ဖွဲ့စည်းတည်ဆောက်ထားသော မေးခွန်းစာအိတ်ကို လက်ခံသည် (pagination၊ sort၊
...
3. အပြောင်းအလဲကို လှိမ့်လိုက်သည်- `[settlement.repo]` ကို အပ်ဒိတ်လုပ်ပါ၊ တစ်ခုစီကို ပြန်လည်စတင်ပါ
   node၊ ထို့နောက် `GET /v2/configuration` လျှပ်တစ်ပြက်ရိုက်ချက် (သို့မဟုတ်
...
1. သက်တူရွယ်တူတစ်ဦးစီမှ စီစဉ်သတ်မှတ်မှုကို ရယူပါ (`GET /v2/configuration` သို့မဟုတ်
...
**ခွင့်ပြုချက်ရပြီးနောက်ပိုင်း ဖြန့်ချိမှုများ**1. အတည်ပြုထားသော `[settlement.repo]` config ကိုအသုံးပြုပြီး node တစ်ခုစီကို ပြန်လည်စတင်ပါ (သို့မဟုတ် roll
   ၎င်းကို သင်၏ အလိုအလျောက်စနစ်ဖြင့်)။ `GET /v2/configuration` ကို ချက်ချင်းခေါ်ပြီး တင်ထားပါတယ်။
...
ဤရည်ရွယ်ချက်အတွက် `/v2/configuration` လမ်းကြောင်းနှင့် SDKs ကဲ့သို့သော မျက်နှာပြင်အကူအညီများ အားလုံး
...
1. ပြီးပြီးချင်း ရွယ်တူချင်းအလိုက် `GET /v2/configuration` (သို့မဟုတ် SDK အကူအညီပေးသူ) ကို ခေါ်ပါ
...
- `config/peers/*.json` သည် သက်တူရွယ်တူတစ်ဦးစီအတွက် `/v2/configuration` လျှပ်တစ်ပြက်ရိုက်ချက်များ၊
...
3. **လယ်ဂျာ/config လျှပ်တစ်ပြက်ပုံများကို သိမ်းဆည်းပါ။** `repo query list` အထွက်ကို ရှေ့/နောက် ထုတ်ယူပါ။
   ...
   ဖြတ်သွားသည်၊ ရွယ်တူတစ်ဦးလျှင် `/v2/configuration` လျှပ်တစ်ပြက်ရိုက်ချက်များ (§2.9) ကိုဖမ်းယူပြီး ၎င်းတို့ကို သိမ်းဆည်းပါ။
