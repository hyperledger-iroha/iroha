...
1. **လျှပ်တစ်ပြက်လက်ကျန်များ** စွမ်းအားပေးသော `FindAssets` မေးမြန်းချက်ကို အသုံးပြုပါ။
   ...
   `<katakana-i105-account-id>` အတွက် XOR လက်ကျန်များကို တင်ပို့ရန် `iroha_python` အကူအညီပေးသူ
   `<katakana-i105-account-id>` နှင့် သုံးသပ်ချက်တွင် ပါဝင်သည့် စားပွဲအကောင့်တိုင်း။ စတိုး
   JSON အောက်တွင်
