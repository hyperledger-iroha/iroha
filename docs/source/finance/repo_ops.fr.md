...
source_last_modified: "2026-01-22T15:51:19.707360+00:00"
...
1. **Snapshot balances.** Use the `FindAssets` query that powers
   ...
   `iroha_python` helper to export XOR balances for `<i105-account-id>`,
   `<i105-account-id>`, and every desk account involved in the review. Store
   the JSON under
