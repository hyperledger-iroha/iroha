...
| `iroha_cli app sns settlement ledger --bundle artifacts/sns/settlements/2026-05-01/makoto.sora.json --treasury-account treasury@sora --steward-account makoto.suffix@sns` | Emits Norito `Transfer` ISIs and persists them beside the bundle. |
