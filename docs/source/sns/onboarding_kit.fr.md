...
source_last_modified: "2026-01-03T18:07:57.532325+00:00"
...
- `scripts/sns_bulk_onboard.py` (documented in
  ...
  NDJSON, and optionally POSTs `/v2/sns/registrations`. Capture the resulting
...
4. API smoke-test artefacts (Torii `POST /v2/sns/registrations` samples, CLI output).
