...
source_last_modified: "2025-12-29T18:16:36.089578+00:00"
...
attach disputes to the same IH58 selectors and suffix identifiers used
elsewhere in SNS.
...
| `selector` | object `{suffix_id,label,global_form}` | Targeted name. `global_form` must match the canonical IH58 output documented in `address_display_guidelines.md`. |
