...
| Address UX guide | [`address_display_guidelines.md`](./address_display_guidelines.md) | Canonical IH58 (preferred) + compressed (`snx1`, second-best) renderings mirrored by wallets/explorers. |
