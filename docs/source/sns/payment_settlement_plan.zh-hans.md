...
PaymentBundleV1:
  ...
  ledger_projection:
    debit_account: "<katakana-i105-account-id>"
...
| `iroha_cli app sns settlement ledger --bundle artifacts/sns/settlements/2026-05-01/makoto.sora.json --treasury-account <katakana-i105-account-id> --steward-account <katakana-i105-account-id>` | Emits Norito `Transfer` ISIs and persists them beside the bundle. |
