...
| 0x22 | MINT_ASSET | `&AccountId`፣ `&AssetDefinitionId`፣ `&QuantityValueV1` | `u64=0` | `G_mint` | Mints `amount` ንብረት ወደ መለያ |
| 0x23 | BURN_ASSET | `&AccountId`፣ `&AssetDefinitionId`፣ `&QuantityValueV1` | `u64=0` | `G_burn` | ከመለያው `amount` ያቃጥላል |
...
| 0x27 | NFT_SET_METADATA | `&NftId`, `&Name`, `&Json` | `u64=0` | `G_nft_set_metadata` | NFT ሜታዳታ ያዘምናል |
