...
| 0x22 | MINT_ASSET | `&AccountId`፣ `&AssetDefinitionId`፣ `&Amount` | `u64=0` | `G_mint` | Mints `amount` ንብረት ወደ መለያ |
| 0x23 | BURN_ASSET | `&AccountId`፣ `&AssetDefinitionId`፣ `&Amount` | `u64=0` | `G_burn` | ከመለያው `amount` ያቃጥላል |
