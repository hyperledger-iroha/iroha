...
- **མངའ་ཁོངས་དང་རྩིས་ཐོ་ དེ་ལས་ རྒྱུ་དངོས་** ཀེན་ནོ་ནཱལ་ཨའི་ཨེཆ་༥༨ རྩིས་ཐོ་ཨའི་ཌི་ཚུ་ (དགའ་གདམ་) ལག་ལེན་འཐབ། `name@dataspace` / `name@domain.dataspace` འགྲུལ་ལམ་ཅིག་སྦེ་ལུས།
