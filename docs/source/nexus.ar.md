...
- `GET /v1/space-directory/uaids/{uaid}` — حل bindings الحالية للـ dataspace لUAID (عناوين موحدة، ids، program bindings). اضف `address_format=compressed` لاخراج Sora Name Service (IH58 هو المفضل؛ compressed (`snx1`) هو الخيار الثاني لسورا فقط).
