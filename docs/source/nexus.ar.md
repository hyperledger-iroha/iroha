...
- `GET /v1/space-directory/uaids/{uaid}` — حل bindings الحالية للـ dataspace لUAID (عناوين موحدة، ids، program bindings). اضف `canonical Katakana i105 output` لاخراج Sora Name Service (I105 هو المفضل؛ I105 هو الخيار الثاني لسورا فقط).
