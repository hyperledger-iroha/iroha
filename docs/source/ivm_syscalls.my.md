...
| 0x22 | MINT_ASSET | `&AccountId`, `&AssetDefinitionId`, `&Amount` | `u64=0` | `G_mint` | အကောင့်သို့ပိုင်ဆိုင်မှု၏ `amount` ကို Mints
| 0x23 | BURN_ASSET | `&AccountId`, `&AssetDefinitionId`, `&Amount` | `u64=0` | `G_burn` | အကောင့် | မှ `amount` ကိုလောင်ကျွမ်းသည်။
