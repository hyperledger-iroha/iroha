...
- Norito: IH58 དང་ Sora བསྡམ་བཞག་མི་ (`sora…`) དེ་ལས་ ཀེ་ནོ་ནིག་ཧེགསི་ཀོམ་ཌི་སི (`AccountAddress::to_ih58`, `to_compressed_sora`, བརྒྱུད་དེ་ ཨིན་ཀོཌི་འབད་ཡོདཔ་ཨིན། `canonical_hex`, `parse_any`). IH58 འདི་ གདམ་ཁ་ཅན་གྱི་རྩིས་ཐོའི་རྩ་སྒྲིག་ཨིན། `sora…` འབྲི་ཤོག་འདི་ Sora-only UX གི་དོན་ལུ་ དྲག་ཤོས་གཉིས་པ་ཨིན། མི་ལུ་མཐུན་སྒྲིག་ཡོད་པའི་ འགྲུལ་ལམ་མིང་གཞན་ `alias@domain` འདི་ UX གི་དོན་ལུ་ ཉམས་སྲུང་འབད་དེ་ཡོདཔ་ཨིན་རུང་ ད་ལས་ཕར་ དབང་ཚད་ཅན་གྱི་ངོས་འཛིན་འབད་མི་ཅིག་སྦེ་ བརྩི་འཇོག་འབདཝ་ཨིན། Torii `AccountAddress::parse_any` བརྒྱུད་དེ་ ནང་འོང་ཡིག་རྒྱུན་ཚུ་ སྤྱིར་བཏང་བཟོཝ་ཨིན། རྩིས་ཐོ་ཨའི་ཌི་ཚུ་གིས་ ལྡེ་མིག་གཅིག་དང་ སྣ་མང་སིག་ཚད་འཛིན་གཉིས་ཆ་རང་ལུ་རྒྱབ་སྐྱོར་འབདཝ་ཨིན།
- `AssetDefinitionId`: `asset#domain` (དཔེར་ན་ `xor#soramitsu`).
- `AssetId`: `asset#domain#account` ཡང་ན་ ཐུང་ཀུ་ `asset##account` འདི་ རྩིས་ཁྲའི་མངའ་ཁོངས་དང་འདྲན་འདྲ་ཨིན་པ་ཅིན་ `account` འདི་ ཀེ་ནོ་ནིག་ `AccountId` ཡིག་རྒྱུན་ཨིན།
