...
- `AccountAlias` ҡиммәттәре - был предмет өҫтөндә айырым SNS бәйләүҙәре. А
  домен-квалификациялы псевдоним, мәҫәлән, `merchant@banka.sbp` һәм мәғлүмәт киңлеге-тамыр псевдоним
...
Ағымдағы Torii маршруттары:| Маршрут | Маҡсат |
|--------|
| 18НИ00000085Х | Әүҙем һәм әүҙем булмаған RAM-LFE программаһы сәйәсәтен, уларҙы йәмәғәт башҡарыу метамағлүмәттәрен, шул иҫәптән өҫтәмә BFV `input_encryption` параметрҙарын һәм программаланған бекэнд `ram_fhe_profile` исемлегенә инә. |
| 18НИ00000088Х | Ҡабул итә теүәл бер `{ input_hex }` йәки `{ encrypted_input }` һәм ҡайтара штатһыҙ `RamLfeExecutionReceipt` плюс `{ output_hex, output_hash, receipt_hash }` һайланған программа өсөн. Ағымдағы Torii эшләү ваҡыты программаланған BFV бэкэнды өсөн квитанциялар сығара. |
| 18НИ00000093Х | 18NI00000094X ҡаршы баҫылған сылбырлы программа сәйәсәте һәм теләк буйынса тикшерә, тип шылтыратыусы биргән `output_hex` тура килә квитанция `output_hash`. |
| 18НИ00000097Х | Йәшерен функциялы сәйәсәттең әүҙем һәм әүҙем булмаған исемдәр киңлеген, уларҙы асыҡ метамағлүмәттәрҙе, шул иҫәптән өҫтәмә BFV `input_encryption` параметрҙарын, клиент яғынан шифрланған индереү өсөн кәрәкле `normalization` режимын һәм программаланған BF сәйәсәте өсөн `ram_fhe_profile` исемлегенә инә. |
| 18НИ00000101Х | Ҡабул итә теүәл бер Norito йәки Norito. Ябай текст `input` сервер яғынан нормалаштырылған; БФВ `encrypted_input` инде баҫылған сәйәсәт режимы буйынса нормалаштырылырға тейеш. Һуңынан ос нөктәһе `opaque:` ручкаһын сығара һәм ҡул ҡуйылған квитанцияны ҡайтара, тип `ClaimIdentifier` сылбырҙа тапшыра ала, шул иҫәптән сеймал `signature_payload_hex` һәм анализланған `signature_payload`. || 18НИ00000110Х | Ҡабул итә теүәл бер `{ input }` йәки `{ encrypted_input }`. Ябай текст `input` сервер яғынан нормалаштырылған; БФВ `encrypted_input` инде баҫылған сәйәсәт режимы буйынса нормалаштырылырға тейеш. Һуңғы нөктә идентификаторҙы `{ opaque_id, receipt_hash, uaid, account_id, signature }`-ҡа хәл итә, ҡасан әүҙем дәғүә бар, шулай уҡ канон ҡул ҡуйылған файҙалы йөктө `{ signature_payload_hex, signature_payload }` тип ҡайтара. |
| 18НИ00000117Х | Ҡарап өҫкә ныҡлы `IdentifierClaimRecord` бәйле детерминистик ҡабул итеү хеш шулай операторҙар һәм SDKs аудит дәғүә милек йәки диагностика реплей / тап килмәү етешһеҙлектәре сканерлау тулы идентификатор индексы. |
