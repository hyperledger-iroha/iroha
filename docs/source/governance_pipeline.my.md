...
- `NextMode` + `ModeActivationHeight` မှ ပြဌာန်းထားသော ပူးတွဲသဘောတူညီမှု လက်လွှဲပေးပို့မှုများဖြင့် - အထောက်အထားစိစစ်သူ၏ မှားယွင်းသောအပြုအမူကို အထောက်အထားပိုက်လိုင်း (`/v2/sumeragi/evidence*`၊ CLI အကူအညီပေးသူများ) မှတဆင့် အရေးယူဆောင်ရွက်ပါသည်။
