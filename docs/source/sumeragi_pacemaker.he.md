...
- הגדרות: ‏`sumeragi_pacemaker_backoff_multiplier`, ‏`sumeragi_pacemaker_rtt_floor_multiplier`, ‏`sumeragi_pacemaker_max_backoff_ms`
...
- אימות קונפיגורציה: ‏`max(sumeragi_pacemaker_backoff_multiplier)` וכדומה

## דטרמיניזם ובטיחות
- טיימרים/backoff/ג׳יטר משפיעים רק על זמני הצעות/שינויי תצוגה; הם אינם נוגעים בתוקף חתימות או בכללי QC.
