...
- བཅོ་ཁ་: `fixtures/account/address_vectors.json` (IH58 (pordered) + བསྡམ་བཞག་ (`sora`, གཉིས་པ་) + སྣ་མང་སིག་ པོ་སི་པོ་ཕེསི་/ནེ་གེ་ཊིབ་གནད་དོན་ཚུ་)།
...
|----------------------------------------- |
| རསཊི་གནས་སྡུད་-དཔེ་ཚད་ | `crates/iroha_data_model/tests/account_address_vectors.rs` | JSON དང་ ཀེན་ནོ་ནིག་པེ་ལོཌི་ཚུ་ བསྐྱར་བཟོ་འབད་ཞིནམ་ལས་ IH58 (དགའ་གདམ་)/བསྡོམས་རྩིས་ (`sora`, གཉིས་པ་)/ཁྲིམས་ལུགས་གཞི་བསྒྱུར་ + གཞི་བཀོད་འཛོལ་བ་ཚུ་ ཞིབ་དཔྱད་འབདཝ་ཨིན། |
| Torii | `crates/iroha_torii/tests/account_address_vectors.rs` | སར་བར་གྱི་ཕྱོགས་ཀྱི་གསང་ཡིག་ཚུ་ བདེན་དཔྱད་འབདཝ་ཨིན། Torii གིས་ IH58 (དགའ་གདམ་)/བསྡམ་བཞག་མི་ (`sora`, གཉིས་པ་) གིས་ གཏན་འབེབས་བཟོ་ཐོག་ལས་ སྐྱོན་བརྗོད་འབདཝ་ཨིན། |
| ཇ་བ་ཨིསི་ཀིརིཔཊི་ཨེསི་ཌི་ཀེ་ | `javascript/iroha_js/test/address.test.js` | མེ་ལོང་ཝི་༡ གི་སྒྲིག་བཀོད་ཚུ་ (IH58 གིས་ དགའ་གདམ་/བསྡམ་བཞག་འབད་ཡོདཔ་ (`sora`) གཉིས་པ་/ཆ་ཚང་/ཆ་ཚང་) དེ་ལས་ Norito-style sytle sytle sytle sytle syme- style fronor code ཚུ་ ངན་ལྷད་ཅན་ཚུ་ཚུ་གི་དོན་ལུ་ཨིན། |
| Swift ཨེསི་ཌི་ཀེ་ | `IrohaSwift/Tests/IrohaSwiftTests/AccountAddressTests.swift` | IH58 (དགའ་གདམ་)/བསྡམ་བཞག་མི་ (`sora`, དྲག་ཤོས་གཉིས་པ་) ཌི་ཀོ་ཌིང་དང་ སྣ་མང་སིག་པེ་ལོཌི་ དེ་ལས་ ཨེ་པཱལ་སྟེགས་བུ་ཚུ་ནང་ འཛོལ་བ་ཚུ་ བརྒལ་ཚུགསཔ་ཨིན། |
