...
- GET `/v1/sumeragi/evidence`
  ...
  - Parametres de requete: `limit` (defaut 50, max 1000), `offset` (defaut 0), `kind` (optionnel; un de `DoublePrevote|DoublePrecommit|InvalidQC|InvalidProposal|Censorship`).
