...
- བརྟག་དཔྱད།: ཀེརེཊསི་/ཨཝ་ཨེམ་/བརྟག་དཔྱད/ཀླི་_སི་མོཀ.s:8 — `let bin = env!("CARGO_BIN_EXE_koto build");`
- བརྟག་དཔྱད།: ཀེརེཊསི་/ཨཝ་ཨེམ་/བརྟག་དཔྱད/ཀླི་_ས་མོ།
- བརྟག་དཔྱད།: ཀེརེཊསི/ཨཝ་ཨེམ་/བརྟག་དཔྱད/ཀླི་_སི་མོཀ.s:88 — `let bin = env!("CARGO_BIN_EXE_koto build");`
...
- བརྟག་དཔྱད།: ལག་ཆས་/སོ་ནེན་-ལག་ཤེཀ་-ཧར་ནིས/བརྟག་དཔྱད་/ཕིགསི་ཅར་_བདེན་དཔྱད་.rs:6 — `let bin = env!("CARGO_BIN_EXE_koto build");`
