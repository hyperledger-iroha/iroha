...
- **Метрики:**  
  ...
  реагировать на всплески missing-availability (reschedule счетчики — legacy и должны быть нулевыми),
...
- **Dashboards:**  
  ...
  - `sumeragi_da_gate_block_total{reason="missing_availability_qc"}` стабильно растет.
