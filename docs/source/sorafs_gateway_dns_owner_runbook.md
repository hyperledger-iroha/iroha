...
Before running shell snippets, export `DNS_CUTOVER_WINDOW`,
`DNS_CUTOVER_START`, `DNS_FREEZE_EXPIRES_AT`, and `DNS_REHEARSAL_DATE`
from the approved rollout ticket for the current governed cutover.
