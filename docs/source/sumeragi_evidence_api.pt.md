...
- GET `/v1/sumeragi/evidence`
  ...
  - Parametros de query: `limit` (default 50, max 1000), `offset` (default 0), `kind` (opcional; um de `DoublePrevote|DoublePrecommit|InvalidQC|InvalidProposal|Censorship`).
