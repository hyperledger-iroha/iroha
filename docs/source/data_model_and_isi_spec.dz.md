...
- `AssetId`: ཀེ་ནོ་ནིཀ་ཨེན་ཀོ་ཌི་འབད་ཡོད་པའི་ཚིག་ཡིག་ `<base58-asset-id>#<katakana-i105-account-id>` (རིག་གཞུང་ཚིག་ཡིག་འབྲི་ཤོག་ཚུ་ གསར་བཏོན་འགོ་དང་པ་ནང་ རྒྱབ་སྐྱོར་མེདཔ་ཨིན།)།- `NftId` — `nft$domain`. NFT: `{ id, content: Metadata, owned_by }`. གསང་གྲངས་: `crates/iroha_data_model/src/nft.rs`.
...
- རྒྱུ་དངོས་ཨའི་ཌི་ཚུ་ མིན་ཊི་/བརན་/སྤོ་བཤུད་མཚམས་ཐིག་ཚུ་ནང་ ཀེ་ནོ་ནིཀ་ལུ་སྡོདཔ་ཨིན་ `<base58-asset-id>#<katakana-i105-account-id>`; ལག་ལེན་འཐབ། `iroha tools encode asset-id` དང་ `--definition <base58-asset-definition-id>` ཡང་ན་ `--alias ...` དང་ `--account`.
