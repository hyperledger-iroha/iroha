...
Stateless verifier нь version, chain, height, header hash, context, subject, CommitQC-г
яг тааруулж, artifact доторх бүх PoP-ийг шалгана. Signer index-үүд эрс өсөх дараалалтай,
...
mmr_leaf_index?, mmr_peaks? }`. Optional MMR талбарууд зөвхөн commitments бөгөөд
finality эсвэл inclusion proof биш.
