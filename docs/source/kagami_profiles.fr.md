...
- Profils : `iroha3-dev` (chaîne `iroha3-dev.local`, collecteurs k=1 r=1, graine VRF dérivée de l'identifiant de la chaîne lorsque NPoS est sélectionné), `iroha3-testus` (chaîne `iroha3-testus`, collecteurs k=3 r=3, nécessite `--vrf-seed-hex` lorsque NPoS est sélectionné), `iroha3-nexus` (chaîne `iroha3-nexus`, collecteurs k=5 r=3, nécessite `--vrf-seed-hex` lorsque NPoS est sélectionné).
