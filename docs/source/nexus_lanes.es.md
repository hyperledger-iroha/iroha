...
- Los snapshots de estado en niveles reflejan el mismo ciclo; cada lane escribe en `cold_store_root/lanes/lane_{id:03}_{slug}` y los retiros migran el arbol de directorios a `cold_store_root/retired/lanes/`.
