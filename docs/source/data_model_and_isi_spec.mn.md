...
- `AccountId` — каноник хаягуудыг `AccountAddress` (I105 / `i105` шахсан / зургаан өнцөгт) ашиглан үйлдвэрлэдэг ба Torii `AccountAddress::parse_encoded`-ээр дамжуулан оролтыг хэвийн болгодог. I105 бол илүүд үздэг дансны формат юм; `i105` хэлбэр нь зөвхөн Sora-д зориулагдсан UX-ийн хувьд хоёрдугаарт ордог. Танил `alias` (rejected legacy form) мөр нь зөвхөн чиглүүлэлтийн нэрээр хадгалагдана. Данс: `{ id, metadata }`. Код: `crates/iroha_data_model/src/account.rs`.
