...
# LLM зохицуулалтын сануулга

## Зорилго

Эдгээр шуурхай загварууд нь инженерүүдэд @mtakemiya-аас тодруулгыг хурдан цуглуулахад тусалдаг
замын зураглалын зүйлүүд нээлттэй асуулт үлдээх үед. Доорх хэсгүүдийн аль нэгийг нь хуулж бичнэ үү
LLM урсгал, хаалтанд орсон орлуулагчийг сольж, холбогдох файл эсвэл
мөрийн лавлагаа нь контекст хэвээр үлдэх болно.

## Архитектур эсвэл дизайны шийдвэр
...
## Тохиргоо эсвэл операторын заавар
...
## Криптограф эсвэл протоколын командууд
...
## Туршилтын вектор эсвэл бэхэлгээ
...
## Инженерчлэл эсвэл процессыг гарга
