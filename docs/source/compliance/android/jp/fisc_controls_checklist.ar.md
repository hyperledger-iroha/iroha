...
| ** التحكم في الوصول والمصادقة ** | تحترم SDK سياسات Torii TLS والطلبات الموقعة `/v2/pipeline`؛ مرجع مسارات عمل المشغل دعم دليل التشغيل §4–5 للتصعيد بالإضافة إلى تجاوز البوابة عبر عناصر Norito الموقعة. | `docs/source/android_support_playbook.md`; `docs/source/sdk/android/telemetry_redaction.md` (تجاوز سير العمل). | ✅ تم التنفيذ |
