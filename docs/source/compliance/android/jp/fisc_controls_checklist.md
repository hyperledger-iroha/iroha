...
| **Access control & authentication** | SDK honours Torii TLS policies and `/v2/pipeline` signed requests; operator workflows reference Support Playbook §4–5 for escalation plus override gating via signed Norito artefacts. | `docs/source/android_support_playbook.md`; `docs/source/sdk/android/telemetry_redaction.md` (override workflow). | ✅ Implemented |
