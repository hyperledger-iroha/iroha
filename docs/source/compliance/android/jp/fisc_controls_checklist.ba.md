...
| **Индеть контроль & аутентификация** | SDK хөрмәт Torii TLS сәйәсәте һәм `/v2/pipeline` ҡул ҡуйҙы запростар; оператор эш ағымы һылтанма ярҙам Playbook §4–5 өсөн эскалация плюс өҫтөндә ҡапҡа аша ҡул ҡуйылған Norito артефакттары. | `docs/source/android_support_playbook.md` X; `docs/source/sdk/android/telemetry_redaction.md` (өҫтөндә эш ағымы). | ✅ Өҫтөнлөк |
