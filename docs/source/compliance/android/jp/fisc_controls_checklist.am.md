...
| ** የመዳረሻ ቁጥጥር እና ማረጋገጫ** | ኤስዲኬ የTorii TLS ፖሊሲዎችን እና `/v2/pipeline` የተፈረሙ ጥያቄዎችን ያከብራል፤ ከዋኝ የስራ ፍሰቶች ማመሳከሪያ ፕሌይ ደብተር §4–5ን ከፍ ለማድረግ ይደግፉ እና ጌቲንግን በተፈረመ Norito ቅርሶች። | `docs/source/android_support_playbook.md`; `docs/source/sdk/android/telemetry_redaction.md` (የስራ ፍሰትን ይሽሩ)። | ✅ ተተግብሯል |
