...
| **Մուտքի վերահսկում և նույնականացում** | SDK-ն հարգում է Torii TLS քաղաքականությունը և `/v2/pipeline` ստորագրված հարցումները. օպերատորի աշխատանքային հոսքերի տեղեկանք Աջակցման խաղագիրք §4–5՝ ընդլայնման և շրջադարձային մուտքի համար ստորագրված Norito արտեֆակտների միջոցով: | `docs/source/android_support_playbook.md`; `docs/source/sdk/android/telemetry_redaction.md` (շրջանցել աշխատանքային հոսքը): | ✅ Իրականացվել է |
