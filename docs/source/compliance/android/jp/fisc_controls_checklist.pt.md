...
| **Controle de acesso e autenticação** | O SDK respeita as políticas TLS Torii e as solicitações assinadas `/v2/pipeline`; referência de fluxos de trabalho do operador Support Playbook §4–5 para escalonamento e substituição de controle por meio de artefatos Norito assinados. | `docs/source/android_support_playbook.md`; `docs/source/sdk/android/telemetry_redaction.md` (substituir fluxo de trabalho). | ✅ Implementado |
