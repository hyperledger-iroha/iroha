...
| **ဝင်ရောက်ထိန်းချုပ်မှုနှင့် အထောက်အထားစိစစ်ခြင်း** | SDK သည် Torii TLS မူဝါဒများနှင့် `/v2/pipeline` လက်မှတ်ထိုးတောင်းဆိုမှုများကို ဂုဏ်ပြုပါသည်။ အော်ပရေတာ အလုပ်အသွားအလာများ တိုးလာမှုအတွက် ပံ့ပိုးကူညီမှု Playbook §4–5 နှင့် Norito လက်မှတ်ရေးထိုးထားသော အထောက်အထားများမှတစ်ဆင့် ဂိတ်ပေါက်များကို ထပ်ရေးပါ။ | `docs/source/android_support_playbook.md`; `docs/source/sdk/android/telemetry_redaction.md` (အလုပ်အသွားအလာကို အစားထိုးသည်)။ | ✅ Implemented |
