...
`TransferAssetBatch` бер үк рөхсәт һәм арифметик чектарҙы айырым `Transfer::asset_quantity` шылтыратыуҙары булараҡ башҡара, әммә бөтә дельталарҙы бер генә `TransferTranscript` эсендә теркәй. Күп дельта транскрипциялары посейдон даестрын элид тиклем пер-дельта йөкләмәләр ер эҙләүҙә. Kotodama төҙөүсе хәҙер автоматик рәүештә башланғыс/ос syscalls сығара, шуға күрә килешеп, ҡул-кодлау Norito файҙалы йөктәрһеҙ пакетлы күсермәләрҙе таратыу мөмкин.
