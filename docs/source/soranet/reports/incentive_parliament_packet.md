...
3. **Config sanity** - run
   `iroha sorafs incentives service init --state /tmp/incentives-test.json --config docs/examples/soranet_incentive_parliament_packet/reward_config.json --treasury-account treasury@soranet --force`
