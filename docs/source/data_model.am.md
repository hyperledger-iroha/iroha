...
- `AssetId`: ቀኖናዊ ኮድ በጥሬው `<base58-asset-id>#<katakana-i105-account-id>` (የቆዩ የጽሑፍ ቅጾች በመጀመሪያው መለቀቅ አይደገፉም)።
...
- ለአዝሙድና / ለማቃጠል / ለማስተላለፍ የንብረት መታወቂያዎች ቀኖናዊ `<base58-asset-id>#<katakana-i105-account-id>` ይቀራሉ; እነሱን በ:
