...
- `AssetId`: ቀኖናዊ ኮድ በጥሬው `<asset-definition-id>#<i105-account-id>` (የቆዩ የጽሑፍ ቅጾች በመጀመሪያው መለቀቅ አይደገፉም)።
...
- ለአዝሙድና / ለማቃጠል / ለማስተላለፍ የንብረት መታወቂያዎች ቀኖናዊ `<asset-definition-id>#<i105-account-id>` ይቀራሉ; እነሱን በ:
