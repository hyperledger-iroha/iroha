...
- `AccountId`: IH58, Sora қысылған (`sora…`) және канондық он алтылық кодектер (`AccountAddress::to_ih58`, I1000030, Kotodama, `AccountAddress` арқылы кодталған канондық идентификатор. `canonical_hex`, `parse_encoded`). IH58 - қолайлы тіркелгі пішімі; `sora…` пішіні тек Sora UX үшін екінші ең жақсы. Адамға қолайлы `alias` (rejected legacy form) маршрутизаторының бүркеншік аты UX үшін сақталған, бірақ енді беделді идентификатор ретінде қарастырылмайды. Torii кіріс жолдарын `AccountAddress::parse_encoded` арқылы қалыпқа келтіреді. Тіркелгі идентификаторлары бір кілтті де, мультисигті контроллерді де қолдайды.
