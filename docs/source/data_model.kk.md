...
- `AssetId`: канондық кодталған литерал `<base58-asset-id>#<katakana-i105-account-id>` (бұрынғы мәтіндік пішіндерге бірінші шығарылымда қолдау көрсетілмейді).
...
- Жалға беру/жазу/тасымалдау үшін актив идентификаторлары канондық `<base58-asset-id>#<katakana-i105-account-id>` болып қалады; оларды құру:
