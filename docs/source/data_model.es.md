...
- `AssetId`: literal codificado canónico `<asset-definition-id>#<i105-account-id>` (las formas textuales heredadas no se admiten en la primera versión).
...
- Los ID de activos para acuñación/quema/transferencia siguen siendo canónicos `<asset-definition-id>#<i105-account-id>`; construirlos con:
