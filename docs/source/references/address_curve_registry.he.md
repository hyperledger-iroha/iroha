...
3. **דקוד אלגוריתמי ייעודי:** השתמשו באותם דקודרים קנוניים כמו `iroha_crypto`
   (`ed25519_dalek`, `pqcrypto_mldsa`, `w3f_bls`/`blstrs`, `sm2`, עזרי TC26
...
| `ml-dsa` (Dilithium3) | `0x02` | 1952 | 3309 | דחיית payloads שאינם בדיוק 1952 בתים לפני דקוד; ניתוח מפתח Dilithium3 ואימות חתימות עם pqcrypto-mldsa באורכים קנוניים. |
