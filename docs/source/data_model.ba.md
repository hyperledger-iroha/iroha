...
- Псевдоним моделе:
  ...
  - Домен-квалификациялы псевдонимдар, мәҫәлән, `merchant@banka.paynet` псевдоним бәйләүендә доменды ла, мәғлүмәт киңлеген дә йөрөтә.
  - Мәғлүмәттәр киңлеге-тамыр псевдонимдары, мәҫәлән, `merchant@paynet` мәғлүмәттәр киңлеген генә йөрөтә һәм шуға күрә `Account::new(...)` менән тәбиғи рәүештә парлана.
