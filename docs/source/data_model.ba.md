...
- `AccountId`: IH58, Сора ҡыҫылған (`sora…`) һәм канонлы гекс кодектары (`AccountAddress::to_ih58`, `to_compressed_sora`, `sora…`) аша кодланған канонлы идентификатор. `canonical_hex`, `parse_encoded`). IH58 - өҫтөнлөклө иҫәп форматында; `sora…` формаһы Сора-тик UX өсөн икенсе иң яҡшы. Кешегә уңайлы маршрутлаштырыу псевдонимы `alias` (rejected legacy form) UX өсөн һаҡлана, әммә хәҙер абруйлы идентификатор булараҡ ҡаралмай. Torii `AccountAddress::parse_encoded` аша килгән ептәрҙе нормалләштерә. Иҫәп идентификаторҙары ярҙам итә, ике бер асҡыс һәм мультисиг контроллерҙар.
