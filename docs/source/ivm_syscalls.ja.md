...
| 0x22 | MINT_ASSET                        | `&AccountId`, `&AssetDefinitionId`, `&Amount`                         | `u64=0`      | `G_mint`                          | 指定量をアカウントへ鋳造する          |
| 0x23 | BURN_ASSET                        | `&AccountId`, `&AssetDefinitionId`, `&Amount`                         | `u64=0`      | `G_burn`                          | 指定量をアカウントから焼却する        |
