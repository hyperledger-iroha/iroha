...
- གསལ་སྡུད་: `iroha3-dev` (རྒྱུན་རིམ་ `iroha3-dev.local`, བསྡུ་སྒྲིག་ k=1, r=1, VRF འདི་ NPoS སེལ་འཐུ་འབད་བའི་སྐབས་ རིམ་སྒྲིག་ཨའི་ཌི་ལས་འབྱུང་ཡོདཔ་ཨིན།) `iroha3-testus` (chain Kagami, བསྡུ་སྒྲིག་ཀེ་=༣, དགོས་མཁོ་ཡི། NPoS སེལ་འཐུ་འབད་བའི་སྐབས་ `--vrf-seed-hex` X ལུ་ `iroha3-nexus` (རིམ་སྒྲིག་ `iroha3-nexus`, བསྡུ་སྒྲིག་པ་ k=5 r=3, NPoS སེལ་འཐུ་འབད་བའི་སྐབས་ `--vrf-seed-hex` དགོཔ་ཨིན།)
...
- དཔེ་ཚད་ཀྱི་བང་རིམ་: སྔོན་ལས་བཟོ་མི་ བང་རིམ་ཚུ་ `defaults/kagami/iroha3-{dev,testus,nexus}/` གི་འོག་ལུ་སྡོད་དོ་ཡོདཔ་ཨིན། `cargo xtask kagami-profiles [--profile <name>|all] [--out <dir>] [--kagami <bin>]` དང་མཉམ་དུ་བསྐྱར་བཟོ་འབད།
