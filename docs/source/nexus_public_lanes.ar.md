...
الحصص الفعالة والسحوبات المعلقة عبر `GET /v2/nexus/public_lanes/{lane}/stake` حتى تعرض
...
- **Torii/CLI quickstart:**
  ...
  - تستخدم ISIs دورة الحياة المسار القياسي للمعاملات (Torii `/v2/transactions`
...
- ✅ يعرض Torii `/v2/nexus/public_lanes/{lane}/{validators,stake,rewards/pending}` بترميز Norito JSON
