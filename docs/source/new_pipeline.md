...
```
- Basic example (CLI): `iroha bridge emit-receipt --lane "btc→iroha" --direction mint --source_tx 0x11.. --amount 1000 --asset_id wBTC#btc --recipient alice@main --proof_hash 0x33..`

{
  "src_chain": "iroha-mainnet",
  "dst_chain": "evm-eth",
  "payload": { "Mint": { "asset": "wBTC#btc", "to": "alice@main", "amount": "100000" } },
  "inclusion_path": "0x...",
  "header_hash": "0x..."
}
```
