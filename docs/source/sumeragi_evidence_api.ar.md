...
- GET `/v1/sumeragi/evidence`
  ...
  - معاملات الاستعلام: `limit` (default 50, max 1000)، `offset` (default 0)، `kind` (اختياري؛ احد `DoublePrevote|DoublePrecommit|InvalidQC|InvalidProposal|Censorship`).
