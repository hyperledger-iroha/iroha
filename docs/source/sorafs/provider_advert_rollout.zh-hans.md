...
source_hash: d57a50c641089d8d2600e970ebf2aed733dc82dba194753d6e5bcbed9aa99de0
source_last_modified: "2026-01-05T09:28:12.077837+00:00"
...
2. **Regenerate with provider tooling.**
   ...
   - Validate via `/v2/sorafs/providers` and `sorafs_fetch`; warnings about unknown
...
- **Incident response.** If `reject` alerts fire, on-call engineers:
  1. Fetch the offending advert via Torii discovery (`/v2/sorafs/providers`).
  2. Re-run advert validation in the provider pipeline and compare with
     `/v2/sorafs/providers` to reproduce the error.
...
- [SoraFS Node/Client Protocol](../sorafs_node_client_protocol.md)
- [Provider Admission Policy](provider_admission_policy.md)
- [Migration Roadmap](migration_roadmap.md)
- [Provider Advert Multi-Source Extensions](provider_advert_multisource.md)
