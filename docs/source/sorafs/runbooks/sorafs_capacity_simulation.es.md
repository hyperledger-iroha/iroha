...
El script invoca `sorafs_manifest_builder capacity` para emitir payloads Norito deterministas, codificaciones base64, cuerpos de solicitud para Torii y resúmenes JSON para:
