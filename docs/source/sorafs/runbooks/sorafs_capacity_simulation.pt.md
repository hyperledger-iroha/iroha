...
O script invoca `sorafs_manifest_builder capacity` para emitir payloads Norito determinísticos, codificações base64, corpos de requisição para Torii e resumos JSON para:
