...
- გაშვების დრო და CLI ავლენს ეტაპობრივ პარამეტრებს `/v1/sumeragi/params` და `iroha sumeragi params --summary`-ის მეშვეობით, ასე რომ ოპერატორებს შეუძლიათ დაადასტურონ აქტივაციის სიმაღლეები და i105... სია.
