...
# LLM კოორდინაციის მოთხოვნა

## მიზანი

ეს სწრაფი შაბლონები ეხმარება ინჟინერებს სწრაფად შეაგროვონ განმარტებები @mtakemiya-სგან
როდესაც საგზაო რუქის ელემენტები ღია კითხვებს ტოვებს. დააკოპირეთ ქვემოთ მოცემული ერთ-ერთი განყოფილება
LLM ძაფი, ჩაანაცვლეთ ფრჩხილებში ჩასმული ჩანაცვლების ველები და შეიტანეთ შესაბამისი ფაილი ან
ხაზოვანი მითითებები, ასე რომ კონტექსტი რჩება მიმაგრებული.

## არქიტექტურა ან დიზაინის გადაწყვეტილებები
...
## კონფიგურაცია ან ოპერატორის ხელმძღვანელობა
...
## კრიპტოგრაფია ან პროტოკოლის პრიმიტივები
...
## ტესტის ვექტორები ან მოწყობილობები
...
## გამოშვების ინჟინერია ან პროცესი
