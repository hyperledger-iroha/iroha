...
lang: mn
direction: ltr
source: docs/source/sdk/android/telemetry_schema_diff.md
status: complete
generator: scripts/sync_docs_i18n.py
source_hash: 11d0f99065e660b0200c2f43864ccf62ebc8ef6b8e6ed4800b7d0ab6a2de42a0
source_last_modified: "2025-12-29T18:16:36.055835+00:00"
...
|--------------|------------------------|-----------|------------------|
| `torii.http.request.authority` | `blake2b_256` hash | Prevents leaking operator endpoints from mobile traces while keeping the canonical Katakana i105 route observable on Rust. | `REQUIRED_ANDROID_REPRESENTATIONS` inside `tools/telemetry-schema-diff/src/main.rs` plus `telemetry-schema-diff` CLI gating; entries appear under `intentional_differences` when accepted. |
