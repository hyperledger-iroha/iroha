...
| 2026-07-12 | `769ce89c0686acecd107d91bbe5d7fdaf638e0e1fabf19cfe5d2b00d11115334` (`target-codex/android_codegen/instruction_manifest.json`) | first-release `RegisterPinManifest` schema migration | Regenerated the 104-entry manifest and builder catalog after folding the retired chunk digest into `manifest_payload` and retaining the epoch, alias, and successor fields. | Refreshed every Android generated instruction, builder, and manifest-catalog page and replayed the SoraFS pin-registration fixture. | `docs/source/sdk/android/generated/codegen_manifest_metadata.json`, `docs/source/sdk/android/generated/codegen_hash_tree.json`, `artifacts/android/codegen_parity_summary.json` |
