...
| `org.hyperledger.iroha.android.tools.PendingQueueInspector` | Generate queue hash/alias inventories | Built via `java/iroha_android/run_tests.sh`; outputs JSON for governance archives. |
