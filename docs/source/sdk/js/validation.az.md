...
- `ERR_INVALID_ACCOUNT_ID` — account identifiers must be canonical I105 account literals only; non-canonical I105 literals, any `@domain` suffix, canonical hex, `uaid:`, `opaque:`, and alias forms are rejected.
