...
# ထုတ်ပေးထားသော IVM Syscall Table

ဤဖိုင်ကို `crates/ivm_abi/src/syscalls.rs` မှထုတ်ပေးပါသည်။ syscall နံပါတ်များကိုပြောင်းလဲရန် အရင်းအမြစ်ကို တည်းဖြတ်ပါ။ ထို့နောက် ဤဇာတ်ညွှန်းကို ပြန်ဖွင့်ပါ။| အမည် | တန်ဖိုး ( hex ) | မှတ်ချက် |
|--------|----------------|------|
...
| SYSCALL_TRANSFER_V1 |  | SYSCALL_TRANSFER_ASSET | ၏အမည်များ
