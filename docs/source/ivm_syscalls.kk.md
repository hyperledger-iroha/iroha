...
| 0x22 | MINT_ASSET | `&AccountId`, `&AssetDefinitionId`, `&QuantityValueV1` | `u64=0` | `G_mint` | шотқа активтің `amount` теңгелері |
| 0x23 | BURN_ASSET | `&AccountId`, `&AssetDefinitionId`, `&QuantityValueV1` | `u64=0` | `G_burn` | | шотынан `amount` күйдіреді
