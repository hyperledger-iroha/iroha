...
3. **Manual smoke-** `irohad --sora --config configs/soranexus/nexus/config.toml --chain 0000…` သည် CBDC ဖိုင်များကိုညွှန်ပြသည့် manifest directory ပါရှိသော၊ ထို့နောက် `/v2/sumeragi/status` ကိုနှိပ်ပြီး CBDC လမ်းကြောအတွက် `lane_governance.manifest_ready=true` ကိုအတည်ပြုပါ။
