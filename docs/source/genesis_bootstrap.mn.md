...
- **Хүсэлтийн урсгал:** хадгалах сан хоосон, `genesis.file` тохируулаагүй үед (болон
  `genesis.bootstrap_enabled=true`), `genesis.expected_hash` нь гарын үсэгтэй генезис блокийг
  яг таг, заавал тогтоох ёстой. Файл болон хэш хоёулаа байхгүй бол ямар ч хүсэлт илгээхээс өмнө
  эхлүүлэх тохиргооны алдаа гарна. Дараа нь зангилаа ачааллыг татаж, гарын үсгийг `validate_genesis_block`-ээр баталгаажуулж,
...
- **Операторын алхмууд:** хамгийн багадаа нэг итгэмжлэгдсэн үе тэнгийнхэн хүчинтэй генезитэй холбогдох боломжтой эсэхийг баталгаажуулж, тохируулна уу.
  ...
  алсын bootstrap-ыг идэвхжүүлэхээс өмнө яг блокийг `expected_hash`-д тогтооно уу. Орон нутгийн гарын үсэгтэй
  `genesis.file` нь өөрөө тодорхой артефакт тул нэмэлт хэш шаардахгүй. Тогтвортой ачаалал байж болно
