...
бүх `/v2/da/ingest` мэдүүлэг. Torii нь манифестуудыг хэрэгжүүлэхтэй хамт дахин бичдэг
...
иж бүрдэл нь `/v2/da/ingest`-д тохирохгүй хадгалах бодлогыг илгээж, баталгаажуулдаг
