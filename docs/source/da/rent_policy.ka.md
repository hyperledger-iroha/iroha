...
|-------|-------------|---------|
| `base_rate_per_gib_month` | XOR ირიცხება თითო გიბაიტზე შენახვის თვეში. | `"0.25"` XOR |
...
| `egress_credit_per_gib` | კრედიტი გადახდილია, როდესაც პროვაიდერი ემსახურება DA მონაცემთა 1 გიბაიტს. | `"0.0015"` XOR |
...
საბოლოო `egress_credit_per_gib` ველი საშუალებას იძლევა დაფები და გადახდა
...
დაურთოთ Norito/JSON კოდირებული `DaRentPolicyV1` მმართველობის წინადადებებს ან დაქირავებას
