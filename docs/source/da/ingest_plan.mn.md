...
- `iroha app da get` нь аль хэдийн ажиллаж байгаа олон эх сурвалжийн найруулагчийн хувьд DA-д чиглэсэн өөр нэрийг нэмдэг.
  ...
  тасалбарын замыг ашиглаж байна CLI нь `/v2/da/manifests/<ticket>`-аас манифест татаж, багцыг үргэлжлүүлнэ
...
- `/v2/da/manifests` хариултууд одоо `manifest_hash` болон CLI + SDK туслах (`iroha app da get`,
...
- Пин бүртгэлийн паритет одоо SDK-д хүрч байна: `ToriiClient.registerSorafsPinManifest(...)`
  ...
  `/v2/sorafs/pin/register`. Энэ нь CI роботууд болон автоматжуулалтыг CLI руу нэвтрэхээс хамгаалдаг
...
- **PDP/PoTR дэгээ** — PDP амлалтууд нь бөөгнөрсөн дэлгүүрээс шууд гардаг бөгөөд хадгалагдах болно.
  ...
  `Sora-PDP-Commitment` толгой нь одоо `/v2/da/ingest` болон `/v2/da/manifests/{ticket}` хоёрын аль алинд нь нийлүүлэгддэг.
...
## Хэрэгжүүлэх тэмдэглэл- Torii-ийн `/v2/da/ingest` төгсгөлийн цэг нь ачааллын шахалтыг хэвийн болгож, дахин тоглуулах кэшийг ажиллуулж,
...
- Torii нь мөн `GET /v2/da/manifests/{storage_ticket}`-г ил гаргадаг тул SDK болон операторууд манифестуудыг татаж авах боломжтой.
...
Үе шаттай олдворыг хэрэглэснээр `POST /v2/da/ingest`. Амжилтгүй болсон сессийг тодорхой цуцалж болно
