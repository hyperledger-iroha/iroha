...
`/v2/da/ingest` میں پیش کیا گیا ، اس کے علاوہ بونس جو PDP/POTR عملدرآمد کو انعام دیتے ہیں اور
...
1. ** ingest: ** `/v2/da/ingest` فعال `DaRentPolicyV1` ، کوٹس کرایہ پر لوڈ کرتا ہے
...
- `torii_da_rent_gib_months_total`- Gib-months کے ذریعہ `/v2/da/ingest` کے ذریعہ حوالہ دیا گیا ہے۔
...
- ✅ `/v2/da/ingest` رسیدیں اب `rent_quote` کو سرایت کرتی ہیں اور CLI/SDK سطحوں کو حوالہ دیا گیا ہے
