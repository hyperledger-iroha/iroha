...
Este archivo se genera a partir de `crates/ivm/src/syscalls.rs`. Para cambiar los números de las syscalls, edita la fuente y vuelve a ejecutar este script.
