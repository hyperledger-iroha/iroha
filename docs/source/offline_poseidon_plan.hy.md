...
local prover inputs. Torii no longer exposes a legacy transfer-proof HTTP route; Offline V2 issue, redeem, and audit payloads are submitted as transaction instructions.
