...
- **მომთხოვნის ნაკადი:** როცა მეხსიერება ცარიელია და `genesis.file` არ არის დაყენებული (და
  `genesis.bootstrap_enabled=true`), `genesis.expected_hash`-მა ზუსტად უნდა დაამაგროს ხელმოწერილი
  გენეზისის ბლოკი. ფაილისა და ჰეშის ერთდროულად არქონა გაშვების კონფიგურაციის შეცდომაა
  ნებისმიერი მოთხოვნის გაგზავნამდე. შემდეგ კვანძი იღებს დატვირთვას და ამოწმებს ხელმოწერებს `validate_genesis_block`-ის საშუალებით,
...
- **ოპერატორის ნაბიჯები:** დარწმუნდით, რომ მინიმუმ ერთი სანდო თანატოლი ხელმისაწვდომია სწორი გენეზისით, კონფიგურაცია
  ...
  დისტანციური bootstrap-ის ჩართვამდე ზუსტი ბლოკი დაამაგრეთ `expected_hash`-ში. ლოკალური ხელმოწერილი
  `genesis.file` უკვე ცხადი არტეფაქტია და დამატებით ჰეშს არ საჭიროებს. მუდმივი დატვირთვა შეიძლება იყოს
