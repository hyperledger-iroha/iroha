...
| 0x22 | MINT_ASSET | `&AccountId`, `&AssetDefinitionId`, `&Amount` | `u64=0` | `G_mint` | Hisobga aktivning `amount` pul pullari |
| 0x23 | BURN_ASSET | `&AccountId`, `&AssetDefinitionId`, `&Amount` | `u64=0` | `G_burn` | Hisobdan `amount` kuyadi |
