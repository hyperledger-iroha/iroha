...
| 0x22 | 0x22 MINT_資產 | `&AccountId`、`&AssetDefinitionId`、`&Amount` | `u64=0` | `G_mint` |向賬戶鑄造 `amount` 資產 |
| 0x23 | 0x23 BURN_ASSET | 燒毀資產`&AccountId`、`&AssetDefinitionId`、`&Amount` | `u64=0` | `G_burn` |從帳戶中燒毀 `amount` |
