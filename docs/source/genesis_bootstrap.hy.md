...
- **Հարկողի հոսք.** երբ պահեստը դատարկ է, և `genesis.file` կարգավորված չէ (և
  `genesis.bootstrap_enabled=true`), `genesis.expected_hash`-ը պարտադիր պետք է ամրագրի ստորագրված
  գենեզիս բլոկի ճշգրիտ հեշը։ Թե՛ ֆայլի, թե՛ հեշի բացակայությունը մեկնարկային կազմաձևման
  սխալ է՝ նախքան որևէ հարցում ուղարկելը։ Այնուհետև հանգույցը վերցնում է բեռը և հաստատում ստորագրությունները `validate_genesis_block`-ի միջոցով,
...
- **Օպերատորի քայլեր.** համոզվեք, որ առնվազն մեկ վստահելի գործընկերոջ հասանելի է վավեր ծագումով, կազմաձևեք
  ...
  հեռակա bootstrap-ը միացնելուց առաջ ճշգրիտ բլոկն ամրագրեք `expected_hash`-ում։ Տեղական ստորագրված
  `genesis.file`-ն արդեն հստակ արտեֆակտ է և լրացուցիչ հեշ չի պահանջում։ Մշտական ծանրաբեռնվածությունը կարող է լինել
