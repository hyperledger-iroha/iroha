...
- ဆောက်လုပ်ရေးသမားများ
  - `NewAccount` မှတစ်ဆင့် `Account::new_in_domain(id, domain)` သည် တိကျပြတ်သားသော ဒိုမိန်းလင့်ခ်ချိတ်ထားသော မှတ်ပုံတင်ခြင်းကို အကောင်အထည်ပေါ်စေပြီး ထို့ကြောင့် `ScopedAccountId` လိုအပ်ပါသည်။
  - `NewAccount` သည် `Account::new(id)` မှတစ်ဆင့် ချိတ်ဆက်ထားသော ဒိုမိန်းမပါသော စကြာဝဠာအကောင့်အကြောင်းအရာကိုသာ မှတ်ပုံတင်သည်။
- Alias မော်ဒယ်
