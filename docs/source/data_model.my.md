...
- `ScopedAccountId { account: AccountId, domain: DomainId }` သည် ကန့်သတ်ထားသော မြင်ကွင်းတစ်ခု လိုအပ်မှသာ တိကျပြတ်သားသော ဒိုမိန်းအကြောင်းအရာကို သယ်ဆောင်ပေးပါသည်။
- `Account { id, metadata, label?, uaid?, linked_domains? }` — `label` သည် rekey မှတ်တမ်းများအသုံးပြုသော ရွေးချယ်နိုင်ဖွယ်တည်ငြိမ်သော alias တစ်ခုဖြစ်ပြီး `uaid` သည် ရွေးချယ်နိုင်သော Nexus-wide [Universal Account ID](Norito) နှင့် Norito canonical ဝိသေသလက္ခဏာ၏တစ်စိတ်တစ်ပိုင်းမဟုတ်ဘဲ အညွှန်းကိန်းပြည်နယ်မှ ဆင်းသက်လာသည်။
- ဆောက်လုပ်ရေးသမားများ
  - `NewAccount` မှတစ်ဆင့် `Account::new(scoped_id)` သည် တိကျပြတ်သားသော ဒိုမိန်းလင့်ခ်ချိတ်ထားသော မှတ်ပုံတင်ခြင်းကို အကောင်အထည်ပေါ်စေပြီး ထို့ကြောင့် `ScopedAccountId` လိုအပ်ပါသည်။
  - `NewAccount` သည် `Account::new_domainless(id)` မှတစ်ဆင့် ချိတ်ဆက်ထားသော ဒိုမိန်းမပါသော စကြာဝဠာအကောင့်အကြောင်းအရာကိုသာ မှတ်ပုံတင်သည်။
- Alias မော်ဒယ်
  - Canonical အကောင့်အထောက်အထားတွင် domain သို့မဟုတ် dataspace အပိုင်း ဘယ်သောအခါမှ မပါဝင်ပါ။
  - အကောင့်အတုအယောင်များသည် `AccountId` ၏ထိပ်တွင် သီးခြား SNS/ အကောင့်တံဆိပ်စည်းနှောင်မှုများဖြစ်သည်။
  - `merchant@hbl.sbp` ကဲ့သို့သော Domain-အရည်အချင်းပြည့်မီသော aliases များသည် alias binding တွင် domain တစ်ခုနှင့် dataspace နှစ်ခုလုံးကို သယ်ဆောင်သည်။
  - `merchant@sbp` ကဲ့သို့သော Dataspace-root aliases များသည် dataspace ကိုသာသယ်ဆောင်သောကြောင့် `Account::new_domainless(...)` နှင့် သဘာဝကျကျတွဲဖက်ပါ။
  - စမ်းသပ်မှုများနှင့် ပြင်ဆင်မှုများသည် universal `AccountId` ကို ဦးစွာ စေ့စပ်ထားသင့်ပြီး၊ ထို့နောက် domain လင့်ခ်များ၊ alias ငှားရမ်းမှုများ နှင့် alias ခွင့်ပြုချက်များကို အကောင့်အထောက်အထားကိုယ်တိုင်ကုဒ်သွင်းမည့်အစား သီးခြားစီထည့်သွင်းသင့်သည်။

### ပိုင်ဆိုင်မှု အဓိပ္ပါယ်ဖွင့်ဆိုချက်များနှင့် ပိုင်ဆိုင်မှုများ
- `AssetDefinitionId { aid_bytes: [u8; 16] }` ကို ဗားရှင်းရေးဆွဲခြင်းနှင့် checksum ဖြင့် ရှေ့မဆက်ထားသော Base58 လိပ်စာအဖြစ် စာသားအတိုင်း ဖော်ထုတ်ထားသည်။
- `AssetDefinition { id, name, description?, alias?, spec: NumericSpec, mintable: Mintable, logo: Option<SorafsUri>, metadata, owned_by: AccountId, total_quantity: Numeric }`။
  ...
  - Torii ပိုင်ဆိုင်မှု-အဓိပ္ပါယ်ဖွင့်ဆိုချက်များတွင် `alias_binding { alias, status, lease_expiry_ms, grace_until_ms, bound_at_ms }` ပါ၀င်နိုင်ပြီး `status` သည် `permanent`၊ `leased_active`၊ Kotodama သို့မဟုတ် Kotodama၊
  - Alias ​​ကြည်လင်ပြတ်သားမှုသည် node နံရံနာရီထက် နောက်ဆုံးသတ်မှတ်ထားသော ပိတ်ဆို့ချိန်တံဆိပ်ကို အသုံးပြုသည်။ `grace_until_ms` ကို ကျော်သွားသည်နှင့် တပြိုင်နက်၊ အတိုကောက် ရွေးချယ်မှုများသည် အမှိုက်ပုံးကို မဖယ်ရှားရသေးလျှင်ပင် ချက်ချင်းဖြေရှင်းခြင်း ရပ်သွားပါသည်။ တိုက်ရိုက်အဓိပ္ပါယ်ဖွင့်ဆိုချက်များသည် `expired_pending_cleanup` အဖြစ် နှောင်ကြိုးနှောင်ကြိုးကို အစီရင်ခံနိုင်သေးသည်။
...
- `EventBox`- ပိုက်လိုင်း၊ ပိုက်လိုင်း-အသုတ်၊ ဒေတာ၊ အချိန်၊ execute-trigger နှင့် အစပျိုးပြီးသော ဖြစ်ရပ်များအတွက် ပေါင်းစည်းအမျိုးအစား။ `EventFilterBox` သည် စာရင်းသွင်းမှုများနှင့် အစပျိုးသည့် စစ်ထုတ်မှုများအတွက် မှန်သည်။
...
- စိတ်ကြိုက်ကန့်သတ်ဘောင်များ- `Json` အဖြစ် ယူဆောင်လာကာ `CustomParameterId` (`Name`) မှ သတ်မှတ်ပေးထားသော စီမံအုပ်ချုပ်သူ-သတ်မှတ်ထားသည်။
...
- `InstructionBox`- အမျိုးအစား ID + ကုဒ်လုပ်ထားသော bytes မှတစ်ဆင့် အကောင်အထည်ဖော်ထားသော clone/eq/ord ပါရှိသော `Box<dyn Instruction>` wrapper
...
- `TransactionBuilder`- `chain`၊ `authority`၊ `creation_time_ms`၊ ချန်လှပ်ထားသော `time_to_live_ms` နှင့် `nonce`, Kotodama,018an `Executable`။
...
- ပါဝင်မှုဆိုင်ရာ အထောက်အထားများ (`BlockProofs`) သည် ဝင်ရောက်မှု/ရလဒ် Merkle အထောက်အထားများနှင့် `fastpq_transcripts` မြေပုံနှစ်ခုလုံးကို ဖော်ထုတ်နိုင်သောကြောင့် off-chain provers များသည် ငွေပေးငွေယူ hash တစ်ခုနှင့် ဆက်စပ်နေသည့် လွှဲပြောင်းသည့် မြစ်ဝကျွန်းပေါ်ဒေသများကို ထုတ်ယူနိုင်ပါသည်။
- `ExecWitness` မက်ဆေ့ဂျ်များ (Torii မှတစ်ဆင့် ထုတ်လွှင့်ပြီး အများဆန္ဒအရ အတင်းအဖျင်းအလို့ငှာ ကျောထောက်နောက်ခံပြုထားသော) သည် ယခုအခါ `fastpq_transcripts` နှင့် မြှုပ်နှံထားသော `fastpq_batches: Vec<FastpqTransitionBatch>` နှင့် မြှုပ်နှံထားသော `fastpq_batches: Vec<FastpqTransitionBatch>` နှစ်ခုလုံးပါဝင်သည် tx_set_hash) ထို့ကြောင့် ပြင်ပသက်သေများသည် စာသားမှတ်တမ်းများကို ပြန်လည်ကုဒ်သွင်းခြင်းမပြုဘဲ canonical FASTPQ အတန်းများကို ထည့်သွင်းနိုင်သည်။
...
- ရိုက်ဖျက်ထားသော ပုံစံများ-
  - `QueryBox<T>` သည် ကမ္ဘာလုံးဆိုင်ရာ မှတ်ပုံတင်ခြင်းမှ ကျောထောက်နောက်ခံပြုထားသော Norito serde ပါသော `Query<Item = T>` ကို ဖျက်လိုက်သော သေတ္တာတစ်ခုဖြစ်သည်။
...
- Registry နှင့် codecs:
  ...
  - `QueryOutputBatchBox` သည် တစ်သားတည်းဖြစ်တည်နေသော vector များထက် ပေါင်းလဒ်အမျိုးအစား (ဥပမာ၊ `Vec<Account>`၊ ​​`Vec<Name>`၊ `Vec<AssetDefinition>`၊ `Vec<BlockHeader>`) နှင့် tuple နှင့် extension helpers များ။
- DSL- အချိန်-စစ်ဆေးထားသော ပရောဂျက်များနှင့် ရွေးချယ်သူများအတွက် ပရိုဂရမ်ဆိုင်ရာ လက္ခဏာများ (`HasProjection<PredicateMarker>` / `SelectorMarker`) ဖြင့် `query::dsl` တွင် အကောင်အထည်ဖော်ထားသည်။ `fast_dsl` အင်္ဂါရပ်သည် လိုအပ်ပါက ပိုမိုပေါ့ပါးသော မူကွဲတစ်ခုကို ဖော်ထုတ်ပေးပါသည်။
...
## မက်တာဒေတာ- `Metadata(BTreeMap<Name, Json>)`- သော့/တန်ဖိုးစတိုးဆိုင်များစွာ (`Domain`၊ `Account`၊ `AssetDefinition`၊ `Nft`၊ အစပျိုးမှုများ၊ နှင့် အရောင်းအဝယ်များ)။
- API: `contains`, `iter`, `get`, `insert`, နှင့် (`transparent_api`) `remove`။

## အင်္ဂါရပ်များနှင့် သတ်မှတ်ချက်များ

- စိတ်ကြိုက်ရွေးချယ်နိုင်သော API များ (`std`၊ `json`၊ `transparent_api`၊ `ffi_export`၊ `ffi_import`၊ `fast_dsl`၊ I018NI0000033450 `fault_injection`)။
...
- `asset + account + optional scope` ဖြင့် ပိုင်ဆိုင်သော လက်ကျန်ငွေများကို အများသူငှာ ရှာဖွေခြင်းလိပ်စာ၊ အကြမ်းထည် encoded `AssetId` literals များသည် အတွင်းပိုင်းကိုယ်စားပြုမှုဖြစ်ပြီး Torii/CLI ရွေးချယ်မှုမျက်နှာပြင်၏ အစိတ်အပိုင်းမဟုတ်ပါ။
- `POST /v1/assets/definitions/query` နှင့် `GET /v1/assets/definitions` နှင့် `alias_binding.status`၊ `alias_binding.lease_expiry_ms`၊ `alias_binding.grace_until_ms` နှင့် `name#domain` နှင့် `name#domain` တို့အပြင် `name#domain` နှင့် Kotodama `name`၊ `alias` နှင့် `metadata.*`။
