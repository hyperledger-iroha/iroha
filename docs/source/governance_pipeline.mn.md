...
- Баталгаажуулагчийн буруутай үйлдлийг `NextMode` + `ModeActivationHeight`-ээр баталгаажуулсан нотлох баримтын шугамаар (`/v2/sumeragi/evidence*`, CLI туслахууд) хариуцдаг.
