...
| 0x22 | MINT_ASSET | `&AccountId`, `&AssetDefinitionId`, `&Amount` | `u64=0` | `G_mint` | Դրամահատարաններ `amount` ակտիվների հաշվին |
| 0x23 | ԱՅՐՎԱԾ_ԱԿՏԻՎ | `&AccountId`, `&AssetDefinitionId`, `&Amount` | `u64=0` | `G_burn` | Այրվում է `amount` հաշվից |
