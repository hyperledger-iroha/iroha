...
| 0x22 | MINT_ASSET | `&AccountId`, `&AssetDefinitionId`, `&QuantityValueV1` | `u64=0` | `G_mint` | Դրամահատարաններ `amount` ակտիվների հաշվին |
| 0x23 | ԱՅՐՎԱԾ_ԱԿՏԻՎ | `&AccountId`, `&AssetDefinitionId`, `&QuantityValueV1` | `u64=0` | `G_burn` | Այրվում է `amount` հաշվից |
...
| 0x27 | NFT_SET_METADATA | `&NftId`, `&Name`, `&Json` | `u64=0` | `G_nft_set_metadata` | Թարմացնում է NFT մետատվյալները |
