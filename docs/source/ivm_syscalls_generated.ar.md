<!-- Arabic translation of docs/source/ivm_syscalls_generated.md -->
...
# جدول نداءات نظام IVM المُولَّد

يُولَّد هذا الملف انطلاقًا من `crates/ivm_abi/src/syscalls.rs`. لتغيير أرقام النداءات، عدِّل الشيفرة المصدرية ثم أعد تشغيل هذا البرنامج النصي.
...
ملاحظة: تُحل الأسماء المستعارة إلى قيمة الثابت الهدف أثناء الترجمة البرمجية.
