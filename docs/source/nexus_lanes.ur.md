...
- `LaneCatalog`, `LaneMetadata`, اور `DataSpaceCatalog` `iroha_data_model::nexus` میں رہتے ہیں اور manifests اور SDKs کے لئے Norito-compatible structures فراہم کرتے ہیں۔
