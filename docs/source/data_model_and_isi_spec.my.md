...
- `AccountId` — Canonical လိပ်စာများကို `AccountAddress` (I105 / hex) နှင့် Torii သည် `AccountAddress::parse_encoded` မှတဆင့် သွင်းအားများကို ပုံမှန်ဖြစ်စေသည်။ I105 သည် ဦးစားပေးအကောင့်ဖော်မတ်ဖြစ်သည်။ `i105` ဖောင်သည် Sora-only UX အတွက် ဒုတိယအကောင်းဆုံးဖြစ်သည်။ အကျွမ်းတဝင်ရှိသော `alias` (rejected legacy form) စာကြောင်းကို လမ်းကြောင်းပြောင်းခြင်းအဖြစ်သာ သိမ်းဆည်းထားသည်။ အကောင့်- `{ id, metadata }`။ ကုဒ်- `crates/iroha_data_model/src/account.rs`။
