...
- NEW_VIEW height floor: cached NEW_VIEW entries below the active round height (`highest_qc.height + 1` or committed tip + 1) are discarded so proposals cannot regress after a higher commit certificate is observed.
