...
| 0x22 | MINT_ASSET | `&AccountId`, `&AssetDefinitionId`, `&Amount` | `u64=0` | `G_mint` | ზარაფხანა `amount` აქტივის ანგარიშზე |
| 0x23 | BURN_ASSET | `&AccountId`, `&AssetDefinitionId`, `&Amount` | `u64=0` | `G_burn` | წვავს `amount` ანგარიშიდან |
