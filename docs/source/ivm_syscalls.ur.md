...
| 0x22 | ٹکسال_اسیٹ | `&AccountId` ، `&AssetDefinitionId` ، `&QuantityValueV1` | `u64=0` | `G_mint` | اکاؤنٹ میں اثاثہ کے ٹکسال `amount` |
| 0x23 | برن_اسیٹ | `&AccountId` ، `&AssetDefinitionId` ، `&QuantityValueV1` | `u64=0` | `G_burn` | اکاؤنٹ سے `amount` برنز |
