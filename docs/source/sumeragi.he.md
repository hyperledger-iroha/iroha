...
- **לידר**: בעת צפייה לבלוק (טרנזקציות בתור או הורה נעול שזקוק לבלוק ילד) והדד-ליין מתקרב – משדר `BlockCreated`. כאשר התור ריק ואין צורך בהתאוששות empty-child, הפייסמייקר נשאר idle ואינו שולח הצעות heartbeat.
