...
### דרישות מפתח ולידטור
- ולידטורים חייבים להשתמש במפתחות BLS-Normal ולהציג הוכחת החזקה (PoP). באתחול (גובה 0), ב-NPoS מעדיפים את רשימת הוולידטורים הפעילים במסלול הציבורי מהסטייקינג; כאשר אין ולידטורים פעילים, נופלים חזרה ל-`trusted_peers` לאחר סינון עמיתים ללא BLS-Normal או עם PoP חסר/שגוי.
