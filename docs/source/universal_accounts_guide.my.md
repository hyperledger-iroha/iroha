...
- `ScopedAccountId { account, domain }` သည် ကြည့်ရှုမှုများအတွက် တိကျပြတ်သားသော ဒိုမိန်းအကြောင်းအရာဖြစ်သည်။
  ဒိုမိန်းလင့်ခ်တစ်ခု အကောင်အထည်ပေါ်လာစေမည့် မှတ်ပုံတင်မှုများ။ ဒါဟာ ဒုတိယကျမ်းဂန်မဟုတ်ပါဘူး။
  အထောက်အထား
- SNS/account aliases များသည် ထိုအကြောင်းအရာ၏ထိပ်တွင် သီးခြားနှောင်ကြိုးများဖြစ်သည်။ တစ်
...
- သိမ်းဆည်းထားသော အကောင့်မှတ်တမ်းများပေါ်ရှိ `linked_domains` သည် ပြည်နယ်မှ ဆင်းသက်လာသည်။
  အကောင့်ဒိုမိန်း အညွှန်းကိန်းများ။ ၎င်းသည် ၎င်းအတွက် လက်ရှိရုပ်လုံးပေါ်လာသော လင့်ခ်များကို ဖော်ပြသည်။
  ဘာသာရပ်; ၎င်းသည် canonical identifier ၏ အစိတ်အပိုင်းမဟုတ်ပါ။

အော်ပရေတာများ၊ SDK နှင့် စမ်းသပ်မှုများအတွက် အကောင်အထည်ဖော်မှုစည်းမျဉ်း- canonical မှ စတင်သည်။
`AccountId`၊ ထို့နောက် နာမည်တူငှားရမ်းမှုများ၊ ဒေတာနေရာ/ဒိုမိန်းခွင့်ပြုချက်များကို ပေါင်းထည့်ကာ ပြတ်သားစွာ
ဒိုမိန်းလင့်ခ်များ သီးခြားစီ။ domain-scoped canonical အတုကို မပေါင်းစပ်ပါနှင့်
အကောင့်အမည်များ သို့မဟုတ် လမ်းကြောင်းတစ်ခုသည် ဒိုမိန်းအပိုင်းကို သယ်ဆောင်ထားသောကြောင့်ဖြစ်သည်။
...
| `GET /v1/identifier-policies` | ရွေးချယ်နိုင်သော BFV `input_encryption` ပါရာမီတာများ၊ ကုဒ်ဝှက်ထားသော client-side input အတွက် လိုအပ်သော `normalization` မုဒ် နှင့် `ram_fhe_profile` အပါအဝင် ၎င်းတို့၏ အများသုံး လျှို့ဝှက်လုပ်ဆောင်ချက် မူဝါဒ namespaces နှင့် ၎င်းတို့၏ အများသူငှာ မက်တာဒေတာများကို စာရင်းပြုစုထားသည်။ |
| `POST /v1/accounts/{account_id}/identifiers/claim-receipt` | `{ input }` သို့မဟုတ် `{ encrypted_input }` ကို အတိအကျ လက်ခံပါသည်။ Plaintext `input` သည် ပုံမှန်ဆာဗာ-ခြမ်းဖြစ်သည်။ BFV `encrypted_input` ကို ထုတ်ပြန်ထားသည့် မူဝါဒမုဒ်အရ ပုံမှန်ပြန်ဖြစ်ရပါမည်။ ထို့နောက် အဆုံးမှတ်သည် `opaque:` လက်ကိုင်ကို ထုတ်ယူပြီး `ClaimIdentifier` အပါအဝင် အကြမ်းထည် `signature_payload_hex` နှင့် ခွဲခြမ်းစိတ်ဖြာထားသော `signature_payload` အပါအဝင် ကွင်းဆက်တွင် တင်ပြနိုင်သည့် လက်မှတ်ရေးထိုးထားသော ပြေစာကို ပြန်ပေးသည်။ || `POST /v1/identifiers/resolve` | `{ input }` သို့မဟုတ် `{ encrypted_input }` ကို အတိအကျ လက်ခံပါသည်။ Plaintext `input` သည် ပုံမှန်ဆာဗာ-ခြမ်းဖြစ်သည်။ BFV `encrypted_input` ကို ထုတ်ပြန်ထားသည့် မူဝါဒမုဒ်အရ ပုံမှန်ပြန်ဖြစ်ရပါမည်။ လက်ရှိအရေးဆိုမှုတစ်ခုရှိသည့်အခါ အဆုံးအမှတ်သည် `{ opaque_id, receipt_hash, uaid, account_id, signature }` တွင် identifier ကို ဖြေရှင်းပေးပြီး `{ signature_payload_hex, signature_payload }` အဖြစ် canonical signed payload ကို ပြန်ပေးသည်။ |
| `GET /v1/identifiers/receipts/{receipt_hash}` | သတ်မှတ်ထားသော ပြေစာ hash နှင့် ဆက်စပ်နေသည့် ဆက်ရှိနေသော `IdentifierClaimRecord` ကို ရှာကြည့်ခြင်းဖြင့် အော်ပရေတာများနှင့် SDK များသည် ပိုင်ဆိုင်မှုတောင်းဆိုမှုကို စာရင်းစစ်နိုင်သည် သို့မဟုတ် အထောက်အထားအပြည့်အစုံကို စကင်န်မဖတ်ဘဲ ပြန်လည်ကစားခြင်း/ မကိုက်ညီမှု ကျရှုံးမှုများကို အဖြေရှာနိုင်မည်ဖြစ်သည်။ |
...
လက်ရှိ SDK ပံ့ပိုးမှု-- `normalizeIdentifierInput(value, normalization)` သည် Rust နှင့် ကိုက်ညီသည်။
...
- `ClaimIdentifier` (ပြေစာ-ဘောင်၊ အကြမ်း `opaque_id` အရေးဆိုမှုများကို ပယ်ချပါသည်)
- `RevokeIdentifier`

ယခု `iroha_crypto::ram_lfe` တွင် နောက်ခံသုံးခု ရှိပါသည်။

- သမိုင်းဝင် ကတိကဝတ်-နှောင်ကြိုး `HKDF-SHA3-512` PRF နှင့်
...
ဥပမာ CLI စက်ရှင် (Torii URL `torii_api_url` မှတဆင့် ပြင်ဆင်သတ်မှတ်ထားသော `iroha.json`)
...
သတ်မှတ်ထားသောခေတ်တွင် မည်သို့သော ချည်နှောင်မှုများ လှုပ်ရှားခဲ့သနည်း။

## 4. ထုတ်ဝေခြင်းစွမ်းရည်သည် အထောက်အထားများဖြင့် ထင်ရှားသည်။
...
- [ ] CLI/Torii ခေါ်ဆိုမှုအတွက် ပြေစာ (stdout သို့မဟုတ် `--json-out` artefact)။
- [ ] `SpaceDirectoryEvent` payload ကို အသက်သွင်းခြင်းကို သက်သေပြခြင်း။
...
3. `notes` သည် စည်းကမ်းထိန်းသိမ်းရေးအဖွဲ့၏မူဝါဒအကိုးအကားများပါရှိပါသည် (MiCA ဆောင်းပါး၊ JFSA
   စက်ဝိုင်း စသဖြင့်)။
4. Allowance windows (`PerSlot`၊ `PerMinute`၊ `PerDay`) နှင့် ရွေးချယ်နိုင်သည်
   `max_amount` ထုပ်များကြောင့် SDKs များသည် host ကဲ့သို့တူညီသောကန့်သတ်ချက်များကိုလိုက်နာသည်။
...
- **API ခေါ်ဆိုမှုများ-** domain-scoped portfolio queries ဖြင့် အစားထိုးပါ။
  `GET /v1/accounts/{uaid}/portfolio` နှင့် manifest/binding endpoints
...
- `crates/iroha_cli/src/space_directory.rs` — CLI အကောင်အထည်ဖော်မှုကို ကိုးကားထားသည်။
  ဤလမ်းညွှန်။
