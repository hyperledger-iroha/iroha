...
Benchmarklar skaler, ish vaqtini avtomatik aniqlash va majburiy NEON yugurishlarini (median, mks) solishtiradi.
...
Metadata: skalar={'cpu': 'm3-pro-local', 'target_arch': 'aarch64', 'target_os': 'macos'}, auto={'cpu': 'm3-pro-local', 'target_arch': 'aarch64',''cos','ma' neon-force={'cpu': 'm3-pro-local', 'target_arch': 'aarch64', 'target_os': 'makos'}.

### SM Performance snapshot (x86_64 Rosetta, Apple M3 Pro)

Benchmarklar Rosetta ostida olingan skaler, ish vaqti avtomatik aniqlash va majburiy NEON yugurishlarini (median, mks) solishtiradi.| Benchmark | Skalar | Avto | Neon-Force | Avto va Skalar | Neon vs Skalar | Neon vs Avto |
|----------|--------|------|------------|----------------|---------------|--------------|
...
Metadata: skalar={'cpu': 'm3-pro-rosetta', 'target_arch': 'x86_64', 'target_os': 'macos'}, auto={'cpu': 'm3-pro-rosetta', 'target_arch': 'x86':''s'_6', neon-force={'cpu': 'm3-pro-rosetta', 'target_arch': 'x86_64', 'target_os': 'makos'}.