...
### SM Performans Snapshot (Apple Silicon)

Benchmarklar skalyar, işləmə vaxtının avtomatik aşkarlanması və məcburi NEON qaçışlarını (median, µs) müqayisə edir.
...
Metadata: skalar={'cpu': 'm3-pro-local', 'target_arch': 'aarch64', 'target_os': 'macos'}, auto={'cpu': 'm3-pro-local', 'target_arch': 'aarch64','_cos':' neon-force={'cpu': 'm3-pro-local', 'target_arch': 'aarch64', 'target_os': 'makos'}.

### SM Performans Snapshot (x86_64 Rosetta, Apple M3 Pro)

Benchmarklar Rosetta altında çəkilmiş skalyar, işləmə müddətinin avtomatik aşkarlanması və məcburi NEON qaçışlarını (medianlar, µs) müqayisə edir.| Benchmark | Skalyar | Avto | Neon-Force | Avto vs Skalar | Neon vs Skalar | Neon vs Avto |
|----------|--------|------|------------|----------------|---------------|--------------|
...
Metadata: skalar={'cpu': 'm3-pro-rosetta', 'target_arch': 'x86_64', 'target_os': 'macos'}, auto={'cpu': 'm3-pro-rosetta', 'target_arch': 'x86':''s' neon-force={'cpu': 'm3-pro-rosetta', 'target_arch': 'x86_64', 'target_os': 'makos'}.