...
### Instantâneo de desempenho SM (Apple Silicon)

Os benchmarks comparam escalar, detecção automática de tempo de execução e execuções NEON forçadas (medianas, µs).
...
| sm2_vs_ed25519_verificar/verificar/ed25519 |    35,43 |  35,80 |      35,47 |      +1,04% |       +0,12% |      -0,91% |
| sm2_vs_ed25519_verificar/verificar/sm2 |   270,66 | 269,30 |     269,28 |      -0,50% |       -0,51% |      -0,01% |
...
Metadados: scalar={'cpu': 'm3-pro-local', 'target_arch': 'aarch64', 'target_os': 'macos'}, auto={'cpu': 'm3-pro-local', 'target_arch': 'aarch64', 'target_os': 'macos'}, neon-force={'cpu': 'm3-pro-local', 'target_arch': 'aarch64', 'target_os': 'macos'}.

### Instantâneo de desempenho SM (x86_64 Rosetta, Apple M3 Pro)

Os benchmarks comparam a detecção automática escalar, em tempo de execução e as execuções NEON forçadas (medianas, µs) capturadas no Rosetta.| Referência | Escalar | Automóvel | Força Neon | Automático vs Escalar | Néon vs Escalar | Néon vs Automóvel |
|-----------|--------|------|------------|----------------|---------------|--------------|
...
Metadados: escalar={'cpu': 'm3-pro-rosetta', 'target_arch': 'x86_64', 'target_os': 'macos'}, auto={'cpu': 'm3-pro-rosetta', 'target_arch': 'x86_64', 'target_os': 'macos'}, neon-force={'cpu': 'm3-pro-rosetta', 'target_arch': 'x86_64', 'target_os': 'macos'}.