...
- [ ] Torii `/v2/node/capabilities` գովազդը (`iroha runtime capabilities`-ի միջոցով) գրանցված՝ ստուգելով `crypto.sm` մանիֆեստի դաշտերը և արագացման քաղաքականության նկարը:
