...
| SM4 | GB/T32907 | GM/T0002 | 128-ቢት የማገጃ ሲፈር; Iroha GCM/CCM ረዳቶችን ያቀርባል እና በትግበራዎች ላይ ትልቅ-ኢንዲያን እኩልነትን ያረጋግጣል። |- **የችሎታ መግለጫ፡** Torii `/v2/node/capabilities` የመጨረሻ ነጥብ የሚከተለውን የJSON ቅርፅ ያስተዋውቃል ኦፕሬተሮች እና መሳሪያዎች የኤስኤም ኤን ኤን ኤን ፕረማሲያዊ በሆነ መንገድ ሊጠቀሙበት ይችላሉ።
