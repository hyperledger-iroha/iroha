...
### SM өнімділігінің суреті (Apple Silicon)

Эталондар скалярды, орындалу уақытын автоматты анықтауды және мәжбүрлі NEON жүгірістерін (медиандар, мкс) салыстырады.
...
Метадеректер: skalar={'cpu': 'm3-pro-local', 'target_arch': 'aarch64', 'target_os': 'macos'}, auto={'cpu': 'm3-pro-local', 'target_arch': 'aarch64'_s':'maget neon-force={'cpu': 'm3-pro-local', 'target_arch': 'aarch64', 'target_os': 'macos'}.

### SM өнімділігінің суреті (x86_64 Rosetta, Apple M3 Pro)

Эталондар Rosetta астында түсірілген скалярды, орындалу уақытын автоматты анықтауды және мәжбүрлі NEON жүгірістерін (медиандар, мкс) салыстырады.| Эталон | Скалярлық | Авто | Neon-Force | Автоматты және скалярлық | Неон скалярға қарсы | Neon vs Auto |
|----------|--------|------|------------|----------------|---------------|--------------|
...
Метадеректер: skalar={'cpu': 'm3-pro-rosetta', 'target_arch': 'x86_64', 'target_os': 'macos'}, auto={'cpu': 'm3-pro-rosetta', 'target_arch': 'x86_arch': 'x86''},'_64', neon-force={'cpu': 'm3-pro-rosetta', 'target_arch': 'x86_64', 'target_os': 'macos'}.