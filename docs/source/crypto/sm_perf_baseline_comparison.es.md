...
### Instantánea de rendimiento de SM (Apple Silicon)

Los puntos de referencia comparan ejecuciones escalares, de detección automática en tiempo de ejecución y de NEON forzadas (medianas, µs).
...
Metadatos: escalar={'cpu': 'm3-pro-local', 'target_arch': 'aarch64', 'target_os': 'macos'}, auto={'cpu': 'm3-pro-local', 'target_arch': 'aarch64', 'target_os': 'macos'}, neon-force={'cpu': 'm3-pro-local', 'target_arch': 'aarch64', 'target_os': 'macos'}.

### Instantánea de rendimiento de SM (x86_64 Rosetta, Apple M3 Pro)

Los puntos de referencia comparan ejecuciones escalares, de detección automática en tiempo de ejecución y de NEON forzadas (medianas, µs) capturadas en Rosetta.| Punto de referencia | Escalar | Automático | Fuerza de neón | Automático frente a escalar | Neón vs Escalar | Neón vs Auto |
|-----------|--------|------|------------|----------------|---------------|--------------|
...
Metadatos: escalar={'cpu': 'm3-pro-rosetta', 'target_arch': 'x86_64', 'target_os': 'macos'}, auto={'cpu': 'm3-pro-rosetta', 'target_arch': 'x86_64', 'target_os': 'macos'}, neon-force={'cpu': 'm3-pro-rosetta', 'target_arch': 'x86_64', 'target_os': 'macos'}.