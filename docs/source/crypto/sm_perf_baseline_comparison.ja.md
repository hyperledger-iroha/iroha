...
### SM パフォーマンス スナップショット (Apple Silicon)

ベンチマークは、スカラー、ランタイム自動検出、強制 NEON 実行 (中央値、μs) を比較します。
...
| sm2_vs_ed25519_verify/検証/ed25519 |    35.43 |  35.80 |      35.47 |      +1.04% |       +0.12% |      -0.91% |
| sm2_vs_ed25519_verify/検証/sm2 |   270.66 | 269.30 |     269.28 |      -0.50% |       -0.51% |      -0.01% |
| sm3_vs_sha256_hash/sha256_hash |    11.59 |  11.61 |      11.62 |      +0.18% |       +0.24% |      +0.06% |
| sm3_vs_sha256_ハッシュ/sm3_ハッシュ |    11.34 |  57.95 |      57.94 |    +410.90% |     +410.86% |      -0.01% |
...
メタデータ: scalar={'cpu': 'm3-pro-local'、'target_arch': 'aarch64'、'target_os': 'macos'}、auto={'cpu': 'm3-pro-local'、'target_arch': 'aarch64'、'target_os': 'macos'}、neon-force={'cpu': 'm3-pro-local'、'target_arch': 'aarch64'、'target_os': 'macos'}。

### SM パフォーマンス スナップショット (x86_64 Rosetta、Apple M3 Pro)

ベンチマークは、Rosetta でキャプチャされたスカラー、ランタイム自動検出、および強制 NEON 実行 (中央値、μs) を比較します。|ベンチマーク |スカラー |自動 |ネオンフォース |オート vs スカラー |ネオン vs スカラー |ネオン vs オート |
|----------|----------|------|----------|-----|--------------|--------------|
...
メタデータ: スカラー={'cpu': 'm3-pro-rosetta', 'target_arch': 'x86_64', 'target_os': 'macos'}, auto={'cpu': 'm3-pro-rosetta', 'target_arch': 'x86_64', 'target_os': 'macos'}, neon-force={'cpu': 'm3-pro-rosetta'、'target_arch': 'x86_64'、'target_os': 'macos'}。