...
### Снимок производительности SM (Apple Silicon)

В тестах сравниваются скалярные, автоматические и принудительные запуски NEON (медианы, мкс).
...
Метаданные: scalar={'cpu': 'm3-pro-local', 'target_arch': 'aarch64', 'target_os': 'macos'}, auto={'cpu': 'm3-pro-local', 'target_arch': 'aarch64', 'target_os': 'macos'}, neon-force={'cpu': 'm3-pro-local', 'target_arch': 'aarch64', 'target_os': 'macos'}.

### Снимок производительности SM (x86_64 Rosetta, Apple M3 Pro)

В тестах сравниваются скалярные, автоматические определения во время выполнения и принудительные прогоны NEON (медианы, мкс), полученные в Rosetta.| Бенчмарк | Скаляр | Авто | Неоновая сила | Авто против Скаляра | Неон против Скаляра | Неон против Авто |
|-----------|--------|------|------------|----------------|---------------|--------------|
...
Метаданные: scalar={'cpu': 'm3-pro-rosetta', 'target_arch': 'x86_64', 'target_os': 'macos'}, auto={'cpu': 'm3-pro-rosetta', 'target_arch': 'x86_64', 'target_os': 'macos'}, neon-force={'cpu': 'm3-pro-rosetta', 'target_arch': 'x86_64', 'target_os': 'macos'}.