...
- [ ] Torii `/v2/node/capabilities` зар (`iroha runtime capabilities`-ээр) бүртгэгдэж, `crypto.sm` манифест талбарууд болон хурдатгалын бодлогын агшин зургийг баталгаажуулж байна.
