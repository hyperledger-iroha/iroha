...
### Instantané des performances SM (Apple Silicon)

Les benchmarks comparent les exécutions scalaires, la détection automatique d'exécution et les exécutions NEON forcées (médianes, µs).
...
| sm3_vs_sha256_hash/sha256_hash |    11h59 |  11.61 |      11.62 |      +0,18% |       +0,24% |      +0,06% |
| sm3_vs_sha256_hash/sm3_hash |    11h34 |  57,95 |      57,94 |    +410,90% |     +410,86% |      -0,01% |
| sm4_vs_chacha20poly1305_decrypt/chacha20poly1305_decrypt |     1,89 |   1,89 |       1,90 |      -0,04% |       +0,47% |      +0,51% |
| sm4_vs_chacha20poly1305_decrypt/sm4_gcm_decrypt |    16.02 |  16h05 |      16.06 |      +0,20% |       +0,30% |      +0,10% |
...
Métadonnées : scalar={'cpu' : 'm3-pro-local', 'target_arch' : 'aarch64', 'target_os' : 'macos'}, auto={'cpu' : 'm3-pro-local', 'target_arch' : 'aarch64', 'target_os' : 'macos'}, neon-force={'cpu' : 'm3-pro-local', 'target_arch' : 'aarch64', 'target_os' : 'macos'}.

### Instantané des performances SM (x86_64 Rosetta, Apple M3 Pro)

Les benchmarks comparent les exécutions scalaires, de détection automatique d'exécution et de NEON forcées (médianes, µs) capturées sous Rosetta.| Référence | Scalaire | Automobile | Néon-Force | Auto vs Scalaire | Néon vs Scalaire | Néon contre Auto |
|---------------|--------|------|------------|----------------|---------------|--------------|
...
Métadonnées : scalar={'cpu' : 'm3-pro-rosetta', 'target_arch' : 'x86_64', 'target_os' : 'macos'}, auto={'cpu' : 'm3-pro-rosetta', 'target_arch' : 'x86_64', 'target_os' : 'macos'}, neon-force={'cpu' : 'm3-pro-rosetta', 'target_arch' : 'x86_64', 'target_os' : 'macos'}.