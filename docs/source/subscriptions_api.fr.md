...
```json
{
  ...
  "plan": { "provider": "soraカタカナ...", "billing": { "...": "..." }, "pricing": { "...": "..." } }
}
```
Response:
```json
...
```json
{ "authority": "soraカタカナ...", "private_key": "<hex>", "cancel_mode": "immediate" }
```
or
```json
{ "authority": "soraカタカナ...", "private_key": "<hex>", "cancel_mode": "period_end" }
```
