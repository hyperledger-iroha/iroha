...
# LLM համակարգման հուշումներ

## Նպատակը

Այս արագ ձևանմուշները օգնում են ինժեներներին արագ պարզաբանումներ հավաքել @mtakemiya-ից
երբ ճանապարհային քարտեզի կետերը բաց հարցեր են թողնում: Պատճենեք ստորև բերված բաժիններից մեկը
LLM շարանը, փոխարինեք փակագծերում տեղադրված տեղապահները և ներառեք համապատասխան ֆայլ կամ
տողերի հղումներ, որպեսզի համատեքստը մնա խարսխված:

## Ճարտարապետության կամ դիզայնի որոշումներ
...
## Կազմաձևում կամ Օպերատորի ուղեցույց
...
## Կրիպտոգրաֆիա կամ արձանագրության պրիմիտիվներ
...
## Փորձարկման վեկտորներ կամ հարմարանքներ
...
## Թողարկման ճարտարագիտություն կամ գործընթաց
