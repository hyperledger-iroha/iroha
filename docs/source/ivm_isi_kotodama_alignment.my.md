...
- Codegen (`kotodama::compiler`) သည် IVM ops ၏ အခွဲတစ်ခုကို ထုတ်လွှတ်ပြီး ပိုင်ဆိုင်မှုဆိုင်ရာ လုပ်ဆောင်ချက်များအတွက် `SCALL` ကို အသုံးပြုသည်-
  ...
  - `BurnAsset`/`TransferAsset` အလားတူ (ပမာဏကို QuantityValueV1 ညွှန်ပြချက်အဖြစ် ကျော်သွားသည်)။
...
- SYSCALL_MINT_ASSET(အကောင့်- ptr AccountId၊ ပိုင်ဆိုင်မှု- ptr AssetDefinitionId၊ ပမာဏ- ptr QuantityValueV1) → ISI Mint
- SYSCALL_BURN_ASSET(အကောင့်- ptr AccountId၊ ပိုင်ဆိုင်မှု- ptr AssetDefinitionId၊ ပမာဏ- ptr QuantityValueV1) → ISI Burn
- SYSCALL_TRANSFER_ASSET(မှ- ptr AccountId၊ သို့- ptr AccountId၊ ပိုင်ဆိုင်မှု- ptr AssetDefinitionId၊ ပမာဏ- ptr QuantityValueV1)) → ISI Transfer
