...
| 0x22 | MINT_ASSET | `&AccountId`, `&AssetDefinitionId`, `&QuantityValueV1` | `u64=0` | `G_mint` | Casas de moneda `amount` de activo a cuenta |
| 0x23 | QUEMAR_ACTIVO | `&AccountId`, `&AssetDefinitionId`, `&QuantityValueV1` | `u64=0` | `G_burn` | Quema `amount` de la cuenta |
...
| 0x27 | NFT_SET_METADATA | `&NftId`, `&Name`, `&Json` | `u64=0` | `G_nft_set_metadata` | Actualiza los metadatos de NFT |
