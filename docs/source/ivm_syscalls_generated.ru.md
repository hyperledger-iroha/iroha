<!-- Russian translation of docs/source/ivm_syscalls_generated.md -->
...
# Сгенерированная таблица системных вызовов IVM

Этот файл генерируется из `crates/ivm_abi/src/syscalls.rs`. Чтобы изменить номера вызовов, отредактируйте исходники и перезапустите скрипт.
...
Примечание: псевдонимы разворачиваются в значение своей целевой константы на этапе компиляции.
