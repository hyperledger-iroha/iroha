...
| `taikai_trm_alias_rotations_total` | `crates/iroha_torii/src/da.rs:875`, `crates/iroha_telemetry/src/metrics.rs:11672` | Increments when `/v1/da/ingest` accepts a new TRM per alias. Use it to prove rotation cadence and detect stalled windows. |
