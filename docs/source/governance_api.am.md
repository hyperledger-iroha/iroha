...
- `gov_manifest_approvers`፡ አማራጭ የ JSON ድርድር i105... የመለያ መታወቂያዎች። የሌይን ሰነዱ ከአንድ በላይ ምልአተ ጉባኤ ሲያውጅ፣ መግቢያ የግብይቱን ባለስልጣን እና የተዘረዘሩትን ሂሳቦች የማብራራቱን ምልአተ ጉባኤ ለማርካት ይፈልጋል።
- ቴሌሜትሪ ሁለንተናዊ የመግቢያ ቆጣሪዎችን በ`governance_manifest_admission_total{result}` ያጋልጣል ስለዚህ ኦፕሬተሮች የተሳካላቸው እውቅናዎችን ከ `missing_manifest` ፣ `non_i105..._authority` ፣ `quorum_rejected` ፣ `protected_namespace_rejected` ፣ እና I10108NIX ፣
  ...
  - ጥያቄ (v1-ቅጥ DTO):
    {
      ...
      "ሥር_ፍንጭ"፡ "0x…64hex?"፣
      "ባለቤት": "i105…", // ቀኖናዊ AccountId (I105 ቀጥተኛ፣ አማራጭ @የጎራ ፍንጭ)
      "መጠን": "100?",
      "የቆይታ_ብሎኮች": 6000?,
      "አቅጣጫ": "አዬ|አይ | እምቢ?",
  ...
  - ጥያቄ፡-
    {
      ...
      "ምርጫ": {
        ...
        "ባለቤት"፡ ባዶ፣ // አማራጭ ቀኖናዊ AccountId (I105 ቀጥተኛ፣ አማራጭ @የጎራ ፍንጭ)
...
- ** DoublePrepare/DoubleCommit** — የ i105... የተፈረመ የሚጋጭ ሃሽ ለተመሳሳይ `(phase,height,view,epoch)` tuple።
...
የጋራ መግባባት የወጪው i105... ስብስብ አዲሱ ስብስብ ሃሳብ ማቅረብ ከመጀመሩ በፊት የድንበሩን እገዳ እንደሚያጠናቅቅ ዋስትና ይሰጣል። የሩጫ ጊዜው ደንቡን በተጣመሩ መለኪያዎች ያስፈጽማል፡-- `SumeragiParameter::NextMode` እና `SumeragiParameter::ModeActivationHeight` መፈፀም አለባቸው **በተመሳሳይ ብሎክ**። `mode_activation_height` ማሻሻያውን ከተሸከመው የማገጃ ቁመት በጥብቅ የሚበልጥ መሆን አለበት፣ ይህም ቢያንስ የአንድ-ብሎክ መዘግየት ነው።
