...
- DONE: La couverture d integration exerce les endpoints `/v1/sumeragi/*` uniquement via le pipeline Vote/commit certificate (`integration_tests/tests/sumeragi_vote_qc_commit.rs`).
