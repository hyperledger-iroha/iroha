...
- معمار:
  - `NewAccount` بذریعہ `Account::new_in_domain(id, domain)` ایک واضح ڈومین سے منسلک رجسٹریشن کو عملی شکل دیتا ہے اور اس لیے `ScopedAccountId` کی ضرورت ہوتی ہے۔
  - `NewAccount` بذریعہ `Account::new(id)` صرف یونیورسل اکاؤنٹ کا مضمون رجسٹر کرتا ہے جس کا کوئی لنکڈ ڈومین نہیں ہے۔
- عرفی ماڈل:
  ...
  - ڈیٹا اسپیس روٹ عرفی نام جیسے کہ `merchant@sbp` صرف ڈیٹا اسپیس رکھتا ہے اور اس لیے قدرتی طور پر `Account::new(...)` کے ساتھ جوڑتا ہے۔
