...
- Барилгачид:
  - `NewAccount`-ээр дамжуулан `Account::new(scoped_id)` нь домэйнтэй шууд холбоотой бүртгэлийг хийдэг тул `ScopedAccountId` шаардлагатай.
  - `NewAccount` `Account::new_domainless(id)`-ээр дамжуулан зөвхөн холбоотой домэйнгүй бүх нийтийн дансыг бүртгэдэг.
- Алс загвар:
  ...
  - `merchant@sbp` гэх мэт өгөгдлийн орон зайн эх нэрс нь зөвхөн өгөгдлийн орон зайг агуулж байдаг тул `Account::new_domainless(...)`-тэй байгалийн жамаар хослодог.
