...
- A má conduta do validador é resolvida por meio do pipeline de evidências (`/v2/sumeragi/evidence*`, auxiliares CLI) com transferências de consenso conjunto aplicadas por `NextMode` + `ModeActivationHeight`.
