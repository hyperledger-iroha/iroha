...
- مجموع اختباري، موجه للإنسان ** عنوان I105 ** تم إنتاجه بواسطة
...
- وصف مغلف I105 المطبق في نموذج البيانات و
...
| `ERR_INVALID_I105_PREFIX_ENCODING` | بايتات بادئة I105 مشوهة. | إعادة تشفير العنوان باستخدام برنامج تشفير متوافق؛ لا تقم بتغيير بايت I105 البادئة يدوياً. |
...
- **Pure checksum envelope (على غرار البيتكوين).** مجموع اختباري أبسط ولكن اكتشاف الأخطاء أضعف
