<!-- Hebrew translation of docs/comment_audit.md -->
...
אישרנו כי ההערות בקוד ובתיעוד של מודולי ה־IVM המפורטים להלן משקפות את ההתנהגות הקיימת (אין צורך בשינויים בקוד):
