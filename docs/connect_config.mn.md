...
- `connect.enabled=false`-г бүх Холболтын маршрутуудыг (`/v1/connect/*`) идэвхгүй болгохын тулд тохируулна уу.
- WS сессийн төгсгөлийн цэгүүд болон `/v1/connect/status`-г идэвхжүүлэхийн тулд `true` (өгөгдмөл) гэж үлдээнэ үү.
...
- Ажиллаж байх үед (`connect.enabled=false`) идэвхгүй болсон үед WS болон төлөвийн чиглүүлэлтүүдийг холбох боломжгүй.
  бүртгэгдсэн; `/v1/connect/ws` болон `/v1/connect/status`-ийн хүсэлтүүд 404-ийг буцаана.
- Серверт `/v1/connect/session` (base64url эсвэл hex, 32 байт)-д зориулж үйлчлүүлэгчээс өгсөн `sid` шаардлагатай.
