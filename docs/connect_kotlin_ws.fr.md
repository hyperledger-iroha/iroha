...
<!-- Traduction française de docs/connect_kotlin_ws.md (Kotlin WS Join with Tokens) -->

## Connexion WebSocket Kotlin avec Tokens (OkHttp)
...
### Sceller/ouvrir des payloads (ChaCha20‑Poly1305 + AAD)
...
// Sceller SignResultOk de wallet → app avec seq=1 (payload uniquement ; framing Norito non montré)
