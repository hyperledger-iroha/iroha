...
- རན་ཊའིམ་ (I18NI0000004X) ལུ་ ལྕོགས་མིན་བཟོ་བའི་སྐབས་ ཌབ་ལུ་ཨེསི་དང་ གནས་ཚད་ཀྱི་ལམ་ཚུ་མེན།
  ཐོ་བཀོད་འབད་ཡོདཔ། ཞུ་བ་ `/v1/connect/ws` དང་ `/v1/connect/status` ལུ་ 404 སླར་ལོག་འབདཝ་ཨིན།
- སར་བར་འདི་ལུ་ `/v1/connect/session` (base64url ཡང་ན་ hex, 32 bytes) གི་དོན་ལུ་ མཁོ་སྤྲོད་འབད་མི་ `sid` དགོཔ་ཨིན།
