...
2. **လက်ခံထားသော သွင်းအားစုများ-** ခွဲခြမ်းစိတ်ဖြာသူများသည် IH58 (နှစ်သက်ရာ)၊ `sora` ဖိသိပ်မှုကို လက်ခံရမည်၊
   ...
   လမ်းကြောင်း အရိပ်အမြွက်များအတွက် `@<domain>` နောက်ဆက်တွဲ။ `<label>@<domain>` aliases လိုအပ်သည်။
   ဖြေရှင်းသူ။ Raw `public_key@domain` (multihash hex) ကို ဆက်လက်ပံ့ပိုးထားသည်။
3. **ဖြေရှင်းသူများ-** domainless IH58/sora ခွဲခြမ်းစိတ်ဖြာခြင်း domain-selector တစ်ခု လိုအပ်သည်
