...
- Ստուգիչ, մարդուն ուղղված **Iroha Base58 հասցե (IH58)** արտադրված է
  `AccountAddress::to_ih58`, որը շղթայական տարբերակիչ է կապում հաշվի հետ
...
- Նկարագրեք տվյալների մոդելում ներդրված IH58 Base58 ծրարը և
...
(`AccountAddress`), որը կարող է արտանետվել որպես մարդու դեմ ուղղված մի քանի ձևաչափեր: IH58 է
...
- **IH58 (Iroha Base58)** – Base58 ծրար, որը ներառում է շղթան
...
- **Սորայի սեղմված տեսք** – միայն Սորա այբուբեն՝ **105 սիմվոլներից**, որը կառուցվել է
  ...
  IH58 հավաքածու. Տողերը սկսվում են պահակային `sora`-ով, ներդնում են Bech32m-ից ստացված
...
`AccountAddress::parse_any`-ը ավտոմատ կերպով հայտնաբերում է IH58 (նախընտրելի), սեղմված (`sora`, երկրորդ լավագույն) կամ կանոնական վեցանկյուն
(միայն `0x...`; բաց վեցանկյունը մերժվում է) մուտքագրում և վերադարձնում է ինչպես վերծանված օգտակար բեռը, այնպես էլ հայտնաբերվածը
`AccountAddressFormat`. Torii-ն այժմ զանգահարում է `parse_any`՝ ISO 20022-ի լրացուցիչ համար
...
- Երկուական կարգավորիչի օգտակար բեռը (`ControllerPayload::Multisig`) կոդավորում է
  ...
  `AccountAddress::canonical_bytes()`-ը գրում է IH58 (նախընտրելի)/sora (երկրորդ լավագույն) օգտակար բեռներին:
- Հաշինգը (`MultisigPolicy::digest_blake2b256()`) օգտագործում է Blake2b-256-ը
  ...
  դետերմինիստական քաղաքականության ID, որը համապատասխանում է IH58-ում ներկառուցված վերահսկիչ բայթերին:
- Սարքավորումների ծածկույթն ապրում է `fixtures/account/address_vectors.json`-ում (պատյաններում
  `addr-multisig-*`): Դրամապանակները և SDK-ները պետք է հաստատեն IH58 կանոնական տողերը
  ստորև՝ հաստատելու, որ դրանց կոդավորիչները համապատասխանում են Rust-ի իրականացմանը:

| Գործի ID | շեմ ​​/ անդամներ | IH58 բառացի (նախածանց `0x02F1`) | Սորա սեղմված (`sora`) բառացի | Ծանոթագրություններ |
|-----------------------------------------------------------------------------------------------|
...
- **Տեղական տիրույթի ամփոփում (`treasury`, սերմ բայթ `0x01`)**  
  ...
  Բաշխում․ 32 բայթ Ed25519 բանալի):Միավոր թեստերը (`account::address::tests::parse_any_accepts_all_formats`) հաստատում են ներքևում գտնվող V1 վեկտորները `AccountAddress::parse_any`-ի միջոցով՝ երաշխավորելով, որ գործիքավորումը կարող է հիմնվել վեցանկյուն, IH58 (նախընտրելի) և սեղմված (`sora`, երկրորդ լավագույն) ձևերի կանոնական ծանրաբեռնվածության վրա: Վերականգնեք ընդլայնված հարմարանքների հավաքածուն `cargo run -p iroha_data_model --example address_vectors`-ով:
...
Հետևաբար, `AccountAddress::to_ih58` և `to_compressed_sora` օգնականները արտանետում են
...
| Հաշիվ / ընտրիչ | IH58 բառացի (նախածանց `0x02F1`) | Սորա սեղմված (`sora`) բառացի |
|--------------------------------------------------------------------------------------|
...
- **CAIP-10 ձև:** `iroha:<caip-2-id>:<ih58-addr>` շղթայական-ագնոստիկայի համար
...
- **Մեքենայի օգնականներ.** Հրապարակեք կոդեկներ Rust, TypeScript/JavaScript, Python,
  և Kotlin ծածկող IH58 և սեղմված ձևաչափեր (`AccountAddress::to_ih58`,
  `AccountAddress::parse_any` և դրանց SDK համարժեքները): CAIP-10 օգնականներն են
  ապագա աշխատանք.

#### 2.7 Deterministic IH58 alias

- **Նախածանցի քարտեզագրում.** Կրկին օգտագործեք `chain_discriminant`-ը որպես IH58 ցանցի նախածանց:
  `encode_ih58_prefix()` (տես `crates/iroha_data_model/src/account/address.rs`)
...
- **Հաշվի նյութ.** IH58-ը կոդավորում է կառուցված կանոնական բեռը
  `AccountAddress::canonical_bytes()` — վերնագրի բայթ, տիրույթի ընտրիչ և
  վերահսկիչի ծանրաբեռնվածություն: Հաշինգի լրացուցիչ քայլ չկա. IH58-ը ներառում է
...
- **Կոդավորում.** `encode_ih58()`-ը միացնում է նախածանցի բայթերը կանոնականի հետ
  օգտակար բեռ և ավելացնում է Blake2b-512-ից ստացված 16-բիթանոց ստուգիչ գումարը՝ ֆիքսված
  նախածանց `IH58PRE` (`b"IH58PRE" || prefix || payload`): Արդյունքը Base58-ով կոդավորված է `bs58`-ի միջոցով:
  CLI/SDK օգնականները բացահայտում են նույն ընթացակարգը, և `AccountAddress::parse_any`
  այն հակադարձում է `decode_ih58`-ի միջոցով:

#### 2.8 Նորմատիվ տեքստային թեստի վեկտորներ

`fixtures/account/address_vectors.json` պարունակում է ամբողջական IH58 (նախընտրելի) և սեղմված (`sora`, երկրորդ լավագույն)
բառացի յուրաքանչյուր կանոնական բեռի համար: Առանձնահատկություններ.

- **`addr-single-default-ed25519` (Sora Nexus, նախածանց `0x02F1`):**  
  IH58 `6cmzPVPX5jDQFNfiz6KgmVfm1fhoAqjPhoPFn4nx9mBWaFMyUCwq4cw`, սեղմված (`sora`)
  `sora2QG…U4N5E5`. Torii-ն արտանետում է այս ճշգրիտ տողերը `AccountId`-ից
  `Display` իրականացում (կանոնական IH58) և `AccountAddress::to_compressed_sora`:
- **`addr-global-registry-002a` (ռեգիստրի ընտրիչ → գանձարան):**  
  IH58 `3oE9sLeRGP49Cu7mQ1nF4wtKAm29BG4TGLiRsaXe7mhbMP5WZ113nNW1N6RbqF`, սեղմված (`sora`)
...
- **Խափանման դեպք (`ih58-prefix-mismatch`):**  
  IH58 բառացի վերլուծություն, որը կոդավորված է `NETWORK_PREFIX + 1` նախածանցով հանգույցի վրա
  ակնկալելով կանխադրված նախածանցի ելքը
  `AccountAddressError::UnexpectedNetworkPrefix { expected: 753, found: 754 }`
  նախքան տիրույթի երթուղավորման փորձը: `ih58-checksum-mismatch` հարմարանք
...
սցենարներ կանոնական վեցանկյունի վրա, IH58 (նախընտրելի), սեղմված (`sora`, կես-/լրիվ լայնություն), անուղղակի
...
|------|---------|-----------------|
| `global_domain` | Հայտարարում է, որ տիրույթը գրանցված է գլոբալ մակարդակով և պետք է համապատասխանի շղթայական տարբերակիչին և IH58 նախածանցին: | `{ "domain": "<label>", "chain": "sora:nexus:global", "ih58_prefix": 753, "selector": "global" }` |
...
`{domain, chain, discriminant/ih58_prefix}`. `tombstone` գրառումները **պետք է** մեջբերել
...
2. **Ստեղծիր կանոնական մարսողություններ։** Վազիր
   ...
   ընտրիչները վերածվում են կանոնական IH58 (նախընտրելի), սեղմված (`sora`, երկրորդ լավագույն), վեցանկյուն կամ JSON ձևերի՝ բաց թողնելով
...
4. **Ստուգեք և հրապարակեք։** Հետևեք runbook ստուգաթերթին (հեշ, Sigstore,
   ...
   կանոնականացնում է IH58 (նախընտրելի)/սորա (երկրորդ լավագույն) բառացիները փաթեթի վայրէջքից անմիջապես հետո:
...
- **Ցուցադրել կանխադրվածները. ** Դրամապանակները ցույց են տալիս IH58 հասցեն (կարճ, ստուգված ամփոփված)
...
- **Մուտքի կանոնականացում.** Torii և SDK-ներն ընդունում են IH58 (նախընտրելի)/sora (երկրորդ լավագույն)/0x
  հասցեները գումարած `alias@domain`, `public_key@domain`, `uaid:…` և
...
- **Սխալների կանխարգելում.** Դրամապանակները վերլուծում են IH58 նախածանցները և պարտադրում շղթայական խտրականությունը
...
- **Կոդեկ գրադարաններ.** Official Rust, TypeScript/JavaScript, Python և Kotlin
  գրադարանները տրամադրում են IH58 կոդավորում/վերծանում և սեղմված (`sora`) աջակցություն
...
- **Անվտանգ համօգտագործման հոսքեր. ** Մակերեսները, որոնք պատճենում կամ ցուցադրում են, հասցեագրում են IH58 ձևի լռելյայն հասցեները և բացահայտում են հարակից «share» գործողությունը, որը ներկայացնում է և՛ ամբողջական տողը, և՛ QR կոդը, որը ստացվում է նույն օգտակար բեռից, որպեսզի օգտվողները կարողանան ստուգել ստուգիչ գումարը տեսողականորեն կամ սկանավորելով: Երբ կրճատումն անխուսափելի է (օրինակ՝ փոքր էկրաններ), պահպանեք տողի սկիզբն ու վերջը, ավելացրեք հստակ էլիպսներ և հասանելի դարձրեք ամբողջական հասցեն՝ պատճենահանման վահանակի միջոցով՝ պատահական կտրվածքը կանխելու համար:
...
- **Էկրանի ընթերցման աջակցություն.** Տրամադրեք տեսողականորեն թաքնված պիտակներ (`aria-label`/`aria-describedby`), որոնք նկարագրում են հիմնական Base58 նախածանցի թվանշանները և բաժանում IH58 օգտակար բեռը 4 կամ 8 նիշ խմբերի փոխարեն, այնպես որ խմբային նիշերի տեխնոլոգիան կարդում է խմբային նիշերը: Հայտարարեք պատճենման/համօգտագործման հաջողությունը քաղաքավարի կենդանի շրջանների միջոցով և համոզվեք, որ QR նախադիտումները ներառում են նկարագրական այլընտրանքային տեքստ («IH58 հասցեն <alias>-ի համար 0x02F1 շղթայում»):
- **Միայն Sora-ի սեղմված օգտագործումը.** `sora…` սեղմված տեսքը միշտ նշեք որպես «միայն Sora» և պատճենեք այն հստակ հաստատման հետևում, նախքան պատճենելը: SDK-ները և դրամապանակները պետք է հրաժարվեն սեղմված արտադրանքի ցուցադրումից, երբ շղթայի տարբերակիչը Sora Nexus արժեքը չէ, և պետք է օգտագործողներին ուղղորդեն դեպի IH58՝ միջցանցային փոխանցումների համար՝ միջոցների սխալ ուղղումից խուսափելու համար:

## Իրականացման ստուգաթերթ

- **IH58 ծրար.** Նախածանցը կոդավորում է `chain_discriminant`-ը՝ օգտագործելով կոմպակտ
  6-/14-բիթանոց սխեման `encode_ih58_prefix()`-ից, մարմինը կանոնական բայթ է
  (`AccountAddress::canonical_bytes()`), իսկ ստուգիչ գումարը առաջին երկու բայթն է
  Blake2b-512-ի (`b"IH58PRE"` || նախածանց || մարմին): Ամբողջական ծանրաբեռնվածությունը Base58- է
  կոդավորված `bs58`-ի միջոցով:
- **Ռեեստրի պայմանագիր.** Ստորագրված JSON (և կամընտիր Merkle արմատ) հրատարակում
  `{discriminant, ih58_prefix, chain_alias, endpoints}` 24 ժամ TTL-ով և
  ռոտացիոն ստեղներ.
...
- **Տեքստային օգնականներ.** Նավ IH58 ↔ սեղմված (`sora…`) կոդեկներ Rust-ում,
...
- `GET /v1/accounts` ընդունում է կամընտիր `address_format` հարցման պարամետրը և
  `POST /v1/accounts/query`-ն ընդունում է նույն դաշտը JSON ծրարի ներսում:
  Աջակցվող արժեքներն են.
  - `ih58` (կանխադրված) — պատասխանները թողարկում են կանոնական IH58 Base58 օգտակար բեռներ (օրինակ.
    `6cmzPVPX5jDQFNfiz6KgmVfm1fhoAqjPhoPFn4nx9mBWaFMyUCwq4cw`):
  - `compressed` — պատասխանները թողարկում են միայն Sora-ի համար նախատեսված `sora…` սեղմված տեսքը, մինչդեռ
...
- Անվավեր արժեքներ են վերադարձվում `400` (`QueryExecutionFail::Conversion`): Սա թույլ է տալիս
  ...
  պահպանելով IH58-ը որպես փոխգործունակ լռելյայն:
- Ակտիվների սեփականատերերի ցուցակները (`GET /v1/assets/{definition_id}/holders`) և դրանց JSON-ը
  ծրար գործընկերը (`POST …/holders/query`) նույնպես պատվում է `address_format`:
  `items[*].account_id` դաշտն արտանետում է սեղմված տառեր, երբ
  պարամետր/ծրար դաշտը սահմանվել է `compressed`՝ արտացոլելով հաշիվները
...
- ** Փորձարկում. ** Ավելացրեք միավորի թեստեր կոդավորիչի / ապակոդավորիչի հետադարձ կապի, սխալ շղթայի համար
  ...
  IH58-ի համար ծայրից ծայր հոսում է:
...
| `ERR_INVALID_IH58_PREFIX` | IH58 ցանցի պահանջվող նախածանցը չի կարող կոդավորվել: | Ընտրեք նախածանց շղթայի ռեեստրում հրապարակված `0..=16383` ներառական տիրույթում: |
...
| Կոդ | Ձախողում | Առաջարկվող վերականգնում |
|------|---------|-------------------------|
| `ERR_INVALID_IH58_ENCODING` | IH58 տողը պարունակում է այբուբենից դուրս նիշեր: | Համոզվեք, որ հասցեն օգտագործում է հրապարակված IH58 այբուբենը և չի կրճատվել պատճենման/տեղադրման ընթացքում: |
...
| `ERR_CHECKSUM_MISMATCH` | IH58 (նախընտրելի) կամ սեղմված (`sora`, երկրորդ լավագույն) ստուգիչ գումարի վավերացումը ձախողվեց: | Վերականգնել հասցեն վստահելի աղբյուրից. սա սովորաբար ցույց է տալիս պատճենման/տեղադրման սխալ: |
| `ERR_INVALID_IH58_PREFIX_ENCODING` | IH58 նախածանցի բայթերը սխալ ձևավորված են: | Վերակոդավորել հասցեն համապատասխան կոդավորիչով; մի փոխեք առաջատար Base58 բայթերը ձեռքով: |
...
| `ERR_UNSUPPORTED_ADDRESS_FORMAT` | Ավտոմատ հայտնաբերումը չկարողացավ ճանաչել մուտքագրման ձևաչափը: | Տրամադրեք IH58 (նախընտրելի), սեղմված (`sora`) կամ կանոնական `0x` վեցանկյուն տողեր վերլուծիչներ կանչելիս: |
...
| `ERR_UNEXPECTED_NETWORK_PREFIX` | Ապակոդավորված IH58 ցանցի նախածանցը տարբերվում է կազմաձևված արժեքից: | Անցեք հասցեի թիրախային շղթայից կամ կարգավորեք սպասվող դիսկրիմինանտը/նախածանցը: |
...
- ** Pure Base58Check (Bitcoin-ի ոճով):** Ավելի պարզ ստուգիչ գումար, բայց ավելի թույլ սխալի հայտնաբերում
  քան Blake2b-ից ստացված IH58 ստուգիչ գումարը (`encode_ih58`-ը կտրում է 512-բիթանոց հեշը)
...
- **Bech32m ծրար։** QR հարմար է և առաջարկում է մարդու համար ընթեռնելի նախածանց, բայց
  կշեղվեր առաքման IH58 իրականացումից (`AccountAddress::to_ih58`)
  և պահանջում են վերստեղծել բոլոր հարմարանքները/SDK-ները: Ներկայիս ճանապարհային քարտեզը պահպանում է IH58 +
...
- Նշեք, թե ինչպես են Kotodama/IVM պայմանագրերը մուտք գործում IH58 օգնականներին (`to_address()`,
  `parse_address()`) և արդյոք շղթայական պահեստավորումը երբևէ պետք է բացահայտի CAIP-10-ը
  քարտեզագրումներ (այսօր IH58-ը կանոնական է):
- Ուսումնասիրեք Iroha շղթաների գրանցումը արտաքին ռեգիստրներում (օրինակ՝ IH58 ռեեստրում,
  CAIP անվանատարածքի գրացուցակ) էկոհամակարգերի ավելի լայն հավասարեցման համար:

## Հաջորդ քայլերը

1. IH58 կոդավորումը վայրէջք է կատարել `iroha_data_model`-ում (`AccountAddress::to_ih58`,
   `parse_any`); շարունակեք տեղափոխել հարմարանքները/թեստերը յուրաքանչյուր SDK-ի վրա և մաքրեք ցանկացածը
   Bech32m տեղապահներ.
