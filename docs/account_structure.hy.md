...
- Ստուգիչ, մարդուն ուղղված **Iroha Base58 հասցե (I105)** արտադրված է
...
- Նկարագրեք տվյալների մոդելում ներդրված I105 Base58 ծրարը և
...
- **I105 (Iroha Base58)** – Base58 ծրար, որը ներառում է շղթան
...
- **Կոդավորում.** `encode_i105()`-ը միացնում է նախածանցի բայթերը կանոնականի հետ
  ...
  նախածանց `I105PRE` (`b"I105PRE" || prefix || payload`): Արդյունքը Base58-ով կոդավորված է `bs58`-ի միջոցով:
...
- **I105 ծրար.** Նախածանցը կոդավորում է `chain_discriminant`-ը՝ օգտագործելով կոմպակտ
  ...
  Blake2b-512-ի (`b"I105PRE"` || նախածանց || մարմին): Ամբողջական ծանրաբեռնվածությունը Base58- է
...
- `GET /v2/accounts` ընդունում է կամընտիր `canonical I105 rendering` հարցման պարամետրը և
  `POST /v2/accounts/query`-ն ընդունում է նույն դաշտը JSON ծրարի ներսում:
  Աջակցվող արժեքներն են.
  - `i105` (կանխադրված) — պատասխանները թողարկում են կանոնական I105 Base58 օգտակար բեռներ (օրինակ.
...
- Ակտիվների սեփականատերերի ցուցակները (`GET /v2/assets/{definition_id}/holders`) և դրանց JSON-ը
...
| `ERR_INVALID_I105_PREFIX_ENCODING` | I105 նախածանցի բայթերը սխալ ձևավորված են: | Վերակոդավորել հասցեն համապատասխան կոդավորիչով; մի փոխեք առաջատար Base58 բայթերը ձեռքով: |
