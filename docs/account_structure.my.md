...
- လူမျက်နှာဖြင့် စစ်ဆေးထားသော **Iroha Base58 လိပ်စာ (I105)** မှ ထုတ်လုပ်သည်
...
- ဒေတာမော်ဒယ်တွင် အကောင်အထည်ဖော်ခဲ့သော I105 Base58 စာအိတ်ကို ဖော်ပြပါ။
...
- **I105 (Iroha Base58)** - ကွင်းဆက်ကို မြှုပ်ထားသည့် Base58 စာအိတ်
...
- ** ကုဒ်သွင်းခြင်း-** `encode_i105()` သည် ရှေ့ဆက်ဘိုက်များကို canonical နှင့် ပေါင်းစပ်သည်
  ...
  ရှေ့စာလုံး `I105PRE` (`b"I105PRE" || prefix || payload`)။ ရလဒ်သည် `bs58` မှတစ်ဆင့် Base58-encode လုပ်ထားသည်။
...
- **Screen-reader ပံ့ပိုးမှု-** အမြင်အာရုံဖြင့် ဝှက်ထားသော အညွှန်းများ (`aria-label`/`aria-describedby`) သည် ထိပ်တန်း Base58 ရှေ့ရှေ့ဂဏန်းများကို ဖော်ပြပြီး I105 payload အား စာလုံး 4 လုံး သို့မဟုတ် 8 လုံးဖြင့် အပိုင်းပိုင်းခွဲပေးသည်၊ ထို့ကြောင့် assistive technology အစား run-string အက္ခရာများကို ဖတ်ပါသည်။ ယဉ်ကျေးသော တိုက်ရိုက်ထုတ်လွှင့်သည့် ဒေသများမှတစ်ဆင့် အောင်မြင်မှုကို ကူးယူခြင်း/မျှဝေခြင်းအား ကြေညာပြီး QR အစမ်းကြည့်ရှုမှုများတွင် သရုပ်ဖော်ထားသော alt စာသား (“I105 လိပ်စာသည် ကွင်းဆက် 0x02F1” အတွက် <alias> အတွက် လိပ်စာ) ပါ၀င်ကြောင်း သေချာပါစေ။
...
- **I105 စာအိတ်-** Prefix သည် compact ကို အသုံးပြု၍ `chain_discriminant` ကို ကုဒ်လုပ်သည်
  ...
  Blake2b-512(`b"I105PRE"` || ရှေ့ဆက် || ကိုယ်ထည်)။ ဝန်ဆောင်ခ အပြည့်အစုံမှာ Base58- ဖြစ်သည်။
...
| `ERR_INVALID_I105_PREFIX_ENCODING` | I105 ရှေ့ဆက်ဘိုက်များသည် ပုံမမှန်ပါ။ | လိုက်လျောညီထွေရှိသော ကုဒ်နံပါတ်ဖြင့် လိပ်စာကို ပြန်လည်ကုဒ်လုပ်ပါ။ ဦးဆောင် Base58 bytes ကို ကိုယ်တိုင်မပြောင်းပါနှင့်။ |
