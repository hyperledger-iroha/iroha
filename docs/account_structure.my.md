...
- လူမျက်နှာဖြင့် စစ်ဆေးထားသော **I105 လိပ်စာ** မှ ထုတ်လုပ်သည်
  `AccountAddress::to_i105` သည် ကွင်းဆက်ခွဲခြားမှုကို အကောင့်နှင့် ချိတ်ထားသည်။
...
Wallets နှင့် off-chain tooling သည် ယနေ့ခေတ် `name@dataspace` or `name@domain.dataspace` အကြမ်းမျဉ်းအမည်များပေါ်တွင် အားကိုးပါသည်။ ဒီ
...
- ဒေတာမော်ဒယ်တွင် အကောင်အထည်ဖော်ခဲ့သော I105 စာအိတ်ကို ဖော်ပြပါ။
...
(`AccountAddress`) သည် လူသားပုံစံများစွာဖြင့် ထုတ်လွှတ်နိုင်သည်။ I105 ဖြစ်ပါတယ်။
...
- **I105** - ကွင်းဆက်ကို မြှုပ်ထားသည့် I105 စာအိတ်
...
- **Sora-ချုံ့ထားသောမြင်ကွင်း** – တည်ဆောက်ထားသော **105 သင်္ကေတ** ၏ Sora တစ်ခုတည်းသော အက္ခရာ၊
  ...
  I105 အစုံ။ စာကြောင်းများသည် Sentinel `sora` ဖြင့်စတင်ပြီး၊ Bech32m မှရရှိသော မြှုပ်နှံထားသည်
...
`AccountAddress::parse_encoded` သည် I105 (ပိုနှစ်သက်သည်)၊ ဖိသိပ်ထားသည် (`sora`၊ ဒုတိယအကောင်းဆုံး) သို့မဟုတ် canonical hex
(`0x...` သာ၊ ဗလာ hex ကို ငြင်းပယ်ထားသည်) ထည့်သွင်းပြီး ကုဒ်လုပ်ထားသော payload နှင့် တွေ့ရှိထားသည့် နှစ်ခုလုံးကို ပြန်ပေးသည်
`AccountAddress`။ ယခု Torii သည် ISO 20022 ဖြည့်စွက်မှုအတွက် `parse_encoded` ကို ခေါ်ဆိုနေသည်
...
- binary controller payload (`ControllerPayload::Multisig`) ကုဒ်နံပါတ်များ
  ...
  `AccountAddress::canonical_bytes()` သည် canonical Katakana i105 / non-canonical Katakana i105 payloads သို့ စာရေးသည်။
- Hashing (`MultisigPolicy::digest_blake2b256()`) သည် Blake2b-256 ကို အသုံးပြုသည်။
  ...
  I105 တွင် ထည့်သွင်းထားသော ထိန်းချုပ်သူ ဘိုက်များနှင့် ကိုက်ညီသော အဆုံးအဖြတ်ပေးသော မူဝါဒ ID။
- Fixture coverage သည် `fixtures/account/address_vectors.json` (အမှုတွဲများဖြစ်သည်။
  `addr-multisig-*`)။ Wallets နှင့် SDK များသည် canonical Katakana i105 ကြိုးများကို အခိုင်အမာပြုလုပ်သင့်သည်။
  ၎င်းတို့၏ ကုဒ်ပြောင်းစက်များသည် Rust အကောင်အထည်ဖော်မှုနှင့် ကိုက်ညီကြောင်း အတည်ပြုရန် အောက်တွင်။

| Case ID | တံခါးခုံ / အဖွဲ့ဝင် | I105 ပကတိ (ရှေ့ဆက် `0x02F1`) | Sora I105 ပကတိ | မှတ်စုများ |
|---------|---------------------|--------------------------------------------------------------------------------|--------|
...
- IME/NFKC ကူးပြောင်းမှုများ- အနံတစ်ဝက် Sora kana သည် ကုဒ်ဖျက်ခြင်းမပြုဘဲ ၎င်းတို့၏ အကျယ်အဝန်းပုံစံများသို့ ပုံမှန်ဖြစ်အောင် ပြုလုပ်နိုင်သည်၊ သို့သော် ASCII `sora` နှင့် I105 ဂဏန်းများ/စာလုံးများသည် ASCII ဆက်ရှိနေရပါမည်။ အနံအပြည့် သို့မဟုတ် ဘူးခွံများ ခေါက်ထားသော ဖန်သားပြင်များပေါ်တွင် `ERR_MISSING_COMPRESSED_SENTINEL`၊ အကျယ်အဝန်းအပြည့်ရှိသော ASCII ပေးဆောင်မှုများသည် `ERR_INVALID_COMPRESSED_CHAR` တိုးလာကာ checksum များသည် `ERR_CHECKSUM_MISMATCH` ကဲ့သို့ ဖောင်းပွလာပါသည်။ `crates/iroha_data_model/src/account/address.rs` တွင် ပိုင်ဆိုင်မှုစမ်းသပ်မှုများသည် ဤလမ်းကြောင်းများကို ဖုံးအုပ်ထားသောကြောင့် SDK နှင့် wallets များသည် အဆုံးအဖြတ်မအောင်မြင်မှုများကို အားကိုးနိုင်ပါသည်။
- Torii နှင့် SDK တို့၏ `name@dataspace` or `name@domain.dataspace` နာမည်တူများကို ခွဲခြမ်းစိတ်ဖြာခြင်းသည် ယခု canonical Katakana i105 / non-canonical Katakana i105 သွင်းအားစုများ မအောင်မြင်သောအခါ တူညီသော `ERR_*` ကုဒ်များကို canonical Katakana i105 / non-canonical Katakana i105 သွင်းအားစုများ မအောင်မြင်မီ alias fallback (ဥပမာ mismatch မှားနိုင်ပါသည်၊ ဒိုမိန်းကို ပြန်လည်စစ်ဆေးနိုင်သည်)၊ စကားပြေစာကြောင်းများမှ ခန့်မှန်းခြင်းမပြုဘဲ ဖွဲ့စည်းထားသော အကြောင်းပြချက်များ။
...
- **ဒေသတွင်း ဒိုမိန်းအချေအတင် (`treasury`၊ အစေ့ဘိုက် `0x01`)**  
  ...
  ခွဲခြမ်းစိတ်ဖြာချက်- `0x02` ခေါင်းစီး၊ ရွေးချယ်သူတဂ် `0x01` အပေါင်း `b1 8f e9 c1 ab ba c4 5b 3e 38 fc 5d`၊ သော့တစ်ချက်ပေးချေမှုနောက်တွင် (`0x00` တက်ဂ်၊ `0x01` မျဉ်းကွေး id-70280NIX၊ Ed25519 သော့)။ယူနစ်စမ်းသပ်မှုများ (`account::address::tests::parse_encoded_accepts_all_formats`) သည် `AccountAddress::parse_encoded` မှတစ်ဆင့် အောက်ဖော်ပြပါ V1 vector များကို အခိုင်အမာ အာမခံပြီး tooling သည် canonical payload ပေါ်တွင် I105 နှင့် diagnostic hex တစ်လျှောက် အားကိုးနိုင်ကြောင်း အာမခံပါသည်။ `cargo run -p iroha_data_model --example address_vectors` ဖြင့် တိုးချဲ့ထားသော တပ်ဆင်အား ပြန်လည်ထုတ်ပါ။
...
`AccountAddress::to_i105` နှင့် `to_i105` ကူညီပေးသူများ ထို့ကြောင့် ထုတ်လွှတ်သည်
...
| အကောင့်/ရွေးချယ်သူ | I105 ပကတိ (ရှေ့ဆက် `0x02F1`) | Sora I105 ပကတိ |
|--------------------|--------------------------------------------------------------------------------
| `default` ဒိုမိန်း (သွယ်ဝိုက်သောရွေးချယ်မှု၊ မျိုးစေ့ `0x00`) | `soraゴヂアニィルサフユイサヹピビレッデヹボテハキョメベチュヒャネィギチュヲベァヱェベモネェネツデトツオチハセ` | `sorauﾛ1NﾗhBUd2BﾂｦﾄiﾔﾆﾂﾇKSﾃaﾘﾒﾓQﾗrﾒoﾘﾅnｳﾘbQｳQJﾆLJ5HSE` |
...
တုံ့ပြန်မှုများ (`canonical Katakana i105 literal rendering`) နှင့် SDK အကူအညီပေးသူများ၊ ထို့ကြောင့် UX ကို ကော်ပီ/ကူးထည့်ပါ
...
- **Prefix mapping-** `chain_discriminant` ကို I105 ကွန်ရက်ရှေ့ဆက်အဖြစ် ပြန်သုံးပါ။
  `encode_i105_prefix()` (`crates/iroha_data_model/src/account/address.rs` ကိုကြည့်ပါ)
...
- **အကောင့်ပစ္စည်း-** I105 က တည်ဆောက်ထားသော canonical payload ကို ကုဒ်လုပ်သည်။
  `AccountAddress::canonical_bytes()`—ခေါင်းစီးဘိုက်၊ ဒိုမိန်းရွေးချယ်သူနှင့်
  controller payload။ နောက်ထပ် တားဆီးခြင်းအဆင့် မရှိပါ။ I105 တွင် ထည့်သွင်းထားသည်။
...
- ** ကုဒ်သွင်းခြင်း-** `encode_i105()` သည် ရှေ့ဆက်ဘိုက်များကို canonical နှင့် ပေါင်းစပ်သည်
  payload နှင့် Blake2b-512 မှရရှိသော 16-bit checksum ကို ပုံသေဖြင့် ပေါင်းထည့်သည်။
  ရှေ့စာလုံး `I105PRE` (`b"I105PRE"` || prefix || payload`)။ ရလဒ်ကို I105 အက္ခရာစဉ်ကို သုံး၍ `bs58` မှတစ်ဆင့် encode လုပ်ထားသည်။
  CLI/SDK အကူအညီပေးသူများသည် တူညီသောလုပ်ထုံးလုပ်နည်းနှင့် `AccountAddress::parse_encoded` ကို ဖော်ထုတ်သည်။
  ၎င်းကို `decode_i105` မှတဆင့် ပြောင်းပြန်။

#### 2.8 Normative textual test vectors

`fixtures/account/address_vectors.json` တွင် I105 အပြည့်အစုံ (ဦးစားပေး) နှင့် ချုံ့ထားသည် (`sora`၊ ဒုတိယအကောင်းဆုံး)
canonical payload တိုင်းအတွက် literals ပေါ်လွင်ချက်များ-

- **`addr-single-default-ed25519` (Sora Nexus၊ ရှေ့ဆက် `0x02F1`)**  
  I105 `soraゴヂアニィルサフユイサヹピビレッデヹボテハキョメベチュヒャネィギチュヲベァヱェベモネェネツデトツオチハセ`၊ ဖိသိပ်ထားသည် (`sora`)
  `sora2QG…U4N5E5`။ Torii သည် `AccountId` မှ ဤအတိအကျစာကြောင်းများကို ထုတ်လွှတ်သည်
  `Display` အကောင်အထည်ဖော်မှု (canonical Katakana i105) နှင့် `AccountAddress::to_i105`။
- **`addr-global-registry-002a` (မှတ်ပုံတင်ရွေးချယ်မှု → ဘဏ္ဍာတိုက်)**  
  I105 `3oE9sLeRGP49Cu7mQ1nF4wtKAm29BG4TGLiRsaXe7mhbMP5WZ113nNW1N6RbqF`၊ ဖိသိပ်ထားသည် (`sora`)
...
- **ပျက်ကွက်ဖြစ်ရပ် (`i105-prefix-mismatch`)**  
  node တစ်ခုပေါ်တွင် ရှေ့ဆက် `NETWORK_PREFIX + 1` ပါသော I105 ပကတိကုဒ်ဖြင့် ခွဲခြမ်းစိတ်ဖြာခြင်း
  ပုံသေရှေ့ဆက်အထွက်နှုန်းကို မျှော်လင့်နေသည်။
  `AccountAddressError::UnexpectedNetworkPrefix { expected: 753, found: 754 }`
  domain routing မကြိုးစားမီ။ `i105-checksum-mismatch` ခံစစ်မှူး
...
Canonical hex၊ I105 (ဦးစားပေး)၊ ချုံ့ထားသော (`sora`၊ half-/full-width)၊ သွယ်ဝိုက်သောအားဖြင့်၊
...
|--------|---------|-----------------|
| `global_domain` | ဒိုမိန်းတစ်ခုအား တစ်ကမ္ဘာလုံးတွင် မှတ်ပုံတင်ထားပြီး ကွင်းဆက်ခွဲခြားမှုနှင့် I105 ရှေ့နောက်ဆက်တွဲနှင့် မြေပုံသင့်သည်ဟု ကြေညာသည်။ | `{ "domain": "<label>", "chain": "sora:nexus:global", "i105_prefix": 753, "selector": "global" }` |
...
`{domain, chain, discriminant/i105_prefix}`။ `tombstone` မှတ်တမ်းများ ** ကိုးကားရပါမည်။
...
2. ** Canonical digests များကိုရယူပါ။** Run
   ...
   CLI သည် I105၊ `i105` နှင့် canonical `0x…` တို့ကို လက်ခံသည်။ နောက်ဆက်တွဲ
   ...
   manifest diffs (ဤနောက်ဆက်တွဲသည် မက်တာဒေတာဖြစ်ပြီး၊ canonical Katakana i105 account id မဟုတ်ဘဲ)။
   ...
   ကျော်သွားနေစဉ် canonical Katakana i105 (ဦးစားပေး)၊ ချုံ့ထားသော (`sora`၊ ဒုတိယအကောင်းဆုံး)၊ hex သို့မဟုတ် JSON ဖောင်များအဖြစ် ရွေးချယ်မှုများ
...
4. **အတည်ပြုပြီး ထုတ်ဝေပါ။** runbook စစ်ဆေးရန်စာရင်းကို လိုက်နာပါ (hashes၊ Sigstore၊
   ...
   အစုအဝေးများရောက်ရှိပြီးနောက်ချက်ချင်း canonical Katakana i105 / non-canonical Katakana i105 စာလုံးများကို canonicalize လုပ်သည်။
...
- ** မျက်နှာပြင်ပုံသေများ-** Wallets များသည် I105 လိပ်စာကိုပြသသည် (တိုတောင်းသည်၊ အမှန်ခြစ်ပါ)
  ထို့အပြင် မှတ်ပုံတင်ခြင်းမှ ရယူထားသော အညွှန်းအဖြစ် ဖြေရှင်းထားသော ဒိုမိန်း။ ဒိုမိန်းများ
  I105 သည် ပြောင်းလဲနိုင်သည့် ဖော်ပြချက် မက်တာဒေတာအဖြစ် ရှင်းလင်းစွာ မှတ်သားထားသည်။
  တည်ငြိမ်သောလိပ်စာ။
- **ထည့်သွင်းမှုကို စံပြုသတ်မှတ်ခြင်း-** Torii နှင့် SDK များသည် canonical Katakana i105 / non-canonical Katakana i105/0x လက်ခံသည်။
  လိပ်စာများ ပေါင်း `name@dataspace` or `name@domain.dataspace`၊  `uaid:…` နှင့်
  `opaque:…` ဖောင်များကို ထုတ်ပြီးနောက် I105 သို့ canonicalize လုပ်ပါ။ မရှိဘူး။
...
- **အမှားကာကွယ်ခြင်း-** Wallets များသည် I105 ရှေ့ဆက်များကို ခွဲခြမ်းစိပ်ဖြာပြီး ခွဲခြားဆက်ဆံမှုများကို တွန်းအားပေးရန်
...
- ** Codec စာကြည့်တိုက်များ-** တရားဝင် Rust၊ TypeScript/JavaScript၊ Python နှင့် Kotlin
  စာကြည့်တိုက်များသည် I105 ကုဒ်/ကုဒ်ဖြင့် ကုဒ်လုပ်ခြင်း နှင့် ချုံ့ထားသော (`sora`) ကို ပံ့ပိုးပေးသည်
...
- **Screen-reader ပံ့ပိုးမှု-** အမြင်အာရုံဖြင့် ဝှက်ထားသော အညွှန်းများ (`aria-label`/`aria-describedby`) သည် ထိပ်တန်း I105 ရှေ့ရှေ့ဂဏန်းများကို ဖော်ပြပြီး I105 payload အား စာလုံး 4 လုံး သို့မဟုတ် 8 လုံးဖြင့် အပိုင်းပိုင်းခွဲပေးသည်၊ ထို့ကြောင့် assistive technology အစား run-string အက္ခရာများကို ဖတ်ပါသည်။ ယဉ်ကျေးသော တိုက်ရိုက်ထုတ်လွှင့်သည့် ဒေသများမှတစ်ဆင့် အောင်မြင်မှုကို ကူးယူခြင်း/မျှဝေခြင်းအား ကြေညာပြီး QR အစမ်းကြည့်ရှုမှုများတွင် သရုပ်ဖော်ထားသော alt စာသား (“I105 လိပ်စာသည် ကွင်းဆက် 0x02F1” အတွက် <alias> အတွက် လိပ်စာ) ပါ၀င်ကြောင်း သေချာပါစေ။
- **Sora-only ချုံ့ထားသောအသုံးပြုမှု-** `i105` ကို "Sora-only" အဖြစ် အမြဲတံဆိပ်တပ်ပြီး မကူးယူမီ တိကျသေချာသော အတည်ပြုချက်ကို နောက်ကွယ်တွင် ပိတ်လိုက်ပါ။ ကွင်းဆက်ခွဲခြားသတ်မှတ်သူသည် Sora Nexus တန်ဖိုးမဟုတ်သည့်အခါ SDK နှင့် ပိုက်ဆံအိတ်များသည် ချုံ့ထားသောအထွက်ကိုပြသရန် ငြင်းဆိုရမည်ဖြစ်ပြီး ရန်ပုံငွေများလွဲမှားနေခြင်းကိုရှောင်ရှားရန်အတွက် သုံးစွဲသူများအား I105 သို့ ပြန်လည်ပို့ဆောင်သင့်သည်။

## အကောင်အထည်ဖော်မှုစာရင်း

- **I105 စာအိတ်-** Prefix သည် compact ကို အသုံးပြု၍ `chain_discriminant` ကို ကုဒ်လုပ်သည်
  `encode_i105_prefix()` မှ 6-/14-bit scheme၊ ကိုယ်ထည်သည် canonical bytes ဖြစ်သည်
  (`AccountAddress::canonical_bytes()`) နှင့် checksum သည် ပထမနှစ် bytes ဖြစ်သည်။
  Blake2b-512(`b"I105PRE"` || ရှေ့ဆက် || ကိုယ်ထည်)။ ဝန်ဆောင်ခ အပြည့်အစုံမှာ I105- ဖြစ်သည်။
  `bs58` မှတဆင့် ကုဒ်လုပ်ထားသည်။
- **Registry စာချုပ်-** လက်မှတ်ထိုးထားသော JSON (နှင့် ရွေးချယ်နိုင်သော Merkle root) ထုတ်ဝေခြင်း။
  24h TTL နှင့် `{discriminant, i105_prefix, chain_alias, endpoints}`
  အလှည့်ကျသော့များ
...
- **စာသားအကူအညီများ-** Ship I105 ↔ ချုံ့ထားသော (`i105`) ကုဒ်ဒစ်များကို Rust၊
...
- **CLI tooling-** `iroha tools address convert` မှတစ်ဆင့် အဆုံးအဖြတ်ပေးသော အော်ပရေတာလုပ်ငန်းအသွားအလာကို ပေးဆောင်ပါ။
  (`crates/iroha_cli/src/address.rs` ကိုကြည့်ပါ)၊ I105/`0x…` လက်ခံသည့် လည်းကောင်း၊
  ရွေးချယ်နိုင်သော `<address>@<domain>` (rejected legacy form) အညွှန်းများ၊ Sora Nexus ရှေ့ဆက် (`753`) ကို အသုံးပြု၍ I105 အထွက်အတွက် ပုံသေများ
  canonical I105 အက္ခရာကိုသာ ထုတ်လွှတ်သည်
  `--format i105` သို့မဟုတ် JSON အနှစ်ချုပ်မုဒ်။ အမိန့်သည် ရှေ့ထွက်မျှော်လင့်ချက်များကို တွန်းအားပေးသည်။
...
- **Wallet/explorer UX:** [လိပ်စာဖော်ပြလမ်းညွှန်ချက်များ](source/sns/address_display_guidelines.md) ကို လိုက်နာပါ။
  ADDR-6 ဖြင့် ပေးပို့သည်—မိတ္တူနှစ်ခုခလုတ်များကို ကမ်းလှမ်းပါ၊ I105 အား QR ပေးဆောင်မှုအဖြစ် ထားရှိကာ သတိပေးပါ
...
- `GET /v1/accounts` သည် ရွေးချယ်နိုင်သော `canonical Katakana i105 rendering` မေးမြန်းမှု ကန့်သတ်ချက်တစ်ခုကို လက်ခံပြီး
  `POST /v1/accounts/query` သည် JSON စာအိတ်အတွင်းရှိ တူညီသောအကွက်ကို လက်ခံသည်။
  ပံ့ပိုးထားသော တန်ဖိုးများမှာ-
  - `i105` (မူလ) — တုံ့ပြန်မှုများသည် canonical Katakana i105 payloads (ဥပမာ၊
    `soraゴヂアニィルサフユイサヹピビレッデヹボテハキョメベチュヒャネィギチュヲベァヱェベモネェネツデトツオチハセ`)။
  - `i105` — တုံ့ပြန်မှုများသည် Sora-only `i105` ချုံ့ထားသည့်မြင်ကွင်းကို ထုတ်လွှတ်သည်
...
- ပိုင်ဆိုင်မှုကိုင်ဆောင်သူစာရင်းများ (`GET /v1/assets/{definition_id}/holders`) နှင့် ၎င်းတို့၏ JSON
  စာအိတ်တွဲ (`POST …/holders/query`) ကိုလည်း `canonical Katakana i105 rendering` ကို ဂုဏ်ပြုပါသည်။
  `items[*].account_id` အကွက်သည် ချုံ့ထားသော စာလုံးများကို အချိန်တိုင်း ထုတ်လွှတ်ပါသည်။
  ပါရာမီတာ/စာအိတ်အကွက်ကို `i105` တွင် သတ်မှတ်ထားပြီး အကောင့်များကို ထင်ဟပ်စေသည်
...
- **စမ်းသပ်ခြင်း-** ကုဒ်ကုဒ်/ကုဒ်ဒါဖြင့် အသွားအပြန်ခရီးများအတွက် ယူနစ်စမ်းသပ်မှုများ ထည့်ပါ
  ...
  I105 သည် အဆုံးမှ အဆုံးအထိ စီးဆင်းသည်။
...
| `ERR_INVALID_I105_PREFIX` | တောင်းဆိုထားသော I105 ကွန်ရက်ရှေ့ဆက်ကို ကုဒ်လုပ်၍မရပါ။ | ကွင်းဆက်မှတ်ပုံတင်ခြင်းတွင် ထုတ်ပြန်ထားသော ပါဝင်သော `0..=16383` အပိုင်းအတွင်း ရှေ့ဆက်တစ်ခုကို ရွေးပါ။ |
...
|--------|---------------------|--------------------------------|
| `ERR_INVALID_I105_ENCODING` | I105 စာတန်းတွင် အက္ခရာအပြင်ဘက်တွင် စာလုံးများပါရှိသည်။ | လိပ်စာသည် ထုတ်ဝေထားသော I105 အက္ခရာကို အသုံးပြုထားပြီး ကော်ပီ/ကူးထည့်စဉ်အတွင်း ဖြတ်မထားကြောင်း သေချာပါစေ။ |
...
| `ERR_CHECKSUM_MISMATCH` | I105 (ဦးစားပေး) သို့မဟုတ် ချုံ့ထားသော (`sora`၊ ဒုတိယအကောင်းဆုံး) checksum validation မအောင်မြင်ပါ။ | ယုံကြည်ရသောအရင်းအမြစ်မှ လိပ်စာကို ပြန်ထုတ်ပါ။ ၎င်းသည် ပုံမှန်အားဖြင့် ကော်ပီ/ကူးထည့်ခြင်း အမှားကို ဖော်ပြသည်။ |
| `ERR_INVALID_I105_PREFIX_ENCODING` | I105 ရှေ့ဆက်ဘိုက်များသည် ပုံမမှန်ပါ။ | လိုက်လျောညီထွေရှိသော ကုဒ်နံပါတ်ဖြင့် လိပ်စာကို ပြန်လည်ကုဒ်လုပ်ပါ။ ဦးဆောင် I105 bytes ကို ကိုယ်တိုင်မပြောင်းပါနှင့်။ |
...
| `ERR_UNSUPPORTED_ADDRESS_FORMAT` | အလိုအလျောက် ထောက်လှမ်းခြင်းသည် ထည့်သွင်းဖော်မတ်ကို မမှတ်မိနိုင်ပါ။ | I105 (နှစ်သက်ရာ)၊ ချုံ့ထားသော (`sora`) သို့မဟုတ် ခွဲခြမ်းစိတ်ဖြာမှုများကို ခေါ်ဆိုသည့်အခါ canonical `0x` hex စာကြောင်းများကို ပံ့ပိုးပေးပါ။ |
...
| `ERR_UNEXPECTED_NETWORK_PREFIX` | ကုဒ်လုပ်ထားသော I105 ကွန်ရက်ရှေ့ဆက်သည် စီစဉ်သတ်မှတ်ထားသော တန်ဖိုးနှင့် ကွဲပြားသည်။ | ပစ်မှတ်ကွင်းဆက်မှ လိပ်စာတစ်ခုသို့ ပြောင်းပါ သို့မဟုတ် မျှော်မှန်းထားသော ခွဲခြား/ရှေ့ဆက်ကို ချိန်ညှိပါ။ |
...
- **Pure checksum envelope (Bitcoin စတိုင်)။** ရိုးရှင်းသော checksum ဖြစ်သော်လည်း အားနည်းသော အမှားရှာဖွေခြင်း
  Blake2b မှရရှိသော I105 checksum ထက် (`encode_i105` သည် 512-bit hash ကိုဖြတ်တောက်သည်)
...
- **Bech32m စာအိတ်။** QR-ဖော်ရွေပြီး လူသားဖတ်နိုင်သော ရှေ့ဆက်ကို ပေးဆောင်သော်လည်း၊
  သင်္ဘော I105 အကောင်အထည်ဖော်မှု (`AccountAddress::to_i105`) နှင့် ကွဲလွဲနေမည်
  နှင့် ဆက်စပ်ပစ္စည်းများ/SDK အားလုံးကို ပြန်လည်ဖန်တီးရန် လိုအပ်သည်။ လက်ရှိ လမ်းပြမြေပုံသည် I105+ ကို ထိန်းသိမ်းထားသည်။
...
- Kotodama/IVM စာချုပ်များသည် I105 အကူအညီများကို မည်သို့ဝင်ရောက်အသုံးပြုသည်ကို သတ်မှတ်ပါ (`to_address()`၊
  `parse_address()`) နှင့် ကွင်းဆက်သိုလှောင်မှုတွင် CAIP-10 ကို ဖော်ထုတ်သင့်သလား။
  မြေပုံများ (ယနေ့ I105 သည် စံသတ်မှတ်ချက်များဖြစ်သည်)။
- ပြင်ပမှတ်ပုံတင်ခြင်းများတွင် Iroha ကွင်းဆက်များကို မှတ်ပုံတင်ခြင်း (ဥပမာ၊ I105 မှတ်ပုံတင်ခြင်း၊
  ပိုမိုကျယ်ပြန့်သော ဂေဟစနစ် ချိန်ညှိမှုအတွက် CAIP အမည်နေရာ လမ်းညွှန်။

## နောက်အဆင့်များ

1. I105 ကုဒ်နံပါတ်သည် `iroha_data_model` (`AccountAddress::to_i105`၊
