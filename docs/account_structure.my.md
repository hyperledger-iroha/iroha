...
Wallets နှင့် off-chain tooling သည် ယနေ့ခေတ် `alias@domain` အကြမ်းမျဉ်းအမည်များပေါ်တွင် အားကိုးပါသည်။ ဒီ
...
`AccountAddress::parse_any` သည် IH58 (ပိုနှစ်သက်သည်)၊ ဖိသိပ်ထားသည် (`sora`၊ ဒုတိယအကောင်းဆုံး) သို့မဟုတ် canonical hex
(`0x...` သာ၊ ဗလာ hex ကို ငြင်းပယ်ထားသည်) ထည့်သွင်းပြီး ကုဒ်လုပ်ထားသော payload နှင့် တွေ့ရှိထားသည့် နှစ်ခုလုံးကို ပြန်ပေးသည်
`AccountAddressFormat`။ ယခု Torii သည် ISO 20022 ဖြည့်စွက်မှုအတွက် `parse_any` ကို ခေါ်ဆိုနေသည်
...
Canonical payload တိုင်းကို `header · domain selector · controller` အဖြစ် သတ်မှတ်ထားသည်။ ဟိ
...
#### 2.2 ဒိုမိန်းရွေးချယ်မှု ကုဒ်နံပါတ်များ (ADDR-1a)

ဒိုမိန်းရွေးချယ်သည့်စနစ်သည် ခေါင်းစီးကိုချက်ချင်းလိုက်နာပြီး တဂ်ထားသောသမဂ္ဂတစ်ခုဖြစ်သည်။

| Tag | အဓိပ္ပါယ် | ဝန်ဆောင်ခ | မှတ်စုများ |
|--|---------|---------|-------|
| `0x00` | သွယ်ဝိုက်သော မူရင်းဒိုမိန်း | မရှိ | ပြင်ဆင်ထားသော `default_domain_name()` နှင့် ကိုက်ညီသည်။ |
| `0x01` | ဒေသဆိုင်ရာ ဒိုမိန်းအချေအတင် | 12 bytes | Digest = `blake2s_mac(key = "SORA-LOCAL-K:v1", canonical_label)[0..12]`။ |
| `0x02` | ကမ္ဘာလုံးဆိုင်ရာ မှတ်ပုံတင်ခြင်း ဝင်ခွင့် | 4 bytes | Big-endian `registry_id`; ကမ္ဘာလုံးဆိုင်ရာ မှတ်ပုံတင်သင်္ဘောများအထိ သိမ်းဆည်းထားသည်။ |

ဒိုမိန်းအညွှန်းများကို hashing မလုပ်မီ (UTS-46 + STD3 + NFC) ကို canonicalised လုပ်ထားသည်။ အမည်မသိ တဂ်များသည် `AccountAddressError::UnknownDomainTag` ကို မြှင့်တင်သည်။ ဒိုမိန်းတစ်ခုမှ လိပ်စာတစ်ခုကို အတည်ပြုသောအခါ၊ မကိုက်ညီသော ရွေးချယ်သူများသည် `AccountAddressError::DomainMismatch` ကို မြှင့်တင်သည်။
...
ရွေးချယ်သည့်ကိရိယာသည် ထိန်းချုပ်ကိရိယာပေးချေမှုဝန်နှင့် ချက်ချင်းကပ်လျက်ဖြစ်သောကြောင့် ဒီကုဒ်ဒါသည် လမ်းလျှောက်နိုင်သည်။
အစီအစဥ်အရ ဝါယာကြိုးဖော်မတ်- tag byte ကိုဖတ်ပါ၊ tag-specific payload ကိုဖတ်ပါ၊ ထို့နောက် ဆက်လက်လုပ်ဆောင်ပါ။
controller bytes သို့။

** ရွေးချယ်သူ နမူနာများ **

- *သွယ်ဝိုက်သောမူလ* (`tag = 0x00`)။ ဝန်ဆောင်ခမရှိပါ။ မူရင်းအတွက် ဥပမာ canonical hex
  အဆုံးအဖြတ်စမ်းသပ်သော့ကို အသုံးပြု၍ ဒိုမိန်း
  `0x02000001203b6a27bcceb6a42d62a3a8d02a6f0d73653215771de243a63ac048a18b59da29`။
- *Local digest* (`tag = 0x01`)။ Payload သည် 12-byte digest ဖြစ်သည်။ ဥပမာ (`treasury` မျိုးစေ့
  `0x01`): `0x0201b18fe9c1abbac45b3e38fc5d0001208a88e3dd7409f195fd52db2d3cba5d72ca6709bf1d94121bf3748801b40f6f5c`။
- *ကမ္ဘာလုံးဆိုင်ရာမှတ်ပုံတင်ခြင်း* (`tag = 0x02`)။ Payload သည် `registry_id:u32` အကြီးကြီးဖြစ်သည်။ ဘိုက်
  payload ၏နောက်လိုက်များသည် implicit-default case နှင့် တူညီပါသည်။ ရွေးချယ်သူသည် ရိုးရှင်းပါသည်။
  ပုံမှန် domain string ကို registry pointer ဖြင့် အစားထိုးသည်။ နမူနာအသုံးပြုခြင်း။
  `registry_id = 0x0000_002A` (decimal42) နှင့် အဆုံးအဖြတ်ပေးသော ပုံသေထိန်းချုပ်ကိရိယာ-
  `0x02020000002a000120641297079357229f295938a4b5a333de35069bf47b9d0704e45805713d13c201`။  
  ခွဲခြမ်းစိတ်ဖြာချက်- `0x02` ခေါင်းစီး၊ `0x02` ရွေးချယ်သူ တဂ်၊ `00 00 00 2A` မှတ်ပုံတင်အမှတ်၊ `0x00`
  ထိန်းချုပ်ကိရိယာတဂ်၊ `0x01` မျဉ်းကွေး id၊ `0x20` သော့အရှည်၊ 32-byte Ed25519 သော့ပေးချေမှု။

#### 2.3 ထိန်းချုပ်ကိရိယာ ပေးချေမှုကုဒ်များ (ADDR-1a)

controller payload သည် domain selector ပြီးနောက် နောက်ဆက်တွဲဖြစ်သော အခြားသော တဂ်လုပ်ထားသောသမဂ္ဂဖြစ်သည်-| Tag | ထိန်းချုပ်သူ | အပြင်အဆင် | မှတ်စုများ |
|--|------------|--------|-------|
...
- Domainless IH58 (ဦးစားပေး)/sora (ဒုတိယအကောင်းဆုံး) literals များသည် domain-selector solutionr မှတစ်ဆင့် မြှုပ်သွင်းထားသော ရွေးချယ်သူကို ဖြေရှင်းပေးသည်။ မည်သည့်အရာကိုမျှ မတပ်ဆင်ထားပါက (သို့မဟုတ် ရွေးချယ်မှုအား ဖြေရှင်း၍မရပါ) `ERR_DOMAIN_SELECTOR_UNRESOLVED` ဖြင့် ခွဲခြမ်းစိတ်ဖြာမှု မအောင်မြင်ပါ။ သွယ်ဝိုက်သော ပုံသေရွေးချယ်ပေးသူသည် ဖြေရှင်းသူမလိုအပ်ဘဲ ပြင်ဆင်သတ်မှတ်ထားသော မူရင်းဒိုမိန်းတံဆိပ်ကို ဖြေရှင်းသည်။
...
- **ဒေသတွင်း ဒိုမိန်းအချေအတင် (`treasury`၊ အစေ့ဘိုက် `0x01`)**  
  ...
  ခွဲခြမ်းစိတ်ဖြာချက်- `0x02` ခေါင်းစီး၊ ရွေးချယ်သူတဂ် `0x01` အပေါင်း `b1 8f e9 c1 ab ba c4 5b 3e 38 fc 5d`၊ သော့တစ်ချက်ပေးချေမှုနောက်တွင် (`0x00` တက်ဂ်၊ `0x01` မျဉ်းကွေး id-70280NIX၊ Ed25519 သော့)။ယူနစ်စမ်းသပ်မှုများ (`account::address::tests::parse_any_accepts_all_formats`) သည် `AccountAddress::parse_any` မှတစ်ဆင့် အောက်ဖော်ပြပါ V1 vector များကို အခိုင်အမာ အာမခံပြီး tooling သည် hex၊ IH58 (ဦးစားပေး) နှင့် compressed (`sora`၊ ဒုတိယအကောင်းဆုံး) ပုံစံများတစ်လျှောက် canonical payload ပေါ်တွင် အားကိုးနိုင်ကြောင်း အာမခံပါသည်။ `cargo run -p iroha_data_model --example address_vectors` ဖြင့် တိုးချဲ့ထားသော တပ်ဆင်အား ပြန်လည်ထုတ်ပါ။

| ဒိုမိန်း | အစေ့ဘိုက် | Canonical hex | ချုံ့ထားသည် (`sora`) |
|----------------|-----------------|----------------------------------------------------------------------------------------------------------------|
| ပုံသေ | `0x00` | `0x02000001203b6a27bcceb6a42d62a3a8d02a6f0d73653215771de243a63ac048a18b59da29` | `sora2QGﾈkﾀﾍrNﾒBﾎwﾍwﾙwﾗXHwﾜCﾘﾂY8ryGUﾈﾎyQｲHyヰD8ｲﾁYVY9VF8` |
...
|--------------------|--------------------------------------------------------------------------------
| `default` ဒိုမိန်း (သွယ်ဝိုက်သောရွေးချယ်မှု၊ မျိုးစေ့ `0x00`) | `RnuaJGGDL8HNkN8bwHwBTU32fTWQmbRoM3QZBJintx5RqTU7GgPJmNiA` | `sora2QGﾈkﾀﾍrNﾒBﾎwﾍwﾙwﾗXHwﾜCﾘﾂY8ryGUﾈﾎyQｲHyヰD8ｲﾁYVY9VF8` (ရှင်းလင်းပြတ်သားသောလမ်းကြောင်းဆိုင်ရာ အရိပ်အမြွက်များကို ပေးဆောင်သည့်အခါ နောက်ဆက်တွဲ `@default`) |
...
flows တို့သည် verbatim ကို အားကိုးနိုင်သည်။ တိကျသောလမ်းကြောင်းလမ်းညွှန်ချက် လိုအပ်မှသာ `<address>@<domain>` ကို ဖြည့်စွက်ပါ။ suffix သည် canonical output ၏ အစိတ်အပိုင်းမဟုတ်ပါ။
...
- **စက်အကူအညီများ-** Rust၊ TypeScript/JavaScript၊ Python၊
  ...
  `AccountAddress::parse_any` နှင့် ၎င်းတို့၏ SDK တူညီမှုများ)။ CAIP-10 အထောက် အကူများ ဖြစ်ကြပါသည်။
  အနာဂတ်အလုပ်။
...
- ** ကုဒ်သွင်းခြင်း-** `encode_ih58()` သည် ရှေ့ဆက်ဘိုက်များကို canonical နှင့် ပေါင်းစပ်သည်
  ...
  CLI/SDK အကူအညီပေးသူများသည် တူညီသောလုပ်ထုံးလုပ်နည်းနှင့် `AccountAddress::parse_any` ကို ဖော်ထုတ်သည်။
...
- **`addr-single-default-ed25519` (Sora Nexus၊ ရှေ့ဆက် `0x02F1`)**  
  IH58 `RnuaJGGDL8HNkN8bwHwBTU32fTWQmbRoM3QZBJintx5RqTU7GgPJmNiA`၊ ဖိသိပ်ထားသည် (`sora`)
...
2. ** Canonical digests များကိုရယူပါ။** Run
   ...
   `--append-domain` အတွက် `<address>@<domain>` အဖြစ် ပြောင်းလဲထားသော ကုဒ်နံပါတ်ကို ပြန်ဖွင့်သည်
   ...
   `iroha tools address normalize --input <file> --only-local` ကို အစုလိုက်အပြုံလိုက်-ဒေသတွင်းသို့ ပြောင်းလဲရန်
...
- **ထည့်သွင်းမှုကို စံပြုသတ်မှတ်ခြင်း-** Torii နှင့် SDK များသည် IH58 (ဦးစားပေး)/sora (ဒုတိယအကောင်းဆုံး)/0x လက်ခံသည်။
  လိပ်စာများ ပေါင်း `alias@domain`၊ `public_key@domain`၊ `uaid:…` နှင့်
...
- **CLI tooling-** `iroha tools address convert` မှတစ်ဆင့် အဆုံးအဖြတ်ပေးသော အော်ပရေတာလုပ်ငန်းအသွားအလာကို ပေးဆောင်ပါ။
  ...
  ရွေးချယ်နိုင်သော `<address>@<domain>` အညွှန်းများ၊ Sora Nexus ရှေ့ဆက် (`753`) ကို အသုံးပြု၍ IH58 အထွက်အတွက် ပုံသေများ
  ...
  ခွဲခြမ်းစိတ်ဖြာပြီး ပံ့ပိုးပေးထားသော ဒိုမိန်း (JSON တွင် `input_domain`) နှင့် `--append-domain` အလံကို မှတ်တမ်းတင်သည်
  `<address>@<domain>` အဖြစ် ပြောင်းထားသော ကုဒ်နံပါတ်ကို ပြန်ဖွင့်သည် ထို့ကြောင့် ထင်ရှားသော ကွဲပြားမှုများသည် အံဝင်ခွင်ကျ ရှိနေပါသည်။
...
- **Torii ပေါင်းစည်းခြင်း-** Cache Nexus သည် TTL ကိုလေးစားပြီး ထုတ်လွှတ်သည်
  ...
  `alias@domain` ကို canonicalize လုပ်ရန် `POST /v1/accounts/resolve` ကို ဖော်ထုတ်ပါ။
  `public_key@domain`၊ `uaid:`/`opaque:` စာသားများ သို့မဟုတ် ကုဒ်နံပါတ်များအဖြစ် ကုဒ်နံပါတ်များ
  ဖြေရှင်းထားသော ဒိုမိန်းနှင့် အရင်းအမြစ်ကို ပြန်ပေးနေစဉ် IH58။
...
1. IH58 ကုဒ်နံပါတ်သည် `iroha_data_model` (`AccountAddress::to_ih58`၊
   `parse_any`); SDK တစ်ခုစီသို့ တပ်ဆင်မှုများ/စမ်းသပ်မှုများကို ဆက်လက်လုပ်ဆောင်ပြီး မည်သည့်အရာကိုမဆို ဖယ်ရှားလိုက်ပါ။
