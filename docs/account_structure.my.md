...
- binary controller payload (`ControllerPayload::Multisig`) ကုဒ်နံပါတ်များ
  ...
  `AccountAddress::canonical_bytes()` သည် I105 (ဦးစားပေး)/sora (ဒုတိယအကောင်းဆုံး) payloads သို့ စာရေးသည်။
...
- Fixture coverage သည် `fixtures/account/address_vectors.json` (အမှုတွဲများဖြစ်သည်။
  `addr-multisig-*`)။ Wallets နှင့် SDK များသည် canonical i105 ကြိုးများကို အခိုင်အမာပြုလုပ်သင့်သည်။
...
- Torii နှင့် SDK တို့၏ `address@domain` (rejected legacy form) နာမည်တူများကို ခွဲခြမ်းစိတ်ဖြာခြင်းသည် ယခု I105 (ဦးစားပေး)/sora (ဒုတိယအကောင်းဆုံး) သွင်းအားစုများ မအောင်မြင်သောအခါ တူညီသော `ERR_*` ကုဒ်များကို I105 (ဦးစားပေး)/sora (ဒုတိယအကောင်းဆုံး) သွင်းအားစုများ မအောင်မြင်မီ alias fallback (ဥပမာ mismatch မှားနိုင်ပါသည်၊ ဒိုမိန်းကို ပြန်လည်စစ်ဆေးနိုင်သည်)၊ စကားပြေစာကြောင်းများမှ ခန့်မှန်းခြင်းမပြုဘဲ ဖွဲ့စည်းထားသော အကြောင်းပြချက်များ။
...
- **ဒေသတွင်း ဒိုမိန်းအချေအတင် (`treasury`၊ အစေ့ဘိုက် `0x01`)**  
  ...
  ခွဲခြမ်းစိတ်ဖြာချက်- `0x02` ခေါင်းစီး၊ ရွေးချယ်သူတဂ် `0x01` အပေါင်း `b1 8f e9 c1 ab ba c4 5b 3e 38 fc 5d`၊ သော့တစ်ချက်ပေးချေမှုနောက်တွင် (`0x00` တက်ဂ်၊ `0x01` မျဉ်းကွေး id-70280NIX၊ Ed25519 သော့)။ယူနစ်စမ်းသပ်မှုများ (`account::address::tests::parse_encoded_accepts_all_formats`) သည် `AccountAddress::parse_encoded` မှတစ်ဆင့် အောက်ဖော်ပြပါ V1 vector များကို အခိုင်အမာ အာမခံပြီး tooling သည် hex၊ I105 (ဦးစားပေး) နှင့် i105-default (`sora`၊ ဒုတိယအကောင်းဆုံး) ပုံစံများတစ်လျှောက် canonical payload ပေါ်တွင် အားကိုးနိုင်ကြောင်း အာမခံပါသည်။ `cargo run -p iroha_data_model --example address_vectors` ဖြင့် တိုးချဲ့ထားသော တပ်ဆင်အား ပြန်လည်ထုတ်ပါ။
...
တုံ့ပြန်မှုများ (`canonical i105 literal rendering`) နှင့် SDK အကူအညီပေးသူများ၊ ထို့ကြောင့် UX ကို ကော်ပီ/ကူးထည့်ပါ
...
- **`addr-single-default-ed25519` (Sora Nexus၊ ရှေ့ဆက် `0x02F1`)**  
  I105 `6cmzPVPX5jDQFNfiz6KgmVfm1fhoAqjPhoPFn4nx9mBWaFMyUCwq4cw`၊ ဖိသိပ်ထားသည် (`sora`)
  `sora2QG…U4N5E5`။ Torii သည် `AccountId` မှ ဤအတိအကျစာကြောင်းများကို ထုတ်လွှတ်သည်
  `Display` အကောင်အထည်ဖော်မှု (canonical i105) နှင့် `AccountAddress::to_i105`။
...
2. ** Canonical digests များကိုရယူပါ။** Run
   ...
   manifest diffs (ဤနောက်ဆက်တွဲသည် မက်တာဒေတာဖြစ်ပြီး၊ canonical i105 account id မဟုတ်ဘဲ)။
   ...
   ကျော်သွားနေစဉ် canonical i105 (ဦးစားပေး)၊ ချုံ့ထားသော (`sora`၊ ဒုတိယအကောင်းဆုံး)၊ hex သို့မဟုတ် JSON ဖောင်များအဖြစ် ရွေးချယ်မှုများ
...
4. **အတည်ပြုပြီး ထုတ်ဝေပါ။** runbook စစ်ဆေးရန်စာရင်းကို လိုက်နာပါ (hashes၊ Sigstore၊
   ...
   အစုအဝေးများရောက်ရှိပြီးနောက်ချက်ချင်း I105 (ဦးစားပေး)/sora (ဒုတိယအကောင်းဆုံး) စာလုံးများကို canonicalize လုပ်သည်။
...
- ** မျက်နှာပြင်ပုံသေများ-** Wallets များသည် I105 လိပ်စာကိုပြသသည် (တိုတောင်းသည်၊ အမှန်ခြစ်ပါ)
  ...
  တည်ငြိမ်သောလိပ်စာ။
- **ထည့်သွင်းမှုကို စံပြုသတ်မှတ်ခြင်း-** Torii နှင့် SDK များသည် I105 (ဦးစားပေး)/sora (ဒုတိယအကောင်းဆုံး)/0x လက်ခံသည်။
...
- **CLI tooling-** `iroha tools address convert` မှတစ်ဆင့် အဆုံးအဖြတ်ပေးသော အော်ပရေတာလုပ်ငန်းအသွားအလာကို ပေးဆောင်ပါ။
  ...
  အော်ပရေတာများမှ ပြတ်သားစွာ တောင်းဆိုသောအခါတွင်သာ Sora-only i105-default အက္ခရာကို ထုတ်လွှတ်သည်
...
- `GET /v1/accounts` သည် ရွေးချယ်နိုင်သော `canonical i105 rendering` မေးမြန်းမှု ကန့်သတ်ချက်တစ်ခုကို လက်ခံပြီး
  ...
  - `i105` (မူလ) — တုံ့ပြန်မှုများသည် canonical i105 payloads (ဥပမာ၊
    `6cmzPVPX5jDQFNfiz6KgmVfm1fhoAqjPhoPFn4nx9mBWaFMyUCwq4cw`)။
  - `i105_default` — တုံ့ပြန်မှုများသည် Sora-only `i105` ချုံ့ထားသည့်မြင်ကွင်းကို ထုတ်လွှတ်သည်
