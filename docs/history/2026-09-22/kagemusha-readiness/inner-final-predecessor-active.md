...
The seven inner tests passed in the partial default window below, including six
satisfiable whole-PLONK cases through the guarded inner implementation. The wider
regression selection did not complete successfully.
