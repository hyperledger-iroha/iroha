<!-- Japanese translation of docs/connect_kotlin_ws.md -->
...
### ペイロードの暗号化／復号（ChaCha20-Poly1305 + AAD）
...
// seq=1 で wallet → app 向け SignResultOk を暗号化（ペイロードのみ。Norito フレーミングは別途）
