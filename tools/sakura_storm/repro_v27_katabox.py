...
def main() -> None:
    ...
    env_base.setdefault("SS_GRID_N", "32")
    env_base.setdefault("SS_CELL_SIZE", "16")
    env_base.setdefault("SS_GRID_OFFSET", "0")
    env_base.setdefault("SS_GLYPH_SIZE", "10")
    env_base.setdefault("SS_GLYPH_THRESH", "140")
    ...
    env_base.setdefault("SS_KATAKANA_BOX_ON", "255,244,250")
    env_base.setdefault("SS_KATAKANA_BOX_OFF", "92,56,72")
    env_base.setdefault("SS_KATAKANA_ALPHA", "200")
    env_base.setdefault("SS_KATAKANA_BOX_ALPHA", "255")
    env_base.setdefault("SS_KATAKANA_SCALE", "0.85")
    env_base.setdefault("SS_KATAKANA_BOX_SCALE", "0.85")
