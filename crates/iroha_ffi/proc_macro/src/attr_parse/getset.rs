                ...
                .is_some()
            {
                accumulator.push(
                    darling::Error::custom(
                        "getset attributes without `getset` prefix are not supported by iroha_ffi",
                    )
                    .with_span(attr),
                );
            }
