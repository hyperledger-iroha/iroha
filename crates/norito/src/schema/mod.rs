...
/// use norito::{
///     crc64_fallback, from_bytes, to_bytes, NoritoDeserialize, NoritoSerialize,
/// };
/// use norito::core::{Compression, Header, MAGIC, VERSION_MAJOR, VERSION_MINOR};
/// use norito::schema::SamplePayload;
///
...
///     // UTF-8 bytes for "demo" followed by padding
///     0x00, 0x00, 0x00, 0x00, 0x00, 0x64, 0x65, 0x6D,
///     0x6F, 0x2C, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
///     // Archived `Vec<u32>` header (len/capacity)
///     0x00, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
///     0x00, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
///     // Item payload (`1`, `2`, `3`) stored as u32 values
