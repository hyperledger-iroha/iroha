...
The encoded proof is 1,138,854 bytes. Its transfer rows use the canonical
`FastpqBalanceKeyV1` frames. The test retains the production verifier's 512 KiB rejection, then applies a fixed
