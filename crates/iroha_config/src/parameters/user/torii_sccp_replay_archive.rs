...
impl ToriiSccpReplayArchive {
    ...
    fn into_actual(self) -> Result<Option<actual::ToriiSccpReplayArchive>, &'static str> {
...
fn bounded_usize(value: u64, hard_max: u64, message: &'static str) -> Result<usize, &'static str> {
