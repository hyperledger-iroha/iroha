...
pub mod genesis_instructions_json {
    ...
    mod tests {
        ...
        fn structured_genesis_rejects_negative_asset_mint_quantity() {
            let asset_id = AssetId::new(
                AssetDefinitionId::derive_from_components(
                    DomainId::try_new("fixture", "universal").expect("domain"),
        ...
        fn deserialize_structured_instructions_roundtrip() {
            ...
            let domain_id: DomainId = DomainId::try_new("fixture", "universal").unwrap();
            ...
            let asset_alias: AssetDefinitionAlias = "coin#fixture.universal".parse().unwrap();
...
mod tests {
    ...
    fn parse_genesis_accepts_structured_accounts_without_selector_bootstrap() -> Result<()> {
        ...
        let domain_name: Name = "fixture".parse()?;
    ...
    fn load_new_genesis_block() -> Result<()> {
        ...
        let _genesis_block = builder
            .domain(DomainId::try_new("fixture", "universal")?)
    ...
    fn genesis_block_builder_example() -> Result<()> {
        ...
        genesis_builder = genesis_builder
            .domain(DomainId::try_new("fixture", "universal").unwrap())
