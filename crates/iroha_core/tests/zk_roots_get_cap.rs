...
fn zk_roots_get_respects_cap_and_max() {
    ...
    state.set_zk(cfg::Zk {
        ...
        fastpq: cfg::Fastpq {
            ...
            metal_trace: cfg::defaults::zk::fastpq::METAL_TRACE,
            metal_debug_enum: cfg::defaults::zk::fastpq::METAL_DEBUG_ENUM,
            metal_debug_fused: cfg::defaults::zk::fastpq::METAL_DEBUG_FUSED,
        },
        root_history_cap: 4,
