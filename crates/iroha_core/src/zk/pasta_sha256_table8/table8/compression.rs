...
use super::{super::DIGEST_SIZE, SpreadInputs, SpreadVar, SpreadWord, Table8Assignment};
use crate::zk::pasta_sha256_table8::AssignedWord;
use ff::PrimeField;
use halo2_proofs::{
...
impl<F: PrimeField> Table8Assignment<F> for CompressionConfig {}
...
#[cfg(test)]
mod isolated_tests {
    use super::super::{Table8Chip, Table8Config};
    use halo2_proofs::{
        circuit::{Layouter, V1},
        dev::MockProver,
    ...
    impl Circuit<Fp> for DecomposeAbcdCircuit {
        ...
        fn synthesize(
            ...
            Table8Chip::<Fp>::load(config.clone(), &mut layouter)?;
            layouter.assign_region(
...
#[cfg(test)]
mod tests {
    use super::super::{super::BLOCK_SIZE, Table8Chip, Table8Config, msg_schedule_test_input};
    use crate::zk::pasta_sha256_table8::{BlockWord, IV, ROUND_CONSTANTS};
    use ff::PrimeField;
    ...
    impl<F: PrimeField> Circuit<F> for BadCompressionCircuit {
        ...
        fn synthesize(
            ...
            Table8Chip::<F>::load(config.clone(), &mut layouter)?;
            let (_, halves) = config
                .message_schedule
    ...
    fn compress() {
        ...
        impl<F: PrimeField> Circuit<F> for MyCircuit {
            ...
            fn synthesize(
                ...
                Table8Chip::load(config.clone(), &mut layouter)?;
                // Test vector: "abc"
