...
fn namespace_privacy_and_terminal_source_guards_hold() {
    ...
    assert!(source.contains("Err(RegisteredPlatformP256StatementErrorV2::VerificationUnavailable)"));
    ...
    assert!(owner
        .contains("statement_bytes: Zeroizing<[u8; REGISTERED_PLATFORM_P256_STATEMENT_BYTES_V2]>"));
