//! Aggregate Kagemusha V1 state-machine tests.
...
use iroha_data_model::{
    ...
    kagemusha::{
        ...
        KAGEMUSHA_HISTORY_ACCUMULATOR_BYTES_V1, KAGEMUSHA_OUTBOX_RETRY_METADATA_MAX_BYTES_V1,
        ...
        KagemushaAcceptanceIntentV1, KagemushaAcceptanceTicketV1, KagemushaAcknowledgementV1,
        KagemushaArtifactBindingV1, KagemushaArtifactRoleV1, KagemushaCommitCertificateV1,
        KagemushaCommitEvidenceV1, KagemushaCommitWrapperProofV1, KagemushaDevicePublicKeyV1,
        KagemushaDeviceSignatureV1, KagemushaEncryptedCreditEnvelopeV1,
        KagemushaHardwareCredentialV1, KagemushaInboxReceiptV1, KagemushaLifecycleBindingV1,
        KagemushaOperationKindV1, KagemushaOutboxReservationV1, KagemushaPairedProofV1,
        KagemushaPaymentRequestV1, KagemushaPaymentV1, KagemushaRedemptionStatementV1,
        KagemushaTransferStatementV1, KagemushaTrustedCommitTimeV1,
        kagemusha_ciphertext_digest_v1, kagemusha_credit_opening_canonical_len_v1,
        kagemusha_device_key_reference_v1, kagemusha_inbox_receipt_commitment_v1,
...
use crate::zk::kagemusha_v1_recursion::{
    ...
    KagemushaMintFinalityArtifactsV1, KagemushaMintFinalityHelperVerificationRequestV1,
    KagemushaParityVerificationRequestV1, KagemushaRecursionArtifactsV1,
    KagemushaStateProofVerificationRequestV1, canonical_commit_certificate_digest_v1,
};
...
fn asset_incarnation() -> AxtAssetIncarnationV1 {
    ...
    AxtAssetIncarnationV1::derive(
        ...
        &HashOf::<BlockHeader>::from_untyped_unchecked(Hash::new(
            b"kagemusha-v1-state-registration",
        )),
        &Hash::new(b"kagemusha-v1-state-execution"),
        1,
    )
}
...
fn state_context() -> KagemushaStateContextV1 {
...
fn artifact(role: KagemushaArtifactRoleV1, tag: u8) -> KagemushaArtifactBindingV1 {
...
fn artifacts() -> KagemushaRecursionArtifactsV1 {
    KagemushaRecursionArtifactsV1 {
        ...
        eq_protocol_digest: crate::zk::kagemusha_v1_poseidon::encode(Fp::from(0x15_u64)),
        ep_protocol_digest: crate::zk::kagemusha_v1_poseidon::encode(Fq::from(0x16_u64)),
        commit_wrapper_eq_protocol_digest: crate::zk::kagemusha_v1_poseidon::encode(Fp::from(
            0x17_u64,
        )),
        commit_wrapper_ep_protocol_digest: crate::zk::kagemusha_v1_poseidon::encode(Fq::from(
            0x18_u64,
        )),
        mint_authorization_eq_protocol_digest: crate::zk::kagemusha_v1_poseidon::encode(
            Fp::from(0x19_u64),
        ),
        mint_authorization_ep_protocol_digest: crate::zk::kagemusha_v1_poseidon::encode(
            Fq::from(0x1A_u64),
        ),
        guard_bundle_eq_protocol_digest: crate::zk::kagemusha_v1_poseidon::encode(Fp::from(
            0x1B_u64,
        )),
        guard_bundle_ep_protocol_digest: crate::zk::kagemusha_v1_poseidon::encode(Fq::from(
            0x1C_u64,
        )),
        guard_bundle_verifying_key_eq: artifact(KagemushaArtifactRoleV1::GuardBundleVkEq, 0x50),
        guard_bundle_verifying_key_ep: artifact(KagemushaArtifactRoleV1::GuardBundleVkEp, 0x51),
        ...
        mint_finality: KagemushaMintFinalityArtifactsV1 {
            proving_key_eq: artifact(KagemushaArtifactRoleV1::MintCreditPkEq, 0x54),
            verifying_key_eq: artifact(KagemushaArtifactRoleV1::MintCreditVkEq, 0x55),
            proving_key_ep: artifact(KagemushaArtifactRoleV1::MintCreditPkEp, 0x56),
            verifying_key_ep: artifact(KagemushaArtifactRoleV1::MintCreditVkEp, 0x57),
        },
...
fn eq_history() -> KagemushaEqAccumulatorV1 {
...
fn ep_history() -> KagemushaEpAccumulatorV1 {
    let challenges = (0..KAGEMUSHA_RECURSION_IPA_K_V1)
...
impl KagemushaRecursiveVerifierV1 for AcceptingRecursiveVerifier {
...
impl KagemushaCandidateProofVerifierV1 for AcceptingRecursiveVerifier {
    fn verify_candidate_proof(
        &self,
        _candidate: &PreparedOutgoingCandidateV1,
        _proof: &KagemushaPairedProofV1,
    ) -> Result<(), String> {
        Ok(())
    }
}

impl KagemushaCommitWrapperVerifierV1 for AcceptingRecursiveVerifier {
    fn verify_commit_wrapper(
        &self,
        _public_inputs: &KagemushaCommitWrapperPublicInputsV1,
        _proof: &KagemushaCommitWrapperProofV1,
    ) -> Result<(), String> {
        Ok(())
    }
}
...
impl KagemushaGuardBundleVerifierV1 for AcceptingGuardVerifier {
    fn verify_bootstrap(
        &self,
...
impl KagemushaGuardBundleVerifierV1 for RejectingTransitionGuardVerifier {
    fn verify_bootstrap(
        &self,
        _statement: &BootstrapStatementV1,
        _guard_bundle: &[u8],
...
type TestMachine = KagemushaStateMachineV1<AcceptingRecursiveVerifier, AcceptingGuardVerifier>;
...
fn machine(balance: u128) -> TestMachine {
    ...
    let state = KagemushaStateV1::build(
        context,
        kagemusha_liability_pool_id_v1(&lane.network_id, &lane.asset, context.asset_incarnation)
    ...
    KagemushaStateMachineV1 {
        ...
        consumed_credits,
        acceptance_ticket_book: KagemushaAcceptanceTicketBookV1::new(64 * 1024 * 1024),
        sender_outbox_capacity: KagemushaSenderOutboxCapacityV1::new(
            u64::from(
                iroha_data_model::kagemusha::KAGEMUSHA_PAYMENT_OUTBOX_MIN_BYTES_V1
                    .max(iroha_data_model::kagemusha::KAGEMUSHA_REDEMPTION_OUTBOX_MIN_BYTES_V1),
            ) + 1_048_576,
        ),
        outgoing_candidate_journal: KagemushaOutgoingCandidateJournalV1::default(),
        proof_release: KagemushaStateProofReleaseV1::from_test_artifacts(artifacts()),
...
fn rejecting_transition_machine(
    balance: u128,
) -> KagemushaStateMachineV1<AcceptingRecursiveVerifier, RejectingTransitionGuardVerifier> {
...
fn encrypted_credit_stub(recipient_one_time_key: [u8; 32], index: u64) -> Vec<u8> {
    ...
    let mut nonce = [0x69; KAGEMUSHA_XCHACHA20POLY1305_NONCE_BYTES_V1];
    nonce[KAGEMUSHA_XCHACHA20POLY1305_NONCE_BYTES_V1 - core::mem::size_of::<u64>()..]
...
fn payment_stub_with_amount(
    ...
    let signature = sign(&key, b"kagemusha-v1-state-test");
    ...
    let hardware_credential = KagemushaHardwareCredentialV1 {
        ...
        device_key_reference: kagemusha_device_key_reference_v1(&public_key),
        issued_at_ms: 1,
    ...
    let payment = KagemushaPaymentV1 {
        ...
        proof: KagemushaCommitWrapperProofV1 {
            ...
            eq_deferred_audit: crate::zk::kagemusha_v1_poseidon::encode(Fp::from(0x31_u64)),
            ep_deferred_audit: crate::zk::kagemusha_v1_poseidon::encode(Fq::from(0x32_u64)),
            eq_proof: vec![0xA1],
            ep_proof: vec![0xB2],
...
fn transition_authorization(preview: &TransitionPreviewV1) -> TransitionAuthorizationV1 {
    TransitionAuthorizationV1 {
        ...
        proof: KagemushaPairedProofV1 {
            ...
            guard_eq_credential_audit: crate::zk::kagemusha_v1_poseidon::encode(Fp::from(
                0x41_u64,
            )),
            guard_ep_credential_audit: crate::zk::kagemusha_v1_poseidon::encode(Fq::from(
                0x42_u64,
            )),
            eq_deferred_audit: crate::zk::kagemusha_v1_poseidon::encode(Fp::from(0x43_u64)),
            ep_deferred_audit: crate::zk::kagemusha_v1_poseidon::encode(Fq::from(0x44_u64)),
            eq_proof: vec![0xC1],
            ep_proof: vec![0xD2],
            eq_history: eq_history_bytes(),
            ep_history: ep_history_bytes(),
...
fn prepared_send_with_commit_evidence(
    ...
    payment: &KagemushaPaymentV1,
    reservation_id: DigestV1,
    commit_evidence: KagemushaCommitEvidenceV1,
) -> Result<(PreparedOutgoingCandidateV1, TransitionPreviewV1), KagemushaStateErrorV1> {
    let statement = &payment.statement;
    let amount = statement.amount;
    let outbox_reservation = KagemushaOutboxReservationV1 {
        reservation_id,
        operation_kind: KagemushaOperationKindV1::SendSplit,
        reserved_outbox_bytes: iroha_data_model::kagemusha::KAGEMUSHA_PAYMENT_OUTBOX_MIN_BYTES_V1,
        issued_at_ms: 100,
        expires_at_ms: 10_000,
    };
...
fn prepared_redemption(
    ...
    let effect_digest = KagemushaRedemptionStatementV1 {
        version: KAGEMUSHA_WIRE_VERSION_V1,
...
fn commit_wrapper_proof(
    ...
    KagemushaCommitWrapperProofV1 {
        ...
        eq_deferred_audit: crate::zk::kagemusha_v1_poseidon::encode(Fp::from(0x71_u64)),
        ep_deferred_audit: crate::zk::kagemusha_v1_poseidon::encode(Fq::from(0x72_u64)),
        eq_proof: vec![0xE8],
        ep_proof: vec![0xE9],
        eq_history: eq_history_bytes(),
        ep_history: ep_history_bytes(),
...
fn reseal_snapshot(snapshot: &mut KagemushaStateSnapshotV1) {
...
fn receive_fold_late_authorization_failure_is_fully_atomic() {
    ...
    assert_eq!(
        ...
        Err(KagemushaStateErrorV1::GuardRejected(
...
fn mocked_state_machine_folds_one_thousand_credits_and_builds_one_spend() {
    ...
    machine.acceptance_ticket_book = KagemushaAcceptanceTicketBookV1::new(512 * 1024 * 1024);
    ...
    let mut restored = TestMachine::restore(
        snapshot,
        &anchor,
        KagemushaStateProofReleaseV1::from_test_artifacts(artifacts()),
    ...
    let payment = match &finalized.envelope {
        KagemushaOutgoingEnvelopeV1::Payment(payment) => payment,
...
fn receiver_snapshot_meter_covers_max_guard_and_collection_framing() {
    ...
    for index in 0..128_u64 {
        ...
        staged.stage_certificate.guard_bundle = if index == 0 {
            vec![0xA5; KAGEMUSHA_GUARD_BUNDLE_MAX_BYTES_V1]
        } else {
            vec![0xA5]
        };
        ...
        if index == 0 {
            assert!(usage.live_bytes > KAGEMUSHA_GUARD_BUNDLE_MAX_BYTES_V1 as u64);
        }
        if pending.len() == 127 {
    ...
    assert!(folded_usage.retained_bytes > KAGEMUSHA_GUARD_BUNDLE_MAX_BYTES_V1 as u64);
    assert!(
...
fn proof_histories_remain_constant_size_as_balance_history_grows() {
    ...
    let preview = machine
        .preview_rotate(
            ...
            machine.state().suite_id,
            machine.state().vk_digest,
            [0; 32],
            digest(0xB3),
            40_000,
        )
...
#[test]
fn rotate_is_the_only_verifier_bridge_operation() {
    let machine = machine(41);
    let next_epoch = HardwareEpochV1 {
        generation: 2,
        epoch_id: digest(0xB4),
    };
    let next_binding = DevicePolicyBindingV1 {
        device_key_reference: digest(0xB5),
        hardware_policy_id: digest(0xB6),
    };
    let next_suite = digest(0xB7);
    let next_vk = digest(0xB8);
    let bridge = digest(0xB9);
    let preview = machine
        .preview_rotate(
            next_epoch,
            next_binding,
        ...
        .expect("governed verifier-changing rotation");
    assert_eq!(preview.proof_statement.kind, KagemushaTransitionKindV1::Rotate);
    assert_eq!(preview.successor.suite_id, next_suite);
    assert_eq!(preview.successor.vk_digest, next_vk);
    assert_eq!(preview.successor.balance, machine.state().balance);
    assert_eq!(
        preview.successor.consumed_credit_root,
        machine.state().consumed_credit_root
    );
    assert_eq!(
        preview.proof_statement.rotate_verifier_authorization_digest,
        bridge
    );
...
fn prepare_atomically_reserves_capacity_and_snapshot_rejects_torn_outbox() {
    ...
    let reservation_bytes = iroha_data_model::kagemusha::KAGEMUSHA_REDEMPTION_OUTBOX_MIN_BYTES_V1;
    ...
    assert!(matches!(
        machine.outgoing_candidate_journal.stage(),
        KagemushaOutgoingJournalStageV1::Prepared(existing) if existing == &prepared
    ));
    ...
    torn.sender_outbox_capacity = KagemushaSenderOutboxCapacityV1::new(total_outbox_bytes);
...
fn mock_candidate_recovery_commits_one_successor_and_preserves_retry_bytes() {
    ...
    assert!(matches!(
        ...
        KagemushaOutgoingJournalStageV1::Candidate(existing) if existing == &candidate
    ));
...
fn mock_candidate_restore_rejects_torn_and_corrupt_boundaries() {
    ...
    let mut committed_journal = KagemushaOutgoingCandidateJournalV1::default();
    committed_journal
    ...
    let mut corrupt_journal = KagemushaOutgoingCandidateJournalV1::default();
    corrupt_journal
    ...
    missing_reservation.sender_outbox_capacity =
        KagemushaSenderOutboxCapacityV1::new(machine.sender_outbox_capacity.total_outbox_bytes());
...
fn hardware_commit_atomically_installs_successor_and_final_retry_state() {
    ...
    candidate_proof.eq_proof = vec![0xE8; KAGEMUSHA_PARITY_PROOF_MAX_BYTES_V1];
    candidate_proof.ep_proof = vec![0xE9; KAGEMUSHA_PARITY_PROOF_MAX_BYTES_V1];
    let candidate = machine
    ...
    assert!(matches!(
        machine.outgoing_candidate_journal.stage(),
        KagemushaOutgoingJournalStageV1::Committed(existing) if existing == &committed
    ));
    assert_eq!(
        machine.preview_rotate(
            HardwareEpochV1 {
    ...
    let public_inputs = committed
        .public_wrapper_inputs()
        .expect("terminal public inputs");
    let wrapper_proof = KagemushaCommitWrapperProofV1 {
        version: KAGEMUSHA_WIRE_VERSION_V1,
        eq_protocol_digest: artifacts().commit_wrapper_eq_protocol_digest,
        ep_protocol_digest: artifacts().commit_wrapper_ep_protocol_digest,
        semantic_digest: public_inputs.semantic_digest,
        ...
        eq_deferred_audit: crate::zk::kagemusha_v1_poseidon::encode(Fp::from(0x71_u64)),
        ep_deferred_audit: crate::zk::kagemusha_v1_poseidon::encode(Fq::from(0x72_u64)),
        eq_proof: vec![0xE8; KAGEMUSHA_PARITY_PROOF_MAX_BYTES_V1],
        ep_proof: vec![0xE9; KAGEMUSHA_PARITY_PROOF_MAX_BYTES_V1],
        eq_history: eq_history_bytes(),
        ep_history: ep_history_bytes(),
    };
    let finalized = machine
        .finalize_outgoing_candidate(
            wrapper_proof,
            vec![0xEA; KAGEMUSHA_OUTBOX_RETRY_METADATA_MAX_BYTES_V1 as usize],
        )
