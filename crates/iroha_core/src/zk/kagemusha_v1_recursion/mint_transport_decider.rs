...
> {
    ...
    let (eq_builder, ep_builder, eq_audit, ep_audit, eq_bindings, ep_bindings) =
        build_mint_transport_pair_v1(
            MintTransportFamilyV1::Authorization,
            eq_params,
            ep_params,
            witness,
    ...
    Ok((
        KagemushaMintAuthorizationTransportEqCircuitV1 {
            builder: eq_builder,
            provider_policy_root,
            provider_policy_cells: authorization_policy_cells_v1(&eq_bindings)?,
        },
        KagemushaMintAuthorizationTransportEpCircuitV1 {
            builder: ep_builder,
            provider_policy_root,
            provider_policy_cells: authorization_policy_cells_v1(&ep_bindings)?,
        },
        eq_audit,
        ep_audit,
    ))
...
pub(super) fn build_kagemusha_mint_authority_transport_pair_v1(
    ...
    String,
> {
    let (eq_builder, ep_builder, eq_audit, ep_audit, _, _) = build_mint_transport_pair_v1(
        MintTransportFamilyV1::Authority,
        eq_params,
        ep_params,
        witness,
