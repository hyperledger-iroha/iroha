...
use iroha_data_model::offline::{
    OfflineCashArtifactRoleV1, OFFLINE_CASH_ACKNOWLEDGEMENT_MAX_BYTES_V1,
    OFFLINE_CASH_ARTIFACT_SET_MAX_BYTES_V1, OFFLINE_CASH_ENCRYPTED_CREDIT_MAX_BYTES_V1,
    OFFLINE_CASH_HALO2_K_V1, OFFLINE_CASH_HELPER_PROVING_KEY_MAX_BYTES_V1,
    OFFLINE_CASH_HISTORY_ACCUMULATOR_BYTES_V1, OFFLINE_CASH_PAIRED_PROOF_MAX_BYTES_V1,
    ...
    OFFLINE_CASH_PROCESS_RSS_MAX_BYTES_V1, OFFLINE_CASH_SESSION_MAX_BYTES_V1,
    OFFLINE_CASH_STATE_PROVING_KEY_MAX_BYTES_V1, OFFLINE_CASH_TEXT_SESSION_MAX_BYTES_V1,
