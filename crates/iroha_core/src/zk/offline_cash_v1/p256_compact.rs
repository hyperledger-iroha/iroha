...
use halo2_base::{
    AssignedValue, Context, ContextCell, FIRST_PHASE_CELL_TYPE_ID,
    ...
    utils::{BigPrimeField, CurveAffineExt as _, biguint_to_fe, decompose_biguint, modulus},
    virtual_region::{copy_constraints::SharedCopyConstraintManager, lookups::LookupAnyManager},
};
use halo2_ecc::{
    bigint::{ProperCrtUint, big_is_equal, big_less_than},
    ecc::{
        EcPoint, ec_add_unequal, ec_select, ec_select_from_bits, ec_sub_strict, ec_sub_unequal,
        into_strict_point,
    },
