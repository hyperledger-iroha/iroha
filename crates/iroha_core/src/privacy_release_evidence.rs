...
use iroha_data_model::{
    ...
    privacy::{
        ...
        PrivacyCredentialDocumentTypeV1, PrivacyEngineIdV1, PrivacyEngineManifestDigestV1,
        ...
        PrivacyVegaMdlSignatureAlgorithmV1, PrivacyVerifierDigestV1, PrivacyZkAmsActionV1,
