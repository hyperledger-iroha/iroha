...
use iroha_data_model::privacy::{
    ...
    PrivacyNativeConsensusBindingDigestV1, PrivacyNativeConsensusBindingV1, PrivacyProtocolIdV1,
};
use rand::TryRngCore;
...
pub(crate) const PRIVATE_NOTE_DOMAINS_V1: aggregate::AggregateStarkDomainsV1 =
