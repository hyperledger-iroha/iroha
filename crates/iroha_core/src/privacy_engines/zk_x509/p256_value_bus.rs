...
use super::p256_air::{
    ...
    ZkX509P256ModulusV1, p256_arithmetic_operand_limbs_v1,
};
...
#[derive(Clone, Debug)]
pub(crate) struct P256ValueBusStarkFixedProviderV1<'a> {
...
impl<'a> P256ValueBusStarkFixedProviderV1<'a> {
...
mod tests {
    ...
    fn numeric_endpoint_rows(
        ...
        let fixed = P256ValueBusStarkFixedProviderV1::new_v1(
            endpoint,
            &program.initial,
            &program.linked,
            &program.equalities,
    ...
    fn numeric_fixed_and_row_providers_cover_active_logical_and_domain_padding() {
        ...
        for endpoint in [
            ...
            let fixed_provider = P256ValueBusStarkFixedProviderV1::new_v1(
                endpoint,
                &program.initial,
                &program.linked,
                &program.equalities,
