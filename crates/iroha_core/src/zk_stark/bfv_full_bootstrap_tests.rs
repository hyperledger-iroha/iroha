...
fn sample_bfv_full_bootstrap_artifacts_for_secret(
    ...
    let accumulator =
        iroha_crypto::encode_bfv_full_bootstrap_accumulator_artifact_v1(params, 1, &accumulator)
    ...
    let blind_rotation_key = iroha_crypto::encode_bfv_full_bootstrap_blind_rotation_artifact_v1(
        params,
        1,
        &blind_rotation_key,
    )
...
fn bfv_full_bootstrap_stark_test_release_audit_package_and_digest(
    ...
    let archive_body = [
        ...
        .concat();
    let report_bytes = iroha_crypto::bfv_full_bootstrap_release_audit_report_bytes_v1(&report_body)
...
-> [iroha_crypto::BfvFullBootstrapExecutionProverInputMaterialV1; 2] {
    ...
    let material =
        iroha_crypto::bfv_full_bootstrap_circuit_material_from_artifacts_v1(&params, 1, &artifacts)
