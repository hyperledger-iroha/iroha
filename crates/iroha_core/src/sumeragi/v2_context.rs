...
pub(crate) fn validate_staged_genesis_v2_authority(
    ...
    let expected = freeze_staged_genesis_v2(
        ...
        wire::SumeragiV2GenesisContextParameters {
            ...
            offline_cash_mint_finality_epoch_roster: context
                .offline_cash_mint_finality_epoch_roster
                .clone(),
            next_offline_cash_mint_finality_epoch_roster: context
                .next_epoch_snapshot
                .as_ref()
...
pub fn freeze_staged_genesis_v2(
    ...
    let election = FrozenElectionInputs {
        epoch: 0,
        offline_cash_mint_finality_epoch_roster: signed_parameters
            .offline_cash_mint_finality_epoch_roster
            .clone(),
        epoch_end_height,
        mode,
