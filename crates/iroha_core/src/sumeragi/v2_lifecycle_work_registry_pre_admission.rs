...
impl DurableStoreTerminalRetrySealV1 {
    ...
    pub(in crate::sumeragi) fn seal_validate_predecessor(
        ...
        let validate_pending = validate_ownership
            ...
            .ok()?;
        let projected_store_pending =
            validate_pending.project_validate_store_predecessor(validate_effect, &store_effect)?;
...
impl PreparedAuthenticatedGenesisStoredReplayPreAdmission {
    ...
    pub(in crate::sumeragi) fn seal_store_terminal_retry(
        ...
        self.exactly_retains_owned_store(durable_receipt, ownership)
            .then_some(())?;
        DurableStoreTerminalRetrySealV1::seal_exact(&self.store_effect, ownership, durable_receipt)
    }
