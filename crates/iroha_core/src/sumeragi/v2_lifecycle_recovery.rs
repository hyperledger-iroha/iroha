...
/// while network lane-work ingress remains closed. Every Queue replay must still be
/// quarantined, including an empty replay, until the returned receipt is consumed.
