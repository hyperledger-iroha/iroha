...
mod tests {
    ...
    use crate::sumeragi::{
        ...
        v2_runner::ProductionLifecyclePreActivationRunnerBorrowV1,
    };
    ...
    fn prepared_local_proposal_state_is_affine_and_context_directive_bound() {
        ...
        let directive = LocalProposalDirective::for_test(tag, 0, None, None, None);
        let runner = ProductionLifecyclePreActivationRunnerBorrowV1::for_test();
        ...
        let foreign_directive = LocalProposalDirective::for_test(
