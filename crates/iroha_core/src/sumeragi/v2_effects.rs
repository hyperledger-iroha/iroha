...
//!
//! Rollover deliberately models cleanup as partial success. Kura's typed
//! finality receipt is the irreversible boundary; WAL, body-store, and chunk
//! retirement happen afterward and surface bounded warnings independently.
//! Retained files are replay-safe and never turn a durable decision back into
//! an unfinalized height.

use std::{collections::BTreeMap, fmt, path::Path, sync::Arc, time::Instant};
