//! Context-bound evidence validation and WSV persistence.
//!
//! Live protocol-v2 consensus authenticates votes before reducer admission. The
//! test-only helpers in this module exercise archival evidence construction and
//! deduplication without keeping the retired global actor in production builds.
