...
impl ExplorerEncoder {
    ...
    fn phase(&mut self, value: LifecyclePhase) {
        self.tag(match value {
            ...
            LifecyclePhase::FetchDecision => 5,
            LifecyclePhase::Store => 6,
            LifecyclePhase::StoreDecision => 7,
            LifecyclePhase::Validate => 8,
            LifecyclePhase::ValidateDecision => 9,
            LifecyclePhase::Apply => 10,
            LifecyclePhase::BroadcastProposal => 11,
            LifecyclePhase::BroadcastPrepareVote => 12,
            LifecyclePhase::BroadcastCommitVote => 13,
            LifecyclePhase::BroadcastPrepareQc => 14,
            LifecyclePhase::BroadcastCommitQc => 15,
            LifecyclePhase::BroadcastTimeoutVote => 16,
            LifecyclePhase::BroadcastTc => 17,
            LifecyclePhase::EnterView => 18,
            LifecyclePhase::DiagnosticProposalEquivocation => 19,
            LifecyclePhase::DiagnosticVoteEquivocation => 20,
            LifecyclePhase::DiagnosticTimeoutEquivocation => 21,
            LifecyclePhase::DiagnosticInvalidBody => 22,
            LifecyclePhase::Serve => 23,
            LifecyclePhase::ProducerTurn => 24,
        });
    }
