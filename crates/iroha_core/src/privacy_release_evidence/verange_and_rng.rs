...
pub const fn privacy_release_protocol_descriptor_v1(
    ...
    match protocol_id {
        PrivacyProtocolIdV1::ZkAcePqAuthorizationV0 => {
            "zk-ace-pq-authorization-v0; activation=enabled; permutation=dense-mds-poseidon-goldilocks-x7; commitment=4-independent-length-framed-lane-domain-hashes; combined-generic-collision-target=128-bits; air=4-parallel-poseidon-lanes+complete-quadratic-x7; prover=zk_ace::prove_zk_ace_privacy_v1_with_rng; verifier=zk_ace::verify_zk_ace_privacy_v1; fixed-primary=4096 execution-trace rows; trace-width=136; fixed-secondary=108 unique verifier queries; fixed-depth=12 Fp4 FRI rounds; proof-cap=1427158 exact bytes; proof-soundness=classical-ROM-work-normalized-128-bits; qROM-not-claimed"
        }
