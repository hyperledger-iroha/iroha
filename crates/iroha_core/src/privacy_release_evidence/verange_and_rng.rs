...
pub const fn privacy_release_protocol_descriptor_v1(
    ...
    match protocol_id {
        PrivacyProtocolIdV1::ZkAcePqAuthorizationV0 => {
            "zk-ace-pq-authorization-v0; activation=requires-reviewed-four-stage-and-committed-network-evidence-pins; candidate-permutation=dense-mds-poseidon-goldilocks-x7; candidate-output=4-independent-equal-length-explicit-domain-lanes-with-one-state0-word-each; lane-domains=lane0:zk-ace.poseidon-x7.digest-lane-0.v2,lane1:zk-ace.poseidon-x7.digest-lane-1.v2,lane2:zk-ace.poseidon-x7.digest-lane-2.v2,lane3:zk-ace.poseidon-x7.digest-lane-3.v2; commitment-binding-target=128-bits-classical-ROM; release-gate=positive-canonical-end-to-end+public-statement-binding-mutation+proof-corruption-and-truncation+maximum-shape-resource+committed-policy-transfer+FindPrivacyZkAceReplayNullifierV1-finalized-NetworkId-height-block-hash-provenance+replay-rejection; production-path=availability-pin-guarded; evidence-path=feature-isolated-candidate-joins-production-validation-prover-and-verifier-core; candidate-fixed-primary=4096 execution-trace rows; candidate-fixed-secondary=108 unique verifier queries; candidate-fixed-depth=12 Fp4 FRI rounds; candidate-proof-cap=1427158 exact bytes; candidate-proof-soundness=classical-ROM-work-normalized-128-bits; qROM-not-claimed"
        }
