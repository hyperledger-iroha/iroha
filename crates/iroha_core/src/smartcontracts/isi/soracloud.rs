...
use iroha_data_model::{
    ...
    soracloud::{
        ...
        SoraServiceExecutionPlaneV1, SoraServiceHealthStatusV1, SoraServiceLeaseEgressCheckpointV1,
        ...
        SoraServiceMailboxMessageV1, SoraServiceMutationPreconditionV1, SoraServiceRolloutStateV1,
