...
pub mod isi {
    ...
    fn ensure_kagemusha_v2_chain_backend_available(
        ...
        // TODO: Remove this fail-closed gate only when the branch-independent
        // V2 proof backend and the corresponding chain executor ship together.
    ...
    mod tests {
        ...
        use iroha_data_model::{
            ...
            offline::{
                ...
                KagemushaRecursiveSpendBundleV1, KagemushaRecursiveSpendInitRequestV2,
                KagemushaRecursiveSpendLineageWitnessV1, KagemushaRecursiveSpendTopUpRequestV2,
