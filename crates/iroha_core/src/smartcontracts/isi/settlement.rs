...
mod tests {
    ...
    #[test]
    fn settlement_quantities_reject_negative_numerics_at_construction() {
        let error = Quantity::try_from_numeric(Numeric::new(-1, 0))
            .expect_err("negative quantities must not be constructible");
