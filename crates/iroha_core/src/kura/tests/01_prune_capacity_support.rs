...
fn seal_prune_intent_fixture(mut intent: KuraPruneIntentV3) -> KuraPruneIntentV3 {
    for _ in 0..4 {
...
fn admit_prune_intent_fixture(kura: &Kura, mut intent: KuraPruneIntentV3) -> KuraPruneIntentV3 {
