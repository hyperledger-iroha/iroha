...
//! build fingerprint. The opt-in Kagemusha candidate-build feature additionally requires and
//! verifies an independently pinned reviewed clean signed source closure supplied by the
