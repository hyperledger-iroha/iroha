...
use crate::{KeyGenOption, SessionKey, error::ParseError, rng::rng_from_seed};
...
mod tests {
    ...
    fn hkdf_derivation_is_domain_separated() {
        ...
        let session1 = scheme.compute_shared_secret(&sk1, &pk2);
        let session2 = scheme.compute_shared_secret(&sk2, &pk1);
