...
/// Compatibility shim that makes a modern `rand_core` RNG implement both the new (0.9)
/// and compat (0.6) traits required by downstream dependencies (e.g., `signature`,
...
/// Deterministic RNG derived from an arbitrary seed via SHA-256, compatible with both
/// modern and compat `rand_core` consumers.
...
/// Operating-system RNG wrapped in a compatibility shim.
