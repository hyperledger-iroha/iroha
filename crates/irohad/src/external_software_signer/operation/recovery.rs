...
pub(in crate::external_software_signer) struct RecoveredSignerSignatureV1 {
...
pub(in crate::external_software_signer) struct RecoveredSignerOperationV1 {
...
impl SignerOperationCoordinatorV1 {
    ...
    pub(in crate::external_software_signer) fn recover_completed(
        &self,
        ...
        let current = self.verify(&self.source.observe_committed(&request)?)?;
