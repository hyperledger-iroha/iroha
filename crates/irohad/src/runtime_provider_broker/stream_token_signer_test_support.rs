...
// messages below do not establish attestation, completion, finality or signer qualification.
mod stream_token_signer_test_support {
    use super::*;
    ...
    pub(super) fn signer_binding() -> StreamTokenSignerRuntimeBindingV1 {
    ...
    pub(super) fn expected(
        ...
        SignerStreamTokenExpectedV1::new(body, signer_binding().custody())
            .expect("independently prepared test operation")
    }

    pub(super) fn receipt(payload: &[u8]) -> SignerStreamTokenReceiptV1 {
        let (_, expected) =
            prepare_stream_token_signing_payload_v1(payload, signer_binding().custody())
    ...
    pub(super) fn query() -> SignerStreamTokenObservationRequestV1 {
        ...
        SignerStreamTokenObservationRequestV1 {
            ...
            subject: SignerStreamTokenObservationRequestSubjectV1::CurrentCustody {
                binding_digest: stream_token_binding_digest_v1(signer_binding().custody())
                    .unwrap(),
            },
            challenge: [0x91; 32],
    ...
    pub(super) fn state_claim(
        ...
        let signer_backend = signer_binding();
        SignerStreamTokenStateObservationV1 {
            body: SignerStreamTokenStateObservationBodyV1 {
                ...
                subject: SignerStreamTokenStateSubjectV1::CurrentCustody {
                    binding_digest: stream_token_binding_digest_v1(signer_backend.custody()).unwrap(),
                },
                ...
                network_id: signer_backend.custody().network_id,
                ...
                active_head: SignerCustodyActiveHeadV1 {
                    ...
                    key_revision: signer_backend.custody().key_revision,
                    policy_revision: signer_backend.custody().policy_revision,
                    policy_digest: signer_backend.custody().policy_digest,
                },
