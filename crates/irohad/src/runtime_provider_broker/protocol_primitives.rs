...
define_broker_wire_struct!(sensitive "irohad::runtime_provider_broker::protocol::primitives::PurposeSignRequestWireV1" pub(super) PurposeSignRequestWireV1 { pub(super) purpose: u8, pub(super) payload: Vec<u8>, });
...
define_broker_wire_struct!(copy "irohad::runtime_provider_broker::protocol::primitives::SignResultWireV1" pub(super) SignResultWireV1 { pub(super) signature: [u8; 64], });
define_broker_wire_struct!(sensitive "irohad::runtime_provider_broker::protocol::primitives::VariableSignatureResultWireV1" pub(super) VariableSignatureResultWireV1 { pub(super) signature: Vec<u8>, });
impl_broker_debug_fields!(VariableSignatureResultWireV1 as value {
    "signature_len" => value.signature.len(),
} => finish_non_exhaustive);
define_broker_wire_struct!(copy "irohad::runtime_provider_broker::protocol::primitives::PopIssuerSignRequestWireV1" pub(super) PopIssuerSignRequestWireV1 { pub(super) purpose: u8, pub(super) digest: [u8; 32], });
define_broker_wire_struct!(copy "irohad::runtime_provider_broker::protocol::primitives::PopIssuerSignResultWireV1" pub(super) PopIssuerSignResultWireV1 { pub(super) signature: [u8; 64], });
define_broker_wire_struct!(owned "irohad::runtime_provider_broker::protocol::primitives::GlobalBeaconPartialSignRequestWireV1" pub(super) GlobalBeaconPartialSignRequestWireV1 {
...
define_broker_wire_struct!(copy "irohad::runtime_provider_broker::protocol::primitives::GlobalBeaconPartialSignResultWireV1" pub(super) GlobalBeaconPartialSignResultWireV1 {
    pub(super) partial: iroha_data_model::consensus::GlobalThresholdBeaconPartialSignatureV1,
});
define_broker_wire_struct!(owned "irohad::runtime_provider_broker::protocol::primitives::ParliamentTlePartialReleaseSignRequestWireV1" pub(super) ParliamentTlePartialReleaseSignRequestWireV1 {
    pub(super) projection: iroha_core::tle_release::AuthorizedTleReleaseProjectionV1,
});
define_broker_wire_struct!(owned "irohad::runtime_provider_broker::protocol::primitives::ParliamentTlePartialReleaseSignResultWireV1" pub(super) ParliamentTlePartialReleaseSignResultWireV1 {
    pub(super) partial: iroha_core::tle_release::TlePartialReleaseShareV1,
});
define_broker_wire_struct!(owned "irohad::runtime_provider_broker::protocol::primitives::ParliamentTleCapabilityAttestRequestWireV1" pub(super) ParliamentTleCapabilityAttestRequestWireV1 {
    pub(super) key_session: iroha_core::tle_release::TleKeySessionPublicStateV1,
    pub(super) participant_index: u16,
});
define_broker_wire_struct!(owned "irohad::runtime_provider_broker::protocol::primitives::ParliamentTleCapabilityAttestResultWireV1" pub(super) ParliamentTleCapabilityAttestResultWireV1 {
...
define_broker_wire_struct!(owned "irohad::runtime_provider_broker::protocol::primitives::PopRuntimeOpenResultWireV1" pub(super) PopRuntimeOpenResultWireV1 { pub(super) issuer_signer_handle: String, pub(super) issuer_public_key: [u8; 32], pub(super) enrollment_recipient_key_id: String, pub(super) enrollment_recipient_public_key_digest: [u8; 32], pub(super) wallet_recipient_key_id: String, pub(super) wallet_recipient_public_key_digest: [u8; 32], pub(super) wallet_wrapping_key_id: String, });
define_broker_wire_struct!(move_sensitive "irohad::runtime_provider_broker::protocol::primitives::PopRecipientOpenRequestWireV1" pub(super) PopRecipientOpenRequestWireV1 { pub(super) encrypted_payload: sorafs_manifest::hybrid_envelope::HybridPayloadEnvelopeV1, pub(super) aad: Vec<u8>, });
...
define_broker_wire_struct!(move_sensitive "irohad::runtime_provider_broker::protocol::primitives::PopRecipientOpenResultWireV1" pub(super) PopRecipientOpenResultWireV1 { pub(super) plaintext: Vec<u8>, });
...
define_broker_wire_struct!(sensitive "irohad::runtime_provider_broker::protocol::primitives::BrokerFrameV1" pub(super) BrokerFrameV1 { pub(super) magic: [u8; 8], pub(super) version: u16, pub(super) kind: u8, pub(super) body: Vec<u8>, });
...
define_broker_wire_struct!(owned "irohad::runtime_provider_broker::protocol::primitives::NativeTransactionSignerBindingWireV1" pub(super) NativeTransactionSignerBindingWireV1 { pub(super) role: u8, pub(super) authority: iroha_data_model::account::AccountId, pub(super) public_key: iroha_crypto::PublicKey, });
pub(super) const SORACLOUD_RUNTIME_SIGNER_ROLE_WIRE_V1: u8 = 5;
define_broker_wire_struct!(owned "irohad::runtime_provider_broker::protocol::primitives::EvidenceViewerWebAuthnBindingWireV1" pub(super) EvidenceViewerWebAuthnBindingWireV1 { pub(super) rp_id: String, pub(super) allowed_origins: Vec<String>, pub(super) challenge_ttl_ms: u64, });
...
define_broker_wire_struct!(copy "irohad::runtime_provider_broker::protocol::primitives::ProviderIngestSourceLimitsWireV1" pub(super) ProviderIngestSourceLimitsWireV1 { pub(super) operation_timeout_ms: u64, pub(super) max_content_bytes: u64, pub(super) max_source_providers: u32, pub(super) max_concurrent_streams: u32, });
...
define_broker_wire_struct!(owned "irohad::runtime_provider_broker::protocol::primitives::ProviderIngestSignerBindingWireV1" pub(super) ProviderIngestSignerBindingWireV1 { pub(super) runtime_handle: String, pub(super) adapter_revision: u64, pub(super) signer_policy_id: [u8; 32], pub(super) signer_policy_revision: u64, pub(super) signer_policy_predecessor_digest: Option<[u8; 32]>, pub(super) signer_policy_digest: [u8; 32], pub(super) algorithm: u8, pub(super) public_key: Vec<u8>, });
