#[test]
fn authoritative_agent_autonomy_status_includes_authoritative_run_evidence()
-> Result<(), eyre::Report> {
    use iroha_core::state::World;

    let mut world = World::default();
    let manifest = fixture_agent_manifest();
    let request_commitment = iroha_data_model::soracloud::derive_agent_autonomy_request_commitment(
        "ops_agent",
        "hash:artifact#1",
        Some("hash:prov#1"),
        25,
    ...
    world.soracloud_runtime_receipts_mut_for_testing().insert(
        ...
        SoraRuntimeReceiptV1 {
            ...
            service_name: "workflow_service".parse().expect("valid service name"),
    ...
    world
        ...
        .insert(
            ...
            SoraAgentApartmentAuditEventV1 {
                ...
                service_name: Some("workflow_service".to_owned()),
