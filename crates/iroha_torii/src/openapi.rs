...
fn offline_allowance_query_parameters() -> Vec<Value> {
    vec![
        string_query_param(
            "controller_id",
            "Filter allowances by controller account (accepts IH58/compressed/public-key literals).",
        ),
        integer_query_param(
...
fn offline_transfer_query_parameters() -> Vec<Value> {
    vec![
        string_query_param(
            "controller_id",
            "Filter bundles by originating controller account (accepts IH58/compressed/public-key literals).",
        ),
        string_query_param(
            "receiver_id",
            "Filter bundles by receiver account (accepts IH58/compressed/public-key literals).",
        ),
        string_query_param(
            "deposit_account_id",
            "Filter bundles by deposit account (accepts IH58/compressed/public-key literals).",
        ),
        string_query_param(
            "certificate_id_hex",
...
fn offline_receipt_query_parameters() -> Vec<Value> {
    vec![
        string_query_param(
            "controller_id",
            "Filter receipts by sender/controller account (accepts IH58/compressed/public-key literals).",
        ),
        string_query_param(
            "receiver_id",
            "Filter receipts by receiver account (accepts IH58/compressed/public-key literals).",
        ),
        string_query_param(
            "bundle_id_hex",
...
fn account_paths() -> Map {
    ...
    paths.insert(
        ...
        Value::Object(json_post_operation(
            "Accounts",
            "Onboard an account.",
            "Register or onboard an account.",
            "#/components/schemas/JsonValue",
            "#/components/schemas/JsonValue",
            Vec::new(),
        )),
...
fn nexus_public_lane_stake_operation() -> Map {
    ...
    operation.insert(
        ...
        Value::Array(vec![
            ...
            string_query_param(
                "validator",
                "Optional validator account literal to filter stake entries (IH58/compressed).",
            ),
        ]),
    );
    operation.insert(
...
fn nexus_public_lane_rewards_operation() -> Map {
    ...
    operation.insert(
        ...
        Value::String(
            "Returns the unclaimed reward amount per asset for the requested account in the \
             given public lane. Requires an `account` query parameter (IH58/compressed) and \
    ...
    operation.insert(
        ...
        Value::Array(vec![
            ...
            string_query_param(
                "account",
                "Account literal to evaluate pending rewards for (IH58/compressed).",
            ),
