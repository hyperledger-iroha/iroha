...
fn tags_section() -> Value {
    ...
    offline.insert(
        "description".into(),
        Value::String(
            "Kagemusha readiness and asynchronous top-up/redemption operations. Commands accept only the canonical typed application/x-norito representation."
                .to_owned(),
        ),
    );
...
fn insert_offline_typed_schemas(schemas: &mut Map) {
    ...
    for (name, schema) in [
        ...
        (
            ...
            norito::json!({
                ...
                "properties": {
                    ...
                    "steps": {
                        "type": "array",
                        "items": { "$ref": "#/components/schemas/OfflineTransitionProofStep" }
                    }
                }
            }),
        ),
        (
            "OfflineTransitionVerifierRecord",
            norito::json!({
                "type": "object",
                "required": ["id", "record"],
                "properties": {
        ...
        (
            "OfflineTransitionProofRecordBundle",
            norito::json!({
                "type": "object",
                "required": ["bundle", "verifier_records"],
                "properties": {
                    "bundle": { "$ref": "#/components/schemas/OfflineTransitionProofBundle" },
                    "verifier_records": {
                        "type": "array",
                        "items": { "$ref": "#/components/schemas/OfflineTransitionVerifierRecord" }
                    }
                }
            }),
        ),
        ...
        (
            ...
            norito::json!({
                ...
                "properties": {
                    ...
                    "artifact_binding": { "$ref": "#/components/schemas/OfflineArtifactBinding" },
            ...
            norito::json!({
                ...
                "properties": {
                    ...
                    "change_artifact_binding": {
                        "oneOf": [
                            { "$ref": "#/components/schemas/OfflineArtifactBinding" },
                            { "type": "null" }
                        ]
                    },
...
fn openapi_schemas() -> Map {
        ...
        norito::json!({
            ...
            "properties": {
                ...
                "circuit_id": {
                    "type": "string",
                    "minLength": 1,
                    "description": "Exact verifier circuit selected at the evaluated block."
                },
                "commitment": {
                    "type": "string",
                    "pattern": "^[0-9a-f]{64}$",
                ...
                "max_proof_bytes": {
                    ...
                    "format": "uint32",
                    "minimum": 1,
                    "description": "Maximum proof payload accepted by the active registry record."
                },
                "activation_height": {
                    "type": "integer",
                    "format": "uint64",
    ...
    schemas.insert(
        ...
        norito::json!({
            "type": "object",
            "required": [
                "product_mode", "required_bridge_abi_version", "max_hops",
                ...
                "proof_backend_available", "witnessless_reserved_lineage_supported",
                "ready", "blockers"
            ],
            "additionalProperties": false,
            "properties": {
                "product_mode": {
                    "type": "string",
                    "enum": ["recursive_spend_v1"],
                    "description": "Sole public first-release spendable-cash selector."
                },
                ...
                "witnessless_reserved_lineage_supported": {
                    "type": "boolean",
                    "description": "Whether Reserved-lineage branches can be verified and redeemed without a peer-supplied lineage witness."
                },
                "ready": {
                    "type": "boolean",
...
mod tests {
    ...
    fn generated_spec_offline_roots_and_json_adapters_are_exact() {
        ...
        assert_eq!(
            property_ref(schemas, "OfflineTopUpRequest", "artifact_binding"),
