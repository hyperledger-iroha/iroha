...
pub const CATALOGED_ROUTES: &[RouteDescriptor] = &[
    ...
    contracts_and_verification_keys::SORAFS_GATEWAY_COMPLIANCE_FEEDS_BY_FEED_ID_GET,
    contracts_and_verification_keys::SORAFS_GATEWAY_COMPLIANCE_STATUS_GET,
    contracts_and_verification_keys::SORAFS_GATEWAY_COMPLIANCE_STAGE_POST,
    contracts_and_verification_keys::SORAFS_GATEWAY_COMPLIANCE_ACKNOWLEDGE_POST,
    contracts_and_verification_keys::SORAFS_GATEWAY_COMPLIANCE_PROMOTE_POST,
    contracts_and_verification_keys::SORAFS_GATEWAY_COMPLIANCE_ROLLBACK_POST,
...
mod tests {
    ...
    include!("route_catalog/authentication_routes_test.rs");
    ...
    include!("route_catalog/reputation_surface_test.rs");
}
