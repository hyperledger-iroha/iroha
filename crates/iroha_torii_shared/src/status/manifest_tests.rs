//! Manifest status payload contracts.
...
fn lane_teu_status_uses_one_complete_v1_binary_layout() {
    ...
    let status = NexusLaneTeuStatus {
        ...
        capacity: 2,
        committed: 3,
        buckets: crate::status::NexusLaneTeuBuckets {
            floor: 4,
            headroom: 5,
            must_serve: 6,
            circuit_breaker: 7,
        },
        deferrals: crate::status::NexusLaneTeuDeferrals {
            cap_exceeded: 8,
            envelope_limit: 9,
            quota: 10,
            circuit_breaker: 11,
        ...
        layer_width_buckets: crate::status::SchedulerLayerWidthBuckets::new([
