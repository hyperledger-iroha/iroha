...
pub fn impl_derive_visit(emitter: &mut Emitter, input: &syn::DeriveInput) -> TokenStream2 {
    ...
    let default_visit_sigs: Vec<syn::Signature> = [
        ...
        // "fn visit_execute_wasm(operation: &ExecuteWasm)",
        "fn visit_execute_wasm_smartcontract(operation: &WasmExecutable<WasmSmartContract>)",
        "fn visit_execute_wasm_trigger(operation: &WasmExecutable<TriggerModule>)",
