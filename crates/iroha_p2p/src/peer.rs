...
mod tests {
    ...
    async fn soranet_handshake_accepts_bls_peer_identities() {
        ...
        let outbound = ConnectedTo {
            our_public_address: outbound_addr,
            expected_peer_id: expected_inbound_id,
            key_pair: outbound_keys,
            connection: Connection::from_split(101, outbound_read, outbound_write),
