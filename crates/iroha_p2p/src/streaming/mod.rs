...
//! dedicated control stream for `ControlFrame` exchange and unreliable DATAGRAM delivery for
//! encrypted media chunks. Implementations can use these helpers to negotiate capabilities,
//! announce manifests, and move ciphertext payloads while delegating cryptographic verification to
//! `iroha_crypto::streaming`.
#[cfg(feature = "quic")]
