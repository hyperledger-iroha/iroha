...
pub mod nft {
    ...
    use super::*;
    use crate::permission::{account::is_account_owner, nft::is_nft_owner, revoke_permissions};
    ...
    pub fn visit_set_nft_key_value<V: Execute + Visit + ?Sized>(
        ...
        deny!(
            executor,
            "Can't set value to the NFT metadata of another account"
        );
    }
    ...
    pub fn visit_remove_nft_key_value<V: Execute + Visit + ?Sized>(
        ...
        deny!(
            executor,
            "Can't remove value from the NFT metadata of another account"
        );
    }
}
