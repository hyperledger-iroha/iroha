//! Joined admitted insertion through the original MV child checkpoints.
//!
...
use concread::bptree::{AllocationDemand, ClonePlanning, PairInsertError, Prepaid};
...
{
    /// Begin a private insertion transaction under these same physical writers.
    ///
    ...
    P: AdmittedStoragePolicy + ClonePlanning<K, V> + ClonePlanning<K, Option<V>>,
{
    ...
    /// No-op insertions remain explicit and aborted siblings contribute no rows.
