...
pub mod prelude {
    ...
    pub use crate::{
        ...
        appeals::{
            AppealClass, AppealClassConfig, AppealDecimalParseError, AppealDecision,
            AppealDisbursementError, AppealDisbursementInput, AppealDisbursementPlan,
            AppealPricingConfig, AppealPricingError, AppealQuote, AppealQuoteBreakdown,
            ...
            JurorPayout, parse_appeal_decimal_literal,
        },
