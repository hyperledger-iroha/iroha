...
types!(
    ...
    TransactionEntrypointProofPredicateAtom,
    TransactionEntrypointProofProjection<PredicateMarker>,
    TransactionEntrypointProofProjection<SelectorMarker>,
    ...
    TransactionResult,
    TransactionResultProofPredicateAtom,
    TransactionResultProofProjection<PredicateMarker>,
    TransactionResultProofProjection<SelectorMarker>,
    ...
    Vec<MerkleProof<TransactionEntrypoint>>,
    Vec<MerkleProof<TransactionResult>>,
    Vec<Metadata>,
    Vec<Name>,
    Vec<Numeric>,
