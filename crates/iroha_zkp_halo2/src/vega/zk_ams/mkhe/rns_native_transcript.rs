...
///
/// No discharge bridge is exposed in this tranche.  The exact post-cross
...
/// Move-only owner awaiting the future concrete global-root equality bridge.
///
/// This shape has no constructor or transition in the zero-root tranche.  It
/// cannot accept a raw or generic global root and grants no verification,
/// readiness, composite, or release authority.
#[allow(
    dead_code,
    missing_copy_implementations,
    reason = "the future concrete global-root bridge must consume this owner exactly once"
)]
#[must_use = "global-root equality remains pending until a concrete verifier-owned bridge exists"]
