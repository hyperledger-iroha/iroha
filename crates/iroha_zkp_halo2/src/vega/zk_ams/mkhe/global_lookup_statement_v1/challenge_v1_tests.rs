...
fn executable_coordinate_manifest_has_exact_ordinals_and_predicates() {
    for ordinal in 0..COMPLETE_CHALLENGE_ORDINAL_V1 {
        ...
        assert_eq!(coordinate.predicate, if ordinal == 0 { ChallengePredicateV1::OutsideLookupTable } else { ChallengePredicateV1::Nonzero });
    }
    ...
    let first_round = challenge_coordinate_v1(33).unwrap().purpose;
    ...
    for (ordinal, label, statement, coordinate) in [(46, b"equation-sumcheck-round".as_slice(), 0, 13), (47, b"equation-sumcheck-round".as_slice(), 1, 0), (229, b"group-sumcheck-round".as_slice(), 14, 0), (237, b"group-sumcheck-round".as_slice(), 14, 8), (238, b"lookup-sumcheck-round".as_slice(), 15, 0), (266, b"lookup-sumcheck-round".as_slice(), 15, 28), (267, b"evaluation-opening-batch".as_slice(), 0, u16::MAX), (282, b"evaluation-opening-batch".as_slice(), 15, u16::MAX), (283, b"mask-opening-batch".as_slice(), u16::MAX, u16::MAX)] {
...
fn lookup_relation_has_literal_oracle_and_rejects_every_hostile_term() {
    ...
    assert_eq!(mask_constraint_residuals_v1(7, Scalar::from_u64(5), Scalar::from_u64(7), Scalar::from_u64(12), Scalar::from_u64(99)).unwrap(), [Scalar::zero(); 2]);
...
fn manifest_topology_and_complete_transcript_have_literal_kats() {
    assert_eq!(hex::encode(challenge_manifest_digest_v1()), "992641207c6cd0c0f9b596cb7bfd192d44b8336210765d3ab2bb0bc0df52e0b7");
    assert_eq!(hex::encode(global_lookup_topology_digest_v1()), "2d1dcc86a7c58d99a729df30b5c48d3082cea1e4706068eedf6c6ea5aea567a6");
    let kat = transcript_kat_v1();
    assert_eq!(hex::encode(kat.digest), "82cd8ecc15a89879994dabecaefeaa203e8cf30c3c6718f0fc5d8249d35a5dbf");
    for (actual, expected) in [(kat.z,"6d40d6be60870e4b5c04469c6185d889130bdb559db7514ee2fb19b23a98d260"),(kat.first_sumcheck,"a08a10e8f9bd0b3213d4a9e9c958b22dc7326875fc8210b02b7005472892faff"),(kat.last_sumcheck,"86954c58336bec632a977742bb88f37b6cdfd937d3facfb51f5ddaf4d4ae2bd6"),(kat.first_endpoint_batch,"dccdac7319fb2625b4c4d13c2a4239c3e367a99635b16cd8235378895f56510e"),(kat.last_endpoint_batch,"07ae5d3d52fde2daf666905e6290b96f5e0fddc814c58dfe33f80214d1b41fdb"),(kat.mask_batch,"18f289469d8b7db2331ad6528d7fa86d23c090d6a0d5bbb0e8d217671441069e")] { assert_eq!(hex::encode(actual), expected); }
}
...
fn source_guards_keep_the_manifest_private_bounded_and_non_replayable() {
    ...
    assert!(production.contains("for ordinal in 0..COMPLETE_CHALLENGE_ORDINAL_V1"));
    assert!(production.contains("FIRST_SUMCHECK_ORDINAL_V1 == MU_ORDINAL_V1 + 1"));
    assert_eq!(
        parent
