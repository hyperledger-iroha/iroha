...
//! arithmetic workspace, and publishes 38 independently addressed `c0` limbs followed by
//! 38 independently addressed `c1` limbs. No native `P`-sized key component or `2P`-sized
//! ciphertext crosses this public boundary.
//!
