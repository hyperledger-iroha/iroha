...
mod mkhe;
pub use mkhe::{
    ZkAmsMkheErrorV1, ZkAmsMkheReadinessV1, ZkAmsMkheReleaseManifestV1,
...
mod tests {
    ...
    fn unavailable_mkhe_release_has_no_public_prove_or_verify_bypass() {
        assert_eq!(
            ...
            [
                0x64, 0x68, 0xec, 0xb6, 0x5a, 0x19, 0xd6, 0x4d, 0x5e, 0xa0, 0x64, 0x06, 0x16, 0xbe,
                0xef, 0x82, 0x90, 0x86, 0xb6, 0x17, 0xb3, 0x41, 0xac, 0xbb, 0xca, 0x5e, 0x81, 0xb4,
                0x9b, 0x61, 0xdf, 0x94
            ]
        );
        assert_eq!(
