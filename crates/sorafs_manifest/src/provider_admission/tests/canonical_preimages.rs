...
fn admission_digest_preimages_ignore_caller_layout() {
    ...
    #[norito(
        schema_name = "sorafs_manifest::provider_admission::ProviderAdmissionRevocationV1::digest::RevocationBody<'_>"
    )]
    ...
    let revocation_digest = independently_hash_frame(
        REVOCATION_DIGEST_DOMAIN,
        &ReviewedRevocationBody {
