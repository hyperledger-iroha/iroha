...
- Payload examples:
  ...
  - Mint asset:
    - `{"type":"wsv.mint_asset","payload":{"account_id":"<account>","asset_id":"<internal-bucket:base58-asset-definition-id>#<katakana-i105-account-id>","amount":100}}`
- Notes:
  ...
  - Public asset ids are bare Base58 asset-definition ids. The `asset_id` example above is an internal balance-bucket literal.
