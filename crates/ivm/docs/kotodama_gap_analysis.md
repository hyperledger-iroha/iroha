...
- Done: entrypoint manifests always emit hints; wildcard keys cover opaque access, and diagnostics counters report fallback usage.
...
- Entrypoint manifests always emit hints; fallback usage is surfaced via diagnostics rather than skip reasons.
