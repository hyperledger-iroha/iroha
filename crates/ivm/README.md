...
- Implemented:
  ...
  - AES, SHA-3, Poseidon helpers and BN254 utilities on CPU; Ed25519, ECDSA, and ML-DSA verification.
...
- **Quantum-Resistant Signatures:** ML‑DSA (Crystals Dilithium) verification ships in every IVM build.
