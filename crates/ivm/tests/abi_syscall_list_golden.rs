...
fn abi_syscall_list_matches_golden() {
    ...
    let golden: &[u32] = &[
        ...
        S::SYSCALL_JSON_GET_AMOUNT_DIRECT,
        ...
        S::SYSCALL_NUMERIC_TO_INT_DIRECT,
        S::SYSCALL_NUMERIC_ADD_DIRECT,
        S::SYSCALL_NUMERIC_SUB_DIRECT,
        S::SYSCALL_NUMERIC_MUL_DIRECT,
        S::SYSCALL_NUMERIC_DIV_DIRECT,
        S::SYSCALL_NUMERIC_REM_DIRECT,
        S::SYSCALL_NUMERIC_NEG_DIRECT,
        S::SYSCALL_NUMERIC_EQ_DIRECT,
        S::SYSCALL_NUMERIC_NE_DIRECT,
        S::SYSCALL_NUMERIC_LT_DIRECT,
        S::SYSCALL_NUMERIC_LE_DIRECT,
        S::SYSCALL_NUMERIC_GT_DIRECT,
        S::SYSCALL_NUMERIC_GE_DIRECT,
        ...
        S::SYSCALL_AMOUNT_FROM_I64,
        S::SYSCALL_AMOUNT_FROM_U128,
        S::SYSCALL_AMOUNT_TO_I64,
        S::SYSCALL_AMOUNT_ADD,
        S::SYSCALL_AMOUNT_SUB,
        S::SYSCALL_AMOUNT_MUL,
        S::SYSCALL_AMOUNT_DIV_EXACT,
        S::SYSCALL_AMOUNT_DIV_ROUND,
        S::SYSCALL_AMOUNT_EQ,
        S::SYSCALL_AMOUNT_NE,
        S::SYSCALL_AMOUNT_LT,
        S::SYSCALL_AMOUNT_LE,
