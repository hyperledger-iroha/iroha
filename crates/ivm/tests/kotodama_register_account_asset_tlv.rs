...
fn kotodama_register_account_and_unregister_asset() {
    ...
    let src = r#"
        fn main() {
          ...
          register_account(account_id("ed0120CE7FA46C9DCE7EA4B125E2E36BDB63EA33073E7590AC92816AE1E861B7048B04@wonderland"));
          register_asset("rose", "ROSE", 0, 1);
          unregister_asset(asset_definition("rose#wonderland"));
          unregister_account(account_id("ed0120CE7FA46C9DCE7EA4B125E2E36BDB63EA33073E7590AC92816AE1E861B7048B04@wonderland"));
        }
    "#;
    ...
    let account_map: HashMap<u64, ivm::AccountId> = HashMap::new();
    let asset_map: HashMap<u64, ivm::AssetDefinitionId> = HashMap::new();
    let host = WsvHost::new(wsv, caller, account_map, asset_map);
