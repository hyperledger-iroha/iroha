...
use iroha_data_model::{
    ...
    kagemusha::{
        ...
        KagemushaPaymentV1, KagemushaTrustedCommitTimeV1,
...
fn fixture_values_v1() -> FixtureValuesV1 {
    ...
    let semantic_digest = kagemusha_payment_body_digest_v1(&output, &encrypted_credit)
...
fn canonical_fixture_v1() -> Value {
    ...
    json::json!({
        ...
        "request": encoded_section(request_raw.clone(), Some(request_text), Some(1)),
        ...
        "proof": encoded_section(proof_raw, None, None),
