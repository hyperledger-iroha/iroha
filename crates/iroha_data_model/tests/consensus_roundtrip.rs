...
fn rng_proposal_gate_status(rng: &mut DeterministicRng) -> SumeragiProposalGateStatus {
    SumeragiProposalGateStatus {
        height: rng.next_u64(),
        view: rng.next_u64(),
        queue_len: rng.next_u64(),
        pending_blocks_total: rng.next_u64(),
        pending_blocks_blocking: rng.next_u64(),
        active_pending_for_tip: rng.next_u64(),
        queue_saturated: rng.next_bool(),
        active_pending: rng.next_bool(),
        rbc_backlog: rng.next_bool(),
        relay_backpressure: rng.next_bool(),
        consensus_queue_backpressure: rng.next_bool(),
        should_defer: rng.next_bool(),
        only_pacing_backpressure: rng.next_bool(),
        commit_inflight_active: rng.next_bool(),
        cached_proposal_present: rng.next_bool(),
        cached_proposal_hint_present: rng.next_bool(),
        round_liveness_present: rng.next_bool(),
        frontier_owner_present: rng.next_bool(),
        missing_qc_liveness_active: rng.next_bool(),
        last_pacemaker_attempt_age_ms: rng.next_u64(),
        last_successful_proposal_age_ms: rng.next_u64(),
    }
}
...
fn rng_sumeragi_status(rng: &mut DeterministicRng) -> SumeragiStatusWire {
    SumeragiStatusWire {
        ...
        proposal_gate: rng_proposal_gate_status(rng),
        ...
        tx_queue_retained_bytes: rng.next_u64(),
        tx_queue_max_retained_bytes: rng.next_u64(),
        tx_queue_saturated: rng.next_bool(),
        tx_queue_saturated_by_count: rng.next_bool(),
        tx_queue_saturated_by_bytes: rng.next_bool(),
        tx_queue_saturated_by_age: rng.next_bool(),
        tx_queue_oldest_queued_age_ms: rng.next_u64(),
        epoch_length_blocks: rng.next_u64(),
...
fn sumeragi_wire_status_roundtrip() {
    ...
    let status = SumeragiStatusWire {
        ...
        proposal_gate: SumeragiProposalGateStatus {
            ...
            cached_proposal_present: true,
            cached_proposal_hint_present: true,
            round_liveness_present: true,
            frontier_owner_present: false,
