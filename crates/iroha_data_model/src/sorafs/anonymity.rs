...
/// Successful terminal payload for an anonymous service-note escrow.
#[derive(Clone, Copy, Debug, PartialEq, Eq, PartialOrd, Ord, Encode, Decode, IntoSchema)]
#[cfg_attr(feature = "json", derive(DeriveJsonSerialize, DeriveJsonDeserialize))]
#[cfg_attr(feature = "json", norito(deny_unknown_fields))]
pub struct SorafsAnonymousServiceRefundV1 {
...
/// Adjudicated terminal payload for an anonymous service-note escrow.
#[derive(Clone, Copy, Debug, PartialEq, Eq, PartialOrd, Ord, Encode, Decode, IntoSchema)]
#[cfg_attr(feature = "json", derive(DeriveJsonSerialize, DeriveJsonDeserialize))]
#[cfg_attr(feature = "json", norito(deny_unknown_fields))]
pub struct SorafsAnonymousServiceSlashV1 {
...
pub enum SorafsAnonymousServiceEscrowStateV1 {
    ...
    Refunded(SorafsAnonymousServiceRefundV1),
    /// Governance adjudication transferred only the note value to the penalty sink.
    Slashed(SorafsAnonymousServiceSlashV1),
}
...
impl SorafsAnonymousServiceEscrowV1 {
    ...
    pub fn refund(
        ...
        let mut next = self.clone();
        next.state =
            SorafsAnonymousServiceEscrowStateV1::Refunded(SorafsAnonymousServiceRefundV1 {
    ...
    pub fn slash(
        ...
        let mut next = self.clone();
        next.state = SorafsAnonymousServiceEscrowStateV1::Slashed(SorafsAnonymousServiceSlashV1 {
            evidence_digest,
            adjudication_digest,
            finalized_height,
        });
...
mod tests {
    ...
    fn exit_delay_is_frozen_and_exact() {
        ...
        assert_eq!(
            ...
            SorafsCitizenBondStateV1::ExitPending(SorafsCitizenBondExitPendingV1 {
