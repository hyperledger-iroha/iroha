    ...
    fn sample_fhe_input_admission_proof() -> SoracloudFheInputAdmissionProofV1 {
        ...
        let (_, public_key, _) =
            keygen_from_seed(&params, b"soracloud-input-admission-proof-keygen")
    ...
    fn assert_soracloud_artifact_digest_domains(
        ...
        let domains = schema_value
            ...
            .and_then(Value::as_object)
            .unwrap_or_else(|| {
                panic!("{context} must carry artifact digest domains at `{pointer}`")
            });
    ...
    fn assert_soracloud_execution_schema_sections(schema_value: &Value, context: &str) {
        ...
        assert_schema_u64_field(
            ...
            "trace_field_count",
            u64::from(
                iroha_crypto::fhe_bfv::BFV_FULL_BOOTSTRAP_EXECUTION_PREFIX_TRACE_FIELD_COUNT_V1,
            ),
            context,
        );
        assert_schema_u64_field(
        ...
        let artifact_bundle =
            assert_schema_object(schema_value, "/artifact_bundle", "artifact bundle");
        assert_schema_u64_field(
            artifact_bundle,
    ...
    fn assert_soracloud_release_audit_schema_sections(schema_value: &Value, context: &str) {
        ...
        assert_schema_u64_field(
            ...
            "field_count",
            u64::from(
                iroha_crypto::fhe_bfv::BFV_FULL_BOOTSTRAP_RELEASE_AUDIT_EVIDENCE_FIELD_COUNT_V1,
            ),
            context,
        );
        ...
        assert_schema_u64_field(
            ...
            "field_count",
            u64::from(
                iroha_crypto::fhe_bfv::BFV_FULL_BOOTSTRAP_RELEASE_AUDIT_SIGNOFF_FIELD_COUNT_V1,
            ),
            context,
        );
        assert_schema_u64_field(
        ...
        assert_schema_u64_field(
            ...
            "field_count",
            u64::from(
                iroha_crypto::fhe_bfv::BFV_FULL_BOOTSTRAP_RELEASE_AUDIT_RECORD_FIELD_COUNT_V1,
            ),
            context,
        );
        ...
        assert_schema_u64_field(
            ...
            "field_count",
            u64::from(
                iroha_crypto::fhe_bfv::BFV_FULL_BOOTSTRAP_RELEASE_AUDIT_MANIFEST_FIELD_COUNT_V1,
            ),
            context,
        );
