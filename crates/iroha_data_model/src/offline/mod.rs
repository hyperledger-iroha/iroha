...
mod model {
    ...
    /// Canonical proof-bearing receipt for an exact V5 candidate.
    #[derive(Debug, Clone, PartialEq, Eq, Decode, Encode, IntoSchema)]
    #[cfg_attr(
        feature = "json",
        derive(crate::DeriveJsonSerialize, crate::DeriveJsonDeserialize)
    ...
    #[norito(deny_unknown_fields)]
    pub struct KagemushaRecursiveSpendQualificationReceiptV5 {
        /// Exact V5 receipt schema identifier.
        pub(super) schema: String,
        /// Receipt layout version.
        pub(super) version: u16,
        /// SHA-256 of the exact canonical unsigned V5 candidate record.
        #[cfg_attr(feature = "json", norito(json = "crate::json_helpers::fixed_bytes"))]
        pub(super) candidate_sha256: [u8; 32],
        /// SHA-256 of the candidate's exact canonical unsigned V5 manifest.
        #[cfg_attr(feature = "json", norito(json = "crate::json_helpers::fixed_bytes"))]
        pub(super) manifest_sha256: [u8; 32],
        /// Exact in-process physical-memory ceiling committed by the candidate.
        pub(super) generation_memory_limit_bytes: u64,
        /// Exact mandatory in-process memory enforcement profile.
        pub(super) generation_memory_enforcement_profile: String,
        /// Framed then payload SHA-256 for all eight unchanged cryptographic artifact roles.
        #[cfg_attr(feature = "json", norito(json = "crate::json_helpers::fixed_array"))]
        pub(super) artifact_role_digests: [[u8; 32]; 16],
        /// Exact canonical Eq/Ep initialization proof pair bytes.
        pub(super) initialization_pair: Vec<u8>,
    ...
    /// Immutable V5 release identity reviewed before evidence finalization.
    #[derive(Debug, Clone, PartialEq, Eq, PartialOrd, Ord, Decode, Encode, IntoSchema)]
    #[cfg_attr(
        feature = "json",
        derive(crate::DeriveJsonSerialize, crate::DeriveJsonDeserialize)
    ...
    #[norito(deny_unknown_fields)]
    pub struct KagemushaRecursiveSpendCryptographicReviewSubjectV5 {
        /// SHA-256 of the canonical immutable V5 candidate.
        #[cfg_attr(feature = "json", norito(json = "crate::json_helpers::fixed_bytes"))]
        pub candidate_sha256: [u8; 32],
        /// SHA-256 of the canonical V5 qualification receipt.
        #[cfg_attr(feature = "json", norito(json = "crate::json_helpers::fixed_bytes"))]
        pub qualification_receipt_sha256: [u8; 32],
        /// Domain-separated identity of the V5 candidate and receipt.
        #[cfg_attr(feature = "json", norito(json = "crate::json_helpers::fixed_bytes"))]
        pub qualified_candidate_sha256: [u8; 32],
        /// Exact release generation copied from the candidate.
        pub generation: String,
        /// Exact signed source revision copied from the candidate.
        pub source_commit: String,
        /// Exact Git tree object copied from the candidate.
        pub source_git_tree: String,
        /// Exact signed source-tree identity copied from the candidate.
        #[cfg_attr(feature = "json", norito(json = "crate::json_helpers::fixed_bytes"))]
        pub source_tree_sha256: [u8; 32],
        /// Exact clean-tree state copied from the candidate (`false`).
        pub source_repo_dirty: bool,
        /// Exact canonical V2 closure descriptor digest copied from the candidate.
        #[cfg_attr(feature = "json", norito(json = "crate::json_helpers::fixed_bytes"))]
        pub reviewed_source_closure_descriptor_sha256: [u8; 32],
        /// Exact retained C-prime source-seal projection digest copied from the candidate.
        #[cfg_attr(feature = "json", norito(json = "crate::json_helpers::fixed_bytes"))]
        pub authenticated_source_seal_projection_sha256: [u8; 32],
        /// Exact network for which the reviewed candidate was built.
        pub network_id: NetworkId,
    ...
    /// Exact domain-separated payload signed by every V5 reviewer.
    #[derive(Debug, Clone, PartialEq, Eq, PartialOrd, Ord, Decode, Encode, IntoSchema)]
    #[cfg_attr(
        feature = "json",
        derive(crate::DeriveJsonSerialize, crate::DeriveJsonDeserialize)
    ...
    #[norito(deny_unknown_fields)]
    pub struct KagemushaRecursiveSpendCryptographicReviewPayloadV5 {
        /// Cross-protocol replay separator.
        pub domain: String,
        /// Exact immutable V5 candidate under review.
        pub subject: KagemushaRecursiveSpendCryptographicReviewSubjectV5,
        /// Review disposition; production requires `Approved`.
        pub decision: KagemushaRecursiveSpendCryptographicReviewDecisionV4,
        /// SHA-256 of the complete retained review report.
        #[cfg_attr(feature = "json", norito(json = "crate::json_helpers::fixed_bytes"))]
    ...
    /// One policy-authorized signature over a complete V5 review payload.
    #[derive(Debug, Clone, PartialEq, Eq, PartialOrd, Ord, Decode, Encode, IntoSchema)]
    #[cfg_attr(
        feature = "json",
        derive(crate::DeriveJsonSerialize, crate::DeriveJsonDeserialize)
    ...
    #[norito(deny_unknown_fields)]
    pub struct KagemushaRecursiveSpendCryptographicReviewApprovalV5 {
        /// Reviewer identity selected by the trusted release policy.
        pub public_key: PublicKey,
        /// Signature over the exact V5 domain, source identities, report, roles, and checks.
        pub signature: SignatureOf<KagemushaRecursiveSpendCryptographicReviewPayloadV5>,
    }
    /// Canonical signed independent cryptographic-review evidence for V5.
    #[derive(Debug, Clone, PartialEq, Eq, PartialOrd, Ord, Decode, Encode, IntoSchema)]
    #[cfg_attr(
        feature = "json",
        derive(crate::DeriveJsonSerialize, crate::DeriveJsonDeserialize)
    ...
    #[norito(deny_unknown_fields)]
    pub struct KagemushaRecursiveSpendCryptographicReviewEvidenceV5 {
        /// Exact V5 cryptographic-review schema.
        pub schema: String,
        /// Cryptographic-review envelope version.
        pub version: u16,
        /// Candidate-bound V5 review decision signed by every approval.
        pub payload: KagemushaRecursiveSpendCryptographicReviewPayloadV5,
        /// Strictly ascending, unique reviewer approvals.
        pub approvals: Vec<KagemushaRecursiveSpendCryptographicReviewApprovalV5>,
    }
    /// Immutable subject shared by every role-specific V5 release approval.
    #[derive(Debug, Clone, PartialEq, Eq, PartialOrd, Ord, Decode, Encode, IntoSchema)]
    #[cfg_attr(
        feature = "json",
        derive(crate::DeriveJsonSerialize, crate::DeriveJsonDeserialize)
    ...
    #[norito(deny_unknown_fields)]
    pub struct KagemushaRecursiveSpendReleaseAttestationSubjectV5 {
        /// SHA-256 of the canonical V5 manifest with its attestation slot zeroed.
        #[cfg_attr(feature = "json", norito(json = "crate::json_helpers::fixed_bytes"))]
        pub manifest_subject_sha256: [u8; 32],
        /// SHA-256 of the canonical V5 qualification receipt.
        #[cfg_attr(feature = "json", norito(json = "crate::json_helpers::fixed_bytes"))]
        ...
        #[cfg_attr(feature = "json", norito(json = "crate::json_helpers::fixed_bytes"))]
        pub qualified_candidate_sha256: [u8; 32],
        /// Exact release generation copied from the V5 manifest.
        pub generation: String,
        /// Exact signed source revision copied from the V5 manifest.
        pub source_commit: String,
        /// Exact Git tree object copied from the V5 manifest.
        pub source_git_tree: String,
        /// Exact signed source-tree identity copied from the V5 manifest.
        #[cfg_attr(feature = "json", norito(json = "crate::json_helpers::fixed_bytes"))]
        pub source_tree_sha256: [u8; 32],
        /// Exact clean-tree state copied from the V5 manifest (`false`).
        pub source_repo_dirty: bool,
        /// Exact canonical V2 closure descriptor digest copied from the manifest.
        #[cfg_attr(feature = "json", norito(json = "crate::json_helpers::fixed_bytes"))]
        pub reviewed_source_closure_descriptor_sha256: [u8; 32],
        /// Exact retained C-prime source-seal projection digest copied from the manifest.
        #[cfg_attr(feature = "json", norito(json = "crate::json_helpers::fixed_bytes"))]
        pub authenticated_source_seal_projection_sha256: [u8; 32],
        /// Digest of the signed physical-device evidence file.
        #[cfg_attr(feature = "json", norito(json = "crate::json_helpers::fixed_bytes"))]
        pub benchmark_evidence_sha256: [u8; 32],
        /// Digest of the independent V5 cryptographic review file.
        #[cfg_attr(feature = "json", norito(json = "crate::json_helpers::fixed_bytes"))]
        pub cryptographic_review_sha256: [u8; 32],
    }
    /// Domain-separated value signed for one independent V5 approval role.
    #[derive(Debug, Clone, PartialEq, Eq, PartialOrd, Ord, Decode, Encode, IntoSchema)]
    #[cfg_attr(
        feature = "json",
        derive(crate::DeriveJsonSerialize, crate::DeriveJsonDeserialize)
    ...
    #[norito(deny_unknown_fields)]
    pub struct KagemushaRecursiveSpendReleaseApprovalPayloadV5 {
        /// Cross-protocol replay separator.
        pub domain: String,
        /// Authority role for which this signature is valid.
        pub role: KagemushaRecursiveSpendReleaseApprovalRoleV1,
        /// Complete V5 release subject approved by the signer.
        pub subject: KagemushaRecursiveSpendReleaseAttestationSubjectV5,
    }
    /// One role-bound signature inside a V5 release attestation.
    #[derive(Debug, Clone, PartialEq, Eq, PartialOrd, Ord, Decode, Encode, IntoSchema)]
    #[cfg_attr(
        feature = "json",
        derive(crate::DeriveJsonSerialize, crate::DeriveJsonDeserialize)
    ...
    #[norito(deny_unknown_fields)]
    pub struct KagemushaRecursiveSpendReleaseApprovalV5 {
        /// Independent authority role represented by this signature.
        pub role: KagemushaRecursiveSpendReleaseApprovalRoleV1,
        /// Exact signer key selected by the trusted release policy.
        pub public_key: PublicKey,
        /// Signature over the V5 domain, role, and complete source-bound subject.
        pub signature: SignatureOf<KagemushaRecursiveSpendReleaseApprovalPayloadV5>,
    }
    /// Authenticated release envelope whose digest occupies the V5 manifest slot.
    #[derive(Debug, Clone, PartialEq, Eq, PartialOrd, Ord, Decode, Encode, IntoSchema)]
    #[cfg_attr(
        feature = "json",
        derive(crate::DeriveJsonSerialize, crate::DeriveJsonDeserialize)
    ...
    #[norito(deny_unknown_fields)]
    pub struct KagemushaRecursiveSpendReleaseAttestationV5 {
        /// Exact V5 attestation schema.
        pub schema: String,
        /// Attestation layout version.
        pub version: u16,
        /// Immutable V5 subject approved by all roles.
        pub subject: KagemushaRecursiveSpendReleaseAttestationSubjectV5,
        /// Strictly ordered, unique role/signer approvals.
        pub approvals: Vec<KagemushaRecursiveSpendReleaseApprovalV5>,
    }
    /// Deterministic V5 deployment marker written only after release verification.
    #[derive(Debug, Clone, PartialEq, Eq, PartialOrd, Ord, Decode, Encode, IntoSchema)]
    #[cfg_attr(
        feature = "json",
        derive(crate::DeriveJsonSerialize, crate::DeriveJsonDeserialize)
    ...
    #[norito(deny_unknown_fields)]
    pub struct KagemushaRecursiveSpendPromotedReleaseV5 {
        /// Exact V5 promotion-record schema.
        pub schema: String,
        /// Promotion-record layout version.
        pub version: u16,
        /// Authenticated V5 release generation.
        pub generation: String,
        /// SHA-256 of the immutable V5 candidate record.
        #[cfg_attr(feature = "json", norito(json = "crate::json_helpers::fixed_bytes"))]
        pub candidate_sha256: [u8; 32],
        /// SHA-256 of the canonical V5 qualification receipt.
        #[cfg_attr(feature = "json", norito(json = "crate::json_helpers::fixed_bytes"))]
        ...
        #[cfg_attr(feature = "json", norito(json = "crate::json_helpers::fixed_bytes"))]
        pub qualified_candidate_sha256: [u8; 32],
        /// SHA-256 of the complete canonical V5 manifest.
        #[cfg_attr(feature = "json", norito(json = "crate::json_helpers::fixed_bytes"))]
        pub manifest_sha256: [u8; 32],
        /// SHA-256 of the canonical signed V5 release attestation.
        #[cfg_attr(feature = "json", norito(json = "crate::json_helpers::fixed_bytes"))]
        pub release_attestation_sha256: [u8; 32],
        /// SHA-256 of the locally trusted release policy.
        #[cfg_attr(feature = "json", norito(json = "crate::json_helpers::fixed_bytes"))]
        ...
        /// Canonically ordered role/signer identities whose signatures were verified.
        pub approved_signers: Vec<KagemushaRecursiveSpendApprovedSignerV1>,
        /// Whether every content-addressed artifact was verified before publication.
        pub artifact_inventory_verified: bool,
        /// Native bridge ABI required to consume this promoted release.
        pub bridge_abi_version: u32,
        /// Exact Eq-then-Ep eight-role cryptographic artifact inventory.
        pub artifact_roles: Vec<String>,
        /// Authenticated release-specific proof-pair byte ceiling.
        pub max_proof_bytes: u32,
    }
    /// Complete signed V5 release material persisted by consensus activation.
    #[derive(Debug, Clone, PartialEq, Eq, PartialOrd, Ord, Decode, Encode, IntoSchema)]
    #[cfg_attr(
        feature = "json",
        derive(crate::DeriveJsonSerialize, crate::DeriveJsonDeserialize)
    ...
    #[norito(deny_unknown_fields)]
    pub struct KagemushaRecursiveSpendReleaseRecordV5 {
        /// Canonical evidence-bearing V5 release manifest.
        pub manifest: KagemushaRecursiveSpendArtifactManifestV5,
        /// Role-threshold signatures over the finalized V5 release subject.
        pub release_attestation: KagemushaRecursiveSpendReleaseAttestationV5,
        /// Canonical signed physical-device benchmark summary bytes.
        pub physical_device_benchmark_summary: Vec<u8>,
        /// Canonical signed V5 independent cryptographic-review summary bytes.
        pub cryptographic_review_summary: Vec<u8>,
        /// Promotion marker binding the candidate, policy, release, and inventory.
        pub promotion_record: KagemushaRecursiveSpendPromotedReleaseV5,
    }
    /// Atomic consensus payload for one V5 release and its two unchanged terminal verifiers.
    #[derive(Debug, Clone, PartialEq, Eq, PartialOrd, Ord, Decode, Encode, IntoSchema)]
    #[cfg_attr(
        feature = "json",
        derive(crate::DeriveJsonSerialize, crate::DeriveJsonDeserialize)
    ...
    #[norito(deny_unknown_fields)]
    pub struct KagemushaRecursiveSpendReleaseActivationV5 {
        /// Fully authenticated signed V5 release record.
        pub release_record: KagemushaRecursiveSpendReleaseRecordV5,
        /// SHA-256 of the operator-configured canonical release policy.
        #[cfg_attr(feature = "json", norito(json = "crate::json_helpers::fixed_bytes"))]
        pub configured_policy_sha256: [u8; 32],
        /// Registry id for the EqAffine/Vesta verifying key.
