...
// Compare the borrowed canonical wire view so predicate equality reflects semantics without
// cloning an attacker-controlled predicate payload.
...
mod codec_tests {
    ...
    fn compound_predicate_equality_tracks_predicate_semantics() {
        ...
        let unknown = CompoundPredicate::<query::CommittedTransaction>::with_payload(
