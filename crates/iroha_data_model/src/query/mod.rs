...
impl CommittedTransaction {
    ...
    pub fn inject_instructions(
        ...
        // Update the proof's leaf hash to match the tampered entrypoint.
        self.entrypoint_proof.sibling_hashes[0] = Some(self.entrypoint.hash());
    }
    ...
    pub fn swap_result(&mut self) {
        ...
        *result = if result.is_ok() {
        ...
        // Update the proof's leaf hash to match the tampered result.
        self.result_proof.sibling_hashes[0] = Some(self.result.hash());
    }
}
