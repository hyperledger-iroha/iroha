...
.register_with_id_slice::<RegisterOracleFeed>("iroha.instruction.v1::oracle::RegisterOracleFeed")
            .register_with_id_slice::<SubmitOracleObservation>("iroha.instruction.v1::oracle::SubmitOracleObservation")
            .register_with_id_slice::<AggregateOracleFeed>("iroha.instruction.v1::oracle::AggregateOracleFeed")
            .register_with_id_slice::<OpenOracleDispute>("iroha.instruction.v1::oracle::OpenOracleDispute")
            .register_with_id_slice::<ResolveOracleDispute>("iroha.instruction.v1::oracle::ResolveOracleDispute")
            .register_with_id_slice::<ProposeOracleChange>("iroha.instruction.v1::oracle::ProposeOracleChange")
            .register_with_id_slice::<VoteOracleChangeStage>("iroha.instruction.v1::oracle::VoteOracleChangeStage")
            .register_with_id_slice::<RollbackOracleChange>("iroha.instruction.v1::oracle::RollbackOracleChange")
            .register_with_id_slice::<SubmitDefiOracleAttestation>("iroha.instruction.v1::oracle::SubmitDefiOracleAttestation")
            .register_with_id_slice::<RecordTwitterBinding>("iroha.instruction.v1::oracle::RecordTwitterBinding")
            .register_with_id_slice::<RevokeTwitterBinding>("iroha.instruction.v1::oracle::RevokeTwitterBinding");
        let (
            register,
            submit,
            aggregate,
