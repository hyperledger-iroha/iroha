...
.register_with_id_slice::<ClaimTwitterFollowReward>("iroha.instruction.v1::social::ClaimTwitterFollowReward")
            .register_with_id_slice::<SendToTwitter>("iroha.instruction.v1::social::SendToTwitter")
            .register_with_id_slice::<CancelTwitterEscrow>("iroha.instruction.v1::social::CancelTwitterEscrow");
