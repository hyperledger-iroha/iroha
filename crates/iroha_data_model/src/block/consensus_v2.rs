...
pub struct SumeragiV2GenesisContextParameters {
    ...
    #[norito(required)]
    pub next_offline_cash_mint_finality_epoch_roster:
        Option<crate::isi::offline_cash_v1::OfflineCashMintFinalityEpochRosterV1>,
}
impl SumeragiV2GenesisContextParameters {
    ...
    #[must_use]
    pub fn recommended(
        offline_cash_mint_finality_epoch_roster: crate::isi::offline_cash_v1::OfflineCashMintFinalityEpochRosterV1,
        next_offline_cash_mint_finality_epoch_roster: Option<
            crate::isi::offline_cash_v1::OfflineCashMintFinalityEpochRosterV1,
        >,
    ) -> Self {
        Self {
            ...
            next_offline_cash_mint_finality_epoch_roster,
        }
    }
...
pub(crate) fn test_genesis_context_parameters() -> SumeragiV2GenesisContextParameters {
    ...
    SumeragiV2GenesisContextParameters::recommended(
        test_offline_cash_mint_finality_roster(network_id, 0, &roster),
        None,
    )
}
