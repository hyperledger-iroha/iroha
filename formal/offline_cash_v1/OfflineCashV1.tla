---- MODULE OfflineCashV1 ----
EXTENDS Naturals, FiniteSets, Sequences

(***************************************************************************
Finite-state safety model for the sole first-release Offline Cash protocol.
...
AxtAssetIncarnationV1 ==
  [assetDefinitionId |-> "offline-cash-asset", incarnationId |-> 1]
...
PaymentLifecycleBinding(c) ==
  ...
  IN [networkId |-> "offline-cash-v1-network",
      protocolVersion |-> 1,
      suiteId |-> PaymentSuite[c],
      vkDigest |-> PaymentSuite[c],
      assetId |-> "offline-cash-asset",
      assetIncarnation |-> AxtAssetIncarnationV1,
      assetScale |-> 2,
...
RedemptionLifecycleBinding(v) ==
  [networkId |-> "offline-cash-v1-network",
   protocolVersion |-> 1,
