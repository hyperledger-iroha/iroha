...
episode disappears in the initial state even though no lower physical rank
exists.  No production fairness or transition is modeled here.
***************************************************************************)
