...
Restart increments the executor generation before any volatile completion can
be used; Resume* may re-sign only an already acknowledged current-view intent.
