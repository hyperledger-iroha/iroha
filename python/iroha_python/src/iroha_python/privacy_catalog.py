...
PRIVACY_PRODUCTION_REVIEW_SCOPE_VERSION = "privacy-production-review-scope-v1"
...
PRIVACY_PRODUCTION_REVIEW_SCOPE_KEYS = frozenset(
    (
        "version",
        "algorithm_id",
        "chain_id",
...
PENDING_PRODUCTION_BACKEND_FAMILIES = frozenset(
    (
        "anonymous-pgc",
...
REQUIRED_PRIVACY_PLAN_STAGE_BY_ALGORITHM_ID = {
    algorithm_id: implementation_stage
    for algorithm_id, implementation_stage, _backend_family in REQUIRED_PRIVACY_PLAN_ROWS
}
...
_RAW_PRIVACY_ALGORITHM_DESCRIPTORS_JSON = (
    ...
    ",\"note_encryption\":false},\"implementationStage\":\"chain-executable\",\"recommendedFor\":[\"po"
    "st-quantum transaction authorization migration\",\"identity-private source-account authori"
    "zation\",\"authorization envelopes for transparent asset transfers\"],\"sourceReferences\":[{"
    "\"label\":\"ZK-ACE: Practical Post-Quantum Authorization for Blockchain\",\"url\":\"https://arx"
    "iv.org/abs/2603.07974\"}],\"securityNotes\":[\"Authorization is only one PQ layer; proof bac"
    "kend and note encryption must also be PQ before a payment flow is end-to-end post-quantu"
    "m.\",\"Replay nullifiers must be chain-domain separated and irreversible after acceptance."
    "\",\"A dev verifier must never be accepted under a production verifier key id.\",\"Native AI"
    "R openings are blinded so sampled rows do not recover identity or replay witness limbs.\""
    ",\"Any chain roots, nullifiers, revocation data, or replay guards for this flow must pers"
    "ist across node restarts before admitting ledger mutations.\",\"Wallet witness material an"
    "d private inputs must stay local and must not be exposed through SDK or chain APIs.\",\"Pr"
    "oduction hardening requires deterministic vectors, negative/adversarial test cases, repl"
    "ay/nullifier rejection tests, parser/verifier fuzzing, performance gates, and internal c"
    "ryptographic review.\"],\"requiredState\":[\"registered ZK-ACE identity commitment\",\"source-"
    "account allowlist\",\"authorization policy hash registry\",\"active ZK-ACE verifier key\",\"ch"
    "ain/domain binding state\",\"transfer digest binding\",\"replay nullifier uniqueness set\",\"i"
    "dentity rotation/revocation registry\",\"STARK/FRI verifier parameter floors\",\"wallet iden"
    "tity witness and replay-secret store\"],\"failureModes\":[\"transaction digest substitution\""
    ",\"chain-id or domain-separator mismatch\",\"replayed nullifier\",\"revoked identity commitme"
    "nt\",\"policy hash mismatch\",\"malformed proof bytes\",\"wrong verifier key\",\"public input mi"
    "smatch\"],\"setupSteps\":[\"Register a ZK-ACE identity commitment, source-account allowlist,"
    ...
    ":[\"Hash the transaction payload and chain/domain context.\",\"Derive a fresh replay nullif"
    "ier.\",\"Generate a ZK-ACE authorization proof and submit a protected transparent transfer"
    ".\"],\"sdkEntrypoints\":[\"buildRegisterZkAceIdentityCommitmentInstruction\",\"buildRotateZkAc"
    "eIdentityCommitmentInstruction\",\"buildRevokeZkAceIdentityCommitmentInstruction\",\"buildZk"
    "AceAuthorizedTransferInstruction\",\"buildZkAceAuthorizationProofV1\"],\"plannedSdkEntrypoin"
    "ts\":[],\"chainRequirements\":[\"zk::RegisterZkAceIdentityCommitment\",\"zk::RotateZkAceIdenti"
    "tyCommitment\",\"zk::RevokeZkAceIdentityCommitment\",\"zk::SubmitZkAceAuthorizedTransfer\",\"a"
    "ctive stark/fri/sha256-goldilocks ZK-ACE verifier key\",\"ZK-ACE identity source-account a"
    "llowlist\"]},{\"id\":\"anonymous-pgc-k-out-of-n-v1\",\"name\":\"Anonymous PGC k-out-of-n payment"
    "s v1\",\"shortName\":\"Anonymous PGC\",\"summary\":\"Account-based anonymous confidential paymen"
    "t target with hidden sender, hidden amount, receiver privacy, and k-out-of-n receiver-se"
    "t proofs.\",\"category\":\"payment\",\"maturity\":\"accepted_conference\",\"coveredCriteria\":[\"hid"
    ...
    "s\":[{\"label\":\"Anonymous PGC with k-out-of-n Proofs\",\"url\":\"https://eprint.iacr.org/2025/"
    "884\"}],\"securityNotes\":[\"Requires fresh anonymity-set roots and replay/link-tag state.\","
    ...
    "t commitment set\",\"recent anonymity-set roots\",\"spent link-tag set\",\"range-proof verifie"
    "r parameters\",\"wallet account blinding and receiver recovery metadata\"],\"failureModes\":["
    "\"stale or unknown anonymity-set root\",\"duplicate link tag\",\"receiver-set substitution\",\""
    "range commitment mismatch\",\"authorization envelope mismatch\",\"malformed proof bytes\",\"wr"
    "ong verifier key\",\"public input mismatch\"],\"setupSteps\":[\"Register anonymous account com"
    "mitments and anonymity-set accumulator state.\",\"Register the k-out-of-n payment verifier"
    " key and range-proof parameters.\",\"Persist wallet blinding, balance-opening, and receive"
    "r recovery witnesses.\"],\"executionSteps\":[\"Select an anonymity-set root and receiver set"
    ".\",\"Create balance commitments, receiver ciphertext commitments, and link tag.\",\"Generat"
    "e the Anonymous PGC proof and submit the transfer instruction.\"],\"sdkEntrypoints\":[\"buil"
    "dAnonymousPgcReceiverSet\",\"buildAnonymousPgcAccountCommitmentInstruction\",\"buildAnonymou"
    "sPgcKOutOfNProofV1\",\"buildAnonymousPgcTransferInstruction\"],\"plannedSdkEntrypoints\":[],\""
    "chainRequirements\":[\"anonymous account commitment accumulator\",\"spent link-tag set\",\"Ano"
    "nymous PGC verifier\",\"range-proof component verifier\",\"typed zk::RegisterAnonymousPgcAcc"
    "ountCommitment instruction\",\"typed zk::SubmitAnonymousPgcTransfer instruction\"]},{\"id\":\""
    "verange-transparent-range-v1\",\"name\":\"VeRange transparent range proofs v1\",\"shortName\":\""
    "VeRange\",\"summary\":\"Verification-efficient transparent range-proof component for confide"
    "ntial amounts, solvency proofs, and numeric credential predicates.\",\"category\":\"proof_ba"
    "ckend\",\"maturity\":\"accepted_conference\",\"coveredCriteria\":[\"hide_amount\"],\"proofFamily\":"
    "\"verange-transparent-range\",\"publicInputsSchema\":\"commitments,range_parameters,aggregati"
    "on_count,domain_separator,payload_digest\",\"verifierKeyId\":\"verange_transparent_range_v1\""
    ",\"pqLayers\":{\"proof\":true,\"authorization\":false,\"note_encryption\":false},\"implementation"
    "Stage\":\"component\",\"recommendedFor\":[\"confidential amount range proofs\",\"reserve or solv"
    "ency proofs\",\"numeric credential predicates\"],\"sourceReferences\":[{\"label\":\"VeRange: Ver"
    "ification-efficient Zero-knowledge Range Arguments\",\"url\":\"https://eprint.iacr.org/2025/"
    "528\"}],\"securityNotes\":[\"This range-proof backend component is not a standalone payment "
    "protocol.\",\"Range parameters must be bound to the transaction payload and verifier key.\""
    ",\"Aggregated proof limits must be enforced by validators.\",\"The SDK dev fixture is non-p"
    "roduction and verifies deterministic binding only; production VeRange proving remains un"
    "available until the hardening gates pass.\",\"Wallet witnesses and private range inputs mu"
    "st stay local and must not be exposed through SDK or chain APIs.\",\"Production hardening "
    "requires deterministic vectors, negative/adversarial test cases, replay/nullifier reject"
    "ion tests, parser/verifier fuzzing, performance gates, and internal cryptographic review"
    ".\"],\"requiredState\":[\"range-proof verifier parameters\",\"VeRange verifier key registry\",\""
    "range commitment domain separators\",\"maximum aggregation policy\"],\"failureModes\":[\"wrong"
    " bit length\",\"commitment substitution\",\"verifier-parameter mismatch\",\"oversized aggregat"
    "ion\",\"malformed proof bytes\",\"wrong verifier key\",\"public input mismatch\"],\"setupSteps\":"
    "[\"Register VeRange verifier parameters and allowed bit lengths.\",\"Define the commitment "
    "scheme and domain separators used by dependent algorithms.\"],\"executionSteps\":[\"Build am"
    "ount commitments.\",\"Generate a range proof bound to the transaction payload.\",\"Attach th"
    "e range-proof envelope to the dependent confidential algorithm.\"],\"sdkEntrypoints\":[\"bui"
    "ldRangeCommitment\",\"buildVeRangeDevProofFixture\",\"buildVeRangeProofEnvelope\",\"buildVeRan"
    "geProofV1\",\"verifyVeRangeProofLocally\",\"verifyVeRangeProofV1\"],\"plannedSdkEntrypoints\":["
    "],\"chainRequirements\":[\"VeRange verifier registry entry\",\"range commitment binding rules"
    "\",\"dependent payment or credential verifier\"]},{\"id\":\"zkat-policy-private-auth-v1\",\"name"
    "\":\"zkAt policy-private authorization v1\",\"shortName\":\"zkAt policy auth\",\"summary\":\"Polic"
    "y-private blockchain authenticator that hides threshold rules, signer sets, and account "
    "authorization logic.\",\"category\":\"authorization\",\"maturity\":\"accepted_conference\",\"cover"
    "edCriteria\":[],\"proofFamily\":\"zkat-policy-private-authenticator\",\"publicInputsSchema\":\"p"
    "olicy_commitment,tx_digest,account_id,action_class,domain_separator,policy_epoch\",\"verif"
    "ierKeyId\":\"zkat_policy_private_auth_v1\",\"pqLayers\":{\"proof\":false,\"authorization\":false,"
    "\"note_encryption\":false},\"implementationStage\":\"sdk-builder\",\"recommendedFor\":[\"institut"
    "ional wallet policy privacy\",\"hidden threshold authorization\",\"authorization-policy migr"
    "ation without revealing signer topology\"],\"sourceReferences\":[{\"label\":\"zkAt: Zero-Knowl"
    "edge Authenticator for Blockchain\",\"url\":\"https://drops.dagstuhl.de/entities/document/10"
    ".4230/LIPIcs.AFT.2025.2\"}],\"securityNotes\":[\"Hides authorization policy, not payment fie"
    "lds.\",\"Policy commitments require explicit epoch, replay, and rotation semantics.\",\"Comb"
    "ining with ZK-ACE requires both proofs to bind the same transaction digest.\",\"Production"
    " zkAt proof admission requires canonical policy commitments, transaction digest binding,"
    " account/action/domain binding, verifier-key registration, deterministic vectors, parser"
    "/verifier fuzzing, performance gates, and internal cryptographic review.\",\"Any chain roo"
    "ts, nullifiers, revocation data, or replay guards for this flow must persist across node"
    " restarts before admitting ledger mutations.\",\"Wallet witness material and private input"
    "s must stay local and must not be exposed through SDK or chain APIs.\",\"Production harden"
    ...
    "view.\"],\"requiredState\":[\"policy commitment registry\",\"policy epoch state\",\"authorizatio"
    "n replay guard\",\"authorization verifier registry\",\"wallet policy witness store\"],\"failur"
    "eModes\":[\"policy-root substitution\",\"stale policy epoch\",\"unauthorized signer witness\",\""
    "transaction digest mismatch\",\"authorization replay\",\"malformed proof bytes\",\"wrong verif"
    "ier key\",\"public input mismatch\"],\"setupSteps\":[\"Register a hidden policy commitment and"
    " verifier key.\",\"Bind the policy to account action classes and epoch rules.\"],\"execution"
    "Steps\":[\"Generate a policy-private authenticator proof.\",\"Attach the authenticator envel"
    "ope to the transaction authorization path.\"],\"sdkEntrypoints\":[\"buildZkAtPolicyCommitmen"
    "t\",\"buildZkAtAuthenticatorEnvelope\",\"buildZkAtPolicyProofV1\",\"verifyZkAtPolicyProofV1\"],"
    "\"plannedSdkEntrypoints\":[],\"chainRequirements\":[\"zkAt policy commitment registry\",\"zkAt "
    "verifier\",\"account policy epoch state\",\"account policy replay protection\",\"typed zk::Reg"
    "isterZkAtPolicyCommitment instruction\",\"typed zk::SubmitZkAtAuthorizedTransaction admiss"
    "ion\"]},{\"id\":\"zk-ams-recursive-admission-v0\",\"name\":\"ZK-AMS recursive anonymous admissio"
    "n v0\",\"shortName\":\"ZK-AMS admission\",\"summary\":\"Research target for recursively aggregat"
    "ed anonymous admission from real-world personhood or eligibility credentials into anonym"
    "ous on-chain accounts.\",\"category\":\"admission\",\"maturity\":\"arxiv_preprint\",\"coveredCrite"
    "ria\":[],\"proofFamily\":\"recursive-anonymous-admission\",\"publicInputsSchema\":\"issuer_root,"
    "admission_batch_root,admission_nullifiers,anonymous_account_commitments,recursive_admiss"
    "ion_digest,domain_separator\",\"verifierKeyId\":\"zk_ams_recursive_admission_v0\",\"pqLayers\":"
    "{\"proof\":false,\"authorization\":false,\"note_encryption\":false},\"implementationStage\":\"sdk"
    "-builder\",\"recommendedFor\":[\"anonymous onboarding\",\"Sybil-resistant wallet issuance\",\"cr"
    "edential-gated CBDC pilots\"],\"sourceReferences\":[{\"label\":\"ZK-AMS recursive anonymous ad"
    "mission\",\"url\":\"https://arxiv.org/abs/2602.16130\"}],\"securityNotes\":[\"Admission privacy "
    "is separate from later payment privacy.\",\"Duplicate admission prevention depends on issu"
    "er-scoped nullifiers.\",\"Recursive batching must bind every admitted account commitment.\""
    ",\"This production admission component is proof-verifiable but not a standalone payment p"
    "rotocol.\",\"Production ZK-AMS admission requires canonical issuer roots, admission-nullif"
    "ier sets, anonymous account commitments, recursive admission digests, domain binding, ve"
    "rifier-key registration, deterministic vectors, parser/verifier fuzzing, performance gat"
    "es, and internal cryptographic review.\",\"Any chain roots, nullifiers, revocation data, o"
    "r replay guards for this flow must persist across node restarts before admitting ledger "
    "mutations.\",\"Wallet admission witnesses and private inputs must stay local and must not "
    "be exposed through SDK or chain APIs.\",\"Production hardening requires deterministic vect"
    "ors, negative/adversarial test cases, replay/nullifier rejection tests, parser/verifier "
    "fuzzing, performance gates, and internal cryptographic review.\"],\"requiredState\":[\"issue"
    "r root registry\",\"admission nullifier set\",\"anonymous account commitment registry\",\"recu"
    "rsive verifier parameters\",\"recursive admission verifier key registry\",\"wallet admission"
    " witness store\"],\"failureModes\":[\"duplicate credential admission\",\"wrong issuer root\",\"b"
    "atch omission or account commitment substitution\",\"recursive proof parameter mismatch\",\""
    "malformed proof bytes\",\"wrong verifier key\",\"public input mismatch\"],\"setupSteps\":[\"Regi"
    "ster credential issuer roots and recursive verifier parameters.\",\"Define anonymous accou"
    "nt commitment format and admission-nullifier derivation.\"],\"executionSteps\":[\"Collect ad"
    "mitted account commitments into a batch.\",\"Generate or import a recursive admission proo"
    "f.\",\"Submit the batch proof and admission nullifiers.\"],\"sdkEntrypoints\":[\"buildZkAmsAdm"
    "issionBatch\",\"buildZkAmsAdmissionProofEnvelope\",\"buildZkAmsAdmissionBatchProofV0\",\"verif"
    "yZkAmsAdmissionBatchProofV0\"],\"plannedSdkEntrypoints\":[],\"chainRequirements\":[\"issuer ro"
    "ot registry\",\"admission nullifier set\",\"recursive admission verifier\",\"typed ZK-AMS admi"
    "ssion batch instruction\"]},{\"id\":\"vega-existing-credential-zk-v0\",\"name\":\"Vega existing-"
    "credential ZK proofs v0\",\"shortName\":\"Vega credentials\",\"summary\":\"Low-latency zero-know"
    "ledge proof target for proving predicates over existing credentials without revealing th"
    "e full credential.\",\"category\":\"credential\",\"maturity\":\"technical_report\",\"coveredCriter"
    "ia\":[],\"proofFamily\":\"existing-credential-zk\",\"publicInputsSchema\":\"issuer_commitment,cr"
    "edential_schema,predicate_commitment,subject_binding,expiration_epoch,domain_separator\","
    "\"verifierKeyId\":\"vega_existing_credential_zk_v0\",\"pqLayers\":{\"proof\":false,\"authorizatio"
    "n\":false,\"note_encryption\":false},\"implementationStage\":\"sdk-builder\",\"recommendedFor\":["
    "\"legacy credential bridges\",\"private eligibility checks\",\"attribute predicates for walle"
    "t enrollment\"],\"sourceReferences\":[{\"label\":\"Vega: Low-Latency Zero-Knowledge Proofs ove"
    "r Existing Credentials\",\"url\":\"https://www.microsoft.com/en-us/research/publication/vega"
    "-low-latency-zero-knowledge-proofs-over-existing-credentials/\"}],\"securityNotes\":[\"Crede"
    "ntial schema parsing must be deterministic and versioned.\",\"Proofs must bind to wallet o"
    "r identity commitments to prevent credential replay.\",\"Issuer trust, expiration, and rev"
    "ocation semantics require registered policy inputs.\",\"This production credential compone"
    "nt is proof-verifiable but not a standalone payment protocol.\",\"Production Vega credenti"
    "al admission requires canonical issuer commitments, credential schema, predicate commitm"
    "ent, subject binding, expiration epoch, domain binding, verifier-key registration, deter"
    "ministic vectors, parser/verifier fuzzing, performance gates, and internal cryptographic"
    " review.\",\"Any chain roots, nullifiers, revocation data, or replay guards for this flow "
    "must persist across node restarts before admitting ledger mutations.\",\"Wallet credential"
    " predicate witnesses and private inputs must stay local and must not be exposed through "
    ...
    "e gates, and internal cryptographic review.\"],\"requiredState\":[\"credential issuer regist"
    "ry\",\"supported credential schema registry\",\"predicate registry\",\"revocation or expiratio"
    "n policy\",\"wallet credential predicate witness store\",\"credential predicate commitment r"
    "egistry\",\"credential predicate verifier key registry\"],\"failureModes\":[\"expired credenti"
    "al\",\"wrong issuer\",\"predicate mismatch\",\"wallet-binding replay\",\"malformed proof bytes\","
    "\"wrong verifier key\",\"public input mismatch\"],\"setupSteps\":[\"Register supported credenti"
    "al schemas, issuers, and predicates.\",\"Bind credential proof subjects to wallet or ZK-AC"
    "E identity commitments.\"],\"executionSteps\":[\"Parse the credential under a registered sch"
    "ema.\",\"Generate a predicate proof and bind it to the wallet context.\",\"Submit the proof "
    "envelope to the admission or authorization flow.\"],\"sdkEntrypoints\":[\"buildVegaCredentia"
    "lPredicateCommitment\",\"buildVegaCredentialProofEnvelope\",\"buildVegaCredentialPredicatePr"
    "oofV0\",\"verifyVegaCredentialPredicateProofV0\"],\"plannedSdkEntrypoints\":[],\"chainRequirem"
    "ents\":[\"credential schema registry\",\"issuer registry\",\"credential predicate verifier\",\"t"
    "yped Vega credential proof instruction\"]},{\"id\":\"silent-threshold-anoncred-v0\",\"name\":\"S"
    "ilent threshold anonymous credentials v0\",\"shortName\":\"Silent threshold cred\",\"summary\":"
    "\"Research target for threshold-issued anonymous credentials with silent setup, issuer hi"
    "ding, constant-size showings, and dynamic verifier policies.\",\"category\":\"credential\",\"m"
    "aturity\":\"technical_report\",\"coveredCriteria\":[],\"proofFamily\":\"threshold-anonymous-cred"
    "entials\",\"publicInputsSchema\":\"issuer_set_commitment,threshold_policy_hash,credential_sh"
    "owing_commitment,showing_nullifier,verifier_policy_hash,domain_separator\",\"verifierKeyId"
    "\":\"silent_threshold_anoncred_v0\",\"pqLayers\":{\"proof\":false,\"authorization\":false,\"note_e"
    "ncryption\":false},\"implementationStage\":\"sdk-builder\",\"recommendedFor\":[\"multi-authority"
    " regulated credentials\",\"issuer-hiding eligibility proofs\",\"central-bank or supervisor i"
    "ssued wallet credentials\"],\"sourceReferences\":[{\"label\":\"Anonymous Credentials with Issu"
    "er-Hiding, Threshold Issuance, and Silent Setup\",\"url\":\"https://www2.eecs.berkeley.edu/P"
    "ubs/TechRpts/2026/EECS-2026-124.html\"}],\"securityNotes\":[\"Credential issuance and revoca"
    "tion governance are as important as proof verification.\",\"Issuer-set commitments require"
    " explicit threshold, rotation, and downgrade protections.\",\"This production credential c"
    "omponent is proof-verifiable but not a standalone payment protocol.\",\"Production silent-"
    "threshold credential admission requires canonical issuer-set, threshold-policy, showing-"
    "nullifier, verifier-policy, domain binding, verifier-key registration, deterministic vec"
    "tors, parser/verifier fuzzing, performance gates, and internal cryptographic review.\",\"A"
    "ny chain roots, nullifiers, revocation data, or replay guards for this flow must persist"
    " across node restarts before admitting ledger mutations.\",\"Wallet credential showing wit"
    "nesses and private inputs must stay local and must not be exposed through SDK or chain A"
    "PIs.\",\"Production hardening requires deterministic vectors, negative/adversarial test ca"
    "ses, replay/nullifier rejection tests, parser/verifier fuzzing, performance gates, and i"
    "nternal cryptographic review.\"],\"requiredState\":[\"threshold issuer registry\",\"credential"
    " parameter registry\",\"verifier policy registry\",\"credential showing nullifier policy\",\"w"
    "allet credential showing witness store\",\"credential showing commitment registry\",\"anonym"
    "ous credential verifier key registry\"],\"failureModes\":[\"insufficient issuer threshold\",\""
    "issuer-set substitution\",\"credential showing replay\",\"verifier-policy mismatch\",\"malform"
    "ed proof bytes\",\"wrong verifier key\",\"public input mismatch\"],\"setupSteps\":[\"Register is"
    "suer sets, threshold policies, and credential parameters.\",\"Define showing-nullifier and"
    " verifier-policy binding rules.\"],\"executionSteps\":[\"Generate a credential showing proof"
    " under the verifier policy.\",\"Submit the proof as an admission or authorization componen"
    "t.\"],\"sdkEntrypoints\":[\"buildSilentThresholdCredentialCommitments\",\"buildSilentThreshold"
    "CredentialEnvelope\",\"buildSilentThresholdCredentialShowingProofV0\",\"verifySilentThreshol"
    "dCredentialShowingProofV0\"],\"plannedSdkEntrypoints\":[],\"chainRequirements\":[\"threshold i"
    "ssuer registry\",\"anonymous credential verifier\",\"credential showing replay policy\",\"type"
    "d silent-threshold credential proof instruction\"]},{\"id\":\"zk-x509-onchain-identity-v0\",\""
    "name\":\"ZK-X.509 on-chain identity v0\",\"shortName\":\"ZK-X.509 identity\",\"summary\":\"ZK proo"
    "f target for X.509 certificate validity, ownership, revocation status, and wallet-addres"
    "s binding.\",\"category\":\"identity\",\"maturity\":\"arxiv_preprint\",\"coveredCriteria\":[],\"proo"
    "fFamily\":\"zkvm-x509-identity\",\"publicInputsSchema\":\"ca_root_commitment,certificate_polic"
    "y_hash,revocation_root,subject_commitment,address_binding,domain_separator\",\"verifierKey"
    "Id\":\"zk_x509_onchain_identity_v0\",\"pqLayers\":{\"proof\":false,\"authorization\":false,\"note_"
    "encryption\":false},\"implementationStage\":\"sdk-builder\",\"recommendedFor\":[\"institutional "
    "wallet identity\",\"legal-entity account binding\",\"private PKI-based eligibility checks\"],"
    "\"sourceReferences\":[{\"label\":\"ZK-X.509 on-chain identity\",\"url\":\"https://arxiv.org/abs/2"
    "603.25190\"}],\"securityNotes\":[\"Legacy X.509 trust roots are usually not post-quantum.\",\""
    "Revocation root freshness must be explicit in the public inputs.\",\"Address binding must "
    "prevent proof replay across wallets and chains.\",\"Production ZK-X.509 identity proofs ve"
    "rify canonical CA-root, certificate-policy, revocation-root, subject-commitment, wallet "
    "binding, and domain-separated public inputs while remaining a reusable identity componen"
    "t rather than a standalone payment protocol.\",\"Any chain roots, nullifiers, revocation d"
    "ata, or replay guards for this flow must persist across node restarts before admitting l"
    "edger mutations.\",\"Wallet witness material and private inputs must stay local and must n"
    "ot be exposed through SDK or chain APIs.\",\"Production hardening requires deterministic v"
    "ectors, negative/adversarial test cases, replay/nullifier rejection tests, parser/verifi"
    "er fuzzing, performance gates, and internal cryptographic review.\"],\"requiredState\":[\"tr"
    "usted CA root registry\",\"certificate policy registry\",\"revocation root registry\",\"identi"
    "ty proof verifier\",\"wallet certificate witness store\",\"certificate subject commitment re"
    "gistry\",\"ZK-X.509 verifier key registry\"],\"failureModes\":[\"expired certificate\",\"revoked"
    " certificate\",\"unknown CA root\",\"wrong wallet address binding\",\"address-binding replay\","
    "\"stale revocation root\",\"malformed proof bytes\",\"wrong verifier key\",\"public input misma"
    "tch\"],\"setupSteps\":[\"Register trusted CA roots, certificate policies, and revocation-roo"
    "t feeds.\",\"Define wallet address binding and domain-separation rules.\"],\"executionSteps\""
    ":[\"Generate a proof of certificate validity, ownership, and revocation status.\",\"Bind th"
    "e proof to an institution wallet or ZK-ACE identity commitment.\"],\"sdkEntrypoints\":[\"bui"
    "ldZkX509IdentityCommitments\",\"buildZkX509IdentityEnvelope\",\"buildZkX509IdentityProofV0\","
    "\"verifyZkX509IdentityProofV0\"],\"plannedSdkEntrypoints\":[],\"chainRequirements\":[\"trusted "
    "CA root registry\",\"revocation root registry\",\"ZK-X.509 verifier\",\"typed ZK-X.509 identit"
    "y proof instruction\"]},{\"id\":\"jindo-lattice-pcs-zk-v0\",\"name\":\"Jindo lattice polynomial "
    "commitment ZK v0\",\"shortName\":\"Jindo lattice PCS\",\"summary\":\"2026 lattice-based polynomi"
    "al commitment candidate for post-quantum zero-knowledge proof systems.\",\"category\":\"proo"
    "f_backend\",\"maturity\":\"technical_report\",\"coveredCriteria\":[],\"proofFamily\":\"lattice-pol"
    "ynomial-commitment\",\"publicInputsSchema\":\"commitment,opening_claim,query_set,parameter_h"
    "ash,domain_separator\",\"verifierKeyId\":\"jindo_lattice_pcs_zk_v0\",\"pqLayers\":{\"proof\":true"
    ",\"authorization\":false,\"note_encryption\":false},\"implementationStage\":\"sdk-builder\",\"rec"
    "ommendedFor\":[\"post-quantum proof-system research\",\"future PQ verifier backend evaluatio"
    "n\",\"lattice PCS benchmarking\"],\"sourceReferences\":[{\"label\":\"Jindo lattice-based polynom"
    "ial commitment\",\"url\":\"https://eprint.iacr.org.cn/2026/044\"}],\"securityNotes\":[\"This is "
    "a production proof backend component, not a standalone transaction algorithm.\",\"PQ proof"
    " coverage alone does not imply PQ authorization or note encryption.\",\"Parameter selectio"
    "n and implementation security require independent review.\",\"Production Jindo lattice pro"
    "ving and verifier adapters require registered LatticePcsSis parameters, deterministic ve"
    "ctors, parser/verifier fuzzing, performance gates, and internal cryptographic review.\",\""
    "Production hardening requires deterministic vectors, negative/adversarial test cases, re"
    "play/nullifier rejection tests, parser/verifier fuzzing, performance gates, and internal"
    " cryptographic review.\"],\"requiredState\":[\"lattice PCS parameter registry\",\"backend veri"
    "fier implementation\",\"lattice PCS verifier key registry\",\"production benchmark vectors\"]"
    ",\"failureModes\":[\"parameter mismatch\",\"opening claim substitution\",\"unsupported query se"
    "t\",\"backend misclassified as production-ready\",\"malformed proof bytes\",\"wrong verifier k"
    "ey\",\"public input mismatch\"],\"setupSteps\":[\"Track lattice PCS parameter sets and verifie"
    "r API shape.\",\"Benchmark prover, verifier, and proof-size behavior before integration.\"]"
    ",\"executionSteps\":[\"Use as a candidate backend for future PQ circuits only after concret"
    "e circuit integration.\"],\"sdkEntrypoints\":[\"buildJindoLatticePublicInputs\",\"buildJindoLa"
    "tticeProofEnvelope\",\"buildJindoLatticeProofV0\",\"verifyJindoPolynomialCommitmentV0\"],\"pla"
    "nnedSdkEntrypoints\":[],\"chainRequirements\":[\"Jindo verifier backend\",\"lattice PCS parame"
    "ter registry\",\"dependent circuit integration\"]},{\"id\":\"sis-hints-anoncred-pq-v0\",\"name\":"
    "\"SIS-with-hints PQ anonymous credentials v0\",\"shortName\":\"SIS hints anoncred\",\"summary\":"
    "\"PKC 2026 research foundation for lattice/SIS-with-hints anonymous credentials and post-"
    "quantum credential proofs.\",\"category\":\"credential\",\"maturity\":\"accepted_conference\",\"co"
    "veredCriteria\":[],\"proofFamily\":\"lattice-anonymous-credentials\",\"publicInputsSchema\":\"is"
    "suer_commitment,credential_commitment,showing_policy_hash,parameter_hash,domain_separato"
    "r\",\"verifierKeyId\":\"sis_hints_anoncred_pq_v0\",\"pqLayers\":{\"proof\":true,\"authorization\":f"
    "alse,\"note_encryption\":false},\"implementationStage\":\"sdk-builder\",\"recommendedFor\":[\"pos"
    "t-quantum anonymous credential research\",\"future PQ KYC or eligibility proofs\",\"assumpti"
    "on tracking for lattice credential designs\"],\"sourceReferences\":[{\"label\":\"Tight Reducti"
    "ons for SIS-with-Hints Assumptions with Applications\",\"url\":\"https://kclpure.kcl.ac.uk/p"
    "ortal/en/publications/tight-reductions-for-sis-with-hints-assumptions-with-applications/"
    "\"}],\"securityNotes\":[\"This is a production credential proof component, not a standalone "
    "wallet protocol.\",\"PQ credential proof coverage does not make a payment flow end-to-end "
    "post-quantum.\",\"Parameter choices and reduction assumptions need explicit governance.\",\""
    "Production SIS-with-hints credential proving and verifier adapters require registered Si"
    "sWithHints parameters, deterministic vectors, parser/verifier fuzzing, performance gates"
    ", and internal cryptographic review.\",\"Wallet lattice credential witnesses and private i"
    "nputs must stay local and must not be exposed through SDK or chain APIs.\",\"Production ha"
    "rdening requires deterministic vectors, negative/adversarial test cases, replay/nullifie"
    "r rejection tests, parser/verifier fuzzing, performance gates, and internal cryptographi"
    "c review.\"],\"requiredState\":[\"lattice credential parameter registry\",\"issuer parameter r"
    "egistry\",\"credential showing verifier\",\"wallet lattice credential witness store\",\"lattic"
    "e credential commitment registry\",\"lattice credential verifier key registry\"],\"failureMo"
    "des\":[\"wrong parameter set\",\"issuer parameter substitution\",\"credential showing replay\","
    "\"overclaiming production readiness from assumption research\",\"malformed proof bytes\",\"wr"
    "ong verifier key\",\"public input mismatch\"],\"setupSteps\":[\"Track supported SIS-with-hints"
    " parameter sets and issuer parameters.\",\"Define how future PQ credential showings bind t"
    "o wallet or authorization contexts.\"],\"executionSteps\":[\"Use as a future PQ credential b"
    "ackend after a concrete credential protocol is selected.\"],\"sdkEntrypoints\":[\"buildSisHi"
    "ntsCredentialCommitments\",\"buildSisHintsCredentialEnvelope\",\"buildSisHintsAnonymousCrede"
    "ntialProofV0\",\"verifySisHintsAnonymousCredentialProofV0\"],\"plannedSdkEntrypoints\":[],\"ch"
    "ainRequirements\":[\"lattice anonymous credential verifier\",\"credential parameter registry"
    "\",\"issuer parameter registry\",\"typed SIS-with-hints credential proof instruction\"]},{\"id"
    "\":\"orchard-halo2-actions-v1\",\"name\":\"Orchard-style Halo2 action bundle v1\",\"shortName\":\""
    "Orchard Halo2\",\"summary\":\"Zcash Orchard-style action bundle with note commitments, nulli"
    "fiers, and one aggregated Halo2 proof over spend/output actions.\",\"category\":\"payment\",\""
    "maturity\":\"specification\",\"coveredCriteria\":[\"hide_amount\",\"hide_sender\",\"hide_receiver\""
    "],\"proofFamily\":\"halo2-pasta-action-bundle\",\"publicInputsSchema\":\"anchor,nullifiers,cmx,"
    "value_commitments,binding_signature\",\"verifierKeyId\":\"orchard_halo2_action_bundle_v1\",\"p"
    "qLayers\":{\"proof\":false,\"authorization\":false,\"note_encryption\":false},\"implementationSt"
    "age\":\"sdk-builder\",\"recommendedFor\":[\"single-asset private transfers\",\"mature note/nulli"
    "fier wallet design\",\"compact client proofs without Groth16 ceremonies\"],\"sourceReference"
    "s\":[{\"label\":\"ZIP 224 Orchard Shielded Protocol\",\"url\":\"https://zips.z.cash/zip-0224\"},{"
    "\"label\":\"Zcash Protocol Specification\",\"url\":\"https://zips.z.cash/protocol/protocol.pdf\""
    "}],\"securityNotes\":[\"Orchard actions require circuit-compatible note/nullifier semantics"
    " and domain-separated action hashes.\",\"Viewing-key and outgoing-viewing metadata must re"
    "main wallet-local.\",\"Production readiness requires audited Halo2 parameters and note-enc"
    "ryption review.\",\"Production hardening requires deterministic vectors, negative/adversar"
    "ial test cases, replay/nullifier rejection tests, parser/verifier fuzzing, performance g"
    "ates, and internal cryptographic review.\"],\"requiredState\":[\"Orchard note commitment tre"
    "e\",\"Orchard nullifier set\",\"Orchard action-bundle verifier key registry\",\"wallet Orchard"
    " witness store\"],\"failureModes\":[\"stale anchor\",\"duplicate nullifier\",\"invalid action-bu"
    "ndle proof\",\"malformed proof bytes\",\"wrong verifier key\",\"public input mismatch\"],\"setup"
    "Steps\":[\"Add Orchard-compatible note, nullifier, action, and anchor data model types.\",\""
    "Register Orchard Halo2 verifier parameters and action-bundle public input layout.\",\"Pers"
    "ist wallet note plaintexts, diversifiers, Merkle witnesses, and outgoing viewing data.\"]"
    ",\"executionSteps\":[\"Select spend notes and anchors from the wallet witness store.\",\"Crea"
    "te output notes and value commitments.\",\"Generate one Halo2 proof over the action bundle"
    " and submit nullifiers plus commitments.\"],\"sdkEntrypoints\":[\"buildOrchardActionBundlePr"
    "oofV1\",\"buildOrchardActionBundleInstruction\"],\"plannedSdkEntrypoints\":[],\"chainRequireme"
    "nts\":[\"Orchard note commitment tree\",\"Orchard nullifier set\",\"Halo2 action-bundle verifi"
    "er\",\"wallet Orchard witness store\",\"typed Orchard action-bundle instruction\"]},{\"id\":\"pe"
    "numbra-masp-v1\",\"name\":\"Penumbra-style multi-asset shielded pool v1\",\"shortName\":\"Penumb"
    "ra MASP\",\"summary\":\"Single multi-asset shielded pool using typed notes, note commitments"
    ", nullifiers, and spend/output proofs for private IBC-style assets.\",\"category\":\"payment"
    "\",\"maturity\":\"specification\",\"coveredCriteria\":[\"hide_amount\",\"hide_sender\",\"hide_receiv"
    "er\",\"hide_asset_type\"],\"proofFamily\":\"groth16-bls12-377-decaf377\",\"publicInputsSchema\":\""
    "state_commitment_anchor,nullifiers,note_commitments,balance_commitment,asset_id_commitme"
    "nt\",\"verifierKeyId\":\"penumbra_masp_v1\",\"pqLayers\":{\"proof\":false,\"authorization\":false,\""
    "note_encryption\":false},\"implementationStage\":\"sdk-builder\",\"recommendedFor\":[\"multi-ass"
    "et shielded pools\",\"IBC-style asset privacy\",\"asset-id hiding with typed-value notes\"],\""
    "sourceReferences\":[{\"label\":\"Penumbra Multi-Asset Shielded Pool\",\"url\":\"https://protocol"
    ".penumbra.zone/main/shielded_pool.html\"},{\"label\":\"Penumbra Cryptographic Primitives\",\"u"
    "rl\":\"https://protocol.penumbra.zone/main/crypto.html\"}],\"securityNotes\":[\"Typed asset va"
    "lues must bind asset identifiers to balance commitments.\",\"Groth16 parameter registratio"
    "n must distinguish spend and output circuits.\",\"Wallet note plaintexts and position meta"
    "data must not be exposed through public APIs.\",\"Production MASP use requires audited par"
    "ameter governance and chain-state integration review.\",\"Production hardening requires de"
    ...
    "edState\":[\"multi-asset state commitment tree\",\"typed nullifier set\",\"Groth16 spend/outpu"
    "t verifier key registry\",\"wallet asset metadata witness store\"],\"failureModes\":[\"stale s"
    "tate commitment anchor\",\"duplicate nullifier\",\"asset balance commitment mismatch\",\"malfo"
    "rmed proof bytes\",\"wrong verifier key\",\"public input mismatch\"],\"setupSteps\":[\"Add typed"
    "-value notes, asset identifiers, state commitments, and nullifier state.\",\"Register Grot"
    "h16/BLS12-377 verifier parameters for spend and output proofs.\",\"Persist wallet note pla"
    "intexts, asset metadata, state commitment positions, and nullifier keys.\"],\"executionSte"
    "ps\":[\"Select positioned notes and derive nullifiers.\",\"Create typed output notes and bal"
    "ance commitments.\",\"Submit spend/output actions with proofs against the shielded pool st"
    "ate commitment tree.\"],\"sdkEntrypoints\":[\"buildPenumbraSpendProofV1\",\"buildPenumbraOutpu"
    "tProofV1\",\"buildPenumbraShieldedPoolTransaction\"],\"plannedSdkEntrypoints\":[],\"chainRequi"
    "rements\":[\"multi-asset state commitment tree\",\"typed note commitment and nullifier state"
    "\",\"Groth16 verifier registry\",\"wallet multi-asset witness store\",\"typed Penumbra shielde"
    "d-pool transaction admission\"]},{\"id\":\"monero-fcmp-plus-plus-v1\",\"name\":\"Monero FCMP++ R"
    "ingCT-style transfer v1\",\"shortName\":\"FCMP++\",\"summary\":\"Full-chain membership proof tar"
    "get that replaces small decoy rings with a full-output-set spend proof while retaining h"
    "idden amounts and one-time receivers.\",\"category\":\"payment\",\"maturity\":\"specification\",\""
    "coveredCriteria\":[\"hide_amount\",\"hide_sender\",\"hide_receiver\"],\"proofFamily\":\"fcmp-plus-"
    "plus-curve-trees-bulletproofs\",\"publicInputsSchema\":\"membership_root,key_image_or_link_t"
    "ag,amount_commitments,range_commitments,spend_authorization,chain_tag\",\"verifierKeyId\":\""
    "monero_fcmp_plus_plus_v1\",\"pqLayers\":{\"proof\":false,\"authorization\":false,\"note_encrypti"
    "on\":false},\"implementationStage\":\"sdk-builder\",\"recommendedFor\":[\"maximal sender anonymi"
    "ty sets\",\"decoy-ring replacement research\",\"account-independent UTXO spend privacy\"],\"so"
    "urceReferences\":[{\"label\":\"Monero FCMP++ Development\",\"url\":\"https://web.getmonero.org/2"
    "024/04/27/fcmps.html\"}],\"securityNotes\":[\"Full-chain membership roots must be canonical "
    "and replay protected.\",\"Link tags/key images must be unique without revealing owned outp"
    "uts.\",\"Range-proof and amount-commitment parameters require production verifier review.\""
    ",\"Wallet witness material and private inputs must stay local and must not be exposed thr"
    "ough SDK or chain APIs.\",\"Production hardening requires deterministic vectors, negative/"
    "adversarial test cases, replay/nullifier rejection tests, parser/verifier fuzzing, perfo"
    "rmance gates, and internal cryptographic review.\"],\"requiredState\":[\"full-output-set com"
    "mitment accumulator\",\"spent link-tag set\",\"FCMP++ verifier key registry\",\"wallet output "
    "ownership scan state\"],\"failureModes\":[\"stale membership root\",\"duplicate link tag\",\"amo"
    "unt commitment mismatch\",\"malformed proof bytes\",\"wrong verifier key\",\"public input mism"
    "atch\"],\"setupSteps\":[\"Add output commitment accumulator state suitable for full-chain me"
    "mbership proofs.\",\"Define link tags/key images and spent-output rejection for Iroha asse"
    "ts.\",\"Implement wallet scanning, ownership recovery, and amount commitment witness stora"
    "ge.\"],\"executionSteps\":[\"Select owned outputs from the wallet scan state.\",\"Generate ful"
    "l-chain membership and amount-conservation proofs.\",\"Submit link tag, output commitments"
    ", range proof, and spend authorization.\"],\"sdkEntrypoints\":[\"buildFcmpPlusPlusMembership"
    "ProofV1\",\"buildFcmpPlusPlusTransferInstruction\"],\"plannedSdkEntrypoints\":[],\"chainRequir"
    "ements\":[\"full-output-set commitment accumulator\",\"spent link-tag set\",\"FCMP++ verifier\""
    ",\"wallet scanning and ownership recovery\",\"typed FCMP++ transfer instruction\"]},{\"id\":\"m"
    "iden-stark-note-v1\",\"name\":\"Miden-style STARK private note transaction v1\",\"shortName\":\""
    "Miden STARK\",\"summary\":\"Client-side STARK-proved account transition using private notes "
    "whose data stays off-chain while note hashes/nullifiers anchor correctness.\",\"category\":"
    "\"payment\",\"maturity\":\"specification\",\"coveredCriteria\":[\"hide_amount\",\"hide_receiver\",\"h"
    "ide_asset_type\"],\"proofFamily\":\"stark-vm-note-transaction\",\"publicInputsSchema\":\"account"
    "_id,initial_account_commitment,final_account_commitment,input_note_nullifiers,output_not"
    "e_hashes,reference_block\",\"verifierKeyId\":\"miden_stark_note_v1\",\"pqLayers\":{\"proof\":true"
    ",\"authorization\":false,\"note_encryption\":false},\"implementationStage\":\"sdk-builder\",\"rec"
    "ommendedFor\":[\"client-side proving\",\"private programmable note workflows\",\"parallel acco"
    "unt-local transaction execution\"],\"sourceReferences\":[{\"label\":\"Miden Transaction Model\""
    ",\"url\":\"https://docs.miden.xyz/core-concepts/miden-base/transaction/\"},{\"label\":\"Miden N"
    "otes\",\"url\":\"https://docs.miden.xyz/core-concepts/miden-base/note/\"}],\"securityNotes\":[\""
    "Private note data and off-chain delivery metadata must stay wallet-local.\",\"Account-loca"
    "l transition proofs must bind initial and final account commitments.\",\"Reference blocks "
    "must prevent replay against stale account state.\",\"Production Miden note transactions re"
    "quire audited STARK parameters and account-state integration review.\",\"Production harden"
    "ing requires deterministic vectors, negative/adversarial test cases, replay/nullifier re"
    "jection tests, parser/verifier fuzzing, performance gates, and internal cryptographic re"
    "view.\"],\"requiredState\":[\"private note hash database\",\"input note nullifier set\",\"accoun"
    "t commitment state\",\"STARK VM verifier key registry\",\"wallet private note witness store\""
    "],\"failureModes\":[\"stale reference block\",\"duplicate input note nullifier\",\"account comm"
    "itment transition mismatch\",\"malformed proof bytes\",\"wrong verifier key\",\"public input m"
    "ismatch\"],\"setupSteps\":[\"Add private note hash/nullifier state and account-local transit"
    "ion verification.\",\"Register a STARK VM verifier and public-input commitment layout.\",\"P"
    "ersist private note data and off-chain delivery metadata in the wallet note store.\"],\"ex"
    "ecutionSteps\":[\"Execute the account-local transition against private note witnesses.\",\"P"
    "roduce a STARK proof for the transaction script and account state delta.\",\"Submit note n"
    "ullifiers, output note hashes, account commitments, and proof.\"],\"sdkEntrypoints\":[\"buil"
    "dMidenStarkTransactionProofV1\",\"buildMidenNoteTransactionInstruction\"],\"plannedSdkEntryp"
    "oints\":[],\"chainRequirements\":[\"STARK VM verifier\",\"private note hash and nullifier data"
    "base\",\"account commitment state\",\"wallet private-note delivery store\",\"typed Miden note "
    "transaction instruction\"]},{\"id\":\"aztec-private-rollup-v1\",\"name\":\"Aztec-style programma"
    "ble private transaction v1\",\"shortName\":\"Aztec private\",\"summary\":\"Programmable private-"
    "state transaction using client-side private execution, note hashes, nullifiers, encrypte"
    "d logs, and recursive private-kernel proofs.\",\"category\":\"payment\",\"maturity\":\"specifica"
    "tion\",\"coveredCriteria\":[\"hide_amount\",\"hide_sender\",\"hide_receiver\"],\"proofFamily\":\"plo"
    "nkish-private-kernel-rollup\",\"publicInputsSchema\":\"note_hashes,nullifiers,encrypted_logs"
    ",public_call_requests,private_kernel_commitment,rollup_state_roots\",\"verifierKeyId\":\"azt"
    "ec_private_kernel_v1\",\"pqLayers\":{\"proof\":false,\"authorization\":false,\"note_encryption\":"
    "false},\"implementationStage\":\"sdk-builder\",\"recommendedFor\":[\"programmable private payme"
    "nts\",\"hybrid public/private contract workflows\",\"wallet-side private execution with encr"
    "ypted note discovery\"],\"sourceReferences\":[{\"label\":\"Aztec State Management\",\"url\":\"http"
    "s://docs.aztec.network/developers/docs/foundational-topics/state_management\"},{\"label\":\""
    "Aztec Private Kernel Circuit\",\"url\":\"https://docs.aztec.network/developers/nightly/docs/"
    "foundational-topics/advanced/circuits/private_kernel\"}],\"securityNotes\":[\"Private-kernel"
    " proofs must bind note hashes, nullifiers, encrypted logs, and public calls.\",\"Encrypted"
    " log delivery metadata must not leak wallet note ownership.\",\"Recursive verifier registr"
    "ation must distinguish private-kernel versions and rollup state roots.\",\"Production priv"
    "ate-rollup use requires audited private-kernel parameters and rollup-state integration r"
    "eview.\",\"Production hardening requires deterministic vectors, negative/adversarial test "
    "cases, replay/nullifier rejection tests, parser/verifier fuzzing, performance gates, and"
    " internal cryptographic review.\"],\"requiredState\":[\"private note-hash tree\",\"nullifier t"
    "ree\",\"encrypted log delivery store\",\"private-kernel verifier key registry\",\"wallet priva"
    "te execution witness store\"],\"failureModes\":[\"stale rollup state root\",\"duplicate nullif"
    "ier\",\"private-kernel public input mismatch\",\"malformed proof bytes\",\"wrong verifier key\""
    ",\"public input mismatch\"],\"setupSteps\":[\"Add private note-hash and nullifier trees plus "
    "encrypted log delivery metadata.\",\"Register a private-kernel verifier and public-input l"
    "ayout for private contract side effects.\",\"Persist wallet PXE-style note discovery, priv"
    "ate call witnesses, and app-scoped nullifier keys.\"],\"executionSteps\":[\"Execute private "
    "contract calls locally against wallet notes.\",\"Accumulate note hashes, nullifiers, encry"
    "pted logs, and public-call requests in the private kernel.\",\"Submit the recursive privat"
    "e-kernel proof and side-effect commitments for validator verification.\"],\"sdkEntrypoints"
    "\":[\"buildAztecPrivateKernelProofV1\",\"buildAztecPrivateRollupTransactionInstruction\"],\"pl"
    "annedSdkEntrypoints\":[],\"chainRequirements\":[\"private note-hash tree\",\"nullifier tree\",\""
    "encrypted log store\",\"private-kernel verifier\",\"wallet private execution environment\",\"t"
    "yped Aztec private-rollup transaction instruction\"]},{\"id\":\"pq-masp-stark-v0\",\"name\":\"Po"
    "st-quantum MASP STARK v0\",\"shortName\":\"PQ MASP v0\",\"summary\":\"Target end-to-end post-qua"
    "ntum MASP using STARK/FRI proofs, ML-DSA authorization, and ML-KEM note encryption.\",\"ca"
    "tegory\":\"payment\",\"maturity\":\"specification\",\"coveredCriteria\":[\"hide_amount\",\"hide_send"
    "er\",\"hide_receiver\",\"hide_asset_type\",\"post_quantum\"],\"proofFamily\":\"stark-fri\",\"publicI"
    "nputsSchema\":\"pool_id,asset_set_root,nullifier_set,output_commitments,root,chain_tag,pq_"
    "policy_hash\",\"verifierKeyId\":\"pq_masp_stark_v0\",\"pqLayers\":{\"proof\":true,\"authorization\""
    ":true,\"note_encryption\":true},\"implementationStage\":\"sdk-builder\",\"recommendedFor\":[\"end"
    "-to-end post-quantum privacy target\",\"long-horizon central-bank pilot research\",\"strict "
    "PQ proof, authorization, and note-encryption experiments\"],\"sourceReferences\":[{\"label\":"
    "\"NIST Post-Quantum Standards\",\"url\":\"https://www.nist.gov/news-events/news/2024/08/nist-"
    "releases-first-3-finalized-post-quantum-encryption-standards\"},{\"label\":\"FIPS 203 ML-KEM"
    "\",\"url\":\"https://csrc.nist.gov/pubs/fips/203/final\"},{\"label\":\"FIPS 204 ML-DSA\",\"url\":\"h"
    "ttps://csrc.nist.gov/pubs/fips/204/final\"},{\"label\":\"FIPS 205 SLH-DSA\",\"url\":\"https://cs"
    "rc.nist.gov/pubs/fips/205/final\"}],\"securityNotes\":[\"PQ MASP combines experimental STARK"
    "/FRI proving with production PQ authorization and note encryption requirements.\",\"ML-DSA"
    " domains and ML-KEM ciphertext formats must be bound to verifier keys and pool identifie"
    "rs.\",\"Post-quantum readiness still requires parameter review, parser fuzzing, and intern"
    "al cryptographic review.\",\"Wallet witness material and private inputs must stay local an"
    "d must not be exposed through SDK or chain APIs.\",\"Any chain roots, nullifiers, revocati"
    "on data, or replay guards for this flow must persist across node restarts before admitti"
    "ng ledger mutations.\",\"Production hardening requires deterministic vectors, negative/adv"
    "ersarial test cases, replay/nullifier rejection tests, parser/verifier fuzzing, performa"
    "nce gates, and internal cryptographic review.\"],\"requiredState\":[\"PQ MASP asset-set comm"
    "itment root\",\"PQ nullifier set\",\"ML-KEM encrypted note payload store\",\"wallet PQ note wi"
    "tness store\"],\"failureModes\":[\"stale asset-set root\",\"duplicate PQ nullifier\",\"ML-DSA or"
    " ML-KEM domain mismatch\",\"malformed proof bytes\",\"wrong verifier key\",\"public input mism"
    "atch\"],\"setupSteps\":[\"Register STARK/FRI verifier parameters and PQ MASP public input la"
    "yout.\",\"Define ML-DSA authorization domains and ML-KEM note-encryption payload formats.\""
    ",\"Persist wallet PQ note witnesses, nullifier positions, and encapsulation metadata.\"],\""
    "executionSteps\":[\"Select PQ MASP input notes and derive nullifiers.\",\"Generate STARK/FRI"
    " transfer proofs with ML-DSA authorization and ML-KEM output-note encryption.\",\"Submit n"
    "ullifiers, output commitments, PQ policy hash, and proof for verifier admission.\"],\"sdkE"
    "ntrypoints\":[\"buildPqMaspStarkTransferProofV0\",\"buildPqMaspStarkRegisterPoolInstruction\""
    ",\"buildPqMaspStarkTransferInstruction\",\"generateMlDsaKeyPair\",\"encapsulateMlKem\"],\"plann"
    "edSdkEntrypoints\":[],\"chainRequirements\":[\"STARK/FRI verifier enabled\",\"ML-DSA transacti"
    "on authorization\",\"ML-KEM note payload encryption\",\"zk::RegisterAssetHiddenZkPool\",\"zk::"
    "AssetHiddenZkTransfer\",\"active PQ MASP verifier key\"]}]"
)
...
_EXECUTABLE_SDK_IMPLEMENTATION_STAGES = frozenset(
    (
        "chain-executable",
        "sdk-builder",
        "component",
...
_PROOF_BUILDER_EXPORTED_IMPLEMENTATION_STAGES = frozenset(
    (
        "chain-executable",
        "sdk-builder",
        "component",
...
def _privacy_evidence_sdk_entrypoints(
    ...
    if isinstance(value, list):
        entrypoints = _privacy_evidence_string_list(value)
        if entrypoints != expected:
            return None
        if any(
            not _is_sdk_entrypoint_name(entrypoint)
            or _entrypoint_is_dev_fixture(entrypoint)
...
def _privacy_evidence_sdk_exports(
    value: Any,
    *,
    sdk_entrypoints: list[str],
    ...
    for surface in PRIVACY_PRODUCTION_SDK_ENTRYPOINT_SURFACES:
        entrypoints = _privacy_evidence_string_list(value.get(surface))
        if entrypoints != sdk_entrypoints:
            return None
        if any(
            not _is_sdk_entrypoint_name(entrypoint)
            or _entrypoint_is_dev_fixture(entrypoint)
            ...
            return None
        result[surface] = list(entrypoints)
    return result
...
def _privacy_evidence_review_scope(
    value: Any,
    descriptor: Mapping[str, Any],
    *,
    chain_id: str,
    sdk_entrypoints: list[str],
    fuzz_results: Mapping[str, Any],
    performance_results: Mapping[str, Any],
    localnet_run_id: str,
) -> dict[str, Any] | None:
    if not isinstance(value, Mapping) or set(value) != PRIVACY_PRODUCTION_REVIEW_SCOPE_KEYS:
        return None
    algorithm_id = _privacy_evidence_text_value(value.get("algorithm_id"), limit=160)
    scope_chain_id = _privacy_evidence_chain_id(value.get("chain_id"))
    verifier_key_id = value.get("verifier_key_id")
    proof_family = value.get("proof_family")
    public_inputs_schema = value.get("public_inputs_schema")
    scope_entrypoints = _privacy_evidence_string_list(value.get("sdk_entrypoints"))
    required_state = _privacy_evidence_string_list(value.get("required_state"))
    fuzz_artifact_hash = _privacy_evidence_hash_uri(value.get("fuzz_artifact_hash"))
    performance_artifact_hash = _privacy_evidence_hash_uri(
        value.get("performance_artifact_hash")
    )
    scope_localnet_run_id = _privacy_evidence_localnet_run_id(
        value.get("localnet_run_id")
    )
    if (
        value.get("version") != PRIVACY_PRODUCTION_REVIEW_SCOPE_VERSION
        or algorithm_id != descriptor.get("id")
        or scope_chain_id != chain_id
        or not _privacy_evidence_nullable_equals(
            verifier_key_id,
        ...
        or scope_entrypoints != sdk_entrypoints
        or required_state != list(descriptor.get("required_state", []))
        or fuzz_artifact_hash != fuzz_results["artifact"]["uri"]
        or performance_artifact_hash != performance_results["artifact"]["uri"]
        or scope_localnet_run_id != localnet_run_id
    ):
        return None
    return {
        "version": PRIVACY_PRODUCTION_REVIEW_SCOPE_VERSION,
        "algorithm_id": algorithm_id,
        "chain_id": scope_chain_id,
        "verifier_key_id": verifier_key_id,
        "proof_family": proof_family,
        "public_inputs_schema": public_inputs_schema,
        "sdk_entrypoints": list(scope_entrypoints),
        "required_state": list(required_state),
        "fuzz_artifact_hash": fuzz_artifact_hash,
        "performance_artifact_hash": performance_artifact_hash,
        "localnet_run_id": scope_localnet_run_id,
    }
...
def _privacy_trusted_production_evidence(
    ...
    *,
    ...
    if sdk_entrypoints is None:
        return None
    sdk_exports = _privacy_evidence_sdk_exports(
        source.get("sdk_exports"),
        sdk_entrypoints=sdk_entrypoints,
    )
    if sdk_exports is None:
        return None
    ...
    if fuzz_results is None or performance_results is None:
        return None
    review_scope = _privacy_evidence_review_scope(
    ...
    return {
        ...
        "sdk_parity_artifacts": sdk_parity_artifacts,
...
def _privacy_production_gate_from_evidence(
    ...
    return {
        ...
        "review_scope": copy.deepcopy(evidence["review_scope"]),
        "sdk_exports": copy.deepcopy(evidence["sdk_exports"]),
        "sdk_parity_artifacts": copy.deepcopy(evidence["sdk_parity_artifacts"]),
...
def _with_privacy_production_evidence(
    ...
    *,
    ...
    result["sdk_exports"] = copy.deepcopy(trusted_evidence["sdk_exports"])
...
def _validate_descriptor_shape(descriptor: Mapping[str, Any], index: int) -> None:
    ...
    backend_family = BACKEND_FAMILY_BY_ALGORITHM_ID.get(str(descriptor.get("id")))
    if (
        implementation_stage == "production-hardened"
        and backend_family in PENDING_PRODUCTION_BACKEND_FAMILIES
    ):
        raise RuntimeError(
            "privacy algorithm catalog entry "
            f"{index} backend family {backend_family!r} is still pending "
    ...
    if any(_entrypoint_is_explicit_dev_fixture(entrypoint) for entrypoint in sdk_entrypoints):
        ...
        has_exported_production_proof_builder = any(
            _entrypoint_is_production_proof_builder(entrypoint)
            for entrypoint in sdk_entrypoints
        )
        if not planned_sdk_entrypoints and not has_exported_production_proof_builder:
            raise RuntimeError(
                "privacy algorithm catalog entry "
                f"{index} executable DevFixture SDK entrypoints must retain "
                "planned production SDK entrypoints or export a production "
                "proof builder until production gates pass"
            )
        if not has_exported_production_proof_builder and not any(
            _entrypoint_is_production_proof_builder(entrypoint)
            for entrypoint in planned_sdk_entrypoints
        ):
            raise RuntimeError(
    ...
    if (
        ...
        if (
            ...
            raise RuntimeError(
                ...
                "or a production proof builder must be exported for "
                "pre-production source-referenced implementation stages"
            )
        if not any(
    ...
    if "post_quantum" in seen_criteria:
        ...
        post_quantum_entrypoints = (
            descriptor.get("sdk_entrypoints", [])
            if descriptor.get("implementation_stage")
            in _EXECUTABLE_SDK_IMPLEMENTATION_STAGES
...
def _apply_privacy_inventory_advancements(
    ...
    if algorithm_id in production_inventory_algorithm_ids:
        ...
        result["implementation_stage"] = (
            REQUIRED_PRIVACY_PLAN_STAGE_BY_ALGORITHM_ID.get(algorithm_id)
    ...
    if algorithm_id in REQUIRED_PRIVACY_PLAN_SDK_ENTRYPOINTS_BY_ALGORITHM_ID and (
        ...
        result["implementation_stage"] = REQUIRED_PRIVACY_PLAN_STAGE_BY_ALGORITHM_ID[
            algorithm_id
        ]
...
def _validate_required_privacy_plan_rows(
    ...
    for algorithm_id, implementation_stage, backend_family in REQUIRED_PRIVACY_PLAN_ROWS:
        ...
        proof_builder_entrypoints = tuple(
            descriptor.get("sdk_entrypoints", [])
        ) + tuple(descriptor.get("planned_sdk_entrypoints", []))
        if not any(
            _entrypoint_is_production_proof_builder(entrypoint)
...
def _validate_required_privacy_plan_raw_source(
    descriptor: Mapping[str, Any],
    index: int,
) -> None:
    algorithm_id = str(descriptor.get("id") or "")
    expected_display_text = REQUIRED_PRIVACY_PLAN_DISPLAY_TEXT_BY_ALGORITHM_ID.get(
        algorithm_id
    )
    if expected_display_text is None:
        return
    if (
        descriptor.get("name"),
        descriptor.get("short_name"),
    ...
    expected_fields: tuple[tuple[str, object], ...] = (
        (
            "implementation_stage",
            REQUIRED_PRIVACY_PLAN_STAGE_BY_ALGORITHM_ID[algorithm_id],
        ),
        (
            "security_notes",
            REQUIRED_PRIVACY_PLAN_SECURITY_NOTES_BY_ALGORITHM_ID[algorithm_id],
    ...
    for field, expected in expected_fields:
        ...
        if actual != expected:
            raise RuntimeError(
                "privacy algorithm catalog entry "
                f"{index} required privacy plan raw source row {algorithm_id!r} "
                f"must keep field {field!r} aligned with required inventory; "
                "do not rely on compatibility overlays to repair production "
                "stage or SDK entrypoint drift"
            )
...
def _load_descriptors() -> tuple[dict[str, Any], ...]:
    ...
    for index, item in enumerate(loaded):
        ...
        raw_canonical = _canonicalize_value(item)
        _validate_required_privacy_plan_raw_source(raw_canonical, index)
        canonical = _apply_privacy_inventory_advancements(raw_canonical)
...
def _privacy_plan_entrypoints_available(
    ...
    if implementation_stage in _EXECUTABLE_SDK_IMPLEMENTATION_STAGES:
