"""Mandatory execution checks against the freshly installed PyO3 ABI24 module."""
...
def test_authenticated_pyo3_abi24_executes_the_privacy_catalog_contract() -> None:
