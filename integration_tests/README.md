...
- Feature flags: `telemetry` (default), `fault_injection`, `norito_streaming_fec`, `js_host_parity`, `zk-stark`. Enable with `cargo test -p integration_tests --features "<feature list>"`.
