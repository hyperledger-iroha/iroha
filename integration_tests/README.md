...
- `scripts/run_full_tests.sh` now reuses the workspace-built `irohad`, `iroha`, and `kagami` binaries when they are available and isolates the integration-test permit directory by default.
