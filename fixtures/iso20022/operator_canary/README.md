...
They are intentionally non-secret examples that use `.example.invalid` HTTPS
endpoints and relative paths resolved from this directory. Relative paths must
