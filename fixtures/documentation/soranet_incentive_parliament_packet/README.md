...
- Supporting artefacts: `fixtures/documentation/soranet_incentive_shadow_run.{json,pub,sig}`,
...
```bash
shasum -a 256 fixtures/documentation/soranet_incentive_parliament_packet/* \
  fixtures/documentation/soranet_incentive_shadow_run.json \
  fixtures/documentation/soranet_incentive_shadow_run.sig
```
