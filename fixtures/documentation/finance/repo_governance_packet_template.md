...
file referenced in §2.8 of `specs/finance/repo_ops.md`.
...
> `fixtures/documentation/finance/repo_custodian_ack_template.md` for a ready-to-fill
...
`specs/finance/repo_ops.md` §2.9 for the evidence workflow).
...
in `specs/finance/repo_ops.md` §3.2.
...
exports referenced in `specs/finance/repo_ops.md`. Record the files +
