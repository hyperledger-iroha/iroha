...
@pytest.mark.parametrize("symbol,old,new", [
    ...
    ("Kura::read_first_admission_carrier", "retained_block_record_at_without_live_body", "retained_block_record_at"),
    ("Kura::read_first_admission_carrier", "if header != record.block_header", "if false"),
    ("Kura::read_first_admission_carrier", "body.canonical_proposal_wire_hash()? != finality.subject.payload_hash", "false"),
