...
`KagemushaRecursiveSpendV2` consumes the canonical V3 release manifest and its
...
`beginPastaCycleV3ArtifactIngest`, write bounded chunks, finalize only after the
