...
final class ToriiGovernanceDecodingTests: XCTestCase {
    func testGovernanceLockRecordAcceptsStringAmount() throws {
        let json = """
        {"owner":"sorauﾛ1PﾉｳﾇmEｴWｵebHﾑ6ﾔﾙｲヰiwuCWErJ7uｽoPGｱﾔnjﾑKﾋTCW2PV","amount":"123","expiry_height":10,"direction":1,"duration_blocks":5}
        """.data(using: .utf8)!
    ...
    func testGovernanceLockRecordRejectsFloatAmount() {
        let json = """
        {"owner":"sorauﾛ1PﾉｳﾇmEｴWｵebHﾑ6ﾔﾙｲヰiwuCWErJ7uｽoPGｱﾔnjﾑKﾋTCW2PV","amount":1.5,"expiry_height":10,"direction":1,"duration_blocks":5}
        """.data(using: .utf8)!
