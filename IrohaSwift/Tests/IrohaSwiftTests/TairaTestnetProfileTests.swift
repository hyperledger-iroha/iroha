...
final class TairaTestnetProfileTests: XCTestCase {
    ...
    func testExactPublicMetadata() {
        ...
        XCTAssertEqual(TairaTestnetProfile.offlineCashAssetDefinitionId, "7ZepsJTHCVLKsrFFNZGSRGZgvBhv")
        XCTAssertEqual(TairaTestnetProfile.offlineCashAssetAlias, "ds#boi.is")
        XCTAssertEqual(TairaTestnetProfile.offlineCashAssetScale, 2)
