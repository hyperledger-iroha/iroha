...
public struct IrohaOfflineTransferCapabilities: Equatable, Sendable {
    public let qr: Bool
    public let nfc: Bool
    ...
    public var availableTransports: [IrohaOfflineTransferTransportKind] {
        IrohaOfflineTransferTransportKind.allCases.filter {
            switch $0 {
            case .qr: return qr
            case .nfc: return nfc
            case .nearby: return nearby
...
public struct IrohaOfflineTransferTheme {
    ...
    public static let boi = IrohaOfflineTransferTheme(
