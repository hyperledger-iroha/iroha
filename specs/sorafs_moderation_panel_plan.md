...
- `sorafs_manifest::SoraFsModerationBallotGovernanceEventV1` and the embedded
  ...
  native events.
- `fixtures/documentation/ministry/policy_jury_roster_example.json` and
  `fixtures/documentation/ministry/policy_jury_sortition_example.json` provide example
...
- Deploy the existing appeal/panel transaction outbox, finalized-chain
  ...
  `specs/sorafs_commit_reveal_plan.md`.
