...
- `specs/sorafs_gateway_dns_owner_runbook.md` (cutover cadence)
...
cargo xtask soradns-hosts \
  ...
  --verify-host-patterns fixtures/documentation/soradns_host_patterns_docs_sora.json
```

For Taira's owned Mon gateway, add `--pretty-suffix mon.taira.sora.net`; the
derived pretty host becomes `docs.sora.mon.taira.sora.net`.
...
`fixtures/documentation/soradns_host_patterns_docs_sora.json` so onboarding teams can
...
cargo xtask soradns-gar-template \
  ...
  --json-out fixtures/documentation/soradns_gar_docs_sora.json
```
...
| File | Description |
|------|-------------|
| `fixtures/documentation/soradns_host_patterns_docs_sora.json` | Canonical GAR host-pattern verification payload referenced by `soradns-hosts`. |
| `fixtures/documentation/soradns_gar_docs_sora.json` | Sample GAR template emitted by `soradns-gar-template` (pre-signature). |
