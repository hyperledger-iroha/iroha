...
Authorized integration location: `/Users/takemiyamakoto/dev/iroha`, branch
`optimizations`. Implementation and validation for this task use only this checkout.
