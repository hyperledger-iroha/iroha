...
`specs/sorafs_gateway_dns_design_minutes.md`.

## Status Summary

- Invitations sent 2025-02-21 using `specs/sorafs_gateway_dns_design_invite.txt`.
...
5. **Owner runbook** — The shared SOP now lives in `specs/sorafs_gateway_dns_owner_runbook.md`; it was circulated with the kickoff deck and referenced when tracking rehearsal status.
6. **Close-out confirmation** — All follow-ups above were completed and logged in `specs/sorafs_gateway_dns_design_minutes.md` under the 2025-03-04 close-out entry.
...
- Agenda archive: `specs/sorafs_gateway_dns_design_agenda.md`.
- Minutes and action register: `specs/sorafs_gateway_dns_design_minutes.md`.
