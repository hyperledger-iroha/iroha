...
See `specs/da/ingest_plan.md` (Validation checklist) for the updated gate
...
2. **Diff intent vs live replicas.** Use the new audit helper:
   ...
   `fixtures/documentation/da_manifest_review_template.md` packet for Parliament votes.
3. **Trigger re-replication.** When the audit reports a shortfall, issue a fresh
   ...
   `specs/sorafs/storage_capacity_marketplace.md` and re-run the audit
