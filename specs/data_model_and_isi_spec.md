...
- `Name` — validated textual identifier. Rules: `crates/iroha_model_base/src/name.rs`.
...
- `Metadata` — `BTreeMap<Name, Json>` with checked insert/remove. Code: `crates/iroha_model_base/src/metadata.rs`.
