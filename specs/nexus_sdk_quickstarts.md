...
`specs/sdk/*` and the operator runbook (`specs/nexus_operations.md`).
...
- Download the Nexus config bundle (see `specs/sora_nexus_operator_onboarding.md`)
...
- Docs: `specs/sdk/js/quickstart.md` (pending rename to align with this doc)
...
- Docs: `specs/sdk/android/index.md`
...
- **`ERR_SETTLEMENT_PAUSED`** — lane-level governance pause; check
  `specs/nexus_operations.md` for the incident process.
