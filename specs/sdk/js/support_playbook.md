...
(`specs/sdk/js/fixture_cadence.md`), verification outputs, and the latest
...
- `specs/sdk/js/publishing.md` — release automation + rollback guide.
- `specs/sdk/js/release_playbook.md` — GitHub workflow driven release flow.
- `specs/sdk/js/fixture_cadence.md` — governance-approved regeneration schedule.
