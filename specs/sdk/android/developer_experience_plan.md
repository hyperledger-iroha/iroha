...
- Detailed design notes for each experience now live under `specs/sdk/android/samples/` (see `operator_console.md` and `retail_wallet.md`) so engineering tickets can link to concrete acceptance criteria.
