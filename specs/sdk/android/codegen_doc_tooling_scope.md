...
- New tool: `scripts/android_codegen_docs.py` that consumes the manifests above
  and renders:
  - `specs/sdk/android/generated/instructions/*.md` (one file per
    discriminant with field tables, Norito examples, Kotlin usage snippet).
  - `specs/sdk/android/generated/manifest_catalog.md` (index referencing
...
- Add `make android-codegen-docs` that executes:
  ...
  4. `scripts/docs/hash_tree.sh specs/sdk/android/generated`.
- New CI workflow `.github/workflows/android_codegen_docs.yml` (mirrors
  ...
  docs are stale.
- Publish guidance:
  - Link the generated Markdown via `specs/sdk/android/index.md`.
...
pipeline, producing `specs/sdk/android/generated/` via
`make android-codegen-docs`. Hash-tree metadata lives in
`specs/sdk/android/generated/codegen_hash_tree.json` (emitted by
