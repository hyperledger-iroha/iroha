...
- Pre-work: Review `specs/sdk/android/telemetry_redaction.md`,
  `specs/android_support_playbook.md`, and
  `specs/android_runbook.md` sections 2-5.
...
- Slide deck storyboard: `specs/sdk/android/readiness/deck/telemetry_redaction_v1.md`
  (export to slides before the live run; tracks speaker notes and demo cues).
- Quick reference card: `specs/sdk/android/telemetry_redaction_quick_reference.md`
  (override workflow, dashboard URLs, alert checklist).
- Lab guide: `specs/sdk/android/readiness/labs/telemetry_lab_01.md`
  (maps chaos checklist scenarios to Android tooling and evidence requirements).
- Knowledge check: `specs/sdk/android/readiness/forms/telemetry_quiz_2026-02.md`
  (Google Form export and Markdown source used for sign-off).
- Policy references: `specs/sdk/android/telemetry_redaction.md`,
  `specs/android_support_playbook.md`, and `specs/android_runbook.md`.
...
|------|---------|---------|------------------|
| 2026-02-05 | Email - SRE governance list | Shared readiness plan overview, linked policy docs, requested agenda slot confirmation. | `specs/sdk/android/readiness/archive/2026-02/pre-read-email.eml` |
...
Lab scenarios reuse `specs/sdk/android/telemetry_chaos_checklist.md`; the
Android-specific instructions live in
`specs/sdk/android/readiness/labs/telemetry_lab_01.md`.
...
- Schema diffs: `scripts/telemetry/run_schema_diff.sh` with outputs stored in
  `specs/sdk/android/readiness/schema_diffs/`.
- Override audit evidence: `specs/sdk/android/readiness/override_logs/`
  plus validator outputs from `scripts/telemetry/*`.
- Lab artefacts: store logs and screenshots in
  `specs/sdk/android/readiness/labs/reports/<stamp>/`.
...
- Response export: `specs/sdk/android/readiness/forms/responses/2026-02-and7.csv`
  (session date 2026-02-18).
- Quiz summary: `specs/sdk/android/readiness/reports/202602_and7_quiz.md`
  with JSON companion under `artifacts/android/telemetry/and7_quiz/`.
- Attendance log: `specs/sdk/android/readiness/archive/2026-02/attendance.md`.
