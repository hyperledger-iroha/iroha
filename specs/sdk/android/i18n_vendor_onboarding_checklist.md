...
|------|-------|-----|--------|----------|
| Execute PO `DOCS-L10N-4901` & NDA, create vendor billing profile | Docs/DevRel Manager | 2026-04-04 | ✅ Completed | `specs/docs_devrel/minutes/2026-03.md` (Procurement section) |
...
| Share glossary + style guide (`specs/sdk/android/i18n_plan.md` Section 2) | Android DX TL | 2026-04-08 | ✅ Completed | Attached in kickoff minutes |
...
| QA shadow assignment (Thu session) + reviewer rota confirmation | Docs/DevRel Manager + Vendor PM | 2026-04-09 | ✅ Completed | Rota documented in `specs/sdk/android/i18n_plan.md` Section 4.3 |
| First delivery pilot: Android quickstart refresh | Vendor PM + Android DX TL | 2026-04-12 | 🕒 In Flight | Request `specs/sdk/android/i18n_requests/quickstart_20260408.md`, nightly `ci/check_android_docs_i18n.sh` output archived |
...
1. **Thursday (vendor QA shadow)** – Vendor joins the Android DX engineer to
   ...
   notes recorded under `specs/sdk/android/i18n_requests/minutes/`.
...
- For every translation delivery, run:
  ...
  scripts/sync_docs_i18n.py \
    --locale ja --locale he \
    --status-out specs/sdk/android/i18n_requests/<name>.md
  ```
...
`specs/docs_devrel/monthly_sync_agenda.md`). Update this checklist when
