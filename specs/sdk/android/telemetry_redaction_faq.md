...
- When rotating, run the same command with `--write-cache` to capture the before
  ...
  `specs/sdk/android/readiness/screenshots/<YYYY-MM-DD>/salts/`.
...
- Archive screenshots and CLI transcripts under
  `specs/sdk/android/readiness/screenshots/<scenario>/`.
...
- **Chaos lab artefacts:** `specs/sdk/android/readiness/`
