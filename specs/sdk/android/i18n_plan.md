...
|----------|--------------|-----------|-----------|-------|
| Quickstart | `specs/sdk/android/index.md` | `index.ja.md` | `index.he.md` | Already localized; requires AND5 sample references + screenshot updates. |
| Key management | `specs/sdk/android/key_management.md` | `key_management.ja.md` | `key_management.he.md` | Update once AND2 alias lifecycle stabilizes; ensure glossary terms align with StrongBox doc. |
| Offline signing | `specs/sdk/android/offline_signing.md` | `offline_signing.ja.md` | `offline_signing.he.md` | Include envelope/handoff terminology. |
| Networking guide | `specs/sdk/android/networking.md` | `networking.ja.md` | `networking.he.md` | Must cover `/v1/pipeline`, Norito RPC, telemetry toggles. |
| Sample walkthrough — Operator console | `specs/sdk/android/samples/operator_console.md` | `samples/operator_console.ja.md` | `samples/operator_console.he.md` | New for AND5; share screenshots + CLI output. |
| Sample walkthrough — Retail wallet | `specs/sdk/android/samples/retail_wallet.md` | `samples/retail_wallet.ja.md` | `samples/retail_wallet.he.md` | Emphasize offline signing guidance. |
| Troubleshooting matrix | `specs/sdk/android/troubleshooting.md` | `troubleshooting.ja.md` | `troubleshooting.he.md` | To be written post-sample CI; include localization-ready strings. |
| Release/provenance notes | `specs/release/provenance/android/*.md` | JP/HE appendices | Optional if regulators require; track via governance tickets. |

## 3. Workflow & SLA

1. **Source of truth:** English docs live on `main`. Every change touching scoped files must update `specs/sdk/android/i18n_plan.md` status tables.
...
|-----------|----------|---------------|--------|
| Approve Japanese translator contract | 2026-04-05 | 0.5 FTE contractor | 🈴 Completed — PO `DOCS-L10N-4901` countersigned 2026-04-04; Kotodama Language Partners (0.5 FTE) onboarding 2026-04-08 with NDA + billing profile captured in `specs/docs_devrel/minutes/2026-03.md`. |
...
| Vendor onboarding & QA shadowing | 2026-04-12 | Android DX TL + Docs vendor lead | 🈴 Completed — Kickoff held 2026-04-08, tooling demo + screenshot SOP recorded, and the QA checklist lives in `specs/sdk/android/i18n_vendor_onboarding_checklist.md` to guide ongoing drops. |

Escalate resource blockers during the monthly Docs sync (see `specs/sdk/android/telemetry_redaction_minutes_20260212.md` for template).
...
| 2026-03-12 | Mar Docs/DevRel sync (`specs/docs_devrel/minutes/2026-03.md`) | PO `DOCS-L10N-4901` still pending; decision to escalate via ticket `PO-20260312` with SLA evidence and to increase Android diff digest cadence (Tue/Thu/Sat) until the contractor is live. HE reviewer PTO (2026-03-25–28) requires onboarding Eitan Levi as backup and updating the reviewer rota. | Docs/DevRel Manager to file escalation + update `status.md` (due 2026-03-14); Android DX TL to run expanded diff digests immediately; Android DX TL + Docs/DevRel Manager to confirm HE backup by 2026-03-18 and log rota update by 2026-03-20. |
...
- CI freshness output (`ci/check_android_docs_i18n.sh`) and ticket summaries
  from `specs/sdk/android/i18n_requests/` are reviewed live so SLA risks
  are caught early.
...
to `specs/sdk/android/i18n_vendor_onboarding_checklist.md`. Keep that
...
| Nexus overview (`specs/nexus_overview.md`) | 2026-03-24 | 🈯 Ticket `DOCS-L10N-4821` (vendor pending ETA) | 🈯 Ticket `DOCS-L10N-4822` (Docs engineer rota 2026-04-15) | Placeholder files checked in (`nexus_overview.ja.md`/`.he.md`); translators need settlement context. |
| Nexus operations runbook (`specs/nexus_operations.md`) | 2026-03-24 | 🈯 Ticket `DOCS-L10N-4823` | 🈯 Ticket `DOCS-L10N-4824` | Mirrors operator runbook severity matrix; ensure terminology matches support playbook. |
| Nexus settlement FAQ (`specs/nexus_settlement_faq.md`) | 2026-03-24 | 🈳 Not Started | 🈳 Not Started | Assign after worked examples land; note dependency in Section 7. |
| Nexus SDK quickstarts (`specs/nexus_sdk_quickstarts.md`) | 2026-03-24 | 🈳 Not Started | 🈳 Not Started | Blocked until SDK snippet API surfaces stabilize; track under NX-14. |
...
|----------|------------------|-------|
| Diff digest + request | `scripts/sync_docs_i18n.py --locale ja --locale he --status-out specs/sdk/android/i18n_requests/<doc>_YYYYMMDD.md` | Attach git hash + rendered HTML snippets; link the request file in the Docs tracker ticket. |
...
| Monthly staffing minutes | `specs/sdk/android/i18n_requests/minutes/YYYY-MM.md` | Mirrors the Docs sync template; list owners, blockers, and escalation notes. |
...
Store the bundle under `specs/sdk/android/i18n_requests/archive/YYYY-MM/`
