...
| Android follow-up | Required actions for codegen, fixtures, documentation and consumers. |
...
| 2026-09-25 | `f42e79c2a6280ec925838dc1c1084125b011cc63d2ae91f92d15946befdd9273` (`target-codex/android_codegen/instruction_manifest.json`) | Uncommitted `optimizations` integration based on `e3e07a1c3bda` | Removed 42 unregistered direct grouped instruction IDs from the exporter; the 78-entry catalog uses canonical V1 registry IDs. `RegisterZkAsset` has two fields and `FinalizeElection.tally` is `Vec<u128>`. | Regenerated the instruction, builder, catalog, metadata and hash-tree files twice with identical bytes; manifest parity and 11 Python parity tests pass. The SoraFS fixture replay and Android consumer rebuild remain open. | `specs/sdk/android/generated/codegen_manifest_metadata.json`, `specs/sdk/android/generated/codegen_hash_tree.json`, `docs/history/2026-09-25/first-release-integration-checkpoint.md` |
