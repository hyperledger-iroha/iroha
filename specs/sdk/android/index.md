...
schema, see [`specs/torii/portfolio_api.md`](../../torii/portfolio_api.md).
...
Generated references live under `specs/sdk/android/generated/` and are
...
`fixtures/documentation/android_partner_sla_notes_template.md` when recording sessions.

## Connect Sessions (AND7 Preview)

Android wallets share the same Connect contract documented in
`specs/connect_architecture_strawman.md`. The Java SDK already ships the
building blocks:
