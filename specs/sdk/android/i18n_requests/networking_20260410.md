...
**Source doc:** `specs/sdk/android/networking.md`  
...
- Include the new “Telemetry + Chaos Hooks” appendix and ensure the Norito RPC
  glossary stays aligned with `specs/torii/nrpc_spec.md`.
...
1. Updated `specs/sdk/android/networking.ja.md` & `networking.he.md`.
...
- Generate localization status + archive diff snippets for reviewers:
  ...
  scripts/sync_docs_i18n.py \
    --locale ja --locale he \
    --status-out specs/sdk/android/i18n_requests/networking_20260410.md
  ```
