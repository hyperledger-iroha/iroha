...
**Source doc:** `specs/sdk/android/troubleshooting.md`  
...
- Maintain anchors pointing to `specs/android_runbook.md`,
  `specs/sdk/android/telemetry_redaction.md`, and labs references.
- Screenshots are not required for this request; focus on table accuracy.

## Deliverables

1. Updated `specs/sdk/android/troubleshooting.ja.md` and `.he.md`.
...
- Generate localization status files:
  ...
  scripts/sync_docs_i18n.py \
    --locale ja --locale he \
    --status-out specs/sdk/android/i18n_requests/troubleshooting_matrix_20260324.md
  ```
...
- Reference glossary: `specs/sdk/android/i18n_plan.md` (Section 2).
