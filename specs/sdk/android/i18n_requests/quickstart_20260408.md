...
**Source doc:** `specs/sdk/android/index.md`  
...
- Keep terminology aligned with `specs/sdk/android/key_management.md`
  (StrongBox alias lifecycle), `specs/sdk/android/offline_signing.md`
...
1. Updated `specs/sdk/android/index.ja.md` with AND5 content.
2. Updated `specs/sdk/android/index.he.md` mirroring the JP changes.
...
- Run `scripts/sync_docs_i18n.py --locale ja --locale he --status-out specs/sdk/android/i18n_requests/quickstart_20260408.md`
...
- Reference the kickoff notes in `specs/sdk/android/i18n_plan.md`
