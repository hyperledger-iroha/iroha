...
- **Android source:** `android.telemetry.device_profile` gauge emitted by the
  SDK per `specs/sdk/android/telemetry_redaction.md` and tracked in the
  signal inventory worksheet (`specs/sdk/android/readiness/signal_inventory_worksheet.md`).
- **Swift source:** `device_profile_bucket` field present on
  ...
  in `specs/sdk/swift/telemetry_redaction.md`.
...
- Nightly schema diff runs (`specs/sdk/android/telemetry_schema_diff.md`,
