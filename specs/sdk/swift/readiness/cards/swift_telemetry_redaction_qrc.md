...
full policy lives in `specs/sdk/swift/telemetry_redaction.md`; this card
...
4. Update `specs/sdk/swift/telemetry_redaction.md` Appendix B and the
...
- Log rotation minutes under
  `specs/sdk/swift/readiness/archive/<year>-<month>/salt_rotation.md`.
...
## Incident Artefacts
- Screenshots/logs: `specs/sdk/swift/readiness/screenshots/<date>/`.
- Lab/chaos reports: `specs/sdk/swift/readiness/labs/swift_telemetry_lab_01.md`.
- Emails & receipts: `specs/sdk/swift/readiness/archive/<date>/`.
