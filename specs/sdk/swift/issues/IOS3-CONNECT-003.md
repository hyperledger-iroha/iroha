...
- Document configuration knobs in `specs/references/ios_metrics.md` and
  `specs/telemetry/swift_status_feeds.md`.
...
- ✅ Fixture bundle + loader tests exercise queue/resume timelines and keep the
  NDJSON schema stable (`specs/sdk/swift/readiness/archive/2026-05/connect/`,
