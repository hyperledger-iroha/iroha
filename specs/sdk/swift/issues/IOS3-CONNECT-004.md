...
- Store fixtures under
  `specs/sdk/swift/readiness/archive/2026-05/connect/` with hashes + meta.
- Provide helper loader in `IrohaSwift/Tests/IrohaSwiftTests/ConnectFixtureLoader.swift`.
- Document fixture usage + replay recipe in `specs/sdk/swift/connect_replay_fixtures.md`.
...
- ✅ Fixture bundle captured under
  `specs/sdk/swift/readiness/archive/2026-05/connect/` with scenario JSON
