...
publisher called out in `specs/sdk/swift/connect_workshop.md` and the
IOS3 combine plan.
...
4. Doc updates:
   - `specs/sdk/swift/index.md` (API surface).
   - `specs/connect_architecture_strawman.md` (queue ownership, telemetry).
5. Telemetry wiring + exporter docs (`specs/references/ios_metrics.md`).
...
- ✅ Workshop closed (2026-05-20); evidence captured in
  `specs/sdk/swift/readiness/archive/2026-05/connect/workshop-notes.md`
