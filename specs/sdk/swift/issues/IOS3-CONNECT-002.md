...
3. Update `specs/sdk/swift/connect_workshop.md` outcomes + status digest.
4. Cookbook/example snippet under `specs/sdk/swift/index.md` demonstrating
...
- ✅ Workshop finished and fixtures now live under
  `specs/sdk/swift/readiness/archive/2026-05/connect/`; `ConnectFixtureLoaderTests`
