...
3. **Validate taxonomy alignment.**
   - Run `swift test --filter ConnectErrorTests --package-path IrohaSwift` to ensure the error taxonomy feeding telemetry stays stable (`specs/connect_error_taxonomy.md`).
