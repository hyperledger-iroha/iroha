...
- **Pre-work:** Review `specs/sdk/swift/telemetry_redaction.md`,
  `specs/sdk/swift/support_playbook.md#telemetry-and-readiness`, and
...
- **Slide deck storyboard:** `specs/sdk/swift/readiness/deck/telemetry_redaction_ios7.md`
  (export to slides before the live run; tracks speaker notes + demo cues).
- **Quick reference card:** `specs/sdk/swift/readiness/cards/swift_telemetry_redaction_qrc.md`
  (override workflow, dashboard URLs, alert checklist).
- **Lab guide:** `specs/sdk/swift/readiness/labs/swift_telemetry_lab_01.md`
  (maps chaos checklist scenarios to Swift tooling, Torii staging assets, and
  evidence requirements).
- **Knowledge check:** `specs/sdk/swift/readiness/forms/swift_telemetry_quiz_2026-03.md`
  (Google Form export + Markdown source used for sign-off).
- **Policy references:** `specs/sdk/swift/telemetry_redaction.md`,
  `specs/sdk/swift/support_playbook.md`, and
  `specs/sdk/swift/telemetry_chaos_checklist.md`.
...
|------|---------|---------|------------------|
| 2026-02-20 | Email — SRE governance list | Shared readiness plan overview, linked policy docs, requested agenda slot confirmation. | `specs/sdk/swift/readiness/archive/2026-03/sre_governance_brief_20260220.md` |
...
Lab scenarios reuse `specs/sdk/swift/telemetry_chaos_checklist.md`; the
Swift-specific instructions live in
`specs/sdk/swift/readiness/labs/swift_telemetry_lab_01.md`.
...
- Incident artefacts: archive logs/screenshots in
  `specs/sdk/swift/readiness/archive/2026-03/` and
  `specs/sdk/swift/readiness/screenshots/`.

## 2026-03 Session Outcomes

- Response export: `specs/sdk/swift/readiness/forms/responses/2026-03-and7.csv`
  (session date 2026-03-05).
- Quiz summary: `specs/sdk/swift/readiness/reports/202603_and7_quiz.md`
  with JSON companion `artifacts/swift/telemetry/and7_quiz/202603-summary.json`.
- Attendance log: `specs/sdk/swift/readiness/archive/2026-03/attendance.md`
