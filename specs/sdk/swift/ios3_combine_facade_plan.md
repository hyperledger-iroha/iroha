...
- Deliverables: helper APIs, unit tests, doc snippet in `specs/sdk/swift/index.md`.
...
- Document the bridging rules (frame ownership, telemetry hooks, fail-close) in
  `specs/connect_architecture_strawman.md`.
...
1. **APIs & Docs:** Update `specs/sdk/swift/index.md` and the Connect
