...
- A synthetic baseline lives at
  `specs/sdk/swift/readiness/archive/2026-05/connect/` (mock Torii values,
...
- **Evidence archive:** stash `manifest.json`, queue files, metrics, session
  ...
  `specs/sdk/swift/readiness/archive/<date>/connect/` and link them from
  `specs/sdk/swift/connect_workshop.md` + `status.md`.
