...
|----------|--------------|-----------|-----------|--------------|
| Quickstart | `specs/sdk/swift/index.md` | `index.ja.md` | `index.he.md` | In scope for IOS5 beta refresh; reuse Android glossary. |
| Pipeline adoption | `specs/sdk/swift/pipeline_adoption_guide.md` | `pipeline_adoption_guide.ja.md` | `pipeline_adoption_guide.he.md` | Translate after Torii staging doc lock; include retry/idempotency terms. |
| Fixture cadence brief | `specs/sdk/swift/ios2_fixture_cadence_brief.md` | `ios2_fixture_cadence_brief.ja.md` | `ios2_fixture_cadence_brief.he.md` | Share cadence table with Android fixture brief to keep terminology aligned. |
| Telemetry redaction | `specs/sdk/swift/telemetry_redaction.md` | `telemetry_redaction.ja.md` | `telemetry_redaction.he.md` | Add OTLP attribute glossary; align with AND7 redaction plan. |
| Support playbook | `specs/sdk/swift/support_playbook.md` | `support_playbook.ja.md` | `support_playbook.he.md` | Include SLA appendix once IOS8 support policy lands. |
...
- **Evidence:** store request files and CI status snapshots under
  `specs/sdk/swift/readiness/archive/i18n/` for auditability.
