...
- [x] Update `specs/connect_architecture_strawman.md` with accepted answers.
...
- 📄 Summary + distribution steps live in `specs/project_tracker/connect_architecture_pre_read.md`; include the link in the Feb 2026 workshop invite and in the `#sdk-council` reminder.
