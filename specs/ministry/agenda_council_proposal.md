...
cargo xtask ministry-agenda validate \
  ...
  --registry fixtures/documentation/ministry/agenda_duplicate_registry.json
```
...
cargo xtask ministry-agenda sortition \
  --roster fixtures/documentation/ministry/agenda_council_roster.json \
  --slots 3 \
...
- `--roster` — JSON file describing every eligible member:
  ...
  `fixtures/documentation/ministry/agenda_council_roster.json`. Optional fields (role,
...
`fixtures/documentation/ministry/agenda_sortition_summary_example.json`. Key fields:
...
- `fixtures/documentation/ministry/agenda_proposal_example.json` — canonical,
  lint-clean proposal payload with two evidence attachments.
- `fixtures/documentation/ministry/agenda_duplicate_registry.json` — starter registry
