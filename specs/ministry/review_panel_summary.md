...
cargo xtask ministry-panel synthesize \
  --proposal fixtures/documentation/ministry/agenda_proposal_example.json \
  --volunteer fixtures/documentation/ministry/volunteer_brief_template.json \
  --ai-manifest fixtures/documentation/ai_moderation_calibration_manifest_202602.json \
...
2. `--volunteer` – JSON array of volunteer briefs that follow `specs/ministry/volunteer_brief_template.md`. Off-topic entries are ignored automatically.
