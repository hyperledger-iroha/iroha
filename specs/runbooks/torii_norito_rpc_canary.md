...
- [`specs/torii/nrpc_spec.md`](../torii/nrpc_spec.md) (protocol contract)
- [`specs/torii/norito_rpc_rollout_plan.md`](../torii/norito_rpc_rollout_plan.md)
- [`specs/torii/norito_rpc_telemetry.md`](../torii/norito_rpc_telemetry.md)
...
1. **Spec freeze confirmed.** Ensure `specs/torii/nrpc_spec.md` hash matches the
...
3. **Smoke tests.**
   ...
   - Record hashes inside `specs/torii/norito_rpc_stage_reports.md`.
4. **Observe telemetry.**
...
6. **Evidence capture.**
   - Update `specs/torii/norito_rpc_stage_reports.md` with:
     - Config digest
...
`specs/status/norito_rpc_canary_log.md` (if present).
...
6. File a post-mortem stub under `specs/postmortems/norito_rpc_rollback.md`
...
1. Update `specs/torii/norito_rpc_stage_reports.md` with the GA recommendation.
