...
- Archive the `iroha app sorafs fetch --json-out <path>` report as deployment evidence. A committed Buildkite merge gate is not present in this checkout; use `specs/sorafs_ci_templates.md` as the template when wiring one.
