...
[`specs/sorafs/chunker_profile_authoring.md`](sorafs/chunker_profile_authoring.md)):
...
4. Once the envelope lands, the registry crate ships the new descriptor, docs
   update `specs/sorafs/chunker_registry.md`, and the CLI/gateway tooling
...
`specs/sorafs/migration_ledger.md` so SDK and operator teams can subscribe
...
- Keep `specs/sorafs/migration_roadmap.md` and the migration ledger
