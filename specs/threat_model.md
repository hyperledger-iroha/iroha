...
| --- | --- | --- | --- | --- |
| Upgrade SBOM provenance gap | Closed | Runtime admission enforces SBOM/SLSA provenance policy and trusted signer thresholds (see `specs/runtime_upgrades.md`). | Security WG | 2025-11-30 |
