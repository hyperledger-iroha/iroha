...
| Torii spec review (IOS2) | Torii Platform TL | Scheduled | Session locked for 2026-11-21 (agenda/invite in `specs/sdk/swift/torii_spec_review.md`) to freeze `/v1/pipeline` + Norito RPC behaviour for IOS2. |
...
- Risk tracker: `specs/sdk/swift/connect_risk_tracker.md`
...
```bash
export SWIFT_STATUS_ARCHIVE_DIR=specs/status
