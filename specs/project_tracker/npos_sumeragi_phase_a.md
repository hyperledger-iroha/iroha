...
> Historical pre-release planning record. The consensus-VRF and global-RBC
> work below was superseded before V1 by the canonical global threshold beacon
> and signed RS16 DA; neither is a supported first-release path. See
> `specs/sumeragi_v2.md` and
...
| GA-A6.3 | A6 — Tooling, Docs, and Validation | Publish operator troubleshooting guidance for deterministic cadence and finite-queue pressure. | `@operator-docs`, `@telemetry-ops` | GA-A6.1 | 2026-04-28 | Completed — `specs/telemetry.md` documents authenticated status plus transaction, ingress, and P2P queue signals. |
