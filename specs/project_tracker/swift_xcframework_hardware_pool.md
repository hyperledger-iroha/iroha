...
- Device matrix reference: `specs/swift_xcframework_device_matrix.md`
...
- [x] Validate Buildkite metadata after devices are added to the pool.  
      ...
      _Next step:_ Weekly sanity check procedure documented in `specs/references/ci_operations.md` under “Weekly XCFramework StrongBox sanity check”.
