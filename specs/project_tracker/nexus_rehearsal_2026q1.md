...
| Increase TEU headroom observability (alert tuning) | @nexus-core | 2026-05-07 | Completed | `nexus.scheduler.headroom` telemetry log + `nexus_scheduler_lane_headroom_events_total` metric document per `specs/telemetry.md`. |
| Document OTLP batch sizing knob in ops guide | @program-mgmt | 2026-04-22 | Completed | Added OTLP capture tuning guidance + collector snippet to `specs/telemetry.md`. |
...
update (`specs/nexus_transition_notes.md`, `roadmap.md`, `status.md`).
