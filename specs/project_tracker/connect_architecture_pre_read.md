...
1. **Strawman spec** — `specs/connect_architecture_strawman.md`  
...
2. **Feedback checklist** — `specs/connect_architecture_feedback.md`  
   Captures every Android/JS decision and the owners who signed off.
3. **Follow-up tracker** — `specs/project_tracker/connect_architecture_followups_ios.md`  
