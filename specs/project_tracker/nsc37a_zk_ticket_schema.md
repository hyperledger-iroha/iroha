...
- [x] Produce migration playbook (operator & governance guidance). See `specs/project_tracker/nsc37a_zk_ticket_migration_playbook.md`.
...
3. **Telemetry + alerts.**  
   ...
   - Alignment action: register all metrics in `specs/telemetry.md` under a single section
...
Outstanding NSC-37b-specific work is tracked in `specs/project_tracker/nsc37b_streaming_enforcement.md`;
