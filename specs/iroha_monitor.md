...
`specs/images/iroha_monitor_demo/`. `make check-iroha-monitor-docs`
...
The shipped snapshots live in `specs/images/iroha_monitor_demo/`:
...
`specs/images/iroha_monitor_demo/`; CI runs
