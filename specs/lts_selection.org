...
In addition to the current release procedure outlined in
[[release_dual_track_runbook.md][the dual-track release procedure]], the LTS
must adhere to the following additional steps.
