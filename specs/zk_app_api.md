...
proof_body_max_inflight = 8           # aggregate pre-parse proof/SCCP/Offline Cash body admission
proof_body_read_timeout_ms = 15000    # absolute deadline for each admitted proof/SCCP/Offline Cash body
