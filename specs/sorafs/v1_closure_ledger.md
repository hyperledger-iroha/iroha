...
records 442 promotion/signing contract tests and 30 separately executed actual
cosign cryptographic tests against unchanged observed development inputs. The
latter uses public upstream fixtures and the independently retained executable
pin. These results close no deployment, inner-approval or release goal.
