...
The architecture contract lives in `specs/sorafs_architecture_rfc.md`.
Milestone history lives in `specs/sorafs/migration_ledger.md`. Repository
...
first-release item lives in `specs/sorafs/v1_closure_ledger.md`.
...
`specs/sorafs/l1_deployment_qualification.md`. A passing result confirms
