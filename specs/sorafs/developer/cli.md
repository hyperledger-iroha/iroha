...
- `specs/sorafs_cli.md` — exhaustive flag documentation.
- `specs/sorafs_proof_streaming.md` — proof telemetry schema and Grafana
  dashboard template.
- `specs/sorafs/manifest_pipeline.md` — deep dive on chunking, manifest
