...
See `specs/sorafs_cli.md` for a detailed breakdown of flags, chunker
...
Refer to `specs/sorafs_proof_streaming.md` for the schema and dashboard
templates.

## 5. Adopt the pipeline in CI/CD

- GitHub/GitLab recipes: `fixtures/documentation/sorafs_ci.md`
- CI-focused CLI notes: `specs/sorafs_ci_templates.md`
...
- Apply the deployment checklist in `specs/sorafs/developer/deployment.md`.
- Enforce capability and policy checks using the operator guides under
  `specs/sorafs/runbooks/`.
