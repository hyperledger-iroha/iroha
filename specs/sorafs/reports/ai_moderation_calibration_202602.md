...
The full manifest lives in `fixtures/documentation/ai_moderation_calibration_manifest_202602.json`
...
complete scoreboard JSON (`fixtures/documentation/ai_moderation_calibration_scorecard_202602.json`)
...
`specs/sorafs_ai_moderation_plan.md`.
