...
[`specs/sorafs/proposals/sorafs_sf1_profile_v1.json`](proposals/sorafs_sf1_profile_v1.json)
and the accompanying dry-run log in
[`specs/sorafs/reports/sf1_determinism.md`](reports/sf1_determinism.md).
...
`specs/sorafs/proposals/`. Use
`specs/sorafs/proposals/sorafs_sf1_profile_v1.json` as the concrete
...
- Store any benchmarking artefacts (e.g., throughput comparisons) under
  `specs/sorafs/reports/` for future reference.

For operational expectations during rollout refer to the migration ledger
(`specs/sorafs/migration_ledger.md`). For runtime conformance rules see
