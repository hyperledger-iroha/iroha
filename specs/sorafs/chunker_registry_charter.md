...
> `specs/sorafs/council_minutes_2025-10-29.md`). Any amendments require a
...
(`specs/sorafs/chunker_profile_authoring.md`) by defining the governance
...
- Store determinism reports in `specs/sorafs/reports/`.
- Council minutes referencing chunker decisions live under
  `specs/sorafs/migration_ledger.md`.
- Update `roadmap.md` and `status.md` after each major registry change.

## References

- Authoring guide: `specs/sorafs/chunker_profile_authoring.md`
- Conformance checklist: `specs/sorafs/chunker_conformance.md`
- Registry reference: `specs/sorafs/chunker_registry.md`
