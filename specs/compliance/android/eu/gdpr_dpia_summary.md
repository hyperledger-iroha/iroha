...
| Reference Docs | `specs/sdk/android/telemetry_redaction.md`, `specs/android_support_playbook.md`, `specs/android_runbook.md` |
...
| Override misuse leaking PII | Very Low | High | Norito override requests logged, expire within 24h, require SRE approval (`specs/android_runbook.md` §3). |
...
1. **Quarterly review:** Validate telemetry schemas, salt rotations, and override logs; document in `specs/sdk/android/telemetry_redaction_minutes_YYYYMMDD.md`.
