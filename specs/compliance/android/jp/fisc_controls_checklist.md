...
| **Cryptographic key management** | Rotation and software-backed custody provide the baseline control. Caller-selected StrongBox providers, attestation validation, and device-matrix coverage add optional hardware evidence without becoming a build, release, or deployment prerequisite. | `specs/sdk/android/key_management.md`; `specs/sdk/android/readiness/android_strongbox_device_matrix.md`; `scripts/android_strongbox_attestation_ci.sh`. | ✅ Implemented |
