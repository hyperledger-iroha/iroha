...
|----------|------|----------|-----------------|--------|
| DR-2026-02-Q1 | 2026-02-20 | Simulated Pixel 8 Pro lane outage + attestation backlog with AND7 telemetry rehearsal | `artifacts/android/device_lab_contingency/20260220-failover-drill/` | ✅ Completed — bundle hashes recorded in `specs/compliance/android/evidence_log.csv`. |
...
1. Confirm baseline capacity in `specs/sdk/android/android_strongbox_capture_status.md`.
...
3. Append the final row to `device_lab_contingency.md` with trigger, actions,
   and follow-ups.
4. Update `specs/compliance/android/evidence_log.csv` with:
