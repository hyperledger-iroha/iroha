...
- **Parity feed** — JSON document matching `specs/references/ios_metrics.md`
...
`specs/sdk/swift/reproducibility_checklist.md` and
`specs/sdk/swift/support_playbook.md`, hashing each file, recording the
