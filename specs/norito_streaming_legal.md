...
3. Update `specs/norito_streaming.md` (§7.7 & §19) with any jurisdictional changes.
...
- NSC‑42 Legal Brief: `specs/project_tracker/nsc42_codec_legal_brief.md`
- NSC‑55 Validation Plan: `specs/project_tracker/nsc55_rans_validation_plan.md`
- Norito Streaming Overview: `specs/norito_streaming.md`
