...
- Latest `sorafs_orchestrator` binary with capability-weighting (commit ≥ the
  drill reference shown in `specs/soranet/reports/pq_ratchet_validation.md`).
...
- **Incident Log**: Append the captured telemetry snippets and operator notes to `fixtures/documentation/soranet_pq_ratchet_fire_drill.log`.
