...
The seed OpenAPI document lives at `specs/soranet/control_plane_openapi.yaml`
and defines:
...
`specs/soranet/control_plane_rbac.yaml` lists scopes, roles, and audit
expectations:
...
fixtures. CLI docs will live under `specs/soranet/control_plane_cli.md`
...
3. Publish UI wireframes and accessibility checklist for the console
   ...
   `specs/soranet/control_plane_console.md`.
