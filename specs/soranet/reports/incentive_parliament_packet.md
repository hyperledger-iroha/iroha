...
- `fixtures/documentation/soranet_incentive_parliament_packet/reward_config.json` -
...
- `fixtures/documentation/soranet_incentive_parliament_packet/shadow_daemon.json` -
  beneficiary + bond mapping consumed by both the replay harness and the
  production payout daemon.
- `fixtures/documentation/soranet_incentive_parliament_packet/economic_analysis.md` -
  fair-distribution analysis for the 2025-10 -> 2025-11 shadow simulation.
- `fixtures/documentation/soranet_incentive_parliament_packet/rollback_plan.md` -
  operational rollback playbook for suspending automatic payouts.
- `fixtures/documentation/soranet_incentive_parliament_packet/README.md` -
  quick-start guide for auditors, including checksum instructions.
- Signed shadow-run report:
  `fixtures/documentation/soranet_incentive_shadow_run.{json,pub,sig}` (detailed in
  `specs/soranet/reports/incentive_shadow_run.md`).
...
3. **Config sanity** - run
   `iroha app sorafs incentives service init --state /tmp/incentives-test.json --config fixtures/documentation/soranet_incentive_parliament_packet/reward_config.json --treasury-account <i105-account-id> --force`
...
- Ship a fresh 60-day replay and update the economic analysis before requesting
  renewed approval.
- Archive superseded packets under `fixtures/documentation/soranet_incentive_parliament_packet/`
