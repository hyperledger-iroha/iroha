...
2. Publish dashboards + SLOs for the incentives pipeline and run dry-runs on the staging network.
   ...
   with signed artefacts for Parliament review.【specs/soranet/reports/incentive_shadow_run.md:1】
3. Secure Sora Parliament approval for the bonding/payout parameters and migrate the configuration
   ...
   until Parliament issues a new digest; rollback keeps using the null hash to halt automation.【crates/sorafs_orchestrator/src/incentives.rs:51】【fixtures/documentation/soranet_incentive_parliament_packet/rollback_plan.md:1】【specs/soranet/reports/incentive_parliament_packet.md:1】
