...
- **Evidence bundle:** See
  `specs/sorafs_gateway_dns_design_runbook.md` section 9 and
...
- Trustless HTTP profile alignment stays in
  `specs/sorafs_gateway_profile.md`, covering CAR streams, refusal
  semantics, and telemetry headers.
- Direct-mode operation follows
  `specs/sorafs_gateway_direct_mode.md` while SoraNet defaults ramp.
...
- Deployment automation is documented in
  `specs/sorafs_gateway_deployment_handbook.md` and the TLS/ECH operator
...
Reference implementation plan: `specs/sorafs_gateway_conformance.md`.
...
- `specs/sorafs_gateway_profile.md`
- `specs/sorafs_gateway_conformance.md`
- `specs/sorafs_gateway_direct_mode.md`
- `specs/sorafs_gateway_deployment_handbook.md`
- `specs/sorafs_gateway_tls_automation.md`
- `specs/sorafs_gateway_dns_design_runbook.md`
- `specs/sorafs_gateway_dns_design_minutes.md`
...
- Use `specs/sorafs_gateway_dns_design_runbook.md` for rehearsal,
