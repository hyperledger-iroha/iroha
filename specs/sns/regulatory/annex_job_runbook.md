...
`specs/sns/regulatory/annex_jobs.json`, how to execute
...
3. If you prefer a manual edit, append entries to
   ...
   EU DSA memo skeleton (`specs/sns/regulatory/eu-dsa/<cycle>.md`) with
...
1. Attach the generated artefacts (`artifacts/sns/regulatory/...`) to the
   governance ticket.
2. Update `specs/sns/onboarding_kit.md` (Section 1.3) if the cadence or
   annex scope changes.
