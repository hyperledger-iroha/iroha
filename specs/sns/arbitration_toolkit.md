...
`fixtures/documentation/sns/arbitration_case_schema.json`; the publication outline is
`fixtures/documentation/sns/arbitration_transparency_report_template.md`. They support
