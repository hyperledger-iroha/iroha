...
- Reconciliation template: `fixtures/documentation/soranet_gateway_billing/reconciliation_report_template.md`
...
5. Fill in `billing_reconciliation_report.md` (or start from the template in
   `fixtures/documentation/soranet_gateway_billing/reconciliation_report_template.md`)
