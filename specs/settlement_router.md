...
mirroring the summary described in `specs/nexus_fee_model.md`.
...
- Keep swapline bring-up/unwind evidence under
  ...
  `specs/settlement_swapline_runbook.md`.
...
4. **Swap-line health** - Ensure outstanding swaps respect the configured limit
   ...
   unwind bundles per `specs/settlement_swapline_runbook.md`.
