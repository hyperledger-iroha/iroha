...
- **Related runbook:** `specs/sorafs_gateway_dns_design_runbook.md`
...
4. **TLS/ECH hand-off:** SF-5b TLS/ECH automation is handled by
   `specs/sorafs_gateway_tls_automation.md`; gateways capture evidence
...
- Runbook snapshot: `specs/sorafs_gateway_dns_design_runbook.md` section
  9 records the 2025-03-02 mock run.
- GAR telemetry appendix:
  `specs/sorafs_gateway_dns_design_gar_telemetry.md`.
- Attendance and owner register:
  `specs/sorafs_gateway_dns_design_attendance.md`.
- TLS/ECH operator hand-off:
  `specs/sorafs_gateway_tls_automation.md`.
- Conformance plan: `specs/sorafs_gateway_conformance.md`.
...
`specs/sorafs_gateway_dns_design_pre_read.md`, but its body is now an
