...
|---------|-------------|-------|
| Rust data-model | `crates/iroha_data_model/tests/account_address_vectors.rs` | Canonical Rust host verifier: parses strict I105, re-encodes the fixture prefix, validates multisig material, and checks canonical-hex conversions plus structured errors. |
| Torii routes | `crates/iroha_torii/tests/address_parsing.rs` | Exercises actual Axum/Torii account path and query consumers, accepted I105, malformed/public-key/selector-prefixed rejection, and invalid-address metrics. |
