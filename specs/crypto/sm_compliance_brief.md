...
This brief supplements the architecture notes in `specs/crypto/sm_program.md`
...
Templates live under `specs/crypto/attachments/` for easy inclusion in
...
## Standards & Citations
- **GM/T 0002-2012 / GB/T 32907-2016** — SM4 block cipher and AEAD parameters (ECB/GCM/CCM). Matches the vectors captured in `specs/crypto/sm_vectors.md`.
