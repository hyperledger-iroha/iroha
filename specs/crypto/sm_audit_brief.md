...
- `specs/crypto/sm_program.md` — programme history, dependency audit, and
  rollout guardrails.
- `specs/crypto/sm_operator_rollout.md` — operator-facing enablement and
  rollback procedures.
- `specs/crypto/sm_compliance_brief.md` — regulatory summary and export
  considerations.
...
- `specs/crypto/sm_program.md`
- `specs/crypto/sm_operator_rollout.md`
- `specs/crypto/sm_compliance_brief.md`
- `specs/crypto/sm_lock_refresh_plan.md`
...
| NCC Group APAC | Hardware/SOC + Rust cryptography red teams, published reviews of RustCrypto primitives and payment cryptography bridges. | Holistic assessment of Rust + JNI/FFI bindings, deterministic policy validation, perf/telemetry gate review, operator playbook walkthrough. | Reserved as contingency; can also provide bilingual reporting for Chinese regulators. |
