...
1. **Raise request in Crypto WG + Release Eng sync (owner: @crypto-wg lead).**
   - Reference `specs/crypto/sm_program.md` and note the optional nature of the feature.
...
5. **Follow-up tasks.**
   - Update `specs/crypto/sm_program.md` action item checklist.
...
| Update SM program doc checklist | After merge | Crypto WG lead | ✅ Addressed via `specs/crypto/sm_program.md` entry (2026-02-12) |
