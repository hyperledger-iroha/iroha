...
alongside the configuration brief in `specs/crypto/sm_program.md` and the
legal/export guidance in `specs/crypto/sm_compliance_brief.md`.
...
- **Verify-only readiness (SM-RR1).** Convene Release Eng, Crypto WG, Ops, and Legal. Require:
  ...
  - `specs/crypto/sm_program.md` / `sm_compliance_brief.md` / this checklist updated within the last release window.
