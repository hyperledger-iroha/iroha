...
- `specs/android_support_playbook.md` — release calendar, SLAs, and
  escalation tree.
...
- Follow `specs/compliance/android/and6_compliance_checklist.md` for EU
  and JP submissions. Update `specs/compliance/android/evidence_log.csv`
