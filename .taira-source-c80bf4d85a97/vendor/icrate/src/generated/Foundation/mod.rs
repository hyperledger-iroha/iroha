...
// NOTE: Generated NS* error codes remain available through
// `__FoundationErrors::__anonymous__::CONST_NAME`.
...
// NOTE: NSURL error codes remain available through
// `__NSURLError::__anonymous__::CONST_NAME`.
