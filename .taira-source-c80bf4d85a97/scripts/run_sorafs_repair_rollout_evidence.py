...
PLAN_SCHEMA = "sorafs.repair.rollout_evidence_collection_plan.v1"
...
def validate_plan_json(
    ...
    """Validate the repair collection-plan envelope before use."""

    return validate_runner_evidence_plan(
        rendered,
        plan,
        diagnostic_prefix="repair rollout runner plan",
