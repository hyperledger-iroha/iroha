...
public static class SccpV1
{
    ...
    {
        if (anchor.ProtocolVersion != 3 || anchor.CheckpointHeight == 0)
        {
            throw new ArgumentException("SCCP finality anchor must bind protocol version 3 and a nonzero height.");
        }
        foreach (var (value, name) in new[]
        {
