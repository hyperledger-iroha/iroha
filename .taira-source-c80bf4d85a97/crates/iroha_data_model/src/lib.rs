...
pub mod asset;
/// Exact bounded native asset-transfer capabilities.
...
pub mod prelude {
    ...
    pub use iroha_primitives::{
        ...
        numeric_abi::{
            ...
            NUMERIC_FRAME_HEADER_BYTES_V1, NUMERIC_POINTER_ENVELOPE_OVERHEAD_V1,
            QUANTITY_SCHEMA_HASH_V1, QUANTITY_SCHEMA_NAME_V1,
        },
    };
