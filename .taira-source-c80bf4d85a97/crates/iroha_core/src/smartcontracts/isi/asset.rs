...
pub mod query {
    ...
    mod tests {
        ...
        fn transfer_restricted_asset_rejects_ambiguous_source_dataspace_binding() {
            ...
            let uaid_bob = iroha_data_model::nexus::UniversalAccountId::from_hash(
                iroha_crypto::Hash::new(b"uaid::bob-ambiguous-source"),
            );
