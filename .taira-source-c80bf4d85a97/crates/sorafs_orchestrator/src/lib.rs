...
pub mod prelude {
    ...
    pub use crate::{
        ...
        appeals::{
            ...
            AppealPricingError, AppealQuantityParseError, AppealQuote, AppealQuoteBreakdown,
            AppealQuoteInput, AppealSettlementBreakdown, AppealSettlementConfig,
            AppealSettlementError, AppealUrgency, AppealVerdict, AppealVerdictParseError,
            JurorPayout, parse_appeal_quantity_literal,
        },
