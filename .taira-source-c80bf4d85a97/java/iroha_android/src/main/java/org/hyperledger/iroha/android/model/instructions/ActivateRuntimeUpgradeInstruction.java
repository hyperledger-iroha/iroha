...
/** Typed builder for {@code ActivateRuntimeUpgrade} instructions. */
public final class ActivateRuntimeUpgradeInstruction implements InstructionTemplate {

  public static final String ACTION = "ActivateRuntimeUpgrade";
  private static final String ID_HEX = "id_hex";

  private final String idHex;
  private final Map<String, String> arguments;

  private ActivateRuntimeUpgradeInstruction(final Builder builder) {
    this(builder, builder.canonicalArguments());
  }

  private ActivateRuntimeUpgradeInstruction(
  ...
  public static ActivateRuntimeUpgradeInstruction fromArguments(
    ...
    return new ActivateRuntimeUpgradeInstruction(builder, new LinkedHashMap<>(arguments));
  }
  ...
  public boolean equals(final Object obj) {
    ...
    if (!(obj instanceof ActivateRuntimeUpgradeInstruction other)) {
      return false;
    }
  ...
  public static final class Builder {
    ...
    public ActivateRuntimeUpgradeInstruction build() {
      if (idHex == null || idHex.isBlank()) {
        throw new IllegalStateException("idHex must be provided");
      }
      return new ActivateRuntimeUpgradeInstruction(this);
    }
