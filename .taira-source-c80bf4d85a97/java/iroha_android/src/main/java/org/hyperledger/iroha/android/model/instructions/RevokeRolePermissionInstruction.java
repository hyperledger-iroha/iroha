...
public final class RevokeRolePermissionInstruction implements InstructionTemplate {

  private static final String ACTION = "RevokeRolePermission";
  ...
  private RevokeRolePermissionInstruction(final Builder builder) {
    this(builder, builder.canonicalArguments());
  }

  private RevokeRolePermissionInstruction(
  ...
  public static RevokeRolePermissionInstruction fromArguments(final Map<String, String> arguments) {
    ...
    return new RevokeRolePermissionInstruction(builder, new LinkedHashMap<>(arguments));
  }
  ...
  public boolean equals(final Object obj) {
    ...
    if (!(obj instanceof RevokeRolePermissionInstruction other)) {
      return false;
    }
  ...
  public static final class Builder {
    ...
    public RevokeRolePermissionInstruction build() {
      ...
      return new RevokeRolePermissionInstruction(this);
    }
