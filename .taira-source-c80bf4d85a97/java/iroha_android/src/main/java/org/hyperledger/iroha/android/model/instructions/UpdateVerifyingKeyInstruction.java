...
/** Typed builder for {@code UpdateVerifyingKey} instructions. */
public final class UpdateVerifyingKeyInstruction implements InstructionTemplate {

  private static final String ACTION = "UpdateVerifyingKey";
  ...
  private UpdateVerifyingKeyInstruction(final Builder builder, final Map<String, String> args) {
  ...
  public boolean equals(final Object obj) {
    ...
    if (!(obj instanceof UpdateVerifyingKeyInstruction other)) {
      return false;
    }
  ...
  public static final class Builder {
    ...
    public UpdateVerifyingKeyInstruction build() {
      if (backend == null) {
      ...
      return new UpdateVerifyingKeyInstruction(this, args);
    }
  }
}
