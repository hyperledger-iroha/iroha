...
## Iroha Connect Client жишээнүүд (TypeScript болон Kotlin)

Энэ баримт бичиг нь v0 дүрмийг хэрэгжүүлдэг үйлчлүүлэгчийн хамгийн бага хэсгийг харуулж байна:
- AEAD AAD нь гадна талын толгой хэсгийг холбодог (хувилбар, sid, dir, seq, төрөл=Шифр текст).
- `seq` (12 байт IETF бус: 0x00000000 || seq_le)-ээс үүсээгүй.
- Зөвшөөрөгдсөний дараа хяналтын хүрээ (Хаах/Татгалзах) шифрлэгдсэнээр илгээгдсэн.

Эдгээр нь тайлбар юм; хатууруулах/үйлдвэрлэлийн шалгалтыг орхигдуулсан.

### TypeScript (libsodium + WebCrypto)

Хамаарал: `libsodium-wrappers` (X25519, BLAKE2b, ChaCha20‑Poly1305), WebCrypto (HKDF‑SHA‑256).
...
Тэмдэглэл:
- Үйлчлүүлэгч нэг удаагийн жетон авахын тулд `sid` (32 байт; base64url/hex) тооцоолж, `/v1/connect/session` руу POST хийнэ; сервер `sid` цуурайтаж байна. `Authorization: Bearer <token>` эсвэл `Sec-WebSocket-Protocol: iroha-connect.token.v1.<base64url(token)>` ашиглан WS-д нэгдээрэй.
- Түлхүүрүүд байгаа бол (Батлах) шифрлэгдсэн ачааллаар Хаах/Татгалзах илгээнэ үү.
- Dedupe түлхүүрүүд болон `seq` нь апп/түрийвчний хүрээнүүдийн хувьд нэг чиглэлтэй байх ёстой; `Envelope.seq == frame.seq`. Серверийн үйл явдлууд нь тусдаа сервер талын дарааллыг ашигладаг бөгөөд AEAD/dedupe-ээс хасагдсан.