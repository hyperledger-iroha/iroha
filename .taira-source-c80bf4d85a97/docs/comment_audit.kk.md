...
# Түсініктеме аудиті жазбалары

Келесі IVM модульдерін тексеріп, олардың кірістірілген/құжаттар түсініктемелерінің ағымдағы әрекетке сәйкестігін растады (кодты өңдеу қажет емес):
...
Қосымша түсініктеме жаңартулары қажет болса, қалған жұмыс кеңістігінің жәшіктері әлі де рұқсатты қажет етеді.