...
(МИЗАН). Ҡайҙа документация йәки ориентирҙар retired codec менән сағыштырырға, ул тик өсөн генә .
...
һөҙөмтәлелеге — ул Norito, retired codec түгел.
...
- Сым форматы I18NT000000010X, retired codec түгел. Яланғас вариант өсөн `norito::codec::{Encode,Decode}` API-лар ҡулланыла.