...
# Docs Portal Preview მოწვევა (თარგი)

გამოიყენეთ ეს შაბლონი რეცენზენტებისთვის გადახედვისას წვდომის ინსტრუქციების გაგზავნისას. ჩანაცვლება
ჩანაცვლების ველები (`<...>`) შესაბამისი მნიშვნელობებით, დაურთეთ აღმწერი +
დაარქივეთ არტეფაქტები, რომლებიც მითითებულია შეტყობინებაში და შეინახეთ საბოლოო ტექსტი შიგნით
შესაბამისი ბილეთი.
