...
# Hujjatlar portalini oldindan koʻrish taklifi (shablon)

Ko'rib chiquvchilarga oldindan ko'rishga kirish ko'rsatmalarini yuborishda ushbu shablondan foydalaning. O'zgartiring
tegishli qiymatlar bilan to'ldirgichlar (`<...>`), deskriptorni ilova qiling +
xabarda havola qilingan artefaktlarni arxivlang va yakuniy matnni ichida saqlang
tegishli qabul chiptasi.
