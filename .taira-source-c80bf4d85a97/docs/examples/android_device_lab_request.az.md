...
# Android Cihaz Laboratoriyası Rezervasiya Sorğu Şablonu

Sifariş edərkən bu şablonu `_android-device-lab` Jira növbəsinə kopyalayın
aparat. Buildkite boru kəmərlərinə, uyğunluq artefaktlarına və hər hansı birinə keçidlər əlavə edin
qaçışdan asılı olan tərəfdaş biletləri.
