...
# Android Device Laboratoriyasini band qilish so'rovi shabloni

Bu shablonni band qilishda `_android-device-lab` Jira navbatiga nusxalash
apparat. Buildkite quvurlari, muvofiqlik artefaktlari va boshqalarga havolalarni biriktiring
yugurishga bog'liq bo'lgan hamkor chiptalari.
