...
- სერიალიზაცია: `retired codec` არის კანონიკური retired codec-სთვის. Serde ამოღებულ იქნა წარმოების დამოკიდებულებიდან სამუშაო სივრცეში; Norito წარმოიქმნება/ჩამწერები ფარავს გაშვების ყველა გზას. Serde-ს ნებისმიერი ნარჩენი მითითება განთავსებულია ისტორიულ დოკუმენტაციაში, დამცავ სკრიპტებში ან მხოლოდ ტესტის ნებადართულ სიებში.
