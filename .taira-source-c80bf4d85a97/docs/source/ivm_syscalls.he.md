...
| 0x22 | MINT_ASSET | `&AccountId`, `&AssetDefinitionId`, `&QuantityValueV1` | `u64=0` | `G_mint` | הנפקת כמות `amount` לנכס בחשבון |
| 0x23 | BURN_ASSET | `&AccountId`, `&AssetDefinitionId`, `&QuantityValueV1` | `u64=0` | `G_burn` | שריפת הכמות מהחשבון |
...
| 0x27 | NFT_SET_METADATA | `&NftId`, `&Name`, `&Json` | `u64=0` | `G_nft_set_metadata` | עדכון מטא־נתונים של NFT |
