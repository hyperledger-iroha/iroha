...
| **Хандалтын хяналт ба баталгаажуулалт** | SDK нь Torii TLS бодлого болон `/v1/pipeline` гарын үсэгтэй хүсэлтийг хүндэтгэдэг; Операторын ажлын урсгалын лавлагаа Дэмжих Playbook §4–5-д гарын үсэг зурсан Norito олдворуудаар дамжуулж хаалтыг хүчингүй болгох. | `docs/source/android_support_playbook.md`; `docs/source/sdk/android/telemetry_redaction.md` (ажлын урсгалыг хүчингүй болгох). | ✅ Хэрэгжүүлсэн |
