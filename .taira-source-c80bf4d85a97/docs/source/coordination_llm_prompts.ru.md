...
# Подсказки по координации LLM

## Цель

Эти шаблоны подсказок помогают инженерам быстро получить разъяснения от @mtakemiya.
когда пункты дорожной карты оставляют открытые вопросы. Скопируйте один из разделов ниже в файл
LLM, замените заполнители в квадратных скобках и включите соответствующий файл или
ссылки на строки, поэтому контекст остается привязанным.

## Архитектурные или дизайнерские решения
...
## Конфигурация или руководство для оператора
...
## Криптография или примитивы протоколов
...
## Разработка выпуска или процесс
