...
| ༠x༢༢ | MINT_ASSET | `&AccountId`, `&AssetDefinitionId`, `&QuantityValueV1`, `u64=0` | `G_mint` | རྩིས་ཁྲ་ `amount` རྩིས་ཁྲའི་རྒྱུ་དངོས་ |
| ༠x༢༣ | BURN_ASSET | `&AccountId`, Norito, `&QuantityValueV1` | `u64=0` | `G_burn` | རྩིས་ཁྲ་ནང་ལས་ `amount` འདི་ |
