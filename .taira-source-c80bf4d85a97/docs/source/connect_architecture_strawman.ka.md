...
- დამტკიცების ჩარჩოები მოიცავს არჩეულ ანგარიშს/კონტროლერს, ნებართვის ექოს, მტკიცებულების პაკეტს (ZK მტკიცებულება ან ატესტაცია) და პოლიტიკის ნებისმიერ გადართვას (მაგ., `deferred_queue_enabled`).
...
- როდესაც აპლიკაცია გადართავს `deferred_queue_enabled=false`-ს, SDK-ები დაუყოვნებლივ იშლება და
