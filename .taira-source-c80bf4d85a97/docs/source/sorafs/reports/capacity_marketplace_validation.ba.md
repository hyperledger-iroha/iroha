...
Operators should regenerate onboarding/dispute request payloads with `sorafs_manifest_builder capacity {declaration,dispute}` and archive the resulting JSON/Norito bytes alongside the governance ticket.
