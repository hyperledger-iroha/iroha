...
- منظوری کے فریموں میں منتخب کردہ اکاؤنٹ/کنٹرولر ، اجازت کی بازگشت ، پروف بنڈل (زیڈ کے پروف یا تصدیق) ، اور کسی بھی پالیسی ٹوگل (جیسے ، `deferred_queue_enabled`) شامل ہیں۔
...
- جب ایک ایپ `deferred_queue_enabled=false` کو ٹوگل کرتی ہے تو ، SDKS فوری طور پر نالی اور
