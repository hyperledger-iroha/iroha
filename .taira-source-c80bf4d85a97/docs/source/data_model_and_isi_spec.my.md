...
ID များတွင် `Display`/`FromStr` ဖြင့် အသွားအပြန် တည်ငြိမ်သော စာကြောင်းပုံစံများ ရှိသည်။ အမည်စည်းမျဉ်းများသည် နေရာလွတ်နှင့် သီးသန့် `@ # $` စာလုံးများကို တားမြစ်ထားသည်။- `Name` — တရားဝင်အတည်ပြုထားသော စာသားအမှတ်အသား။ စည်းမျဉ်းများ- `crates/iroha_data_model/src/name.rs`။
- `DomainId` — `name`။ ဒိုမိန်း- `{ id, logo, metadata, owned_by }`။ တည်ဆောက်သူများ- `NewDomain`။ ကုဒ်- `crates/iroha_data_model/src/domain.rs`။
- `AccountId` — `AccountAddress` မှတစ်ဆင့် I105 နှင့် Torii သည် `AccountAddress::parse_encoded` မှတစ်ဆင့် သွင်းအားများကို ပုံမှန်ဖြစ်စေသည်အဖြစ် `AccountAddress` ကို ထုတ်လုပ်သည်။ တင်းကျပ်သော runtime ပိုင်းခြားစိတ်ဖြာမှုသည် canonical I105 ကိုသာလက်ခံသည်။ ကွင်းဆက်အကောင့်နာမည်တူများသည် `name@domain.dataspace` သို့မဟုတ် `name@dataspace` ကိုအသုံးပြုပြီး canonical `AccountId` တန်ဖိုးများကို ဖြေရှင်းပါ။ ၎င်းတို့ကို တင်းကျပ်သော `AccountId` ခွဲခြမ်းစိတ်ဖြာသူများမှ လက်မခံပါ။ အကောင့်- `{ id, metadata }`။ ကုဒ်- `crates/iroha_data_model/src/account.rs`။- အကောင့်ဝင်ခွင့်မူဝါဒ — ဒိုမိန်းများသည် မက်တာဒေတာကီး `iroha:account_admission_policy` အောက်တွင် Norito-JSON `AccountAdmissionPolicy` ကို သိမ်းဆည်းခြင်းဖြင့် သွယ်ဝိုက်သောအကောင့်ဖန်တီးမှုကို ထိန်းချုပ်ပါသည်။ သော့မရှိသည့်အခါ၊ ကွင်းဆက်အဆင့် စိတ်ကြိုက် ကန့်သတ်ဘောင် `iroha:default_account_admission_policy` သည် ပုံသေကို ပေးသည်။ ၎င်းသည်လည်းမရှိသည့်အခါ၊ hard default သည် `ImplicitReceive` (ပထမထုတ်ခြင်း) ဖြစ်သည်။ မူဝါဒသည် `mode` (`ExplicitOnly` သို့မဟုတ် `ImplicitReceive`) နှင့် ရွေးချယ်နိုင်သော ငွေပေးချေမှုတစ်ခုခြင်း (မူလ `16`) နှင့် ပိတ်ဆို့ဖန်တီးမှုစာထုပ်များ၊ ချန်လှပ်ထားသော Norito per-sin50x (အကောင့် per-block 10N0X) (180NI) ပိုင်ဆိုင်မှု အဓိပ္ပါယ်ဖွင့်ဆိုချက်နှင့် ရွေးချယ်နိုင်သော `default_role_on_create` (`AccountCreated` ပြီးနောက် ခွင့်ပြုထားသော၊ ပျောက်ဆုံးပါက `DefaultRoleError` ဖြင့် ငြင်းပယ်သည်)။ ကမ္ဘာဦးကျမ်းတွင် မပါဝင်နိုင်ပါ။ `InstructionExecutionError::AccountAdmission` ပါ အမည်မသိအကောင့်များအတွက် ပြေစာပုံစံ ညွှန်ကြားချက်များကို ပိတ်ထားသည်/မမှန်ကန်သော မူဝါဒများကို ငြင်းပယ်ပါ။ `AccountCreated` မတိုင်ခင် `iroha:created_via="implicit"`၊ မူရင်းအခန်းကဏ္ဍများသည် နောက်ဆက်တွဲ `AccountRoleGranted` ကို ထုတ်လွှတ်ပြီး ပိုင်ရှင်-အခြေခံစည်းမျဉ်းများသည် အကောင့်အသစ်အား အပိုအခန်းကဏ္ဍများမပါဘဲ ၎င်း၏ကိုယ်ပိုင်ပိုင်ဆိုင်မှု/NFT များကို သုံးစွဲခွင့်ပေးသည်။ Code: `crates/iroha_data_model/src/account/admission.rs`, `crates/iroha_core/src/smartcontracts/isi/account_admission.rs`။- `AssetDefinitionId` — canonical asset-definition bytes များပေါ်တွင် canonical unprefixed Base58 လိပ်စာ။ ဤသည်မှာ အများသူငှာ ပိုင်ဆိုင်မှု ID ဖြစ်သည်။ အဓိပ္ပါယ်- `{ id, name, description?, alias?, spec: NumericSpec, mintable: Mintable, logo, metadata, owned_by, total_quantity }`။ `alias` စာသားများသည် `<name>#<domain>.<dataspace>` သို့မဟုတ် `<name>#<dataspace>` ဖြစ်ရမည်၊ `<name>` သည် ပိုင်ဆိုင်မှု အဓိပ္ပါယ်ဖွင့်ဆိုချက်အမည်နှင့် ညီမျှပြီး ၎င်းတို့သည် အရင်းခံ Base58 ပိုင်ဆိုင်မှု ID သို့သာ ဖြေရှင်းပါသည်။ ကုဒ်- `crates/iroha_data_model/src/asset/definition.rs`။
  - Alias ​​ငှားရမ်းမှု မက်တာဒေတာကို သိမ်းဆည်းထားသည့် ပိုင်ဆိုင်မှု-အဓိပ္ပါယ်ဖွင့်ဆိုချက်အတန်းမှ သီးခြားဆက်လက်တည်ရှိနေပါသည်။ Core/Torii သည် `alias` ကို အဓိပ္ပါယ်ဖွင့်ဆိုချက်များဖတ်သောအခါ binding record မှ ရုပ်လုံးပေါ်လာသည်။
  - Torii ပိုင်ဆိုင်မှု-အဓိပ္ပါယ်ဖွင့်ဆိုချက်များသည် `alias_binding { alias, status, lease_expiry_ms, grace_until_ms, bound_at_ms }` ကို ဖော်ထုတ်ပြီး၊ `status` သည် `permanent`၊ `leased_active`၊ Iroha၊ သို့မဟုတ် Norito
  - Alias ​​ရွေးချယ်သူများသည် နောက်ဆုံးသတ်မှတ်ထားသော ပိတ်ဆို့ဖန်တီးမှုအချိန်ကို ဆန့်ကျင်သည်။ `grace_until_ms` ပြီးနောက်၊ နောက်ခံပုံသဏ္ဍာန်ကို မဖယ်ရှားရသေးသည့်တိုင် alias ရွေးပေးသည့်ကိရိယာများသည် ဖြေရှင်းမှုရပ်သွားပါသည်။ တိုက်ရိုက်အဓိပ္ပါယ်ဖွင့်ဆိုချက်များသည် `expired_pending_cleanup` အဖြစ် တင်းမာသောစည်းနှောင်မှုကို အစီရင်ခံနိုင်သေးသည်။
- `AssetId`- အများသူငှာ ပိုင်ဆိုင်မှု ခွဲခြားသတ်မှတ်မှုစနစ်သည် Base58 ဖောင်ပုံစံ `name#dataspace` သို့မဟုတ် `name#domain.dataspace` ကဲ့သို့ ပိုင်ဆိုင်မှု အလွဲများ သည် `AssetId` သို့ ဖြေရှင်းပါသည်။ အတွင်းပိုင်းစာရင်းကိုင်ကိုင်ဆောင်ထားသော `asset + account + optional dataspace` အကွက်များကို လိုအပ်သည့်နေရာတွင် ခွဲထုတ်နိုင်သော်လည်း အဆိုပါပေါင်းစပ်ပုံသဏ္ဍာန်သည် အများသူငှာ `AssetId` မဟုတ်ပါ။
- `NftId` — `nft$domain`။ NFT- `{ id, content: Metadata, owned_by }`။ ကုဒ်- `crates/iroha_data_model/src/nft.rs`။- `RoleId` — `name`။ အခန်းကဏ္ဍ- တည်ဆောက်သူ `NewRole { inner: Role, grant_to }` နှင့်အတူ `{ id, permissions: BTreeSet<Permission> }`။ ကုဒ်- `crates/iroha_data_model/src/role.rs`။
...
- ** ကုဒ်ရေးနည်းဆိုင်ရာ အခြေခံများ** (အင်္ဂါရပ် `sm`):
  - `Sm2PublicKey` / `Sm2Signature` သည် Canonical SEC1 အမှတ် + SM2 အတွက် ပုံသေအကျယ် `r∥s` ကုဒ်ကို ထင်ဟပ်စေသည်။ တည်ဆောက်သူများသည် မျဉ်းကွေးအဖွဲ့ဝင်ခြင်းနှင့် ID ခွဲခြားခြင်းဆိုင်ရာ သဘောတရားများ (`DEFAULT_DISTID`) ကို ပြဋ္ဌာန်းထားသော်လည်း အတည်ပြုခြင်းသည် ပုံစံမမှန်သော သို့မဟုတ် အကွာအဝေးမြင့်သည့် စကေးများကို ပယ်ချပါသည်။ ကုဒ်- `crates/iroha_crypto/src/sm.rs` နှင့် `crates/iroha_data_model/src/crypto/mod.rs`။
...
- Dataspace မှရရှိသောဆက်စပ်စတိုးဆိုင်များ (`space_directory_manifests`၊ `uaid_dataspaces`၊ `axt_policies`၊ `axt_replay_ledger`၊ Lane-relay အရေးပေါ် registry override) နှင့် dataspace-target permissions (Norito) ကို စတိုးဆိုင်များတွင် ခွင့်ပြုချက်ပေးထားသည်။ လည်ပတ်နေချိန်ကတ်တလောက်မွမ်းမံမှုများပြီးနောက် ဒေတာနေရာလွတ်များ ဟောင်းနွမ်းနေသော ကိုးကားချက်များကို တားဆီးကာကွယ်ပေးသည့် တက်ကြွသော `dataspace_catalog` မှ ဒေတာနေရာလွတ်များ ပျောက်သွားသောအခါ `State::set_nexus(...)`။ လမ်းကြောတစ်ခုအား အနားပေးသည် သို့မဟုတ် မတူညီသော dataspace သို့ ပြန်လည်သတ်မှတ်ပေးသည့်အခါ လမ်းကြောသတ်မှတ်ထားသော DA/relay ကက်ရှ်များ (`lane_relays`၊ `da_commitments`၊ `da_confidential_compute`၊ `da_pin_intents`) ကိုလည်း လမ်းကြောတစ်ခုအား အနားပေးသည့်အခါ သို့မဟုတ် မတူညီသော dataspace သို့ ပြန်လည်သတ်မှတ်ပေးသည့်အခါတွင်လည်း ဖြတ်တောက်ထားပါသည်။ ထို့ကြောင့် lane-local stateg သည် data များကို ဖြတ်ကျော်၍မရပါ။ Space Directory ISIs (`PublishSpaceDirectoryManifest`, `RevokeSpaceDirectoryManifest`, `ExpireSpaceDirectoryManifest`) သည် `dataspace` ကိုလည်း လက်ရှိ catalog နှင့် သက်ဆိုင်ပြီး `InvalidParameter` နှင့် အမည်မသိ ID များကို ငြင်းပယ်ပါသည်။
...
- Core စရိုက်- `Instruction: Send + Sync + 'static` နှင့် `dyn_encode()`၊ `as_any()`၊ တည်ငြိမ်သော `id()` (ကွန်ကရစ်အမျိုးအစားအမည်သို့ ပုံသေများ)။
...
- NFT မှတ်ပုံတင်ပါ- တည်ဆောက်သူထံမှ တည်ဆောက်သည်။ `owned_by = authority` သတ်မှတ်သည်။
  - ကြိုတင်သတ်မှတ်ချက်များ- NFT မရှိခြင်း၊ domain ရှိတယ်။
  - ပွဲများ- `DomainEvent::Nft(NftEvent::Created)`။
  - အမှားများ- `Repetition(Register, NftId)`။ ကုဒ်- `core/.../isi/nft.rs`။- မှတ်ပုံတင်ရန် အခန်းကဏ္ဍ- `NewRole { inner, grant_to }` (အကောင့်-အခန်းကဏ္ဍမြေပုံဆွဲခြင်းမှတစ်ဆင့် မှတ်တမ်းတင်ထားသော ပထမပိုင်ရှင်)၊ စတိုးဆိုင် `inner: Role` မှ တည်ဆောက်သည်။
...
- Trigger ကို မှတ်ပုံတင်ပါ- စစ်ထုတ်မှုအမျိုးအစားအလိုက် သတ်မှတ်သင့်လျော်သော trigger တွင် trigger ကို သိမ်းဆည်းပါ။
  ...
  - အမှားများ- `Repetition(Register, TriggerId)`၊ `InvalidParameterError::SmartContract(..)` ပြောင်းလဲခြင်း/အတည်ပြုခြင်း မအောင်မြင်မှုများ။ ကုဒ်- `core/.../isi/triggers/mod.rs`။- Peer/Domain/Account/AssetDefinition/NFT/Role/Trigger ကို မှတ်ပုံတင်ခြင်းမှ ဖြုတ်ပါ- ပစ်မှတ်ကို ဖယ်ရှားသည်။ ဖျက်ခြင်းဖြစ်ရပ်များကို ထုတ်လွှတ်သည်။ ထပ်လောင်း ကက်ဆက်ကပ်ခြင်းကို ဖယ်ရှားခြင်း-- ဒိုမိန်းစာရင်းမသွင်းပါ- ဒိုမိန်းအဖွဲ့အစည်းအပြင် ၎င်း၏ရွေးချယ်သူ/ထောက်ခံချက်-မူဝါဒအခြေအနေကို ဖယ်ရှားသည်။ ဒိုမိန်းအတွင်းရှိ ပိုင်ဆိုင်မှုဆိုင်ရာ အဓိပ္ပါယ်ဖွင့်ဆိုချက်များကို ဖျက်ပစ်သည် (ထိုအဓိပ္ပါယ်ဖွင့်ဆိုချက်များဖြင့် သော့ခတ်ထားသော လျှို့ဝှက် `zk_assets` ဘေးထွက်အခြေအနေ)၊ အဆိုပါ အဓိပ္ပါယ်ဖွင့်ဆိုချက်များ (နှင့် ပိုင်ဆိုင်မှုတစ်ခုအတွက် မက်တာဒေတာ)၊ ဒိုမိန်းအတွင်းရှိ NFTs နှင့် ဖယ်ရှားထားသော ဒိုမိန်းတွင် အမြစ်တွယ်နေသော အကောင့်တုများ ခန့်မှန်းချက်များကို ဖျက်သည်။ ၎င်းသည် ဖယ်ရှားထားသော ဒိုမိန်း သို့မဟုတ် ၎င်းနှင့်ဖျက်ထားသော အရင်းအမြစ်များကို ရည်ညွှန်းသည့် အကောင့်-/အခန်းကဏ္ဍ-သတ်မှတ်ခွင့်ပြုချက် ထည့်သွင်းမှုများကိုလည်း ဖြတ်တောက်ပေးသည် (ဒိုမိန်းခွင့်ပြုချက်များ၊ ဖယ်ရှားထားသော အဓိပ္ပါယ်ဖွင့်ဆိုချက်များအတွက် ပိုင်ဆိုင်မှု/ပိုင်ဆိုင်မှုခွင့်ပြုချက်များ၊ နှင့် ဖယ်ရှားထားသော NFT ID များအတွက် NFT ခွင့်ပြုချက်များ)။ ဒိုမိန်းဖယ်ရှားခြင်းသည် ကမ္ဘာလုံးဆိုင်ရာ `AccountId`၊ ၎င်း၏ tx-sequence/UAID အခြေအနေ၊ နိုင်ငံခြားပိုင်ဆိုင်မှု သို့မဟုတ် NFT ပိုင်ဆိုင်မှု၊ အစပျိုးလုပ်ပိုင်ခွင့်အာဏာ သို့မဟုတ် ရှင်သန်နေသောအကောင့်ကိုညွှန်ပြသည့် အခြားသော ပြင်ပစာရင်းစစ်/ဖွဲ့စည်းမှုဆိုင်ရာ အကိုးအကားများကို ဖျက်မည်မဟုတ်ပါ။ Guard rails- ဒိုမိန်းအတွင်းရှိ ပိုင်ဆိုင်မှုဆိုင်ရာ အဓိပ္ပါယ်ဖွင့်ဆိုချက်များအား ပြန်လည်po-သဘောတူညီချက်၊ အခြေချ-လယ်ဂျာ၊ အများသူငှာလမ်းသွား ဆုငွေ/တောင်းဆိုမှု၊ အော့ဖ်လိုင်း ထောက်ပံ့ကြေး/လွှဲပြောင်းမှု၊ အခြေချ repo ပုံသေများ (`settlement.repo.eligible_collateral`၊ `settlement.repo.collateral_substitution_matrix`)၊ အုပ်ချုပ်မှု-config ဖြင့် ရည်ညွှန်းနေသေးသည့်အချိန်တွင် ငြင်းပယ်သည် မဲပေးခြင်း/နိုင်ငံသားဖြစ်မှု/ပါလီမန်-အရည်အချင်းပြည့်မီမှု/ဗိုင်းရပ်စ်-ဆုချီးမြှင့်သည့် ပိုင်ဆိုင်မှု-ဆုငွေ ရည်ညွှန်းချက်များ၊ oracle-economics မှ စီစဉ်သတ်မှတ်ထားသော ဆုလာဘ်/မျဥ်းစောင်း/အငြင်းပွားမှု-ငွေချေးစာချုပ် ပိုင်ဆိုင်မှု-အဓိပ္ပါယ်ဖွင့်ဆိုချက်များ၊ သို့မဟုတ် Nexus အခကြေးငွေ/လောင်းကြေး ပိုင်ဆိုင်မှု-အဓိပ္ပါယ်ဖွင့်ဆိုချက်များ (I1827080X)။ ဖြစ်ရပ်များ- `DomainEvent::Deleted`၊ ဖယ်ရှားလိုက်သော domain resour အတွက် တစ်ပါတည်း ဖျက်ခြင်းဖြစ်ရပ်များထို့နောက်။ အမှားများ- `FindError::Domain` ပျောက်ဆုံးပါက၊ `InvariantViolation` ကို ထိန်းသိမ်းထားသော ပိုင်ဆိုင်မှု-အဓိပ္ပါယ်ဖွင့်ဆိုချက် ပဋိပက္ခများ။ ကုဒ်- `core/.../isi/world.rs`။- အကောင့်ကို စာရင်းမသွင်းပါ- အကောင့်၏ခွင့်ပြုချက်များ၊ အခန်းကဏ္ဍများ၊ tx-sequence တန်ပြန်၊ အကောင့်တံဆိပ်ပုံဖော်ခြင်းနှင့် UAID စည်းနှောင်မှုများကို ဖယ်ရှားသည်။ အကောင့်ပိုင်ပစ္စည်းများ (နှင့် ပစ္စည်းတစ်ခုချင်း မက်တာဒေတာ) အကောင့်ပိုင် NFT များကို ဖျက်ခြင်း၊ ထိုအကောင့်၏ အခွင့်အာဏာရှိသော အစပျိုးမှုများကို ဖယ်ရှားပါ။ ဖယ်ရှားထားသော အကောင့်ကို ကိုးကားသော အကောင့်-/အခန်းကဏ္ဍ-သတ်မှတ်ခွင့်ပြုချက် ထည့်သွင်းမှုများ၊ ဖယ်ရှားထားသော ပိုင်ဆိုင်သော NFT ID များအတွက် အကောင့်-/အခန်းကဏ္ဍ-သတ်မှတ်ထားသော NFT-ပစ်မှတ်ခွင့်ပြုချက်များ၊ နှင့် ဖယ်ရှားလိုက်သော အစပျိုးများအတွက် အကောင့်-/အခန်းကဏ္ဍ-သတ်မှတ်ထားသော အစပျိုး-ပစ်မှတ်ခွင့်ပြုချက်များ။ Guard rails- အကောင့်သည် ဒိုမိန်းတစ်ခု ပိုင်ဆိုင်ဆဲ၊ ပိုင်ဆိုင်မှု အဓိပ္ပါယ်ဖွင့်ဆိုချက်၊ SoraFS ပံ့ပိုးပေးသူ ပေါင်းစည်းမှု၊ အသက်ဝင်သော နိုင်ငံသားဖြစ်မှု မှတ်တမ်း၊ အများသူငှာ လမ်းသွားလောင်းကြေး/ဆုငွေ အခြေအနေ (အကောင့်ကို တောင်းဆိုသူ သို့မဟုတ် ဆုပေးသူ-ဆုပေးသူ-ပိုင်ဆိုင်မှု ပိုင်ရှင်အဖြစ် ပေါ်လာသည့်)၊ တက်ကြွသော twitter ပြည်နယ် (ပါဝင်သည့် သို့မဟုတ် ဖြည့်သွင်းထားသော မှတ်တမ်းများ အပါအဝင်၊ oracle-economics မှ စီစဉ်သတ်မှတ်ထားသော ဆုငွေ/မျဥ်းစောင်း အကောင့် ကိုးကားချက်များ)၊ တက်ကြွသော Nexus အခကြေးငွေ/လောင်းကြေး အကောင့် ကိုးကားချက်များ (`nexus.fees.fee_sink_account_id`၊ `nexus.staking.stake_escrow_account_id`၊ `nexus.staking.slash_sink_account_id`၊ canonical invalidifierless အကောင့်များပိတ်ခြင်း)၊ canonical မအောင်မြင်သော domains များအဖြစ် ခွဲခြမ်းစိတ်ဖြာထားသည် တက်ကြွသောပြန်လည်ပို-သဘောတူညီချက်အခြေအနေ၊ အသက်ဝင်သောအခြေချ-လယ်ဂျာအခြေအနေ၊ တက်ကြွသောအော့ဖ်လိုင်းခွင့်ပြုချက်/လွှဲပြောင်းမှု သို့မဟုတ် အော့ဖ်လိုင်းစီရင်ချက်-ပြန်လည်ရုတ်သိမ်းခြင်းအခြေအနေ၊ တက်ကြွသောပိုင်ဆိုင်မှုအဓိပ္ပါယ်ဖွင့်ဆိုချက်များများအတွက် တက်ကြွသောအော့ဖ်လိုင်းအကောင့်ဖွဲ့စည်းပုံအကိုးအကားများ (`settlement.offline.escrow_accounts`)၊ တက်ကြွသောအုပ်ချုပ်မှုအခြေအနေ (အဆိုပြုချက်/အဆင့်အတည်ပြုချက်als/locks/slashes/council/parliament rosters၊ အဆိုပြုချက်ပါလီမန်လျှပ်တစ်ပြက်ပုံများ၊ runtime-upgrade proposer records၊ governance-configured escrow/slash-receiver/viral-pool အကောင့်ကိုးကားချက်များ၊ အုပ်ချုပ်မှု SoraFS telemetry မှတဆင့် တင်သွင်းသူ10028X `gov.sorafs_telemetry.per_provider_submitters`၊ သို့မဟုတ် SoraFS မှ ပံ့ပိုးပေးသူ-ပိုင်ရှင် ရည်ညွှန်းချက်များ `gov.sorafs_provider_owners`)၊ ပြင်ဆင်သတ်မှတ်ထားသော အကြောင်းအရာ ထုတ်ဝေခွင့်ပြုစာရင်း အကောင့်ကိုးကားချက်များ (`content.publish_allow_accounts`)၊ တက်ကြွသော လူမှုရေးဆိုင်ရာ အာမခံချက်ဖန်တီးသူ- တက်ကြွသော ပေးပို့သူအခြေအနေ၊ တက်ကြွသော ပေးပို့သူ၏ အခြေအနေ၊ တက်ကြွသောလမ်းကြော-တဆင့်တဆင့်အရေးပေါ်အတည်ပြုပေးသည့်အခြေအနေ၊ သို့မဟုတ် တက်ကြွသော SoraFS ပင်-မှတ်ပုံတင်ထုတ်ပေးသူ/နှောင်ကြိုးမှတ်တမ်းများ (ပင် မန်နီးဖက်စ်များ၊ ထင်ရှားသောအမည်ပွားများ၊ ကူးယူမှုအမှာစာများ)။ အစီအစဉ်များ- `AccountEvent::Deleted`၊ နှင့် NFT ကို ဖယ်ရှားလိုက်လျှင် `NftEvent::Deleted`။ အမှားများ- `FindError::Account` ပျောက်ဆုံးပါက၊ ပိုင်ဆိုင်မှု `InvariantViolation` တွင် မိဘမဲ့ကလေးများ။ ကုဒ်- `core/.../isi/domain.rs`။- AssetDefinition ကို စာရင်းမသွင်းပါ- ထိုအဓိပ္ပါယ်ဖွင့်ဆိုချက်နှင့် ၎င်းတို့၏ ပိုင်ဆိုင်မှုတစ်ခုချင်းဆိုင်ရာ မက်တာဒေတာအားလုံးကို ဖျက်ပြီး ထိုအဓိပ္ပါယ်ဖွင့်ဆိုချက်ဖြင့် လျှို့ဝှက်ထားသော `zk_assets` ဘေးထွက်အခြေအနေအား ဖယ်ရှားသည်။ ဖယ်ရှားထားသော ပိုင်ဆိုင်မှု အဓိပ္ပါယ်ဖွင့်ဆိုချက် သို့မဟုတ် ၎င်း၏ ပိုင်ဆိုင်မှုဖြစ်ရပ်များကို ရည်ညွှန်းသော ကိုက်ညီသော `settlement.offline.escrow_accounts` နှင့် အကောင့်-/အခန်းကဏ္ဍ-သတ်မှတ်ခွင့်ပြုချက် ထည့်သွင်းမှုများကိုလည်း ဖြတ်တောက်သည်။ Guard rails- အဓိပ္ပါယ်ဖွင့်ဆိုချက်ကို ပြန်ပို-သဘောတူညီချက်၊ အခြေချ-လယ်ဂျာ၊ အများသူငှာ လမ်းသွားဆုငွေ/အရေးဆိုမှု၊ အော့ဖ်လိုင်းထောက်ပံ့ကြေး/လွှဲပြောင်းမှုအခြေအနေ၊ အခြေချပြန်ပိုပုံသေများ (`settlement.repo.eligible_collateral`၊ `settlement.repo.collateral_substitution_matrix`)၊ အုပ်ချုပ်မှု-ပြင်ဆင်သတ်မှတ်ထားသော ဝန်ဆောင်မှုပေးခွင့်/မဲပေးခြင်း/မဲပေးခြင်း ပိုင်ဆိုင်မှု-အဓိပ္ပါယ်ဖွင့်ဆိုချက်များ၊ oracle-economics မှ စီစဉ်သတ်မှတ်ထားသော ဆုငွေ/မျဥ်းစောင်း/အငြင်းပွား-နှောင်ကြိုးများ ပိုင်ဆိုင်မှု-အဓိပ္ပါယ်ဖွင့်ဆိုချက်များ၊ သို့မဟုတ် Nexus အခကြေးငွေ/လောင်းကြေး ပိုင်ဆိုင်မှု-အဓိပ္ပါယ်ဖွင့်ဆိုချက်များ (`nexus.fees.fee_asset_id`၊ `nexus.staking.stake_asset_id`)။ အစီအစဉ်များ- ပိုင်ဆိုင်မှုတစ်ခုလျှင် `AssetDefinitionEvent::Deleted` နှင့် `AssetEvent::Deleted`။ အမှားများ- `FindError::AssetDefinition`၊ `InvariantViolation` ကိုးကားမှုပဋိပက္ခများ။ ကုဒ်: `core/.../isi/domain.rs`။
...
- ပိုင်ဆိုင်မှု (ဂဏန်း) mint/burn- လက်ကျန်များနှင့် အဓိပ္ပါယ်ဖွင့်ဆိုချက်၏ `total_quantity` ကို ချိန်ညှိသည်။
  ...
  - ပွဲများ- `AssetEvent::Added`/`AssetEvent::Removed`၊ `AssetDefinitionEvent::MintabilityChanged` (`Once` သို့မဟုတ် `Limited(n)` ၎င်း၏ ထောက်ပံ့ကြေးငွေကုန်သွားသောအခါ)။
  ...
  - အမှားများ- `MathError::Overflow` မမှန်ကန်သော mint; `FindError::Trigger` ပျောက်ဆုံးပါက။ ကုဒ်- `core/.../isi/triggers/mod.rs`။

### လွှဲပြောင်းခြင်း။
အမျိုးအစားများ- `Transfer<S: Identifiable, O, D: Identifiable>`၊ `TransferBox` အဖြစ် အကွက်များ။

- ပိုင်ဆိုင်မှု (ကိန်းဂဏာန်း)- အရင်းအမြစ် `AssetId` မှနုတ်၍ ဦးတည်ရာ `AssetId` (တူညီသောအဓိပ္ပါယ်ဖွင့်ဆိုချက် မတူညီသောအကောင့်)။ သုညရှိသော အရင်းအမြစ်ပိုင်ဆိုင်မှုကို ဖျက်ပါ။
  - ကြိုတင်သတ်မှတ်ချက်များ- ရင်းမြစ် ပိုင်ဆိုင်မှု ရှိနေသည် ။ တန်ဖိုးသည် `spec` ကို ကျေနပ်သည်။
  - ပွဲများ- `AssetEvent::Removed` (ရင်းမြစ်), `AssetEvent::Added` (ဦးတည်ရာ)။
...
- AssetDefinition ပိုင်ဆိုင်မှု- `AssetDefinition.owned_by` ကို ဦးတည်ရာအကောင့်သို့ ပြောင်းသည်။
  ...
  - အမှားများ- `FindError::Account/AssetDefinition`။ ကုဒ်- `core/.../isi/account.rs`။- NFT ပိုင်ဆိုင်မှု- `Nft.owned_by` ကို ဦးတည်ရာအကောင့်သို့ ပြောင်းသည်။
  - ကြိုတင်သတ်မှတ်ချက်များ- အကောင့်နှစ်ခုလုံးရှိပါသည် NFT ရှိသည်; အရင်းအမြစ်သည် လက်ရှိပိုင်ဆိုင်ရမည်၊ အခွင့်အာဏာသည် အရင်းအမြစ်အကောင့်၊ အရင်းအမြစ်-ဒိုမိန်းပိုင်ရှင်၊ NFT-ဒိုမိန်းပိုင်ရှင် သို့မဟုတ် ထို NFT အတွက် `CanTransferNft` ကို ကိုင်ထားရပါမည်။
...
- အမှားများ- ပစ်မှတ်မရှိပါက `FindError::<Target>`။ ဖယ်ရှားရန်အတွက် ပျောက်ဆုံးနေသောသော့ပေါ်တွင် `FindError::MetadataKey`။ ကုဒ်- `crates/iroha_data_model/src/isi/transparent.rs` နှင့် ပစ်မှတ်တစ်ခုလျှင် executor impls။

### ခွင့်ပြုချက်များနှင့် ရာထူးများ- ခွင့်ပြု/ပြန်လည်ရုပ်သိမ်းခြင်း။
အမျိုးအစားများ- `Grant<O, D>` နှင့် `Revoke<O, D>`၊ `Permission`/`Role` နှင့် `Account` နှင့် `Permission`/`Role` နှင့် `Account` နှင့် IVM။- အကောင့်အား ခွင့်ပြုချက်ပေးသည်- မွေးရာပါရှိပြီးသားမဟုတ်ပါက `Permission` ကို ပေါင်းထည့်သည်။ ပွဲများ- `AccountEvent::PermissionAdded`။ အမှားများ- ပွားပါက `Repetition(Grant, Permission)`။ ကုဒ်- `core/.../isi/account.rs`။
...
- အခန်းကဏ္ဍကို ခွင့်ပြုချက်ပေးသည်- ခွင့်ပြုချက်ထည့်သွင်းပြီး အခန်းကဏ္ဍကို ပြန်လည်တည်ဆောက်သည်။ ပွဲများ- `RoleEvent::PermissionAdded`။ အမှားများ- `Repetition(Grant, Permission)`။ ကုဒ်- `core/.../isi/world.rs`။
- ရာထူးမှခွင့်ပြုချက်ကို ရုတ်သိမ်းသည်- ထိုခွင့်ပြုချက်မရှိဘဲ အခန်းကဏ္ဍကို ပြန်လည်တည်ဆောက်သည်။ ပွဲများ- `RoleEvent::PermissionRemoved`။ အမှားများ- `FindError::Permission` မရှိလျှင်။ ကုဒ်- `core/.../isi/world.rs`။### အစပျိုးမှုများ- လုပ်ဆောင်ရန်
အမျိုးအစား- `ExecuteTrigger { trigger: TriggerId, args: Json }`။
- အပြုအမူ- အစပျိုးစနစ်ခွဲအတွက် `ExecuteTriggerEvent { trigger_id, authority, args }` ကို စီစစ်သည်။ လူကိုယ်တိုင်လုပ်ဆောင်မှုကို ခေါ်ဆိုမှုအစပျိုးခြင်းများအတွက်သာ ခွင့်ပြုသည် (`ExecuteTrigger` filter); filter သည် တူညီရမည်ဖြစ်ပြီး ခေါ်ဆိုသူသည် အစပျိုးလုပ်ဆောင်မှုအာဏာပိုင်ဖြစ်ရမည် သို့မဟုတ် ထိုအခွင့်အာဏာအတွက် `CanExecuteTrigger` ကို ကိုင်ထားပါ။ အသုံးပြုသူမှပေးသော executor သည် အသက်ဝင်သောအခါ၊ အစပျိုးလုပ်ဆောင်မှုကို runtime executor မှအတည်ပြုပြီး ငွေပေးငွေယူ၏ executor လောင်စာဘတ်ဂျက် (အခြေခံ `executor.fuel` နှင့် စိတ်ကြိုက်မက်တာဒေတာ `additional_fuel`) ကိုအသုံးပြုသည်။
...
- `TransactionBuilder`/`SignedTransaction`- မက်တာဒေတာ၊ `chain_id`၊ `authority`၊ `creation_time_ms`၊ ရွေးချယ်နိုင်သော I10390390X၊ ရွေးချယ်နိုင်သော I10390 `nonce`။ ကုဒ်- `crates/iroha_data_model/src/transaction/`။
...
- ဘဝသံသရာကို အစပျိုးပါ
  - `Register::trigger(Trigger::new(id, Action::new(exec, repeats, authority, filter)))` သည် စစ်ထုတ်မှုဖြင့် အဓိပ္ပာယ်သက်ရောက်သော mintability စစ်ဆေးချက်၊ `ExecuteTrigger::new(id).with_args(&args)` သည် configured authority နှင့် ကိုက်ညီရမည်။
...
- Canonical Base58 id အတွက် alias များကို ဖြေရှင်းပါ-
  - JSON `{ "alias": "pkr#bankb.paynet" }` ဖြင့် `POST /v1/assets/aliases/resolve`
...
- အများသူငှာ ပိုင်ဆိုင်မှုရွေးချယ်သည့်စနစ်များသည် အရင်းအနှီးအခြေခံသော Base58 ပိုင်ဆိုင်မှု-အဓိပ္ပါယ်ဖွင့်ဆိုချက် ids များအပြင် ခွဲထွက်ပိုင်ဆိုင်မှုအကွက်များ (`account`၊ ရွေးချယ်နိုင်သော `scope`) ကို အသုံးပြုသည်။ အကြမ်းထည် encode လုပ်ထားသော `AssetId` literals များသည် အတွင်းပိုင်းအထောက်အပံများ ရှိနေကြပြီး Torii/CLI ရွေးချယ်မှုမျက်နှာပြင်၏ မပါဝင်ပါ။
- ပိုင်ဆိုင်မှု-အဓိပ္ပါယ်ဖွင့်ဆိုချက်စာရင်း/မေးမြန်းမှု စစ်ထုတ်မှုများနှင့် အမျိုးအစားများသည် `alias_binding.status`၊ `alias_binding.lease_expiry_ms`၊ `alias_binding.grace_until_ms` နှင့် `alias_binding.bound_at_ms` တို့ကိုလည်း လက်ခံပါသည်။
...
ဤ spec ကို ပြန်ဆိုထားသော API/behavior table သို့ ချဲ့ထွင်လိုပါက သို့မဟုတ် ခိုင်မာသော ဖြစ်ရပ်/အမှားတိုင်းနှင့် အပြန်အလှန်ချိတ်ဆက်ထားလိုပါက စကားလုံးကို ပြောပြီး ၎င်းကို ထပ်ချဲ့ပါမည်။