...
| Moteur basé sur un schéma ISO 20022 et pont Torii | ◉ | Schémas canoniques ISO 20022 intégrés, analyse XML déterministe et API `/v1/iso20022/messages/{MsgId}` exposée. | statut.md:65-70 |
