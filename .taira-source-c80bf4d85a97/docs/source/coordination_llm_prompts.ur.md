...
# ایل ایل ایم کوآرڈینیشن اشارہ

## مقصد

یہ فوری ٹیمپلیٹس انجینئرز کو @ایم ٹاکیمیا سے جلد وضاحت جمع کرنے میں مدد کرتے ہیں
جب روڈ میپ آئٹمز کھلے سوالات چھوڑ دیتے ہیں۔ نیچے دیئے گئے حصے میں سے ایک کو کاپی کریں
ایل ایل ایم تھریڈ ، بریکٹ والے پلیس ہولڈرز کو تبدیل کریں ، اور متعلقہ فائل یا شامل کریں
لائن حوالہ جات لہذا سیاق و سباق لنگر انداز رہتا ہے۔

## فن تعمیر یا ڈیزائن کے فیصلے
...
## ترتیب یا آپریٹر رہنمائی

````markdown
We are documenting configuration/operator guidance and need input.

**Topic**: [e.g., release artifact selection between ````markdown
We are documenting configuration/operator guidance and need input.
