...
# LLM үйлестіру нұсқаулары

## Мақсат

Бұл жылдам үлгілер инженерлерге @mtakemiya сайтынан түсініктемелерді жылдам жинауға көмектеседі
жол картасының элементтері ашық сұрақтар қалдырғанда. Төмендегі бөлімдердің бірін көшіріп алыңыз
LLM ағынын, жақшадағы толтырғыштарды ауыстырыңыз және тиісті файлды немесе қосыңыз
жол сілтемелері, сондықтан контекст бекітілген болып қалады.

## Архитектура немесе дизайн шешімдері
...
## Конфигурация немесе Оператор нұсқаулығы
...
## Криптография немесе протокол примитивтері
...
## Сынақ векторлары немесе арматура
...
## Инженерлік немесе процесті шығарыңыз
