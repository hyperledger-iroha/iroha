...
### የኤስኤምኤስ አፈጻጸም ቅጽበታዊ ገጽ እይታ (አፕል ሲሊከን)

መመዘኛዎች ስኬርን፣ የሩጫ ጊዜ ራስ-ማወቂያን እና የግዳጅ NEON ሩጫዎችን (ሚዲያን፣ µs) ያወዳድራሉ።

| ቤንችማርክ | Scalar | መኪና | ኒዮን-ኃይል | Auto vs Scalar | ኒዮን vs Scalar | ኒዮን vs ራስ |
|--------|--------|------|------------|
| sm2_vs_ed25519_ምልክት/ed25519_ምልክት |    32.83 |  32.91 |      32.82 |      + 0.23% |       -0.03% |      -0.25% |
| sm2_vs_ed25519_ምልክት/sm2_ምልክት |   302.19 | 301.51 |     301.98 |      -0.23% |       -0.07% |      + 0.16% |
| sm2_vs_ed25519_አረጋግጥ/አረጋግጥ/ ed25519 |    35.43 |  35.80 |      35.47 |      + 1.04% |       + 0.12% |      -0.91% |
| sm2_vs_ed25519_አረጋግጥ/አረጋግጥ/sm2 |   270.66 | 269.30 |     269.28 |      -0.50% |       -0.51% |      -0.01% |
...
| sm4_vs_chacha20poly1305_decrypt/chacha20poly1305_ዲክሪፕት |     1.89 |   1.89 |       1.90 |      -0.04% |       + 0.47% |      + 0.51% |
...
ሜታዳታ፡ scalar={'cpu'፡ 'm3-pro-local'፣ 'ዒላማ_አርች'፡ 'aarch64'፣ 'ዒላማ_ኦስ'፡ 'ማኮስ'}፣ auto={'cpu': 'm3-pro-local'፣ 'ታርጌት_አርክ'፡ 'aarch64'፣ 'ታርጌት_ኦስ'፡'{'macos- 'm3-pro-local'፣ 'ዒላማ_አርክ'፡ 'aarch64'፣ 'ዒላማ_ኦስ'፡ 'ማኮስ'}።

### የኤስኤምኤስ አፈጻጸም ቅጽበታዊ ገጽ እይታ (x86_64 Rosetta፣ Apple M3 Pro)

መመዘኛዎች በሮዝታ ስር የተያዙትን ስኬር፣ የአሂድ ጊዜ ራስ-ማወቂያ እና የግዳጅ NEON ሩጫዎችን (ሚዲያን፣ µs) ያወዳድራሉ።| ቤንችማርክ | Scalar | መኪና | ኒዮን-ኃይል | Auto vs Scalar | ኒዮን vs Scalar | ኒዮን vs ራስ |
|--------|--------|------|------------|
...
ሜታዳታ፡ scalar={'cpu'፡ 'm3-pro-rosetta'፣ ' target_arch': 'x86_64', 'target_os': 'macos'}, auto={'cpu': 'm3-pro-rosetta', 'target_arch': 'x86_64',': 'targetcoss:' necpuros 'm3-pro-rosetta'፣ 'ዒላማ_አርክ'፡ 'x86_64'፣ 'ዒላማ_ኦስ'፡ 'ማኮስ'}።