...
### תמונת מצב של ביצועי SM (Apple Silicon)

מדדים משווים סקלרים, זיהוי אוטומטי של זמן ריצה וריצות NEON מאולצות (חציונים, µs).
...
מטא נתונים: scalar={'cpu': 'm3-pro-local', 'target_arch': 'aarch64', 'target_os': 'macos'}, auto={'cpu': 'm3-pro-local', 'target_arch': 'aarch64', 'target_os': 'macos'='} 'm3-pro-local', 'target_arch': 'aarch64', 'target_os': 'macos'}.

### SM Performance Snapshot (x86_64 Rosetta, Apple M3 Pro)

מדדים משווים סקלרים, זיהוי אוטומטי של זמן ריצה וריצות NEON מאולצות (חציונים, µs) שנלכדו תחת Rosetta.| בנצ'מרק | סקלאר | אוטומטי | ניאון-פורס | אוטומטי לעומת סקלאר | ניאון נגד סקלאר | ניאון נגד אוטומטי |
|-----------|--------|------|--------|----------------|-------------------------------|
...
מטא נתונים: scalar={'cpu': 'm3-pro-rosetta', 'target_arch': 'x86_64', 'target_os': 'macos'}, auto={'cpu': 'm3-pro-rosetta', 'target_arch': 'x86_64', 'target_64', 'target_64'}, 'neo-macos:'}': 'm3-pro-rosetta', 'target_arch': 'x86_64', 'target_os': 'macos'}.