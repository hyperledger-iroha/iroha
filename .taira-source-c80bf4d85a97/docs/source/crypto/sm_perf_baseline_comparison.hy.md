...
Հենանիշները համեմատում են սկալյար, գործարկման ժամանակի ավտոմատ հայտնաբերումը և հարկադիր NEON գործարկումները (միջիններ, µs):
...
Մետատվյալներ՝ scalar={'cpu': 'm3-pro-local', 'target_arch': 'aarch64', 'target_os': 'macos'}, auto={'cpu': 'm3-pro-local', 'target_arch': 'aarch64', 'target_os': 'macos', 'target_os': 'macos': 'm3-pro-local', 'target_arch': 'aarch64', 'target_os': 'macos'}:

### SM Performance Snapshot (x86_64 Rosetta, Apple M3 Pro)

Հենանիշները համեմատում են սկալյար, գործարկման ժամանակի ավտոմատ հայտնաբերումը և հարկադիր NEON վազքները (միջիններ, μs), որոնք նկարվել են Rosetta-ի ներքո:| Հենանիշ | Սկալարային | Ավտո | Նեոն-Ֆորս | Auto vs Scalar | Neon vs Scalar | Նեոն ընդդեմ Ավտո |
|-----------|--------|------|------------|---------------|--------------|-------------|
...
Մետատվյալներ՝ scalar={'cpu': 'm3-pro-rosetta', 'target_arch': 'x86_64', 'target_os': 'macos'}, auto={'cpu': 'm3-pro-rosetta', 'target_arch': 'x86_64', 'target', 'sco neon-force={'cpu': 'm3-pro-rosetta', 'target_arch': 'x86_64', 'target_os': 'macos'}: