...
საორიენტაციო ნიშნები ადარებს სკალარს, გაშვების ავტომატურ გამოვლენას და იძულებითი NEON გაშვებას (მედიანები, μs).
...
მეტამონაცემები: scalar={'cpu': 'm3-pro-local', 'target_arch': 'aarch64', 'target_os': 'macos'}, auto={'cpu': 'm3-pro-local', 'target_arch': 'aarch64', 'target_os': 'macos'}=" 'm3-pro-local', 'target_arch': 'aarch64', 'target_os': 'macos'}.

### SM Performance Snapshot (x86_64 Rosetta, Apple M3 Pro)

საორიენტაციო ნიშნები ადარებს სკალარს, გაშვების ავტომატურ გამოვლენას და იძულებითი NEON რბენებს (მედიანები, μs) როზეტას ქვეშ.| ნიშნული | სკალარული | ავტო | Neon-Force | Auto vs Scalar | ნეონი vs სკალარი | ნეონი vs ავტო |
|-----------|--------|-----|------------|---------------|--------------|-------------|
...
მეტამონაცემები: scalar={'cpu': 'm3-pro-rosetta', 'target_arch': 'x86_64', 'target_os': 'macos'}, auto={'cpu': 'm3-pro-rosetta', 'target_arch': 'x86_64', 'target_s' neon-force={'cpu': 'm3-pro-rosetta', 'target_arch': 'x86_64', 'target_os': 'macos'}.