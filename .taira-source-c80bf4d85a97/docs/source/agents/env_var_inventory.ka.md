...
სულ მითითებები: **502** · უნიკალური ცვლადები: **137**
...
## CARGO_BIN_EXE_koto build (ტესტი: 3)

- ტესტი: crates/ivm/tests/cli_smoke.rs:8 — `let bin = env!("CARGO_BIN_EXE_koto build");`
- ტესტი: crates/ivm/tests/cli_smoke.rs:56 — `let bin = env!("CARGO_BIN_EXE_koto build");`
- ტესტი: crates/ivm/tests/cli_smoke.rs:88 — `let bin = env!("CARGO_BIN_EXE_koto build");`
...
- ტესტი: crates/sorafs_orchestrator/tests/sorafs_cli.rs:42 — `let path = env::var("CARGO_BIN_EXE_sorafs_cli")`
...
- ტესტი: crates/sorafs_orchestrator/tests/sorafs_cli.rs:48 — `let path = env::var("CARGO_BIN_EXE_taikai_car")`
...
## IROHA_RUN_IGNORED (ტესტი: 66)- ტესტი: crates/iroha_core/tests/gov_auto_close_approve.rs:20 — `if std::env::var("IROHA_RUN_IGNORED").ok().as_deref() != Some("1") {`
...
- ტესტი: crates/ivm/src/bin/koto check.rs:702 — `let previous = env::var("LANG").ok();`
