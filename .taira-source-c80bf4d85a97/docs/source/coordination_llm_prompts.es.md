...
# Indicaciones de coordinación de LLM

## Propósito

Estas plantillas de avisos ayudan a los ingenieros a recopilar rápidamente aclaraciones de @mtakemiya
cuando los elementos de la hoja de ruta dejan preguntas abiertas. Copie una de las secciones siguientes en el
Hilo de LLM, reemplace los marcadores de posición entre corchetes e incluya el archivo o
referencias de línea para que el contexto permanezca anclado.
...
## Configuración o guía del operador
...
## Primitivas de criptografía o protocolo
...
## Vectores o accesorios de prueba
...
## Ingeniería de lanzamiento o proceso
