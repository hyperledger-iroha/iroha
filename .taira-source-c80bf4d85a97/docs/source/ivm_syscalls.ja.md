...
| 0x22 | MINT_ASSET                        | `&AccountId`, `&AssetDefinitionId`, `&QuantityValueV1`                         | `u64=0`      | `G_mint`                          | 指定量をアカウントへ鋳造する          |
| 0x23 | BURN_ASSET                        | `&AccountId`, `&AssetDefinitionId`, `&QuantityValueV1`                         | `u64=0`      | `G_burn`                          | 指定量をアカウントから焼却する        |
...
| 0x27 | NFT_SET_METADATA                  | `&NftId`, `&Name`, `&Json`                                                       | `u64=0`      | `G_nft_set_metadata`              | NFT メタデータを更新する              |
