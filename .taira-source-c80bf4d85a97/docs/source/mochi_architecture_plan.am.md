...
2. `mochi-ui`፡ በ`egui`/`eframe` ላይ የተገነባ የዴስክቶፕ አፕሊኬሽን የተጠቃሚ በይነገጹን የሚያቀርብ እና ሁሉንም ኦርኬስትራ በ`mochi-core` ኤፒአይ ነው።
...
- ቀጭን የTorii የደንበኛ ንብርብር የኤችቲቲፒ እና የዌብሶኬት ጥሪዎችን ያጠቃልላል፣ በ Iroha Rust ደንበኛ ሳጥኖች ላይ በመደገፍ retired codec ኢንኮዲንግ/ዲኮዲንግ እንዳይሰራ ማድረግ።
...
- ** አግድ እና የክስተት ዥረቶች ***፡ ለ UI ፓነሎች የማህደረ ትውስታ ጥቅል ቋት በማጠራቀም ለ`/v1/blocks/stream` እና `/v1/events/ws` ይመዝገቡ።
- **ስቴት ኤክስፕሎረር**፡ በNorito የሚደገፉ የ`/v1/query` ጥሪዎችን ጎራዎችን፣ መለያዎችን፣ ንብረቶችን እና የንብረት መግለጫዎችን በፓጂኔሽን አጋዥ እና በዲበ ውሂብ ማጠቃለያዎች ያሂዱ።
- ** የግብይት አቀናባሪ**፡ የመድረክ ሚንት/የማስተማሪያ ረቂቆችን ማስተላለፍ፣ ወደ ፊርማ ግብይቶች መደብደብ፣ የNorito ክፍያን አስቀድመው ማየት፣ በ`/v1/pipeline/transactions` በኩል ማስገባት እና የተከሰቱትን ክስተቶች መከታተል፣ የቮልት ፊርማ መንጠቆዎች የወደፊት ድግግሞሾች ናቸው.
