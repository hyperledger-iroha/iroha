...
- Torii հաճախորդի բարակ շերտը պարուրում է HTTP և WebSocket զանգերը՝ հենվելով Iroha Rust հաճախորդի արկղերի վրա, որտեղ հնարավոր է, խուսափելու retired codec կոդավորման/վերծանումից վերագործարկումից:
