...
| Motor basado en esquemas ISO 20022 y puente Torii | ◉ | Esquemas canónicos ISO 20022 integrados, análisis XML determinista y API `/v1/iso20022/messages/{MsgId}` expuesta. | estado.md:65-70 |
