...
- პროფილები: `iroha3-dev` (ჯაჭვი `iroha3-dev.local`, კოლექციონერები k=1 r=1, VRF თესლი მიღებული ჯაჭვის id-დან NPoS-ის არჩევისას), `iroha3-taira` (ჯაჭვი `iroha3-taira`, `iroha3-taira`, `iroha3-taira`, `iroha3-taira`, `iroha3-taira`, `iroha3-taira`, Kagami, Kagami, Kagami, Kagami, კოლექციონერები k=130X, კოლექციონერები. როდესაც არჩეულია NPoS), `iroha3-nexus` (ჯაჭვი `iroha3-nexus`, კოლექტორები k=5 r=3, საჭიროებს `--vrf-seed-hex`-ს NPoS არჩევისას).
...
- პაკეტების ნიმუში: წინასწარ გენერირებული პაკეტები მოქმედებს `defaults/kagami/iroha3-{dev,taira,nexus}/`-ის ქვეშ (genesis.json, config.toml, docker-compose.yml, verify.txt, README). რეგენერაცია `cargo xtask kagami-profiles [--profile <name>|all] [--out <dir>] [--kagami <bin>]`-ით.
