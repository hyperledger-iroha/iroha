...
- retired codec шилийг буулгах; `norito::codec` одоо эх Norito цуваачлалаар хэрэгжиж байна.
- Хайрцаг дээрх `retired_codec` хэрэглээг `norito::codec`-ээр соль.
- Багаж хэрэгслийг эх Norito цуваа руу шилжүүлж эхэлнэ.
- Үлдсэн `retired codec` хамаарлыг ажлын талбараас устгаж, үндсэн Norito цуваачлалыг дэмжинэ.
- Үлдэгдэл retired codec шинж чанарын уламжлалыг Norito хувилбараар сольж, хувилбар кодлогч модулийн нэрийг өөрчил.
...
- хувийн түлхүүрүүдэд multihash форматыг ашиглах (#4541)
 - `legacy_codec_decoder` нэрийг `norito_cli` болгон өөрчлөх
...
- Одоогийн хэрэглэгчидтэй зөрчилдөхөөс урьдчилан сэргийлэхийн тулд шинэ контейнер руу шилжих.
 - hyperledger#2158 `retired_codec` болон бусад хамаарлыг шинэчил. (Norito кодлогч)
- Барилга засах.
