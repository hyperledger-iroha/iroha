...
Бұл файл IVM архитектурасы мен ABI ескертпелеріне арналған workspace түбіріндегі кіріс құжаты болып табылады.
Толық құжаттама `docs/source/` және `crates/ivm/docs/` ішінде орналасқан.
