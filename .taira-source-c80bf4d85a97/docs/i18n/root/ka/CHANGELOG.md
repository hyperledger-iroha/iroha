...
## [გამოუქვეყნებელი]- ჩამოაგდეთ retired codec შიმი; `norito::codec` ახლა დანერგილია მშობლიური Norito სერიულიზაციით.
- შეცვალეთ `retired_codec` გამოყენება `norito::codec`-ით ყუთებში.
- დაიწყეთ ინსტრუმენტების მიგრაცია მშობლიურ Norito სერიალიზაციაზე.
- ამოიღეთ დარჩენილი `retired codec` დამოკიდებულება სამუშაო სივრციდან მშობლიური Norito სერიალიზაციის სასარგებლოდ.
- შეცვალეთ ნარჩენი retired codec ნიშან-თვისებების წარმოებულები მშობლიური Norito იმპლემენტაციებით და დაარქვით ვერსია კოდეკის მოდულს.
...
- გამოიყენეთ მულტიჰაშის ფორმატი პირადი გასაღებებისთვის (#4541)
 - დაარქვით `legacy_codec_decoder` `norito_cli`
...
- გადადით ახალ კონტეინერში, რათა თავიდან აიცილოთ კონფლიქტები მიმდინარე მომხმარებლებთან.
 - hyperledger#2158 განაახლეთ `retired_codec` და სხვა დამოკიდებულებები. (Norito კოდეკი)
- შეასწორეთ აშენება.
