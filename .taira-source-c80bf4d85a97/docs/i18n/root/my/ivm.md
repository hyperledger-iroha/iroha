...
ဤဖိုင်သည် IVM ဗိသုကာနှင့် ABI မှတ်စုများအတွက် workspace root ရှိ အဓိက အဝင်စာတမ်းဖြစ်သည်။
အသေးစိတ် စာတမ်းများကို `docs/source/` နှင့် `crates/ivm/docs/` အောက်တွင် တွေ့နိုင်သည်။
