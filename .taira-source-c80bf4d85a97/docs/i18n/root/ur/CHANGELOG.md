...
- `retired_codec` استعمال کو `norito::codec` کے ساتھ کریٹوں میں تبدیل کریں۔
- ٹولنگ کو آبائی I18NT0000000020x سیریلائزیشن میں منتقل کرنا شروع کریں۔
- مقامی I18NT000000000021x سیریلائزیشن کے حق میں ورک اسپیس سے باقی `retired codec` انحصار کو ہٹا دیں۔
...
- نجی چابیاں (#4541) کے لئے ملٹی ہش فارمیٹ استعمال کریں
 - `legacy_codec_decoder` کا نام `norito_cli` کا نام دیں
...
- موجودہ صارفین کے ساتھ تنازعات کو روکنے کے لئے نئے کنٹینر میں جائیں۔
 - ہائپرلیجر#2158 اپ گریڈ `retired_codec` اور دیگر انحصار۔ (i18nt00000031x کوڈیک)
- تعمیر کو ٹھیک کریں۔
