...
- CI һаҡсыһы: `scripts/check_no_legacy_codec.sh` retired codec тәьмин итә (I18NI000000093X) тик I18NT0000000010X эталон йүгәнендә генә күренә. Урынында йүгерергә, әгәр һеҙ ҡағыла сериализация коды.
