...
Ce fichier est le point d’entrée situé à la racine du workspace pour les notes sur l’architecture et l’ABI d’IVM.
La documentation détaillée se trouve dans `docs/source/` et `crates/ivm/docs/`.
