...
Этот файл является входной точкой в корне workspace для заметок по архитектуре IVM и ABI.
Подробная документация находится в `docs/source/` и `crates/ivm/docs/`.
