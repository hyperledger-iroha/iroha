...
# Մեկնաբանություն աուդիտի նշումներ

Ստուգել է հետևյալ IVM մոդուլները և հաստատել, որ դրանց ներկառուցված/փաստաթղթային մեկնաբանությունները համընկնում են ընթացիկ վարքագծի հետ (կոդերի խմբագրում չի պահանջվում).
...
Աշխատանքային տարածքի մնացած արկղերը դեռ պետք է անցում կատարեն, եթե մեկնաբանությունների հետագա թարմացումներն անհրաժեշտ լինեն: