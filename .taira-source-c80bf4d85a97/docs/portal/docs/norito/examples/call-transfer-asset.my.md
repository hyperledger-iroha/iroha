...
- `FindAccountAssets` သို့မဟုတ် `iroha ledger asset list all --verbose` မှတစ်ဆင့် လက်ကျန်ငွေများကို စစ်ဆေးပြီး မက်တာဒေတာစောင့်သည် လွှဲပြောင်းသည့်အကြောင်းအရာကို မှတ်တမ်းတင်ထားကြောင်း အတည်ပြုရန် ဖြစ်ရပ်များကို စစ်ဆေးပါ။
