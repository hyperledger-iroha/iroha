...
- Vérifiez les soldes via `FindAccountAssets` ou `iroha ledger asset list all --verbose` et inspectez les événements pour confirmer que le garde de métadonnées a journalisé le contexte du transfert.
