...
| 3 | `cargo run -p sorafs_car --bin sorafs_manifest_chunk_store -- --list-profiles` | `sorafs.sf1@1.0.0` သည် မှတ်ပုံတင်ခြင်းဖော်ပြချက် (`profile_id=1`) နှင့် ကိုက်ညီပါသည်။ | မှတ်ပုံတင်ခြင်း မက်တာဒေတာသည် တစ်ပြိုင်တည်းရှိနေကြောင်း သေချာစေပါသည်။ |
