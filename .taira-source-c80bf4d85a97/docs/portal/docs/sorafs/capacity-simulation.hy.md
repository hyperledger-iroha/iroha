...
`run_cli.sh`-ը փաթաթում է `sorafs_manifest_builder capacity`՝ արտանետելու Norito օգտակար բեռներ, base64 բլբեր, Torii հարցումների մարմիններ և JSON ամփոփագրեր՝
