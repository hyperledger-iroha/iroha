...
title: מדריך תאימות chunker של SoraFS
sidebar_label: תאימות chunker
description: דרישות ותהליכי עבודה לשימור פרופיל chunker דטרמיניסטי SF1 לאורך fixtures ו-SDKs.
---
