...
---
title: Digest del libro mayor de reserva y dashboards
description: Cómo convertir la salida de `sorafs reserve ledger` en telemetría, dashboards y alertas para la política Reserve+Rent.
---
