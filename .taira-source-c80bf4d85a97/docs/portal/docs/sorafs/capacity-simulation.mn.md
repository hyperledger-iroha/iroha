...
`run_cli.sh` нь `sorafs_manifest_builder capacity`-ийг ороож, Norito ачаалал, base64 blob, Torii хүсэлтийн биетүүд болон JSON хураангуйг:
