...
---
title: Юрисдикционный обзор GAR (SNNet-9)
sidebar_label: Юрисдикционный обзор GAR
description: Подписанные решения по юрисдикциям и digests Blake2b для интеграции в конфигурации compliance SoraNet.
---
