...
title: מדריך תפעול שירות הפאזלים
sidebar_label: Ops לשירות הפאזלים
description: תפעול ה-daemon `soranet-puzzle-service` עבור admission tickets של Argon2/ML-DSA.
---
