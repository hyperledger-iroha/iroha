...
- Хийн төлж буй гүйлгээ бүр `LaneSettlementReceipt` гэж бичдэг.  Тус бүр
  ...
  хэлбэлзэл (`xor_variance`), миллисекундээр блокийн цагийн тэмдэг.
- Гүйцэтгэлийг блоклох нь нэг эгнээ/өгөгдлийн орон зайд хүлээн авсан дүнг нэгтгэж, нийтэлдэг.
  ...
  `total_local_amount`, `total_xor_due`, болон
  `total_xor_after_haircut`-ийг шөнийн цагаар нийтэлсэн
  эвлэрүүлэх экспорт.
- Шинэ `total_xor_variance` тоолуур нь аюулгүй байдлын маржин хэр их байсныг хянадаг
