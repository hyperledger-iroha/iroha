...
- **Sora Taira (testnet)** - prefixe reseau de staging `taira`, miroir de la configuration mainnet pour les tests d'integration et la validation pre-release (chain UUID `fc56984b-2be7-431d-840e-21514d1883f0`).
