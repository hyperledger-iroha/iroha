...
- ဓာတ်ငွေ့ပေးဆောင်သည့် အရောင်းအ၀ယ်တိုင်းတွင် `LaneSettlementReceipt` မှတ်တမ်းရှိသည်။  အသီးသီး
  ...
  ကွဲပြားမှု (`xor_variance`) နှင့် ပိတ်ဆို့အချိန်တံဆိပ်ကို မီလီစက္ကန့်များအတွင်း။
- လမ်းသွား/ဒေတာနေရာလွတ်အလိုက် လက်ခံဖြတ်ပိုင်းများကို စုစည်းပြီး ၎င်းတို့ကို ထုတ်ဝေပါ။
  ...
  `total_local_amount`၊ `total_xor_due`၊ နှင့်
  `total_xor_after_haircut` သည် ညတိုင်းအတွက် ဘလောက်ကို ခြုံငုံထားသည်။
  ပြန်လည်သင့်မြတ်ရေး တင်ပို့မှု။
- `total_xor_variance` ကောင်တာအသစ်တစ်ခုသည် ဘေးကင်းလုံခြုံရေးအနားသတ်မည်မျှရှိသည်ကို ခြေရာခံသည်။
