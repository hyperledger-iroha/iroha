...
| Outillage CLI | أدخل `sorafs_manifest_builder` مع الأوامر التالية: `provider-admission proposal`، `provider-admission sign`، `provider-admission verify`. | الأدوات مجموعة العمل | ✅ |
...
1. حدد المظروف الذي تعرض للاختراق وقم بإبطاله :
   ...
   `verify_revocation_signatures`، وتقرير ملخص الإلغاء. 【crates/sorafs_car/src/bin/sorafs_manifest_builder/provider_admission.rs#L593】【F:crates/sorafs_manifest/src/provider_admission.rs#L486】
