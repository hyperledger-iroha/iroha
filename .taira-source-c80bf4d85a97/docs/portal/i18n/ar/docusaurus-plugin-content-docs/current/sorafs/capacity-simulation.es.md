...
`run_cli.sh` يرسل `sorafs_manifest_builder capacity` لإصدار الحمولات النافعة Norito، وblobs base64، ومجموعة طلبات Torii واستئناف JSON لـ:- ثلاثة تصريحات من الموردين المشاركين في سيناريو مفاوضات الشراء.
