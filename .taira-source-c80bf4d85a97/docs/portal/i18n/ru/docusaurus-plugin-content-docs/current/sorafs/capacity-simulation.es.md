...
`run_cli.sh` конвертирует `sorafs_manifest_builder capacity` для отправки полезных данных Norito, больших двоичных объектов base64, запроса на Torii и резюме JSON для:
