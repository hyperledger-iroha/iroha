...
##### `colr.010` / `.011` / `.012` (управление обеспечением)
...
- **Прием Torii** → Отправьте ветки финансирования PvP через `POST /v1/iso20022/pacs009`; мост
...
### Замена обеспечения РЕПО → `colr.012`| Поле/контекст репо | Путь ISO 20022 | Заметки |
|-------------------------------------------------|-----------------------------------|-------|
