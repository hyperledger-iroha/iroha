...
Los operadores deben regenerar las cargas útiles de solicitud de onboarding/disputa con `sorafs_manifest_builder capacity {declaration,dispute}` y archivar los bytes JSON/Norito resultantes junto al ticket de gobernanza.
