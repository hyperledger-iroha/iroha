...
2. ابن او نزّل الثنائيات الداعمة:
   - `koto build` - Archivo Kotodama Código de bytes IVM/Norito
...
- La versión `koto build` de ABI incluye la versión `koto build --help` de ABI v1 (la versión `koto build --help`) لعرض الدعم).
