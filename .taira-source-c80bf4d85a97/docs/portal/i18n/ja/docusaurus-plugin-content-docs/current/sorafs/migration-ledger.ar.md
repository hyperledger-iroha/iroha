...
|----------|--------------|--------------|--------------|---------------|----------|
| M0 | 1–6 |チャンカーの試合結果パイプライン、CAR + マニフェスト、アーティファクト、最高です。 |ドキュメント、DevRel、SDK | اعتماد `sorafs_manifest_builder` مع flags التوقع، تسجيل الإدخالات في هذا السجل، الحفاظ على الـ CDN القديم。 | ✅ こんにちわ |
