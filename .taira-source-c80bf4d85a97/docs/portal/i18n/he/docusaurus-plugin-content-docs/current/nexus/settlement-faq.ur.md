...
שאלות נפוצות על יישוב חשבונאות (`docs/source/nexus_settlement_faq.md`) کو mono-repo میں تلاش کیے بغیر دیکھ سکیں۔ נתב התיישבות התיישבות הנתב התיישבות کرنی ہے، اور SDKs کو Norito payloads کیسے ضم کرنے چاہیئیں۔
...
|-----------|------------------------|----------------|
| מקור `xor_hosted_custody` | יומן נתב + `nexus_settlement_latency_seconds{lane}` + `settlement_router_haircut_total{lane}` | CBDC buffers متعین XOR ڈیبٹ کرتے ہیں اور haircuts پالیسی کے اندر رہتے ہیں۔ |
...
- שאלות נפוצות על מוצר: `docs/source/nexus_settlement_faq.md`
- מפרט נתב יישוב: `docs/source/settlement_router.md`
- CBDC پالیسی playbook: `docs/source/cbdc_lane_playbook.md`
- פנקס פעולות: [Nexus פעולות](./nexus-operations)