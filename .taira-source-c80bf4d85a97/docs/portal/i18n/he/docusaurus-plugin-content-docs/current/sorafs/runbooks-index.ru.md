...
---
id: runbooks-index
כותרת: Индекс операторских ранбуков
sidebar_label: Индекс ранбуков
תיאור: Каноническая точка входа для мигрированных операторских ранбуков SoraFS.
---

> Отражает реестр владельцев, который находится в `docs/source/sorafs/runbooks/`.
> Каждое новое руководство по операциям SoraFS должно быть связано здесле после публикации
> сборке портала.
...
Волна DocOps уже повысила одобренный ревьюерами хост бета‑превью על `https://docs.iroha.tech/`.
...
|--------|--------|----------------|---------|
| שער Запуск ו-DNS | Networking TL, Ops Automation, Docs/DevRel | [`sorafs/gateway-dns-runbook`](./gateway-dns-runbook.md) | `docs/source/sorafs_gateway_dns_design_runbook.md` |
...
| Сверка ёмкости | האוצר / SRE | [`sorafs/capacity-reconciliation`](./capacity-reconciliation.md) | `docs/source/sorafs/runbooks/capacity_reconciliation.md` |
| Операции реестра пинов | Tooling WG | [`sorafs/pin-registry-ops`](./pin-registry-ops.md) | `docs/source/sorafs/pin_registry_ops.md` |
| Чеклист операций узла | צוות אחסון, SRE | [`sorafs/node-operations`](./node-operations.md) | `docs/source/sorafs/runbooks/sorafs_node_ops.md` |
| Ранбук споров и отзывов | מועצת ממשל | [`sorafs/dispute-revocation-runbook`](./dispute-revocation-runbook.md) | `docs/source/sorafs/dispute_revocation_runbook.md` |
...
| Наблюдаемость якоря Taikai | פלטפורמת מדיה WG / DA Program / Networking TL | [`sorafs/taikai-anchor-runbook`](./taikai-anchor-runbook.md) | `docs/source/taikai_anchor_monitoring.md` |
