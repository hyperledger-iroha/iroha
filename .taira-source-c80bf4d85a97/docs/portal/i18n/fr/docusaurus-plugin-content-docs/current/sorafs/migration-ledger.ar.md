...
|--------|---------------|--------------|----------------|-------------|--------|
| M0 | أسابيع 1–6 | نُشرت luminaires للـ chunker؛ تصدر pipelines حزما من CAR + manifeste إلى جانب artefacts القديمة؛ تم إنشاء إدخالات السجل. | Docs, DevRel, SDK | Utilisez `sorafs_manifest_builder` pour les drapeaux associés aux paramètres du CDN. | ✅ نشط |
