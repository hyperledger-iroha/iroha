...
`run_cli.sh` envia `sorafs_manifest_builder capacity` para emitir payloads Norito, blobs base64, campos de solicitação para Torii e resumos JSON para:
