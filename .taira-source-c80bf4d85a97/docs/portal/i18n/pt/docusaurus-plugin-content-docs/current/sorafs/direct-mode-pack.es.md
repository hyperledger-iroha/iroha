...
- `fetch_command_respects_direct_transports` executa `sorafs_cli fetch --transport-policy=direct-only` contra um gateway Torii simulado, proporcionando uma experiência de humor para ambientes regulados que fijan transporta diretamente.【crates/sorafs_orchestrator/tests/sorafs_cli.rs:2733】
