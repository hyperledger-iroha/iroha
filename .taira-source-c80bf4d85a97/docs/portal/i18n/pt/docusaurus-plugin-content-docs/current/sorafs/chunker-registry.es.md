...
| `sorafs_manifest_builder` | ⚠️ Retirado | Construtor de manifesto fora de suporte; usa `iroha app sorafs toolkit pack` para CAR/manifesto empaquetado e mantém `--plan=-` para revalidação determinista. |
