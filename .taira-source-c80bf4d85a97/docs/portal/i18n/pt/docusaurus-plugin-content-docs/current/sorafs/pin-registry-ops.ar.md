...
3. **اعادة اسناد التكرار**
   - اصدر اوامر جديدة عبر `sorafs_manifest_builder capacity replication-order` عندما ينخفض هامش التراكم (`stat="avg"`) em 5 etapas (تغليف manifest/CAR يستخدم `iroha app sorafs toolkit pack`).
