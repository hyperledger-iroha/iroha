...
3. **Reatribuir replicacao**
   - Emita novas ordens via `sorafs_manifest_builder capacity replication-order` quando a folga do backlog (`stat="avg"`) cair abaixo de 5 épocas (o empacotamento de manifesto/CAR usa `iroha app sorafs toolkit pack`).
