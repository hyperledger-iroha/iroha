...
| CLI de ferramentas | Extensor `sorafs_manifest_builder` com subcomandos: `provider-admission proposal`, `provider-admission sign`, `provider-admission verify`. | GT Ferramentaria | ✅ |
