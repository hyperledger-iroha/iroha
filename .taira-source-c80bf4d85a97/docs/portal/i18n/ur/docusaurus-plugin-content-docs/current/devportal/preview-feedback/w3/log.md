...
نیچے درج ایونٹس `artifacts/docs_portal_preview/feedback_log.json` میں بھی ملتے ہیں
اور `preview-20260218-summary.json` / `preview-20260218-digest.md` میں سمری ہوتے ہیں۔

| ٹائم اسٹیمپ (UTC) | ایونٹ | موصول کنندہ | نوٹس |
| --- | --- | --- | --- |
| 2026-02-18 14:00 | invite-sent | finance-beta-01 | فنانس پائلٹ کوہورٹ |
...
`npm run --prefix docs/portal preview:wave -- --wave preview-20260218 --invite-start 2026-02-18 --invite-end 2026-02-28 --report-date 2026-03-01`
استعمال کر کے اس لاگ کو اپ ڈیٹ کرتے وقت digest اور portal data دوبارہ بنائیں۔
