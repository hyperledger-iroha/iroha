...
1. ریلے ایڈمن اینڈ پوائنٹس کے علاوہ `/v1/soranet/privacy/event|share` اسٹریم سے آرکسٹیٹر سے `artifacts/sorafs_privacy/<relay>.ndjson` پر NDJSON برآمد کریں۔
