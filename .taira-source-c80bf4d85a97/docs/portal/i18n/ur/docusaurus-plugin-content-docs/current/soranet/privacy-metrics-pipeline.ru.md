...
1. ایڈمن اینڈ پوائنٹس ریلے اور آرکسٹریٹر اسٹریم `/v1/soranet/privacy/event|share` سے `artifacts/sorafs_privacy/<relay>.ndjson` سے NDJSON برآمد کریں۔
