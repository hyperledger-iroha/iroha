...
3. **Replication کی reassign**
   - جب backlog slack (`stat="avg"`) 5 epochs سے نیچے جائے تو `sorafs_manifest_builder capacity replication-order` کے ذریعے نئے orders جاری کریں (manifest/CAR packaging `iroha app sorafs toolkit pack` استعمال کرتا ہے)۔
