...
- ** پائپ لائن/ایس ایس ای ٹیسٹ۔ اس فلٹر کے ساتھ `/v1/pipeline/events/transactions` کو سبسکرائب کریں تاکہ یہ ثابت کیا جاسکے کہ واضح لین کے بغیر بھیجے گئے ریکارڈ فال بیک لین ID کے تحت آتے ہیں۔
