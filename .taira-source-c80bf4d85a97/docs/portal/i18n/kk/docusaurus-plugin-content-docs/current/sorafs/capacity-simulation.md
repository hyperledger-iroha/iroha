...
`run_cli.sh` `sorafs_manifest_builder capacity` орап, Norito пайдалы жүктемелерді, base64 блобтарын, Torii сұрау элементтерін және JSON қорытындыларын шығарады:
