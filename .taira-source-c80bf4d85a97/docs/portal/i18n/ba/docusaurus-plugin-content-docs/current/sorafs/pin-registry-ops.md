...
3. **Респумент репликация**
   - `sorafs_manifest_builder capacity replication-order` аша яңы заказдар сығарыу ҡасан артта ҡалған ялҡаулыҡ (I18NI000000074X) 5 эпоханан түбәнерәк төшә (махсус/CAR упаковкаһы `iroha app sorafs toolkit pack` ҡуллана).
