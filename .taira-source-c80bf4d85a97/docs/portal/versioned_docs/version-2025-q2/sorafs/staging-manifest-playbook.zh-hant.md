...
id: staging-manifest-playbook-zh-hant
...
slug: /sorafs/staging-manifest-playbook-zh-hant
---

:::注意規範來源
鏡子 `docs/source/sorafs/runbooks/staging_manifest_playbook.md`。保持兩個副本在各個版本之間保持一致。
:::
