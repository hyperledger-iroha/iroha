...
3. **Хуулбарыг дахин хуваарилах**
   - Хоцрогдол (`stat="avg"`) 5 үеээс доош буурах үед `sorafs_manifest_builder capacity replication-order`-ээр шинэ захиалга гаргана (манифест/МАШИНЫ савлагаанд `iroha app sorafs toolkit pack` ашигладаг).
