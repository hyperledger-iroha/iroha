...
slug: /sorafs/pin-registry-ops-my
---

::: Canonical Source ကို သတိပြုပါ။
မှန်ချပ်များ `docs/source/sorafs/runbooks/pin_registry_ops.md`။ ဗားရှင်းနှစ်မျိုးလုံးကို ထုတ်ဝေမှုများတစ်လျှောက် ချိန်ညှိထားပါ။
:::

## ခြုံငုံသုံးသပ်ချက်

ဤ runbook သည် SoraFS pin registry နှင့် ၎င်း၏ ထပ်တူပြုခြင်းဝန်ဆောင်မှုအဆင့် သဘောတူညီချက်များ (SLAs) ကို စောင့်ကြည့်ပြီး စမ်းသပ်နည်းကို မှတ်တမ်းတင်ထားသည်။ မက်ထရစ်များကို `iroha_torii` မှ မြစ်ဖျားခံပြီး `torii_sorafs_*` အမည်စကွက်အောက်တွင် Prometheus မှတဆင့် တင်ပို့သည်။ Torii သည် နောက်ခံ 30 စက္ကန့်ကြားကာလတွင် registry state ကိုနမူနာယူသည်၊ ထို့ကြောင့် `/v1/sorafs/pin/*` အဆုံးမှတ်များကို စစ်တမ်းကောက်ယူသည့်အော်ပရေတာများမရှိသည့်တိုင် ဒက်ရှ်ဘုတ်များသည် လက်ရှိရှိနေပါသည်။ အောက်ဖော်ပြပါ ကဏ္ဍများသို့ တိုက်ရိုက်မြေပုံထုတ်သည့် အဆင်သင့်အသုံးပြုနိုင်သော Grafana အပြင်အဆင်အတွက် ရွေးချယ်ထားသော ဒက်ရှ်ဘုတ် (`docs/source/grafana_sorafs_pin_registry.json`) ကို တင်သွင်းပါ။
...
| `torii_sorafs_replication_sla_total` | `outcome` (`met` \| `missed` \| `pending`) | SLA စာရင်းကိုင်- `met` သည် နောက်ဆုံးသတ်မှတ်ရက်အတွင်း ပြီးမြောက်သော မှာယူမှုများကို ရေတွက်သည်၊ `missed` သည် နောက်ကျပြီးစီးမှုများ + သက်တမ်းကုန်ဆုံးခြင်း၊ `pending` သည် ထူးခြားသောအော်ဒါများကို ထင်ဟပ်စေသည်။ |
...
လျှပ်တစ်ပြက်ဆွဲခြင်းတိုင်းတွင် တိုင်းတာမှုအားလုံးကို ပြန်လည်သတ်မှတ်ထားပါသည်၊ ထို့ကြောင့် ဒက်ရှ်ဘုတ်များသည် `1m` cadence သို့မဟုတ် ထို့ထက်ပိုမိုမြန်ဆန်သင့်သည်။
...
6. **Latency vs deadline slack** – ထပ်ဆင့် `torii_sorafs_replication_completion_latency_epochs{stat="p95"}` နှင့် `torii_sorafs_replication_deadline_slack_epochs{stat="avg"}`။ ဥပမာအားဖြင့် သင်သည် လုံးဝ slack ကြမ်းပြင်ကို လိုအပ်သည့်အခါ `min_over_time` ကြည့်ရှုမှုများကို ထည့်ရန် Grafana အသွင်ပြောင်းမှုများကို အသုံးပြုပါ။
...
## သတိပေးချက်အဆင့်များ- ** SLA အောင်မြင်မှု  0**
...
1. **အကြောင်းရင်းကို ဖော်ထုတ်ပါ**
   ...
   - တည်ငြိမ်သော လွဲချော်မှုများဖြင့် နောက်ကျကျန်နေပါက ကောင်စီ၏အတည်ပြုချက်ကို စောင့်ဆိုင်းနေသော ထင်ရှားသည့်ရလဒ်များကို အတည်ပြုရန် ဝင်ခွင့် (`/v1/sorafs/pin/*`) ကို စစ်ဆေးပါ။
2. **ဝန်ဆောင်မှုပေးသူ အခြေအနေကို အတည်ပြုပါ**
   - `iroha app sorafs providers list` ကို run ပြီး ကြော်ငြာထားသော စွမ်းရည်များကို ထပ်တူပြုခြင်း လိုအပ်ချက်များနှင့် ကိုက်ညီကြောင်း စစ်ဆေးပါ။
...
3. **ပုံတူကူးခြင်းကို ပြန်လည်သတ်မှတ်ရန်**
   - backlog slack (`stat="avg"`) သည် 5 ပိုင်းအောက် ကျဆင်းသွားသောအခါတွင် `sorafs_manifest_builder capacity replication-order` မှတစ်ဆင့် အမှာစာအသစ်များ ထုတ်ပေးပါသည်။
   - နာမည်တူများသည် တက်ကြွသောထင်ရှားသောစည်းနှောင်မှုများမရှိလျှင် (`torii_sorafs_registry_aliases_total` မမျှော်လင့်ဘဲကျဆင်းသွားသည်)။
4. **စာရွက်စာတမ်းရလဒ်**
...
ထုတ်လုပ်ရေးတွင် alias cache မူဝါဒကို ဖွင့်ရန် သို့မဟုတ် တင်းကျပ်သည့်အခါ ဤအဆင့်သတ်မှတ်ထားသော လုပ်ထုံးလုပ်နည်းကို လိုက်နာပါ-1. **ဖွဲ့စည်းပုံပြင်ဆင်ခြင်း**
   - `torii.sorafs_alias_cache` ကို `iroha_config` (အသုံးပြုသူ → အမှန်တကယ်) တွင် သဘောတူထားသည့် TTLs များနှင့် ကျေးဇူးတော်ဝင်းဒိုးများ- `positive_ttl`၊ `refresh_window`၊ `hard_expiry`, I180NI0800, I180NI0800, `rotation_max_age`၊ `successor_grace` နှင့် `governance_grace`။ မူရင်းများသည် `docs/source/sorafs_alias_policy.md` ရှိ မူဝါဒနှင့် ကိုက်ညီပါသည်။
...
2. **Dry-run in stage**
   ...
   - လတ်ဆတ်သော၊ ပြန်လည်ဆန်းသစ်-ဝင်းဒိုး၊ သက်တမ်းကုန်သွားသော၊ နှင့် ခက်ခဲသောသက်တမ်းကုန်ဆုံးသွားသောကိစ္စများကို ပေါင်းစပ်ထားသော ဓာတုအထောက်အထားများဖြင့် `/v1/sorafs/pin/{digest}` နှင့် `/v1/sorafs/aliases` ကို လေ့ကျင့်ပါ။ HTTP အခြေအနေကုဒ်များ၊ ခေါင်းစီးများ (`Sora-Proof-Status`၊ `Retry-After`၊ `Warning`) နှင့် JSON ကိုယ်ထည်အကွက်များကို ဤ runbook နှင့် ကိုက်ညီအောင် စစ်ဆေးပါ။
...
4. ** ဖြန့်ကျက်ပြီးနောက် အတည်ပြုခြင်း**
   - `torii_sorafs_alias_cache_refresh_total` နှင့် `torii_sorafs_alias_cache_age_seconds` ကို မိနစ် 30 စောင့်ကြည့်ပါ။ `error`/`expired` မျဉ်းကွေးများတွင် နှိုက်နှိုက်ချွတ်ချွတ်များသည် မူဝါဒပြန်လည်စတင်သည့်ဝင်းဒိုးများနှင့် ဆက်စပ်နေသင့်သည်။ မမျှော်လင့်ထားသော တိုးတက်မှုဆိုလိုသည်မှာ အော်ပရေတာများသည် ဆက်မလုပ်မီ နာမည်တူအထောက်အထားများနှင့် ပံ့ပိုးပေးသူကျန်းမာရေးကို စစ်ဆေးရပါမည်။
...
5. **နောက်ပြန်ဆွဲ**
   - နာမည်တူများထုတ်ပေးခြင်းနောက်ကျသွားကာ ပြန်လည်ဆန်းသစ်သည့်ဝင်းဒိုးခရီးစဉ်များ မကြာခဏပြုလုပ်ပါက၊ Config တွင် `refresh_window` နှင့် `positive_ttl` ကို တိုးမြှင့်ခြင်းဖြင့် မူဝါဒကို ယာယီဖြေလျှော့ပါ၊ ထို့နောက် ပြန်လည်အသုံးချပါ။ `hard_expiry` ကို နဂိုအတိုင်းထားပါ၊ ထို့ကြောင့် အမှန်တကယ် ဟောင်းနွမ်းနေသော အထောက်အထားများကို ပယ်ချဆဲဖြစ်သည်။
   - တယ်လီမီတာမှ မြင့်မားသော `error` ရေတွက်မှုများ ဆက်လက်ပြသနေပါက ယခင် `iroha_config` လျှပ်တစ်ပြက်ကို ပြန်ယူခြင်းဖြင့် ယခင်ဖွဲ့စည်းပုံသို့ ပြန်ပြောင်းကာ alias မျိုးဆက်နှောင့်နှေးမှုများကို ခြေရာခံရန် အဖြစ်အပျက်တစ်ခုကို ဖွင့်ပါ။
