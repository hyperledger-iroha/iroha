...
export function resolveToriiClientConfig(input = {}) {
  ...
  for (const source of sources) {
    ...
    for (const removedOption of ["transactionStatusScope", "statusEndpoints"]) {
      if (Object.prototype.hasOwnProperty.call(source, removedOption)) {
        throw new TypeError(`${removedOption} is no longer supported`);
      }
    }
