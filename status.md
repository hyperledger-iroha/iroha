...
- Sakura Storm v27: added `v26_preview` palette (extracted from the v26 fullwidth katakana preview) and made katabox default to it with v26-style annular data bands + smaller logo hole and stronger katakana box/text contrast; symbol replay builds the logo mask for `SS_KATAKANA_OUTSIDE_LOGO` even when overlay is off.
