...
## Latest Updates
- RBC: throttle READY chunk-root mismatch logs via mismatch throttling, make pending-session stash cap configurable, refactor allocation weighting, unify chunking logic, add persist-queue drop telemetry, and refresh docs/tests. Tests: not run (not requested).
