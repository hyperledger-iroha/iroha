...
FRESH_EVIDENCE_REQUIRED_FIELDS = COMMON_EVIDENCE_REQUIRED_FIELDS + (
    "generated_at_unix",
)
EVIDENCE_REQUIRED_FIELDS: dict[str, tuple[str, ...]] = {
    "appeal_intake": FRESH_EVIDENCE_REQUIRED_FIELDS
    + (
        "case_digest_hex",
        "route_count",
        "passed_route_count",
    ...
    "sortition_roster": FRESH_EVIDENCE_REQUIRED_FIELDS
    + (
        "case_digest_hex",
    ...
    "evidence_viewer": FRESH_EVIDENCE_REQUIRED_FIELDS
    + (
        "case_digest_hex",
        "roster_hash_hex",
        "session_count",
    ...
    "operator_workflow": FRESH_EVIDENCE_REQUIRED_FIELDS
    + (
        "case_digest_hex",
        "roster_hash_hex",
        "route_count",
    ...
    "juror_notifications": FRESH_EVIDENCE_REQUIRED_FIELDS
    + (
        "case_digest_hex",
        "roster_hash_hex",
        "notification_count",
    ...
    "commit_reveal": FRESH_EVIDENCE_REQUIRED_FIELDS
    + (
        "case_digest_hex",
        "roster_hash_hex",
        "route_count",
    ...
    "decision_publication": FRESH_EVIDENCE_REQUIRED_FIELDS
    + (
        "case_digest_hex",
        "roster_hash_hex",
        "tally_digest_hex",
    ...
    "settlement_integration": FRESH_EVIDENCE_REQUIRED_FIELDS
    + (
        "case_digest_hex",
        "roster_hash_hex",
        "tally_digest_hex",
    ...
    "transparency_reputation": FRESH_EVIDENCE_REQUIRED_FIELDS
    + (
        "case_digest_hex",
        "roster_hash_hex",
        "tally_digest_hex",
    ...
    "e2e_panel": FRESH_EVIDENCE_REQUIRED_FIELDS
    + (
        "case_digest_hex",
        "roster_hash_hex",
        "tally_digest_hex",
...
def build_summary(
    ...
    for path in files:
        ...
        if evidence_artifact_is_valid(artifact):
            ...
            if kind_name == "appeal_intake" and isinstance(case_digest, str):
                valid_case_digests.add(case_digest)
    ...
    valid_case_digests = require_single_active_digest(
        valid_case_digests,
        errors,
        label="valid_case_digests",
    )
    validate_bound_evidence_digest_references(
    ...
    for artifact in roster_candidate_artifacts:
        if evidence_artifact_is_valid(artifact):
            ...
            if isinstance(case_digest, str) and isinstance(roster_hash, str):
                valid_roster_bindings.add((case_digest, roster_hash))

    valid_roster_bindings = require_single_active_binding(
        valid_roster_bindings,
        errors,
        label="valid_roster_bindings",
    )
    validate_bound_evidence_tuple_references(
        required_kinds=required_kinds,
        missing_anchor_required_kinds=tuple(KIND_BY_NAME),
        ...
        if evidence_artifact_is_valid(artifact):
            ...
            if (
                ...
                valid_tally_bindings.add(
                    (case_digest, roster_hash, tally_digest)
                )

    valid_tally_bindings = require_single_active_binding(
        valid_tally_bindings,
        errors,
        label="valid_tally_bindings",
    )
    validate_bound_evidence_tuple_references(
        required_kinds=required_kinds,
        missing_anchor_required_kinds=tuple(KIND_BY_NAME),
