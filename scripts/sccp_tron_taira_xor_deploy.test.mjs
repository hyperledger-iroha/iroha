...
test("TRON endpoint normalization rejects unsafe deployment gateway overrides", () => {
  ...
  assert.throws(() => normalizeTronEndpoint("https://api.trongrid.io/root;param"), /params, query strings, or fragments/);
  assert.throws(() => normalizeTronEndpoint("https://api.trongrid.io?api_key=secret"), /params, query strings, or fragments/);
  assert.throws(() => normalizeTronEndpoint("https://api.trongrid.io/#fragment"), /params, query strings, or fragments/);
  assert.throws(() => normalizeTronEndpoint(" https://api.trongrid.io"), /exact HTTPS URL/);
  assert.throws(() => normalizeTronEndpoint("https://api.trongrid.io\nsecret"), /exact HTTPS URL/);
  assert.throws(() => normalizeTronEndpoint("https://localhost"), /public DNS/);
  assert.throws(() => normalizeTronEndpoint("https://node.localhost"), /public DNS/);
  assert.throws(() => normalizeTronEndpoint("https://local"), /public DNS/);
  assert.throws(() => normalizeTronEndpoint("https://tron.local"), /public DNS/);
  assert.throws(() => normalizeTronEndpoint("https://bad_host.trongrid.io"), /public DNS/);
  assert.throws(() => normalizeTronEndpoint("https://0.0.0.0"), /public DNS/);
  assert.throws(() => normalizeTronEndpoint("https://8.8.8.8"), /public DNS/);
  assert.throws(() => normalizeTronEndpoint("https://127.0.0.1"), /public DNS/);
  assert.throws(() => normalizeTronEndpoint("https://10.0.0.7"), /public DNS/);
  assert.throws(() => normalizeTronEndpoint("https://100.64.0.1"), /public DNS/);
  assert.throws(() => normalizeTronEndpoint("https://172.16.0.1"), /public DNS/);
  assert.throws(() => normalizeTronEndpoint("https://192.0.0.1"), /public DNS/);
  assert.throws(() => normalizeTronEndpoint("https://192.168.1.2"), /public DNS/);
  assert.throws(() => normalizeTronEndpoint("https://198.18.0.1"), /public DNS/);
  assert.throws(() => normalizeTronEndpoint("https://224.0.0.1"), /public DNS/);
  assert.throws(() => normalizeTronEndpoint("https://[::1]"), /public DNS/);
  assert.throws(() => normalizeTronEndpoint("https://[fd00::1]"), /public DNS/);
  assert.throws(() => normalizeTronEndpoint("https://[fe80::1]"), /public DNS/);
  assert.throws(() => normalizeTronEndpoint("https://[::ffff:127.0.0.1]"), /public DNS/);
  assert.throws(() => normalizeTronEndpoint("https://[::7f00:1]"), /public DNS/);
  assert.throws(() => normalizeTronEndpoint("https://[64:ff9b::7f00:1]"), /public DNS/);
  assert.throws(() => normalizeTronEndpoint("https://[2002:7f00:0001::1]"), /public DNS/);
  assert.throws(() => normalizeTronEndpoint("https://[2001:0000:7f00:0001::1]"), /public DNS/);
  assert.throws(() => normalizeTronEndpoint("https://[2001:db8::1]"), /public DNS/);
});
