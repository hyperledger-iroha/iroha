#!/usr/bin/env python3
"""Fail-closed verifier for the ABI-21 bridge embedded in an APK or AAB."""
...
def strict_provenance(payload: bytes) -> dict[str, object]:
    ...
    if (
        ...
        or decoded["native_bridge_abi_version"] != 21
...
def main(argv: list[str]) -> int:
    try:
        ...
        return 1
    print("[android-native-archive] authenticated ABI-21 bridge bytes match SDK AAR and app archive")
    return 0
