...
""",
        "classified selector must delegate every candidate to the sealed ordinary-before-dependency choice",
        errors,
    )
    _require_rust_token_sequence(
        ingress_path,
...
""",
        "the shared selector must run barrier dependencies only after ordinary candidates and still execute the downstream predicate",
        errors,
    )
