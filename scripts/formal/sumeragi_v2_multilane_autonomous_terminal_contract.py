...
AUTONOMOUS_TERMINAL_ALL_BINDINGS = (
    ...
    (
        KURA_PIPELINE_AND_LANE_ARTIFACTS_RELATIVE,
        "method",
        "AutonomousLifecycleTerminalOutcomeV1::from_legacy_v1_body",
        (
            "body.version != Self::LEGACY_VERSION",
    ...
    (
        KURA_PIPELINE_AND_LANE_ARTIFACTS_RELATIVE,
        "method",
        "AutonomousLifecycleTerminalOutcomeV1::from_basis_v1_body",
        (
            "body.version != Self::LEGACY_VERSION",
    ...
    (
        KURA_PIPELINE_AND_LANE_ARTIFACTS_RELATIVE,
        "method",
        "AutonomousLifecycleTerminalOutcomeV1::from_v2_body",
        (
    ...
    (
        ...
        (
            "AutonomousLifecycleTerminalOutcomeWireV2 as norito::NoritoSerialize",
            "AutonomousLifecycleTerminalOutcomeBodyWire::V2(wire.body)",
            "LegacyAutonomousLifecycleTerminalOutcomeWireV1 as norito::NoritoSerialize",
            "BasisAutonomousLifecycleTerminalOutcomeWireV1>(bytes)",
            "LegacyAutonomousLifecycleTerminalOutcomeWireV1>(bytes)",
            "ambiguous autonomous lifecycle terminal outcome V1 layout",
            "AutonomousLifecycleTerminalOutcomeBodyWire::BasisV1(wire.body)",
            "AutonomousLifecycleTerminalOutcomeBodyWire::LegacyV1(wire.body)",
        ),
    ),
    (
        KURA_PIPELINE_AND_LANE_ARTIFACTS_RELATIVE,
    ...
    (
        ...
        (
            ...
            "AutonomousLifecycleTerminalOutcomeWireV2",
...
AUTONOMOUS_TERMINAL_ORDERED_SOURCE_CHECKS = (
    (
        ...
        (
            ...
            "AutonomousLifecycleTerminalOutcomeWireV2 as norito::NoritoSerialize",
            "AutonomousLifecycleTerminalOutcomeWireV2>(bytes)?",
            "LegacyAutonomousLifecycleTerminalOutcomeWireV1 as norito::NoritoSerialize",
            "BasisAutonomousLifecycleTerminalOutcomeWireV1>(bytes)",
            "LegacyAutonomousLifecycleTerminalOutcomeWireV1>(bytes)",
            "match (basis, legacy)",
