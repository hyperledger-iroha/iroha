...
&shutdown_signal, lifecycle_process_generation.as_ref(),
    ...
    for path, item, configured_role in (
        (
            lifecycle_runner_path,
            lifecycle_runner_items.get("ordinary_loop"),
        ...
        _require_rust_token_sequence(
            path,
            item,
            f"""V2LaneWorkAdapter::new_with_output_guard_and_transport(
&verified_context, local_peer.clone(), common_config.key_pair.clone(),
{configured_role}
""",
            "each lane adapter must derive production authority from the configured role while emergency Fast recovery remains read-only",
            errors,
        )
        _require_rust_token_sequence(
            path,
...
_PRODUCTION_CAUSAL_FIFO_RUST_ITEM_SHA256 = {
    ...
    "authenticated_command_reaches_fenced_reducer": (
        "f392d0b918b5de3c9a0ebe1988bca1ce3606a892e01e586acc4ed0c39385be16"
    ),
    # `SumeragiV2Adapter::ready_to_finish`; executor readiness is sealed by
    # `_REMOTE_PROPOSAL_REPLAY_ITEM_SHA256["executor_ready"]`.
    "ready_to_finish": (
    ...
    "drive_effects": (
        "9ad900f12ec31351eac3d2b0a19547a0150b1908a8a91cfb4dea93c3dee48fbc"
    ),
    ...
    "real_adapter_fence_completion_bypasses_only_preowned_fenced_fifo": (
        "a1f0f83ad17175625e4bea4775085ff13f429b977f1c3c9172c47c4c7feca3f0"
    ),
    "fresh_periodic_episodes_wait_behind_pre_and_post_timeout_signers": (
        "4e3eea8e449b8a60b7f949c0a8cafd6cc0dc7ab4c307b53db635620972a5d3a6"
    ),
...
_RUNTIME_ENQUEUE_NETWORK_WITH_INGRESS_OWNERSHIP_ITEM_SHA256 = (
    "614cf7b55b57f4b77ecaf42ccf56dd52595cd381a972c05ef0a3c358090f8a50"
)
_RUNTIME_RESTORED_PRE_RUNTIME_TC_CANNOT_DEADLOCK_ITEM_SHA256 = (
    "ea8f7476dd893d09f7a305ae41997398acaf8181076a9940bfe78fb1acfca429"
)
_AUTHENTICATED_DEFERRED_OWNERSHIP_RUST_ITEM_SHA256 = {
    ...
    "reconcile_deferred_ingress_ownership": (
        "95a34e027427518ac11bae4e4b192f4cfd730a3c000f4907009ccac7d5ae0710"
    ),
    ...
    "accept_driver_dispatch": (
        "d096e3315584ceb9b0065209ea3fc0271b8f373ed4d302ad9fcff753696e125d"
    ),
...
_PRODUCTION_CAUSAL_FIFO_RUNTIME_REGRESSION_SHA256 = {
    ...
    "deferred_physical_cut_blocks_only_pre_cut_leader_wire_occurrences": (
        "822c71a7fde81828eba3cddd72b77acdf3c58617f46289711d571b4370307b8a"
    ),
    "later_same_semantic_fair_retry_retains_runtime_lifecycle_root": (
        "14bba44de70d4f1aacc044a7ba5c24ebe3ff5ef101ab001ef908e8c57d4df2a4"
    ),
    "older_frozen_aggregate_carrier_rebases_queued_runtime_minimum": (
        "345c91f83b95bd60c22f94b54466d6e0d77fd6f8e78a3105a3c160478e2e598c"
    ),
    "network_runtime_rejects_unminted_and_unrelated_colliding_fair_ordinals": (
        "d0b4ba4bf07f6672872a4df8eea7394c40f60b176933373d44cfbd162cdf19e3"
    ),
    "distinct_pre_runtime_leader_wire_qc_waits_behind_busy_deferred_owner": (
        "46645c508c721ec7626fa026a115d5c94fa8e10f3dc806558ed14e5690de6e4c"
    ),
    "pacemaker_escape_coalesces_prequeued_distinct_origin_prepare_qc_into_live_busy_producer": (
        "fa8c2cdfd50d4bcf1df87378a6159114bb6b61209b4169d76382561f71420fbb"
    ),
...
_TIMEOUT_VOTE_EPISODE_RUNTIME_REGRESSION_SHA256 = {
    ...
    "restored_pre_runtime_timeout_vote_releases_only_an_absolute_timeout_cut": (
        "450f087197ffee53ff74ef29c3a21e890b95354fb6f1cea21bb0bf3b81e5033c"
    ),
    "pre_timeout_scheduler_owner_may_publish_across_the_physical_snapshot": (
        "845c0d0184b02c170a9dd1b21a45d17690634b008162a06167d49dbd0437013f"
    ),
    "two_fresh_timeout_vote_slots_replenish_once_and_close_a_four_validator_view": (
        "37e812b065d129e0ddd19f11cfa897c113a0e3bcc125f83ee3f7f851be9d4cfe"
    ),
...
_EFFECT_CAPACITY_PRODUCTION_RUST_ITEM_SHA256 = {
    "enqueue_network_with_ingress_ownership": (
        "b292bc0534213dd4cbc440dec35766700cff6ef4e7c86ef9485771300140ebb0"
    ),
    "can_admit_network_message_with_ingress_ownership": (
...
_EFFECT_CAPACITY_LIFECYCLE_RUST_ITEM_SHA256 = {
    ...
    "install_view": (
        "4394b964c82c9143a1e5c8056723a2775c7b33de457eb0f26ea790cd51cfc5ba"
    ),
    ...
    "production_capacity_saturation_admits_response_and_reconstructible_fetch": (
        "886404673d31a039059920f1cae0c716722c7218b363d876786a5df1194dc894"
    ),
...
_LATE_LANE_RECOVERY_TEST_SHA256 = (
    "7bdb8ae223b53522087e98d19643ea8c49b74eebe631d02c7a39472977579fc3"
)
...
_PRODUCTION_RETAINED_EFFECT_FIFO_ITEM_SHA256 = {
    ...
    "retain_effect_batch_at_frontier": (
        "498ebc89028de5a60f9cc909f7a7c6f99fc3b3cf3efda45c2ecf9c62834eb097"
    ),
...
_PRODUCTION_LIFECYCLE_DECISION_APPLY_ITEM_SHA256 = {
    ...
    "prepare_lifecycle_decision_apply_completion": (
        "97da0e4f7b3e220623e43f14b5c289d0ae27c1cf8e56ac42e746b7bd36d95562"
    ),
    "commit_lifecycle_decision_apply_finality": (
        "a1e529a7b784fd7432f58d0f9d0dfc09787b131e610b33b63290c410f4a28083"
    ),
}
...
_PRODUCTION_EXACT_OUTPUT_ITEM_SHA256 = {
    ...
    "retain_returned": "8eff11ad67ba347eba385a7694a4992b6a878f30fc018448dc15652cf382e9a2",
    ...
    "applied_height_reconstruction_covers": "d0ac1d86e0f8ff233cf6854f789660e048246f2d5426193cac23c2ed069884c6",
...
_PRODUCTION_INGRESS_EFFECTS_RECONCILIATION_ITEM_SHA256 = {
    ...
    "settle_released_validate": "9aac0b19c32d1fb822406c4260333cdfd422b440e49a6337bf94016c3aa8cf32",
    "commit_released_validate": "0bd417edcbc9ae11c44db42e12f61a16cbdcff54f85667b511d776cfff8e71d1",
    "register_outbound_payload": "909aba0314ca71ed378c9d2cee8eb56b49fae9a6cc13205ef31b8859b972c294",
    "coordinator_released_validate_preflight": "9f9c8eaf91d0dc71a948cccccfdbe4b3600e2cc12abe3153ad29181bbb70258c",
    "coordinator_released_validate_publish": "829ee750dacc96458b6bc19fb05485dae7225a3a036d28850c1026f39766453e",
}
...
_APPLIED_HEIGHT_TICKETLESS_FINALITY_REGRESSION_TEST_SHA256 = {
    "production_exact_output_observes_finality_only_after_state_commit": (
        "28ff04c7dfe49a4e5a333d48f05ee9bd4db66ee5f2c31f468eafdb04e7f6de60"
    ),
    ...
    "applied_height_finality_releases_only_covered_ticketless_payload_chunks": (
        "efd388ea5423b839fdb70364c3c95eb2406860e4a34d0d58c3a5d66e72ff6fdd"
    ),
}
...
_PRODUCTION_MERGE_SIDECAR_LIFECYCLE_ITEM_SHA256 = {
    ...
    "MergeSidecarLifecycleJournal::read_bounded_regular": "a88d01737f73cbaeb5866d9ed0edf842c2e8b496e259055f1f1860075e8ee26f",
...
_PRODUCTION_MERGE_SIDECAR_ARTIFACT_HELPER_SHA256 = {
    "lifecycle_artifact_identity": (
        "0ea7b25f5462aeb19bb7982820bb3891eeb2cc5d3857491458ce51fd04de9ab4",
        "2a42c1b1ec63d065e5a1799082affd298c22243af990c8fffa371a69207161e2",
        "71ba2d6db0babfcf13a6939c0cedc8263ca73ec6b612b9e17a65ced99b933003",
    ),
    "lifecycle_artifact_revision": (
        "9c899c0f772a2fea975932ce778f884e7776da0858a504b59429eca40aa00f01",
        "c3831899b2617de54389879d9dad5119dd0182362d8f2e7a6d222e1c368c073d",
        "c5b263207a23ea14260fdd7a9915548e253ced7e0a07c1ffa54dd5030fb29ee2",
    ),
    ...
    "lifecycle_artifact_is_single_link": (
        "388a2eacbeffe6479b2c408563203232e82b892f469a639fc3d69511a18abd8c",
    ),
    ...
    "verify_open_lifecycle_regular": (
        "c9251129d16532ac61c7b8d31e779a201a0ae6ea9de23e215dd11f1a67d8b938",
    ),
...
# the sidecar ACK inventory below: the memo may suppress duplicate
...
_PRODUCTION_MERGE_EXECUTION_CACHE_ITEM_SHA256 = {
    ...
    "V2LaneWorkAdapter::decode_and_validate_leader_candidate": (
    ...
    "V2LaneWorkAdapter::merge_parent_frontier_at_generation": (
...
def _require_merge_execution_validation_cache_contract(
    lane_path: Path,
    lane_source: str,
    errors: list[str],
) -> None:
    ...
    expected_qualified = {
        f"V2LaneWorkAdapter::{item_name}" for item_name in expected_items
    }
    missing = sorted(
        expected_qualified - set(_PRODUCTION_MERGE_EXECUTION_CACHE_ITEM_SHA256)
    )
    orphaned = sorted(
        set(_PRODUCTION_MERGE_EXECUTION_CACHE_ITEM_SHA256) - expected_qualified
    )
    if missing or orphaned:
        errors.append(
            f"{lane_path}: merge execution validation-cache token-seal "
            f"inventory mismatch: missing={missing!r}, orphaned={orphaned!r}"
        )

    items: dict[str, RustItem | None] = {}
    for item_name, expected_attributes in expected_items.items():
        ...
        item = _require_qualified_rust_item(
            ...
            item_name,
            errors,
            f"merge execution validation-cache owner {qualified_name}",
            expected_attributes=expected_attributes,
        )
        items[item_name] = item
        expected_sha256 = _PRODUCTION_MERGE_EXECUTION_CACHE_ITEM_SHA256.get(
            qualified_name
        )
...
""",
        "the positive validation memo must retain every exact context, signing, digest, generation, and canonical-body coordinate",
        errors,
    )
    _require_rust_source_token_sequence(
        lane_path,
        ...
        "the lane adapter must own exactly one bounded positive validation memo",
        errors,
    )
    _require_rust_source_token_sequence(
        lane_path,
        ...
        "exactly the live validator and State validating builder may publish positive merge execution authority",
        errors,
        count=2,
    )
    ...
    _require_rust_token_sequence(
        lane_path,
        items.get("decode_and_validate_leader_candidate"),
        """
let digest = crate::merge::merge_qc_message_digest(
        ...
        if digest != signature.message_digest {
            return Err(MergeCandidateValidationError::Invalid(
                "merge leader candidate body differs from its signed digest".to_owned(),
            ));
        }
        match self.validate_merge_candidate_for_active_round(
            ...
            MergeCandidateValidation::Ready => Ok(Some(candidate)),
            MergeCandidateValidation::Deferred => Ok(None),
        }
""",
...
""",
    ...
    memo_item = items.get("merge_execution_candidate_validation_memo")
    _require_rust_token_sequence(
        lane_path,
        memo_item,
        """
...
""",
        "execution validation must begin only at a stable even committed-State generation",
        errors,
    )
    _require_rust_token_sequence(
        lane_path,
...
""",
        "execution validation must preserve the exact carrier context and canonical first-release entry cap",
        errors,
    )
    _require_rust_token_sequence(
        lane_path,
...
""",
        "merge execution cache identity must bind the exact height, signing context, digest key, committed-State generation, and canonical body bytes",
        errors,
    )
    _require_rust_token_sequence(
        lane_path,
        validation_item,
        """
let validated = validated.map_err(MergeCandidateValidationError::Invalid)?;
        let cache_hit = self
            .validated_merge_execution_candidate
            .as_ref()
            .is_some_and(|cached| cached == &validated);
""",
        "live validation must derive one exact memo before testing bounded positive authority",
        errors,
    )
    _require_rust_token_sequence(
        lane_path,
        items.get("merge_parent_frontier_at_generation"),
        """
let state_height = self.state.committed_height();
        let state_hash = self.state.latest_block_hash_fast();
        // Preserve every exact storage error. Neither a lossy height nor Option::None
        // authenticates a retryable publication boundary.
        let durable_height = self
            .kura
            .exact_durable_blocks_count()
            .map_err(|error| error.to_string())?;
        let durable_parent = self.kura.get_durable_block_hash(parent_height);
        let durable_height_after = self
            .kura
            .exact_durable_blocks_count()
            .map_err(|error| error.to_string())?;
        ...
        if durable_parent != Some(expected_parent) {
            return Err(
                "merge validation parent is missing or differs from the exact durable Kura chain"
                    .to_owned(),
            );
        }
        if durable_height_after < durable_height
            || durable_height_after < state_height
            || state_height < parent_height.get()
        {
            return Err(
                "merge validation observed a regressed or contradictory committed frontier"
                    .to_owned(),
            );
        }
        if state_height == parent_height.get() && state_hash != Some(expected_parent) {
            return Err(
                "merge validation parent differs from the exact committed State tip".to_owned(),
            );
        }
        if durable_height_after != durable_height
            || durable_height_after > parent_height.get()
            || state_height > parent_height.get()
        {
            return Ok(MergeCandidateValidation::Deferred);
        }
...
""",
        "merge execution cache reuse must bracket an exact durable parent frontier with the unchanged stable generation",
        errors,
    )
    _require_rust_token_sequence(
        lane_path,
        validation_item,
        """
if self.merge_parent_frontier_at_generation(state_view_generation).map_err(MergeCandidateValidationError::Frontier)? == MergeCandidateValidation::Deferred {
 self.validated_merge_execution_candidate = None;
 return Ok(MergeCandidateValidation::Deferred);
}
let validated = validated.map_err(MergeCandidateValidationError::Invalid)?;
let cache_hit = self.validated_merge_execution_candidate.as_ref().is_some_and(|cached| cached == &validated);
if cache_hit { return Ok(MergeCandidateValidation::Ready); }
""",
        "cache reuse must require the generation-bracketed durable parent frontier helper",
        errors,
    )
    _require_rust_token_sequence(
        lane_path,
...
let validation = self.state.validate_merge_candidate_for_global_round(
        ...
        #[cfg(test)]
        self.run_merge_frontier_test_hook(MergeFrontierTestPhase::FullValidation);
        if self
            .merge_parent_frontier_at_generation(state_view_generation)
            .map_err(MergeCandidateValidationError::Frontier)?
            == MergeCandidateValidation::Deferred
        ...
        Ok(MergeCandidateValidation::Ready)
""",
        "a cache miss must complete full live validation and recheck the stable durable frontier before publishing positive authority",
        errors,
    )
    _require_rust_token_sequence(
        lane_path,
...
""",
    ...
    refresh_authority_clauses = (
        ...
        // Height one has no committed parent and no merge execution candidate.
        ...
        #[cfg(test)]
        self.run_merge_frontier_test_hook(MergeFrontierTestPhase::ParentHeader);
        if self
            .merge_parent_frontier_at_generation(refresh_generation)
            .map_err(V2LaneWorkError::SigningGuard)?
            == MergeCandidateValidation::Deferred
        ...
        let expected_parent = expected_parent.ok_or_else(|| {
            V2LaneWorkError::SigningGuard(
                "merge refresh requires its exact committed parent".to_owned(),
            )
        })?;
        let parent_header = parent_header.ok_or_else(|| {
            V2LaneWorkError::SigningGuard(
                "merge refresh parent header is absent from committed State".to_owned(),
            )
        })?;
        if parent_header.hash() != expected_parent
            || parent_header.height().get().checked_add(1) != Some(self.context.height)
        {
            return Err(V2LaneWorkError::SigningGuard(
                "merge refresh parent header differs from its exact committed context".to_owned(),
            ));
        }
...
let mut persisted_entries = self.merge_entries.iter().filter_map(|(key, pending)| {
        ...
        if let Some((key, entry)) = persisted_entries.next() {
            ...
            // Epoch and persisted evidence are live reads. Classify contradictions
            // only while the same committed frontier still owns those observations.
            if self
                .merge_parent_frontier_at_generation(refresh_generation)
                .map_err(V2LaneWorkError::SigningGuard)?
                == MergeCandidateValidation::Deferred
...
""",
        "global body lock must invalidate merge execution validation authority before retained output scheduling",
        errors,
    )
    _require_rust_token_sequence(
        lane_path,
        items.get("retain_merge_sidecars_for_global_view_guarded"),
        """
...
""",
        "an actual view or terminal-carrier transition must invalidate merge execution validation authority",
        errors,
    )
    _require_rust_token_sequence(
        lane_path,
        items.get("refresh_merge_candidates"),
        "self.validated_merge_execution_candidate = None;",
        "every refresh path without exact voting, unlocked-view, and durable-parent authority must invalidate the memo",
        errors,
        count=3,
    )

    _require_merge_frontier_deferral_contract(lane_path, lane_source, errors)
...
_MERGE_FRONTIER_DEFERRAL_OWNERS = {'classify_merge_state_validation': ('crates/iroha_core/src/sumeragi/v2_lane_work.rs', (('impl', 'V2LaneWorkAdapter'),), (), '_PRODUCTION_MERGE_EXECUTION_CACHE_ITEM_SHA256', 'V2LaneWorkAdapter::classify_merge_state_validation'),
 'decode_and_validate_leader_candidate': ('crates/iroha_core/src/sumeragi/v2_lane_work.rs',
                                          ...
                                          '_PRODUCTION_MERGE_EXECUTION_CACHE_ITEM_SHA256',
                                          'V2LaneWorkAdapter::decode_and_validate_leader_candidate'),
 'validate_merge_candidate_for_active_round': ('crates/iroha_core/src/sumeragi/v2_lane_work.rs',
                                               (('impl', 'V2LaneWorkAdapter'),),
                                               (),
                                               '_PRODUCTION_MERGE_EXECUTION_CACHE_ITEM_SHA256',
                                               'V2LaneWorkAdapter::validate_merge_candidate_for_active_round'),
 'merge_parent_frontier_at_generation': ('crates/iroha_core/src/sumeragi/v2_lane_work.rs',
                                         (('impl', 'V2LaneWorkAdapter'),),
                                         (),
                                         '_PRODUCTION_MERGE_EXECUTION_CACHE_ITEM_SHA256',
                                         'V2LaneWorkAdapter::merge_parent_frontier_at_generation'),
 'refresh_merge_candidates': ('crates/iroha_core/src/sumeragi/v2_lane_work.rs',
                              (('impl', 'V2LaneWorkAdapter'),),
                              (),
                              '_PRODUCTION_MERGE_EXECUTION_CACHE_ITEM_SHA256',
                              'V2LaneWorkAdapter::refresh_merge_candidates'),
 'defer_merge_candidate_work': ('crates/iroha_core/src/sumeragi/v2_lane_work.rs',
                                (('impl', 'V2LaneWorkAdapter'),),
                                (),
                                '_PRODUCTION_MERGE_FRONTIER_DEFERRAL_ITEM_SHA256',
                                'defer_merge_candidate_work'),
 'authorize_local_merge_claim': ('crates/iroha_core/src/sumeragi/v2_lane_work.rs',
                                 (('impl', 'V2LaneWorkAdapter'),),
                                 (),
                                 '_PRODUCTION_MERGE_FRONTIER_DEFERRAL_ITEM_SHA256',
                                 'authorize_local_merge_claim'),
 'accept_merge_signature': ('crates/iroha_core/src/sumeragi/v2_lane_work.rs',
                            (('impl', 'V2LaneWorkAdapter'),),
                            (),
                            '_PRODUCTION_MERGE_FRONTIER_DEFERRAL_ITEM_SHA256',
                            'accept_merge_signature'),
 'prepare_certified_execution_carrier': ('crates/iroha_core/src/sumeragi/v2_lane_work.rs',
                                         (('impl', 'V2LaneWorkAdapter'),),
                                         ('#[allow(dead_code)]',),
                                         '_PRODUCTION_MERGE_FRONTIER_DEFERRAL_ITEM_SHA256',
                                         'prepare_certified_execution_carrier'),
 'prepare': ('crates/iroha_core/src/sumeragi/v2_lane_work.rs',
             (('impl', 'CandidateWorkProvider', 'for', '&', 'mut', 'V2LaneWorkAdapter'),),
             (),
             '_PRODUCTION_MERGE_FRONTIER_DEFERRAL_ITEM_SHA256',
             'prepare'),
 'schedule_retransmission_at': ('crates/iroha_core/src/sumeragi/v2_lane_work.rs',
                                (('impl', 'V2LaneWorkAdapter'),),
                                (),
 ...
 'new_with_output_guard_and_transport_inner': ('crates/iroha_core/src/sumeragi/v2_lane_work.rs',
                                               (('impl', 'V2LaneWorkAdapter'),),
                                               ('#[allow(clippy::too_many_arguments)]',),
                                               '_PRODUCTION_LANE_ACK_SEAM_ITEM_SHA256',
                                               'V2LaneWorkAdapter::new_with_output_guard_and_transport_inner')}
...
""", 1),
    ('merge_parent_frontier_at_generation', 'missing exact parent and unrepresentable height remain fatal', """
let expected_parent = self
            .context
            .parent_commit_qc
            .as_ref()
            ...
            .ok_or_else(|| "merge validation requires its exact committed parent".to_owned())?;
        let parent_height = self
            ...
            .ok_or_else(|| "merge validation parent height is not representable".to_owned())?;
""", 1),
    ('merge_parent_frontier_at_generation', 'storage errors and stable contradictory frontier remain fatal; authenticated forward progress defers', """
let state_height = self.state.committed_height();
        let state_hash = self.state.latest_block_hash_fast();
        // Preserve every exact storage error. Neither a lossy height nor Option::None
        // authenticates a retryable publication boundary.
        ...
        Ok(MergeCandidateValidation::Ready)
""", 1),
    ('validate_merge_candidate_for_active_round', 'each frontier deferral clears the memo and returns Deferred', """
if self.merge_parent_frontier_at_generation(state_view_generation).map_err(MergeCandidateValidationError::Frontier)? == MergeCandidateValidation::Deferred {
 self.validated_merge_execution_candidate = None;
 return Ok(MergeCandidateValidation::Deferred);
}
...
""", 1),
    ('validate_merge_candidate_for_active_round', 'a stable live validation error propagates before positive memo publication', """
let validation = self.state.validate_merge_candidate_for_global_round(
            candidate,
            parent_header,
            active_view,
        ...
        Ok(MergeCandidateValidation::Ready)
""", 1),
    ('defer_merge_candidate_work', 'deferral purges only positive memo and queued merge broadcasts', """
self.validated_merge_execution_candidate = None;
        self.purge_queued_merge_broadcasts();
        MergeRefreshOutcome::Deferred
""", 1),
    ('new_with_output_guard_and_transport_inner', 'constructor frontier hook remains test-only and initially absent', """
#[cfg(test)]
            merge_validation_test_hook: None,
            #[cfg(test)]
            merge_execution_full_validation_checks: 0,
""", 1),
    ('authorize_local_merge_claim', 'intrinsic candidate mismatch is fatal while a closed live view defers', """
if candidate.view != active_view
            || candidate.carrier_height != self.context.height
            || candidate.carrier_parent_hash != expected_parent
        {
...
""", 1),
    ('authorize_local_merge_claim', 'signing validates the exact generation before durable authorization', """
...
if let Some((digest, candidate, bytes)) = authorized_candidate.as_ref() {
            ...
            match self.validate_merge_candidate_for_active_round(
                ...
                Err(reason) => {
                    return Err(V2LaneWorkError::SigningGuard(format!(
...
""", 1),
    ('refresh_merge_candidates', 'installed candidates propagate frontier deferral', """
let mut installed_candidates = Vec::with_capacity(installed_candidate_bodies.len());
        for candidate in installed_candidate_bodies {
            match self.validate_merge_candidate_for_active_round(
                ...
                Ok(MergeCandidateValidation::Ready) => installed_candidates.push(candidate),
                Ok(MergeCandidateValidation::Deferred) => {
                    return Ok(self.defer_merge_candidate_work());
                }
                Err(MergeCandidateValidationError::Invalid(_)) => {}
                Err(MergeCandidateValidationError::Frontier(reason)) => {
                    return Err(V2LaneWorkError::SigningGuard(reason));
                }
            }
        }
""", 1),
    ('refresh_merge_candidates', 'parent snapshot recheck precedes stable fatal classification', """
let expected_parent = self
            .context
            .parent_commit_qc
            .as_ref()
...
""", 1),
    ('accept_merge_signature', 'leader filtering never suppresses fatal frontier errors', """
Err(MergeCandidateValidationError::Frontier(reason)) => { return Err(V2LaneWorkError::SigningGuard(reason)); }
""", 1),
    ('refresh_merge_candidates', 'signing and pending insertion follow explicit local authorization', """
match self.authorize_local_merge_claim(&candidate, active_view, local_index, digest) {
                Ok(LocalMergeAuthorization::Authorized) => {}
                Ok(LocalMergeAuthorization::Deferred) => {
                    return Ok(self.defer_merge_candidate_work());
                }
                Err(MergeSidecarError::SigningGuard(reason)) => {
                    return Err(V2LaneWorkError::SigningGuard(reason));
                }
                Err(error) => {
                    iroha_logger::warn!(
            ...
            let share = self.local_merge_share(key, &candidate, local_index, payload.clone())?;
            self.merge_entries
                .entry(key)
                .or_insert(PendingMerge {
...
""", 1),
    ('accept_merge_signature', 'deferred leader validation cannot persist authorization', """
Ok(Some(candidate)) => candidate,
 Ok(None) => { self.defer_merge_candidate_work(); return Ok(V2LaneIngressOutcome::Rejected); }
""", 1),
    ('accept_merge_signature', 'leader ingress stops after refresh deferral', """
if self.refresh_merge_candidates(active_view)? == MergeRefreshOutcome::Deferred { return Ok(V2LaneIngressOutcome::Rejected); }
""", 1),
    ('schedule_retransmission_at', 'deferred refresh clears the selected retransmission view', """
if self.refresh_merge_candidates(view)? == MergeRefreshOutcome::Deferred { active_merge_view = None; self.purge_queued_merge_broadcasts(); }
""", 1),
    ('schedule_retransmission_at', 'merge share retransmission uses only the remaining active view', """
if let Some(view) = active_merge_view { self.schedule_merge_share_retransmissions(view)?; }
""", 1),
    ('schedule_retransmission_at', 'merge QC retry stops when refresh deferred', """
let Some(active_merge_view) = active_merge_view else { operation.complete(); return Ok(()); };
""", 1),
    ('schedule_retransmission_at', 'scheduler preserves fatal collect_committed_lane_sessions', """
self.collect_committed_lane_sessions()?;
""", 1),
    ('schedule_retransmission_at', 'scheduler preserves fatal purge_queued_global_body_effects_except_committed_outputs', """
self.purge_queued_global_body_effects_except_committed_outputs()?;
""", 1),
    ('schedule_retransmission_at', 'scheduler preserves fatal schedule_committed_lane_outputs', """
...
def _require_merge_frontier_deferral_contract(
    lane_path: Path, lane_source: str, errors: list[str],
) -> None:
    """Require typed deferral to stop every merge-authorizing continuation.

    This narrow contract does not waive the unchanged global, lock, or effects
    owners checked by the encompassing production source contracts.
    """
    runner_path = lane_path.with_name("v2_runner.rs")
    if runner_path.is_symlink() or not runner_path.is_file():
        errors.append(f"{runner_path}: merge frontier deferral requires its real runner source")
        return
    sources = {"v2_lane_work.rs": lane_source,
               "v2_runner.rs": runner_path.read_text(encoding="utf-8")}
    items: dict[str, RustItem] = {}
    for name, (relative, context, attributes, seal_map, seal_key) in _MERGE_FRONTIER_DEFERRAL_OWNERS.items():
        path = lane_path.with_name(Path(relative).name)
        candidates = [candidate for candidate in rust_items(sources[path.name], name)
                      if candidate.brace_context == context]
        purpose = f"merge frontier deferral owner {name}"
        if len(candidates) != 1:
            errors.append(f"{path}: {purpose} requires exactly one owner; found {len(candidates)}")
            continue
        item = candidates[0]
        items[name] = item
        _require_rust_item_context(path, item, context, purpose, errors,
                                   expected_attributes=attributes)
        _require_rust_item_token_sha256(path, item, globals()[seal_map][seal_key], purpose, errors)
    for name, purpose, clause, count in _MERGE_FRONTIER_DEFERRAL_CLAUSES:
        relative = _MERGE_FRONTIER_DEFERRAL_OWNERS[name][0]
        _require_rust_token_sequence(lane_path.with_name(Path(relative).name),
                                    items.get(name), clause,
                                    f"merge frontier deferral: {purpose}", errors, count=count)
...
_PRODUCTION_LANE_ACK_SEAM_ITEM_SHA256 = {
    ...
    "V2LaneWorkAdapter::prune_finalized_merge_sidecars": "177899971313ecd797a0b773bab37ff331226c5768efe2627345532079bd6de7",
...
_PRODUCTION_RUNNER_ACK_SEAM_ITEM_SHA256 = {
    ...
    "retry_exact_output_and_apply_sidecar_admissions": "0f08511c5f86a2275e3d14dfb63f754ba2fdfae6c1c1990e587527924cf1b6b0",
...
_LIFECYCLE_CERTIFIED_SERVE_ITEM_SHA256 = {
    ...
    "turn:LaunchedProductionLifecycleV1::drive_completion_pre_gate_inner": "6f7e6c4677b9cbc9a5d78b18f7c479e6deee5ba869682f56605185e7aa4698fc",
    ...
    "height:drain_lifecycle_v2_ingress": "e5d7110c850bf8e7c4b344312f65c92a1145c7aa6750d184472682c7b32a916b",
...
# Opaque prepared-body proof layout/accessors, independently rehashed with the
# constructor and exact rollover owners before source seals were reconciled.
_PRODUCTION_WORKER_OWNERSHIP_RECONCILIATION_ITEM_SHA256 = {
    "proof_network_id": "7598ceedf3099fc2a7118eaaeae3ece5739c0f49f1661979636f018f855aca92",
    "proof_source_round": "c140a9e9e2a65bad79ba7bd8c19c8de55cf491b7d00f9a60448a852d5fffceb7",
    "proof_layout": "93c3abeccc8aecbd662a84c3c82d275180c8bad33a152bdd946c9cbe1637f855",
}

_PRODUCTION_WORKER_ACK_RECONCILIATION_ITEM_SHA256 = {
    "network_exact_output_hash": "16ebe6af8a1086ccc02013689462d3c26f9b3d1f007c72ef9c5794f0c8bdddc2",
    "wire_make_mut": "dac94947a74e87cfbac13666ae2bb9259446f677ef0fe4709d0252bb286e1593",
    "body_retirement_job": "3c8a1775c209a0d5fb780236a59cbfd88ac62bb7b166764e2f02a98aa328c7cc",
    "body_retirement_execute": "33657f455cf0fcc1c3fa9ca586b5bad2faed514300fc500726caafe9753fbf01",
    "cleanup_execute": "873beeb06c8ff88fdcae320c663dc7173a62d767e71c17fd623062159b1182b1",
}

_PRODUCTION_WORKER_ACK_SEAM_ITEM_SHA256 = {
    "PendingExactFanout::classified_with_route_history": "f42015492ba496463fd54c3f45bdd2ebc8900f8a6e4cab460c0705956e956f5d",
    ...
    "PendingExactOutput::plan_fanout_removal": "ab634c5aff6af5cdf8aabbe333b526e240000e6c3f37de3d5e18eaf1f70a0e67",
    "PendingExactOutput::commit_fanout_removal": "ae237487313762d8b9e93d7dddef17bc5b5d255503fc7013ed49507e2bfbb2d8",
    "PendingExactOutput::remove_fanouts_matching": "34568e487326959128ea1e16250599cad2c8bdf2ffbf854fa6c019e1f79becc0",
    ...
    "PendingExactOutput::enqueue_validated": "052c0f0629aa2af088c30b7125ed43335f0b85ac09cf6b2e0550b249c6723ea0",
    "PendingExactOutput::handoff_applied_height_to_durable_reconstruction": "250dd7b0180479d98870b90703d5ba1ee522d4b25b00719fe337f67713332da0",
    ...
    "ProductionV2Services::enqueue_owned_exact_reply_routes_while_guarded": "4efbda4ba76677d7b95d78cf6a78ac2d44df8e8cfc447f07601b2b80eac20565",
    ...
    "QueuePlanBatchSources::validate": "af9153567ac480450b4eeda4751bf35c389d230dd65a4126b19fd16c08ec372e", "ProductionV2Services::post_queue_plan_admission_certificate": "c8e65ca9bd8d37e1f79c0300208c6e9ed06dce3c964dd4254a9faa0110179581",
    ...
    "ProductionV2Services::finish_height": "cb819ab02386cfb8b552b54d3307d54b6dc1f426683c0048ff64cccfdb7fe309",
}
...
_PRODUCTION_EXACT_OUTPUT_RESERVATION_ITEM_SHA256 = {
    ...
    "PendingExactOutput::validate_fanout_bounds": (
        "4332e7dbb7f989bd0f52834287d0649f629664aa70af86d6a9874fd7a48c966b"
    ),
    "PendingExactOutput::capacity_available_for": (
        "1381bc36cf3c2c37e282db0098928c23843e25b2c6ff3b629be36f66be007135"
    ),
    "PendingExactOutput::can_enqueue": "76a2f00c77c8dba555228342742f84af9f81b32f1ecc2a776782ba3b6dc86335",
    ...
    "ProductionV2Services::start": (
        "db691e2251a6ccceb383214593f38a4bed781279cc06d9aee69482982c537b9a"
    ),
    "ProductionV2Services::start_inner": "a5438a09b9334c8036a63746821bb5c1e74d30b680b597d32648b0c0ec6e7639",
...
_PRODUCTION_EXACT_OUTPUT_CLAIM_ITEM_SHA256 = {
    ...
    "validate_fanout": (
        "808a9ff1235606a7d84ab828a0d40281de0777c4b806b34e73c3afd41e0bf8c4"
    ),
    ...
    "enqueue_owned_exact_reply_routes_while_guarded": (
        "4efbda4ba76677d7b95d78cf6a78ac2d44df8e8cfc447f07601b2b80eac20565"
    ),
    ...
    "post_durable_history_response_with_routes": (
        "62625eed93aea08ba999c6d11e5f40502b9299c57e25e52cf100cb9881bcd156"
    ),
    "post_lane_block": (
...
# Installed only after 72 copied-source baselines and independently rehashed
# semantic mutations bound the decided ingress / prepared-worker handoff chain.
_PRODUCTION_DECIDED_BODY_SERVE_ITEM_SHA256 = {
    "commit_certified_serve": "dcdc2ceb933fe3ef2597bac5509d4c78d6265c589f692b01484ef88fcd1d2464",
    "bind_leader_wire": "8092591b0f4898e4ead275fcf6ca0c6be1394d3121c53c688771d7f4282ab182",
    "permits_height": "0b73454a46a24d97de0b0d32d86a9544cb675aca10623cadb4e91d3c7fbef71e",
    "permits_subject": "d7862c894ed71f532f2afecb009b3471e5488ada9812ade93e5f3c492d261e9d",
    "task_from_bound_ingress": "2699c0291f17ffccdcbe61a3bc607b0d805330fd53788afe231c630f85511cb5",
    "worker_spawn": "bb63632f5544ba6ab9d428d497ca8c5996fb693bf29662b56a4047862dcb1b16",
    "worker_try_enqueue": "80ee3e38ad6e53aac92234045f63afd2a0ff6eeb6013c80659b506cac31ef99b",
    "worker_try_recv": "51b5d82cf5e12b5eabf5879a00dff367f9191d4c456ae74f4a92c3a06bb000ce",
    "worker_defer_prepared": "1ed210c5bab5e8c3090d641a14654073d88a51056b6d0dd4a07d5fc1762c63e0",
    "worker_has_pending": "ee08ecb5b2317d4f55c1dbad8a6f0c9962d2b2893c3c10cbbfefa2ef171b55f3",
    "historical_body_worker": "0309ae380f032b531f3bc1f6b52778f6f5cd76145e4d8e460735a139ee58d7a9",
    "cache_serve": "f27c2c83647e1f60a5375202474238ea513237b6d2157b26e3966d237ebb83c5",
    "cache_prepare": "f0402700428a18b9b520cbe644ce183bc1923d2f126fbd2218430bcfbfa03141",
    "proof_mint": "0281f692586aac67ecef13fb34de4097b176a206e239d5a0b664c52bbfb8609a",
    "proof_covers_message": "b9155a268a15f79c6399d8f05c64fb034cbe3c67f5e57ac5c582b2283ddafe78",
    "validated_cached_exact_output_hash": "f44d52533ff94d16397700dcb513e3e2052f8be7ffdcdce2ff07f2636027dd01",
    "server_enqueue": "852c5b02623c441b550d0f38331a30073ed41f4e80fd913f86471175da256c23",
    "settle_completion": "b55389e85eec43120b51754bdca51860f8fc9bbbdc063259b2c89d5cf7a6f77f",
    "post_prepared": "85cfb705aa6ddabc4399a4b929e856d093ee6045cba080af6c7e313e09ae94a2",
}
...
_PRODUCTION_READY_PROPOSAL_SIGN_PREEMPTION_ITEM_SHA256 = {
    ...
    "dispatch_test::local_proposal_intent_live_wal_sign_fixture": (
        "3c243a42d2017f2fe065b9c2e795fe1d33609598fa1a8915e127414c00d5ae40"
    ),
...
_PRODUCTION_EXACT_OUTPUT_GEOMETRY_ITEM_SHA256 = {
    ...
    "user::Root::parse": (
        "f626e97985d22720a1385a2c33fe343569d27725be9e69e8499416574d7a2eb6"
    ),
...
_PRODUCTION_RUNTIME_CERTIFIED_FENCE_CAPACITY_ITEM_SHA256 = {
    ...
    "test::certified_commit_uses_physical_slot_reserved_from_completions": (
        "bc92ed4b6b07c5f62acc9bdcc9e85efb56bacc28615338b9573bc9c64ed132d8"
    ),
    "test::certified_commit_arriving_first_preserves_every_ordinary_reserve": (
        "05b5e069cc59210e4326376939311c51134968d72a4bb82ef09436703728921c"
    ),
    "test::distinct_certificates_share_exactly_one_physical_credit": (
        "0c83d1a38fe71aa20fcfb735ee9d464835eed37c9e43cfb5ddb42465df82e372"
    ),
    ...
    "test::prepare_qc_cannot_spend_the_certified_physical_credit": (
        "7d6929bf9f6d3fce0f2796527cbc3cdbba06040e708659ff9d5f4128e5117385"
    ),
    "test::retiring_the_sole_certificate_does_not_fake_completion_headroom": (
        "245e914a941d8656f21ab0411bc194e0e478eaa0f3b4175ea8166f3b438b2096"
    ),
    "test::unpublished_body_replacement_cannot_overbook_the_certified_slot": (
        "779cd37572247290f31dfe36c183714827ad8274b96114def2a0f7bd1fcdc9a2"
    ),
}
...
_PRODUCTION_EXACT_OUTPUT_INGRESS_SEAM_ITEM_SHA256 = {
    ...
    "ingress::merge_downstream_with_exact_routes": (
        "c1bbf132dab4c66d08c353a09b55f1adcbf18089c6e2897d4645833751aaede1"
    ),
    "ingress::same_semantic_request": (
        "13cb64e005874ef586e3853182bdb2947e7dcf3498d8f4dd882616023bbf78ee"
    ),
    ...
    "ingress::process_local_projection_hash": (
        "696ffc65129920b2a1871eba24e90055e1a79024980faf3ac6d6e2d88c662c8b"
    ),
    ...
    "ingress::validate_exact": (
        "60d556fab6ee83029c77871b2fff24c9cf781c50cccf2025ead5c70ade2f541e"
    ),
    "effects::accept_payload_chunk_with_ingress_ownership": (
        "c120519c14c7a3fd166d55329f9d6f15359b83bae8d003d3ef70ec75588d4e12"
    ),
    "effects::classify_payload_chunk_lifecycle": (
        "6ccbe2584b2b5bd39856f47ade42b763377d2bb853cbe26126a8e525c6518f8e"
    ),
    "effects::classify_payload_chunk_lifecycle_for_token": (
        "07e0285979bbeb63fe87f904f18190e2739bffe08f1ce461337d4d381c817e38"
    ),
    "effects::begin_apply": (
    ...
    "worker::route_payload_chunk": (
        "fdb0b8e83aaf8b411188eaf19fb4ded7be3dc6e3d203f83ff161081b2321f29c"
    ),
