...
run_positive
run_mutant inflight_first_release_reservation_before_put_batch_bug.cfg MLPutBatchV5BeforeReservationV9
run_mutant inflight_first_release_kura_before_reservation_bug.cfg MLReservationV9BeforeKuraActive
run_mutant inflight_first_release_ready_before_input_bug.cfg MLExecutionInputBeforeReady
run_mutant inflight_first_release_crash_drops_durable_bug.cfg MLCrashPrefixLossFree
run_mutant inflight_first_release_payload_conflict_bug.cfg MLPayloadV3CarriesExactAdmissionPreimage
run_mutant inflight_first_release_commit_scope_conflict_bug.cfg MLCommitAndReleaseRetainExactScope
...
run_mutant inflight_first_release_oversize_put_batch_bug.cfg MLQueuePlanPutBatchBound4096
