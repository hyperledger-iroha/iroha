...
PRODUCTION_TRACE_EXTRACTION_BINDINGS = (
        ...
        "supporting_sources": (
            ...
            },
            {
                ...
                "ordered_tokens": (
                    ...
                    "new_index_bytes: new_entry.to_bytes().to_vec(), integrity_hash: Hash::prehashed([0; Hash::LENGTH]), }.seal(); return Self::execute_bound_progress_append(data_path, index_path, payload, kind, namespace, intent, data, index,)",
                    "if let Some(layout) = layout && height < layout.base_height",
                    "let intent = match BoundProgressAppendIntentV1::for_prepend(namespace, data_path, index_path, height, old_data_len, payload, index_file,)",
                    "return false; } }; return Self::execute_bound_progress_append(data_path, index_path, payload, kind, namespace, intent, data, index,)",
    ...
    },
    {
        ...
        "path": "crates/iroha_core/src/kura/autonomous_merge_bundle_support.rs",
        "impl": "Kura",
        "symbol": "durable_autonomous_lane_merge_source_at_entry_locked",
        ...
        "supporting_sources": (
            {
                "role": "active route durable bundle authority",
                "path": "crates/iroha_core/src/kura/autonomous_merge_bundle_support.rs",
                "impl": "Kura",
                ...
                "ordered_tokens": (
                    ...
                    "self.durable_autonomous_lane_merge_source_at_entry_locked(&entry, lane_block_height, expected_network_id, expected_epoch, certified_override, require_persisted_bundle,)",
                ),
            },
            {
                "role": "retained restart durable bundle authority",
                "path": "crates/iroha_core/src/kura/autonomous_merge_bundle_support.rs",
                "impl": "Kura",
                "symbol": "durable_autonomous_lane_merge_source_at_retained_entry_under_prune_guard",
                "required_tokens": (),
                "ordered_tokens": (
                    "let _geometry_guard = self.lane_geometry_lock.lock()",
    ...
    },
    {
        ...
        "checked_transition_consumer": {
            ...
            "symbol": "validate_for_state_commit",
            "required_tokens": (
                "fn validate_for_state_commit(&self,",
                "carrier_block_hash",
                "staged_merge_entry",
        ...
        "commit_sink": {
            ...
            "required_tokens": (
                ...
                "transactions.try_prepare_publication()",
                "tx_validate_result?;",
                "let autoscale_lifecycle_guard",
                "autoscale_retirement_queue_veto.as_mut()",
                "state_commit_authorization.as_ref()",
    ...
    },
    {
        ...
        "commit_sink": {
            ...
            "required_tokens": (
                ...
                "set_transaction_entrypoint_index_entry",
                "persist_merge_lane_block_application_receipts_after_repair_authorization",
            ),
            "ordered_tokens": (
                "preflight_finalized_merge_carrier_at_under_prune_and_canonical_guards",
    ...
    {'id': 'replica_queue_disposition_observation',
     ...
     'supporting_sources': ({'role': 'production source witness wrapper',
                            ...
                            {'role': 'exhaustive twenty-index strict Queue absence',
                             ...
                             'ordered_tokens': ()},
                            {'role': 'exact admission-to-reservation binding validation',
                             'path': 'crates/iroha_core/src/torii_proxy.rs',
                             'impl': None,
                             'symbol': 'validate_queue_plan_binding_for_lane_reservation_commit',
                             'required_tokens': ('key.validate().map_err(str::to_owned)?',
                                                 'binding.validate_structure()?',
                                                 'key.proposal_height < binding.admission_context.proposal_height',
                                                 'binding.entrypoint_hash != key.entrypoint_hash',
