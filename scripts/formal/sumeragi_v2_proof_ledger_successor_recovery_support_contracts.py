...
def _successor_recovery_pending_kura_tail_source_fidelity_errors(
    ...
    pending_marker_prepare = qualified_item(
        "pending_kura",
        "prepare_apply",
    ...
    released_marker_prepare = qualified_item(
        "pending_kura",
        "prepare_apply",
    ...
    require_order(
        ...
        (
            ...
            "self.validate_pending.exactly_binds_adapter_effect(predecessor)",
            ...
            "PreparedReleasedLifecycleValidatedApplyV1",
        ),
    )
...
def _lifecycle_turn_driver_pending_kura_runner_source_fidelity_errors(
    ...
    _require_rust_token_sequence(
        ...
        pending_live,
        "activated.close_runner_ingress_for_finalized_drain(&mut active_runner, receiver)?;",
        "pending-Kura finalization must close its exact activated ingress exactly once before terminal draining",
        errors,
    )
    reject_tokens(
        "pending_runner",
