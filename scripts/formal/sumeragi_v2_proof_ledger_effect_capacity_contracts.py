# Executed lexically in check_sumeragi_v2_proof_ledger.py after the tail helper.
...
def _effect_capacity_production_source_fidelity_errors(
    ...
    _loaded_path, source = _read_reviewed_rust_source(
        ...
        errors,
        "production effect executor and reviewed test components",
    )
...
""",
    ...
    _require_rust_item_context(
        ...
        dispatch_available,
        production_executor_context,
        "lifecycle Decision Apply dispatch capacity fence",
        errors,
    )
    _require_rust_token_sequence(
        effects_path,
...
""",
    ...
    _require_rust_item_context(
        ...
        prepare_dispatch,
        production_executor_context,
        "exact lifecycle Decision Apply executor dispatch preparation",
        errors,
    )
    _require_rust_token_sequence(
        effects_path,
...
""",
    ...
    prepare_completion = _require_rust_item(
        effects_path,
        source,
    ...
    _require_rust_item_context(
        ...
        prepare_completion,
        production_executor_context,
        "lineage-authenticated lifecycle Decision Apply completion preparation",
        errors,
    )
    _require_rust_token_sequence(
        effects_path,
...
""",
    ...
    commit_finality = _require_rust_item(
        effects_path,
        source,
    ...
    _require_rust_item_context(
        ...
        commit_finality,
        production_executor_context,
        "post-Ledger lifecycle Decision Apply finality commit",
        errors,
    )
    _require_rust_token_sequence(
        effects_path,
...
""",
    ...
    if not runtime_path.is_file() or runtime_path.is_symlink():
        ...
        _loaded_runtime_path, runtime_source = _read_reviewed_rust_source(
            repo_root,
            "crates/iroha_core/src/sumeragi/v2_runtime.rs",
            errors,
            "runtime candidate admission source",
        )
...
""",
    ...
    _effect_capacity_fetch_owner_source_fidelity_errors(
        effects_path,
        source,
        generic_executor_context,
        errors,
