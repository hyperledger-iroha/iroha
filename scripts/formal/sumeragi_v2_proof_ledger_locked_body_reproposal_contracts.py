def _locked_body_reproposal_source_fidelity_errors(
    ...
    directive_path, directive_source = _read_reviewed_rust_source(
        repo_root,
        "crates/iroha_core/src/sumeragi/v2.rs",
        errors,
        "local-proposal directive production source",
    )
...
_LOCKED_BODY_REPROPOSAL_RUST_ITEM_SHA256 = {
    ...
    "run_non_pending_lifecycle_loop": "b08190fa2d04fd5ed07b95279d8d140eb54d2dd2c6ed2e66551807dc88e0348c",
    "run_lifecycle_active_height": "b484fc049ff55e29f5a12d78493a8bd431be96f528ee4404ca502a4f9cf03dcc",
    ...
    "schedule_local_proposal": "8036a1e28aa9453c847849daa0598c001523d6356f114afe18609172713fc1ab",
