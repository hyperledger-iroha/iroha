def _production_liveness_release_inventory_errors(
    ...
    if len(_PRODUCTION_LIVENESS_NEW_REGRESSIONS) != 415:
        errors.append("internal release-regression seal must contain exactly 415 names")
    ...
    documentation_claims = {
        ...
        repo_root / "specs" / "sumeragi_v2_liveness.md": (
            "current source-bound inventory to 834 exact tests "
            "across\n39 modules and "
