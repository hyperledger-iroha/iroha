...
if [ -n "$BIN_IROHA" ]; then
    ...
    bin_iroha=(cargo run --release --bin iroha --)
fi

case $1 in
    "genesis")
        "${bin_kagami[@]}" genesis generate --executor executor.wasm --wasm-dir libs --genesis-public-key ed01204164BF554923ECE1FD412D241036D863A6AE430476C898248B8237D77534CFC4 \
