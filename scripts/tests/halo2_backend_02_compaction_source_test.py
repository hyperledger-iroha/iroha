...
pins the current test inventory, shared proof builders, and caller partition,
and separately authenticates the four callback-bearing permutation/randomized
tests after the deliberate Poseidon-label retirement.
"""
...
POSTIMAGE_BLOB = "5c634fb662db5df13a9548c56afa8210be8593d5"
POSTIMAGE_SHA256 = "fe4ab20295639daa36c7555ef38e0c1e17709aa5a856df712500ca9127a1b18c"
POSTIMAGE_LINES = 960
MINIMUM_RUST_LINE_REDUCTION = 656
MAX_LINE_LENGTH = 100
CURRENT_TEST_INVENTORY_SHA256 = (
    "e37eb033b8f9aa304eb24047c6ceb3d27adbd5d7779faf80289ea254de14bbf7"
)
...
DIRECT_TEST_SHA256 = (
    "f07b4052d57efa3a7af52b1d42b8a3e4a5478dcff230907e898ca8cb706a5824",
    "983fe4cc30d11449af9121b5550cde07d54f87ede947320a1f97d5356057dcc3",
    "bc56416ea09c4554d6eb522b888dfd4e816af1198ef5fdc65594d69421ac8081",
    "f11eca2c92058de14b8715d7af455ff8e57083f17ae0215d66a3beaefc44ac9e",
)
...
def validate_source(source: str, preimage: str) -> None:
    ...
    _require(
        _sha256(json.dumps(postimage_tests, separators=(",", ":")))
        == CURRENT_TEST_INVENTORY_SHA256,
        "current test attributes or order changed",
    )
    ...
    for name, expected_sha256 in zip(DIRECT_TESTS, DIRECT_TEST_SHA256, strict=True):
        function = _function(source, name)
        _require(_sha256(function) == expected_sha256, f"direct test changed: {name}")
        _require(
