...
INSTRUCTIONS="../fuzz/cli_dsl/multisig_set_key_value.json"
...
get_target_account() {
    ./iroha account list filter '{"Atom": {"Id": {"Atom": {"Equals": "'$MULTISIG_ACCOUNT'"}}}}'
}
...
INSTRUCTIONS_HASH=$(echo "$LIST_2_INIT" | jq -r 'keys[0]')
