"""Source contracts for the feature-loaded embedded SoraCloud runtime module tree."""
...
def test_feature_loaded_runtime_uses_explicit_nested_token_auth_path() -> None:
