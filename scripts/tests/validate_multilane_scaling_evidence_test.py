...
# Keep the unittest script entry point usable as well as package-based pytest.
...
class EvidenceBundle(ScalingRunFixture):
    ...
    def raw_run(
        ...
        *,
        ...
        """Bind shared run fixtures to complete outcomes and resource evidence."""
        raw = super().raw_run(
            pair_index=pair_index,
            variant=variant,
            active_lanes=active_lanes,
        ...
        trace_path = self.root / raw["artifacts"]["transaction_trace"]["path"]
