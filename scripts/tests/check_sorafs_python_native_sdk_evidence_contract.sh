...
evidence_directory = (
    "${{ runner.temp }}/iroha-sorafs-python-native-abi24-evidence"
)
evidence_file = f"{evidence_directory}/python-native-abi24.json"
required_workflow_tokens = (
    f"SORAFS_PYTHON_SDK_EVIDENCE_DIR: {evidence_directory}",
    "name: Upload verified Python ABI-24 evidence",
    evidence_file,
...
upload = workflow.split("name: Upload verified Python ABI-24 evidence", 1)[1]
