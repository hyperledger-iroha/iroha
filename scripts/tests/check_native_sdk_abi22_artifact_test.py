...
def test_kotlin_localnet_release_lane_is_mandatory_and_payload_free() -> None:
    ...
    assert {
        ...
        "scripts/tests/deploy_taira_v21_reset_test.py",
        "scripts/tests/deploy_taira_v21_reset_authority_test.py",
        "scripts/tests/prepare_taira_empty_reset_bundle_test.py",
