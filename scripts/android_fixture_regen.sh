...
ALIGNMENT_MD_OUT="${ANDROID_FIXTURE_ALIGNMENT_MD_OUT:-${REPO_ROOT}/specs/sdk/android/norito_fixture_alignment.md}"
ALIGNMENT_JSON_OUT="${ANDROID_FIXTURE_ALIGNMENT_JSON_OUT:-${REPO_ROOT}/specs/sdk/android/norito_fixture_alignment.json}"
