...
_OFFLINE_TOOLCHAIN_SDK_PLANS = (
    ...
    _planned(
        "g-unit-production-881",
        "release-runner",
        "operation:g-unit-production-881.v1",
    ),
    _planned(
        "g-unit-focused-531",
        "release-runner",
        "operation:g-unit-focused-531.v1",
    ),
    _planned(
...
# The scaling entries authorize original-parent phases. They are semantic
# obligations, not argv templates for independently selected collector tools.
# Runtime descriptors and seed bytes remain with BootstrapScalingOperation.
_NETWORK_SCALE_SOAK_PLANS = (
    ...
    _planned(
        ...
        "--source-archive-id",
        "archive:release-scaling.selected-source.v1",
        "--preflight-archive-id",
        "archive:release-scaling.complete-preflight.v1",
        "--evidence-root-id",
        _EVIDENCE_ROOT_ID_SLOT,
    ),
    _planned(
        ...
        "archive:release-scaling.complete-preflight.v1",
        "--plan-archive-id",
        "archive:release-scaling.plan.v1",
        "--budget-archive-id",
        "archive:release-scaling.budget.v1",
        "--launch-owner-id",
        "owner:release-scaling.original-launch-descriptor-and-seed.v1",
        "--evidence-root-id",
        _EVIDENCE_ROOT_ID_SLOT,
    ),
    _planned(
        ...
        "operation:release-scaling.inspect-complete-archive.v1",
        "--measurement-policy-id",
        "policy:release-scaling.all-three-measured-criteria.v1",
        "--native-replay-id",
        "operation:release-scaling.replay-all-ten-native-runs.v1",
        "--parent-record-archive-id",
        "archive:release-scaling.parent-execution.v1",
        "--evidence-root-id",
        _EVIDENCE_ROOT_ID_SLOT,
    ),
    _planned(
