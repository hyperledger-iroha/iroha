...
produces human-readable references under specs/sdk/android/generated/.
    ...
    "ContractManifest": {
        ...
        "fields": [
            ...
            },
            {
                "name": "abi_hash",
                "type": "Option<Hash>",
                "description": "Hash of the syscall/pointer ABI surface for the supplied `abi_version` (see `specs/ivm_header.md`).",
            },
            {
...
SMART_CONTRACT_FIXTURE = (
    "specs/sdk/android/generated/fixtures/"
