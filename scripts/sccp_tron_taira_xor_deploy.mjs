...
function buildTairaXorRouteConfigToml(manifest, options = {}) {
  ...
  if (Object.prototype.hasOwnProperty.call(options, "allow-unready")) {
    throw new Error("--allow-unready was removed; route-config requires production-ready route manifests");
  }
