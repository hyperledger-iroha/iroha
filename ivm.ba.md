...
Был файл IVM архитектураһы һәм ABI иҫкәрмәләре өсөн workspace тамырындағы инеү нөктәһе булып тора.
Ентекле документтар `docs/source/` һәм `crates/ivm/docs/` аҫтында урынлашҡан.
