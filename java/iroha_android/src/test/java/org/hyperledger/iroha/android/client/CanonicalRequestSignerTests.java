...
public final class CanonicalRequestSignerTests {
  ...
  private static void headersCarryVerifiableSignature() throws Exception {
    ...
    final URI uri =
        new URI("http://localhost:8080/v1/accounts/6cmzPVPX944pj7vVyADRpma2DCcBUsG1mhz8VrXArhXaGsjvRUcnbVn/assets?limit=5");
    ...
    final Map<String, String> headers =
        CanonicalRequestSigner.buildHeaders(
            "get", uri, body, "6cmzPVPX944pj7vVyADRpma2DCcBUsG1mhz8VrXArhXaGsjvRUcnbVn", keyPair.getPrivate(), timestampMs, nonce);
    final byte[] message =
