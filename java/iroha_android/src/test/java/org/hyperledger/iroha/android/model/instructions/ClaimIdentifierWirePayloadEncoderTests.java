  ...
  private static void claimIdentifierMatchesRustCanonicalLiveFixture() {
    ...
    final IdentifierResolutionPayload payload =
        new IdentifierResolutionPayload(
            ...
            new IdentifierResolutionExecutionPayload(
                "email_retail",
                "75522459a6b0039705a18ce5d21050f39454f440203d6041c454658735da1d07",
                "bfv-programmed-sha3-256-v1",
                "signed",
                "e12e5429c9c8b146c4ec6db972dcdebd6bc84257a4503c0a152e052d345b303d",
                "444180a5eccbc236041f1dc4d5e3bd220b0656261eb55b9d9ae32aa729b5437f",
                1764450000024L,
                1764453000056L),
    ...
    final IdentifierResolutionReceipt receipt =
        new IdentifierResolutionReceipt(
            payload,
            new IdentifierReceiptAttestation("signed", LIVE_SIGNATURE_HEX, null, null));
