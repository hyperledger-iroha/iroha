...
/** Request body for {@code POST /v1/zk/vk/update}. */
public final class VerifyingKeyUpdateRequest {
  ...
  private VerifyingKeyUpdateRequest(final Builder builder) {
  ...
  public static final class Builder {
    ...
    public VerifyingKeyUpdateRequest build() { return new VerifyingKeyUpdateRequest(this); }
  }
}
