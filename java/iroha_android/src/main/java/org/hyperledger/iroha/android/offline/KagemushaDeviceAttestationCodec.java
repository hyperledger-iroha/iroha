...
final class KagemushaDeviceAttestationCodec {
  ...
  static final String REGISTRATION_SCHEMA =
      "iroha_data_model::kagemusha::KagemushaDeviceAttestationRegistration";
  static final String CHALLENGE_SCHEMA =
      "iroha_data_model::kagemusha::KagemushaDeviceAttestationChallengePreimage";
  static final String ANDROID_CHALLENGE_SCHEMA =
      "iroha_data_model::kagemusha::KagemushaAndroidKeyMintChallengePreimage";
  static final String INSTRUCTION_SCHEMA =
      "iroha_data_model::isi::kagemusha::RegisterKagemushaDeviceAttestation";
  static final String INSTRUCTION_WIRE_ID = "iroha.kagemusha.device_attestation.register";
  ...
  private KagemushaDeviceAttestationCodec() {}

  static byte[] encodeRegistration(final KagemushaDeviceAttestationRegistration registration) {
  ...
  static KagemushaDeviceAttestationRegistration decodeRegistrationCanonical(
    ...
    return withDecodeChain(
        ...
        () -> {
          ...
          final KagemushaDeviceAttestationRegistration decoded = view.decode(REGISTRATION_ADAPTER);
  ...
  static byte[] encodeInstructionPayload(final KagemushaDeviceAttestationRegistration registration) {
    return NoritoCodec.encode(
        Objects.requireNonNull(registration, "registration"),
        INSTRUCTION_SCHEMA,
        INSTRUCTION_ADAPTER,
  ...
  static KagemushaDeviceAttestationRegistration decodeInstructionPayloadCanonical(
      final byte[] archive, final int chainDiscriminant) {
    return withDecodeChain(
        chainDiscriminant,
        () -> {
          ...
          final KagemushaDeviceAttestationRegistration decoded = view.decode(INSTRUCTION_ADAPTER);
  ...
  static InstructionBox instruction(final KagemushaDeviceAttestationRegistration registration) {
    return InstructionBox.fromWirePayload(
        INSTRUCTION_WIRE_ID, encodeInstructionPayload(registration));
  }

  static byte[] canonicalChallengeHash(final KagemushaDeviceAttestationRegistration value) {
    if (KagemushaDeviceAttestationRegistration.ANDROID_KEYMINT_PLATFORM.equals(value.platform())) {
  ...
  static byte[] androidPreKeyGenerationChallengeHash(
    ...
    if (version != KagemushaDeviceAttestationRegistration.REGISTRATION_VERSION) {
  ...
  private static final class RegistrationAdapter
      implements TypeAdapter<KagemushaDeviceAttestationRegistration> {
    @Override
    public void encode(
        final NoritoEncoder encoder, final KagemushaDeviceAttestationRegistration value) {
    ...
    @Override
    public KagemushaDeviceAttestationRegistration decode(final NoritoDecoder decoder) {
      return new KagemushaDeviceAttestationRegistration(
          readField(decoder, child -> checkedU16(child.readUInt(16))),
          readField(decoder, KagemushaDeviceAttestationCodec::readString),
          readField(decoder, KagemushaDeviceAttestationCodec::readString),
          readField(decoder, KagemushaDeviceAttestationCodec::readString),
          readField(decoder, child -> TransferWirePayloadEncoder.decodeAccountIdPayload(
              ...
              child.flags())),
          readField(decoder, KagemushaDeviceAttestationCodec::readOptionAssetDefinitionId),
          readField(decoder, KagemushaDeviceAttestationCodec::readOptionString),
          readField(decoder, KagemushaDeviceAttestationCodec::readOptionString),
          readField(decoder, KagemushaDeviceAttestationCodec::readOptionString),
          readField(decoder, KagemushaDeviceAttestationCodec::readOptionString),
          readField(decoder, KagemushaDeviceAttestationCodec::readOptionBytes),
          new KagemushaDevicePublicKeyV1(
              readField(decoder, KagemushaDeviceAttestationCodec::readP256PublicKey)),
          readField(decoder, KagemushaDeviceAttestationCodec::readString),
          readField(decoder, KagemushaDeviceAttestationCodec::readString),
          readField(decoder, KagemushaDeviceAttestationCodec::readBytes),
          readField(decoder, KagemushaDeviceAttestationCodec::readOptionU32),
          readField(decoder, KagemushaDeviceAttestationCodec::readBool),
  ...
  private static int requiredDecodeChainDiscriminant() {
    ...
    if (value == null) {
      throw new IllegalStateException(
          "Kagemusha attestation decoding requires an explicit chainDiscriminant");
    }
    return value;
  }
  ...
  private static final class InstructionAdapter
    ...
    @Override
    public void encode(
        final NoritoEncoder encoder, final KagemushaDeviceAttestationRegistration registration) {
  ...
  private static final class ChallengeAdapter implements TypeAdapter<Challenge> {
    ...
    public void encode(final NoritoEncoder encoder, final Challenge value) {
      field(encoder, child -> string(child, KagemushaDeviceAttestationRegistration.DEVICE_ATTESTATION_CHALLENGE_DOMAIN));
  ...
  private static final class AndroidChallengeAdapter implements TypeAdapter<AndroidChallenge> {
    ...
    public void encode(final NoritoEncoder encoder, final AndroidChallenge value) {
      field(encoder, child -> string(child, KagemushaDeviceAttestationRegistration.DEVICE_ATTESTATION_CHALLENGE_DOMAIN));
      field(encoder, child -> child.writeUInt(KagemushaDeviceAttestationRegistration.REGISTRATION_VERSION, 16));
      field(encoder, child -> string(child, KagemushaDeviceAttestationRegistration.ANDROID_KEYMINT_PLATFORM));
      field(encoder, child -> string(child, value.deviceId));
      field(encoder, child -> child.writeBytes(TransferWirePayloadEncoder.encodeAccountIdPayload(value.accountId)));
      field(encoder, child -> optionAssetDefinitionId(child, value.assetDefinitionId));
      ...
      field(encoder, child -> string(child, KagemushaDeviceAttestationRegistration.ANDROID_KEYMINT_ASSERTION_SCHEME));
      field(encoder, child -> string(child, KagemushaDeviceAttestationRegistration.ANDROID_KEYMINT_ASSERTION_KEY_ALGORITHM));
  ...
  private static final class Challenge {
    ...
    private Challenge(final KagemushaDeviceAttestationRegistration registration) {
  ...
  private static final class AndroidChallenge {
    ...
    private AndroidChallenge(
      ...
      KagemushaDeviceAttestationRegistration.requireHash(this.recentBlockHash, "recent_block_hash");
    }
  }
  ...
  private static String readOptionString(final NoritoDecoder decoder) {
    ...
    return readField(decoder, KagemushaDeviceAttestationCodec::readString);
  }
  ...
  private static byte[] readOptionBytes(final NoritoDecoder decoder) {
    ...
    return readField(decoder, KagemushaDeviceAttestationCodec::readBytes);
  }
  ...
  private static byte[] readHash(final NoritoDecoder decoder, final String field) {
    ...
    KagemushaDeviceAttestationRegistration.requireHash(value, field);
    return value;
  }
