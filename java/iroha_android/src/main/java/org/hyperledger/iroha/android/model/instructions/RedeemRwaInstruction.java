...
public final class RedeemRwaInstruction implements InstructionTemplate {
  ...
  private static final String ACTION = "RedeemRwa";

  private final String rwaId;
  private final String quantity;
  private final Map<String, String> arguments;

  private RedeemRwaInstruction(final Builder builder) {
    this(builder, builder.canonicalArguments());
  }

  private RedeemRwaInstruction(final Builder builder, final Map<String, String> argumentOrder) {
  ...
  public static RedeemRwaInstruction fromArguments(final Map<String, String> arguments) {
    final Builder builder =
        builder()
            .setRwaId(require(arguments, "rwa"))
            .setQuantity(require(arguments, "quantity"));
    return new RedeemRwaInstruction(builder, new LinkedHashMap<>(arguments));
  }
  ...
  public boolean equals(final Object obj) {
    ...
    if (!(obj instanceof RedeemRwaInstruction other)) {
      return false;
    }
  ...
  public static final class Builder {
    ...
    public RedeemRwaInstruction build() {
      ...
      return new RedeemRwaInstruction(this);
    }
