...
/** Typed builder for the {@code HoldRwa} instruction. */
public final class HoldRwaInstruction implements InstructionTemplate {

  private static final String ACTION = "HoldRwa";

  private final String rwaId;
  private final String quantity;
  private final Map<String, String> arguments;

  private HoldRwaInstruction(final Builder builder) {
    this(builder, builder.canonicalArguments());
  }

  private HoldRwaInstruction(final Builder builder, final Map<String, String> argumentOrder) {
  ...
  public static HoldRwaInstruction fromArguments(final Map<String, String> arguments) {
    final Builder builder =
        builder()
            .setRwaId(require(arguments, "rwa"))
            .setQuantity(require(arguments, "quantity"));
    return new HoldRwaInstruction(builder, new LinkedHashMap<>(arguments));
  }
  ...
  public boolean equals(final Object obj) {
    ...
    if (!(obj instanceof HoldRwaInstruction other)) {
      return false;
    }
  ...
  public static final class Builder {
    ...
    public HoldRwaInstruction build() {
      ...
      return new HoldRwaInstruction(this);
    }
