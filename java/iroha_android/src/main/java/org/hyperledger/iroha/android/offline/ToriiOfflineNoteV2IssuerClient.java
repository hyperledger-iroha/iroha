...
/** Torii-backed issuer client for Offline Note V2 wallet loads. */
public final class ToriiOfflineNoteV2IssuerClient implements OfflineNoteV2IssuerClient {
  ...
  public CompletableFuture<OfflineNoteV2IssueResponse> issueNote(
    ...
    if (pending == null) {
      return failedFuture(
          new OfflineToriiException(
              "Missing Offline Note V2 load context for operation "
    ...
    body.put("lineage_state", OfflineNoteV2IssuerDeviceBinding.deepCopyObject(pending.lineageState));
    ...
    return executePost(
        ...
        payload -> {
          ...
          final OfflineNoteV2.KeyCertificateV2 keyCertificate = parseKeyCertificate(certificateJson);
          ...
          return new OfflineNoteV2IssueResponse(
              commitment,
  ...
  private CompletableFuture<OfflineNoteV2LoadContext> refillKeys(
      final String chainId,
      final String accountId,
      final String assetDefinitionId,
      final OfflineNoteV2IssuerDeviceBinding binding,
        ...
        .whenComplete(
            (response, throwable) -> {
              ...
              try {
                ...
                final OfflineToriiException error =
                    new OfflineToriiException(
                        "Failed to parse Offline Note V2 issuer response for "
                            + request.uri().getPath()
                            + ".",
                        ex,
                        response.statusCode(),
  ...
  private static final class PendingLoad {
    ...
    private final OfflineNoteV2IssuerDeviceBinding deviceBinding;
    ...
    private PendingLoad(
        ...
        final OfflineNoteV2.KeyCertificateV2 keyCertificate,
        final Map<String, Object> lineageState,
        final OfflineNoteV2IssuerDeviceBinding deviceBinding) {
      ...
      this.lineageState = OfflineNoteV2IssuerDeviceBinding.deepCopyObject(lineageState);
      this.deviceBinding = deviceBinding;
    }

    private OfflineNoteV2LoadContext context() {
      return new OfflineNoteV2LoadContext(
