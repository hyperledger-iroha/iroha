 ...
 *
 * <p>This type mirrors {@code KagemushaDeviceAttestationRegistration} exactly. Native clients use
 * bridge ABI 23; the registration's on-chain format marker remains version 1.
 */
public final class KagemushaDeviceAttestationRegistration {

  /** Sole native bridge ABI supported by the first-release Kagemusha V1 client. */
  ...
  private final KagemushaDevicePublicKeyV1 publicKey;
   ...
   */
  public KagemushaDeviceAttestationRegistration(
      final int version,
      ...
      final KagemushaDevicePublicKeyV1 publicKey,
  ...
  public static KagemushaDeviceAttestationRegistration decodeCanonical(
      final byte[] archive, final int chainDiscriminant) {
    return KagemushaDeviceAttestationCodec.decodeRegistrationCanonical(
        archive, chainDiscriminant);
  }

  /** Encode the exact current registration as a framed Norito archive. */
  public byte[] noritoEncoded() {
    return KagemushaDeviceAttestationCodec.encodeRegistration(this);
  }

  /** Deterministic challenge hash that the platform report must bind. */
  public byte[] canonicalChallengeHash() {
    return KagemushaDeviceAttestationCodec.canonicalChallengeHash(this);
  }
  ...
  public static byte[] androidPreKeyGenerationChallengeHash(
      ...
      final byte[] recentBlockHash,
      final long expiresAtMs) {
    return KagemushaDeviceAttestationCodec.androidPreKeyGenerationChallengeHash(
        version,
        deviceId,
        accountId,
        assetDefinitionId,
  ...
  public KagemushaDevicePublicKeyV1 publicKey() {
    return publicKey;
  }
  ...
  public boolean equals(final Object object) {
    ...
    if (!(object instanceof KagemushaDeviceAttestationRegistration other)) {
      return false;
    }
