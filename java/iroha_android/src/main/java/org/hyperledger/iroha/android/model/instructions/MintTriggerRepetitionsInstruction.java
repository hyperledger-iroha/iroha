...
/** Typed builder for `MintTriggerRepetitions` instructions. */
public final class MintTriggerRepetitionsInstruction implements InstructionTemplate {

  private static final String ACTION = "MintTriggerRepetitions";

  private final String triggerId;
  private final int repetitions;
  private final Map<String, String> arguments;

  private MintTriggerRepetitionsInstruction(final Builder builder) {
    this(builder, builder.canonicalArguments());
  }

  private MintTriggerRepetitionsInstruction(
  ...
  public static MintTriggerRepetitionsInstruction fromArguments(final Map<String, String> arguments) {
    return new MintTriggerRepetitionsInstruction(
        builder()
  ...
  public boolean equals(final Object obj) {
    ...
    if (!(obj instanceof MintTriggerRepetitionsInstruction other)) {
      return false;
    }
  ...
  public static final class Builder {
    ...
    public MintTriggerRepetitionsInstruction build() {
      if (triggerId == null) {
        throw new IllegalStateException("triggerId must be provided");
      }
      return new MintTriggerRepetitionsInstruction(this);
    }
