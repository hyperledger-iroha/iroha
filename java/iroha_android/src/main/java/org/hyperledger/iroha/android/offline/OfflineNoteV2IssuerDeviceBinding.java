...
/** Device-binding material required by the Torii Offline Note V2 issuer endpoints. */
public final class OfflineNoteV2IssuerDeviceBinding {
  private final String deviceId;
  private final String offlinePublicKey;
  private final Map<String, Object> deviceBinding;

  public OfflineNoteV2IssuerDeviceBinding(
