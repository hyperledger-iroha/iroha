...
/** Typed builder for the `BurnAsset` instruction. */
public final class BurnAssetInstruction implements InstructionTemplate {

  private static final String ACTION = "BurnAsset";

  private final String assetId;
  private final String quantity;
  private final Map<String, String> arguments;

  private BurnAssetInstruction(final Builder builder) {
    this(builder, builder.canonicalArguments());
  }

  private BurnAssetInstruction(
  ...
  public static BurnAssetInstruction fromArguments(final Map<String, String> arguments) {
    final Builder builder =
        builder()
            .setAssetId(require(arguments, "asset"))
            .setQuantity(require(arguments, "quantity"));
    return new BurnAssetInstruction(builder, new LinkedHashMap<>(arguments));
  }
  ...
  public boolean equals(final Object obj) {
    ...
    if (!(obj instanceof BurnAssetInstruction other)) {
      return false;
    }
  ...
  public static final class Builder {
    ...
    public BurnAssetInstruction build() {
      ...
      return new BurnAssetInstruction(this);
    }
