...
- [ ] Investigate the Izanami 1 TPS run that stopped at ~40 blocks after the block-signer cache change; vote-drain times now dominate slow iterations, so focus on vote handling/backpressure rather than BlockSyncUpdate drain.
