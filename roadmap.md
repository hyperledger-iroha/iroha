...
- [ ] Fix snapshot deserialization on restart so `extra_functional::restart_peer::restarted_peer_should_restore_its_state` can rely on persisted snapshots (remove test cleanup once resolved).
