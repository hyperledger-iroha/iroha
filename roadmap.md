...
work appear here.
Latest sync: ZK voting now validates halo2/ipa envelope metadata (circuit_id/vk_hash) and enforces per-VK max_proof_bytes alongside the length-prefixed nullifier derivation update (see `status.md` for details).
