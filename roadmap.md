...
- [ ] Re-run the Izanami 1 TPS profile to confirm queue-latency reduction after roster-validation memoization (blocked by merge conflict in `crates/iroha_core/src/smartcontracts/isi/staking.rs`).
