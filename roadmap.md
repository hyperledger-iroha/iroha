...
- [ ] Re-run Izanami 1 TPS + NPoS localnet 1 Hz after the drain-cap change and capture results in `status.md`. (Izanami rerun 2026-01-31 interval8 logged in `status.md`; NPoS localnet 1 Hz still pending.) (touch `status.md`)
