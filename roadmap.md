...
- [ ] Re-run the Izanami 1 TPS profile after caching known-block block-signer sets; if BlockSyncUpdate still dominates block-payload drain, evaluate moving known-block QC handling off the block-payload queue or bounding it.
