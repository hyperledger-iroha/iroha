...
- [ ] Re-run the Izanami 1 TPS profile after vote-validation caching in `qc_signers_for_votes`; confirm `vote_drain_ms` reduction and whether additional batching/offload is still needed.
