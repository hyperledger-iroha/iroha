...
- [ ] Re-run the Izanami 1 TPS profile after the pipeline shared-pool reuse + stateless cache + stateless signature batching to confirm vote/block drain improvements and update `status.md`.
