...
- Re-run the previously failing suites (extra_functional seven_peer_consistency/unregister_peer/unstable_network, smart_contract_query_scenarios, sumeragi_npos_liveness) after the READY+DELIVER rebroadcast fixes to confirm RBC delivery across 7+ peers and DA recovery; re-run unstable_network_8_peers_1_fault with the RBC chunk fanout min-quorum fix.
