...
- [ ] Re-run the Izanami 1 TPS (300s) profile after increasing RBC seed worker concurrency and queue caps to confirm additional BlockCreated seeding latency reduction; update `status.md`.
