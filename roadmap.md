...
- [ ] Re-run `cargo test -p integration_tests --test sumeragi_localnet_smoke -- --nocapture` after raising the RBC chunk fanout baseline to commit quorum to reduce READY quorum stalls (prior stall at height 34).
