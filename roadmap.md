...
- GPU zstd (Metal): replace the gpuzstd_metal CPU fallback with a real GPU match-finder + entropy-coding pipeline while keeping bit-for-bit parity with CPU zstd.
