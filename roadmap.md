...
- [ ] Reduce vote-drain hotspots now that vote-verify offload + batching still leave `vote_drain_ms` dominant (latest 1 TPS run: mean 432–490ms, p95 2182–2344ms, 49–50 blocks in 300s); consider buffering/increasing vote-verify queue capacity to avoid synchronous fallbacks or wiring PoP data so BLS aggregate same-message verification is possible.
