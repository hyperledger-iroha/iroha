...
import { noritoEncodeNftMarketValueV1, noritoDecodeNftMarketValueV1,
  noritoEncodeGameValueV1, noritoDecodeGameValueV1 } from "./norito.js";
...
function primitive(name, value) {
  ...
  const encode = name === "u8" ? noritoEncodeGameValueV1 : noritoEncodeNftMarketValueV1;
  const decode = name === "u8" ? noritoDecodeGameValueV1 : noritoDecodeNftMarketValueV1;
...
function decode(name, bytes) {
  ...
  return (name === "u8" ? noritoDecodeGameValueV1 : noritoDecodeNftMarketValueV1)(name, bytes);
}
...
export function decodeGameResourceValueV1(name, input) {
  if (!publicNames.has(name)) throw new TypeError("unknown game resource value");
