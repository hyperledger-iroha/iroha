...
export function registerSorafsOrderbookSubmissionTests(context) {
  const { test } = context;
  const { LocalSigningContext, SorafsOrderbookSubmissionAmbiguousError, ToriiClient, NetworkId, TORII_TEST_NATIVE_BINDING } = context.subject;
