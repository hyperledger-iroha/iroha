...
const sourceOperatorSigningContext = new SourceOperatorSigningContext(
  SourceNetworkId.fromBytes(Buffer.alloc(32, 0xa5)),
  operatorSigner,
);
const distOperatorSigningContext = new DistOperatorSigningContext(
  ...
  return new Client("https://fixture.invalid", {
    operatorSigningContext:
      Client === DistToriiClient
        ? distOperatorSigningContext
        : sourceOperatorSigningContext,
    fetchImpl: async (url) => {
