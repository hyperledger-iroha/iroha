...
//! ## Features
//!
//! This vendored Iroha build requires the Rust standard library. Its `std` feature
//! enables standard-library support in dependencies; the crate itself always uses
//! standard-library error implementations and floating-point approximations.
//!
//! ### Random Generation
//!
