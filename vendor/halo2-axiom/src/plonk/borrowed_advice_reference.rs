//! Frozen original borrowed prover used only for proof-byte regression tests.

use super::*;

/// Original borrowed prover before advice-storage transfer.
pub(super) fn create_proof_reference<
    'params,
    'a,
