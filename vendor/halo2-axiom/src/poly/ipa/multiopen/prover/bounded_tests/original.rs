//! Frozen original IPA multi-opening prover for seeded proof equivalence.

use super::super::super::{
    ChallengeX1, ChallengeX2, ChallengeX3, ChallengeX4, construct_intermediate_sets,
};
...
> Prover<'params, IPACommitmentScheme<C>>
    for OriginalProverIPA<'params, C, QUERY_INSTANCE, PROOF_SUPPLIED_INSTANCE_COMMITMENT_MASK>
{
