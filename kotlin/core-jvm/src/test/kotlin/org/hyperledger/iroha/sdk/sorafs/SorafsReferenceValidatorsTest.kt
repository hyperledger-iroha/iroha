...
class SorafsReferenceValidatorsTest {
    ...
    fun exposesBridgeSelectors() {
        ...
        assertEquals(24, SorafsReferenceValidators.REQUIRED_BRIDGE_ABI_VERSION)
        ...
        assertTrue(!SorafsReferenceValidators.isGovernanceDagBridgeSupported(24, false))
        assertTrue(SorafsReferenceValidators.isGovernanceDagBridgeSupported(24, true))
        assertTrue(!SorafsReferenceValidators.isFixtureBundleBridgeSupported(24, false))
        assertTrue(SorafsReferenceValidators.isFixtureBundleBridgeSupported(24, true))
        assertTrue(!SorafsReferenceValidators.isGovernanceLogNodeBridgeSupported(24, false))
        assertTrue(SorafsReferenceValidators.isGovernanceLogNodeBridgeSupported(24, true))
        assertTrue(!SorafsReferenceValidators.isAppealFinanceBridgeSupported(24, false))
        assertTrue(SorafsReferenceValidators.isAppealFinanceBridgeSupported(24, true))
    ...
    private fun requireNativeBridge(
        requiredMessage: String = "ABI-24 connect_norito_bridge is required.",
    ) {
