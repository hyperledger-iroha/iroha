        ...
        companion object {
            ...
            private fun parseAuthority(authority: String): ControllerPayload {
                ...
                val parsed = try {
                    ...
                    throw IllegalArgumentException("authority must use canonical Katakana i105 encoding", e)
                }
            ...
            private fun parseAddressToController(address: AccountAddress): ControllerPayload {
                try {
                    ...
                    throw IllegalArgumentException(
                        "Failed to extract controller from canonical Katakana i105 account id",
                        e,
                    )
                }
                throw IllegalArgumentException(
