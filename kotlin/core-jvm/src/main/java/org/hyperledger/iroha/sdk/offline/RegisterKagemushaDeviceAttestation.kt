...
class RegisterKagemushaDeviceAttestation(
    val networkId: NetworkId,
    val authority: String,
    val registration: KagemushaDeviceAttestationRegistration,
    ...
    fun instruction(): InstructionBox = KagemushaDeviceAttestationCodec.instruction(registration)
    ...
    companion object {
        ...
        fun decodeInstructionPayloadCanonical(
            ...
            KagemushaDeviceAttestationCodec.decodeInstructionPayloadCanonical(
                archive,
                chainDiscriminant,
            )
    }
