...
private const val ACTION = "UnfreezeRwa"

/** Typed representation of the `UnfreezeRwa` instruction. */
class UnfreezeRwaInstruction private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (other !is UnfreezeRwaInstruction) return false
    ...
    companion object {
        @JvmStatic
        fun fromArguments(arguments: Map<String, String>): UnfreezeRwaInstruction {
            val rwaId = require(arguments, "rwa")
            return UnfreezeRwaInstruction(
                rwaId = rwaId,
