...
private const val ACTION = "HoldRwa"

/** Typed representation of the `HoldRwa` instruction. */
class HoldRwaInstruction private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (other !is HoldRwaInstruction) return false
    ...
    companion object {
        @JvmStatic
        fun fromArguments(arguments: Map<String, String>): HoldRwaInstruction {
            val rwaId = require(arguments, "rwa")
            val quantity = require(arguments, "quantity")
            return HoldRwaInstruction(
                rwaId = rwaId,
                quantity = quantity,
