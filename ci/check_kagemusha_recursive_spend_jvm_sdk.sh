...
cd "${ROOT_DIR}/kotlin"
./gradlew --no-daemon --max-workers=1 -q :core-jvm:clean
./gradlew --no-daemon --max-workers=1 -q :core-jvm:test \
  ...
  --tests org.hyperledger.iroha.sdk.offline.AttestedOfflineNoteTest \
  ...
  --tests org.hyperledger.iroha.sdk.sccp.SccpV1Test \
