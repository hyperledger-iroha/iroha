...
grep -Fq 'KAGEMUSHA_REQUIRED_BRIDGE_ABI_VERSION: 23' "${types_file}"
grep -Fq 'readonly required_bridge_abi_version: 23;' "${types_file}"
grep -Fq 'PRIVACY_REQUIRED_BRIDGE_ABI_VERSION = 23' "${SDK_DIR}/src/crypto.js"
grep -Fq 'PRIVACY_REQUIRED_BRIDGE_ABI_VERSION: 23' "${types_file}"
grep -Fq 'VALIDATION_FEE_REQUIRED_BRIDGE_ABI_VERSION = 23' "${SDK_DIR}/src/validationFeeConsensus.js"
grep -Fq 'VALIDATION_FEE_REQUIRED_BRIDGE_ABI_VERSION: 23' "${types_file}"
